// Function: FUN_1401b6a00
// Addr: 1401b6a00
// Size: 475 bytes


undefined8 * FUN_1401b6a00(longlong *param_1,undefined8 *param_2,undefined8 *param_3)
    ...
    if (uVar12 < 0x2000000000000000) {
      ...
      if (uVar9 != 0) {
        if (uVar9 < 0x1000) {
          ...
          if (uVar9 + 0x27 <= uVar9) goto LAB_1401b6bd7;
      ...
      *(undefined8 *)(puVar11 + -8) = 0x1401b6b9d;
      FUN_1401b7280(param_1,puVar13,uVar1,uVar12);
      *(undefined8 *)(puVar11 + -8) = 0x1401b6ba7;
