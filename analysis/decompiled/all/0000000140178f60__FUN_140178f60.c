// Function: FUN_140178f60
// Addr: 140178f60
// Size: 278 bytes


longlong * FUN_140178f60(longlong param_1,longlong *param_2,undefined8 *param_3,undefined8 param_4)

{
  ...
  uVar7 = uVar11 & *(ulonglong *)(param_1 + 0x30);
  lVar9 = *(longlong *)(*(longlong *)(param_1 + 0x18) + 8 + uVar7 * 0x10);
  if (lVar9 != *(longlong *)(param_1 + 8)) {
    lVar4 = *(longlong *)(*(longlong *)(param_1 + 0x18) + uVar7 * 0x10);
    while( true ) {
      ...
      if ((uVar3 == *(ulonglong *)(lVar9 + 0x20)) &&
         ((uVar3 == 0 ||
          (iVar5 = func_0x0001404210c0(puVar8,plVar6,uVar3,param_4,uVar11), iVar5 == 0)))) {
  ...
  plVar6 = (longlong *)func_0x00014028aff0(0x78);
  return plVar6;
}
