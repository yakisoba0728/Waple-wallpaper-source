// Function: FUN_140372e30
// Addr: 140372e30
// Size: 1327 bytes


undefined8
FUN_140372e30(ulonglong *param_1,longlong param_2,float param_3,byte *param_4,uint param_5)
        ...
        *param_1 = (ulonglong)pbVar11;
        if (uVar13 < uVar8) {
          ...
          if (3 < uVar8 - uVar13) {
            ...
            uVar10 = uVar14;
            if (uVar8 <= uVar13) goto LAB_140373335;
          }
          do {
            bVar4 = *pbVar11;
            pbVar11 = pbVar11 + 1;
...
LAB_140373335:
        ...
        *param_1 = (ulonglong)pbVar11;
        if (uVar13 < uVar8) {
          lVar6 = *(longlong *)(param_2 + 8);
          if (uVar8 - uVar13 < 4) goto LAB_1403731e1;
          do {
            iVar9 = (int)uVar14;
            *(float *)(lVar6 + 4 + uVar14 * 0xc) =
        ...
        *param_1 = (ulonglong)pbVar11;
        if (uVar13 < uVar8) {
          ...
          if (3 < uVar8 - uVar13) {
            ...
            uVar10 = uVar14;
            if (uVar8 <= uVar13) goto LAB_14037309c;
          }
          do {
            pbVar5 = pbVar11 + 1;
            bVar4 = *pbVar11;
