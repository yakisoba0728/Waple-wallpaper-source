// Function: FUN_1401794d0
// Addr: 1401794d0
// Size: 252 bytes


void FUN_1401794d0(undefined8 *param_1)

{
  ...
  if (lVar3 != 0) {
    do {
      FUN_140017240(*(undefined8 *)(param_1[1] + (param_1[2] - 1 & param_1[3] + -1 + lVar3) * 8));
      lVar3 = param_1[4] + -1;
      param_1[4] = lVar3;
    } while (lVar3 != 0);
    param_1[3] = 0;
  ...
  if (param_1[1] != 0) {
    ...
    *(undefined8 *)(puVar5 + -8) = 0x1401795aa;
