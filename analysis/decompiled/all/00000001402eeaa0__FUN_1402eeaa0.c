// Function: FUN_1402eeaa0
// Addr: 1402eeaa0
// Size: 267 bytes


int FUN_1402eeaa0(longlong *param_1,undefined8 *param_2)

{
  ...
  if (lVar1 == 0) {
    ...
    if (iVar3 == 0x62697473) {
      puVar5 = &DAT_1404366c0;
    }
    else if (iVar3 == 0x6f75746c) {
      puVar5 = &DAT_1404366f8;
    }
    else if (iVar3 == 0x53564720) {
      puVar5 = &DAT_140436730;
    }
    else {
      lVar4 = FUN_1402f1c20(lVar1,iVar3,0);
      if ((lVar4 == 0) || (puVar5 = (undefined *)(lVar4 + 0x28), puVar5 == (undefined *)0x0)) {
        return 0x12;
      }
    }
    iVar3 = FUN_1402eeca0(lVar1,puVar5,&local_res8);
    if (iVar3 == 0) {
      ...
      if (local_res8 != (undefined8 *)0x0) {
        ...
        FUN_1402f8060(uVar2,local_res8);
      }
      *param_2 = 0;
    }
  }
