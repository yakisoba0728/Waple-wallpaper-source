// Function: FUN_1403deaf0
// Addr: 1403deaf0
// Size: 343 bytes


void FUN_1403deaf0(longlong param_1,undefined8 param_2)

{
  ...
  if (*(int *)(param_1 + 0x1c) == 9) {
    ...
    local_40 = local_50;
    local_10 = local_50;
    func_0x0001403bcbe0(param_1,param_2,&local_68,&local_48,&local_58);
    func_0x0001403bcbe0(param_1,param_2,&local_18,&dStack_28,&dStack_38);
    return;
  }
