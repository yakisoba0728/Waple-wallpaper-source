// Function: FUN_1403aa1c0
// Addr: 1403aa1c0
// Size: 536 bytes


undefined8 FUN_1403aa1c0(byte *param_1,longlong param_2,longlong param_3,uint param_4)

{
  ...
  if (-1 < iVar14) {
    uVar12 = (uint)(byte)(&DAT_140470560)[*(byte *)(param_3 + 1) & 0xf] +
             (uint)(byte)(&DAT_140470560)[*(byte *)(param_3 + 1) >> 4];
    iVar15 = (uint)(byte)(&DAT_140470560)[*(byte *)(param_3 + 3) & 0xf] +
             (uint)(byte)(&DAT_140470560)[*(byte *)(param_3 + 3) >> 4];
    iVar13 = 0;
    ...
    do {
      ...
      if (iVar9 < 0) {
        ...
        if (iVar9 < 1) {
          if ((uVar12 == 0) ||
             (cVar4 = FUN_1403b0c80(param_3,param_2,param_1,pbVar11 + 2,
                                    *(longlong *)(lVar2 + 0x80) +
          ...
          if ((iVar15 == 0) ||
             (cVar4 = FUN_1403b0c80(param_3 + 2,param_2,param_1,
          ...
          if ((bVar3) || (bVar5)) {
            FUN_14040eef0(lVar2,*(undefined4 *)(lVar2 + 0x5c),param_4 + 1);
          }
          if (iVar15 != 0) {
            FUN_14040eef0(lVar2,*(undefined4 *)(lVar2 + 0x5c),param_4 + 2);
            param_4 = param_4 + 1;
          }
