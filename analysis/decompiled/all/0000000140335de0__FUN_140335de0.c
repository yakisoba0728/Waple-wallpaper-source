// Function: FUN_140335de0
// Addr: 140335de0
// Size: 362 bytes


void FUN_140335de0(longlong param_1,longlong param_2,int *param_3,undefined8 param_4,char param_5)

{
  ...
  if ((*piVar5 != *param_3) || (cVar3 = '\0', piVar5[1] != param_3[1])) {
    local_80 = &local_78;
    local_88 = &local_70;
    cVar3 = FUN_140335330(param_1,lVar4 + param_1,piVar5,param_3);
    if (cVar3 != '\0') {
  ...
  if (iVar1 == 2) {
    ...
    FUN_1403359d0(param_1,lVar4,&local_60,*(undefined4 *)(param_1 + 0x4948));
    if (((int)local_68 != local_60) || (local_68._4_4_ != iStack_5c)) {
      ...
      goto UNWIND_INFO_140335f4b_UnwindCodes_24__OffsetInProlog;
    }
  }
  else if (iVar1 == 4) {
    local_88._0_4_ = *(undefined4 *)(param_1 + 0x494c);
    local_48 = iVar1;
    FUN_1403359d0(param_1,param_2,&local_60,*(undefined4 *)(param_1 + 0x4948));
    local_88._0_4_ = *(undefined4 *)(param_1 + 0x4954);
    FUN_1403359d0(param_1,param_2,local_58,*(undefined4 *)(param_1 + 0x4950));
    local_88 = (undefined8 *)CONCAT44(local_88._4_4_,*(undefined4 *)(param_1 + 0x495c));
    FUN_1403359d0(param_1,param_2,&local_50,*(undefined4 *)(param_1 + 0x4958));
    (**(code **)(*(longlong *)(param_1 + 8) + 0x18))(*(longlong *)(param_1 + 8),&local_68);
UNWIND_INFO_140335f4b_UnwindCodes_24__OffsetInProlog:
    *(undefined8 *)(param_1 + 0x4928) = local_50;
  }
  if (cVar3 == '\0') {
    if (param_5 != '\0') goto code_r0x000140335f97;
code_r0x000140335f9e:
    local_88 = (undefined8 *)CONCAT44(local_88._4_4_,param_3[1]);
    FUN_1403359d0(param_1,param_2,&local_60,*param_3);
    ...
    if (cVar3 == '\0') goto code_r0x000140336000;
  }
  else if (param_5 != '\0') {
code_r0x000140335f97:
    param_2 = param_1 + 0x1838;
    goto code_r0x000140335f9e;
  }
  *(undefined8 *)param_3 = uVar2;
code_r0x000140336000:
