// Function: FUN_140394e80
// Addr: 140394e80
// Size: 520 bytes


undefined4 *
FUN_140394e80(undefined4 *param_1,undefined4 param_2,longlong param_3,longlong param_4,
...

{
  ...
  *(longlong *)(param_1 + 0x28) = param_4;
  FUN_1403958a0(param_1 + 0x2a,param_5);
  *(undefined8 *)(param_1 + 0x3a) = 0;
  puVar4 = (undefined8 *)FUN_1403c4f00(*(longlong *)(param_1 + 0x26) + 0x138);
  ...
  *(undefined8 **)(param_1 + 0x3c) = puVar7;
  uVar6 = FUN_1403c4f00(*(longlong *)(param_1 + 0x26) + 0x138);
  *(undefined8 *)(param_1 + 0x3e) = uVar6;
  *(undefined8 *)(param_1 + 0x40) = 0;
  pbVar1 = *(byte **)(param_1 + 0x3c);
  uVar6 = FUN_1403d0110(pbVar1);
  ...
  *(undefined4 **)(param_1 + 0x52) = param_1 + 0x54;
  ...
  if (*(longlong *)(lVar2 + 0xe8) != 0) {
    ...
    *(code **)(lVar2 + 0x100) = FUN_1403b24a0;
