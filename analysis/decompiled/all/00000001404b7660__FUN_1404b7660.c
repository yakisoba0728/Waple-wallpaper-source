...
void FUN_1404b7660(char *param_1,uint param_2,undefined8 param_3,char *param_4)

{
  ...
  bVar6 = (byte)uVar9;
  if (in_ZF) {
    *(undefined1 *)(unaff_RBP + 0x1d) = *(undefined1 *)(unaff_RBP + 0x1d);
  }
  else {
...
code_r0x0001404b768c:
  ...
  *(int *)(unaff_RSI + (longlong)piVar14) = *(int *)(unaff_RSI + (longlong)piVar14) + (uint)puVar12;
