// Function: FUN_1403410e0
// Addr: 1403410e0
// Size: 477 bytes


undefined8 FUN_1403410e0(longlong param_1,longlong param_2)
  ...
  if (uVar10 != 0) {
    do {
      ...
      if (0 < *(int *)(param_2 + 0x110)) {
        if ((*(uint *)(param_2 + 0x120) < uVar6 - uVar7) ||
           (*(uint *)(param_2 + 0x120) - (uVar6 - uVar7) <=
            CONCAT31(CONCAT21(CONCAT11(uVar1,uVar2),uVar3),uVar4))) {
