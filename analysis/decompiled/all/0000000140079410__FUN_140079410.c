// Function: FUN_140079410
// Addr: 140079410
// Size: 304 bytes


longlong FUN_140079410(longlong param_1,undefined8 *param_2)

{
  ...
  if (*(longlong *)(param_1 + 0x10) == 0x11a7b9611a7b961) {
                    /* WARNING: Subroutine does not return */
    FUN_14028c3b0("unordered_map/set too long");
  }
  lVar6 = func_0x00014028aff0(0xe8);
  return lVar6;
}
