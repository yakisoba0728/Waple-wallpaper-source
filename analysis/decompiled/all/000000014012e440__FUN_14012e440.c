// Function: FUN_14012e440
// Addr: 14012e440
// Size: 308 bytes


void FUN_14012e440(longlong *param_1,undefined8 param_2)
...
LAB_14012e4c7:
    ...
    if ((lVar6 == 8) && (*plVar3 == 0x6970616c6c656873)) {
      ...
      if (lVar6 == 10) {
        ...
        DAT_1404df664 = 4;
        if (lVar6 == 0) goto LAB_14012e614;
      }
      DAT_1404df664 = 5;
    }
  }
LAB_14012e614:
  FUN_1400855f0(&DAT_1404e7fc8,param_2);
  return;
}
