// Function: FUN_14000f9f0
// Addr: 14000f9f0
// Size: 533 bytes


longlong * FUN_14000f9f0(longlong param_1)

{
  ...
  lVar1 = DAT_1404e90c8 * 8;
  if ((DAT_1404e90c8 < *(ulonglong *)(lVar4 + 0x18)) &&
     (plVar5 = *(longlong **)(lVar1 + *(longlong *)(lVar4 + 0x10)), plVar5 != (longlong *)0x0))
  goto LAB_14000fa89;
  if (*(char *)(lVar4 + 0x24) == '\0') {
LAB_14000fac8:
    if (plVar5 != (longlong *)0x0) goto LAB_14000fa89;
  }
  else {
    lVar4 = FUN_1402916f0();
  ...
  if (plVar2 == (longlong *)0x0) {
    ...
    *plVar5 = (longlong)
              std::num_put<wchar_t,std::ostreambuf_iterator<wchar_t,std::char_traits<wchar_t>_>_>::
              vftable;
