// Function: FUN_140209430
// Addr: 140209430
// Size: 268 bytes


void FUN_140209430(longlong *param_1,longlong param_2)

{
  ...
  local_res8._4_4_ = DAT_140492878;
  ...
  if ((uVar2 & 2) != 0) {
    ...
    *(float *)((longlong)param_1 + 0x2f4) = (float)*(uint *)(param_2 + 0x30);
    ...
    goto UNWIND_INFO_14020953c_UnwindCodes_14__OffsetInProlog;
  }
...
UNWIND_INFO_14020953c_UnwindCodes_14__OffsetInProlog:
