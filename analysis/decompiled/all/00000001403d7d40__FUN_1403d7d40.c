// Function: FUN_1403d7d40
// Addr: 1403d7d40
// Size: 9 bytes


void FUN_1403d7d40(longlong *param_1)

{
  ...
  lVar9 = param_1[3];
  lStackX_10 = *(longlong *)(lVar9 + 0x70);
    ...
    if (uVar3 != 0) {
      ...
      do {
        iVar6 = (**(code **)(lVar9 + 0x30))
                          (lVar9,*(undefined4 *)(lStackX_10 + lVar13 * 0x14),
                           *(undefined8 *)(lVar9 + 0x70));
        if (iVar6 == *(int *)(lStackX_10 + lVar13 * 0x14)) {
code_r0x0001403d7e05:
          puVar2 = (uint *)(lStackX_10 + 4 + lVar13 * 0x14);
          *puVar2 = *puVar2 | uVar12;
          ...
          iVar7 = (**(code **)(*(longlong *)(lVar4 + 0x90) + 0x30))
                            (lVar4,*(undefined8 *)(lVar4 + 0x98),iVar6,auStackX_8,uVar8);
          if (iVar7 == 0) goto code_r0x0001403d7e05;
          *(int *)(lStackX_10 + lVar13 * 0x14) = iVar6;
        }
        uVar11 = uVar11 + 1;
        lVar13 = lVar13 + 1;
      } while (uVar11 < uVar3);
  ...
  if ((((*(uint *)((longlong)param_1 + 0x2c) & 0xfffffffe) == 6) &&
      ((*(byte *)(*param_1 + 0xb4) & 4) == 0)) && (uVar14 = 0, lVar9 = lStackX_10, uVar3 != 0)) {
    do {
      ...
      if (uVar11 == 0x20) {
        if (uVar12 == 0x2013) {
          ...
          if (uVar12 != 0x2026) goto LAB_1403d8050;
          uVar10 = 0xfe19;
        }
LAB_1403d800c:
        lVar9 = param_1[1];
        ...
        iVar6 = (**(code **)(*(longlong *)(lVar9 + 0x90) + 0x30))
                          (lVar9,*(undefined8 *)(lVar9 + 0x98),uVar10,auStackX_8,uVar8);
        lVar9 = lStackX_10;
        if (iVar6 != 0) {
          *puVar1 = uVar10;
        }
