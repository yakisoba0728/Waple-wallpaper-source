// Function: FUN_1403dfac0
// Addr: 1403dfac0
// Size: 856 bytes


void FUN_1403dfac0(longlong param_1,longlong *param_2)

{
  ...
  dVar17 = *(double *)(param_1 + 0x11c8);
  dVar5 = *(double *)(param_1 + 0x11c0);
  if ((uVar15 & 1) == 0) {
    uVar14 = 0;
  }
  else if (uVar15 == 0) {
  ...
  if (uVar14 + 4 <= uVar15) {
    do {
      ...
      dVar16 = dVar9 + *pdVar12;
      dVar10 = dVar17 + *pdVar11;
      ...
      fVar18 = (float)dVar10 * *(float *)(lVar6 + 0x54);
      ...
      (**(code **)(lVar8 + 0x28))
                (lVar8,lVar6,plVar2,(float)dVar9 * fVar3,(float)dVar17 * fVar4,fVar3 * (float)dVar16
                 ,fVar18,(float)dVar5 * fVar3,fVar18,uVar13);
      *(float *)((longlong)plVar7 + 0x1c) = (float)dVar5 * fVar3;
      *(float *)(plVar7 + 4) = fVar18;
