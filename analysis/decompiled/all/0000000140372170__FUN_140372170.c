// Function: FUN_140372170
// Addr: 140372170
// Size: 1388 bytes


undefined8
FUN_140372170(longlong param_1,uint param_2,undefined8 param_3,undefined4 param_4,undefined8 param_5
             ,undefined8 *param_6)
              ...
              if ((uVar21 & 0x10) == 0) {
                ...
                do {
                  if ((*(ulonglong *)(puVar17[2] + (ulonglong)(uVar21 >> 0x10) * 0x18 + uVar16 * 8)
                       >> (*puVar1 >> ((byte)(&DAT_14045c498)[uVar16] & 0x1f) & 0x3f) & 1) == 0)
                  goto LAB_140372387;
                  uVar14 = (int)uVar16 + 1;
                ...
                cVar13 = FUN_1403ebff0(puVar17,uVar21 >> 0x10);
                if (cVar13 == '\0') {
LAB_140372387:
                  bVar27 = false;
                }
            ...
            if (((puVar1[1] & *(uint *)(param_1 + 0x1c)) != 0) &&
              ...
              if (cVar13 != '\0') goto LAB_140372475;
            }
            if (!bVar27) {
              local_48 = *(int *)(param_1 + 8) + 1;
              goto UNWIND_INFO_140372756;
            }
          }
LAB_140372455:
          iVar19 = *(int *)(param_1 + 8);
...
LAB_140372682:
  ...
  *(undefined4 *)puVar17 = *(undefined4 *)(lVar6 + 0x5c);
  ...
  if ((uVar23 == 0xffffffff) || (uVar23 - iVar26 < 0x100)) {
    ...
    if (1 < uVar21 - iVar26) {
      uVar15 = FUN_1403a1af0(lVar6,*(undefined8 *)(lVar6 + 0x70),iVar26,uVar21,0xffffffff);
      FUN_1403a1c90(lVar6,*(undefined8 *)(lVar6 + 0x70),iVar26,uVar21,uVar15,3);
    }
  }
  FUN_1403b0330(param_1,param_2,param_4,param_5,uVar23);
  return 1;
LAB_140372475:
  ...
  if (*(uint *)(param_1 + 0x144) < uVar21) {
    ...
    FUN_1403a4650(param_1 + 0x140,uVar21,0);
  }
  *(undefined4 *)(*(longlong *)(param_1 + 0x148) + (ulonglong)uVar23 * 4) =
  ...
  if ((bVar11 == 0) || (bVar22 == 0)) {
    if ((bVar12 != 0) && ((bVar24 != 0 && (bVar12 != bVar11)))) goto UNWIND_INFO_140372756;
  }
    ...
    if (iVar26 == 0) {
      ...
      if (*(uint *)(lVar6 + 100) != 0) {
        while( true ) {
          ...
          if (bVar4 >> 5 != bVar11) goto UNWIND_INFO_140372756;
          bVar12 = 0;
          if ((bVar4 & 0x10) == 0) {
            bVar12 = bVar4 & 0xf;
          }
          if (bVar12 == 0) break;
          if (uVar23 == 0) goto UNWIND_INFO_140372756;
        }
        uVar23 = *(uint *)(param_1 + 0x18);
        uVar5 = (ushort)puVar1[3];
        if ((uVar23 & uVar5 & 0xe) == 0) {
          if ((uVar5 & 8) == 0) goto UNWIND_INFO_140372756;
          if ((uVar23 & 0x10) == 0) {
            if ((uVar23 & 0xff00) == 0) goto UNWIND_INFO_140372756;
            ...
            do {
              if ((*(ulonglong *)(puVar17[2] + (ulonglong)(uVar23 >> 0x10) * 0x18 + uVar16 * 8) >>
                   (uVar14 >> ((byte)(&DAT_14045c498)[uVar16] & 0x1f) & 0x3f) & 1) == 0)
              goto LAB_140372624;
              uVar25 = (int)uVar16 + 1;
            ...
            cVar13 = FUN_1403ebff0(puVar17,uVar23 >> 0x10,uVar14);
            if (cVar13 == '\0') {
LAB_140372624:
              bVar27 = false;
            }
          ...
          if (bVar27) goto UNWIND_INFO_140372756;
        }
        iVar26 = 2;
        goto LAB_140372672;
      }
    }
    else if (iVar26 != 1) goto LAB_140372672;
UNWIND_INFO_140372756:
    lVar6 = *(longlong *)(param_1 + 0xa0);
...
LAB_140372672:
  uVar23 = uVar21;
  if (param_2 <= uVar21) goto LAB_140372682;
  goto code_r0x000140372289;
}
