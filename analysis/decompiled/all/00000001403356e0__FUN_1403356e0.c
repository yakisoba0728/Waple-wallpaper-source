// Function: FUN_1403356e0
// Addr: 1403356e0
// Size: 529 bytes


void FUN_1403356e0(longlong param_1,int param_2,int param_3,int param_4,int param_5,int param_6,
                  uint param_7)

{
  ...
  FUN_1403354b0(param_1,*(undefined4 *)(param_1 + 0x4920),*(undefined4 *)(param_1 + 0x4924),param_2,
                param_3,local_res10,local_res18);
  piVar5 = local_res20;
  uVar4 = param_7;
  FUN_1403354b0(param_1,param_4,param_5,param_6,param_7,piVar5,local_res8);
  ...
  *piVar1 = *piVar1 + ((param_5 - param_3 >> 0x10) * (param_2 >> 0x10) -
  ...
  if (*(char *)(param_1 + 0x4938) != '\0') {
    FUN_140335d10(param_1,param_1 + 0x10,&local_58,uVar2,uVar4 & 0xffffff00);
    uVar3 = CONCAT44(iStack_54,local_58);
  }
