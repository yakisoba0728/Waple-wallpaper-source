...
void FUN_1401ed1a0(longlong *param_1,undefined8 param_2,undefined4 *param_3,undefined8 *param_4,
                  float *param_5)

{
  ...
  local_1e8 = _DAT_140492b30;
  uStack_1e0 = _UNK_140492b38;
  local_1d8 = _DAT_140492b60;
  uStack_1d0 = _UNK_140492b68;
  local_1c8 = _DAT_140492c10;
  uStack_1c0 = _UNK_140492c18;
  local_1b8 = _DAT_140492eb0;
  uStack_1b0 = _UNK_140492eb8;
  if ((param_3[1] & 8) == 0) {
  ...
  puVar11 = (undefined8 *)FUN_14005ed80(&local_188,uVar10,&local_1e8);
  local_1e8 = *puVar11;
  ...
  if (((*(uint *)(lVar5 + 0x118) & 0x400) != 0) && ((*(byte *)(plVar9 + 0x24) & 0x80) != 0)) {
    FUN_140184fd0(lVar5,&local_268,&local_148);
  }
  ...
  uVar10 = FUN_14005ed80(&local_188,&local_148,&local_268);
  pfVar12 = (float *)FUN_14005ed80(local_108,uVar10,&local_1e8);
  fVar6 = pfVar12[0xc];
  fVar7 = pfVar12[0xd];
  fVar15 = pfVar12[8];
  fVar16 = *pfVar12;
  ...
  uVar10 = FUN_14005ed80(local_108,&local_148,&local_268);
  pfVar12 = (float *)FUN_14005ed80(&local_188,uVar10,&local_1e8);
  fVar14 = pfVar12[3] * DAT_1404929c8 + pfVar12[7] * 0.0 + pfVar12[0xb] * 0.0 + pfVar12[0xf];
  local_res8 = ((fVar16 * 0.0 + fVar1 * 0.0 + fVar15 * 0.0 + fVar6) / fVar13) * DAT_140492790 +
               DAT_140492790;
  fStackX_c = ((fVar2 * 0.0 + fVar3 * 0.0 + fVar4 * 0.0 + fVar7) / fVar13) * DAT_140492790 +
              DAT_140492790;
  local_res18 = ((*pfVar12 * DAT_1404929c8 + pfVar12[4] * 0.0 + pfVar12[8] * 0.0 + pfVar12[0xc]) /
                fVar14) * DAT_140492790 + DAT_140492790;
  local_res1c = ((pfVar12[1] * DAT_1404929c8 + pfVar12[5] * 0.0 + pfVar12[9] * 0.0 + pfVar12[0xd]) /
                fVar14) * DAT_140492790 + DAT_140492790;
  if (((*(uint *)(lVar5 + 0x118) & 0x400) == 0) || ((*(byte *)(param_1 + 0x24) & 0x80) == 0)) {
    ...
    local_238 = CONCAT44(*(float *)(lVar5 + 0x1164) * fVar15 + *(float *)(lVar5 + 0x1174) * fVar16 +
                         ...
                         *(float *)(lVar5 + 0x1180) * _DAT_140492690 + *(float *)(lVar5 + 0x1190));
  ...
  local_188 = param_1;
  local_180 = lVar5;
  FUN_1401edbf0(&local_188,&local_res8,local_1a8,&local_218);
  FUN_1401edbf0(&local_188,&local_res18,local_1f8,local_198);
  fVar16 = DAT_1404927d4 / *(float *)(param_1 + 0x5e);
  local_res8 = 1.0;
  fStackX_c = 1.0;
  local_220 = 0;
  fVar15 = DAT_140492a88 / *(float *)((longlong)param_1 + 0x2f4);
  local_228 = fVar16;
  local_224 = fVar15;
  uVar10 = (**(code **)(*param_1 + 0x80))(param_1);
  FUN_1401e5ea0(&local_208,uVar10,local_1a8,&local_218,&local_228,CONCAT44(fStackX_c,local_res8));
  local_res8 = 1.0;
  fStackX_c = 1.0;
  local_220 = 0;
  local_228 = fVar16;
  local_224 = fVar15;
  uVar10 = (**(code **)(*param_1 + 0x80))(param_1);
  FUN_1401e5ea0(&local_218,uVar10,local_1f8,local_198,&local_228,CONCAT44(fStackX_c,local_res8));
  ...
  if (0.0 <= fVar15) {
    ...
    fVar15 = (float)((uint)local_218 ^ DAT_1404930c0);
