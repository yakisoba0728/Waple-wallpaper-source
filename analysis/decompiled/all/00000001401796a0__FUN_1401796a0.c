// Function: FUN_1401796a0
// Addr: 1401796a0
// Size: 43 bytes


/* WARNING: Possible PIC construction at 0x000140179729: Changing call to branch */

void FUN_1401796a0(longlong *param_1)

{
  ...
  if (lVar4 != 0) {
    do {
      uStack_30 = 0x1401796e1;
      FUN_1400c1670(*(undefined8 *)(param_1[1] + (param_1[2] - 1U & param_1[3] + -1 + lVar4) * 8));
      lVar4 = param_1[4] + -1;
      param_1[4] = lVar4;
    } while (lVar4 != 0);
    param_1[3] = 0;
    ...
    *param_1 = 0;
    ...
    do {
      if (lVar4 < 1) {
        ...
        *(undefined **)(puVar6 + -8) = &UNK_14017977a;
        func_0x00014028b040(lVar5);
        param_1[1] = 0;
        param_1[2] = 0;
        goto code_r0x000140179782;
      }
      lVar5 = *(longlong *)(param_1[1] + -8 + lVar4 * 8);
      lVar4 = lVar4 + -1;
    } while (lVar5 == 0);
    puVar7 = &uStack_30;
    uStack_30 = 0x14017972e;
  }
  if (lVar5 != 0) {
