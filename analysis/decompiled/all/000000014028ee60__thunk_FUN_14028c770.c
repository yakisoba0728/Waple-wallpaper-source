// Function: thunk_FUN_14028c770
// Addr: 14028ee60
// Size: 5 bytes


longlong thunk_FUN_14028c770(longlong param_1,longlong param_2,byte *param_3,longlong param_4)

{
  ...
  if ((DAT_1404dc0dc & 4) == 0) {
    lVar3 = func_0x000140421870(acStack_140,0,0x100);
    return lVar3;
  }
  ...
  if (iVar2 != 2) {
    ...
    func_0x000140421870(acStack_140,0,0x100);
