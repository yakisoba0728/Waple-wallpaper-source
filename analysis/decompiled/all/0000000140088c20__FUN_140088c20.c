// Function: FUN_140088c20
// Addr: 140088c20
// Size: 125 bytes


longlong * FUN_140088c20(longlong *param_1)

{
  ...
  bVar4 = FUN_140013560((longlong)*(int *)(*param_1 + 4) + (longlong)param_1,10);
  ...
  if (*(int *)((longlong)iVar6 + 0x10 + (longlong)param_1) == 0) {
    ...
    if ((plVar1 != (longlong *)0x0) && (plVar1 != param_1)) {
      ...
      iVar6 = *(int *)(*param_1 + 4);
      if (*(int *)((longlong)iVar6 + 0x10 + (longlong)param_1) != 0)
      goto UNWIND_INFO_140088c9e_UnwindCodes_28__UnwindOpCode;
    }
    uVar5 = (uint)bVar4;
...
UNWIND_INFO_140088c9e_UnwindCodes_28__UnwindOpCode:
    uVar8 = 4;
  }
  ...
  func_0x000140013c20(lVar7,uVar5 | *(uint *)(lVar7 + 0x10) | uVar8,0);
  ...
  if (((*(int *)(lVar7 + 0x10 + (longlong)param_1) == 0) &&
    ...
    lVar7 = (longlong)*(int *)(*param_1 + 4) + (longlong)param_1;
    func_0x000140013c20(lVar7,*(uint *)(lVar7 + 0x10) | 4,0);
  }
  plVar1 = *(longlong **)((longlong)*(int *)(*param_1 + 4) + 0x48 + (longlong)param_1);
  if (plVar1 != (longlong *)0x0) {
    (**(code **)(*plVar1 + 0x10))();
  }
  FUN_140012ad0(param_1);
  return param_1;
}
