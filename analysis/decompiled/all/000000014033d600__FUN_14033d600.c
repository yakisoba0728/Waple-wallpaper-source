// Function: FUN_14033d600
// Addr: 14033d600
// Size: 333 bytes


ulonglong FUN_14033d600(longlong param_1,longlong param_2,ulonglong param_3,int param_4,
...

{
  ...
  uVar4 = FUN_14033e330(puVar1,param_6,&local_res8);
  if ((int)uVar4 == 0) {
    if (*puVar1 == 0) {
      uVar3 = FUN_14033e330(puVar1,param_6,&local_res8);
      if (uVar3 != 0) {
    ...
    uVar3 = FUN_14033e2b0(local_res8,param_4,param_6);
