...
void FUN_1401e5b60(longlong param_1)

{
  ...
  fVar5 = (float)FUN_14041b0d0(*(float *)(param_1 + 0x110) * DAT_1404926c0);
  uVar6 = (uint)(DAT_140492704 / (fVar5 / (DAT_140492704 / *(float *)(lVar1 + 0x14)))) ^
          DAT_140492ff0;
  *(float *)(lVar2 + 0x30) =
  ...
  *(uint *)(lVar2 + 0x38) = uVar6;
  ...
  if ((*(uint *)(param_1 + 0x118) & 0x800) != 0) {
    ...
    fVar7 = (float)puVar3[1] * _DAT_140493050;
    fVar8 = (float)((ulonglong)puVar3[1] >> 0x20) * _UNK_140493054;
    *puVar3 = CONCAT44((float)((ulonglong)*puVar3 >> 0x20) * _UNK_140493054,
                       (float)*puVar3 * _DAT_140493050);
    fVar4 = _UNK_140492e34;
    fVar5 = _DAT_140492e30;
