...
ulonglong FUN_1402c16e4(ulonglong param_1,undefined2 *param_2,ulonglong param_3,longlong param_4,
...

{
  ...
  local_4b9 = 0;
  local_4c8 = 0;
  if (((param_1 & 2) != 0) || (local_4c0 = 0, param_2 == (undefined2 *)0x0)) {
    local_4c0 = 1;
  }
  local_4b0 = param_5;
  local_58 = &local_4d8;
  ...
  local_4b8 = param_1;
  local_4a8 = param_4;
  iVar1 = FUN_1402c4874(&local_4b8);
  uVar2 = (ulonglong)iVar1;
  if (param_2 == (undefined2 *)0x0) goto LAB_1402c184f;
  if ((param_1 & 1) == 0) {
    if ((param_1 & 2) == 0) {
      if (param_3 == 0) goto LAB_1402c1812;
...
LAB_1402c1892:
      ...
      if (param_3 == 0) goto LAB_1402c184f;
      if (iVar1 < 0) {
        *param_2 = 0;
        goto LAB_1402c184f;
      }
      if (local_4c8 == param_3) goto LAB_1402c1892;
    }
LAB_1402c184a:
    param_2[local_4c8] = 0;
  }
    ...
    if ((param_3 != 0) || (iVar1 == 0)) {
      if (local_4c8 != param_3) goto LAB_1402c184a;
      if ((iVar1 < 0) || (uVar2 <= param_3)) goto LAB_1402c184f;
    }
LAB_1402c1812:
    uVar2 = 0xffffffff;
  }
