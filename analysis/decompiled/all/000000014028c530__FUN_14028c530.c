// Function: FUN_14028c530
// Addr: 14028c530
// Size: 367 bytes


longlong FUN_14028c530(longlong param_1,longlong param_2,byte *param_3,longlong param_4)

{
  ...
  if ((DAT_1404dc00c & 4) == 0) {
    ...
    while (local_140[*(byte *)(param_1 + lVar3)] != '\0') {
      lVar3 = lVar3 + 1;
      if (lVar3 == param_2) {
        return -1;
      }
    ...
    if (iVar2 == 2) {
      lVar3 = FUN_14028d7c0(param_1,param_2,param_3);
      return lVar3;
    }
    if (iVar2 == 1) {
      FUN_1404217a0(local_140,0,0x100);
    ...
    lVar4 = FUN_14028de50(param_1,param_2,param_3);
    lVar3 = -1;
