// Function: FUN_14026d5e0
// Addr: 14026d5e0
// Size: 368 bytes


longlong FUN_14026d5e0(longlong param_1,char *param_2)

{
  ...
  lVar6 = *(longlong *)(DAT_1404e8a78 + 8 + (DAT_1404e8a90 & uVar9) * 0x10);
  if (lVar6 != DAT_1404e8a68) {
    lVar7 = *(longlong *)(DAT_1404e8a78 + (DAT_1404e8a90 & uVar9) * 0x10);
    cVar2 = FUN_14000d010(lVar6 + 0x10,param_2);
    while (cVar2 == '\0') {
      if (lVar6 == lVar7) goto LAB_14026d68e;
      lVar6 = *(longlong *)(lVar6 + 8);
      cVar2 = FUN_14000d010(lVar6 + 0x10,param_2);
    }
    if (lVar6 != 0) goto LAB_14026d695;
  }
LAB_14026d68e:
  lVar6 = DAT_1404e8a68;
LAB_14026d695:
