// Function: FUN_14032af50
// Addr: 14032af50
// Size: 239 bytes


ulonglong FUN_14032af50(longlong param_1,longlong param_2,int param_3)
    ...
    do {
      if (*(int *)(*(longlong *)(param_2 + 0x140) + uVar3 * 0x10) == param_3) {
        ...
        if ((uVar6 < *(uint *)(param_1 + 0xc)) ||
           (local_res10[0] = func_0x0001402f5d60(param_1,uVar6 - *(uint *)(param_1 + 0xc)),
           local_res10[0] != 0)) {
          return 0x53;
        }
        uVar6 = func_0x0001402f5a40(param_1,local_res10);
        if (local_res10[0] != 0) {
        ...
        puVar4 = &DAT_14043ff90;
        if ((uVar6 & 4) == 0) {
          puVar4 = &DAT_14043ff58;
        }
        uVar3 = FUN_1402f56e0(param_1,puVar4,param_2 + 0x148);
        ...
        uVar5 = uVar6 & 0xff;
        uVar3 = func_0x00014032b600(param_1,uVar5,param_2 + 0x15c);
        local_res10[0] = (uint)uVar3;
        if (local_res10[0] != 0) {
          return uVar3;
        }
        uVar3 = func_0x00014032b600(param_1,uVar5,param_2 + 0x16c);
        local_res10[0] = (uint)uVar3;
        if (local_res10[0] != 0) {
          return uVar3;
        }
        if ((uVar6 & 0xffffff00) == 0x100) {
          uVar3 = func_0x00014032b600(param_1,uVar5,param_2 + 0x17c);
          local_res10[0] = (uint)uVar3;
          if (local_res10[0] != 0) {
            return uVar3;
          }
          uVar3 = func_0x00014032b600(param_1,uVar5,param_2 + 0x18c);
          return uVar3;
        }
