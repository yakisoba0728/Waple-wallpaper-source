// Function: FUN_1402bf9e8
// Addr: 1402bf9e8
// Size: 307 bytes


uint FUN_1402bf9e8(uint param_1,__crt_locale_pointers *param_2)

{
  ...
  if (param_1 != 0xffffffff) {
    ...
    if (param_1 < 0x100) {
      uVar4 = (uint)*(byte *)(local_20[0][0x23] + ((ulonglong)param_1 & 0xff));
      if (local_10 != '\0') {
      ...
      local_res18 = 0;
      local_res1a = 0;
      iVar1 = __acrt_LCMapStringA(local_20,local_20[0][0x27],0x200,&local_res8,uVar3,&local_res18,3,
