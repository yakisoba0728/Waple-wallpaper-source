// Function: FUN_1402afa70
// Addr: 1402afa70
// Size: 279 bytes


undefined8 *
FUN_1402afa70(undefined8 param_1,undefined8 *param_2,undefined8 *param_3,undefined8 param_4,
  ...
  *param_6 = *param_6 | uVar1;
  if ((uVar1 & 2) == 0) {
    if (local_res10[0] < 3) {
      ...
      else if (99 < (int)param_5) goto LAB_1402afb68;
    }
    else {
