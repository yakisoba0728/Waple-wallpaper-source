// Function: FUN_14029d4f0
// Addr: 14029d4f0
// Size: 277 bytes


longlong FUN_14029d4f0(longlong param_1)

{
  ...
  lVar4 = DAT_1404e4250;
  local_res18 = DAT_1404e4250;
  if (DAT_1404e41b8 == 0) {
    FUN_1402914b0(&local_res8,0);
    if (DAT_1404e41b8 == 0) {
      DAT_1404e3c90 = DAT_1404e3c90 + 1;
      DAT_1404e41b8 = (ulonglong)DAT_1404e3c90;
    }
    FUN_140291550();
  }
  uVar2 = DAT_1404e41b8;
  lVar3 = *(longlong *)(param_1 + 8);
  lVar1 = DAT_1404e41b8 * 8;
  if (DAT_1404e41b8 < *(ulonglong *)(lVar3 + 0x18)) {
    lVar5 = *(longlong *)(lVar1 + *(longlong *)(lVar3 + 0x10));
    if (lVar5 != 0) goto LAB_14029d583;
  }
  else {
    lVar5 = 0;
  }
...
LAB_14029d5b8:
  ...
  lVar5 = lVar4;
  if (lVar4 == 0) {
    lVar4 = FUN_14029f9d0(&local_res18,param_1);
    lVar5 = local_res18;
    if (lVar4 == -1) {
