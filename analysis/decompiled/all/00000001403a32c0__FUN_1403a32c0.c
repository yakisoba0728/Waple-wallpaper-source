...
void FUN_1403a32c0(longlong param_1,uint param_2,undefined8 param_3)

{
  ...
  cVar3 = FUN_1403a4c30(lVar7,uVar5,0);
  if (cVar3 == '\0') {
    ...
    if ((uVar2 < uVar5) && ((uVar5 - uVar2 & 0xfffffff) != 0)) {
      func_0x000140421870((ulonglong)uVar2 * 0x10 + *(longlong *)(lVar7 + 8),0,
                          (uVar5 - uVar2) * 0x10);
      return;
    }
    *(uint *)(lVar7 + 4) = uVar5;
