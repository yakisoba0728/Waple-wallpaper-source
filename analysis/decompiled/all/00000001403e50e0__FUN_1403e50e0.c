// Function: FUN_1403e50e0
// Addr: 1403e50e0
// Size: 406 bytes


float FUN_1403e50e0(longlong param_1,uint param_2,float param_3,longlong param_4,longlong param_5)

{
  ...
  fVar10 = ((float)(int)((((uint)*pbVar3 * 0x100 + (uint)pbVar3[1]) * 0x100 + (uint)pbVar3[2]) *
                         0x100 + (uint)pbVar3[3]) + 0.0) * DAT_1404925f0;
  ...
  fVar12 = ((float)(int)((((uint)*pbVar9 * 0x100 + (uint)pbVar9[1]) * 0x100 + (uint)pbVar9[2]) *
                         0x100 + (uint)pbVar9[3]) + 0.0) * DAT_1404925f0;
  sVar7 = sVar8;
  fVar11 = fVar10;
  if (fVar12 < fVar10) {
    sVar7 = sVar6;
  ...
  if (fVar11 == fVar12) {
    return (float)(iVar1 + iVar2) * DAT_1404926c0;
  }
