// Function: FUN_140309d80
// Addr: 140309d80
// Size: 539 bytes


void FUN_140309d80(longlong param_1,ushort *param_2)

{
  ...
  if ((param_2[6] < *(ushort *)(param_1 + 0x40)) && (param_2[8] < *(ushort *)(param_1 + 0x40))) {
    if ((param_2[2] < *(ushort *)(param_1 + 0x78)) &&
      ...
      iVar10 = FUN_1402f2180(iVar9,iVar17,0x40);
      iVar11 = -iVar19;
      iVar12 = FUN_1402f2180(iVar8,iVar11,0x40);
      iVar12 = iVar12 + iVar10;
      iVar19 = FUN_1402f2180(iVar9,iVar19,0x40);
      iVar13 = FUN_1402f2180(iVar8,iVar17,0x40);
      ...
      if (iVar10 < iVar19 * 0x13) {
        iVar14 = FUN_1402f2180(iVar14 - iVar16,iVar11,0x40);
        iVar15 = FUN_1402f2180(iVar15 - iVar6,iVar17,0x40);
        iVar16 = FUN_1402f2180(iVar14 + iVar15,iVar8,iVar12);
        iVar14 = FUN_1402f2180(iVar14 + iVar15,iVar9,iVar12);
