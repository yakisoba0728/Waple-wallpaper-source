// Function: FUN_1400b8d20
// Addr: 1400b8d20
// Size: 529 bytes


char * FUN_1400b8d20(longlong param_1,longlong *param_2)
...
joined_r0x0001400b8ebe:
    ...
    if (iVar9 == 1) goto LAB_1400b8db4;
    if (iVar9 == 2) goto joined_r0x0001400b8dde;
    if (iVar9 == 3) goto LAB_1400b8e89;
    if (iVar9 == 4) goto joined_r0x0001400b8ebe;
  }
  iVar6 = 0;
  if (bVar2) {
    iVar6 = iVar9;
