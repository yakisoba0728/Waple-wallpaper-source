...
void FUN_1404b6a80(byte *param_1,byte *param_2)

{
  ...
  *in_RAX = *in_RAX + (byte)param_1;
  in_RAX[in_FS_OFFSET] = in_RAX[in_FS_OFFSET] + (byte)in_RAX + CARRY1(bVar11,(byte)param_1);
  param_1[-0x6691ffe5] = param_1[-0x6691ffe5] ^ unaff_BL;
  uVar4 = (int)in_RAX - *(int *)in_RAX;
