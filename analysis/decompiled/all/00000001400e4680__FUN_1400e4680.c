// Function: FUN_1400e4680
// Addr: 1400e4680
// Size: 11 bytes


void FUN_1400e4680(longlong param_1)

{
  ...
  for (lVar7 = *(longlong *)(param_1 + 0x18); lVar7 != lVar1; lVar7 = lVar7 + 0x28) {
    FUN_1400de2b0(lVar7);
  }
  uVar6 = *(ulonglong *)(param_1 + 8);
  uVar5 = uVar6;
  if (0xfff < (ulonglong)(*(longlong *)(param_1 + 0x10) * 0x28)) {
