// Function: FUN_1403a78d0
// Addr: 1403a78d0
// Size: 1451 bytes


undefined8 FUN_1403a78d0(byte *param_1,longlong param_2)

{
  ...
  if (uVar22 != 0) {
    if (uVar22 == 1) {
      FUN_1403f7f90(param_2,(uint)param_1[1] + (uint)*param_1 * 0x100);
      return 1;
    }
    if (uVar22 < 0x41) {
      pbVar19 = param_1 + 4;
      ...
      *(code **)(param_2 + 0x28) = FUN_1403ec2a0;
...
LAB_1403a7e14:
        ...
        **(uint **)(param_2 + 0x148) = uVar17;
        func_0x0001403eaa90(param_2,uVar22,iVar23 + 1,(uint)param_1[1] + (uint)*param_1 * 0x100,
                            uVar16 + iVar14);
        return 1;
      }
LAB_1403a79f0:
              ...
              if ((uVar16 & 0x10) == 0) {
                ...
                do {
                  if ((*(ulonglong *)(puVar12[2] + (ulonglong)(uVar16 >> 0x10) * 0x18 + uVar11 * 8)
                       >> (*puVar1 >> ((byte)(&DAT_14045c498)[uVar11] & 0x1f) & 0x3f) & 1) == 0)
                  goto LAB_1403a7ad1;
                  uVar10 = (int)uVar11 + 1;
                ...
                cVar9 = FUN_1403ebff0(puVar12,uVar16 >> 0x10,*puVar1);
                if (cVar9 == '\0') {
LAB_1403a7ad1:
                  bVar25 = false;
                }
...
LAB_1403a7bb6:
  ...
  if (*(uint *)(param_2 + 0x144) < uVar16) {
    ...
    FUN_1403a4650(param_2 + 0x140,uVar16,0);
  }
  *(undefined4 *)(*(longlong *)(param_2 + 0x148) + (ulonglong)uVar17 * 4) =
  ...
  if ((bVar7 == 0) || (bVar24 == 0)) {
    if ((bVar8 != 0) && ((bVar21 != 0 && (bVar8 != bVar7)))) goto LAB_1403a7e49;
  }
    ...
    if (iVar23 == 0) {
      ...
      if (*(uint *)(lVar6 + 100) != 0) {
        while( true ) {
          ...
          if (bVar4 >> 5 != bVar7) goto LAB_1403a7e49;
          bVar8 = 0;
          if ((bVar4 & 0x10) == 0) {
            bVar8 = bVar4 & 0xf;
          }
          if (bVar8 == 0) break;
          if (uVar17 == 0) goto LAB_1403a7e49;
        }
        uVar5 = (ushort)puVar1[3];
        uVar17 = *(uint *)(param_2 + 0x18);
        if ((uVar5 & uVar17 & 0xe) == 0) {
          if ((uVar5 & 8) == 0) goto LAB_1403a7e49;
          if ((uVar17 & 0x10) == 0) {
            if ((uVar17 & 0xff00) == 0) goto LAB_1403a7e49;
            ...
            do {
              if ((*(ulonglong *)(puVar12[2] + (ulonglong)(uVar17 >> 0x10) * 0x18 + uVar11 * 8) >>
                   (uVar10 >> ((byte)(&DAT_14045c498)[uVar11] & 0x1f) & 0x3f) & 1) == 0)
              goto LAB_1403a7d73;
              uVar18 = (int)uVar11 + 1;
            ...
            cVar9 = FUN_1403ebff0(puVar12,uVar17 >> 0x10,uVar10);
            if (cVar9 == '\0') {
LAB_1403a7d73:
              bVar25 = false;
            }
    ...
    else if (iVar23 != 1) goto LAB_1403a7dc9;
LAB_1403a7e49:
    lVar6 = *(longlong *)(param_2 + 0xa0);
...
LAB_1403a7dc9:
  ...
  uVar17 = uVar16;
  local_54 = iVar14;
  if (uVar22 <= uVar16) goto LAB_1403a7e14;
  goto LAB_1403a79f0;
}
