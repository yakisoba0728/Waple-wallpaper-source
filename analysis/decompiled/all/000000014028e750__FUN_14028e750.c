...
undefined1 (*) [16]
FUN_14028e750(undefined1 (*param_1) [16],undefined1 (*param_2) [16],undefined1 (*param_3) [16],
             ulonglong param_4)
    ...
    if (param_4 == 1) {
      ...
      if (param_4 <= uVar4) {
        if ((((byte)DAT_1404dc00c & 4) == 0) || (uVar4 < 0x10)) {
          ...
          uVar7 = (uint)param_4;
          uVar8 = 0x10 < uVar7;
          FUN_1404210f0(local_58,param_3,param_4);
          auVar1 = local_58;
          do {
            iVar3 = pcmpestri(local_58,*param_1,0xc,uVar7,0x10);
            if ((bool)uVar8) {
          ...
          if (lVar5 != 0) {
            FUN_1404210f0(local_58,param_1,lVar5);
            iVar3 = pcmpestri(auVar1,local_58,0xc,uVar7,(int)lVar5);
            if (bVar9) {
