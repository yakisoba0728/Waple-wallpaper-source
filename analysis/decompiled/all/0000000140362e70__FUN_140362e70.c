// Function: FUN_140362e70
// Addr: 140362e70
// Size: 238 bytes


uint * FUN_140362e70(uint *param_1,uint *param_2)

{
  ...
  while( true ) {
    ...
    uVar5 = (uVar5 >> 8 & 0xff) * 0x10000 + (uVar5 >> 0x10 & 0xff) * 0x100 + uVar5 * 0x1000000 +
            (uVar5 >> 0x18);
    if ((int)((uint)(uVar5 < uVar8) - (uint)(uVar8 < uVar5)) < 0) break;
    uVar5 = puVar6[-4];
    uVar5 = (uVar5 >> 8 & 0xff) * 0x10000 + (uVar5 >> 0x10 & 0xff) * 0x100 + uVar5 * 0x1000000 +
            (uVar5 >> 0x18);
  ...
  FUN_1404211c0(param_1 + 4,param_1,(longlong)puVar6 - (longlong)param_1);
}
