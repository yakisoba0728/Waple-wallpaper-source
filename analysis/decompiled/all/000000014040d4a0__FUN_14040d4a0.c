// Function: FUN_14040d4a0
// Addr: 14040d4a0
// Size: 727 bytes


void FUN_14040d4a0(longlong *param_1,longlong param_2,undefined8 param_3,longlong param_4)
  ...
  if (((uint)*(byte *)(param_4 + 4) * 0x100 + (uint)*(byte *)(param_4 + 5) != 0xffff) &&
    ...
    if (2 < (uint)(0xffffffff / (ulonglong)uVar2)) {
      pbVar11 = (byte *)(param_1[2] +
                        ...
                        0xfffffffffffffffe));
      cVar5 = FUN_14036f0c0(*param_1 + 0x28,pbVar11,uVar2 * 2,uVar9);
      if (cVar5 != '\0') {
        bVar10 = 0;
