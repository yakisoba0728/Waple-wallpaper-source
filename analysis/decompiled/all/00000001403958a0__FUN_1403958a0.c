// Function: FUN_1403958a0
// Addr: 1403958a0
// Size: 32 bytes


undefined4 * FUN_1403958a0(undefined4 *param_1,int *param_2)

{
  ...
  *param_1 = 0;
  ...
  FUN_1402fc440("SANITIZE",lVar1,0,1,0,1,"start [%p..%p] (%lu bytes)",lVar1,lVar5,uVar4);
}
