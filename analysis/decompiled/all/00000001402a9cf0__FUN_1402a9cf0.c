// Function: FUN_1402a9cf0
// Addr: 1402a9cf0
// Size: 249 bytes


longlong * FUN_1402a9cf0(longlong *param_1,ulonglong param_2,undefined2 param_3)

{
  ...
  if (uVar3 - lVar2 < param_2) {
    plVar5 = (longlong *)FUN_14029caf0(param_1,param_2,local_res8,param_2,param_3);
    return plVar5;
  }
  lVar1 = lVar2 + param_2;
  if (((lVar2 != lVar1) && (7 < uVar3)) && (DAT_140472230 != '\0')) {
    lVar4 = *param_1;
