// Function: FUN_1403bd190
// Addr: 1403bd190
// Size: 682 bytes


ulonglong FUN_1403bd190(longlong param_1,char param_2,undefined4 param_3)

{
  ...
  if ((param_2 == '\0') || (iVar5 == 0)) {
    uVar6 = FUN_1403bd190(param_1,param_2,local_res8[0]);
    if ((int)uVar6 != 0) {
      if (local_res20[0] != 0) {
        *(undefined4 *)
        ...
        FUN_14039ee40(*(longlong *)(lVar1 + 0x78) + uVar7 * 0x14,lVar1);
    ...
    *(undefined4 *)(*(longlong *)(lVar1 + 0x70) + 0xc + (ulonglong)*(uint *)(lVar1 + 0x5c) * 0x14) =
         local_34[0];
    FUN_1403ed4d0(lVar1,local_res8[0]);
    uVar6 = (ulonglong)(*(int *)(lVar1 + 100) - 1);
    if (*(int *)(lVar1 + 100) == 0) {
      uVar6 = uVar8;
    }
    FUN_14039ee40(*(longlong *)(lVar1 + 0x78) + uVar6 * 0x14,lVar1);
    if (local_res20[0] == 0) {
      return 1;
    }
    *(undefined4 *)(*(longlong *)(lVar1 + 0x70) + 0xc + (ulonglong)*(uint *)(lVar1 + 0x5c) * 0x14) =
