// Function: FUN_140136840
// Addr: 140136840
// Size: 599 bytes


longlong * FUN_140136840(float *param_1,longlong *param_2,undefined8 *param_3)

{
  ...
  plVar3 = (longlong *)FUN_14028af20(0x48);
  ...
  *(longlong **)(local_28 + 8) = plVar3;
  ...
  if (lVar2 == *(longlong *)(param_1 + 2)) {
    *(longlong **)(lVar6 + uVar9 * 0x10) = plVar3;
    ...
    if (*(longlong **)(lVar6 + 8 + uVar9 * 0x10) != plVar4) goto LAB_140136a6d;
  }
