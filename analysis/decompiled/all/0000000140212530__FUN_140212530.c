// Function: FUN_140212530
// Addr: 140212530
// Size: 211 bytes


void FUN_140212530(longlong param_1,longlong param_2,char *param_3)

{
  ...
  puVar3 = DAT_1404e97e0;
  puVar2 = DAT_1404e97d8;
  if (param_3 != (char *)0x0) {
    iVar1 = *(int *)(param_2 + 4);
    for (puVar7 = DAT_1404e97d8; puVar7 != puVar3; puVar7 = puVar7 + 5) {
...
LAB_1402125bf:
  ...
  if (*(code **)(param_2 + 0x28) != (code *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x0001402125f2. Too many branches */
