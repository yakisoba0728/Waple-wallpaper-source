// Function: FUN_140370930
// Addr: 140370930
// Size: 161 bytes


void FUN_140370930(longlong param_1,char *param_2,longlong param_3)

{
  ...
  uVar2 = FUN_1403cbf00(pbVar1);
  uVar7 = 0;
  if (uVar2 != 0) {
    do {
      uVar3 = FUN_1403cbf00(pbVar1);
      if (uVar7 < uVar3) {
      ...
      if ((uVar3 != 0xffff) &&
        ...
        do {
          ...
          if (((*(ulonglong *)(param_3 + 8 + (ulonglong)(uVar6 >> 6 & 7) * 8) >> (uVar6 & 0x3f) & 1)
            ...
            param_2[6] = -1;
            param_2[7] = -1;
            puVar4 = (undefined4 *)FUN_1403ed630(param_2,uVar3,1);
