// Function: FUN_140050600
// Addr: 140050600
// Size: 181 bytes


void FUN_140050600(undefined8 *param_1,undefined8 *param_2,undefined8 *param_3)

{
  ...
  cVar9 = FUN_14004fb70(param_1,param_2,param_1);
  ...
  cVar9 = FUN_14004fb70(uVar10,param_3,param_2);
  if (cVar9 != '\0') {
    ...
    cVar9 = FUN_14004fb70(uVar10,param_2,param_1);
    if ((cVar9 != '\0') && (param_2 != param_1)) {
      uVar4 = param_1[1];
      uVar5 = *param_2;
      uVar6 = param_2[1];
