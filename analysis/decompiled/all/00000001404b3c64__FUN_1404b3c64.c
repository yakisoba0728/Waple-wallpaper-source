// Function: FUN_1404b3c64
// Addr: 1404b3c64
// Size: 1 bytes


void FUN_1404b3c64(char *param_1,char *param_2)

{
  ...
  *(undefined1 *)(unaff_RBP + 0x18) = *(undefined1 *)(unaff_RBP + 0x18);
  ...
  *(byte *)CONCAT62(in_register_00000002,sVar2) =
  ...
  if (*(char *)CONCAT62(in_register_00000002,sVar2) != '\0') {
    pcVar1 = (char *)(unaff_GS_OFFSET +
                     CONCAT62(in_register_00000002,CONCAT11(cVar4,bVar3 * '\x02')));
  ...
  *(byte *)CONCAT62(in_register_00000002,sVar2) =
       *(char *)CONCAT62(in_register_00000002,sVar2) + bVar3;
  pcVar1 = (char *)(unaff_GS_OFFSET +
                   CONCAT62(in_register_00000002,CONCAT11((char)((ushort)sVar2 >> 8),bVar3 * '\x02')
                           ));
  *pcVar1 = (*pcVar1 + bVar3 * -2) - CARRY1(bVar3,bVar3);
  sVar2 = (ushort)(byte)(bVar3 * '\x02') * (ushort)*(byte *)(unaff_RBP + 0x18);
  pcVar1 = (char *)(unaff_RBX + 0x4b + unaff_RDI);
