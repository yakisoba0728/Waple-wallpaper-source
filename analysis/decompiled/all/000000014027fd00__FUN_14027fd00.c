...
BADSPACEBASE *
FUN_14027fd00(longlong param_1,undefined4 param_2,undefined4 param_3,undefined8 param_4,
...

{
  ...
  if ((DAT_1404927d8 < dVar25) && (dVar25 < DAT_140492840)) {
    uVar19 = FUN_14027bb00(param_4,param_5,dVar25);
    dVar9 = DAT_140492848;
    uVar11 = FUN_14027b730(param_1);
    if ((uVar11 & 1) == 0) {
      ...
      dVar26 = dVar26 - DAT_140492828;
      dVar28 = dVar28 - DAT_140492828;
      dVar20 = (double)FUN_14041a5d0();
      iVar14 = (int)dVar20;
      dVar20 = (double)FUN_14041a5d0();
      iVar15 = iVar15 + -1;
      iVar16 = iVar14 + 1;
      ...
      fVar29 = pfVar8[1];
      dVar9 = (dVar9 - (double)CONCAT44((uint)((ulonglong)dVar25 >> 0x20) & _UNK_1404930a4,
                                        SUB84(dVar25,0) & _DAT_1404930a0)) *
              (dVar9 - (double)CONCAT44((uint)((ulonglong)dVar10 >> 0x20) & _UNK_1404930a4,
      ...
      dStack_c8 = *pdVar7 + pdVar7[0x17] * dVar10;
      dStack_c0 = pdVar7[1] + pdVar7[0x18] * dVar25;
      fVar29 = (float)((double)(fVar30 - fVar29) * dVar9 + (double)fVar32);
      dVar25 = (double)FUN_1402810a0(pdVar7 + 6,&dStack_c8,lVar4,iVar16,param_2,param_3,uVar19);
      fVar21 = fVar32;
      if (fVar33 <= fVar32) {
        fVar21 = fVar33;
      }
      ...
      register0x00000020 =
           (BADSPACEBASE *)
           (ulonglong)
           ((double)(float)((uint)(fVar21 - fVar24) & _DAT_140493090) *
            *(double *)(*(longlong *)(param_1 + 0x10) + 200) <
           (double)(float)((uint)(fVar27 - fVar24) & _DAT_140493090));
    }
    else {
