// Function: FUN_140312f00
// Addr: 140312f00
// Size: 244 bytes


longlong FUN_140312f00(longlong param_1)
...
LAB_140312fd0:
        ...
        do {
          if (*(int *)((ulonglong)uVar12 * 0x10 + 0xc + *(longlong *)(param_1 + 0xf8)) ==
              (&DAT_14043b874)[lVar11 * 2 + uVar10 * 6]) {
            if (iVar7 == 0) {
              iVar7 = func_0x0001403139f0(param_1,uVar12);
            }
            puVar8 = &DAT_14043b870;
            if (*(int *)(&DAT_14043b870 + (uVar10 * 3 + lVar11) * 8) == iVar7) {
              local_c8[uVar10] = local_c8[uVar10] + 1;
            }
            if (local_c8[uVar10] == 3) goto code_r0x0001403130ae;
          }
          uVar9 = (int)uVar10 + 1;
  ...
  while( true ) {
    if ((!bVar1) && ((&DAT_14043b874)[(longlong)puVar8 * 6] == 0)) {
      local_c8[(longlong)puVar8] = local_c8[(longlong)puVar8] + 1;
    }
    if ((!bVar2) && ((&DAT_14043b87c)[(longlong)puVar8 * 6] == 0)) {
      local_c8[(longlong)puVar8] = local_c8[(longlong)puVar8] + 1;
    }
    if ((!bVar3) && ((&DAT_14043b884)[(longlong)puVar8 * 6] == 0)) {
      local_c8[(longlong)puVar8] = local_c8[(longlong)puVar8] + 1;
    }
