...
longlong *
FUN_1402ac170(undefined8 param_1,longlong *param_2,longlong *param_3,undefined4 *param_4,
...

{
  ...
  local_3b8 = &local_398;
  uVar4 = FUN_140298e60(local_378,0x300,&local_3a8,&local_388);
...
LAB_1402ac2d4:
  ...
  if ((char)uStack_380 == '\0') {
    if (lVar8 != 0) {
      ...
      if (sVar5 != -1) goto LAB_1402ac322;
    }
    lVar8 = 0;
  }
LAB_1402ac322:
  if (lVar6 == 0) {
    if (lVar8 != 0) goto LAB_1402ac337;
  }
  else if (lVar8 == 0) goto LAB_1402ac337;
  *param_6 = *param_6 | 1;
LAB_1402ac337:
  *param_7 = uVar9;
  *param_2 = local_3a8;
