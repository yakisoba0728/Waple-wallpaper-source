// Function: FUN_1403760a0
// Addr: 1403760a0
// Size: 468 bytes


void FUN_1403760a0(longlong param_1,longlong param_2)

{
  ...
  if (cVar1 == '\0') {
    ...
    func_0x000140385990(&local_1a8,local_198,param_2);
  }
  else if (cVar1 == '\x01') {
    local_1a8 = param_1 + 8;
    lVar2 = *(longlong *)(param_2 + 0x18);
    ...
    func_0x00014037d530(&local_1a8,local_198,param_2);
  }
  else if (cVar1 == '\x02') {
    local_1a8 = param_1 + 8;
    lVar2 = *(longlong *)(param_2 + 0x18);
    ...
    FUN_1403843a0(&local_1a8,local_168,param_2);
  }
  else if (cVar1 == '\x04') {
    FUN_1403a9870(param_1 + 8);
  }
  else if (cVar1 == '\x05') {
    local_1a8 = param_1 + 8;
    lVar2 = *(longlong *)(param_2 + 0x18);
    ...
    FUN_14037f510(&local_1a8,local_198,param_2);
  }
