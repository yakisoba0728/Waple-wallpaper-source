// Function: FUN_1401b7a50
// Addr: 1401b7a50
// Size: 603 bytes


void FUN_1401b7a50(longlong *param_1)
            ...
            *local_res18 = (longlong)plVar8;
            while (plVar10 != plVar2) {
              ...
              while( true ) {
                ...
                thunk_FUN_14028af80(plVar8,0x28);
                *(longlong *)(lVar1 + 0x10) = *(longlong *)(lVar1 + 0x10) + -1;
                if (plVar8 == plVar3) break;
                plVar8 = plVar10;
                if (plVar10 == plVar2) goto LAB_1401b7b58;
              }
              *plVar11 = (longlong)plVar2;
...
LAB_1401b7b5c:
      ...
      *(undefined8 *)plVar2[1] = 0;
      ...
      while (puVar6 != (undefined8 *)0x0) {
        ...
        thunk_FUN_14028af80(puVar6,0x28);
        puVar6 = puVar5;
      }
