...
ulonglong FUN_140122870(longlong *param_1,longlong *param_2)

{
  ...
  uVar6 = (**(code **)(*param_2 + 0x38))(param_2,&DAT_14042c3a0,local_res10);
  ...
  if (-1 < (int)uVar6) {
    if (local_res10[0] == 100) {
      ...
      if (param_1[0x11] != 0) {
        (*pcRam00000001404e3a80)(param_1[0x11],&UNK_14042c440,&UNK_14048a030,plVar2);
      }
      plVar1 = (longlong *)*plVar2;
      if (plVar1 != (longlong *)0x0) {
        (**(code **)(*plVar1 + 0x18))(plVar1,(longlong)param_1 + 0x24,0);
        cVar3 = FUN_140015250(6,2,0);
        if ((cVar3 != '\0') &&
           (iVar4 = (**(code **)(*(longlong *)*plVar2 + 0x80))((longlong *)*plVar2,auStackX_18),
           -1 < iVar4)) {
          (**(code **)(*(longlong *)*plVar2 + 0x78))((longlong *)*plVar2,auStackX_18[0] | 0x102);
        }
      }
      ...
      *(undefined4 *)((longlong)param_1 + 0xe4) = 0xbf800000;
      ...
      if (plVar2 != (longlong *)0x0) {
        uVar5 = (**(code **)(*plVar2 + 0x48))(plVar2,0,&uStack_28);
      ...
      *(undefined4 *)(param_1 + 6) = 0x3f800000;
      ...
      if ((local_res10[0] == 400) && ((int)param_1[0x18] == 2)) {
        ...
        *(undefined4 *)(param_1 + 0x16) = 4;
        ...
        uStack_20 = 0;
        uStack_28 = 0x14;
        (**(code **)(*(longlong *)param_1[0x11] + 0x48))((longlong *)param_1[0x11],0,&uStack_28);
        *(undefined4 *)(param_1 + 0x16) = 3;
        (*_UNK_140426b88)(&uStack_28);
        return uVar7;
      }
