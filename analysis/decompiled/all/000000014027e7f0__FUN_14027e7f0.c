...
ulonglong FUN_14027e7f0(double *param_1,float param_2,undefined8 param_3,float *param_4,
...

{
  ...
  uVar7 = FUN_140285390(local_e0,(double)((param_9 - param_8) + param_7),
                        (double)((param_8 - param_7) - param_7),(double)param_7);
  fVar5 = DAT_1404926c0;
  uVar8 = 0;
  uVar9 = uVar7 & 0xffffffff;
  dVar13 = DAT_140492778;
  if (0 < (int)uVar7) {
    do {
      dVar1 = local_e0[uVar8];
      if ((DAT_140492708 < dVar1) && (dVar1 < DAT_140492770)) {
...
LAB_14027ea13:
          dVar16 = (dVar1 - _DAT_1404925c8) * *param_1;
          ...
          if (*(char *)(param_1 + 1) == '\0') {
            ...
            if (fVar12 != fVar18) goto LAB_14027ea13;
          }
          uVar7 = 0;
        }
LAB_14027ea8e:
        if ((_DAT_1404925c8 < param_10) && (dVar13 = DAT_140492778, param_10 < DAT_140492778)) {
          local_118[0] = _DAT_140492ef0;
          local_118[1] = (double)_UNK_140492ef8;
          ...
          uVar6 = FUN_14027b660(param_1,local_118[0],local_118[1],dVar1,local_128[0],local_128[1],
                                fVar18);
          uVar7 = (ulonglong)(uVar6 | (uint)uVar7);
          dVar13 = DAT_140492778;
        }
        if ((_DAT_1404925c8 < param_11) && (dVar13 = DAT_140492778, param_11 < DAT_140492778)) {
          local_118[0] = _DAT_140492ef0;
          local_118[1] = (double)_UNK_140492ef8;
