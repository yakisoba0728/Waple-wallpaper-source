...
longlong *
FUN_1402ab800(undefined8 param_1,longlong *param_2,longlong *param_3,longlong *param_4,
...

{
  ...
  local_98 = &local_78;
  uVar1 = FUN_14029ba50(&local_68,param_3,param_4,*(undefined4 *)(param_5 + 0x18));
  ...
  if (*param_3 == 0) {
    if (*param_4 != 0) goto LAB_1402ab97b;
  }
  else if (*param_4 == 0) goto LAB_1402ab97b;
  *param_6 = *param_6 | 1;
LAB_1402ab97b:
  lVar3 = param_3[1];
  *param_2 = *param_3;
