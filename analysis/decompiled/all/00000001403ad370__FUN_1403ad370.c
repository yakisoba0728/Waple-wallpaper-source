// Function: FUN_1403ad370
// Addr: 1403ad370
// Size: 263 bytes


undefined8 FUN_1403ad370(longlong param_1,longlong param_2)

{
  ...
  if (iVar4 == 1) {
    uVar2 = FUN_1403c70f0(pbVar3,*(undefined4 *)
                                  (*(longlong *)(lVar1 + 0x70) +
  ...
  if ((uVar2 != 0xffffffff) &&
    ...
    FUN_1403b0c80(param_1 + 4,param_2,param_1,
                  param_1 + ((ulonglong)
                             (((uint)(byte)(&DAT_140470560)[*(byte *)(param_1 + 5) >> 4] +
                              (uint)(byte)(&DAT_140470560)[*(byte *)(param_1 + 5) & 0xf]) * uVar2) +
                            4) * 2,
