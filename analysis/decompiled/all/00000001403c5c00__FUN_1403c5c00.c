// Function: FUN_1403c5c00
// Addr: 1403c5c00
// Size: 580 bytes


ulonglong * FUN_1403c5c00(undefined8 *param_1,ulonglong param_2)
    ...
    while( true ) {
      ...
      if (uVar18 != 0) {
        do {
          ...
          FUN_140377740(pbVar7,local_res8,local_68,(uint)bVar2 * 0x100 + (uint)bVar1);
          uVar15 = uVar15 + 1;
        } while (uVar15 < uVar18);
      }
      lVar3 = local_res18;
