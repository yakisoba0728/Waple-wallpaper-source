// Function: FUN_1402bc420
// Addr: 1402bc420
// Size: 473 bytes


ulonglong FUN_1402bc420(longlong param_1,longlong *param_2,uint *param_3,byte *param_4)

{
  ...
  uVar1 = param_3[1];
  if ((uVar1 != 0) && (lVar3 = FUN_1402bb550(), lVar3 + (int)uVar1 != 0)) {
    uVar1 = param_3[1];
    if (uVar1 == 0) {
      lVar3 = 0;
    }
    ...
    if ((*(char *)(lVar3 + 0x10) != '\0') && ((param_3[2] != 0 || ((int)*param_3 < 0)))) {
      ...
      if ((((char)uVar1 < '\0') && ((*param_4 & 0x10) != 0)) && (DAT_1404e4358 != 0)) {
        ...
        *param_2 = lVar3;
        ...
        if ((*param_4 & 1) == 0) {
          ...
          if (uVar5 == 0) {
            ...
            FUN_1404210f0(param_2,uVar4,(longlong)iVar2);
          }
          else {
            if (((lVar3 == 0) || (param_2 == (longlong *)0x0)) ||
