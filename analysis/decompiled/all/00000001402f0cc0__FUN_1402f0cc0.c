// Function: FUN_1402f0cc0
// Addr: 1402f0cc0
// Size: 355 bytes


int FUN_1402f0cc0(longlong *param_1,int param_2)
...
LAB_1402f0d8a:
    ...
    if ((int)uVar1 < (int)uVar4) {
      FUN_1404217a0((int)(uVar1 << 5) + lVar3,0,(longlong)(int)((uVar4 - uVar1) * 0x20));
    }
  }
  param_1[0xb] = lVar3;
  if (iVar5 != 0) {
