// Function: FUN_1400b18a0
// Addr: 1400b18a0
// Size: 319 bytes


char * FUN_1400b18a0(int *param_1,longlong param_2,longlong param_3,undefined4 *param_4)

{
  ...
  if ((param_1[0xb] == 0) || (param_1[0xb] == 1)) {
    ...
    uStack_10 = param_4[2];
    uStack_c = param_4[3];
    pcVar1 = (char *)FUN_1400b19e0(param_1,param_2,param_3,&local_18);
    ...
    if (*pcVar1 != '$') goto LAB_1400b19b1;
    iVar2 = 1;
    param_1[0xb] = 1;
    if (*pcVar1 != '$') goto LAB_1400b19a7;
  }
  else {
    param_1[0xb] = 0;
    pcVar1 = (char *)0x0;
