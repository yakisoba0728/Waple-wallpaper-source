// Function: FUN_140132dc0
// Addr: 140132dc0
// Size: 1307 bytes


void FUN_140132dc0(int *param_1,int *param_2,longlong param_3)
    ...
    if (lVar4 >> 2 < 0x21) {
      if (param_1 != param_2) {
        for (piVar10 = param_1 + 1; piVar10 != param_2; piVar10 = piVar10 + 1) {
          iVar1 = *piVar10;
          if (iVar1 < *param_1) {
            FUN_1404210f0(param_1 + 1,param_1,(longlong)piVar10 - (longlong)param_1);
            *param_1 = iVar1;
          }
          else {
            iVar2 = piVar10[-1];
...
joined_r0x000140132f88:
    if (piVar9 < param_2) {
      iVar1 = *piVar9;
      if (iVar1 <= *piVar8) {
        if (iVar1 < *piVar8) goto joined_r0x000140132fb3;
        if (piVar10 != piVar9) {
          iVar2 = *piVar10;
          *piVar10 = iVar1;
          *piVar9 = iVar2;
      ...
      piVar9 = piVar9 + 1;
      goto joined_r0x000140132f88;
    }
joined_r0x000140132fb3:
    ...
    if ((longlong)piVar8 - (longlong)param_1 >> 2 < (longlong)param_2 - (longlong)piVar10 >> 2) {
      FUN_140132dc0(param_1,piVar8,param_3);
      piVar8 = param_2;
      param_1 = piVar10;
    }
    else {
      FUN_140132dc0(piVar10,param_2,param_3);
    }
