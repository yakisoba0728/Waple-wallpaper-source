// Function: FUN_1400ce830
// Addr: 1400ce830
// Size: 871 bytes


void FUN_1400ce830(longlong param_1)

{
  ...
  lVar6 = func_0x0001400ce440(local_118,param_1 + 0x10);
      ...
      *(undefined8 *)(lVar6 + 200) = uVar7;
      ...
      if (cVar4 == '\0') {
        ...
        *(undefined1 *)(lVar6 + 0xc4) = 1;
        FUN_140098830("Native image error.\n");
      }
      lVar9 = *(longlong *)(param_1 + 8);
      iVar5 = func_0x000140290e50(lVar9 + 0x138);
      if (iVar5 != 0) {
UNWIND_INFO_1400cebb7_UnwindCodes_60__UnwindOpCode:
                    /* WARNING: Subroutine does not return */
        FUN_140290e00(5);
      }
      if (*(int *)(lVar9 + 0x184) == 0x7fffffff) {
UNWIND_INFO_1400cebb7_UnwindCodes_50__OffsetInProlog:
      ...
      FUN_1400ca850(lVar8 + 0x188,local_res8);
      FUN_140290f70(lVar9 + 0x138);
    }
  }
  else {
    uVar7 = func_0x0001400c9810();
    *(undefined8 *)(lVar6 + 200) = uVar7;
    *(undefined4 *)(lVar6 + 0x48) = 0x40000000;
    iVar5 = FUN_14014c230(*(undefined8 *)(lVar6 + 8),uVar7,*(undefined4 *)(lVar6 + 0x10),
                          *(undefined4 *)(lVar6 + 0xd0));
    if (iVar5 < 0) {
      *(undefined4 *)(lVar6 + 0x48) = 0;
      *(undefined1 *)(lVar6 + 0xc4) = 1;
      FUN_140098830("LZ4 error.\n");
    }
  }
  if ((*(longlong *)(lVar6 + 0x68) != *(longlong *)(lVar6 + 0x70)) &&
    ...
    if ((*(uint *)(lVar6 + 0x48) & 0x40000000) == 0) {
      ...
      *(undefined8 *)(lVar6 + 200) = uVar7;
                    /* WARNING: Subroutine does not return */
      FUN_1404211c0(uVar7,lVar9,*(undefined4 *)(lVar6 + 0xd0));
    }
    ...
    if (pbVar11 != pbVar12) {
      do {
             ...
             (lVar8 = *(longlong *)(pbVar11 + 8), lVar8 != 0)) && (*(int *)(pbVar11 + 0x10) != 0))))
        {
          ...
          if (*(char *)(lVar6 + 0x60) == '\0') {
            if (*(int *)(lVar6 + 0x5c) != -1) {
              lVar9 = func_0x0001400c9810(uVar10,iVar5);
              cVar4 = (**(code **)**(undefined8 **)(param_1 + 8))
              ...
              if (iVar5 == 0) {
                if (*(int *)(lVar9 + 0x184) != 0x7fffffff) {
                  ...
                  local_res8[0] = func_0x000140291210();
                  FUN_1400ca850(lVar2 + 0x188,local_res8);
                  FUN_140290f70(lVar9 + 0x138);
                  pbVar12 = local_res10;
                  goto LAB_1400ceb50;
                }
                goto UNWIND_INFO_1400cebb7_UnwindCodes_50__OffsetInProlog;
              }
              goto UNWIND_INFO_1400cebb7_UnwindCodes_60__UnwindOpCode;
            }
            bVar13 = false;
LAB_1400ceb5a:
            FUN_14015c550(*(undefined4 *)(lVar6 + 0x58),pbVar11,lVar8,*(undefined8 *)(lVar6 + 200),
                          *(undefined4 *)(lVar6 + 0x4c));
          }
          else {
            bVar13 = true;
            lVar8 = func_0x0001400c9810(uVar10,iVar5);
            iVar5 = FUN_14014c230(*(undefined8 *)(pbVar11 + 8),lVar8,*(undefined4 *)(pbVar11 + 0x10)
                                  ,iVar5);
            if (iVar5 < 0) goto LAB_1400ceb86;
LAB_1400ceb50:
            if (lVar8 != 0) goto LAB_1400ceb5a;
          }
          if (bVar13) {
            FUN_1400ca290();
          }
...
LAB_1400ceb86:
  ...
  FUN_1400cb060(lVar6 + 0x68);
                    /* WARNING: Subroutine does not return */
  FUN_140017310(lVar6 + 0x18);
}
