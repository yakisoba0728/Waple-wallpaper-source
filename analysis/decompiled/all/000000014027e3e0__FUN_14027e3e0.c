...
undefined1 FUN_14027e3e0(undefined8 param_1,float param_2)

{
  ...
  if (((float)((uint)(fVar4 - DAT_1404926c0) & _DAT_140492fc0) <=
     ...
     (((cVar1 = FUN_1402801b0(), cVar1 != '\0' || (cVar1 = FUN_1402801b0(param_1), cVar1 != '\0'))
      || (cVar1 = FUN_1402801b0(param_1), uVar2 = 0, cVar1 != '\0')))) {
    uVar2 = 1;
  }
  return uVar2;
}
