...
void FUN_140141a80(longlong param_1,undefined1 (*param_2) [16])

{
  ...
  if ((DAT_1404dc008 < 2) ||
    ...
    local_148 = pshufb(*param_2,_DAT_140492d50);
    local_128 = pshufb(param_2[2],_DAT_140492d50);
    local_138 = pshufb(param_2[1],_DAT_140492d50);
    auVar50 = pshufb(param_2[3],_DAT_140492d50);
