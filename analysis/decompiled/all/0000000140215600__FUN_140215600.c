...
void FUN_140215600(longlong param_1,longlong param_2)

{
  ...
  uStack_10 = 0x140215615;
  lVar2 = param_2 - param_1 >> 3;
  if (lVar2 < 0x21) {
    FUN_1402174d0(param_1,param_2,&LAB_140268b60);
  }
  else {
      ...
      if ((uVar4 < 0x2000000000000000) && (0 < (longlong)uVar4)) {
        do {
          ...
          if (puVar1 != (undefined1 *)0x0) {
            if (0x200 < uVar4) goto LAB_1402156c2;
            goto LAB_1402156b0;
          }
          uVar4 = uVar4 >> 1;
        } while (uVar4 != 0);
...
LAB_1402156b0:
    ...
    puVar1 = local_1008;
LAB_1402156c2:
    FUN_1402175c0(param_1,param_2,lVar2,puVar1,uVar4,&LAB_140268b60);
    if (0x200 < uVar4) {
      FUN_14028af80(puVar1);
    }
  }
