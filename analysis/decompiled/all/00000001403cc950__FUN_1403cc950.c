...
void FUN_1403cc950(undefined8 param_1,undefined8 *param_2,longlong *param_3,undefined4 param_4,
...

{
  ...
  local_e0 = DAT_1404dc110 ^ (ulonglong)auStack_3a8;
  local_328 = param_5;
  local_268 = param_6;
  local_2d8 = param_8;
  ...
  local_278 = pbVar28;
  local_270 = param_2;
  puVar13 = (undefined8 *)FUN_140398450(*(longlong *)(*param_3 + 0x20) + 0x128);
  puVar31 = &DAT_14045dde0;
  ...
  if (iVar27 != (int)pbVar25) {
    ...
    if (bVar1 < 0x80) {
      ...
      if ((uint)(iVar27 - (int)pbVar25) < (uint)uVar15) goto LAB_1403cde7d;
      uVar19 = (uint)bVar1;
      if (bVar1 < 0xc0) {
        uVar19 = uVar19 & 0x3f;
        bVar1 = pbVar25[1];
...
LAB_1403ccb9a:
      local_368 = '\x01';
      if ((char)uVar19 < '\0') {
        if (iVar27 == (int)pbVar25) goto LAB_1403cde7d;
        bVar1 = *pbVar25;
        if (bVar1 < 0x80) {
          uVar15 = 1;
        }
        ...
        if (uVar20 == 0) {
          pbVar22 = (byte *)&DAT_14045dde0;
        }
        else {
          pbVar22 = (byte *)((ulonglong)uVar20 + (longlong)puVar13);
        }
        if (uVar11 < (uint)pbVar22[1] * 0x10000 + (uint)pbVar22[2] * 0x100 +
                     (uint)*pbVar22 * 0x1000000 + (uint)pbVar22[3]) {
          pbVar26 = pbVar22 + ((ulonglong)uVar11 + 1) * 4;
        }
        else {
          pbVar26 = (byte *)&DAT_14045dde0;
        }
        ...
        local_238 = local_2d8;
        local_368 = func_0x000140386740(pbVar22,local_328[1],*(undefined4 *)(local_328 + 2),
                                        &local_260);
      }
      cVar10 = local_368;
      ...
      *(undefined4 *)(lVar2 + 0x14) = 0;
      ...
      if ((uVar19 & 2) != 0) {
        ...
        if (bVar1 < 0x80) {
          ...
          if ((uint)(iVar27 - (int)pbVar25) < uVar11) goto LAB_1403cde7d;
        }
        FUN_140397f20(pbVar25);
        ...
        func_0x000140397b10(puVar31,&local_348);
        local_100 = local_340;
        local_f8 = (float *)((longlong)local_340 + (ulonglong)local_338);
        local_f0 = 0;
        local_e8 = 0;
        if (local_340 < local_f8) {
          bVar1 = *(byte *)local_340;
          local_100 = (float *)((longlong)local_340 + 1);
          ...
          if (local_f8 < (float *)((longlong)local_100 + (ulonglong)(local_e8 * local_ec)))
          goto LAB_1403cceff;
          if (local_e8 == 0) {
LAB_1403ccef0:
            local_f0 = 0;
            local_100 = (float *)((longlong)local_100 + (ulonglong)local_e8);
          }
          else if (local_e8 == 1) {
            local_f0 = (int)(char)*(byte *)local_100;
            local_100 = (float *)((longlong)local_340 + 2);
          }
          else if (local_e8 == 2) {
            local_f0 = (int)(short)((ushort)*(byte *)local_100 * 0x100 +
                                   (ushort)*(byte *)((longlong)local_340 + 2));
            local_100 = (float *)((longlong)local_340 + 3);
          }
          else {
            if (local_e8 != 4) goto LAB_1403ccef0;
            local_f0 = (((uint)*(byte *)((longlong)local_340 + 2) + (uint)*(byte *)local_100 * 0x100
                        ) * 0x100 + (uint)*(byte *)((longlong)local_340 + 3)) * 0x100 +
                       (uint)*(byte *)(local_340 + 1);
            local_100 = (float *)((longlong)local_340 + 5);
          }
        }
        else {
LAB_1403cceff:
        ...
        FUN_140386b10(local_290,local_108,0);
        FUN_1403f86a0(lVar2 + 0x10);
        ...
        if (uVar20 != 0) {
          ...
          do {
            ...
            if (uVar18 == 0x80) {
              uVar7 = uVar23;
              if (uVar21 != 0) {
                func_0x000140421870(*(longlong *)(lVar2 + 0x18) + (ulonglong)uVar11 * 4,0,uVar21 * 4
                                   );
                return;
              }
            }
              ...
              if (uVar11 < uVar23) {
                if (3 < uVar23 - uVar11) {
                  ...
                  uVar7 = uVar11;
                  if (uVar23 <= uVar11) goto LAB_1403cd441;
                }
                do {
                  *(float *)(*(longlong *)(lVar2 + 0x18) + (ulonglong)uVar11 * 4) =
                       (float)(int)(short)((ushort)*pbVar25 * 0x100 + (ushort)pbVar25[1]);
...
LAB_1403cd441:
      ...
      if ((uVar19 & 4) != 0) {
        lVar8 = uStack_310;
        lVar9 = uStack_300;
        if (iVar27 == (int)pbVar22) goto LAB_1403cde7d;
        bVar1 = *pbVar22;
        if (bVar1 < 0x80) {
          uVar11 = 1;
        }
          ...
          if ((uint)(iVar27 - (int)pbVar22) < uVar11) goto LAB_1403cde7d;
        }
        uVar12 = FUN_140397f20(pbVar22);
        puVar14 = local_328;
        pbVar22 = pbVar22 + uVar11;
        if (cVar10 != '\0') {
          puVar13 = local_328;
          ...
          if ((*(int *)(puVar13 + 2) != 0) && (-1 < *(int *)(lVar2 + 0x10))) {
            ...
            local_388 = local_2d8;
            FUN_1403c7620(local_2e0,uVar12,&local_2c8,&local_348);
          }
        }
      }
      uVar3 = *puVar14;
      ...
      if ((uVar19 & 8) != 0) {
        ...
        local_2f0 = FUN_140397f20(pbVar22);
        pbVar22 = pbVar22 + uVar11;
      }
      lVar29 = local_290;
      local_318 = _DAT_140492eb0;
      uVar17 = local_318;
      uStack_310 = _UNK_140492eb8;
      lVar8 = uStack_310;
      local_308 = _DAT_140492b30;
      uVar15 = local_308;
      uStack_300 = _UNK_140492b38;
      lVar9 = uStack_300;
      local_2f8 = 0.0;
      local_2ec = uVar19 & 0x10;
      if (local_2ec == 0) {
        local_318._0_4_ = (float)_DAT_140492eb0;
        fVar41 = (float)local_318;
        local_318 = uVar17;
      }
      else {
        if ((uint)(iVar27 - (int)pbVar22) < 2) goto LAB_1403cde7d;
        fVar41 = (float)(int)(short)((ushort)pbVar22[1] + (ushort)*pbVar22 * 0x100);
        local_318._4_4_ = (float)((ulonglong)_DAT_140492eb0 >> 0x20);
      ...
      uStack_310._0_4_ = (float)_UNK_140492eb8;
      ...
      if (local_35c == 0) {
        uStack_310._4_4_ = (float)((ulonglong)_UNK_140492eb8 >> 0x20);
      ...
      local_2a8 = uVar11;
      if (uVar11 == 0) {
        local_308._0_4_ = (float)_DAT_140492b30;
        ...
        local_308._4_4_ = (float)(_DAT_140492b30 >> 0x20);
      ...
      uStack_300._0_4_ = (float)_UNK_140492b38;
      ...
      if (local_29c == 0) {
        uStack_300._4_4_ = (float)((ulonglong)_UNK_140492b38 >> 0x20);
      ...
      for (uVar19 = uVar19 & 0xffff8000; iVar24 = (int)pbVar22, uVar19 != 0;
        ...
        if (iVar27 == iVar24) goto LAB_1403cde7d;
        bVar1 = *pbVar22;
        if (bVar1 < 0x80) {
          uVar15 = 1;
        }
          ...
          if ((uint)(iVar27 - iVar24) < (uint)uVar15) goto LAB_1403cde7d;
        }
        ...
        if (uVar19 != 0) {
          ...
          do {
            if (uVar11 < uVar19) {
              ...
              uVar19 = (uint)DAT_14045dde0;
            }
            if (uVar19 < 0x1000) {
              if (local_218 < 0x41) {
                if (0x3f < uVar19) {
                    /* WARNING: Subroutine does not return */
                  FUN_1403a4650(&local_228,local_224 + local_218,0);
                }
                ...
                uVar20 = local_218;
                if (local_224 <= uVar19) {
                  cVar10 = FUN_1403f86a0(&local_228,uVar19 + 1);
                  uVar20 = uVar19 + 1;
                  if (cVar10 == '\0') {
                    DAT_1404e4ff0._0_4_ = (uint)DAT_14045dde0;
                    pfVar30 = (float *)&DAT_1404e4ff0;
                    goto LAB_1403cda7b;
                  }
                }
                local_218 = uVar20;
...
LAB_1403cda7b:
            if (uVar11 < *(uint *)(lVar2 + 0x14)) {
              ...
              pfVar16 = (float *)&DAT_1404e4ff0;
              DAT_1404e4ff0._0_4_ = (uint)DAT_14045dde0;
            }
            fVar33 = (float)FUN_14041a690(*pfVar16 + fVar4);
        ...
        if (local_2f0 != -1) {
          ...
          if (*(int *)(puVar14 + 2) != 0) {
            ...
            local_2b8 = local_328[2];
            local_388 = local_2d8;
            FUN_1403c7620(local_2e0,local_2f0,&local_2c8,&local_348);
            if (local_2ec != 0) {
        ...
        if (local_354 != 0) {
          fVar38 = fVar38 * DAT_140471b30;
        }
        if (local_35c != 0) {
          fVar35 = fVar35 * DAT_140471b34;
          uStack_310._4_4_ = fVar35;
        }
        if (uVar11 != 0) {
          local_308._0_4_ = fVar37 * DAT_140471b34;
        }
        if (local_360 != 0) {
          fVar36 = fVar36 * DAT_140471b30;
        }
        if (uVar20 != 0) {
          fVar34 = fVar34 * DAT_140471b30;
        }
        if (uVar11 == 0) {
          local_308._0_4_ = fVar35;
        }
        uStack_310 = CONCAT44(uStack_310._4_4_,fVar38 * DAT_140492904);
        local_308 = CONCAT44(fVar36 * DAT_140492904,(float)local_308);
        uStack_300 = CONCAT44(uStack_300._4_4_,fVar34 * DAT_140492904);
        uVar17 = FUN_14040cd80(&local_318,&local_2c8);
        puVar14 = local_268;
        func_0x0001403ecae0(local_268,uVar17,0);
        plVar6 = local_288;
        ...
        *(int *)((longlong)local_288 + 0x34) = *(int *)((longlong)local_288 + 0x34) + -1;
        ...
        local_388 = &local_2c8;
        local_348 = uVar3;
        func_0x0001403cc0f0(local_280,local_288,local_2e4,&local_348);
        *(int *)((longlong)plVar6 + 0x34) = *(int *)((longlong)plVar6 + 0x34) + 1;
        if (1 < local_228 + 1U) {
          local_224 = 0;
          func_0x0001402bf8e0(local_220);
        }
      }
      local_270[1] = pbVar22;
...
LAB_1403cde7d:
  ...
  *local_270 = 0;
  ...
  local_270[2] = 0;
LAB_1403cde8e:
  func_0x0001402ed2f0(local_e0 ^ (ulonglong)auStack_3a8);
  return;
}
