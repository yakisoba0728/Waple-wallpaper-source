// Function: FUN_1400d2c60
// Addr: 1400d2c60
// Size: 1464 bytes


undefined8 *
FUN_1400d2c60(undefined8 *param_1,int param_2,int param_3,int param_4,char *param_5,longlong param_6
             ,undefined4 param_7,int param_8,uint param_9,uint param_10,undefined8 param_11,
             undefined8 param_12,longlong *param_13)

{
  ...
  *puVar18 = 0;
  ...
  param_1[0x11] = 0;
  sVar8 = strlen(_Str);
  FUN_140017480(puVar18,_Str,sVar8);
  uVar6 = 1;
  *(undefined4 *)(param_1 + 0x13) = 1;
  uVar4 = FUN_1400d2a20(uVar5);
  *(uint *)(param_1 + 0x12) = uVar4;
  uVar5 = FUN_1400d2a20(iVar7);
  *(undefined4 *)((longlong)param_1 + 0x94) = uVar5;
  if ((param_10 & 0x20) != 0) {
    iVar17 = *(int *)(param_6 + 0x1a8);
  }
  if ((param_5 == (char *)0x0) || ((iVar17 != 0 && ((param_9 & 0x2000000) == 0)))) {
    bVar15 = 0;
  }
  else {
    bVar15 = (byte)uVar6;
  ...
  if ((uVar3 & 0x10) != 0) {
    ...
    dVar19 = (double)FUN_14041d420((double)((int)(((int)uVar6 >> 0x10 | uVar6) + 1) >> 1));
    uVar6 = *(ushort *)((longlong)param_1 + 0x16) - 1;
    uVar6 = (int)uVar6 >> 1 | uVar6;
    uVar6 = (int)uVar6 >> 2 | uVar6;
    uVar6 = (int)uVar6 >> 4 | uVar6;
    uVar6 = (int)uVar6 >> 8 | uVar6;
    dVar20 = (double)FUN_14041d420((double)((int)(((int)uVar6 >> 0x10 | uVar6) + 1) >> 1));
    uVar16 = 1;
    iVar7 = (int)dVar19;
...
LAB_1400d2f7b:
    local_60 = 0;
    (**(code **)(*plVar11 + 0x28))(plVar11,&local_78,0,&param_5);
  }
  else {
    uVar1 = puVar13[7];
    ...
    param_8 = 0;
    iVar7 = (**(code **)(*plVar11 + 0xf0))(plVar11,uVar4,uVar1 & 0xffffffff,&param_8);
...
LAB_1400d2f9b:
  if (*(int *)((longlong)param_1 + 0x94) != 0) {
    uVar10 = param_1[8];
    uVar9 = FUN_1400d2b20(*(int *)((longlong)param_1 + 0x94),
                          *(undefined2 *)((longlong)param_1 + 0x14),
                          *(undefined2 *)((longlong)param_1 + 0x16),1,iVar17,uVar10,
  ...
  if (((char)param_7 != '\0') || ((param_10 & 6) != 0)) {
    ...
    lVar2 = param_6;
    uVar10 = FUN_1400eb440(uVar10,puVar18,uVar9,iVar17,param_9,
                           CONCAT44(uVar21,*(undefined4 *)(param_1 + 0x13)),param_6,param_11);
    param_1[4] = uVar10;
    if (param_1[0x10] != 0) {
      FUN_14014c8f0(lVar2 + 0x1520,param_1 + 4);
    }
    ...
    *(uint *)(param_1[4] + 0x30) = (uint)*(ushort *)((longlong)param_1 + 0x16);
    ...
    for (puVar13 = (undefined8 *)*puVar18; puVar13 != puVar18; puVar13 = (undefined8 *)*puVar13) {
      plVar11 = (longlong *)puVar13[10];
      param_6 = lVar2;
      if (plVar11 == (longlong *)0x0) {
                    /* WARNING: Subroutine does not return */
        FUN_14028c2c0();
      }
      (**(code **)(*plVar11 + 0x10))(plVar11,&param_6);
    }
  }
  return param_1;
}
