// Function: FUN_14009f8d0
// Addr: 14009f8d0
// Size: 474 bytes


ulonglong FUN_14009f8d0(ulonglong *param_1,ulonglong param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  for (; param_6 != 0; param_6 = param_6 - 1) {
    uVar1 = *param_5;
    uVar3 = *param_1;
    uVar5 = (ulonglong)((uVar1 >> 0x10 & 0xff) * 0x101);
    uVar6 = uVar3 >> 0x30;
    uVar2 = (ulonglong)((uVar1 & 0xff) * 0x101);
    uVar4 = (uVar5 << 0x10 | (ulonglong)((uVar1 >> 8 & 0xff) * 0x101)) << 0x10;
    uVar5 = (uVar5 | ((ulonglong)((uVar1 >> 0x18) * 0x101) & 0xffff) << 0x10) >> 0x10;
    lVar7 = 0xffff - uVar5;
