// Function: FUN_14019f360
// Addr: 14019f360
// Size: 2685 bytes


void FUN_14019f360(byte *param_1,byte *param_2,longlong param_3,undefined1 param_4)

{
  ...
  do {
    if (lVar14 < 0x318) {
      if ((param_1 != pbVar25) && (pbVar18 = param_1 + 0x18, pbVar16 = pbVar18, pbVar18 != pbVar25))
      {
        do {
          ...
          pbVar25 = pbVar16;
          if (bVar26) {
            FUN_1404210f0(pbVar18,param_1,(longlong)pbVar16 - (longlong)param_1);
    ...
    if (param_3 < 1) {
      ...
      do {
        if (1 < ((longlong)pbVar25 - (longlong)param_1 >> 3) * -0x5555555555555555) {
          local_70 = *(undefined8 *)(pbVar25 + -0x18);
          uStack_68 = *(undefined8 *)(pbVar25 + -0x10);
          local_60 = *(undefined8 *)(pbVar25 + -8);
          ...
          *(undefined8 *)(pbVar25 + -8) = *(undefined8 *)(param_1 + 0x10);
          FUN_1401a29e0(param_1,0,
                        ((longlong)(pbVar25 + -0x18) - (longlong)param_1 >> 3) * -0x5555555555555555
                        ,&local_70,param_4);
        }
        pbVar25 = pbVar25 + -0x18;
    ...
    if (lVar21 < 0x29) {
      ...
      FUN_1401a3210(param_1,pbVar15,param_1 + lVar23);
      FUN_1401a3210((longlong)pbVar18 - lVar21,pbVar18,param_1 + (lVar22 + lVar14) * 0x18);
      pbVar16 = pbVar25 + (-0x18 - lVar21);
      FUN_1401a3210(pbVar25 + (-0x18 - lVar23),pbVar16,pbVar25 + -0x18);
    }
    FUN_1401a3210(pbVar15,pbVar18,pbVar16);
      ...
      if ((byte *)0x5f < pbVar25 + (0x17 - (longlong)pbVar16)) {
        do {
          ...
          if (!bVar26) {
            ...
            pbVar19 = pbVar16;
            if (bVar26) goto joined_r0x00014019f809;
            if (pbVar20 != pbVar16) {
...
LAB_14019f8a4:
    ...
    if (((longlong)pbVar18 - (longlong)param_1 >> 3) * -0x5555555555555555 <
      ...
      FUN_14019f360(param_1,pbVar18,param_3,param_4);
      param_1 = pbVar20;
      pbVar18 = pbVar25;
      local_res8 = pbVar20;
      local_res10 = param_2;
      ...
      FUN_14019f360(pbVar20,pbVar25,param_3,param_4);
      local_res10 = pbVar18;
    }
