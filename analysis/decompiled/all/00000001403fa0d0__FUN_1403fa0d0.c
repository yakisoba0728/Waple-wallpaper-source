// Function: FUN_1403fa0d0
// Addr: 1403fa0d0
// Size: 511 bytes


void FUN_1403fa0d0(longlong param_1,longlong *param_2)

{
  ...
  if (1 < *(uint *)(param_1 + 0x1c)) {
    do {
      ...
      pdVar10 = (double *)param_2[2];
      dVar12 = dVar6;
      dVar13 = dVar7;
      if (pdVar10 != (double *)0x0) {
        dVar12 = dVar6 + *pdVar10;
        dVar13 = dVar7 + pdVar10[1];
      }
      fVar14 = (float)dVar13 * *(float *)(*param_2 + 0x54);
      fVar15 = (float)dVar12 * *(float *)(*param_2 + 0x50);
      ...
      (**(code **)(lVar5 + 0x18))(lVar5,lVar4,plVar2,fVar15,fVar14,uVar9);
      *(float *)((longlong)plVar3 + 0x1c) = fVar15;
      *(float *)(plVar3 + 4) = fVar14;
