// Function: FUN_140164690
// Addr: 140164690
// Size: 435 bytes


undefined4 * FUN_140164690(undefined4 *param_1,undefined4 *param_2)
  ...
  if (param_1 != param_2) {
    *param_1 = *param_2;
    ...
    for (puVar10 = (undefined8 *)*puVar2; puVar10 != puVar2; puVar10 = (undefined8 *)*puVar10) {
      ...
      *(undefined4 *)(puVar10 + 6) = *(undefined4 *)(puVar3 + 6);
    ...
    if (puVar3 == puVar1) {
      ...
      *(undefined4 *)(plVar5 + 6) = *(undefined4 *)(puVar3 + 6);
      lVar9 = 1;
      plVar8 = plVar5;
      for (puVar3 = (undefined8 *)*puVar3; puVar3 != puVar1; puVar3 = (undefined8 *)*puVar3) {
        ...
        lVar9 = lVar9 + 1;
        *(undefined4 *)(plVar6 + 6) = *(undefined4 *)(puVar3 + 6);
