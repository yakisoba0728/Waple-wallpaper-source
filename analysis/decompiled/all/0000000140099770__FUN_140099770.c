// Function: FUN_140099770
// Addr: 140099770
// Size: 526 bytes


ulonglong FUN_140099770(longlong param_1,undefined8 param_2,undefined4 param_3,undefined4 param_4)
    ...
    if (((int)uVar4 + 0x7785fffbU & 0xfffffffd) != 0) {
      ...
      *(undefined8 *)(param_1 + 0x128) = 0;
      if (-1 < (int)uVar4) {
        ...
        plVar2 = *(longlong **)(*(longlong *)(param_1 + 0x70) + 0x10);
        (**(code **)(*plVar2 + 0x90))(plVar2,&local_50);
        uVar5 = FUN_14028af20(0xa0);
        uVar5 = FUN_1400d2c60(uVar5,local_50,local_4c,1,0,param_2,0x1b,0x18,0,0,
