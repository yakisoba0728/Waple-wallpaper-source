// Function: FUN_1403911a0
// Addr: 1403911a0
// Size: 489 bytes


undefined8 * FUN_1403911a0(undefined8 *param_1,longlong param_2)

{
  ...
  *param_1 = 0;
  ...
  uVar5 = FUN_14038c420(local_78,puVar7);
  piVar2 = local_48;
  *param_1 = uVar5;
  if (local_48 != (int *)0x0) {
    iVar9 = -1;
  ...
  if (0x13 < *(uint *)(puVar7 + 3)) {
    pbVar8 = (byte *)puVar7[2];
  }
  if ((((uint)pbVar8[1] + (uint)*pbVar8 * 0x100) * 0x100 + (uint)pbVar8[2]) * 0x100 +
      (uint)pbVar8[3] == 0) {
