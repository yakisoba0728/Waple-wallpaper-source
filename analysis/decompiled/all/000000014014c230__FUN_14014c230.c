// Function: FUN_14014c230
// Addr: 14014c230
// Size: 1646 bytes


int FUN_14014c230(ushort *param_1,undefined8 *param_2,int param_3,int param_4)

{
  ...
  if (param_4 == 0) {
    ...
    puVar21 = param_2;
    puVar18 = param_1;
    if ((longlong)puVar26 - (longlong)param_2 < 0x40) goto code_r0x00014014c660;
...
LAB_14014c300:
    do {
      ...
      if (uVar17 == 0xf) {
        if (puVar18 <= puVar24) goto LAB_14014c73f;
        bVar1 = *(byte *)puVar24;
        puVar24 = puVar13 + 1;
        if (puVar18 < puVar24) goto LAB_14014c73f;
        ...
        goto LAB_14014c73f;
        uVar17 = uVar17 + 0xf;
        if (puVar26 + -4 < puVar12) goto LAB_14014c789;
        if (pbVar19 + -0x20 < puVar13) goto LAB_14014c789;
        do {
        ...
        if (pbVar19 + -0x11 < puVar24) goto LAB_14014c789;
      ...
      if (uVar20 == 0xf) {
        ...
        if (pbVar19 + -4 < puVar24) goto LAB_14014c73f;
        ...
        if (uVar20 == 0xffffffffffffffff) goto LAB_14014c73f;
        lVar22 = uVar20 + 0x13;
        if ((undefined8 *)(lVar22 + (longlong)puVar12) < puVar12) goto LAB_14014c73f;
        uVar20 = uVar20 + 0xf;
        if (puVar26 + -8 <= (undefined8 *)(lVar22 + (longlong)puVar12)) goto LAB_14014c83d;
      }
      else {
        puVar21 = (undefined8 *)(uVar20 + 4 + (longlong)puVar12);
        if (puVar26 + -8 <= puVar21) goto LAB_14014c83d;
        if (puVar14 < param_2) goto LAB_14014c73f;
        lVar22 = uVar20 + 4;
        if (7 < uVar10) {
          *puVar12 = *puVar14;
          puVar12[1] = puVar14[1];
...
LAB_14014c73f:
  ...
  if ((undefined8 *)((longlong)puVar26 + -0xc) < puVar21) {
    if ((undefined8 *)((longlong)puVar26 + -5) < puVar21) goto LAB_14014c73f;
...
code_r0x00014014c660:
  while( true ) {
    bVar2 = (byte)*puVar18;
    puVar24 = (ushort *)((longlong)puVar18 + 1);
    uVar17 = (ulonglong)(bVar2 >> 4);
    if (uVar17 == 0xf) break;
    if (pbVar19 + -0x10 <= puVar24 || puVar26 + -4 < puVar21) goto LAB_14014c789;
    ...
    *(undefined4 *)((longlong)puVar21 + 0xc) = uVar9;
    ...
    puVar14 = (undefined8 *)((longlong)puVar12 - uVar25);
    puVar18 = puVar24;
    if (uVar20 == 0xf) goto code_r0x00014014c7dd;
    if ((uVar10 < 8) || (puVar14 < param_2)) goto code_r0x00014014c7d7;
    *puVar12 = *puVar14;
    puVar12[1] = puVar14[1];
    *(undefined2 *)(puVar12 + 2) = *(undefined2 *)(puVar14 + 2);
  ...
  if (puVar13 <= puVar24) goto LAB_14014c73f;
  bVar1 = *(byte *)puVar24;
  puVar24 = puVar18 + 1;
  if (puVar13 < puVar24) goto LAB_14014c73f;
  uVar17 = (ulonglong)bVar1;
  ...
  if (((uVar17 == 0xffffffffffffffff) ||
     ...
     ((ushort *)(uVar17 + (longlong)puVar24) < puVar24)) goto LAB_14014c73f;
LAB_14014c789:
  ...
  if (((undefined8 *)((longlong)puVar26 + -0xc) < puVar12) ||
    ...
    if (((byte *)(uVar17 + (longlong)puVar24) == pbVar19) && (puVar12 <= puVar26)) {
      ...
      FUN_1404211c0(puVar21,puVar24,uVar17);
    }
    goto LAB_14014c73f;
  }
  do {
  ...
  puVar14 = (undefined8 *)((longlong)puVar12 - uVar25);
  uVar20 = (ulonglong)(bVar2 & 0xf);
code_r0x00014014c7d7:
  puVar18 = puVar24;
  if (uVar20 == 0xf) {
code_r0x00014014c7dd:
    puVar24 = (ushort *)((longlong)puVar18 + 1);
    if (pbVar19 + -4 < puVar24) goto LAB_14014c73f;
    ...
    if ((uVar20 == 0xffffffffffffffff) ||
       (puVar24 = (ushort *)((longlong)puVar18 + 1),
       (undefined8 *)(uVar20 + 0xf + (longlong)puVar12) < puVar12)) goto LAB_14014c73f;
    uVar20 = uVar20 + 0xf;
  }
  goto LAB_14014c83d;
}
