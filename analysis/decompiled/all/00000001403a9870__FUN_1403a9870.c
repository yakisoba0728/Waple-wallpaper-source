// Function: FUN_1403a9870
// Addr: 1403a9870
// Size: 258 bytes


undefined8 FUN_1403a9870(undefined8 param_1,longlong param_2)

{
  ...
  if (iVar14 == -1) {
    lVar5 = FUN_140398ae0(lVar9 + 0x80);
  ...
  if (uVar1 != 0) {
    do {
      if (puVar10 == (uint *)0x0) {
UNWIND_INFO_1403a994e_UnwindCodes_1__OffsetInProlog:
        lVar9 = uVar13 * 0x14;
        pbVar6 = (byte *)FUN_1403cf4c0(param_1,*(undefined4 *)(lVar9 + lVar5),iVar14);
        if (pbVar6 != (byte *)0x0) {
          ...
          *(uint *)(lVar9 + *(longlong *)(*(longlong *)(param_2 + 0x20) + 0x70)) = uVar11;
          if ((*(char *)(param_2 + 0x8d) != '\0') &&
            ...
            pcVar3[6] = -1;
            pcVar3[7] = -1;
            puVar7 = (undefined4 *)FUN_1403ed630(pcVar3,uVar11,1);
          ...
          if (*(char *)(param_2 + 0x78) != '\0') {
            uVar4 = FUN_1403caae0(*(undefined8 *)(param_2 + 0x70),uVar11);
        ...
        if ((*puVar10 & *(uint *)(param_2 + 0x88)) != 0)
        goto UNWIND_INFO_1403a994e_UnwindCodes_1__OffsetInProlog;
      }
      uVar11 = (int)uVar13 + 1;
