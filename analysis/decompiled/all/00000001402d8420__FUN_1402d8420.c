// Function: FUN_1402d8420
// Addr: 1402d8420
// Size: 394 bytes


undefined2 * FUN_1402d8420(void)

{
  ...
  lVar10 = 7;
  plVar7 = (longlong *)(*(longlong *)(local_40 + 0x120) + 0x160);
  puVar9 = puVar8;
  do {
    lVar6 = -1;
    do {
      lVar6 = lVar6 + 1;
    } while (*(short *)(plVar7[7] + lVar6 * 2) != 0);
    lVar3 = -1;
    do {
      lVar4 = lVar3;
      lVar3 = lVar4 + 1;
