// Function: FUN_140366a20
// Addr: 140366a20
// Size: 598 bytes


ulonglong * FUN_140366a20(ulonglong *param_1,uint *param_2,uint *param_3,uint *param_4)
...
joined_r0x000140366a7b:
  do {
    if (param_4 <= puVar11) {
joined_r0x000140366acc:
      ...
      goto joined_r0x000140366a7b;
    }
    if (*puVar11 <= *puVar10) {
      if (*puVar10 != *puVar11) goto joined_r0x000140366acc;
      if (puVar12 != puVar11) {
        uVar2 = *(undefined8 *)(puVar11 + 2);
        uVar9 = puVar12[8];
