// Function: FUN_1400e5810
// Addr: 1400e5810
// Size: 44 bytes


void FUN_1400e5810(longlong *param_1)

{
  ...
  pbVar6 = (byte *)*param_1;
  if (pbVar6 == pbVar7) {
UNWIND_INFO_1400e5919_UnwindCodes_102__OffsetInProlog:
  ...
  *param_1 = *param_1 + 1;
  if ((byte *)*param_1 == pbVar7) goto UNWIND_INFO_1400e5919_UnwindCodes_102__OffsetInProlog;
  bVar4 = *(byte *)*param_1;
  *(byte *)((longlong)param_1 + 0x75) = bVar4;
  lVar5 = FUN_1402bbee0(&DAT_140486ea0,(int)(char)bVar4);
  if (lVar5 == 0) goto code_r0x0001400e59d7;
  *(uint *)(param_1 + 0xe) = (uint)bVar4;
  ...
  case 0x24:
    ...
    if (((char)lVar8 == '\0') || (cVar2 != ')')) goto code_r0x0001400e59d7;
  ...
  case 0x7d:
    ...
    break;
  case 0x7c:
    if ((*(byte *)(param_1 + 0xc) & 2) == 0) goto code_r0x0001400e59d7;
    goto code_r0x0001400e5935;
  }
  if (bVar9) {
code_r0x0001400e59d7:
    *(undefined4 *)(param_1 + 0xe) = 0;
    return;
  }
code_r0x0001400e5935:
  return;
}
