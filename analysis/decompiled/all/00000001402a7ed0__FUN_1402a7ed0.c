...
undefined8
FUN_1402a7ed0(undefined8 param_1,undefined8 param_2,short ******param_3,ulonglong param_4,
...

{
  ...
  if ((char)param_4 == '\0') {
    ...
    uVar14 = FUN_14029d3d0(&local_88);
  }
  else {
    (*(code *)PTR__guard_dispatch_icall_140426ae8)();
    uVar14 = FUN_14029d2b0(&local_88);
  }
  local_100 = uVar14;
...
LAB_1402a82a5:
    ...
    FUN_1402a9bd0(local_d0,&local_88);
    FUN_1402a9c30();
    uStack_a8 = 0;
    local_a0 = (short ******)0x0;
    local_98 = 7;
    ...
    if (((ulonglong)local_e8[0][3] & 8) != 0) {
      ...
      FUN_1402a9bd0(&local_b0,&local_88);
      FUN_1402a9c30();
    }
    in_R10 = local_e8[0];
    if (local_114 == ' ') {
...
LAB_1402a8420:
      ...
      if ((local_114 != '$') && (puVar26 = auStack_148, ppppppsVar30 = local_c0, local_114 != '+'))
      {
        ...
        cVar32 = '\0';
        if (local_114 == 'v') goto LAB_1402a83f0;
        puVar26 = auStack_148;
        if (local_114 == 'x') goto LAB_1402a8420;
      }
    }
  }
  else {
...
LAB_1402a8470:
  ...
  else if (cVar32 == 'x') goto LAB_1402a8470;
  cVar32 = puVar26[0x36];
  if (cVar32 == ' ') {
    ppppppsVar30 = (short ******)((longlong)ppppppsVar30 + 1);
  }
    ...
    if (cVar32 != 'x') goto LAB_1402a84c3;
  }
  cVar33 = '\x01';
LAB_1402a84c3:
  cVar32 = puVar26[0x37];
...
LAB_1402a8585:
        ...
        if (sVar11 == -1) goto LAB_1402a859e;
      }
    }
...
LAB_1402a8ac1:
          ...
          if (*pppppsVar5[8] == (short ***)0x0) {
LAB_1402a8aa7:
            *(undefined8 *)(puVar26 + -8) = 0x1402a8abb;
            sVar11 = (*(code *)PTR__guard_dispatch_icall_140426ae8)(pppppsVar5,param_6);
          }
          else {
            iVar4 = *(int *)pppppsVar5[0xb];
            if (iVar4 < 1) goto LAB_1402a8aa7;
            *(int *)pppppsVar5[0xb] = iVar4 + -1;
            pppsVar6 = *pppppsVar5[8];
            *pppppsVar5[8] = (short ***)((longlong)pppsVar6 + 2);
            *(short *)pppsVar6 = param_6;
          ...
          if (sVar11 == -1) goto LAB_1402a8ac1;
        }
        lVar22 = lVar22 + -1;
      } while (lVar22 != 0);
...
LAB_1402a8b3e:
            ...
            if (*pppppsVar5[8] == (short ***)0x0) {
LAB_1402a8b25:
              *(undefined8 *)(puVar26 + -8) = 0x1402a8b39;
              sVar11 = (*(code *)PTR__guard_dispatch_icall_140426ae8)(pppppsVar5,param_6);
            }
            else {
              iVar4 = *(int *)pppppsVar5[0xb];
              if (iVar4 < 1) goto LAB_1402a8b25;
              *(int *)pppppsVar5[0xb] = iVar4 + -1;
              pppsVar6 = *pppppsVar5[8];
              *pppppsVar5[8] = (short ***)((longlong)pppsVar6 + 2);
              *(short *)pppsVar6 = param_6;
            ...
            if (sVar11 == -1) goto LAB_1402a8b3e;
          }
        }
        *(undefined1 *)param_3 = uVar28;
        lVar15 = 0;
...
LAB_1402a8a45:
            ...
            if (*pppppsVar5[8] == (short ***)0x0) {
LAB_1402a8a27:
              *(undefined8 *)(puVar26 + -8) = 0x1402a8a3b;
              sVar11 = (*(code *)PTR__guard_dispatch_icall_140426ae8)(pppppsVar5,sVar11);
            }
            else {
              iVar4 = *(int *)pppppsVar5[0xb];
              if (iVar4 < 1) goto LAB_1402a8a27;
              *(int *)pppppsVar5[0xb] = iVar4 + -1;
              pppsVar6 = *pppppsVar5[8];
              *pppppsVar5[8] = (short ***)((longlong)pppsVar6 + 2);
              *(short *)pppsVar6 = sVar11;
            }
            if (sVar11 == -1) goto LAB_1402a8a45;
          }
...
LAB_1402a89b3:
            ...
            if (*pppppsVar5[8] == (short ***)0x0) {
LAB_1402a8995:
              *(undefined8 *)(puVar26 + -8) = 0x1402a89a9;
              sVar11 = (*(code *)PTR__guard_dispatch_icall_140426ae8)(pppppsVar5,sVar11);
            }
            else {
              iVar4 = *(int *)pppppsVar5[0xb];
              if (iVar4 < 1) goto LAB_1402a8995;
              *(int *)pppppsVar5[0xb] = iVar4 + -1;
              pppsVar6 = *pppppsVar5[8];
              *pppppsVar5[8] = (short ***)((longlong)pppsVar6 + 2);
              *(short *)pppsVar6 = sVar11;
            }
            if (sVar11 == -1) goto LAB_1402a89b3;
          }
          psVar23 = psVar23 + 1;
          lVar22 = lVar22 + -1;
        } while (lVar22 != 0);
...
LAB_1402a8683:
              ...
              if (*pppppsVar5[8] == (short ***)0x0) {
LAB_1402a8665:
                *(undefined8 *)(puVar26 + -8) = 0x1402a8679;
                sVar11 = (*(code *)PTR__guard_dispatch_icall_140426ae8)(pppppsVar5,sVar11);
              }
              else {
                iVar4 = *(int *)pppppsVar5[0xb];
                if (iVar4 < 1) goto LAB_1402a8665;
                *(int *)pppppsVar5[0xb] = iVar4 + -1;
                pppsVar6 = *pppppsVar5[8];
                *pppppsVar5[8] = (short ***)((longlong)pppsVar6 + 2);
                *(short *)pppsVar6 = sVar11;
              }
              if (sVar11 == -1) goto LAB_1402a8683;
            }
...
LAB_1402a8857:
                ...
                if (*pppppsVar5[8] == (short ***)0x0) {
LAB_1402a8839:
                  *(undefined8 *)(puVar26 + -8) = 0x1402a884d;
                  sVar11 = (*(code *)PTR__guard_dispatch_icall_140426ae8)(pppppsVar5,sVar11);
                }
                else {
                  iVar4 = *(int *)pppppsVar5[0xb];
                  if (iVar4 < 1) goto LAB_1402a8839;
                  *(int *)pppppsVar5[0xb] = iVar4 + -1;
                  pppsVar6 = *pppppsVar5[8];
                  *pppppsVar5[8] = (short ***)((longlong)pppsVar6 + 2);
                  *(short *)pppsVar6 = sVar11;
                }
                if (sVar11 == -1) goto LAB_1402a8857;
              }
              plVar21 = (longlong *)((longlong)plVar21 + 2);
              lVar22 = lVar22 + -1;
            } while (lVar22 != 0);
          ...
          *(undefined1 *)param_3 = uVar28;
          *(undefined8 *)(puVar26 + -8) = 0x1402a8881;
          uVar9 = (*(code *)PTR__guard_dispatch_icall_140426ae8)(*(undefined8 *)(puVar26 + 0x48));
          *(undefined8 *)(puVar26 + -8) = 0x1402a888c;
          FUN_14029dd50(param_3,uVar9);
          plVar21 = param_8;
          if (7 < (ulonglong)param_8[3]) {
            plVar21 = (longlong *)*param_8;
          }
...
LAB_1402a8913:
              ...
              if (*pppppsVar5[8] == (short ***)0x0) {
LAB_1402a88f5:
                *(undefined8 *)(puVar26 + -8) = 0x1402a8909;
                sVar11 = (*(code *)PTR__guard_dispatch_icall_140426ae8)(pppppsVar5,sVar11);
              }
              else {
                iVar4 = *(int *)pppppsVar5[0xb];
                if (iVar4 < 1) goto LAB_1402a88f5;
                *(int *)pppppsVar5[0xb] = iVar4 + -1;
                pppsVar6 = *pppppsVar5[8];
                *pppppsVar5[8] = (short ***)((longlong)pppsVar6 + 2);
                *(short *)pppsVar6 = sVar11;
              }
              if (sVar11 == -1) goto LAB_1402a8913;
            }
            psVar23 = psVar23 + 1;
            lVar22 = lVar22 + -1;
          } while (lVar22 != 0);
          ...
          *(undefined8 *)(puVar26 + -8) = 0x1402a86be;
          FUN_14029dd50(param_3,sVar11);
          *(undefined8 *)(puVar26 + -8) = 0x1402a86ce;
          uVar9 = (*(code *)PTR__guard_dispatch_icall_140426ae8)(uVar14);
          *(undefined8 *)(puVar26 + -8) = 0x1402a86d9;
          FUN_14029dd50(param_3,uVar9);
          uVar28 = *(undefined1 *)param_3;
          pppppsVar5 = param_3[1];
...
LAB_1402a8723:
                ...
                if (sVar10 == -1) goto LAB_1402a873c;
              }
              lVar22 = lVar22 + -1;
            } while (lVar22 != 0);
            param_3 = *(short *******)(puVar26 + 0x38);
...
LAB_1402a87c3:
                ...
                if (*pppppsVar5[8] == (short ***)0x0) {
LAB_1402a87a5:
                  *(undefined8 *)(puVar26 + -8) = 0x1402a87b9;
                  sVar11 = (*(code *)PTR__guard_dispatch_icall_140426ae8)(pppppsVar5,sVar11);
                }
                else {
                  iVar4 = *(int *)pppppsVar5[0xb];
                  if (iVar4 < 1) goto LAB_1402a87a5;
                  *(int *)pppppsVar5[0xb] = iVar4 + -1;
                  pppsVar6 = *pppppsVar5[8];
                  *pppppsVar5[8] = (short ***)((longlong)pppsVar6 + 2);
                  *(short *)pppsVar6 = sVar11;
                }
                if (sVar11 == -1) goto LAB_1402a87c3;
              }
              plVar21 = (longlong *)((longlong)plVar21 + 2);
              lVar22 = lVar22 + -1;
            } while (lVar22 != 0);
    ...
    else if (cVar32 == 'x') goto LAB_1402a8ad7;
LAB_1402a8b4d:
...
LAB_1402a8bf6:
          ...
          if (*pppppsVar5[8] == (short ***)0x0) {
LAB_1402a8bd8:
            *(undefined8 *)(puVar26 + -8) = 0x1402a8bec;
            sVar11 = (*(code *)PTR__guard_dispatch_icall_140426ae8)(pppppsVar5,sVar11);
          }
          else {
            iVar4 = *(int *)pppppsVar5[0xb];
            if (iVar4 < 1) goto LAB_1402a8bd8;
            *(int *)pppppsVar5[0xb] = iVar4 + -1;
            pppsVar6 = *pppppsVar5[8];
            *pppppsVar5[8] = (short ***)((longlong)pppsVar6 + 2);
            *(short *)pppsVar6 = sVar11;
          }
          if (sVar11 == -1) goto LAB_1402a8bf6;
        }
        puVar27 = puVar27 + -1;
  ...
  *(undefined8 *)(puVar26 + -8) = 0x1402a8c37;
  FUN_1402a9a70(*(undefined8 *)(puVar26 + 0x68),&local_88,*(undefined2 *)(puVar26 + 0x30),lVar15);
  *(undefined8 *)(puVar26 + -8) = 0x1402a8c41;
  FUN_1402a9c30(&local_b0);
  *(undefined8 *)(puVar26 + -8) = 0x1402a8c4c;
  FUN_1402a9c30(puVar26 + 0x78);
  *(undefined8 *)(puVar26 + -8) = 0x1402a8c56;
  thunk_FUN_140017240(local_68);
  *(undefined8 *)(puVar26 + -8) = 0x1402a8c5f;
  FUN_1402a9c30(param_8);
  *(undefined8 *)(puVar26 + -8) = 0x1402a8c70;
