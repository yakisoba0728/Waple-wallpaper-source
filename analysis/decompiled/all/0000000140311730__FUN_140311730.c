// Function: FUN_140311730
// Addr: 140311730
// Size: 117 bytes


void FUN_140311730(longlong param_1,uint param_2,ulonglong param_3,ulonglong param_4)

{
  ...
  if (uVar9 != 0) {
    if ((3 < uVar9) &&
       ((param_3 + (ulonglong)(uVar9 - 1) * 4 < param_4 ||
        (param_4 + (ulonglong)(uVar9 - 1) * 4 < param_3)))) {
                    /* WARNING: Subroutine does not return */
      FUN_1404211c0(param_4,param_3,(ulonglong)uVar9 << 2);
    }
    do {
      lVar10 = uVar7 * 4;
      lVar1 = uVar7 * 4;
  ...
  if ((uint)uVar7 < param_2) {
    func_0x000140421870(param_4 + uVar7 * 4,0,(ulonglong)(param_2 - (uint)uVar7) << 2);
  }
      ...
      if (1 < *puVar8) {
        ...
        do {
          ...
          if (iVar3 < iVar5) {
            ...
            iVar3 = FUN_1402f2180(iVar3 - *(int *)(lVar1 + 4 + lVar10),
