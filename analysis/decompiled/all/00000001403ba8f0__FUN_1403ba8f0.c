// Function: FUN_1403ba8f0
// Addr: 1403ba8f0
// Size: 378 bytes


longlong FUN_1403ba8f0(void)

{
  ...
  if (*(char *)(lVar3 + 4) != '\0') {
    ...
    *(undefined1 **)(lVar3 + 0x10) = &LAB_1403d2110;
    if (*(undefined8 **)(lVar3 + 0x38) != (undefined8 *)0x0) {
  ...
  if (*(char *)(lVar3 + 4) != '\0') {
    ...
    *(undefined1 **)(lVar3 + 0x18) = &LAB_1403d2110;
    if (*plVar6 != 0) {
  ...
  if (*(char *)(lVar3 + 4) != '\0') {
    ...
    *(undefined1 **)(lVar3 + 0x20) = &LAB_1403d2170;
    if (*plVar6 != 0) {
  ...
  if (*(char *)(lVar3 + 4) != '\0') {
    ...
    *(undefined1 **)(lVar3 + 0x28) = &LAB_1403d1fd0;
    if (*plVar6 != 0) {
