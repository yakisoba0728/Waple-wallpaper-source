// Function: FUN_140350480
// Addr: 140350480
// Size: 102 bytes


void FUN_140350480(longlong param_1,uint param_2,uint param_3)

{
  ...
  if ((iVar11 != iVar8) || (iVar13 != iVar18)) {
    iVar6 = param_3 - uVar9;
    if (iVar6 == 0) {
      FUN_140350790(param_1,iVar8,iVar18);
      goto code_r0x00014035076e;
    }
      ...
      if (iVar6 < 1) {
        do {
          ...
          *piVar1 = *piVar1 + -(int)uVar10 * uVar19 * 2;
          uVar10 = 0x100;
          iVar6 = 0x100;
          FUN_140350790(param_1,iVar11,iVar13);
        } while (iVar13 != iVar18);
      }
      else {
        do {
