// Function: FUN_140346890
// Addr: 140346890
// Size: 195 bytes


undefined8 FUN_140346890(longlong param_1,undefined8 param_2)

{
  ...
  if (local_res8[0] != 0) goto LAB_1403469d0;
  if (0x17 < local_res18[0]) {
    local_res8[0] = FUN_1402f5220(param_2,local_res18[0],&local_res20);
    if (local_res8[0] != 0) goto LAB_1403469d0;
    puVar2 = (undefined2 *)func_0x0001402f7f60(uVar1,0x20,local_res8);
    if (local_res8[0] != 0) goto LAB_1403469d0;
  ...
  local_res8[0] = 8;
LAB_1403469d0:
  FUN_1402f5cd0(param_2,&local_res20);
                    /* WARNING: Subroutine does not return */
  FUN_1402f8060(uVar1,puVar2);
}
