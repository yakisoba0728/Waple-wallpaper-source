// Function: FUN_1403067f0
// Addr: 1403067f0
// Size: 1294 bytes


ulonglong FUN_1403067f0(undefined8 param_1,longlong param_2,uint param_3,undefined4 param_4,
                       undefined8 param_5)

{
  ...
  lVar8 = FUN_1402f04b0(*(undefined8 *)(*(longlong *)(param_2 + 0x90) + 8),&DAT_14043bd54);
  if (lVar8 == 0) {
    return 0xb;
  }
  uVar6 = FUN_1402f5c50(param_1,0);
  if (uVar6 != 0) {
  ...
  if ((((iVar7 == 0x10000) || (iVar7 == 0x20000)) || (iVar7 == 0x74727565)) ||
    ...
    *(uint *)(param_2 + 8) = *(uint *)(param_2 + 8) | 0x800;
    ...
    if (pcVar2 != (char *)0x0) {
      ...
      do {
        lVar8 = FUN_1402bbb40(pcVar11,&DAT_14043b610 + uVar14 * 0x14);
        if (lVar8 != 0) goto LAB_14030697a;
        uVar6 = (int)uVar14 + 1;
        uVar14 = (ulonglong)uVar6;
      } while ((int)uVar6 < 0x14);
    }
    cVar5 = FUN_140312e30(param_2);
    if (cVar5 != '\0') {
LAB_14030697a:
    ...
    if ((local_res10[0] == 0) && (7 < local_48[0])) {
      local_res10[0] = FUN_1402f5150(lVar1,local_48[0],param_2 + 0x448);
      if (local_res10[0] == 0) {
        ...
        if ((uVar15 - 1 < 0xff) && (uVar6 == (*(int *)(param_2 + 0x10) + 5U & 0xfffffffc))) {
          ...
          uVar9 = FUN_1402f7ff0(local_40,8,0,uVar15,0,local_res10);
          *(undefined8 *)(param_2 + 0x460) = uVar9;
          if (local_res10[0] == 0) {
            ...
            FUN_1402ea670(*(undefined8 *)(param_2 + 0x460),uVar12,8,&LAB_140310170);
        ...
        FUN_1402f5c00(lVar1,param_2 + 0x448);
...
LAB_140306b16:
    ...
    if ((*(uint *)(param_2 + 8) & 0x20001) != 0) {
      if (*(longlong *)(*(longlong *)(param_2 + 0xd0) + 0x50) == 0) {
        uVar6 = FUN_1403137a0(param_2,lVar1);
        if (*(int *)(param_2 + 0x3f8) == 0) {
          if ((uVar6 & 0xff) == 0x90) goto LAB_140306bbe;
        }
      ...
      uVar6 = FUN_1403131a0(param_2,lVar1);
      ...
      if (iVar7 == 0) {
        *(uint *)(param_2 + 0x3b0) = local_res10[0];
        uVar6 = FUN_1402f5150(lVar1,local_res10[0],param_2 + 0x3b8);
        if ((uVar6 != 0) && ((char)uVar6 != -0x72)) {
          return (ulonglong)uVar6;
        }
      }
      ...
      if (iVar7 == 0) {
        *(uint *)(param_2 + 0x3c0) = local_res10[0];
        uVar6 = FUN_1402f5150(lVar1,local_res10[0],param_2 + 0x3c8);
        uVar14 = (ulonglong)uVar6;
        if ((uVar6 != 0) && ((char)uVar6 != -0x72)) {
          return uVar14;
        }
      ...
      if ((((*(longlong *)(*(longlong *)(param_2 + 0xd0) + 0x50) == 0) &&
         ...
         (cVar5 = FUN_140312c60(param_2), cVar5 != '\0')) {
        *(uint *)(param_2 + 8) = *(uint *)(param_2 + 8) & 0xfffffffe;
      }
    }
    if ((param_3 >> 0x10 != 0) && ((*(uint *)(param_2 + 8) & 0x100) != 0)) {
      uVar6 = FUN_1402fa830(param_2,param_3 >> 0x10);
      uVar13 = (ulonglong)uVar6;
      if (uVar6 != 0) {
        return uVar13;
      }
    }
    *(code **)(param_2 + 0x2a8) = FUN_14030b680;
    *(undefined1 **)(param_2 + 0x2b8) = &LAB_14030c130;
    *(code **)(param_2 + 0x2c0) = FUN_14030c1d0;
    *(code **)(param_2 + 0x2c8) = FUN_14030b920;
    *(undefined1 **)(param_2 + 0x2b0) = &LAB_14030b6e0;
  }
  else {
LAB_140306bbe:
    uVar13 = 2;
