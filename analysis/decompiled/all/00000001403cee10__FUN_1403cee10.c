// Function: FUN_1403cee10
// Addr: 1403cee10
// Size: 633 bytes


void FUN_1403cee10(byte *param_1,longlong param_2,undefined8 param_3,float param_4)

{
  ...
  if (uVar9 == 1) {
    local_74 = 0;
    FUN_1403cfc40(param_1 + 8,lVar3,param_2,local_88);
    return;
  }
  uVar8 = uVar9 - 1;
  ...
  if (1 < uVar9) {
    do {
      ...
      if (param_4 < ((float)(int)((((uint)param_1[uVar5 * 8 + 9] +
                                 ...
                                 (uint)param_1[uVar5 * 8 + 0xb]) + 0.0) * DAT_1404926c0) break;
      uVar2 = uVar10 + 2;
      uVar10 = uVar4;
    } while (uVar2 < uVar9);
  }
  do {
    uVar9 = (uint)uVar6;
    if (uVar8 < 4) goto joined_r0x0001403cf081;
    ...
    if (((float)(int)((((uint)param_1[uVar6 * 8 + 9] + (uint)param_1[uVar6 * 8 + 8] * 0x100) * 0x100
        ...
        0.0) * DAT_1404926c0 < param_4) break;
    ...
    uVar4 = uVar9 - 3;
           ...
           ((float)(int)((((uint)param_1[uVar6 * 8 + 8] * 0x100 + (uint)param_1[uVar6 * 8 + 9]) *
                        ...
                        (uint)param_1[uVar6 * 8 + 0xb]) + 0.0) * DAT_1404926c0);
  goto LAB_1403cf0cd;
  while( true ) {
    uVar4 = (uint)uVar6;
    uVar9 = uVar4 - 1;
...
LAB_1403cf0cd:
  ...
  if (uVar10 == uVar4) {
    FUN_1403cfc40(pbVar1 + 8,pbVar1,param_2,local_88);
  }
  else {
    FUN_1403cfc40(pbVar1 + 8,pbVar1,param_2,local_88);
    local_74 = 0;
    local_80 = lVar7;
    local_78 = iVar11;
    FUN_1403cfc40(param_1 + (ulonglong)uVar4 * 8 + 8);
  }
  return;
}
