// Function: FUN_1400b74b0
// Addr: 1400b74b0
// Size: 96 bytes


char * FUN_1400b74b0(int *param_1,undefined8 param_2,longlong param_3)

{
  ...
  if ((param_1[0x52] == 0) || (param_1[0x52] == 1)) {
    pcVar1 = (char *)func_0x0001400b75e0(param_1);
    ...
    if (*pcVar1 != '$') goto code_r0x0001400b75ca;
    iVar2 = 1;
    param_1[0x52] = 1;
    if (*pcVar1 != '$') goto code_r0x0001400b75c0;
  }
  else {
    param_1[0x52] = 0;
    pcVar1 = (char *)0x0;
code_r0x0001400b75c0:
    iVar2 = 0;
  }
  param_1[1] = iVar2;
  if (pcVar1 == (char *)0x0) {
