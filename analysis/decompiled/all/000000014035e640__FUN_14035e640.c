...
void FUN_14035e640(longlong param_1)

{
  ...
  lVar1 = param_1 + 0x28;
  FUN_1403a31f0(lVar1,0,FUN_14040b6a0);
  FUN_1403a31f0(lVar1,0,FUN_1403f7780);
  ...
  *(undefined4 *)(puVar6 + 3) = *(undefined4 *)(param_1 + 0x74);
  ...
  lVar9 = 0;
  do {
    FUN_1403a2cd0(lVar1,(&DAT_14045d150)[lVar9 * 2],(&DAT_14045d154)[lVar9 * 2],1);
    uVar8 = (int)uVar7 + 1;
  ...
  while (uVar8 < 9) {
    FUN_1403a2cd0(lVar1,(&DAT_14045d150)[uVar7 * 2],(&DAT_14045d154)[uVar7 * 2],1);
    uVar8 = (int)uVar7 + 1;
    uVar7 = (ulonglong)uVar8;
  }
  return;
