// Function: FUN_14017c440
// Addr: 14017c440
// Size: 651 bytes


longlong * FUN_14017c440(longlong param_1,longlong *param_2,longlong *param_3)

{
  ...
  if (param_2[4] != 0) {
    ...
    } while (uVar8 < (ulonglong)param_2[4]);
  }
  lVar6 = (*(ulonglong *)(param_1 + 0x30) & uVar10) * 0x10;
  plVar9 = (longlong *)(lVar2 + 8 + lVar6);
