// Function: FUN_1402be760
// Addr: 1402be760
// Size: 400 bytes


void FUN_1402be760(longlong param_1)

{
  ...
  *(byte **)(param_1 + 8) = pbVar6;
  if ((bVar1 & 1) != 0) {
    bVar5 = *pbVar6;
    pbVar6 = pbVar6 + -(longlong)(char)(&DAT_14042c3b8)[bVar5 & 0xf];
    *(uint *)(param_1 + 0x1c) = *(uint *)(pbVar6 + -4) >> ((&DAT_14042c3c8)[bVar5 & 0xf] & 0x1f);
    *(byte **)(param_1 + 8) = pbVar6;
  }
  if ((bVar1 & 2) != 0) {
  ...
  if ((bVar1 & 4) != 0) {
    bVar5 = *pbVar6;
    pbVar6 = pbVar6 + -(longlong)(char)(&DAT_14042c3b8)[bVar5 & 0xf];
    *(uint *)(param_1 + 0x24) = *(uint *)(pbVar6 + -4) >> ((&DAT_14042c3c8)[bVar5 & 0xf] & 0x1f);
    *(byte **)(param_1 + 8) = pbVar6;
  }
  pbVar7 = pbVar6 + 4;
  ...
  *(byte **)(param_1 + 8) = pbVar7;
  if ((bVar1 & 8) == 0) {
    if (bVar5 == 0x10) {
      ...
      uVar4 = *(uint *)(((longlong)pbVar7 - (longlong)(char)(&DAT_14042c3b8)[*pbVar7 & 0xf]) + -4);
      *(longlong *)(param_1 + 8) =
           (longlong)pbVar7 - (longlong)(char)(&DAT_14042c3b8)[*pbVar7 & 0xf];
