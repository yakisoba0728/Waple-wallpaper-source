// Function: FUN_1401f3d90
// Addr: 1401f3d90
// Size: 370 bytes


longlong FUN_1401f3d90(longlong param_1,char *param_2)

{
  ...
  lVar6 = *(longlong *)(DAT_1404e8478 + 8 + (DAT_1404e8490 & uVar9) * 0x10);
  if (lVar6 == DAT_1404e8468) {
LAB_1401f3e3e:
    lVar6 = DAT_1404e8468;
  }
  else {
    lVar2 = *(longlong *)(DAT_1404e8478 + (DAT_1404e8490 & uVar9) * 0x10);
    cVar4 = FUN_14000d010(lVar6 + 0x10,param_2);
    while (cVar4 == '\0') {
      if (lVar6 == lVar2) goto LAB_1401f3e3e;
      lVar6 = *(longlong *)(lVar6 + 8);
      cVar4 = FUN_14000d010(lVar6 + 0x10,param_2);
    }
    if (lVar6 == 0) goto LAB_1401f3e3e;
  }
  if (lVar6 != DAT_1404e8468) {
LAB_1401f3e4e:
    return lVar6 + 0x30;
  ...
  if (lVar6 != lVar2) {
    ...
    cVar4 = FUN_14000d010(lVar6 + 0x10,param_2);
    while (cVar4 == '\0') {
      if (lVar6 == lVar3) goto LAB_1401f3ee9;
      lVar6 = *(longlong *)(lVar6 + 8);
      cVar4 = FUN_14000d010(lVar6 + 0x10,param_2);
    }
    if (lVar6 == 0) {
    ...
    if (lVar6 != lVar2) goto LAB_1401f3e4e;
  }
LAB_1401f3ee9:
