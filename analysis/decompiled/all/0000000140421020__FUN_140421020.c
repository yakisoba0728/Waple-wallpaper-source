...
char * FUN_140421020(char *param_1,byte param_2,char *param_3)

{
  ...
  if ((char *)0x1f < param_3) {
    if (((ulonglong)param_1 & 0xf) != 0) {
      ...
      do {
        pcVar3 = param_1;
        if (cVar4 == param_1[(longlong)pcVar2]) goto LAB_1404210ac;
        pcVar2 = pcVar2 + 1;
      } while (pcVar2 != (char *)0x0);
      if (param_3 < (char *)0x20) goto joined_r0x00014042109c;
    }
    do {
