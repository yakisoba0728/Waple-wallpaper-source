// Function: FUN_1401e4a60
// Addr: 1401e4a60
// Size: 562 bytes


longlong * FUN_1401e4a60(float *param_1,longlong *param_2,undefined8 *param_3)

{
  ...
  puVar5 = (undefined8 *)FUN_14028af20(0x40);
  ...
  if (*param_1 <= fVar10 && fVar10 != *param_1) {
    ...
    if (puVar7 != *(undefined8 **)(param_1 + 2)) {
      ...
      while( true ) {
        ...
        if (puVar8 == puVar2) goto LAB_1401e4c1a;
  ...
  *puVar7 = puVar5;
  ...
  if (puVar2 == *(undefined8 **)(param_1 + 2)) {
    *(undefined8 **)(lVar3 + uVar9 * 0x10) = puVar5;
    ...
    if (*(undefined8 **)(lVar3 + 8 + uVar9 * 0x10) != puVar7) goto LAB_1401e4c6a;
  }
