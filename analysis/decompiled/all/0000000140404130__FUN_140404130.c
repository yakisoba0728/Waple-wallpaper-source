// Function: FUN_140404130
// Addr: 140404130
// Size: 395 bytes


undefined8 FUN_140404130(byte *param_1,int *param_2)

{
  ...
  if (((((uVar6 < uVar8) || ((uint)*param_1 * 0x100 + (uint)param_1[1] != iVar7)) ||
      ...
      ((uVar4 = (uint)param_1[3] * 0x10000 + (uint)param_1[4] * 0x100 + (uint)param_1[2] * 0x1000000
       ...
       (cVar2 = FUN_140375bd0(param_2,param_1 + uVar4), cVar2 == '\0')))) ||
  ...
  if (uVar4 != 0) {
    do {
      ...
      uVar5 = (uint)pbVar1[1] * 0x10000 + (uint)pbVar1[2] * 0x100 + (uint)*pbVar1 * 0x1000000 +
              (uint)pbVar1[3];
      if ((uVar5 != 0) && (cVar2 = FUN_140375aa0(param_2,param_1 + uVar5), cVar2 == '\0')) {
        return 0;
      }
      uVar5 = (int)uVar6 + 1;
