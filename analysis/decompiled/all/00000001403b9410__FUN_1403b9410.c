// Function: FUN_1403b9410
// Addr: 1403b9410
// Size: 649 bytes


int * FUN_1403b9410(longlong param_1)

{
  ...
  if (*(code **)(param_1 + 0x20) == (code *)0x0) {
    ...
    piVar3 = (int *)(**(code **)(param_1 + 0x20))
                              (param_1,0x68656164,*(undefined8 *)(param_1 + 0x28));
    piVar4 = (int *)&DAT_14045dd10;
    if (piVar3 != (int *)0x0) {
      piVar4 = piVar3;
    }
  ...
  uVar7 = (int)(pbVar9 + (uint)piVar4[6]) - (int)pbVar9;
  iVar6 = 1;
  FUN_1402fc370("SANITIZE",pbVar9,0,1,0,CONCAT44(uVar10,1),"start [%p..%p] (%lu bytes)",pbVar9,
                pbVar9 + (uint)piVar4[6],CONCAT44(uVar11,uVar7));
  if (pbVar9 == (byte *)0x0) {
    iVar8 = -1;
  ...
  FUN_1402fc370("SANITIZE");
  if (((uVar7 < 0x36) || ((uint)pbVar9[1] + (uint)*pbVar9 * 0x100 != iVar6)) ||
     ((uint)pbVar9[0xd] * 0x10000 + (uint)pbVar9[0xe] * 0x100 + (uint)pbVar9[0xc] * 0x1000000 +
      (uint)pbVar9[0xf] != 0x5f0f3cf5)) {
    cVar5 = '\0';
  }
  else {
    cVar5 = (char)iVar6;
