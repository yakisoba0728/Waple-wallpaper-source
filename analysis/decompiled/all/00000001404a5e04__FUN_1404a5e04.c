...
void FUN_1404a5e04(byte *param_1,undefined8 param_2)

{
  ...
  bVar10 = (byte)param_2;
  bVar9 = (byte)param_1;
  uRam00000001b44f5e10 = uRam00000001b44f5e10 & (uint)in_RAX;
  *in_RAX = *in_RAX | (uint)in_RAX;
  *(byte *)((longlong)in_RAX + (longlong)(param_1 + 0x8bc8c00)) =
       *(byte *)((longlong)in_RAX + (longlong)(param_1 + 0x8bc8c00)) ^ unaff_BH;
