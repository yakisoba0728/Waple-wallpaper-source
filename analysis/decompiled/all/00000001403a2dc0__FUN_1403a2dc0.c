...
void FUN_1403a2dc0(longlong *param_1,longlong param_2,ulonglong param_3,undefined4 param_4,
...

{
  ...
  local_58 = DAT_1404dc040 ^ (ulonglong)auStack_128;
  local_f0 = param_3 & 0xffffffff;
  local_f8 = &DAT_1404621a0 + local_f0;
  local_104 = param_4;
  local_100 = param_1;
  local_e8 = param_2;
  if ((&DAT_1404621a0)[local_f0] == 0x47504f53) {
    puVar4 = (undefined8 *)FUN_1403c4ed0(*param_1 + 0x148);
    ...
    if ((&DAT_1404621a0)[local_f0] != 0x47535542) {
      pbVar9 = (byte *)&DAT_14045dd10;
      goto LAB_1403a2e96;
    }
    puVar4 = (undefined8 *)FUN_1403c4f70(*param_1 + 0x140);
    puVar6 = &DAT_14045dd10;
    if ((undefined8 *)*puVar4 != (undefined8 *)0x0) {
      puVar6 = (undefined8 *)*puVar4;
    }
...
LAB_1403a2e96:
  ...
  do {
    ...
    if (*local_f8 == 0x47504f53) {
      puVar6 = (undefined8 *)FUN_1403c4ed0(*local_100 + 0x148);
LAB_1403a2f13:
      ...
      if (*local_f8 == 0x47535542) {
        puVar6 = (undefined8 *)FUN_1403c4f70(*local_100 + 0x140);
        goto LAB_1403a2f13;
      }
      puVar6 = &DAT_14045dd10;
    }
    lVar5 = FUN_1403c9060(puVar6,param_4,param_5);
    lVar2 = local_e8;
    uVar1 = local_f0;
    puVar16 = local_d8;
    iVar15 = 0x20;
    ...
    if (uVar7 != 0) {
      do {
        if (local_d8[uVar11] < uVar12) {
          ...
          cVar3 = FUN_1403a4c80(lVar5,uVar10,0);
          if (cVar3 == '\0') {
            ...
            if ((uVar13 < uVar10) && (((uVar10 - uVar13) * 3 & 0x3fffffff) != 0)) {
              FUN_1404217a0(*(longlong *)(lVar5 + 8) + (ulonglong)uVar13 * 0xc,0,
                            (uVar10 - uVar13) * 0xc);
            }
            *(uint *)(lVar5 + 4) = uVar10;
