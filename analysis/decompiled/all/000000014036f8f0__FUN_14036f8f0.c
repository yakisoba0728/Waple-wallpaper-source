// Function: FUN_14036f8f0
// Addr: 14036f8f0
// Size: 232 bytes


undefined8 FUN_14036f8f0(byte *param_1,longlong param_2)

{
    ...
    do {
      ...
      if ((uint)pbVar6[5] + (uint)pbVar6[4] * 0x100 != 0) {
        if (*(char *)(param_2 + 0x40) == '\0') {
          cVar3 = func_0x0001403a3420(param_2 + 0x10,(uint)pbVar6[1] + (uint)*pbVar6 * 0x100,
    ...
    do {
      ...
      if ((uint)*pbVar6 * 0x100 + (uint)pbVar6[1] == 0) {
        if (uVar4 != uVar5) {
          ...
          if (*(char *)(param_2 + 0x40) == '\0') {
            cVar3 = func_0x0001403a3420(param_2 + 0x10,uVar4 + iVar8,iVar8 + uVar5);
            if (cVar3 == '\0') {
              return 0;
            }
          }
  ...
  if (uVar4 != uVar7) {
    iVar8 = (uint)param_1[3] + (uint)param_1[2] * 0x100;
    if (*(char *)(param_2 + 0x40) == '\0') {
      cVar3 = func_0x0001403a3420(param_2 + 0x10,uVar4 + iVar8,iVar8 + uVar7);
      if (cVar3 == '\0') {
        return 0;
      }
    }
