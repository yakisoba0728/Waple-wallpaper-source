// Function: FUN_1402b7b70
// Addr: 1402b7b70
// Size: 172 bytes


void FUN_1402b7b70(undefined8 param_1,undefined4 *param_2,longlong *param_3,longlong *param_4,
...

{
  ...
  local_80 = param_6;
  local_88 = param_5;
  FUN_1402b43c0(param_1,local_68);
  if ((char)param_3[1] == '\0') {
  ...
  if (*param_3 == 0) {
    if (*param_4 != 0) goto LAB_1402b7c14;
  }
  else if (*param_4 == 0) goto LAB_1402b7c14;
  *param_7 = *param_7 | 1;
LAB_1402b7c14:
  if (local_58 == 0) {
    *param_7 = *param_7 | 2;
    ...
    if ((ulonglong)param_8[2] < local_58) {
      func_0x000140016f20(param_8,local_58 - param_8[2],0);
    }
    else {
      FUN_140016d70();
    }
