// Function: FUN_1400b9ca0
// Addr: 1400b9ca0
// Size: 599 bytes


byte * FUN_1400b9ca0(longlong param_1,longlong *param_2)

{
  ...
  if (iVar11 == 0) {
    ...
    if (iVar11 == 1) goto LAB_1400b9d59;
    if (iVar11 == 2) {
      while (pbVar7 != pbVar8) {
...
LAB_1400b9d50:
            if (uVar13 <= uVar9) goto joined_r0x0001400b9e67;
LAB_1400b9d59:
