...
void FUN_1404ae234(longlong param_1,byte *param_2,undefined8 param_3,undefined1 *param_4)

{
  ...
  *in_RAX = *in_RAX & (uint)param_1;
  ...
  pbVar25 = (byte *)CONCAT71(uVar23,bVar5);
  pbVar25[0x22] = pbVar25[0x22] | (byte)((ulonglong)param_1 >> 8);
  uVar4 = SUB82(param_2,0);
  pbVar16 = param_2 + -0x18;
  bVar7 = *pbVar16;
  bVar22 = (byte)param_1;
  *pbVar16 = *pbVar16 + bVar22;
  cVar6 = bVar5 + *pbVar25 + CARRY1(bVar7,bVar22);
  bVar7 = cVar6 + *(char *)CONCAT71(uVar23,cVar6) +
          (CARRY1(bVar5,*pbVar25) || CARRY1(bVar5 + *pbVar25,CARRY1(bVar7,bVar22)));
  pbVar16 = (byte *)CONCAT71(uVar23,bVar7);
  pbVar25 = (byte *)(param_1 + -1);
  bVar5 = (byte)((ulonglong)in_RAX >> 8);
  if (pbVar25 == (byte *)0x0 || bVar7 != 0) {
    *pbVar25 = *pbVar25 + bVar5;
    *pbVar16 = *pbVar16 + bVar7;
    pbVar26 = param_2 + -0x18;
    bVar22 = *pbVar26;
    bVar24 = (byte)pbVar25;
    *pbVar26 = *pbVar26 + bVar24;
    cVar6 = bVar7 + *pbVar16 + CARRY1(bVar22,bVar24);
    cVar6 = cVar6 + *(char *)CONCAT71(uVar23,cVar6) +
            (CARRY1(bVar7,*pbVar16) || CARRY1(bVar7 + *pbVar16,CARRY1(bVar22,bVar24)));
    iVar8 = (int)CONCAT71(uVar23,cVar6);
    pbVar25 = (byte *)(param_1 + -2);
    if (pbVar25 == (byte *)0x0 || cVar6 != '\0') {
      *pbVar25 = *pbVar25 + bVar5;
  ...
  *pbVar16 = *pbVar16 | (byte)uVar9;
  ...
  if (pbVar26 == (byte *)0x0 || *pbVar16 == 0) {
    bVar5 = (byte)(uVar9 + *(int *)pbVar16);
    uVar11 = CONCAT31((int3)(uVar9 + *(int *)pbVar16 >> 8),bVar5 - 0x11);
    uVar9 = (uint)(bVar5 < 0x11);
...
code_r0x0001404ae2b2:
    *pbVar26 = *pbVar26;
    bVar5 = (byte)puVar18;
    *(byte *)puVar18 = (char)*puVar18 + bVar5;
    bVar22 = (byte)((ulonglong)puVar18 >> 8);
    piVar17 = (int *)CONCAT71((int7)((ulonglong)puVar18 >> 8),bVar5 + bVar22);
    *(char *)CONCAT62(unaff_0000001a,CONCAT11(unaff_BH,unaff_BL)) =
         *(char *)CONCAT62(unaff_0000001a,CONCAT11(unaff_BH,unaff_BL)) + cVar28 +
         CARRY1(bVar5,bVar22);
    ...
    bVar5 = *pbVar16;
    *pbVar16 = *pbVar16 + bVar7;
    uVar9 = (int)piVar17 + *piVar17 + (uint)CARRY1(bVar5,bVar7);
    if ((int)uVar9 < 0) {
                    /* WARNING: Bad instruction - Truncating control flow here */
      halt_baddata();
    }
    ...
    *(char *)(ulonglong)uVar9 = *(char *)(ulonglong)uVar9 + bVar5;
    bVar22 = (byte)(uVar9 >> 8);
    uVar13 = CONCAT31((int3)(uVar9 >> 8),(bVar5 ^ 8) + bVar22);
    *(char *)CONCAT62(unaff_0000001a,CONCAT11(unaff_BH,unaff_BL)) =
         *(char *)CONCAT62(unaff_0000001a,CONCAT11(unaff_BH,unaff_BL)) + cVar28 +
         CARRY1(bVar5 ^ 8,bVar22);
    pbVar16 = pbVar26 + (longlong)param_2;
    bVar5 = *pbVar16;
    *pbVar16 = *pbVar16 + bVar7;
    uVar9 = uVar13 + *(uint *)(ulonglong)uVar13;
    uVar11 = uVar9 + CARRY1(bVar5,bVar7);
    puVar18 = (uint *)(ulonglong)uVar11;
    if ((int)uVar11 < 0) {
      register0x00000020 = (BADSPACEBASE *)auStack_8;
      uVar9 = (uint)(CARRY4(uVar13,*(uint *)(ulonglong)uVar13) ||
                    CARRY4(uVar9,(uint)CARRY1(bVar5,bVar7)));
...
code_r0x0001404ae301:
  ...
  cVar6 = ((char)pbVar26 - *param_2) - bVar32;
  pbVar16 = (byte *)CONCAT71(uVar23,cVar6);
  uVar11 = (uint)puVar20;
  ...
  *(byte *)puVar20 = (byte)*puVar20 + bVar7;
  ...
  if (SCARRY1((byte)uVar13,bVar7)) {
    ...
    *(byte *)((longlong)puVar20 + 2) = *(byte *)((longlong)puVar20 + 2) + cVar27;
    bVar32 = CARRY1(*pbVar16,(byte)register0x00000020);
    *pbVar16 = *pbVar16 + (byte)register0x00000020;
  }
  else {
    ...
    *(char *)((longlong)puVar18 + 5) = *(char *)((longlong)puVar18 + 5) + cVar27;
    pbVar16 = (byte *)((longlong)puVar18 + 0x21);
    bVar7 = *pbVar16;
    *pbVar16 = *pbVar16 + bVar29;
    ...
    uVar1 = in(uVar4);
    puVar31[-1] = uVar1;
    pbVar16 = (byte *)CONCAT71(uVar23,(((cVar6 - bVar5) -
