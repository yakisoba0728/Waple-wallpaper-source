// Function: FUN_14036a870
// Addr: 14036a870
// Size: 1363 bytes


void FUN_14036a870(undefined8 *param_1,longlong param_2,float param_3)

{
  ...
  if (uVar5 != 0) {
    do {
      if ((*(int *)(param_1 + 2) < 1) && (cVar8 = FUN_14039aa70(param_1), cVar8 == '\0')) {
        return;
      }
      ...
      if (iVar6 == 0) {
        ...
        if (uVar15 < uVar7) {
          if (3 < uVar7 - uVar15) {
            ...
            if (uVar7 <= uVar15) goto LAB_14036ad8d;
          }
          do {
            bVar4 = *pbVar10;
            uVar15 = uVar15 + 1;
        ...
        *param_1 = pbVar10;
        ...
        if (uVar15 < uVar7) {
          if (3 < uVar7 - uVar15) {
            ...
            if (uVar7 <= uVar15) goto LAB_14036ac47;
          }
          do {
            pbVar11 = pbVar10 + 1;
            uVar15 = uVar15 + 1;
...
LAB_14036ac47:
        *param_1 = pbVar10;
        ...
        if (uVar7 <= uVar14) goto LAB_14036ad8d;
        do {
          pbVar11 = pbVar10 + 1;
          uVar14 = uVar14 + 1;
          bVar4 = *pbVar10;
