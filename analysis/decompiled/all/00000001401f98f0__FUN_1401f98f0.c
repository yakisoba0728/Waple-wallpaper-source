...
void FUN_1401f98f0(float *param_1,float *param_2,float param_3,uint param_4,longlong param_5,
...

{
  ...
  if (param_4 != 0) {
    ...
    uVar26 = param_4 * 4;
    uVar23 = param_4 * 6;
    fVar33 = _DAT_140492f00 * fVar32;
    fVar39 = _UNK_140492f04 * fVar32;
    fVar41 = _UNK_140492f08 * fVar32;
    fVar43 = _UNK_140492f0c * fVar32;
    uVar28 = param_4 * 7;
    ...
    do {
      ...
      *(undefined1 (*) [16])(param_11 + (ulonglong)uVar22 * 4 + lVar25 * 4) = auVar64;
      ...
      fVar90 = (float)((uint)(*pfVar13 * *pfVar5 + *pfVar8 * *pfVar4 +
                             *pfVar7 * *pfVar3 + *pfVar6 * *pfVar2) & _DAT_140483800 ^
                      (uint)*param_1);
      fVar92 = (float)((uint)(pfVar13[1] * pfVar5[1] + pfVar8[1] * pfVar4[1] +
                             pfVar7[1] * pfVar3[1] + pfVar6[1] * pfVar2[1]) & _UNK_140483804 ^
                      (uint)param_1[1]);
      fVar94 = (float)((uint)(pfVar13[2] * pfVar5[2] + pfVar8[2] * pfVar4[2] +
                             pfVar7[2] * pfVar3[2] + pfVar6[2] * pfVar2[2]) & _UNK_140483808 ^
                      (uint)param_1[2]);
      fVar96 = (float)((uint)(pfVar13[3] * pfVar5[3] + pfVar8[3] * pfVar4[3] +
                             pfVar7[3] * pfVar3[3] + pfVar6[3] * pfVar2[3]) & _UNK_14048380c ^
                      (uint)param_1[3]);
      ...
      fVar74 = (_DAT_140483870 - fVar44 * fVar44 * auVar46._0_4_) * fVar44 * _DAT_140483810;
      fVar75 = (_UNK_140483874 - fVar52 * fVar52 * auVar46._4_4_) * fVar52 * _UNK_140483814;
      fVar76 = (_UNK_140483878 - fVar53 * fVar53 * auVar46._8_4_) * fVar53 * _UNK_140483818;
      fVar77 = (_UNK_14048387c - fVar54 * fVar54 * auVar46._12_4_) * fVar54 * _UNK_14048381c;
      ...
      fVar90 = (float)(DAT_1404930c0 ^ *puVar12);
      fVar92 = (float)(_UNK_1404930c4 ^ puVar12[1]);
      fVar94 = (float)(_UNK_1404930c8 ^ puVar12[2]);
      fVar96 = (float)(_UNK_1404930cc ^ puVar12[3]);
      ...
      fVar59 = (float)(DAT_1404930c0 ^ *puVar12);
      fVar60 = (float)(_UNK_1404930c4 ^ puVar12[1]);
      fVar61 = (float)(_UNK_1404930c8 ^ puVar12[2]);
      fVar62 = (float)(_UNK_1404930cc ^ puVar12[3]);
      ...
      fVar44 = (float)(DAT_1404930c0 ^ *puVar12);
      fVar52 = (float)(_UNK_1404930c4 ^ puVar12[1]);
      fVar53 = (float)(_UNK_1404930c8 ^ puVar12[2]);
      fVar54 = (float)(_UNK_1404930cc ^ puVar12[3]);
      ...
      fVar70 = (float)((uint)(fVar91 * 0.0 + fVar44 * 0.0 + fVar66 * 0.0 + fVar79 * _DAT_140492f00)
                       & _DAT_140483800 ^ (uint)param_3);
      fVar71 = (float)((uint)(fVar93 * 0.0 + fVar52 * 0.0 + fVar67 * 0.0 + fVar81 * _UNK_140492f04)
                       & _UNK_140483804 ^ (uint)param_3);
      fVar72 = (float)((uint)(fVar95 * 0.0 + fVar53 * 0.0 + fVar68 * 0.0 + fVar83 * _UNK_140492f08)
                       & _UNK_140483808 ^ (uint)param_3);
      fVar73 = (float)((uint)(fVar97 * 0.0 + fVar54 * 0.0 + fVar69 * 0.0 + fVar85 * _UNK_140492f0c)
                       & _UNK_14048380c ^ (uint)param_3);
      ...
      fVar80 = (_DAT_140483870 - fVar70 * fVar70 * auVar47._0_4_) * fVar70 * _DAT_140483810;
      fVar82 = (_UNK_140483874 - fVar71 * fVar71 * auVar47._4_4_) * fVar71 * _UNK_140483814;
      fVar84 = (_UNK_140483878 - fVar72 * fVar72 * auVar47._8_4_) * fVar72 * _UNK_140483818;
      fVar74 = (_UNK_14048387c - fVar73 * fVar73 * auVar47._12_4_) * fVar73 * _UNK_14048381c;
