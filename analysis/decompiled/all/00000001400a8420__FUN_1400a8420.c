// Function: FUN_1400a8420
// Addr: 1400a8420
// Size: 2117 bytes


char * FUN_1400a8420(longlong param_1,longlong *param_2)
...
LAB_1400a8566:
        ...
        if (0x1f < uVar14) {
          ...
          iVar18 = 2;
          goto switchD_1400a84fc_caseD_2;
        }
      } while (iVar18 != 0);
      iVar18 = 1;
    }
        ...
        while( true ) {
          ...
          *(uint *)(param_1 + 0x28) = uVar11;
          ...
          if (iVar18 == 0) {
            iVar18 = 3;
LAB_1400a8675:
            if (pbVar15 == local_res20) goto LAB_1400a85f6;
            bVar10 = *pbVar15;
            *(undefined4 *)(param_1 + 0x2c) = 8;
            iVar18 = 8;
            uVar11 = (uint)bVar10 << 0x18;
...
switchD_1400a84fc_caseD_8:
                  ...
                  *(int *)(param_1 + 0x2c) = iVar18;
                  ...
                  if (*(uint *)(param_1 + 0x68) <= local_res18) goto LAB_1400a8cc3;
                }
                if (local_res18 == 0) {
...
LAB_1400a8b7a:
                uVar14 = (uint)uVar8;
                pcVar6 = (char *)FUN_1400a8d40(param_1,param_2);
                if (param_2 != (longlong *)0x0) {
                  pbVar15 = (byte *)(param_2[3] + *param_2);
                }
                if (pcVar6 != (char *)0x0) {
                  if (*pcVar6 != '$') goto switchD_1400a84fc_default;
                  bVar2 = true;
                  pcVar13 = pcVar6;
                  goto LAB_1400a8507;
                }
                pcVar13 = (char *)FUN_1400a8fa0();
                if ((pcVar13 != (char *)0x0) && (*pcVar13 == '#')) goto LAB_1400a8cca;
                uVar5 = 0;
                do {
                  uVar16 = 0;
...
LAB_1400a8cc3:
  ...
  case 3:
    goto LAB_1400a8675;
  case 4:
    goto switchD_1400a84fc_caseD_4;
  case 5:
    goto switchD_1400a84fc_caseD_5;
  case 6:
    goto LAB_1400a88bb;
  case 7:
    goto LAB_1400a895c;
  case 8:
    goto switchD_1400a84fc_caseD_8;
  case 9:
    goto LAB_1400a8b7a;
  default:
switchD_1400a84fc_default:
    bVar2 = false;
    pcVar13 = pcVar6;
    goto LAB_1400a8507;
  }
