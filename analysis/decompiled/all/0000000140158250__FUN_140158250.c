// Function: FUN_140158250
// Addr: 140158250
// Size: 211 bytes


void FUN_140158250(longlong param_1,longlong param_2,char *param_3)

{
  ...
  puVar3 = DAT_1404e9350;
  puVar2 = DAT_1404e9348;
  if (param_3 != (char *)0x0) {
    iVar1 = *(int *)(param_2 + 4);
    for (puVar7 = DAT_1404e9348; puVar7 != puVar3; puVar7 = puVar7 + 5) {
...
LAB_1401582df:
  ...
  if (*(code **)(param_2 + 0x28) != (code *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x000140158312. Too many branches */
