// Function: FUN_1402db404
// Addr: 1402db404
// Size: 437 bytes


char * FUN_1402db404(ushort *param_1,undefined8 *param_2,ulonglong param_3,undefined8 param_4,
                    longlong param_5)

{
  ...
  if (param_1 == (ushort *)0x0) {
    while( true ) {
      ...
      lVar1 = FUN_1402db158(0,pcVar5,cVar6,param_4,param_5);
      if (lVar1 == -1) {
    ...
    for (; param_3 != 0; param_3 = param_3 - 1) {
      ...
      local_res8[0] = 0;
      lVar1 = FUN_1402db158(local_res8,pcVar5,cVar6,param_4,param_5);
      if (lVar1 == -1) {
        *param_2 = pcVar5;
        *(undefined1 *)(param_5 + 0x30) = 1;
        *(undefined4 *)(param_5 + 0x2c) = 0x2a;
