// Function: FUN_1403694a0
// Addr: 1403694a0
// Size: 329 bytes


void FUN_1403694a0(uint *param_1,uint *param_2,longlong param_3,undefined8 param_4)
      ...
      if (param_1 != param_2) {
        for (puVar10 = param_1 + 7; puVar10 != param_2; puVar10 = puVar10 + 7) {
          ...
          if ((int)uVar6 < 0) {
            ...
            FUN_1404211c0(param_1 + 7,param_1,(longlong)puVar10 - (longlong)param_1);
          }
          while( true ) {
            puVar9 = puVar8 + -7;
            if (uVar1 == *puVar9) {
...
LAB_140369815:
    ...
    lVar7 = (longlong)param_2 - (longlong)param_1;
    if (param_3 < 1) {
      func_0x000140363f10(param_1,param_2,param_4);
      while (0x37 < lVar7) {
        puVar10 = param_2 + -7;
        if (1 < ((longlong)param_2 - (longlong)param_1) / 0x1c) {
          puStack_70 = *(uint **)puVar10;
          ...
          *puVar10 = *param_1;
          ...
          param_2[-1] = uVar3;
          uStack_88 = param_4;
          func_0x0001403680c0(param_1,0,((longlong)puVar10 - (longlong)param_1) / 0x1c,&puStack_70);
        }
        param_2 = puVar10;
    ...
    local_78 = puVar8;
    if (lVar7 < 0x29) {
      FUN_140364e70(param_1,puVar8,puVar10,param_4);
    }
    else {
      lVar7 = lVar7 + 1 >> 3;
      FUN_140364e70(param_1,param_1 + lVar7 * 7,param_1 + lVar7 * 0xe,param_4);
      FUN_140364e70(local_78 + lVar7 * -7,local_78,local_78 + lVar7 * 7,param_4);
      FUN_140364e70(param_2 + -7 + lVar7 * -0xe,puVar10 + lVar7 * -7,param_2 + -7,param_4);
      puVar8 = local_78;
      FUN_140364e70(param_1 + lVar7 * 7,local_78,puVar10 + lVar7 * -7,param_4);
    }
    uStack_88 = param_4;
    func_0x000140366710(&puStack_70,param_1,puVar8,param_2);
    puVar8 = puStack_70;
    puVar10 = (uint *)CONCAT44(uStack_64,uStack_68);
    param_3 = (param_3 >> 1) + (param_3 >> 2);
    if (((longlong)puStack_70 - (longlong)param_1) / 0x1c <
        ((longlong)param_2 - (longlong)puVar10) / 0x1c) {
      FUN_1403694a0(param_1,puStack_70,param_3,param_4);
      puVar8 = param_2;
      param_1 = puVar10;
    }
    else {
      FUN_1403694a0(puVar10,param_2,param_3,param_4);
    }
