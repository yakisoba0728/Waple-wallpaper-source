// Function: FUN_14015af00
// Addr: 14015af00
// Size: 573 bytes


longlong * FUN_14015af00(float *param_1,longlong *param_2,undefined8 *param_3)
  ...
  if (*param_1 <= fVar10 && fVar10 != *param_1) {
    ...
    if (puVar7 != *(undefined8 **)(param_1 + 2)) {
      ...
      while( true ) {
        ...
        if (puVar8 == puVar2) goto LAB_14015b0c7;
  ...
  *puVar7 = puVar5;
  ...
  if (puVar2 == *(undefined8 **)(param_1 + 2)) {
    *(undefined8 **)(lVar3 + uVar9 * 0x10) = puVar5;
    ...
    if (*(undefined8 **)(lVar3 + 8 + uVar9 * 0x10) != puVar7) goto LAB_14015b117;
  }
