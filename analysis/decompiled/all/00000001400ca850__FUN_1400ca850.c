// Function: FUN_1400ca850
// Addr: 1400ca850
// Size: 46 bytes


undefined8 FUN_1400ca850(longlong param_1,uint *param_2)

{
  ...
  if (plVar6 == plVar4) {
code_r0x0001400ca8e2:
    plVar6 = (longlong *)0x0;
  }
  else {
    uVar1 = *(uint *)(plVar6 + 2);
    while (uVar2 != uVar1) {
      if (plVar6 == *(longlong **)(lVar3 + uVar7 * 0x10)) goto code_r0x0001400ca8e2;
