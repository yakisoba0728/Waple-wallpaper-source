// Function: FUN_1400388c0
// Addr: 1400388c0
// Size: 422 bytes


void FUN_1400388c0(longlong param_1,ulonglong param_2)

{
  ...
  func_0x0001400376d0(param_1 + 0x18,2L << (bVar11 & 0x3f),plVar2);
  *(longlong *)(param_1 + 0x38) = lVar15;
  *(longlong *)(param_1 + 0x30) = lVar15 + -1;
  plVar6 = (longlong *)**(undefined8 **)(param_1 + 8);
joined_r0x000140038942:
  do {
    while( true ) {
      if (plVar6 == plVar2) {
        uStackX_10 = 0;
        func_0x000140038f70(&uStackX_10);
        return;
      }
      uVar17 = plVar6[5];
      plVar10 = plVar6 + 2;
