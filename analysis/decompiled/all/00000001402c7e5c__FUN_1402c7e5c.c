// Function: FUN_1402c7e5c
// Addr: 1402c7e5c
// Size: 62 bytes


int FUN_1402c7e5c(undefined8 param_1,undefined1 *param_2,longlong param_3,longlong param_4,
                 undefined4 *param_5)

{
  ...
  if (param_5 == (undefined4 *)0x0) {
    ...
    if (DAT_1404e46ac == 0) goto LAB_1402c7ea9;
  }
  else {
    uVar2 = *param_5;
    uVar3 = param_5[1];
...
LAB_1402c7ea9:
  ...
  if (((param_4 == 0) || (param_2 == (undefined1 *)0x0)) || (param_3 == 0)) {
    ...
    iVar1 = func_0x0001402c1604();
    if (iVar1 < 0) {
      *param_2 = 0;
    }
    if (iVar1 != -2) goto code_r0x0001402c7f1a;
    uStack_1c = 0x22;
  }
  local_18 = '\x01';
  FUN_1402cada4(0,0,0,0,0,local_48);
  iVar1 = -1;
code_r0x0001402c7f1a:
  if (local_20 == '\x02') {
