// Function: FUN_14002ff50
// Addr: 14002ff50
// Size: 334 bytes


undefined4 * FUN_14002ff50(longlong *param_1,undefined4 *param_2)
  ...
  if (uVar4 <= 0x3fffffffffffffff - (uVar4 >> 1)) {
    ...
    if (uVar10 < 0x4000000000000000) {
      ...
      if (uVar4 == 0) {
        ...
        if (uVar4 + 0x27 <= uVar4) goto LAB_14003009a;
