// Function: FUN_14026aa60
// Addr: 14026aa60
// Size: 495 bytes


void FUN_14026aa60(longlong *param_1,ulonglong param_2)
...
LAB_14026ab25:
    ...
    lVar7 = *param_1;
    if (lVar7 == 0) goto LAB_14026ac0f;
    lVar8 = param_1[1];
    for (; lVar7 != lVar8; lVar7 = lVar7 + 0x20) {
      FUN_1401dd580(lVar7 + 8);
    }
    lVar7 = *param_1;
    lVar8 = lVar7;
    puVar11 = auStack_38;
    if ((0xfff < (param_1[2] - lVar7 & 0xffffffffffffffe0U)) &&
       ...
       0x1f < (lVar7 - lVar8) - 8U)) goto LAB_14026ac00;
  }
  else {
    if (uVar9 < 0x1000) {
    ...
    if (uVar9 + 0x27 <= uVar9) goto LAB_14026ac4b;
    lVar6 = FUN_14028af20();
    if (lVar6 != 0) {
...
LAB_14026ac00:
  ...
  *(undefined8 *)(puVar11 + -8) = 0x14026ac0f;
