// Function: FUN_140394860
// Addr: 140394860
// Size: 502 bytes


undefined4 *
FUN_140394860(undefined4 *param_1,undefined8 param_2,longlong param_3,undefined8 param_4,
             int *param_5)

{
  ...
  *(undefined8 **)(param_1 + 0x1a) = &DAT_14045dd10;
  puVar3 = (undefined8 *)FUN_1403c4e30(*(longlong *)(param_1 + 6) + 0x138);
  ...
  *(undefined1 *)(param_1 + 0x14) = 0;
  ...
  if (iVar6 == -1) {
    lVar5 = FUN_140398a10(lVar1 + 0x80);
  ...
  *(undefined1 *)(param_1 + 0x19) = 1;
  ...
  param_1[10] = 0;
  param_1[0x13] = 0;
  FUN_1402fc370("SANITIZE",*(undefined8 *)(param_1 + 0xc),0,1,0,1,"start [%p..%p] (%lu bytes)",
