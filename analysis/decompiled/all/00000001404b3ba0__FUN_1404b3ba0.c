...
void FUN_1404b3ba0(int *param_1,int param_2)

{
  ...
  uVar3 = (in_EAX - *param_1) - (uint)in_CF;
  puVar4 = (uint *)(ulonglong)uVar3;
  bVar2 = (byte)param_2;
  *(byte *)puVar4 = (char)*puVar4 + bVar2;
  *(byte *)puVar4 = (char)*puVar4 + (byte)uVar3;
  *(uint *)((longlong)param_1 + 10) = *(uint *)((longlong)param_1 + 10) & (uint)param_1;
  *(char *)(param_1 + -2) = (char)param_1[-2] + (char)param_1;
  *puVar4 = *puVar4 | uVar3;
  puVar4 = (uint *)((ulonglong)CONCAT31((int3)(uVar3 >> 8),(byte)uVar3 | (byte)*puVar4) &
                   0xffffffffffffffd8);
