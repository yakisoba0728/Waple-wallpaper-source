...
void FUN_1403c3410(longlong param_1,undefined8 param_2)

{
  ...
  if (*(int *)(param_1 + 0x1c) == 0xb) {
    ...
    func_0x0001403bcbe0(param_1,param_2,&local_68,&local_38,&local_48);
    func_0x0001403bcbe0(param_1,param_2,&local_18,&local_28,&local_58);
    return;
  }
