// Function: FUN_140079180
// Addr: 140079180
// Size: 178 bytes


longlong FUN_140079180(longlong param_1,undefined8 *param_2)

{
  ...
  if (*(longlong *)(param_1 + 0x10) == 0x147ae147ae147ae) {
                    /* WARNING: Subroutine does not return */
    FUN_14028c3b0("unordered_map/set too long");
  }
  lVar2 = func_0x00014028aff0(200);
  return lVar2;
}
