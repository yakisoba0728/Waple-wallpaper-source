...
undefined4 FUN_1401a9bc0(longlong *param_1,int param_2)
...
LAB_1401a9ca0:
      ...
      do {
        iVar9 = (int)uVar10;
        if (iVar8 == 0) {
          if (*piVar2 < iVar9) goto LAB_1401a9ceb;
          iVar8 = piVar2[1];
LAB_1401a9ed3:
...
LAB_1401a9d90:
    ...
    if ((double)(float)((uint)(fVar13 - (float)iVar9) & _DAT_140492fc0) < DAT_140492708) break;
  }
  if (fVar4 <= fVar16) {
    fVar16 = fVar4;
  }
...
LAB_1401a9edd:
  ...
  if (param_2 < (int)(iVar9 + 1U)) goto LAB_1401a9f35;
  goto LAB_1401a9ca0;
}
