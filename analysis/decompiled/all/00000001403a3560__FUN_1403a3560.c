// Function: FUN_1403a3560
// Addr: 1403a3560
// Size: 318 bytes


undefined8 * FUN_1403a3560(undefined8 *param_1)

{
  ...
  if (puVar3 == (undefined8 *)0x0) {
    cVar2 = FUN_1403a4770(param_1 + 1,*(int *)((longlong)param_1 + 0xc) + 1,0);
    if (cVar2 == '\0') {
      return (undefined8 *)0x0;
    }
    puVar3 = (undefined8 *)thunk_FUN_1402da070(0x700);
    if (puVar3 == (undefined8 *)0x0) {
      return (undefined8 *)0x0;
    }
    if ((*(int *)((longlong)param_1 + 0xc) < *(int *)(param_1 + 1)) ||
       (cVar2 = FUN_1403a4770(param_1 + 1,*(int *)((longlong)param_1 + 0xc) + 1,0), cVar2 != '\0'))
    {
