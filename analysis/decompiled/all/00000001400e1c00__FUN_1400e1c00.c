// Function: FUN_1400e1c00
// Addr: 1400e1c00
// Size: 4534 bytes


bool FUN_1400e1c00(longlong *param_1,longlong param_2)
...
LAB_1400e2d89:
  ...
  do {
    do {
      uVar27 = 4;
      if (*param_1 < 1) goto LAB_1400e2dac;
      *param_1 = *param_1 + -1;
      ...
      case 6:
        ...
        if ((*(uint *)(param_1 + 0x1c) & 0x100) == 0) {
          for (; pcVar13 != pcVar14; pcVar13 = pcVar13 + 1) {
            bVar35 = true;
            if (pcVar26 == pcVar33) goto LAB_1400e1ec1;
            lVar34 = lVar34 + 1;
            if (*pcVar13 != *pcVar26) goto LAB_1400e1ec5;
            pcVar26 = pcVar26 + 1;
          }
        }
          ...
          do {
            ...
            if (cVar10 != cVar11) goto LAB_1400e1ec5;
            pcVar13 = pcVar13 + 1;
            pcVar26 = pcVar26 + 1;
...
LAB_1400e1ec5:
        ...
        if (*param_1 < lVar34) goto LAB_1400e2dac;
        *param_1 = *param_1 - lVar34;
        uVar32 = local_res10;
        break;
      case 7:
        if (param_1[1] != param_1[0x1b]) {
          plVar30 = (longlong *)FUN_1400e1ad0(param_1,local_40,param_2);
...
LAB_1400e1dea:
        ...
        break;
      case 10:
        FUN_1400e5e80(param_1,1,param_2);
        lVar16 = *(longlong *)(param_2 + 0x20);
        break;
      case 0xb:
        FUN_1400e5e80(param_1,2,param_2);
        lVar16 = *(longlong *)(param_2 + 0x20);
        break;
      case 0xc:
              ...
              if ((uVar22 <= uVar29) && (uVar29 = uVar29 + 1, uVar22 < uVar29)) {
                ...
                *puVar1 = *puVar1 & (1L << ((byte)uVar27 & 0x3f)) - 1U;
                ...
                if (uVar27 < uVar21) {
                  ...
                  FUN_1404217a0(lVar34,0,(uVar21 * 8 - lVar34) + param_1[5] & 0xfffffffffffffff8);
                }
              }
              goto switchD_1400e1c77_caseD_1;
            }
            if (iVar3 == 0xd) {
              uVar19 = piVar20[1];
              uVar12 = uVar19;
      ...
      case 0xd:
        ...
        lVar17 = FUN_1400e5e80(param_1,0xc,param_2);
        lVar31 = param_1[0x12];
      ...
      case 0xe:
        ...
        if (iVar3 != 0) {
          ...
          lVar17 = FUN_1400e5e80(param_1,((*(ulonglong *)(param_1[5] + uVar27 * 8) >>
                                           (uVar29 & 0x3f) & 1) != 0) + '\r');
          lVar31 = param_1[0x12];
          *(undefined8 *)(lVar31 + 0x10 + lVar17 * 0x20) =
...
LAB_1400e22e2:
            ...
            if ((*(uint *)(param_1 + 0x1c) & 0x100) == 0) {
              for (; pcVar14 != pcVar33; pcVar14 = pcVar14 + 1) {
                bVar35 = true;
                if (pcVar26 == pcVar23) goto LAB_1400e22d1;
                lVar34 = lVar34 + 1;
                if (*pcVar14 != *pcVar26) goto LAB_1400e22d5;
                pcVar26 = pcVar26 + 1;
              }
            }
              ...
              do {
                ...
                if (cVar10 != cVar11) goto LAB_1400e22d5;
                pcVar14 = pcVar14 + 1;
                pcVar26 = pcVar26 + 1;
...
LAB_1400e22d5:
            if (pcVar13 != (char *)param_1[1]) goto LAB_1400e22e2;
            local_res10 = 1;
          }
          lVar34 = (longlong)(lVar34 + (ulonglong)((uint)(lVar34 >> 0x3f) & 0x3f)) >> 6;
          if (*param_1 < lVar34) {
      ...
      case 0x12:
        ...
        if ((*(int *)(param_1[0xf] + 0xc + (ulonglong)*(uint *)(param_2 + 0x30) * 0x18) == 0) &&
           (((*(byte *)(param_1 + 0x1c) & 0x3e) != 0 ||
            (cVar11 = FUN_1400e7880(param_1,lVar16,lVar34), cVar11 == '\0')))) {
        ...
        if (*(int *)(param_2 + 0x34) == 1) {
          lVar31 = FUN_1400e5e80(param_1,uVar27 & 0xffffffff,param_2);
          *(longlong *)(lVar34 + uVar21 * 0x18) = lVar31;
          if ((*(int *)(param_2 + 0x20) < 1) &&
            ...
            *(undefined4 *)(lVar34 + 8 + uVar21 * 0x18) = 0;
            ...
            if (*(int *)(param_2 + 0x24) != 0) {
              FUN_1400e5e80(param_1,5,param_2);
            }
          }
          else {
          ...
          lVar16 = *(longlong *)(*(longlong *)(param_2 + 0x28) + 0x10);
          if (*(int *)(param_2 + 0x24) != 0) {
            lVar17 = FUN_1400e5e80(param_1,9,param_2);
            lVar31 = param_1[0x12];
          ...
          lVar17 = FUN_1400e5e80(param_1,(*(int *)(param_2 + 0x20) != 0) + '\n',param_2);
          lVar31 = param_1[0x12];
      ...
      case 0x13:
        ...
        if ((*(uint *)(lVar34 + 0xc) & 0x1000) == 0 && *(int *)(lVar34 + 0x34) == 0) {
          ...
          if (iVar3 < *(int *)(lVar34 + 0x20)) {
            lVar15 = FUN_1400e5e80(param_1,0xb,lVar34);
            lVar16 = param_1[0x12];
              ...
              do {
                ...
                if ((uVar25 >> (uVar29 & 0x3f) & 1) != 0) {
                  *(ulonglong *)(param_1[5] + (uVar27 >> 6) * 8) = uVar25 & ~(1L << (uVar29 & 0x3f))
                  ;
                  lVar16 = FUN_1400e5e80(param_1,0xf,0);
...
LAB_1400e26f9:
            ...
            if (iVar3 != *(int *)(lVar34 + 0x24)) {
              lVar17 = FUN_1400e5e80(param_1,9,lVar34);
              lVar34 = param_1[0x12];
            ...
            lVar17 = FUN_1400e5e80(param_1,10,lVar34);
            lVar16 = param_1[0x12];
            ...
            for (uVar29 = *(uint *)(lVar31 + 0xc + uVar27 * 0x18);
              ...
              if ((uVar27 >> (uVar29 & 0x3f) & 1) != 0) {
                *(ulonglong *)(param_1[5] + (ulonglong)(uVar29 >> 6) * 8) =
                ...
                lVar31 = FUN_1400e5e80(param_1,0xf,0);
          ...
          if (*(int *)(lVar31 + 8 + uVar27 * 0x18) == 1) {
            ...
            *(longlong *)(lVar31 + 0x10 + uVar27 * 0x18) = lVar18;
            ...
            lVar17 = FUN_1400e5e80(param_1,uVar24,lVar34);
...
LAB_1400e28c9:
            ...
            *(longlong *)(lVar17 + 0x10 + uVar21) = lVar18;
            ...
            if (iVar3 == *(int *)(lVar34 + 0x24)) {
              ...
              lVar34 = *plVar30;
              *(longlong *)(lVar17 + 0x10 + uVar21) = lVar18;
              if (lVar18 == *(longlong *)(param_1[0x12] + 0x10 + lVar34 * 0x20)) goto LAB_1400e28c9;
...
LAB_1400e2a8d:
    cVar11 = (char)uVar32;
    lVar16 = param_1[0x16];
    if (lVar16 == 0) goto LAB_1400e2d89;
    while (param_2 == 0) {
      ...
      case 9:
        ...
        *(undefined4 *)(lVar34 + lVar31) = 0xb;
        param_1[0x16] = param_1[0x16] + 1;
        FUN_1400e6070(param_1,*(undefined4 *)(lVar17 + 0xc + uVar27 * 0x18));
        break;
      case 10:
        uVar32 = 0;
        local_res10 = 0;
...
LAB_1400e2d65:
      ...
      cVar11 = (char)uVar32;
      lVar16 = param_1[0x16];
      if (lVar16 == 0) goto joined_r0x0001400e1c25;
    }
  } while( true );
}
