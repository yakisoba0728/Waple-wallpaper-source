...
void FUN_140258120(longlong param_1)

{
  ...
  *(undefined8 **)(lVar13 + 0x30) = puVar10 + 8;
  ...
  if ((*(byte *)(param_1 + 0x594) & 2) == 0) goto code_r0x000140258478;
  ...
  *(undefined8 **)(lVar11 + 0x30) = puVar10 + 8;
  ...
  if (((*(int *)(param_1 + 800) < 1) && ((*(byte *)(param_1 + 0x304) & 0x10) == 0)) &&
    ...
    fStackX_18 = *(float *)(param_1 + 0x4e8);
    fStackX_1c = *(float *)(param_1 + 0x4ec);
    if (DAT_140492a04 <= fStackX_18) {
      fStackX_18 = DAT_140492a04;
    }
    if (DAT_140492a04 <= fStackX_1c) {
      fStackX_1c = DAT_140492a04;
    }
  }
  ...
  *puVar10 = *puVar10;
  ...
  puVar10[4] = puVar10[4];
  puVar10[5] = puVar10[5];
  fStackX_18 = fVar18 * _UNK_140492a7c - fStackX_18;
  fStackX_1c = fVar16 * _UNK_140492a7c - fStackX_1c;
  puVar10[6] = CONCAT44((float)((ulonglong)uVar8 >> 0x20) * fStackX_18 +
                        (float)((ulonglong)uVar6 >> 0x20) * fStackX_1c +
                        (float)((ulonglong)uVar4 >> 0x20) * 0.0 +
                        (float)((ulonglong)puVar10[6] >> 0x20),
                        (float)uVar8 * fStackX_18 + (float)uVar6 * fStackX_1c + (float)uVar4 * 0.0 +
                        (float)puVar10[6]);
  puVar10[7] = CONCAT44((float)((ulonglong)uVar9 >> 0x20) * fStackX_18 +
                        (float)((ulonglong)uVar7 >> 0x20) * fStackX_1c +
                        (float)((ulonglong)uVar5 >> 0x20) * 0.0 +
                        (float)((ulonglong)puVar10[7] >> 0x20),
                        (float)uVar9 * fStackX_18 + (float)uVar7 * fStackX_1c + (float)uVar5 * 0.0 +
                        (float)puVar10[7]);
  ...
  *(float *)(lVar13 + 300) = fVar15 * fVar3;
  ...
  if (lVar13 == 0) {
    ...
    lVar13 = FUN_140150040(*(longlong *)(param_1 + 200) + 0x1630,pcVar14);
    *(longlong *)(param_1 + 0x5c0) = lVar13;
    if (lVar13 != 0) goto code_r0x00014025841c;
  }
  else {
code_r0x00014025841c:
    *(char *)(lVar13 + 0x1f0) = (*(int *)(param_1 + 0x32c) == 0x1f) + '\x01';
    FUN_140156090(*(undefined8 *)(param_1 + 0x5c0));
    (**(code **)(**(longlong **)(param_1 + 0x2d8) + 8))();
    FUN_140157500(*(undefined8 *)(param_1 + 0x5c0));
  }
  lVar13 = *(longlong *)(param_1 + 200);
  plVar1 = (longlong *)(lVar13 + 0x30);
  *plVar1 = *plVar1 + -0x40;
  *(undefined1 *)(lVar13 + 0x1ca) = 1;
code_r0x000140258478:
  fVar18 = fVar18 * _UNK_140492a7c;
  fVar17 = fVar16 * DAT_140492790 - fVar17;
  if (fVar2 < 0.0) {
    fVar18 = fVar18 - fVar2;
  }
  puVar10 = *(undefined8 **)(*(longlong *)(param_1 + 200) + 0x30);
  ...
  *(char *)(lVar11 + 0x19d8) = (*(int *)(param_1 + 0x32c) == 0x1f) + '\x01';
  if (*(int *)(param_1 + 0x518) != 0) {
    FUN_140258d10(param_1);
  }
  if ((*(uint *)(*(longlong *)(param_1 + 200) + 0x118) & 0x2000) != 0) {
    fVar19 = *(float *)(param_1 + 0x340);
  }
  fStack_c0 = fVar19 * *(float *)(param_1 + 0x338);
  uStack_c8 = CONCAT44((float)((ulonglong)*(undefined8 *)(param_1 + 0x330) >> 0x20) * fVar19,
                       (float)*(undefined8 *)(param_1 + 0x330) * fVar19);
  FUN_1401b3500(lVar11 + 0x18a0,*(undefined8 *)(param_1 + 0x5a8),0,0,&uStack_c8,
