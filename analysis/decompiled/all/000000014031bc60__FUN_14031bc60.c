// Function: FUN_14031bc60
// Addr: 14031bc60
// Size: 676 bytes


int FUN_14031bc60(longlong *param_1,undefined8 param_2)

{
  ...
  if ((*(byte *)(lVar9 + 8) & 2) != 0) {
    ...
    if (iVar6 == 0) {
      *(undefined4 *)(param_1 + 8) = local_res8[0];
      ...
      lVar9 = FUN_1402f0420(**(undefined8 **)(*param_1 + 0x3e0),"pshinter");
      if ((((lVar9 != 0) && (puVar3 != (undefined8 *)0x0)) &&
        ...
        while (uVar10 != 0) {
          ...
          if (iVar6 == iVar1) {
            ...
            uVar7 = FUN_1402f20b0(uVar7,iVar6,iVar1);
            uVar8 = FUN_1402f20b0((int)param_1[4],iVar6,iVar1);
          }
  ...
  iVar6 = FUN_1402f4580(*param_1,param_2);
  if (iVar6 == 0) {
    puVar3 = (undefined8 *)(*(undefined8 **)(*param_1 + 0x3e0))[0x21a];
    lVar9 = FUN_1402f0420(**(undefined8 **)(*param_1 + 0x3e0),"pshinter");
    if (((lVar9 != 0) && (puVar3 != (undefined8 *)0x0)) &&
      ...
      while (uVar10 != 0) {
        ...
        if (iVar1 == iVar2) {
          ...
          uVar7 = FUN_1402f20b0(uVar7,iVar1,iVar2);
          uVar8 = FUN_1402f20b0((int)param_1[4],iVar1,iVar2);
        }
        (**(code **)(lVar9 + 8))(puVar3[uVar11 + 1],uVar7,uVar8,0,0);
      }
    }
