// Function: FUN_1401891a0
// Addr: 1401891a0
// Size: 3176 bytes


void FUN_1401891a0(longlong param_1,float param_2)

{
  ...
  if (lVar23 != lVar24) {
    do {
      ...
      if (((*(byte *)(plVar25 + 0x24) & 1) != 0) &&
         ((plVar25[0x30] == 0 || (cVar18 = FUN_140185010(), cVar18 != '\0')))) break;
      plVar25 = (longlong *)0x0;
    } while (lVar23 != lVar24);
  }
  fVar38 = DAT_140492830;
  ...
  *(undefined4 *)(param_1 + 0x148) = *(undefined4 *)(param_1 + lVar23);
  if (plVar25 != (longlong *)0x0) {
    ...
    *(undefined4 *)(param_1 + 0x114) = uVar2;
    ...
    if ((char)*(uint *)(param_1 + 0xe0) < '\0') {
      FUN_140199580(param_1,(undefined4 *)(param_1 + 0xf0),param_1 + 0xfc);
    }
    goto LAB_140189b12;
  }
  if (bVar16) {
    ...
    *(undefined4 *)(param_1 + 0x114) = *(undefined4 *)(param_1 + 0x13c);
    if (cVar18 < '\0') {
      FUN_140199580(param_1,(undefined8 *)(param_1 + 0xf0));
    }
    goto LAB_140189b12;
  }
  ...
  if (*(float *)(param_1 + 0xec) < fVar36) {
    if (uVar27 < uVar19) {
      local_res8 = *(float *)(uVar27 * 0x2c + lVar23);
    }
    else {
      local_res8 = 0.0;
    }
    local_res8 = local_res8 + fVar36;
LAB_1401899f7:
    ...
    *(undefined4 *)(param_1 + 0x110) = *(undefined4 *)(lVar24 + 0x24 + lVar23);
    ...
    if (uVar19 <= uVar27) {
      local_res8 = *(float *)(plVar8 + uVar26 * 4 + 3) - fVar36;
      goto LAB_1401899f7;
    }
    ...
    fVar38 = (fVar37 - fVar30) * DAT_1404926c0;
    *(float *)(param_1 + 0xf0) =
         ((fVar29 - fVar29) * DAT_1404926c0 + fVar31) * fVar33 + fVar43 * fVar29 +
         ((fVar28 - fVar28) * DAT_1404926c0 + fVar31) * fVar41 + fVar44 * fVar28;
    fVar28 = DAT_1404926c0;
    fVar36 = (fVar37 - fVar37) * DAT_1404926c0;
    *(float *)(param_1 + 0xf4) =
         ((fVar35 - fVar35) * DAT_1404926c0 + fVar34) * fVar33 + fVar43 * fVar35 +
         ((fVar32 - fVar32) * DAT_1404926c0 + fVar34) * fVar41 + fVar44 * fVar32;
    fVar32 = DAT_1404926c0;
    *(float *)(param_1 + 0xf8) =
         ((fVar30 - fVar30) * fVar28 + fVar38) * fVar33 + fVar43 * fVar30 +
         (fVar36 + fVar38) * fVar41 + fVar44 * fVar37;
    fVar37 = DAT_1404926c0;
    ...
    fVar39 = (fVar29 - fVar29) * DAT_1404926c0;
    fVar42 = (fVar36 - fVar36) * DAT_1404926c0;
    *(float *)(param_1 + 0xfc) =
         ((fVar38 - fVar38) * DAT_1404926c0 + fVar31) * fVar33 + fVar43 * fVar38 +
    ...
    *(float *)(param_1 + 0x104) =
    ...
    fVar42 = (fVar29 - fVar29) * DAT_1404926c0;
    fVar31 = (fVar36 - fVar36) * DAT_1404926c0;
    *(float *)(param_1 + 0x108) =
         ((fVar38 - fVar38) * DAT_1404926c0 + fVar32) * fVar33 + fVar43 * fVar38 +
    ...
    *(float *)(param_1 + 0x10c) =
    ...
    fVar34 = DAT_1404926c0;
    *(float *)(param_1 + 0x110) =
         ((fVar30 - fVar30) * DAT_1404926c0 + fVar39) * fVar33 + fVar43 * fVar30 +
         ((fVar35 - fVar35) * DAT_1404926c0 + fVar39) * fVar41 + fVar44 * fVar35;
  ...
  *(float *)(param_1 + 0x114) = fVar36;
  if (cVar18 < '\0') {
    FUN_140199580(param_1,param_1 + 0xf0,param_1 + 0xfc);
  }
  fVar36 = param_2 + *(float *)(param_1 + 0xec);
  *(float *)(param_1 + 0xec) = fVar36;
  if (local_res8 < fVar36) {
...
LAB_140189b12:
  ...
  if (DAT_140492900 <= *(float *)(param_1 + 0x148)) {
    fVar36 = DAT_140492900;
  }
  fVar29 = DAT_140492654;
  if (DAT_140492654 <= fVar36) {
    fVar29 = fVar36;
  }
  *(float *)(param_1 + 0x148) = fVar29;
  if ((*(uint *)(param_1 + 0xe0) & 0x100) != 0) {
    ...
    if (0.0 < *(float *)(param_1 + 0x338)) {
      param_2 = (fVar17 - *(float *)(param_1 + 0x338) / fVar38) * DAT_140492868 * param_2;
      if (fVar17 <= param_2) {
        param_2 = fVar17;
      }
  ...
  *(undefined4 *)(lVar23 + 0x70) = uVar2;
  puVar21 = (undefined8 *)
            FUN_14019d920(local_f8,*(longlong *)(param_1 + 0xd8) + 0x68,param_1 + 0xfc,
                          param_1 + 0x108);
  uVar3 = puVar21[1];
