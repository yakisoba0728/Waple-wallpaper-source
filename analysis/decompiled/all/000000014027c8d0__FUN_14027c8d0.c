...
void FUN_14027c8d0(longlong *param_1,longlong *param_2,longlong param_3)

{
  ...
  local_2e8 = 0.0;
  dStack_2e0 = 0.0;
  FUN_140280ac0(local_2c8,param_3);
...
LAB_14027cca0:
              ...
              if (iVar20 != 0) {
                ...
                local_1f8 = local_2d0;
                cVar17 = FUN_14027de00(&local_200,local_2d0,lVar5,local_318);
                if (cVar17 != '\0') goto LAB_14027cfec;
              }
              ...
              if (iVar23 < iVar6 + -1) {
                ...
                local_1d0 = local_2d0;
                cVar17 = FUN_14027de00(&local_1d8,local_2d0,lVar5,local_300);
                if (cVar17 != '\0') goto LAB_14027cfec;
              ...
              if (iVar20 < iVar28) {
                ...
                local_1a8 = local_2d0;
                cVar17 = FUN_14027de00(&local_1b0,local_2d0,lVar5,local_308);
                iVar22 = iVar21;
                if (cVar17 != '\0') goto LAB_14027cfec;
              }
              if ((0 < iVar23) && (iVar20 != 0)) {
                ...
                local_188 = dVar32;
                local_180 = local_2d0;
                cVar17 = FUN_14027df40(&local_188,lVar18,lVar5,local_310,local_318,
                                       lVar7 + lVar18 * 4);
                if (cVar17 != '\0') goto LAB_14027cfec;
              }
              if ((iVar23 < iVar6 + -1) && (iVar20 != 0)) {
                ...
                local_160 = dVar32;
                local_158 = local_2d0;
                cVar17 = FUN_14027df40(&local_160,lVar18,lVar5,local_300,local_318,
                                       lVar7 + lVar18 * 4);
                if (cVar17 != '\0') goto LAB_14027cfec;
              }
              if ((0 < iVar23) && (iVar20 < iVar28)) {
                ...
                local_138 = dVar32;
                local_130 = local_2d0;
                cVar17 = FUN_14027df40(&local_138,local_2d0,lVar5,local_310,local_308,
              ...
              if ((iVar23 < iVar6 + -1) && (iVar20 < iVar28)) {
                ...
                local_110 = dVar32;
                local_108 = local_2d0;
                cVar17 = FUN_14027df40(&local_110,local_2d0,lVar5,local_300,local_308,
                                       lVar7 + ((longlong)(iVar26 + 3) + (longlong)iVar27) * 4);
                if (cVar17 != '\0') goto LAB_14027cfec;
              }
              bVar19 = 0;
              ...
              local_220 = local_2d0;
              cVar17 = FUN_14027de00(&local_228,local_2d0,lVar5,local_310);
              if (cVar17 == '\0') goto LAB_14027cca0;
LAB_14027cfec:
              bVar19 = 1;
            }
            pbVar1 = (byte *)(*param_1 + (longlong)(iVar20 * (int)param_1[2]) + (longlong)iVar23);
