// Function: FUN_1401a0d70
// Addr: 1401a0d70
// Size: 576 bytes


undefined8 * FUN_1401a0d70(float *param_1,undefined8 *param_2,byte *param_3)
  ...
  *puVar2 = puVar4;
  ...
  if (puVar3 == *(undefined8 **)(param_1 + 2)) {
    *(undefined8 **)(lVar1 + uVar5 * 0x10) = puVar4;
    ...
    if (*(undefined8 **)(lVar1 + 8 + uVar5 * 0x10) != puVar2) goto LAB_1401a0f92;
  }
