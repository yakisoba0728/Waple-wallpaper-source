// Function: FUN_140311840
// Addr: 140311840
// Size: 709 bytes


void FUN_140311840(longlong param_1,uint param_2,longlong param_3,longlong param_4)

{
    ...
    do {
      ...
      if (iVar10 < iVar7) {
        if (iVar7 < *(int *)(lVar14 + 0x10)) {
          uVar6 = FUN_1402efa10(iVar7 - iVar10,*(int *)(lVar14 + 0x10) - iVar10);
        }
        else {
          uVar6 = 0x10000;
        }
        ...
        if (*(int *)(lVar14 + 8) < iVar7) {
          uVar6 = FUN_1402efa10(iVar7 - iVar10,iVar10 - *(int *)(lVar14 + 8));
        }
        else {
          uVar6 = 0xffff0000;
        }
  ...
  if (puVar4 != (undefined8 *)0x0) {
        ...
        if (1 < *puVar15) {
          ...
          do {
            ...
            if (iVar10 < iVar7) {
              ...
              iVar10 = FUN_1402f20b0(iVar10 - *(int *)(lVar14 + lVar8),
    ...
    if ((puVar4[2] != 0) &&
       (lVar8 = FUN_1402f7ff0(uVar2,4,0,uVar11,0,local_res10), local_res10[0] == 0)) {
      ...
      *(longlong *)(*(longlong *)(param_1 + 0x408) + 0x10) = param_4;
      if (*puVar3 != 0) {
        do {
          ...
          iVar7 = FUN_140308620(param_1,puVar4 + 1,uVar6);
