// Function: FUN_1403f61f0
// Addr: 1403f61f0
// Size: 646 bytes


void FUN_1403f61f0(longlong param_1,undefined8 param_2)
  ...
  if (7 < *(uint *)(param_1 + 0x1c)) {
    ...
    if (5 < uVar1) {
      do {
        ...
        local_38 = local_58 + *pdVar5;
        local_30 = dStack_50 + *pdVar6;
        ...
        dVar4 = local_30 + *pdVar6;
        dVar3 = local_38 + *pdVar5;
        local_48 = dVar3;
        local_40 = dVar4;
        FUN_1403bc950(param_2,&local_58,&local_38,&local_48);
        uVar9 = uVar8 + 6;
    ...
    FUN_1403ead60(param_1,param_2,&local_58);
  }
  return;
}
