// Function: FUN_1402cdf5c
// Addr: 1402cdf5c
// Size: 950 bytes


undefined8
FUN_1402cdf5c(ulonglong param_1,int param_2,longlong param_3,char param_4,undefined8 *param_5)

{
  ...
  if (iVar12 < iVar11) goto LAB_1402ce236;
  bVar5 = (byte)param_3;
      ...
      if ((uint)-iVar13 < 0x40) {
        ...
        if ((uVar14 != 0) || (bVar4)) {
          ...
          if (iVar12 == 0) {
            ...
            if (iVar12 != 0x200) goto LAB_1402ce0c2;
            bVar5 = bVar5 ^ 1;
          }
        }
        else {
      ...
      if ((uint)-iVar7 < 0x40) {
        ...
        if ((uVar14 != 0) || (bVar4)) {
          ...
          if (iVar7 == 0) {
            ...
            if (iVar7 != 0x200) goto LAB_1402ce1e3;
            bVar5 = bVar5 ^ 1;
          }
        }
        else {
