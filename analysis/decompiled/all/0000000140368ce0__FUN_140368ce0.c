...
void FUN_140368ce0(undefined4 *param_1,undefined8 *param_2,longlong param_3,undefined8 param_4)

{
  ...
  while( true ) {
    if ((longlong)(uVar5 & 0xfffffffffffffff0) < 0x201) {
      FUN_140362da0(param_1,param_2,param_4);
      return;
    }
    uVar5 = (longlong)param_2 - (longlong)param_1;
    if (param_3 < 1) break;
    ...
    if (0x28 < lVar8) {
      ...
      FUN_140364970(param_1,puVar6,param_1 + lVar8 * 8,param_4);
      FUN_140364970(local_58 + lVar8 * -4,local_58,local_58 + lVar8 * 4,param_4);
      puVar7 = puVar7 + lVar8 * -2;
      FUN_140364970(param_2 + -2 + lVar8 * -4,puVar7,param_2 + -2,param_4);
    }
    puVar4 = local_58;
    FUN_140364970(puVar6,local_58,puVar7,param_4);
    local_68 = param_4;
    FUN_140365920(&local_50,param_1,puVar4,param_2);
    puVar6 = puStack_48;
    puVar7 = local_50;
    ...
    if ((longlong)((longlong)local_50 - (longlong)param_1 & 0xfffffffffffffff0U) <
      ...
      FUN_140368ce0(param_1,local_50,param_3,param_4);
      puVar7 = param_2;
      param_1 = puVar6;
    }
    else {
      FUN_140368ce0(puStack_48,param_2,param_3,param_4);
    }
    uVar5 = (longlong)puVar7 - (longlong)param_1;
    param_2 = puVar7;
  }
  FUN_140363730(param_1,param_2,param_4);
  while (0x1f < (longlong)(uVar5 & 0xfffffffffffffff0)) {
    ...
    if (0x1f < (longlong)((longlong)param_2 - (longlong)param_1 & 0xfffffffffffffff0U)) {
      ...
      *(undefined4 *)((longlong)param_2 + -4) = uVar3;
      local_68 = param_4;
      FUN_140367a70(param_1,0,(longlong)puVar7 - (longlong)param_1 >> 4,&local_50);
    }
    param_2 = puVar7;
    uVar5 = (longlong)puVar7 - (longlong)param_1;
  }
