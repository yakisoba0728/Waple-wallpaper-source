// Function: FUN_1403cb7a0
// Addr: 1403cb7a0
// Size: 181 bytes


void FUN_1403cb7a0(longlong param_1,int param_2,int param_3,longlong param_4)

{
  ...
  pbVar7 = (byte *)((ulonglong)*(byte *)(param_1 + 8) * 0x100 +
  ...
  lVar4 = (ulonglong)*(byte *)(param_1 + 0xc) * 0x100 +
