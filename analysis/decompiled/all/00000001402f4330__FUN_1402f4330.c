// Function: FUN_1402f4330
// Addr: 1402f4330
// Size: 588 bytes


int FUN_1402f4330(longlong param_1,longlong param_2,undefined4 param_3)

{
  ...
  if ((*(uint *)(*(longlong *)(param_2 + 0xf0) + 0x30) & 0x100000) != 0) {
    ...
    if ((((lVar8 != 0) && (uVar1 = *(uint *)(param_2 + 0x18), uVar1 < *(uint *)(lVar8 + 0x10))) &&
      ...
      iVar4 = FUN_1402f2220(lVar8,0);
      if (iVar4 == 0) {
        lVar7 = *(longlong *)(lVar8 + 0x2d0);
        while (iVar4 = FUN_1402f12d0(lVar8,local_res20[0],
          ...
          if (((*(uint *)(lVar8 + 0x10) <= uVar1) || ((*(byte *)(lVar8 + 8) & 8) == 0)) ||
            ...
            *(undefined4 *)(param_2 + 0x60) = 0x62697473;
            FUN_1402efb60(*(undefined8 *)(lVar8 + 0x78));
            return 0;
          }
        }
        FUN_1402efb60(*(undefined8 *)(lVar8 + 0x78));
