// Function: FUN_140133a50
// Addr: 140133a50
// Size: 550 bytes


void FUN_140133a50(longlong param_1,longlong param_2,ulonglong param_3,undefined8 param_4,
                  code *param_5)

{
  ...
  while (lVar4 < lVar6) {
    ...
    *(undefined4 *)(param_1 + 0x14 + lVar5) = *(undefined4 *)(param_1 + 0x14 + lVar3);
    FUN_14000de40(param_1 + 0x18 + lVar5,param_1 + 0x18 + lVar3);
    FUN_14000de40(param_1 + 0x38 + lVar5,param_1 + 0x38 + lVar3);
    FUN_14000de40(param_1 + 0x58 + lVar5,param_1 + 0x58 + lVar3);
  ...
  if ((lVar4 == lVar6) && ((param_3 & 1) == 0)) {
    FUN_140132b40(lVar4 * 0x88 + param_1,param_3 * 0x88 + -0x88 + param_1);
    lVar4 = param_3 - 1;
  }
  while (param_2 < lVar4) {
    lVar6 = lVar4 + -1 >> 1;
    ...
    *(undefined4 *)(param_1 + 0x14 + lVar4) = puVar1[5];
    FUN_14000de40(lVar4 + param_1 + 0x18,lVar3 + param_1 + 0x18);
    FUN_14000de40(param_1 + 0x38 + lVar4,param_1 + 0x38 + lVar3);
    FUN_14000de40(param_1 + 0x58 + lVar4,param_1 + 0x58 + lVar3);
    *(undefined8 *)(param_1 + 0x78 + lVar4) = *(undefined8 *)(puVar1 + 0x1e);
    *(undefined4 *)(param_1 + 0x80 + lVar4) = puVar1[0x20];
    lVar4 = lVar6;
  }
  FUN_140132b40(lVar4 * 0x88 + param_1,param_4);
  return;
}
