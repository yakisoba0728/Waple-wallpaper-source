// Function: FUN_1401370e0
// Addr: 1401370e0
// Size: 598 bytes


longlong * FUN_1401370e0(longlong param_1,longlong *param_2,longlong *param_3)

{
  ...
  if (param_2[4] * 2 != 0) {
    ...
    } while (uVar9 < (ulonglong)(param_2[4] * 2));
  }
  ...
  do {
    ...
    FUN_140016770(plVar11 + 2);
    thunk_FUN_14028af80(plVar11,0x48);
      ...
      while (plVar12 != param_3) {
        ...
        if (plVar12[4] * 2 != 0) {
          do {
            ...
            uVar9 = uVar9 + 1;
            uVar10 = (uVar10 ^ *pbVar1) * 0x100000001b3;
          } while (uVar9 < (ulonglong)(plVar12[4] * 2));
        }
