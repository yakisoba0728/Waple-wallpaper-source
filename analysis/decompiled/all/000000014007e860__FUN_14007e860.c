// Function: FUN_14007e860
// Addr: 14007e860
// Size: 829 bytes


void FUN_14007e860(longlong *param_1)
    ...
    if (*(ulonglong *)(lVar2 + 0x10) < *(ulonglong *)(lVar2 + 0x38) >> 3) {
      ...
      if (plVar13 != plVar3) {
        ...
        do {
          ...
          FUN_140017240(plVar6 + 0xe);
          FUN_140017240(plVar6 + 10);
          FUN_14003a630(plVar6 + 7);
            ...
            *plVar8 = (longlong)plVar6;
            while (plVar10 != plVar3) {
              ...
              while( true ) {
                ...
                FUN_140017240(plVar11 + 0xe);
                FUN_140017240(plVar11 + 10);
                FUN_14003a630(plVar11 + 7);
...
LAB_14007e9be:
      ...
      *(undefined8 *)plVar3[1] = 0;
      ...
      while (puVar12 != (undefined8 *)0x0) {
        ...
        FUN_140017240(puVar12 + 0xe);
        FUN_140017240(puVar12 + 10);
        FUN_14003a630(puVar12 + 7);
        FUN_140017240(puVar12 + 2);
        thunk_FUN_14028af80(puVar12,0x90);
        puVar12 = puVar4;
      }
