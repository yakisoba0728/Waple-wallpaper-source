// Function: FUN_1402c2930
// Addr: 1402c2930
// Size: 452 bytes


ulonglong FUN_1402c2930(longlong param_1,undefined1 param_2)
...
LAB_1402c29ae:
  ...
  if (*(int *)(param_1 + 0x30) < 0) {
    ...
    *(uint *)(param_1 + 0x28) = uVar6 & 0xfffffff7;
    func_0x0001402c196c(param_1 + 0x50,(longlong)*(int *)(param_1 + 0x30),
  ...
  *(undefined1 *)(param_1 + 0x4c) = 0;
  if (lVar8 == 8) {
    func_0x0001402c35cc(param_1,uVar7);
  }
  else {
    func_0x0001402c3244(param_1,uVar7 & 0xffffffff,param_2);
  }
