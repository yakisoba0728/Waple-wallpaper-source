// Function: FUN_14033c520
// Addr: 14033c520
// Size: 255 bytes


int FUN_14033c520(longlong *param_1,byte *param_2)

{
  ...
  do {
    ...
    if (bVar1 == 0x25) {
      ...
      iVar2 = FUN_14033c3e0(&local_res8,param_2);
    }
    else if (bVar1 == 0x3c) {
      do {
        local_res8 = local_res8 + 1;
        if (param_2 <= local_res8) goto code_r0x00014033c626;
        do {
          bVar1 = *local_res8;
