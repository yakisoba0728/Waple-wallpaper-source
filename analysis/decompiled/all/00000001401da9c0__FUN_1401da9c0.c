// Function: FUN_1401da9c0
// Addr: 1401da9c0
// Size: 789 bytes


undefined8 * FUN_1401da9c0(float *param_1,undefined8 *param_2,byte *param_3)

{
  ...
  *(undefined4 *)(puVar4 + 3) = 0x3f800000;
  FUN_14003e510(puVar4 + 6,0x10,puVar4[4]);
  ...
  *puVar2 = puVar4;
  ...
  if (puVar3 == *(undefined8 **)(param_1 + 2)) {
    *(undefined8 **)(lVar5 + uVar8 * 0x10) = puVar4;
    ...
    if (*(undefined8 **)(lVar5 + 8 + uVar8 * 0x10) != puVar2) goto LAB_1401dacb7;
  }
