...
void FUN_140284c20(double *param_1,undefined4 *param_2,longlong *param_3,longlong *param_4,
                  longlong *param_5)

{
  ...
  if (((((*(byte *)(param_4 + 1) & 1) != 0) &&
       (cVar15 = FUN_140284180(param_1 + 2,param_2,param_3,param_1), cVar15 != '\0')) ||
      (((*(byte *)(param_4 + 1) & 2) != 0 &&
       (cVar15 = FUN_140284180(param_1 + 8,param_2), cVar15 != '\0')))) ||
     (((*(byte *)(param_4 + 1) & 4) != 0 &&
      (cVar15 = FUN_140284180(param_1 + 0xe,param_2), cVar15 != '\0')))) {
    local_f8 = *param_1;
    ...
    uVar14 = _UNK_140492fd4;
    uVar13 = _DAT_140492fd0;
    dVar20 = (double)CONCAT44(uStack_d4,uStack_d8);
    if ((*(byte *)(param_4 + 1) & 1) != 0) {
      dVar19 = param_1[2];
      uVar17 = SUB84(dVar19,0) & _DAT_140492fd0;
      uVar18 = (uint)((ulonglong)dVar19 >> 0x20) & _UNK_140492fd4;
      dVar19 = (double)CONCAT44(uStack_dc & _UNK_140492fd4,local_e0 & _DAT_140492fd0);
    ...
    *(ulonglong *)(param_2 + 4) = CONCAT44(uStack_dc & uVar14,local_e0 & uVar13);
    ...
    uVar12 = DAT_140492778;
    dVar4 = *param_1 - *pdVar16;
    dVar5 = param_1[1] - pdVar16[1];
    pdVar16 = (double *)(**(code **)(*param_4 + 0x20))(param_4,&local_f8,DAT_140492778);
    ...
    if (dVar7 < 0.0) {
      dVar7 = (double)FUN_14041f780(SUB84(dVar7,0));
    }
    else {
      dVar7 = SQRT(dVar7);
    }
    ...
    if (dVar8 < 0.0) {
      dVar8 = (double)FUN_14041f780(SUB84(dVar8,0));
    }
    else {
      dVar8 = SQRT(dVar8);
    }
    ...
    uVar18 = (uint)((ulonglong)DAT_140492fe0 >> 0x20);
