// Function: thunk_FUN_140086610
// Addr: 140086c40
// Size: 5 bytes


undefined8 * thunk_FUN_140086610(undefined8 *param_1,uint param_2)

{
  ...
  if (*(char *)(param_1 + 1) == '\0') {
    ...
    uStack_a0._4_4_ = SUB84(uVar2,4);
    uStack_a0 = CONCAT44(uStack_a0._4_4_,(undefined4)uStack_a0) & 0xfffffffffffffeff;
    uStack_98 = 0;
    uStack_90 = 0;
    uStack_88 = 0;
...
code_r0x000140086b3d:
          ...
          uStack_a0 = CONCAT44(uStack_a0._4_4_,uVar16);
          goto code_r0x000140086b54;
        }
      }
      else {
