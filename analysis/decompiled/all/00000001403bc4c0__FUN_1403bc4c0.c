// Function: FUN_1403bc4c0
// Addr: 1403bc4c0
// Size: 867 bytes


int * FUN_1403bc4c0(longlong param_1,int *param_2,int param_3)

{
  ...
  do {
    ...
    if (cVar13 == '\0') {
      ...
      FUN_140371340(lVar25 + 6,pcVar23,param_3);
    }
    else if (cVar13 == '\x02') {
      FUN_14036fbd0((ulonglong)*(byte *)(lVar25 + 8) * 0x100 +
                    (ulonglong)*(byte *)(lVar25 + 9) + lVar25,pcVar23,param_3);
      FUN_14036fbd0((ulonglong)*(byte *)(lVar25 + 0xb) +
