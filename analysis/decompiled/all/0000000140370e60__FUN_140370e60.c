...
void FUN_140370e60(byte *param_1,char *param_2,undefined4 param_3)

{
  ...
  bVar3 = *param_1;
  bVar4 = param_1[3];
  uVar12 = (uint)bVar3 * 0x1000000 + (uint)bVar4 + (uint)bVar2 * 0x100 + (uint)bVar1 * 0x10000;
  if (uVar12 < 0x201) {
    uVar10 = 0;
    local_80[0] = 0;
    local_80[1] = 0;
    ...
    if (uVar12 != 0) {
      ...
      do {
        uVar9 = (uint)uVar10;
        uVar8 = uVar10;
        if ((uint)bVar3 * 0x1000000 + (uint)bVar4 + (uint)bVar1 * 0x10000 + (uint)bVar2 * 0x100 <=
            uVar9) {
          uVar8 = 1;
        }
        ...
        if ((((uint)param_1[uVar8 * 8 + lVar6 + 1] + (uint)param_1[uVar8 * 8 + lVar6] * 0x100 != 0)
            || (uVar11 = (uint)param_1[uVar8 * 8 + lVar6 + 3] +
                         (uint)param_1[uVar8 * 8 + lVar6 + 2] * 0x100, uVar11 >> 0xf != 0)) ||
           (((uVar11 & 0x3ff) != 0 &&
