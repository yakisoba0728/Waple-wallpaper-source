// Function: FUN_140392fa0
// Addr: 140392fa0
// Size: 467 bytes


undefined8 * FUN_140392fa0(undefined8 *param_1,longlong param_2)
  ...
  *param_1 = 0;
  ...
  if (*(code **)(param_2 + 0x20) == (code *)0x0) {
    ...
    piVar4 = (int *)(**(code **)(param_2 + 0x20))
                              (param_2,0x56415243,*(undefined8 *)(param_2 + 0x28));
    piVar6 = (int *)&DAT_14045dd10;
    if (piVar4 != (int *)0x0) {
      piVar6 = piVar4;
    }
  ...
  if (local_60 == 0) {
    ...
    cVar2 = FUN_140406190(local_60,local_68);
    FUN_1403beff0(local_68);
    if (cVar2 == '\0') {
