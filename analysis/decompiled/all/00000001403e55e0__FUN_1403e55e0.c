// Function: FUN_1403e55e0
// Addr: 1403e55e0
// Size: 635 bytes


longlong FUN_1403e55e0(longlong *param_1,undefined8 param_2)
...
LAB_1403e5802:
      FUN_1403f3cf0(uVar10,lVar8,param_2);
    }
    else {
      ...
      *(uint *)(lVar8 + 0x14) = uVar9;
      ...
      lVar8 = *param_1;
      if (uVar10 == 10) goto LAB_1403e5802;
      if (uVar10 == 0xf) {
        FUN_1403f5160(lVar8);
        *(undefined4 *)(lVar8 + 0x1c) = 0;
      }
      else {
        if (uVar10 != 0x10) goto LAB_1403e5802;
        FUN_1403f22d0(lVar8);
