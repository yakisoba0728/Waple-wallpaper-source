// Function: FUN_14017b610
// Addr: 14017b610
// Size: 816 bytes


void FUN_14017b610(longlong *param_1)
    ...
    if (*(ulonglong *)(lVar2 + 0x10) < *(ulonglong *)(lVar2 + 0x38) >> 3) {
      ...
      if (plVar13 != plVar3) {
        ...
        do {
          ...
          FUN_140031b80(plVar6 + 0xb);
          FUN_140017240(plVar6 + 7);
          FUN_140017240(plVar6 + 2);
          thunk_FUN_14028af80(plVar6,0x78);
            ...
            *plVar8 = (longlong)plVar6;
            while (plVar10 != plVar3) {
              ...
              while( true ) {
                ...
                FUN_140031b80(plVar11 + 0xb);
                FUN_140017240(plVar11 + 7);
                FUN_140017240(plVar11 + 2);
                thunk_FUN_14028af80(plVar11,0x78);
                *(longlong *)(lVar2 + 0x10) = *(longlong *)(lVar2 + 0x10) + -1;
...
LAB_14017b765:
      ...
      *(undefined8 *)plVar3[1] = 0;
      ...
      while (puVar12 != (undefined8 *)0x0) {
        ...
        FUN_140031b80(puVar12 + 0xb);
        FUN_140017240(puVar12 + 7);
        FUN_140017240(puVar12 + 2);
        thunk_FUN_14028af80(puVar12,0x78);
        puVar12 = puVar4;
      }
