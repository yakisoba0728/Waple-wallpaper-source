// Function: FUN_1403bd510
// Addr: 1403bd510
// Size: 714 bytes


void FUN_1403bd510(longlong param_1,char param_2)

{
  ...
  iVar6 = FUN_1403bd260(param_1,param_2,uVar2);
  if (iVar6 != 0) {
...
switchD_1403bd67b_caseD_2002:
      ...
      if (0x3000 < uVar2) goto switchD_1403bd67b_caseD_200b;
      if (uVar2 == 0x3000) {
switchD_1403bd67b_caseD_2001:
        uVar8 = 0x100;
      }
      else {
        switch(uVar2) {
        case 0x2001:
        case 0x2003:
          goto switchD_1403bd67b_caseD_2001;
        case 0x2002:
          goto switchD_1403bd67b_caseD_2002;
        case 0x2004:
          uVar8 = 0x300;
          break;
        case 0x2005:
        ...
        case 0x200a:
          ...
          break;
        default:
          goto switchD_1403bd67b_caseD_200b;
        case 0x202f:
          uVar8 = 0x1500;
          break;
        case 0x205f:
...
switchD_1403bd67b_caseD_200b:
    if (uVar2 != 0x2011) goto LAB_1403bd7c5;
    lVar4 = *(longlong *)(param_1 + 0x10);
    local_res8[0] = 0;
    lVar5 = *(longlong *)(*(longlong *)(lVar4 + 0x90) + 0x10);
    uVar7 = 0;
