...
undefined8 FUN_140341d00(longlong param_1,undefined8 param_2,undefined4 param_3)

{
  ...
  if (*(uint *)(param_1 + 0x2c) < uVar5) {
    *(undefined8 *)(param_1 + 0x38) = param_2;
    uVar4 = FUN_1402f7ff0(param_2,4,*(uint *)(param_1 + 0x2c),uVar5,*(undefined8 *)(param_1 + 0x30),
                          local_res8);
  ...
  for (; iVar6 != 0; iVar6 = iVar6 + -1) {
    ...
    if (((uVar5 != 0) &&
        (iVar3 = FUN_14034c7e0((ulonglong)uVar5 + *(longlong *)(param_1 + 0x18),param_3), iVar3 != 0
        )) || ((uVar5 = CONCAT31(CONCAT21(CONCAT11(puVar1[7],puVar1[8]),puVar1[9]),puVar1[10]),
               uVar5 != 0 &&
               (iVar3 = FUN_14034c880((ulonglong)uVar5 + *(longlong *)(param_1 + 0x18),param_3),
               iVar3 != 0)))) {
