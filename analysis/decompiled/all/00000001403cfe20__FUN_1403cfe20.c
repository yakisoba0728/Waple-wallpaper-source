// Function: FUN_1403cfe20
// Addr: 1403cfe20
// Size: 249 bytes


uint FUN_1403cfe20(byte *param_1,uint param_2)

{
  ...
  if ((ushort)((ushort)*param_1 * 0x100 + (ushort)param_1[1]) != 10) {
    pbVar2 = (byte *)FUN_1403cf680(param_1);
  ...
  if ((param_2 < uVar4) ||
    ...
    uVar4 = (uint)DAT_14045dd10._2_1_ * 0x100 + (uint)DAT_14045dd10._1_1_ * 0x10000 +
            (uint)(byte)DAT_14045dd10 * 0x1000000 + (uint)DAT_14045dd10._3_1_;
  }
  else {
    uVar5 = 0;
