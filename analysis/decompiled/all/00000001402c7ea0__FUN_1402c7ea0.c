...
ulonglong FUN_1402c7ea0(ulonglong param_1,undefined2 *param_2,ulonglong param_3,longlong param_4,
...

{
  ...
  if (param_5 == (undefined4 *)0x0) {
    ...
    if (DAT_1404e45dc == 0) goto LAB_1402c7f0f;
  }
  else {
    uVar4 = *param_5;
    uVar5 = param_5[1];
...
LAB_1402c7f0f:
  ...
  if ((param_4 == 0) || ((param_3 != 0 && (param_2 == (undefined2 *)0x0)))) {
    ...
    local_4f9 = 0;
    local_508 = 0;
    if (((param_1 & 2) != 0) || (local_500 = 0, param_2 == (undefined2 *)0x0)) {
      local_500 = 1;
    }
    local_4b0 = local_4f8;
    local_498 = 0;
        ...
        if (param_3 != 0) {
          if (iVar1 < 0) {
            *param_2 = 0;
            ...
            if (local_508 != param_3) goto LAB_1402c8085;
            param_2[param_3 - 1] = 0;
          }
        }
        goto LAB_1402c808a;
...
LAB_1402c8085:
      ...
      if ((iVar1 < 0) || (uVar3 <= param_3)) goto LAB_1402c808a;
    }
    FUN_1402d9040(uStack_60);
  }
  uVar3 = 0xffffffff;
