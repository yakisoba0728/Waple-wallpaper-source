// Function: FUN_14014e850
// Addr: 14014e850
// Size: 754 bytes


longlong * FUN_14014e850(float *param_1,longlong *param_2,undefined8 *param_3)

{
  ...
  if (*(longlong *)(param_1 + 4) == 0x1642c8590b21642) {
                    /* WARNING: Subroutine does not return */
    FUN_14028c2e0("unordered_map/set too long");
  }
  puVar4 = (undefined8 *)FUN_14028af20(0xb8);
  ...
  if (*param_1 < (float)(*(longlong *)(param_1 + 4) + 1) / (float)uVar5) {
    ...
    if (puVar8 != *(undefined8 **)(param_1 + 2)) {
      ...
      while( true ) {
        ...
        if (local_38 == puVar2) goto LAB_14014eaca;
  ...
  *puVar8 = puVar4;
  ...
  if (puVar2 == *(undefined8 **)(param_1 + 2)) {
    *(undefined8 **)(lVar6 + uVar10 * 0x10) = puVar4;
    ...
    if (*(undefined8 **)(lVar6 + 8 + uVar10 * 0x10) != puVar8) goto LAB_14014eb1a;
  }
