// Function: FUN_140365e60
// Addr: 140365e60
// Size: 945 bytes


void FUN_140365e60(ulonglong *param_1,uint *param_2,uint *param_3,uint *param_4)
  ...
  if (param_2 < param_3) {
    while( true ) {
      ...
      if (uVar2 < uVar3) {
        ...
        iVar10 = FUN_1403b38b0(param_3 + -4,param_3 + 2);
      }
      if (iVar10 < 0) break;
      if (uVar3 < uVar2) {
        iVar10 = -1;
        ...
        iVar10 = FUN_1403b38b0(param_3 + 2,param_3 + -4);
      }
  ...
  if (puVar12 < param_4) {
    ...
    while( true ) {
      ...
      if (uVar3 < uVar2) {
        ...
        iVar10 = FUN_1403b38b0(puVar12 + 2,param_3 + 2);
      }
      puVar13 = puVar12;
      if (iVar10 < 0) break;
      if (uVar2 < uVar3) {
        ...
        iVar10 = FUN_1403b38b0(param_3 + 2,puVar12 + 2);
      }
      if ((iVar10 < 0) || (puVar12 = puVar12 + 6, puVar13 = puVar12, param_4 <= puVar12)) break;
    }
  }
joined_r0x000140365fe4:
  do {
    if (param_4 <= puVar12) {
joined_r0x0001403660bc:
      while (puVar9 = param_3, puVar8 = puVar11, puVar11 = puVar8, param_2 < puVar9) {
        ...
        if (uVar2 < uVar3) {
          ...
          iVar10 = FUN_1403b38b0(puVar9 + -4,puVar8 + 2);
        }
        if (-1 < iVar10) {
          if (uVar3 < uVar2) {
            iVar10 = -1;
            ...
            iVar10 = FUN_1403b38b0(puVar8 + 2,puVar9 + -4);
          }
          if (iVar10 < 0) break;
          puVar11 = puVar8 + -6;
          if (puVar11 != param_3) {
    ...
    if (uVar3 < uVar2) {
      ...
      iVar10 = FUN_1403b38b0(puVar11 + 2,puVar12 + 2);
    }
    if (-1 < iVar10) {
      if (uVar2 < uVar3) {
        iVar10 = -1;
        ...
        iVar10 = FUN_1403b38b0(puVar12 + 2,puVar11 + 2);
      }
      if (iVar10 < 0) goto joined_r0x0001403660bc;
      if (puVar13 != puVar12) {
        uVar2 = puVar12[1];
        uVar3 = puVar12[2];
        uVar4 = puVar12[3];
