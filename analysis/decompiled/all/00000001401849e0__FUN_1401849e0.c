// Function: FUN_1401849e0
// Addr: 1401849e0
// Size: 1276 bytes


void FUN_1401849e0(float *param_1,longlong param_2)
...
LAB_140184bdb:
    ...
    *param_1 = fVar16;
    ...
    if (iVar14 != 0) {
      if (iVar14 == 1) goto LAB_140184bf9;
      if (iVar14 == 2) goto LAB_140184b8f;
      if (iVar14 == 3) goto LAB_140184c63;
    }
    param_1[4] = fVar16;
    fVar16 = *(float *)(param_2 + 4 + lVar15 * 0x10) + *(float *)(param_2 + 0xc + lVar15 * 0x10);
    if (iVar14 != 0) {
      if (iVar14 == 1) goto LAB_140184c0c;
      if (iVar14 == 2) goto LAB_140184ba2;
      if (iVar14 == 3) goto LAB_140184c76;
    }
    param_1[8] = fVar16;
    fVar16 = *(float *)(param_2 + 0xc + lVar15 * 0x10) - *(float *)(param_2 + 4 + lVar15 * 0x10);
    if (iVar14 != 0) {
      if (iVar14 == 1) goto LAB_140184c1f;
      if (iVar14 == 2) goto LAB_140184bb5;
      if (iVar14 == 3) goto LAB_140184c89;
    }
    param_1[0xc] = fVar16;
    fVar16 = *(float *)(param_2 + 8 + lVar15 * 0x10) + *(float *)(param_2 + 0xc + lVar15 * 0x10);
    if (iVar14 != 0) {
      if (iVar14 == 1) goto LAB_140184c32;
      if (iVar14 == 2) goto LAB_140184bc8;
      if (iVar14 == 3) goto LAB_140184c9c;
    }
    param_1[0x10] = fVar16;
    fVar16 = *(float *)(param_2 + 0xc + lVar15 * 0x10) - *(float *)(param_2 + 8 + lVar15 * 0x10);
    if (iVar14 != 0) {
      if (iVar14 == 1) goto LAB_140184c45;
      if (iVar14 == 2) goto LAB_140184bdb;
      if (iVar14 == 3) goto LAB_140184caf;
    }
    iVar14 = iVar14 + 1;
    param_1[0x14] = fVar16;
  } while (iVar14 < 4);
