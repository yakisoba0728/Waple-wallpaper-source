// Function: FUN_1403eef50
// Addr: 1403eef50
// Size: 539 bytes


void FUN_1403eef50(longlong param_1,longlong param_2)
  ...
  *(char ***)(param_2 + 0x60) = &local_68;
  ...
  if ((*(char ***)(param_2 + 0x58) == &local_68) || ((*(char ***)(param_2 + 0x58))[2] != local_58))
  {
    ...
    if (iVar4 == 0) {
      ...
      lVar5 = FUN_1403c6690(pbVar6,(uint)*(byte *)(param_1 + 1) * 0x100 +
                                   (uint)*(byte *)(param_1 + 2));
      local_78 = 0;
      uStack_70 = 0;
      ...
      cVar3 = FUN_1403c7dc0(pbVar6,(uint)*(byte *)(param_1 + 1) * 0x100 +
      ...
      if (((lVar5 != 0) && (0 < *(int *)(param_2 + 0x80))) && (0 < *(int *)(param_2 + 0x84))) {
        ...
        *(int *)(param_2 + 0x84) = *(int *)(param_2 + 0x84) + -1;
        FUN_1403787c0(lVar5,auStackX_8,param_2);
        *(int *)(param_2 + 0x80) = *(int *)(param_2 + 0x80) + 1;
      }
      if (cVar3 != '\0') {
        lVar5 = *(longlong *)(param_2 + 0x10);
