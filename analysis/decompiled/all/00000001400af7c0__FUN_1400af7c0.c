// Function: FUN_1400af7c0
// Addr: 1400af7c0
// Size: 1132 bytes


char * FUN_1400af7c0(longlong param_1,longlong *param_2)
...
LAB_1400af991:
      *(int *)(param_1 + 0x2c) = (int)uVar8;
      iVar13 = 5;
switchD_1400af865_caseD_5:
      if (puVar14 != puVar10) {
        bVar15 = (byte)*puVar14;
        iVar13 = 6;
        puVar14 = (ushort *)((longlong)puVar14 + 1);
        goto switchD_1400af865_caseD_6;
      }
    }
    goto LAB_1400af8fd;
  }
  ...
  switch(iVar13) {
  case 1:
    goto switchD_1400af865_caseD_1;
  case 2:
    goto switchD_1400af865_caseD_2;
  case 3:
    goto LAB_1400af979;
  case 4:
joined_r0x0001400afa56:
    while (puVar14 != puVar10) {
      uVar11 = *(ulonglong *)(param_1 + 0xfdb0);
      uVar8 = uVar11 & 0xffffffffffffff;
      *(ulonglong *)(param_1 + 0xfdb0) = uVar8;
      ...
      uVar8 = (ulonglong)(byte)uVar4 << (bVar2 & 0x3f) | uVar8;
      *(ulonglong *)(param_1 + 0xfdb0) = uVar8;
      if (bVar2 == 8) goto LAB_1400af991;
      *(ulonglong *)(param_1 + 0xfdb0) = (ulonglong)(bVar2 + 8) << 0x38 | uVar8;
    }
    break;
  case 5:
    goto switchD_1400af865_caseD_5;
  case 6:
switchD_1400af865_caseD_6:
    if (puVar14 != puVar10) {
      bVar16 = (byte)*puVar14;
      iVar13 = 7;
      puVar14 = (ushort *)((longlong)puVar14 + 1);
      goto switchD_1400af865_caseD_7;
    }
    break;
  case 7:
switchD_1400af865_caseD_7:
    if (puVar14 != puVar10) {
      puVar14 = (ushort *)((longlong)puVar14 + 1);
      uVar9 = 0;
      *(byte *)(param_1 + 0x4a) = bVar15 >> 7;
      if (-1 < (char)bVar15) goto LAB_1400afbe5;
      uVar17 = 1 << (bVar15 & 7) + 1;
      for (; uVar9 < uVar17; uVar9 = uVar9 + 1) {
switchD_1400af865_caseD_8:
        if ((longlong)puVar10 - (longlong)puVar14 < 3) {
          *(undefined8 *)(param_1 + 0xfdb0) = 0;
          iVar13 = 9;
switchD_1400af865_caseD_9:
          while( true ) {
            if (puVar14 == puVar10) goto LAB_1400af8fd;
...
LAB_1400afbe5:
    ...
    break;
  case 8:
    goto switchD_1400af865_caseD_8;
  case 9:
    goto switchD_1400af865_caseD_9;
  default:
    bVar3 = false;
    goto LAB_1400af909;
  }
