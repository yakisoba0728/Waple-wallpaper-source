// Function: FUN_1400bab20
// Addr: 1400bab20
// Size: 628 bytes


char * FUN_1400bab20(longlong param_1,longlong *param_2)
...
switchD_1400bab8e_caseD_2:
            if ((longlong)puVar8 - (longlong)puVar10 < 4) {
              *(undefined8 *)(param_1 + 0xae30) = 0;
              iVar4 = 3;
switchD_1400bab8e_caseD_3:
              while( true ) {
                if (puVar10 == puVar8) goto LAB_1400bad3a;
          ...
          if (iVar4 != 0x4c546366) goto LAB_1400baccf;
        }
LAB_1400bacb6:
        pcVar3 = "#png: bad chunk";
        goto LAB_1400bad72;
      }
      if (cVar1 == 'f') goto LAB_1400bacb6;
...
LAB_1400bad3a:
        ...
        iVar9 = 1;
        goto switchD_1400bab8e_default;
      }
...
LAB_1400bad72:
    ...
    return pcVar3;
  case 2:
    goto switchD_1400bab8e_caseD_2;
  case 3:
    goto switchD_1400bab8e_caseD_3;
  case 4:
  case 5:
    goto switchD_1400bab8e_caseD_4;
  }
}
