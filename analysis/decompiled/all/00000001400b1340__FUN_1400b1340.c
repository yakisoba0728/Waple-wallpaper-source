// Function: FUN_1400b1340
// Addr: 1400b1340
// Size: 1339 bytes


char * FUN_1400b1340(longlong param_1,uint *param_2,longlong *param_3)

{
  ...
  if (param_2 == (uint *)0x0) {
    uVar3 = 0;
LAB_1400b1387:
    uVar5 = (&DAT_140482a50)[(uint)uVar3 & 0xf] +
            (&DAT_140482a50)[(uint)(uVar3 >> 0xc) & 0xf] +
            (&DAT_140482a50)[(uint)(uVar3 >> 8) & 0xf] + (&DAT_140482a50)[(uint)(uVar3 >> 4) & 0xf];
    ...
    if ((*param_2 & 0x30000) == 0) goto LAB_1400b1387;
    uVar3 = 0;
  }
    ...
    do {
      ...
      if (uVar5 < *(uint *)(param_1 + 0x2c)) {
        ...
        if (uVar18 < uVar4) {
          ...
          local_res10 = lVar11 + uVar16;
          if (local_res10 < uVar16) {
...
LAB_1400b1859:
        ...
        *puVar14 = *(uint *)(param_1 + 0x80);
        uVar5 = (uint)(byte)(&DAT_14047a4a4)[uVar4] + *(uint *)(param_1 + 0x94);
        ...
        if (*(byte *)(param_1 + 0x4b) != 0) {
          do {
            ...
            *(byte *)(param_1 + 0x4b) = bVar8;
            ...
            uVar5 = *(int *)(&DAT_14047a490 + (ulonglong)bVar8 * 4) + *(uint *)(param_1 + 0x84);
        ...
        if (bVar8 == 0) {
          ...
          *(uint *)(param_1 + 0x94) = uVar5;
          ...
          if (((*(longlong *)(param_1 + 0x78) == 0) && (*(char *)(param_1 + 0x5c) == '\0')) &&
            ...
            uVar12 = (byte)(&DAT_14047a408)[uVar4] + uVar5;
            if ((byte)(&DAT_14047a408)[uVar4] + uVar5 < uVar5) {
              uVar12 = 0xffffffff;
            }
          ...
          *(uint *)(param_1 + 0x94) = uVar5;
          if ((char)uVar4 != '\0') {
            do {
              ...
              uVar4 = (ulonglong)bVar8;
              *(byte *)(param_1 + 0x4b) = bVar8;
              uVar5 = *(int *)(&DAT_14047a490 + uVar4 * 4) + *(uint *)(param_1 + 0x84);
              if (uVar5 < *(uint *)(param_1 + 0x84)) {
                uVar5 = 0xffffffff;
              }
              *(uint *)(param_1 + 0x94) = uVar5;
