// Function: FUN_1403f7170
// Addr: 1403f7170
// Size: 690 bytes


undefined8 * FUN_1403f7170(undefined8 *param_1,undefined8 param_2,uint param_3)

{
  ...
  puVar2 = (undefined1 *)FUN_1403b32d0(puVar4);
  puVar10 = &DAT_14045dd10;
  puVar4 = &DAT_14045dd10;
  if (puVar5 != (undefined8 *)0x0) {
    puVar4 = puVar5;
  ...
  pbVar3 = (byte *)FUN_1403c27d0(lVar8,param_3,
  ...
  if (((pbVar3 != (byte *)0x0) && (puVar2[0x2c] != '\0')) && (puVar2[0x2d] != '\0')) {
    ...
    if ((uVar9 <= param_3) && (param_3 <= (uint)pbVar3[2] * 0x100 + (uint)pbVar3[3])) {
      ...
      cVar1 = FUN_1403cad50(puVar5,param_3 - uVar9,local_res8,local_res20,local_28);
      if (cVar1 != '\0') {
        ...
        if ((local_res8[0] <= *(uint *)(puVar10 + 3)) &&
          ...
          if (local_28[0] == 0x11) {
            ...
            puVar5 = (undefined8 *)
                     FUN_140413f90(puVar5,local_res8[0] + 4,
