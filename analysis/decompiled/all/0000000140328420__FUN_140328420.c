// Function: FUN_140328420
// Addr: 140328420
// Size: 936 bytes


void FUN_140328420(longlong param_1,undefined8 *param_2)
...
LAB_140328511:
        if ((pbVar15 < pbVar6) && (puVar1 = param_2 + 0x38, *(int *)(param_2 + 0x3b) == 0)) {
          ...
          while (local_res10 = iVar9, pbVar15 < pbVar6) {
            ...
            if (pbVar6 <= (byte *)*param_2) goto LAB_1403284eb;
            if (*(int *)(param_2 + 3) != 0) {
              return;
            }
            bVar3 = *pbVar15;
            if ((bVar3 == 0x2f) || (iVar9 = local_res10, local_res10 = iVar8, bVar3 == 0x28)) {
              if (pbVar6 <= pbVar15 + (ulonglong)(bVar3 == 0x28) + 2) goto LAB_1403284eb;
              pbVar15 = pbVar15 + 1;
