// Function: FUN_14037c0f0
// Addr: 14037c0f0
// Size: 210 bytes


undefined8 FUN_14037c0f0(byte *param_1,longlong param_2)

{
  ...
  if (iVar3 == 1) {
    ...
    if (iVar3 == 1) {
      uVar4 = FUN_1403c71c0(pbVar6,**(undefined4 **)(param_2 + 0x10));
    }
    else if (iVar3 == 2) {
      uVar4 = FUN_1403c7240(pbVar6,**(undefined4 **)(param_2 + 0x10));
    }
    else {
      uVar4 = 0xffffffff;
    }
    ...
    local_10 = (byte *)0x0;
    local_18 = FUN_1403ec2a0;
    uVar1 = func_0x000140413900(pbVar5,param_2,&local_18);
    return uVar1;
  }
  if (iVar3 != 2) {
    if (iVar3 == 3) {
      uVar1 = func_0x00014038e630(param_2,(uint)param_1[3] + (uint)param_1[2] * 0x100,param_1 + 8,
                                  FUN_1403ec220,param_1);
      return uVar1;
    }
    return 0;
  }
  ...
  uVar4 = func_0x0001403c6850(pbVar6,**(undefined4 **)(param_2 + 0x10));
