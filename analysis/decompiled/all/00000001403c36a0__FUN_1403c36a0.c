...
void FUN_1403c36a0(longlong param_1,undefined8 param_2)

{
  ...
  if (*(int *)(param_1 + 0x1c) == 0xb) {
    ...
    local_48 = local_38 + *pdVar4;
    local_40 = local_30 + *pdVar8;
    if ((double)CONCAT44((uint)((ulonglong)dVar9 >> 0x20) & _UNK_140492fd4,
                         SUB84(dVar9,0) & _DAT_140492fd0) <=
        (double)CONCAT44((uint)((ulonglong)dVar10 >> 0x20) & _UNK_140492fd4,
      ...
      local_78 = local_48 + *pdVar6;
      dStack_70 = *(double *)(param_1 + 0x11c8);
    }
    local_68 = dVar2;
    FUN_1403bc950(param_2,&local_88,&local_58,&local_68);
    auVar1._8_4_ = uVar11;
    auVar1._0_8_ = dVar2;
    auVar1._12_4_ = (int)uVar3;
    *(undefined1 (*) [16])(param_1 + 0x11c0) = auVar1;
    FUN_1403bc950(param_2,&local_38,&local_48,&local_78);
    *(double *)(param_1 + 0x11c0) = local_78;
