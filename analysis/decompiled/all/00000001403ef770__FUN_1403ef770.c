// Function: FUN_1403ef770
// Addr: 1403ef770
// Size: 377 bytes


void FUN_1403ef770(longlong param_1,longlong param_2,undefined4 param_3)

{
  ...
  FUN_1403f59c0(*(undefined8 *)(param_2 + 0x10),*(undefined8 *)(param_2 + 0x18),fVar11,
  ...
  if (*(longlong *)(lVar5 + 0x98) != 0) {
    uVar8 = *(undefined8 *)(*(longlong *)(lVar5 + 0x98) + 8);
                    ...
                    /* WARNING: Could not recover jumptable at 0x0001403ef8e5. Too many branches */
