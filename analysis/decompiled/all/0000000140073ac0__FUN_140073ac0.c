// Function: FUN_140073ac0
// Addr: 140073ac0
// Size: 483 bytes


void FUN_140073ac0(void)

{
  ...
  if (((byte)DAT_1404e52e4 & 0xc) == 0) {
    ...
    if ((byte)local_30 < 8) {
                    /* WARNING: Could not recover jumptable at 0x000140073c3e. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      (*(code *)(IMAGE_DOS_HEADER_140000000.e_magic +
                *(uint *)(&DAT_140073cdc + (ulonglong)(byte)local_30 * 4)))
