// Function: FUN_1401dadb0
// Addr: 1401dadb0
// Size: 5 bytes


undefined8 * FUN_1401dadb0(float *param_1,undefined8 *param_2,byte *param_3)

{
  ...
  puVar5 = (undefined8 *)func_0x00014028aff0(0x58);
  *(undefined4 *)(puVar5 + 2) = *(undefined4 *)param_3;
  ...
  if (*param_1 < (float)(*(longlong *)(param_1 + 4) + 1) / (float)uVar2) {
    ...
    func_0x0001401dc6a0(param_1,uVar8);
    puVar9 = *(undefined8 **)(param_1 + 2);
    puVar3 = *(undefined8 **)
              (*(longlong *)(param_1 + 6) + 8 + (uVar10 & *(ulonglong *)(param_1 + 0xc)) * 0x10);
    if (puVar3 != puVar9) {
  ...
  *puVar3 = puVar5;
  ...
  if (puVar4 == *(undefined8 **)(param_1 + 2)) {
    *(undefined8 **)(lVar6 + uVar10 * 0x10) = puVar5;
    ...
    if (*(undefined8 **)(lVar6 + 8 + uVar10 * 0x10) != puVar3) goto code_r0x0001401db015;
  }
  *(undefined8 **)(lVar6 + 8 + uVar10 * 0x10) = puVar5;
code_r0x0001401db015:
  *param_2 = puVar5;
  *(undefined1 *)(param_2 + 1) = 1;
  return param_2;
}
