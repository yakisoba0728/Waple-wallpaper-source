// Function: FUN_140134470
// Addr: 140134470
// Size: 816 bytes


void FUN_140134470(longlong *param_1)
    ...
    if (*(ulonglong *)(lVar2 + 0x10) < *(ulonglong *)(lVar2 + 0x38) >> 3) {
      ...
      if (plVar13 != plVar3) {
        ...
        do {
          ...
          FUN_140017240(plVar6 + 10);
          FUN_140017240(plVar6 + 6);
          FUN_140017240(plVar6 + 2);
          thunk_FUN_14028af80(plVar6,0x70);
          ...
          if (plVar6 == local_res20) {
            ...
            *plVar8 = (longlong)plVar6;
            while (plVar10 != plVar3) {
              ...
              if (plVar10[4] != 0) {
                do {
                  pbVar1 = (byte *)((longlong)plVar13 + uVar7);
                  uVar7 = uVar7 + 1;
                  uVar9 = (uVar9 ^ *pbVar1) * 0x100000001b3;
                } while (uVar7 < (ulonglong)plVar10[4]);
              }
              uVar9 = *(ulonglong *)(lVar2 + 0x30) & uVar9;
              plVar13 = *(longlong **)(local_res18 + 8 + uVar9 * 0x10);
              local_res10 = (longlong *)(local_res18 + uVar9 * 0x10);
              plVar11 = plVar10;
              while( true ) {
                plVar10 = (longlong *)*plVar11;
                FUN_140017240(plVar11 + 10);
                FUN_140017240(plVar11 + 6);
                FUN_140017240(plVar11 + 2);
                thunk_FUN_14028af80(plVar11,0x70);
                *(longlong *)(lVar2 + 0x10) = *(longlong *)(lVar2 + 0x10) + -1;
              ...
              *(longlong **)(local_res18 + 8 + uVar9 * 0x10) = plVar3;
            }
            goto LAB_1401345c5;
          }
          plVar6 = plVar10;
...
LAB_1401345c5:
      ...
      *(undefined8 *)plVar3[1] = 0;
      ...
      while (puVar12 != (undefined8 *)0x0) {
        ...
        FUN_140017240(puVar12 + 10);
        FUN_140017240(puVar12 + 6);
        FUN_140017240(puVar12 + 2);
        thunk_FUN_14028af80(puVar12,0x70);
        puVar12 = puVar4;
      }
      ...
      *(undefined8 *)(lVar2 + 0x10) = 0;
      ...
      FUN_1400325c0(*(undefined8 *)(lVar2 + 0x18),*(undefined8 *)(lVar2 + 0x20),&local_res8);
    }
  }
  return;
}
