// Function: FUN_140344d30
// Addr: 140344d30
// Size: 1093 bytes


undefined8 FUN_140344d30(longlong param_1,undefined8 param_2)

{
  ...
  if ((((local_res18[0] != 0) || (local_res20 = func_0x0001402f5570(param_2), local_res8[0] < 0xe))
      || (local_res18[0] = FUN_1402f5220(param_2,local_res8[0],&local_58), puVar4 = local_58,
         local_res18[0] != 0)) ||
     (puVar6 = (ushort *)func_0x0001402f7f60(uVar16,0x90,local_res18), local_res18[0] != 0))
  goto UNWIND_INFO_1403451ab_UnwindCodes_5__UnwindOpCode;
  ...
  *puVar6 = uVar10;
  if (uVar10 < 2) {
    ...
    if ((uVar14 < local_res8[0]) && ((uint)CONCAT11(uVar2,uVar1) <= (local_res8[0] - uVar14) / 6)) {
      ...
      {
        if (uVar10 != 1) goto LAB_140345158;
                ...
                *(undefined1 **)(puVar6 + 0x20) = puVar9;
                ...
                if (uVar8 < local_res8[0]) {
                  ...
                  *(undefined1 **)(puVar6 + 0x1c) = puVar12;
                  ...
                  puVar6[0x3e] = 0;
                  puVar6[0x3f] = 0;
                  if ((*(byte *)(param_1 + 0x410) & 1) == 0) goto LAB_140345158;
...
LAB_140345195:
  ...
  local_res18[0] = 8;
UNWIND_INFO_1403451ab_UnwindCodes_5__UnwindOpCode:
  FUN_1402f5cd0(param_2,&local_58);
                    /* WARNING: Subroutine does not return */
  FUN_1402f8060(uVar16,puVar6);
}
