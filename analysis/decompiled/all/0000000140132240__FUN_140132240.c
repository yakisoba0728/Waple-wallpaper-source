// Function: FUN_140132240
// Addr: 140132240
// Size: 1337 bytes


void FUN_140132240(int *param_1,int *param_2,longlong param_3,undefined1 param_4)
      ...
      if (param_1 != param_2) {
        for (piVar16 = param_1 + 5; piVar16 != param_2; piVar16 = piVar16 + 5) {
          ...
          if (iVar3 < *param_1) {
            ...
            FUN_1404211c0(param_1 + 5,param_1,(longlong)piVar16 - (longlong)param_1);
          }
          iVar2 = piVar16[-5];
          piVar13 = piVar16 + -5;
          piVar15 = piVar16;
    ...
    if (param_3 < 1) {
      ...
      do {
        if (1 < ((longlong)param_2 - (longlong)param_1 >> 2) * -0x3333333333333333) {
          uStack_78 = *(undefined8 *)(param_2 + -5);
          ...
          param_2[-2] = iVar5;
          param_2[-1] = param_1[4];
          func_0x000140133d50(param_1,0,
                              ((longlong)(param_2 + -5) - (longlong)param_1 >> 2) *
                              -0x3333333333333333,&uStack_78,param_4);
        }
        param_2 = param_2 + -5;
...
joined_r0x000140132568:
    if (piVar15 < param_2) {
      if (*piVar15 <= *piVar14) {
        if (*piVar15 < *piVar14) goto joined_r0x0001401325a5;
        if (piVar16 != piVar15) {
          iVar2 = piVar15[1];
          iVar5 = piVar15[2];
          iVar6 = piVar15[3];
      ...
      piVar15 = piVar15 + 5;
      goto joined_r0x000140132568;
    }
joined_r0x0001401325a5:
    ...
    if (((longlong)piVar14 - (longlong)param_1 >> 2) * -0x3333333333333333 <
      ...
      FUN_140132240(param_1,piVar14,param_3,param_4);
      piVar14 = param_2;
      param_1 = piVar16;
    }
    else {
      FUN_140132240(piVar16,param_2,param_3,param_4);
    }
