// Function: FUN_140407e40
// Addr: 140407e40
// Size: 341 bytes


ulonglong FUN_140407e40(byte *param_1,int *param_2)

{
  ...
  if (uVar10 <= uVar8) {
    ...
    if ((((ulonglong)(uint)param_2[6] < (ulonglong)((longlong)pbVar1 - *(longlong *)(param_2 + 2)))
       ...
       (param_2[7] = param_2[7] + iVar5 * -10, param_2[7] <= iVar7)) {
      cVar9 = '\0';
    }
    else {
      cVar9 = '\x01';
    ...
    uVar4 = FUN_1402fc370("SANITIZE",pbVar1,0,1,*param_2 + 1,0,
                          ...
                          uVar2,*(longlong *)(param_2 + 2),*(undefined8 *)(param_2 + 4),pcVar6);
    if (cVar9 != '\0') {
      return uVar8 & 0xff;
    }
  }
