// Function: FUN_140179af0
// Addr: 140179af0
// Size: 674 bytes


longlong * FUN_140179af0(float *param_1,longlong *param_2,undefined8 *param_3)
  ...
  if (*param_1 < (float)(*(longlong *)(param_1 + 4) + 1) / (float)uVar5) {
    ...
    if (puVar8 != *(undefined8 **)(param_1 + 2)) {
      ...
      while( true ) {
        ...
        if (local_38 == puVar2) goto LAB_140179d1a;
  ...
  *puVar8 = puVar4;
  ...
  if (puVar2 == *(undefined8 **)(param_1 + 2)) {
    *(undefined8 **)(lVar6 + uVar10 * 0x10) = puVar4;
    ...
    if (*(undefined8 **)(lVar6 + 8 + uVar10 * 0x10) != puVar8) goto LAB_140179d6a;
  }
