// Function: FUN_1401a8420
// Addr: 1401a8420
// Size: 394 bytes


void FUN_1401a8420(longlong param_1,ulonglong param_2)
...
joined_r0x0001401a84a2:
  do {
    while( true ) {
      if (plVar7 == plVar2) {
        uStackX_10 = 0;
        func_0x0001401a86c0(&uStackX_10);
        return;
      }
