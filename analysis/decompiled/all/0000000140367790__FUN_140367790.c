// Function: FUN_140367790
// Addr: 140367790
// Size: 310 bytes


ulonglong * FUN_140367790(ulonglong *param_1,ushort *param_2,ushort *param_3,ushort *param_4)
...
joined_r0x0001403677f3:
  do {
    if (param_4 <= puVar8) {
joined_r0x000140367835:
      ...
      goto joined_r0x0001403677f3;
    }
    if (*puVar8 <= *puVar6) {
      if (*puVar6 != *puVar8) goto joined_r0x000140367835;
      if (puVar9 != puVar8) {
