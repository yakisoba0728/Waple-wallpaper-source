// Function: FUN_14016e910
// Addr: 14016e910
// Size: 5 bytes


undefined8 * FUN_14016e910(float *param_1,undefined8 *param_2,byte *param_3)

{
  ...
  puVar5 = (undefined8 *)func_0x00014028aff0(0xa0);
  ...
  *(undefined4 *)((longlong)puVar5 + 0x84) = 0;
  ...
  if (*param_1 <= fVar9 && fVar9 != *param_1) {
    uVar6 = FUN_140013010(param_1);
    func_0x0001401651a0(param_1,uVar6);
    puVar8 = *(undefined8 **)(param_1 + 2);
    puVar2 = *(undefined8 **)
              (*(longlong *)(param_1 + 6) + 8 + (uVar7 & *(ulonglong *)(param_1 + 0xc)) * 0x10);
    if (puVar2 != puVar8) {
  ...
  *puVar2 = puVar5;
  ...
  if (puVar4 == *(undefined8 **)(param_1 + 2)) {
    *(undefined8 **)(lVar3 + uVar7 * 0x10) = puVar5;
    ...
    if (*(undefined8 **)(lVar3 + 8 + uVar7 * 0x10) != puVar2) goto code_r0x00014016eb81;
  }
  *(undefined8 **)(lVar3 + 8 + uVar7 * 0x10) = puVar5;
code_r0x00014016eb81:
  *param_2 = puVar5;
  *(undefined1 *)(param_2 + 1) = 1;
  return param_2;
}
