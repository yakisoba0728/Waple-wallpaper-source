...
void FUN_14027bad0(longlong *param_1,longlong *param_2)

{
  ...
  uVar5 = _DAT_140492fc0;
  dVar4 = DAT_140492780;
  fVar3 = DAT_1404926c0;
  iVar11 = 0;
  iVar14 = *(int *)((longlong)param_2 + 0xc);
  dVar18 = dVar18 * DAT_140492780;
  if (0 < iVar14) {
    do {
      iVar14 = 0;
      ...
      if (0 < (int)param_2[1] + -1) {
        do {
          ...
          if ((float)((uint)(fVar25 - fVar3) & uVar5) + (float)((uint)(fVar23 - fVar3) & uVar5) <
              (float)dVar18) {
            bVar6 = FUN_14027b940(pfVar10,pfVar8,2);
            uVar13 = (uint)bVar6 * 2;
            bVar6 = FUN_14027b940();
            uVar13 = (uVar13 | bVar6) * 2;
            bVar6 = FUN_14027b940(pfVar10);
            uVar13 = uVar13 | bVar6;
            if ((((uVar13 & 1) == 0) || (fVar16 == fVar23)) &&
              ...
              else if (fVar22 != fVar23) goto LAB_14027bce2;
            }
            else {
LAB_14027bce2:
    ...
    do {
      ...
      if (0 < (int)param_2[1]) {
        do {
          ...
          ;
          if (fVar16 < (float)(dVar18 * dVar4)) {
            bVar6 = FUN_14027b940(pfVar10,fVar16,2);
            uVar13 = (uint)bVar6 * 2;
            bVar6 = FUN_14027b940();
            uVar13 = (uVar13 | bVar6) * 2;
            bVar6 = FUN_14027b940(pfVar10);
            ...
            if ((((uVar13 & 1) == 0) || (fVar21 == fVar23)) &&
              ...
              else if (fVar22 != fVar23) goto LAB_14027bee2;
            }
            else {
LAB_14027bee2:
              pbVar1 = (byte *)(*param_1 + (longlong)(iVar11 * (int)param_1[2]) + (longlong)iVar14);
      ...
      if (0 < (int)param_2[1] + -1) {
        do {
          ...
          if ((float)((uint)(fVar24 - fVar3) & uVar5) + (float)((uint)(fVar22 - fVar3) & uVar5) <
              fVar28) {
            bVar6 = FUN_14027b940(pfVar10,pfVar12,2);
            uVar13 = (uint)bVar6 * 2;
            bVar6 = FUN_14027b940();
            uVar13 = (uVar13 | bVar6) * 2;
            bVar6 = FUN_14027b940(pfVar10);
            ...
            if ((((uVar13 & 1) == 0) || (fVar25 == fVar24)) &&
              ...
              else if (fVar23 != fVar24) goto LAB_14027c13e;
            }
            else {
LAB_14027c13e:
              pbVar1 = (byte *)(*param_1 + (longlong)(iVar11 * (int)param_1[2]) + (longlong)iVar14);
          ...
          if ((float)((uint)(fVar26 - fVar3) & uVar5) + (float)((uint)(fVar27 - fVar3) & uVar5) <
              fVar28) {
            bVar6 = FUN_14027b940(pfVar15,pfVar9,2);
            uVar13 = (uint)bVar6 * 2;
            bVar6 = FUN_14027b940();
            uVar13 = (uVar13 | bVar6) * 2;
            bVar6 = FUN_14027b940(pfVar15);
            uVar13 = uVar13 | bVar6;
            if ((((uVar13 & 1) == 0) || (*pfVar15 == fVar26)) &&
              ...
              else if (pfVar15[2] != fVar26) goto LAB_14027c24d;
            }
            else {
LAB_14027c24d:
              pbVar1 = (byte *)(*param_1 + 1 +
