// Function: FUN_14030ce10
// Addr: 14030ce10
// Size: 8908 bytes


undefined4 FUN_14030ce10(longlong *param_1)

{
  ...
  do {
    ...
    *(uint *)(param_1 + 7) = uVar19;
    ...
    if ((int)uVar19 < 0) {
      ...
      if ((bVar8 & 0xf0) != 0) {
        ...
        } while (uVar17 < (byte)(&DAT_14043b410)[uVar11] >> 4);
      }
    ...
    bVar8 = (byte)uVar11;
    iVar20 = (int)puVar13;
    iVar21 = ((byte)(&DAT_14043b410)[uVar11] & 0xf) + iVar20;
    *(int *)((longlong)param_1 + 0x3c) = iVar21;
    ...
    case 4:
    case 5:
      uVar5 = (ushort)(bVar8 & 1) << 0xe;
      uVar17 = uVar5 ^ 0x4000;
      if (bVar8 < 4) {
        *(ushort *)((longlong)param_1 + 0x19c) = uVar5;
        *(ushort *)((longlong)param_1 + 0x19e) = uVar17;
        *(ushort *)(param_1 + 0x33) = uVar5;
        *(ushort *)((longlong)param_1 + 0x19a) = uVar17;
      }
      if ((uVar11 & 2) != 0) goto LAB_14030d096;
      *(ushort *)(param_1 + 0x34) = uVar5;
      *(ushort *)((longlong)param_1 + 0x1a2) = uVar17;
      FUN_140309220(param_1);
      break;
    case 6:
    case 7:
      cVar3 = FUN_14030b100(param_1,(short)puVar16[1],(short)*puVar16,(longlong)param_1 + 0x19c);
      if (cVar3 == '\0') {
    ...
    case 8:
    case 9:
      cVar3 = FUN_14030b100(param_1,(short)puVar16[1],(short)*puVar16,param_1 + 0x34);
      if (cVar3 == '\0') goto LAB_14030d096;
      break;
    case 10:
      if (((short)*puVar16 != 0) || ((short)puVar16[1] != 0)) {
        local_res10 = (int)(short)*puVar16;
        local_res14 = (int)(short)puVar16[1];
        FUN_1402f5e70(&local_res10);
...
LAB_14030d096:
    ...
    case 0x13:
      if (*puVar16 == 0) {
        ...
        if (*puVar16 != 1) {
          cVar3 = *(char *)((longlong)param_1 + 0x2c6);
          goto joined_r0x00014030dfc4;
        }
    ...
    case 0x17:
      uVar18 = *puVar16;
      if ((int)uVar18 < 0) goto LAB_14030e8bb;
    ...
    case 0x18:
      *(undefined4 *)(param_1 + 0x35) = 1;
      param_1[0x59] = (longlong)&LAB_14030b5d0;
      break;
    case 0x19:
      *(undefined4 *)(param_1 + 0x35) = 0;
      param_1[0x59] = (longlong)&LAB_14030b610;
      break;
    case 0x1a:
    ...
    case 0x1b:
      ...
      do {
        ...
        *(int *)(param_1 + 0x3d) = iVar20;
        if (*(int *)((longlong)param_1 + 0x1ec) <= iVar20) goto LAB_14030ef55;
        bVar8 = *(byte *)((longlong)iVar20 + param_1[0x3c]);
        *(byte *)(param_1 + 0x3e) = bVar8;
        cVar3 = (&DAT_14043b510)[bVar8];
        *(int *)((longlong)param_1 + 500) = (int)cVar3;
        if (cVar3 < '\0') {
          if (*(int *)((longlong)param_1 + 0x1ec) <= iVar20 + 1) goto LAB_14030ef55;
          *(uint *)((longlong)param_1 + 500) =
               2 - (uint)((byte *)((longlong)iVar20 + param_1[0x3c]))[1] * (int)cVar3;
        }
        if (bVar8 == 0x58) {
          iVar10 = iVar10 + 1;
        }
      ...
      break;
    case 0x1c:
switchD_14030cf26_caseD_1c:
      if ((*puVar16 != 0) || (iVar20 != 0)) {
        plVar1 = param_1 + 0x3d;
        *(uint *)plVar1 = (int)*plVar1 + *puVar16;
        if ((-1 < (int)*plVar1) &&
           (((int)param_1[0x4a] < 1 ||
            ((int)param_1[0x3d] <=
          ...
          *(undefined4 *)((longlong)param_1 + 500) = 0;
          if (((int)*puVar16 < 0) &&
             ...
             *(uint *)(param_1 + 0x67) < *(uint *)((longlong)param_1 + 0x334))) goto LAB_14030e8af;
          break;
        }
      }
LAB_14030e8bb:
    ...
    case 0x26:
      uVar18 = *puVar16;
      if (((int)uVar18 < 1) || (iVar20 < (int)uVar18)) goto LAB_14030edf1;
      puVar6 = puVar16 + -(longlong)(int)uVar18;
      uVar18 = *puVar6;
      FUN_1404210f0(puVar6,puVar6 + 1);
      puVar16[-1] = uVar18;
      break;
    case 0x27:
      uVar17 = (ushort)*puVar16;
      if (uVar17 < *(ushort *)(param_1 + 0xf)) {
        uVar5 = (ushort)puVar16[1];
        if (uVar5 < *(ushort *)(param_1 + 8)) {
          piVar2 = (int *)(param_1[0x11] + (ulonglong)uVar17 * 8);
          iVar10 = (*(code *)param_1[0x5b])
                             (param_1,*(int *)(param_1[10] + (ulonglong)uVar5 * 8) - *piVar2,
                              *(int *)(param_1[10] + 4 + (ulonglong)uVar5 * 8) - piVar2[1]);
          (*(code *)param_1[0x5e])(param_1,param_1 + 0xf,uVar17,iVar10 / 2);
          (*(code *)param_1[0x5e])(param_1,param_1 + 8,uVar5,-(iVar10 / 2));
          break;
        }
      }
LAB_14030edf1:
      cVar3 = *(char *)((longlong)param_1 + 0x2c6);
joined_r0x00014030dfc4:
      if (cVar3 != '\0') goto LAB_14030ea69;
      break;
    case 0x28:
    case 0x7b:
    case 0x83:
    ...
    case 0x8f:
    case 0x90:
switchD_14030cf26_caseD_28:
      FUN_14030b1e0(param_1);
      break;
    case 0x29:
      if (*(ushort *)(param_1 + 8) <= (ushort)*puVar16) {
        cVar3 = *(char *)((longlong)param_1 + 0x2c6);
        goto joined_r0x00014030dfc4;
      }
      bVar8 = 0xf7;
...
LAB_14030d6e5:
          if (*(char *)(puVar14 + 4) != '\0') {
            if (*(int *)((longlong)param_1 + 0x254) <= (int)param_1[0x4a]) goto LAB_14030de7f;
            if (0 < (int)*puVar16) {
          ...
          for (puVar14 = puVar13; puVar14 < puVar13 + (ulonglong)*(uint *)(param_1 + 0x45) * 5;
              puVar14 = puVar14 + 5) {
            if (puVar14[3] == uVar18) goto LAB_14030d6e5;
          }
          if (puVar14 != puVar13 + (ulonglong)*(uint *)(param_1 + 0x45) * 5) goto LAB_14030d6e5;
        }
      }
      goto LAB_14030ea69;
    case 0x2b:
      ...
      if ((uVar18 < uVar19) && (puVar14 = (undefined4 *)param_1[0x46], puVar14 != (undefined4 *)0x0)
        ...
        if ((uVar19 != *(uint *)(param_1 + 0x45)) ||
          ...
          for (puVar13 = puVar14; puVar13 < puVar14 + (ulonglong)*(uint *)(param_1 + 0x45) * 5;
              puVar13 = puVar13 + 5) {
            if (puVar13[3] == uVar18) goto LAB_14030d7da;
          }
          if (puVar13 == puVar14 + (ulonglong)*(uint *)(param_1 + 0x45) * 5) goto LAB_14030ea69;
        }
LAB_14030d7da:
        if (*(char *)(puVar13 + 4) != '\0') {
          if (*(int *)((longlong)param_1 + 0x254) <= (int)param_1[0x4a]) goto LAB_14030de7f;
...
LAB_14030d88b:
          ...
          for (; puVar14 < puVar13; puVar14 = puVar14 + 5) {
            if (puVar14[3] == uVar18) goto LAB_14030d8a5;
          }
          if (puVar14 == puVar13) goto LAB_14030d88b;
LAB_14030d8a5:
          if (uVar18 < 0x10000) {
            *puVar14 = *(undefined4 *)((longlong)param_1 + 0x1dc);
            ...
            *(undefined1 *)(puVar14 + 4) = 1;
            ...
            do {
              ...
              *(int *)(param_1 + 0x3d) = iVar10;
              if (*(int *)((longlong)param_1 + 0x1ec) <= iVar10) goto LAB_14030ef55;
              bVar8 = *(byte *)((longlong)iVar10 + param_1[0x3c]);
              *(byte *)(param_1 + 0x3e) = bVar8;
              cVar3 = (&DAT_14043b510)[bVar8];
              *(int *)((longlong)param_1 + 500) = (int)cVar3;
              if (cVar3 < '\0') {
                if (*(int *)((longlong)param_1 + 0x1ec) <= iVar10 + 1) goto LAB_14030ef55;
                *(uint *)((longlong)param_1 + 500) =
                     2 - (uint)((byte *)((longlong)iVar10 + param_1[0x3c]))[1] * (int)cVar3;
              }
              if (bVar8 == 0x2c) break;
              if (bVar8 == 0x2d) {
                puVar14[2] = iVar10;
                goto switchD_14030cf26_caseD_21;
              }
            } while (bVar8 != 0x89);
LAB_14030d967:
    ...
    case 0x2d:
      ...
      if (iVar10 < 1) {
        ...
        *(int *)(param_1 + 0x4a) = iVar10 + -1;
        lVar15 = param_1[0x4b];
        piVar2 = (int *)(lVar15 + -0x10 + (longlong)iVar10 * 0x18);
        *piVar2 = *piVar2 + -1;
        lVar15 = lVar15 + (longlong)iVar10 * 0x18;
        if (*(int *)(lVar15 + -0x10) < 1) {
          FUN_140309910(param_1,*(undefined4 *)(lVar15 + -0x18));
        }
        else {
          *(int *)(param_1 + 0x4a) = (int)param_1[0x4a] + 1;
    ...
    case 0x30:
    case 0x31:
      FUN_140309f70(param_1);
      break;
    case 0x32:
    case 0x33:
      FUN_14030ac00(param_1,puVar16);
      break;
    case 0x34:
    case 0x35:
      FUN_14030aa10(param_1,puVar16);
      break;
    case 0x36:
    case 0x37:
      FUN_14030af50(param_1,puVar16);
      break;
    case 0x38:
      FUN_14030ada0(param_1,puVar16);
      break;
    case 0x39:
      FUN_140309990(param_1,puVar16);
      break;
    case 0x3a:
    case 0x3b:
      uVar17 = (ushort)*puVar16;
      ...
      if ((*(ushort *)(param_1 + 0xf) <= uVar17) ||
         (*(ushort *)(param_1 + 8) <= *(ushort *)((longlong)param_1 + 0x18c))) goto LAB_14030edf1;
        ...
        *(int *)((longlong)param_1 + 0x3c) = iVar21 - iVar10;
        if (*(ushort *)((longlong)param_1 + 0x18c) < *(ushort *)(param_1 + 8)) {
          for (; iVar10 != 0; iVar10 = iVar10 + -1) {
            ...
            else if (*(char *)((longlong)param_1 + 0x2c6) != '\0') goto LAB_14030ea69;
          }
        }
    ...
    case 0x41:
      ...
      if (iVar20 < *(int *)((longlong)param_1 + 0x1ec)) {
        ...
        if ((int)(iVar20 + uVar18 * 2) < *(int *)((longlong)param_1 + 0x1ec)) {
          if ((iVar10 - *(int *)((longlong)param_1 + 0x24)) + 1U <= uVar18) goto LAB_14030de7f;
          if (*(byte *)((longlong)iVar20 + param_1[0x3c]) == 0) goto LAB_14030de2f;
          do {
...
LAB_14030ef55:
    ...
    case 0x42:
      uVar18 = *puVar16;
      if (*(ushort *)(param_1 + 0x53) <= uVar18) {
        cVar3 = *(char *)((longlong)param_1 + 0x2c6);
        goto joined_r0x00014030dfc4;
      }
      if (((int)param_1[0x3b] == 3) && (param_1[0x54] != param_1[0x56])) {
        lVar15 = FUN_1402f7ff0(param_1[2],4,(short)param_1[0x55],*(ushort *)(param_1 + 0x53),
                               param_1[0x56],local_res8);
        param_1[0x56] = lVar15;
        *(int *)(param_1 + 4) = local_res8[0];
        if (local_res8[0] != 0) break;
        *(short *)(param_1 + 0x55) = (short)param_1[0x53];
        FUN_1404210f0(lVar15,param_1[0x54]);
        param_1[0x54] = param_1[0x56];
      }
      *(uint *)(param_1[0x54] + (ulonglong)uVar18 * 4) = puVar16[1];
      break;
    case 0x43:
...
LAB_14030dfeb:
        if (*(char *)((longlong)param_1 + 0x2c6) != '\0') goto LAB_14030ea69;
        *puVar16 = 0;
      }
      break;
    case 0x44:
      ...
      break;
    case 0x45:
      if (*(uint *)(param_1 + 0x3f) <= *puVar16) goto LAB_14030dfeb;
    ...
    case 0x56:
      uVar19 = *puVar16;
      if ((code *)param_1[0x59] == (code *)&LAB_14030b590) {
        if ((int)uVar19 < 0) {
...
LAB_14030e34a:
    ...
    case 0x71:
    case 0x72:
      FUN_140309660(param_1,puVar16);
      break;
    case 0x5e:
      *(short *)((longlong)param_1 + 0x1cc) = (short)*puVar16;
      break;
    case 0x5f:
      if (6 < *puVar16) goto LAB_14030e8bb;
    ...
    case 0x62:
      if (puVar16[1] == 0) {
        *(undefined4 *)(param_1 + 4) = 0x85;
        ...
        uVar18 = FUN_1402f2140(*puVar16,0x40);
        *puVar16 = uVar18;
      }
      break;
    case 99:
      uVar18 = FUN_1402f20b0(*puVar16,puVar16[1]);
      *puVar16 = uVar18;
      break;
    case 100:
      if ((int)*puVar16 < 0) {
...
LAB_14030e600:
      ...
      else if (uVar19 == 0xc0) goto LAB_14030e600;
      uVar19 = uVar18 & 0x30;
      if (uVar19 == 0) {
      ...
      *(int *)(param_1 + 0x58) = iVar20 >> 8;
      param_1[0x59] = (longlong)&LAB_14030b4e0;
...
LAB_14030e6f4:
      ...
      else if (uVar19 == 0xc0) goto LAB_14030e6f4;
      uVar19 = uVar18 & 0x30;
      if (uVar19 == 0) {
        *(undefined4 *)((longlong)param_1 + 700) = 0;
      }
      ...
      *(int *)((longlong)param_1 + 700) = *(int *)((longlong)param_1 + 700) >> 8;
      *(int *)(param_1 + 0x58) = iVar20 >> 8;
      param_1[0x59] = (longlong)&LAB_14030b530;
      *(int *)(param_1 + 0x57) = iVar10 >> 8;
      *(undefined4 *)(param_1 + 0x35) = 7;
      break;
    case 0x78:
      if (puVar16[1] != 0) goto switchD_14030cf26_caseD_1c;
      break;
    case 0x79:
      if (puVar16[1] == 0) {
        if ((*puVar16 == 0) && (iVar20 == 0)) goto LAB_14030e8bb;
        plVar1 = param_1 + 0x3d;
        *(uint *)plVar1 = (int)*plVar1 + *puVar16;
        if (((int)*plVar1 < 0) ||
           ((0 < (int)param_1[0x4a] &&
            (*(int *)(*(longlong *)(param_1[0x4b] + -8 + (longlong)(int)param_1[0x4a] * 0x18) + 8) <
             (int)param_1[0x3d])))) goto LAB_14030e8bb;
        *(undefined4 *)((longlong)param_1 + 500) = 0;
        if ((-1 < (int)*puVar16) ||
           (*(int *)((longlong)param_1 + 0x334) = *(int *)((longlong)param_1 + 0x334) + 1,
...
LAB_14030e8af:
    ...
    case 0x7a:
      *(undefined4 *)(param_1 + 0x35) = 5;
      param_1[0x59] = (longlong)&LAB_14030b4c0;
      break;
    case 0x7c:
      *(undefined4 *)(param_1 + 0x35) = 4;
      param_1[0x59] = (longlong)&LAB_14030b640;
      break;
    case 0x7d:
      *(undefined4 *)(param_1 + 0x35) = 3;
      param_1[0x59] = (longlong)&LAB_14030b490;
      break;
    case 0x80:
      iVar10 = *(int *)((longlong)param_1 + 0x1a4);
      if (iVar21 < iVar10) {
        if (*(char *)((longlong)param_1 + 0x2c6) == '\0') goto LAB_14030dc76;
        *(undefined4 *)(param_1 + 4) = 0x81;
        *(undefined4 *)((longlong)param_1 + 0x1a4) = 1;
      }
      else {
        *(int *)((longlong)param_1 + 0x3c) = iVar21 - iVar10;
        if ((*(int *)((longlong)param_1 + 0x324) == 7) || (iVar10 == 0)) goto LAB_14030dc76;
        do {
          puVar6 = puVar16 + -1;
          puVar16 = puVar16 + -1;
          if ((ushort)*puVar6 < *(ushort *)(param_1 + 0x1d)) {
            pbVar12 = (byte *)(param_1[0x21] + (ulonglong)(ushort)*puVar6);
            *pbVar12 = *pbVar12 ^ 1;
          }
          else if (*(char *)((longlong)param_1 + 0x2c6) != '\0') goto LAB_14030ea69;
          iVar10 = iVar10 + -1;
    ...
    case 0x81:
      if (*(int *)((longlong)param_1 + 0x324) != 7) {
        ...
        if ((*(ushort *)(param_1 + 0x1d) <= (ushort)uVar18) ||
           (uVar17 = (ushort)*puVar16, *(ushort *)(param_1 + 0x1d) <= uVar17)) goto LAB_14030edf1;
    ...
    case 0x82:
      if (*(int *)((longlong)param_1 + 0x324) != 7) {
        uVar18 = puVar16[1];
        if ((*(ushort *)(param_1 + 0x1d) <= (ushort)uVar18) ||
           (uVar17 = (ushort)*puVar16, *(ushort *)(param_1 + 0x1d) <= uVar17)) goto LAB_14030ea5c;
        for (; uVar17 <= (ushort)uVar18; uVar17 = uVar17 + 1) {
          *(byte *)((ulonglong)uVar17 + param_1[0x21]) =
...
LAB_14030ec81:
          ...
          if (puVar14 < puVar13) {
            do {
              if (puVar14[3] == *puVar16) goto LAB_14030ec9b;
              puVar14 = puVar14 + 5;
            } while (puVar14 < puVar13);
          }
          if (puVar14 == puVar13) goto LAB_14030ec81;
LAB_14030ec9b:
          if (*puVar16 < 0x100) {
            ...
            *(undefined1 *)(puVar14 + 4) = 1;
            ...
            do {
              ...
              *(int *)((longlong)param_1 + 500) = (int)cVar3;
              ...
              if (bVar8 == 0x2c) goto LAB_14030d967;
              if (bVar8 == 0x2d) {
                puVar14[2] = iVar10;
                goto switchD_14030cf26_caseD_21;
              }
...
LAB_14030ea5c:
      ...
      break;
    case 0x91:
      if (*(longlong *)(*param_1 + 0x408) == 0) goto switchD_14030cf26_caseD_28;
      FUN_1403097b0(param_1,puVar16);
      break;
    case 0x92:
      if (*(longlong *)(*param_1 + 0x408) == 0) goto switchD_14030cf26_caseD_28;
      *puVar16 = 0x11;
    ...
    default:
      if (bVar8 < 0xe0) {
        if (bVar8 < 0xc0) {
          if (bVar8 < 0xb8) {
            if (bVar8 < 0xb0) goto switchD_14030cf26_caseD_28;
            iVar20 = (int)param_1[0x3d];
            uVar19 = uVar19 - 0xaf;
            if (*(int *)((longlong)param_1 + 0x1ec) <= (int)(uVar19 + iVar20)) goto LAB_14030ef55;
            ...
            *(undefined4 *)(param_1 + 4) = 0x82;
            ...
            goto LAB_14030ef55;
            if ((iVar10 - *(int *)((longlong)param_1 + 0x24)) + 1U <= uVar19) goto LAB_14030de7f;
            if ((int)uVar19 < 1) {
LAB_14030ef9f:
              *(int *)(param_1 + 0x3d) = iVar20;
            }
          ...
          FUN_14030a360(param_1,puVar16);
        }
      }
      else {
        FUN_14030a5c0(param_1,puVar16);
      }
    }
switchD_14030cf26_caseD_21:
    if ((int)param_1[4] == 0) {
      ...
      *(int *)(param_1 + 0x3d) = (int)param_1[0x3d] + *(int *)((longlong)param_1 + 500);
      ...
      if ((int)param_1[4] != 0x80) goto LAB_14030f0c1;
      puVar14 = (undefined4 *)param_1[0x48];
      if (puVar14 == (undefined4 *)0x0) {
      ...
      while( true ) {
        if (puVar13 <= puVar14) goto LAB_14030f0c1;
      ...
      *(undefined4 **)(puVar13 + 4) = puVar14;
      cVar3 = FUN_140309910(param_1,*puVar14,puVar14[1]);
      if (cVar3 == '\x01') goto LAB_14030f0c1;
    }
