// Function: FUN_1403cfd40
// Addr: 1403cfd40
// Size: 212 bytes


uint FUN_1403cfd40(byte *param_1,uint param_2)

{
  ...
  if ((param_2 < uVar4) ||
    ...
    uVar4 = (uint)(ushort)((ushort)DAT_14045dd10._1_1_ + (ushort)(byte)DAT_14045dd10 * 0x100);
  }
  else {
    uVar5 = 0;
