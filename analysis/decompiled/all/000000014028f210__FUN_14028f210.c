// Function: FUN_14028f210
// Addr: 14028f210
// Size: 194 bytes


undefined1 (*) [32]
FUN_14028f210(undefined1 (*param_1) [32],undefined1 (*param_2) [32],ulonglong param_3)

{
  ...
  pauVar5 = param_1;
  if (((DAT_1404dc0dc & 0x20) == 0) || (uVar6 < 0x20)) {
    pauVar7 = param_1;
    if (((DAT_1404dc0dc & 4) != 0) && (0xf < uVar6)) {
      ...
      do {
        ...
        auVar10 = pshufb(auVar10,*(undefined1 (*) [16])(&DAT_140429a20 + (ulonglong)uVar3 * 0x10));
        *(undefined1 (*) [16])*pauVar5 = auVar10;
        pauVar5 = (undefined1 (*) [32])(*pauVar5 + (byte)(&DAT_140429a60)[CONCAT44(uVar4,uVar3)]);
    ...
    do {
      ...
      auVar1._8_8_ = 0;
      auVar1._0_8_ = *(ulonglong *)(&UNK_140429a70 + CONCAT44(uVar4,uVar2) * 8);
      auVar9 = vpmovzxbd_avx2(auVar1);
      auVar9 = vpermd_avx2(auVar9,*param_1);
      *pauVar5 = auVar9;
      param_1 = param_1 + 1;
      pauVar5 = (undefined1 (*) [32])(*pauVar5 + (byte)(&UNK_140429af0)[CONCAT44(uVar4,uVar2)]);
    } while (param_1 != pauVar7);
  }
