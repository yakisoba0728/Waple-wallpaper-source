// Function: FUN_14013e7f0
// Addr: 14013e7f0
// Size: 295 bytes


undefined8 FUN_14013e7f0(longlong param_1,undefined8 param_2)

{
  ...
  *(undefined8 *)(param_1 + 0x10) = param_2;
  ...
  if (local_res10 != (longlong *)0x0) {
    (**(code **)(*local_res10 + 0x18))(local_res10,&DAT_1404838a0,&DAT_14048add0,param_1 + 0x20);
    if (*(longlong *)(param_1 + 0x20) != 0) {
      ...
      (**(code **)(*(longlong *)(param_1 + -8) + 0x68))(param_1 + -8);
    }
