// Function: FUN_1400e1430
// Addr: 1400e1430
// Size: 389 bytes


void FUN_1400e1430(longlong *param_1)

{
  ...
  *(byte *)((longlong)param_1 + 0x75) = bVar1;
  lVar5 = FUN_1402bbe10(&DAT_140486dd0,(int)(char)bVar1);
  if (lVar5 != 0) {
    *(uint *)(param_1 + 0xe) = (uint)bVar1;
    ...
    case 10:
      ...
      *(undefined4 *)(param_1 + 0xe) = 0x7c;
      return;
    default:
      goto switchD_1400e14a8_caseD_b;
    case 0x24:
      uVar6 = param_1[0xc];
      if ((uVar6 >> 0x18 & 1) == 0) {
        return;
      ...
      cVar3 = *(char *)(lVar5 + 1);
      if ((cVar3 == '\\') && (cVar4 = FUN_1400e5700(param_1), cVar4 != '\0')) {
        cVar3 = *(char *)(lVar5 + 2);
        bVar2 = true;
      }
      else {
    ...
    case 0x5c:
      lVar5 = *param_1;
      cVar3 = FUN_1400e5700(param_1,lVar5);
      if (cVar3 == '\0') {
        return;
      }
      bVar1 = *(byte *)(lVar5 + 1);
