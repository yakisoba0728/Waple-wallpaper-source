// Function: FUN_1400abb00
// Addr: 1400abb00
// Size: 1631 bytes


byte * FUN_1400abb00(longlong param_1,longlong *param_2)
    ...
    if (iVar5 == 2) {
      while( true ) {
        ...
        while (2 < uVar10) {
          ...
          *(byte *)((ulonglong)pbVar12[0x14047a730] + 0xa171 + param_1) = bVar4 & 7;
LAB_1400abda0:
          uVar18 = (uint)pbVar13;
          pbVar12 = pbVar13;
          if (local_res18 <= uVar18) goto joined_r0x0001400abe01;
        }
        iVar5 = 2;
      }
      goto LAB_1400ac0c9;
...
LAB_1400abfc4:
        if (uVar6 <= uVar10) {
          uVar18 = (int)pbVar20 + (*(uint *)(&DAT_140482800 + (ulonglong)uVar6 * 4) & uVar8);
          pbVar20 = (byte *)(ulonglong)uVar18;
          if (uVar18 != 0) {
            pbVar12 = pbVar13;
            do {
              if (local_res20 + (int)pbVar16 <= (uint)pbVar12)
              goto UNWIND_INFO_1400ac12c_UnwindCodes_15__UnwindOpCode;
            ...
            if (uVar18 <= (uint)pbVar13) {
              if ((uint)pbVar13 == uVar18) {
                if (*(char *)(param_1 + 0xa271) == '\0') {
                  ...
                  pcVar7 = (char *)FUN_1400ac200(param_1,0,0,pbVar16,0x101);
                  if ((((byte *)pcVar7 == (byte *)0x0) || (*pcVar7 != 0x23)) &&
                     ((pcVar7 = (char *)FUN_1400ac200(param_1,1,local_b8,uVar18,0),
...
UNWIND_INFO_1400ac12c_UnwindCodes_15__UnwindOpCode:
...
LAB_1400abf1d:
              ...
              uVar11 = (uint)pbVar12;
              uVar18 = (uint)pbVar16;
              if (pbVar9 == local_60) goto LAB_1400ac0c9;
              bVar4 = *pbVar9;
              pbVar9 = pbVar9 + 1;
              uVar8 = uVar8 | (uint)bVar4 << ((byte)uVar10 & 0x1f);
              uVar10 = uVar10 + 8;
            }
            if ((char)(uVar18 >> 0x18) != -0x80)
            goto UNWIND_INFO_1400ac12c_UnwindCodes_10__OffsetInProlog;
            uVar8 = uVar8 >> (sbyte)uVar6;
            uVar10 = uVar10 - uVar6;
            iVar5 = (int)pbVar12;
            if ((uVar18 & 0xf000) != 0) goto code_r0x0001400abf5c;
...
LAB_1400ac1c9:
  ...
  return (byte *)pcVar7;
joined_r0x0001400abe01:
  while (uVar18 < 0x13) {
    pbVar12 = pbVar13 + 0x14047a730;
    uVar18 = (int)pbVar13 + 1;
    pbVar13 = (byte *)(ulonglong)uVar18;
    *(undefined1 *)((ulonglong)*pbVar12 + 0xa171 + param_1) = 0;
  }
  pcVar7 = (char *)FUN_1400ac200(param_1,0,0,0x13,0xfff);
  if (((byte *)pcVar7 == (byte *)0x0) || (*pcVar7 != 0x23)) {
    pbVar16 = (byte *)(ulonglong)local_b8;
...
code_r0x0001400abf5c:
  ...
  if (uVar18 == 0x1000) {
    ...
    if (uVar18 == 0x1100) {
      ...
      if (uVar18 != 0x1200) {
UNWIND_INFO_1400ac12c_UnwindCodes_10__OffsetInProlog:
