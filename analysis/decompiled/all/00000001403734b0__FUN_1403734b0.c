// Function: FUN_1403734b0
// Addr: 1403734b0
// Size: 336 bytes


undefined8 FUN_1403734b0(char *param_1,byte *param_2,int param_3,uint param_4)

{
  ...
  do {
    ...
    if (uVar7 < *(uint *)(param_1 + 0x14)) {
      if (*(int *)(*plVar1 + (ulonglong)uVar7 * 8) != iVar2) goto LAB_140373535;
      puVar10 = (undefined4 *)
