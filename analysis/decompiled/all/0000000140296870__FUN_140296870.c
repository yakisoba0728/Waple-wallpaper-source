// Function: FUN_140296870
// Addr: 140296870
// Size: 869 bytes


void FUN_140296870(longlong *param_1,longlong *param_2,ulonglong param_3,short *param_4,char param_5
                  )

{
  ...
  local_80 = lVar6;
  local_90 = FUN_14000f520(&local_88);
  local_88 = 1;
...
LAB_140296b7b:
          ...
          else if (*param_2 == 0) goto LAB_140296a82;
        }
        ppppuVar7 = local_78;
        if (0xf < local_60) {
          ppppuVar7 = (undefined8 ****)local_78[0];
...
LAB_140296bb8:
    ...
    if (local_98 != '\0') {
      ...
      lVar6 = *param_1;
      if (lVar6 == 0) {
        if (*param_2 == 0) goto UNWIND_INFO_140296c4f_UnwindCodes_20__UnwindOpCode;
        uVar10 = local_88 + 1;
code_r0x000140296c01:
        *param_1 = 0;
        uVar3 = 1;
      }
      else {
...
UNWIND_INFO_140296c4f_UnwindCodes_20__UnwindOpCode:
