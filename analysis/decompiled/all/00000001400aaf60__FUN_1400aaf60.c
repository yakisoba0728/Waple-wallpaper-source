// Function: FUN_1400aaf60
// Addr: 1400aaf60
// Size: 2755 bytes


/* WARNING: Removing unreachable block (ram,0x0001400ab089) */
/* WARNING: Removing unreachable block (ram,0x0001400ab077) */
/* WARNING: Removing unreachable block (ram,0x0001400ab26b) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

char * FUN_1400aaf60(int *param_1,longlong *param_2,longlong *param_3)
...
LAB_1400ab0a4:
      ...
      local_68 = (byte *)0x0;
      uVar14 = 0;
      param_2[2] = local_58 - *param_2;
      uVar6 = _UNK_140492d38;
      uVar5 = _DAT_140492d30;
      pbVar15 = (byte *)0x0;
      lVar12 = *param_3;
      if (lVar12 != 0) {
        pbVar15 = (byte *)(param_3[3] + lVar12);
        local_68 = (byte *)(param_3[2] + lVar12);
      }
      local_res8 = param_1[0x14];
      if (local_res8 == 0) goto LAB_1400ab156;
      uVar14 = param_1[0x28ad];
      pcVar9 = pcVar7;
      if (local_res8 == 1) goto LAB_1400ab170;
      if (local_res8 == 2) goto LAB_1400ab1ca;
      if (local_res8 == 3) goto LAB_1400ab6bc;
      if (local_res8 == 4) {
        while( true ) {
          pcVar7 = (char *)FUN_1400acd40(param_1,param_2,param_3);
          pbVar15 = (byte *)(param_3[3] + *param_3);
          if (pcVar7 != (char *)0x0) break;
          if ((char)param_1[0x11] != '\0') goto LAB_1400ab156;
          while( true ) {
            plVar21 = param_3 + 3;
            *plVar21 = (longlong)pbVar15 - *param_3;
            pcVar9 = (char *)(**(code **)(param_1 + 0x18))(param_1,param_2,param_3);
            pbVar15 = (byte *)(*param_3 + *plVar21);
            if ((pcVar9 != (char *)0x0) && (*pcVar9 == '#')) goto LAB_1400ab7c7;
            if ((char)param_1[0x11] == '\0') break;
LAB_1400ab156:
            while( true ) {
              pcVar9 = pcVar7;
              if (uVar14 != 0) goto LAB_1400ab7b8;
...
LAB_1400ab29b:
                  if ((longlong)puVar22 - (longlong)puVar16 < 4) {
                    ...
                    param_1[0x28b1] = 0;
                    iVar11 = 2;
                    goto joined_r0x0001400ab2dd;
                  }
                  uVar23 = (ulonglong)*puVar16;
                  puVar16 = puVar16 + 1;
LAB_1400ab2ad:
                  uVar13 = (uint)(ushort)uVar23;
                  if (((uint)(uVar23 >> 0x10) & 0xffff) + uVar13 == 0xffff) goto LAB_1400ab358;
                  pcVar7 = "#deflate: inconsistent stored block length";
                }
                else {
                  if (iVar11 == 2) {
joined_r0x0001400ab2dd:
                    while (puVar16 != puVar22) {
                      ...
                      *(ulonglong *)(param_1 + 0x28b0) = uVar23;
                      if (bVar1 == 0x18) goto LAB_1400ab2ad;
...
LAB_1400ab358:
                    ...
                    if (uVar10 != 0) {
                      FUN_1404210f0(lVar18,puVar16);
                      lVar18 = lVar18 + uVar10;
                      puVar16 = (uint *)((longlong)puVar16 + uVar10);
                    }
...
LAB_1400ab3d9:
              ...
              pbVar15 = (byte *)(param_3[3] + lVar12);
              if (pcVar7 != (char *)0x0) goto LAB_1400ab417;
            }
            if (uVar13 == 2) {
              ...
              *(undefined4 *)((longlong)param_1 + 0xa2ad) = 0x5050505;
              pcVar7 = (char *)FUN_1400ac130(param_1,0,0,0x120,0x101);
              if (((pcVar7 != (char *)0x0) && (*pcVar7 == '#')) ||
                 ((pcVar7 = (char *)FUN_1400ac130(param_1,1,0x120,0x140,0), pcVar7 != (char *)0x0 &&
                  (*pcVar7 == '#')))) {
                pcVar9 = pcVar7;
                if (*pcVar7 != '#') {
                  if (*pcVar7 == '$') {
...
LAB_1400ab7b8:
              ...
              local_res8 = 3;
LAB_1400ab6bc:
              pcVar7 = (char *)FUN_1400aba30(param_1,param_3);
              pbVar15 = (byte *)(param_3[3] + *param_3);
              pcVar9 = pcVar7;
              if (pcVar7 != (char *)0x0) goto LAB_1400ab417;
            }
...
LAB_1400ab7c7:
      ...
      if (pcVar9 != (char *)0x0) {
        if (*pcVar9 == '$') {
          uVar17 = uVar23 - local_50;
          uVar19 = local_58 - local_50;
          ...
          *(ulonglong *)(param_1 + 0xc) = uVar10;
          ...
          if (*param_1 == 0x3ccb6c71) {
            uVar14 = 0x8000;
            if (uVar10 < 0x8000) {
              uVar19 = 0x8000 - (ulonglong)(param_1[0xe] & 0x7fff);
              uVar17 = uVar10;
              if (uVar19 < uVar10) {
                uVar17 = uVar19;
              }
              if (uVar17 != 0) {
                FUN_1404210f0((ulonglong)(param_1[0xe] & 0x7fff) + 0x2070 + (longlong)param_1,
                              local_58,uVar17);
              }
              if (uVar17 < uVar10) {
                uVar10 = uVar10 - uVar17;
                if (uVar10 < 0x8001) {
                  if (uVar10 != 0) goto LAB_1400ab939;
                }
                else {
                  uVar10 = 0x8000;
LAB_1400ab939:
                  FUN_1404210f0(param_1 + 0x81c,uVar17 + local_58,uVar10);
                }
                uVar14 = (uint)uVar10 & 0x7fff | 0x8000;
              }
              else {
                ...
                uVar14 = uVar14 + ((uint)uVar17 & 0x7fff);
              }
            }
            else {
              if (0x8000 < uVar10) {
                local_58 = local_58 + (uVar10 - 0x8000);
                uVar10 = 0x8000;
              }
              FUN_1404210f0(param_1 + 0x81c,local_58,uVar10);
            }
            param_1[0xe] = uVar14;
            FUN_1404210f0(param_1 + 0x281c,param_1 + 0x81c,0x101);
          }
          if (*pcVar9 == '$') {
            param_1[0x13] = 1;
          }
        ...
        if (*pcVar9 == '#') goto LAB_1400ab7fe;
      }
      param_1[0x13] = 0;
    }
    else {
      if (param_1[0x13] == 1) goto LAB_1400ab0a4;
      pcVar9 = (char *)0x0;
      param_1[0x13] = 0;
      uVar23 = local_58;
    }
LAB_1400ab7fe:
    ...
    if (*pcVar9 != '$') goto LAB_1400ab9f1;
    iVar11 = 1;
    param_1[0x12] = 1;
    if (*pcVar9 != '$') goto LAB_1400ab9e7;
  }
  else {
    param_1[0x12] = 0;
    pcVar9 = (char *)0x0;
