// Function: FUN_1400afe00
// Addr: 1400afe00
// Size: 1085 bytes


char * FUN_1400afe00(longlong param_1,longlong *param_2)
...
switchD_1400afec9_caseD_1:
    if (puVar14 != puVar15) {
      ...
      while( true ) {
        ...
        if (10 < bVar13) break;
        iVar12 = 3;
switchD_1400afec9_caseD_3:
        bVar13 = (byte)uVar8;
        if (puVar14 == puVar15) goto LAB_1400aff53;
        bVar1 = (byte)*puVar14;
...
LAB_1400b00c2:
  ...
  switch(iVar12) {
  case 1:
    goto switchD_1400afec9_caseD_1;
  case 2:
  case 5:
  case 7:
    break;
  case 3:
    goto switchD_1400afec9_caseD_3;
  case 4:
switchD_1400afec9_caseD_4:
    if (puVar14 == puVar15) goto LAB_1400aff53;
    uVar5 = *puVar14;
    ...
    if ((byte)uVar5 == 3) {
      iVar12 = 6;
      goto switchD_1400afec9_caseD_6;
    }
    iVar12 = 5;
LAB_1400aff26:
    *(ulonglong *)(param_1 + 0xfdc8) = uVar8;
    break;
  case 6:
switchD_1400afec9_caseD_6:
    bVar13 = (byte)uVar8;
    if (puVar14 == puVar15) goto LAB_1400aff53;
    uVar5 = *puVar14;
    puVar14 = (ushort *)((longlong)puVar14 + 1);
    if ((byte)uVar5 == 1) goto switchD_1400afec9_caseD_8;
    *(undefined8 *)(param_1 + 0xfdc8) = 2;
    iVar12 = 7;
    break;
  case 8:
switchD_1400afec9_caseD_8:
...
LAB_1400b018c:
  ...
  case 9:
    while (puVar14 != puVar15) {
      ...
      *(ulonglong *)(param_1 + 0xfdc8) = uVar8;
      if (bVar1 == 8) goto LAB_1400b018c;
      *(ulonglong *)(param_1 + 0xfdc8) = (ulonglong)(bVar1 + 8) << 0x38 | uVar8;
    }
    goto LAB_1400aff53;
  case 10:
    goto switchD_1400afec9_caseD_a;
  default:
    goto switchD_1400afec9_default;
  }
  bVar13 = (byte)uVar8;
...
switchD_1400afec9_caseD_a:
    ...
    bVar3 = true;
    if (iVar9 == 0) goto LAB_1400b0292;
    if (iVar9 == 1) goto UNWIND_INFO_1400b0294_SizeOfProlog;
    if (iVar9 == 2) {
...
LAB_1400b0292:
        iVar9 = 1;
UNWIND_INFO_1400b0294_SizeOfProlog:
        if (pbVar10 == pbVar16) goto code_r0x0001400b02dc;
        bVar1 = *pbVar10;
        pbVar10 = pbVar10 + 1;
        if (bVar1 == 0) {
          pcVar6 = (char *)0x0;
          iVar11 = 0;
          goto code_r0x0001400b02ef;
        }
