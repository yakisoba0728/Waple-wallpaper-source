// Function: FUN_140133e60
// Addr: 140133e60
// Size: 394 bytes


void FUN_140133e60(longlong param_1,ulonglong param_2)

{
  ...
  FUN_140037590(param_1 + 0x18,2L << (bVar12 & 0x3f),plVar2);
  *(longlong *)(param_1 + 0x38) = lVar16;
  *(longlong *)(param_1 + 0x30) = lVar16 + -1;
  plVar7 = (longlong *)**(undefined8 **)(param_1 + 8);
joined_r0x000140133ee2:
  do {
    while( true ) {
      if (plVar7 == plVar2) {
        uStackX_10 = 0;
        func_0x000140134540(&uStackX_10);
        return;
      }
