...
ulonglong FUN_1402801b0(double *param_1,float param_2,undefined8 param_3,float *param_4,
...

{
  ...
  dVar9 = (double)FUN_140285390(local_f0,(double)((param_9 - param_8) + param_7),
  ...
  if (0 < iVar7) {
    do {
      ...
      if ((DAT_140492708 < dVar21) && (dVar21 < DAT_140492770)) {
        ...
        fVar36 = (float)dVar19;
        if ((((DAT_1404926c0 < param_2) && (DAT_1404926c0 < auVar24._0_4_)) &&
            (fVar36 <= DAT_1404926c0)) ||
           (((param_2 < DAT_1404926c0 && (auVar24._0_4_ < DAT_1404926c0)) &&
            (DAT_1404926c0 <= fVar36)))) {
LAB_1402803d8:
          dVar9 = (dVar21 - 0.0) * *param_1;
          dVar26 = (double)fVar36;
          if (((double)param_2 - dVar9 <= dVar26) && (dVar26 <= (double)param_2 + dVar9)) {
            dVar9 = (DAT_140492778 - dVar21) * *param_1;
          ...
          if (*(char *)(param_1 + 1) == '\0') {
            ...
            if (fVar23 != fVar36) goto LAB_1402803d8;
          }
          dVar9 = 0.0;
        }
LAB_14028044e:
        if ((0.0 < param_10) && (param_10 < DAT_140492778)) {
          local_110[0] = _DAT_140492ef0;
          local_110[1] = (double)_UNK_140492ef8;
          ...
          uVar8 = FUN_14027b660(param_1,local_110[0],local_110[1],dVar21,local_138[0],local_138[1],
                                fVar36);
          dVar9 = (double)(ulonglong)(uVar8 | SUB84(dVar9,0));
        }
        if ((0.0 < param_11) && (param_11 < DAT_140492778)) {
          local_110[0] = _DAT_140492ef0;
          local_110[1] = (double)_UNK_140492ef8;
...
LAB_140280ab1:
          ...
          dVar31 = dVar31 - DAT_140492758;
          dVar34 = dVar34 - DAT_140492758;
          ...
          dVar26 = DAT_140492778 - dVar31;
          dVar40 = DAT_140492778 - dVar34;
          ...
          dVar9 = (DAT_140492778 -
                  (double)CONCAT44((uint)((ulonglong)dVar21 >> 0x20) & _UNK_140492fd4,
                                   SUB84(dVar21,0) & _DAT_140492fd0)) *
                  (DAT_140492778 -
                  (double)CONCAT44((uint)((ulonglong)local_118 >> 0x20) & _UNK_140492fd4,
                                   SUB84(local_118,0) & _DAT_140492fd0));
          fVar29 = fVar32;
          if (fVar23 <= fVar32) {
            fVar29 = fVar23;
          }
          ...
          dVar21 = (double)FUN_140280fd0(pdVar5 + 6,local_110 + 2);
          fVar23 = fVar39;
          if (fVar39 <= fVar41) {
            fVar23 = fVar41;
          }
          ...
          dVar9 = param_1[2];
          if ((double)(float)((uint)(fVar36 - fVar28) & (uint)_DAT_140492fc0) *
              *(double *)((longlong)dVar9 + 200) <
              (double)(float)((uint)(fVar29 - fVar28) & (uint)_DAT_140492fc0)) goto LAB_140280ab1;
          uVar38 = 0;
          in_XMM2_Dc = 0;
          in_XMM2_Dd = 0;
        }
