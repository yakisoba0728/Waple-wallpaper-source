...
void FUN_1404bf6a8(char *param_1,undefined8 param_2)

{
  ...
  *pcVar1 = *pcVar1 + (char)((ulonglong)param_2 >> 8);
  ...
  bVar9 = CARRY1(*pbVar8,(byte)param_2);
  *pbVar8 = *pbVar8 + (byte)param_2;
  uVar6 = func_0x00014176f708();
  uVar7 = (uVar6 + 0xe61fe410) - (uint)bVar9;
  bVar5 = *pbVar3;
  *pbVar3 = *pbVar3 << 1 | (uVar6 < 0x19e01bf0 || uVar6 + 0xe61fe410 < (uint)bVar9);
