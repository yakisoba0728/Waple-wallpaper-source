...
longlong *
FUN_1402ac650(undefined8 param_1,longlong *param_2,longlong *param_3,longlong *param_4,
...

{
  ...
  if ((char)uVar1 < '\0') {
    ...
    *param_7 = 0;
    ...
    uVar3 = FUN_140292a60(local_50,&local_60,(int)(char)uVar1,local_68);
    *param_7 = uVar3;
  ...
  if (*param_3 == 0) {
    if (*param_4 != 0) goto LAB_1402ac780;
  }
  else if (*param_4 == 0) goto LAB_1402ac780;
  *param_6 = *param_6 | 1;
LAB_1402ac780:
  lVar2 = param_3[1];
  *param_2 = *param_3;
