// Function: FUN_14030a040
// Addr: 14030a040
// Size: 339 bytes


void FUN_14030a040(longlong param_1)
      ...
      do {
        ...
        if (uVar6 <= uVar5) {
          ...
          while (uVar3 = uVar8 + 1,
            ...
            uVar8 = uVar3;
            if (uVar5 < uVar3) goto UNWIND_INFO_14030a1a1_UnwindCodes_60__OffsetInProlog;
          }
          uVar9 = (ulonglong)uVar8;
          if (uVar5 < uVar3) goto UNWIND_INFO_14030a1a1_UnwindCodes_29__OffsetInProlog;
          do {
            if ((*(byte *)((ulonglong)uVar3 + *(longlong *)(param_1 + 0x108)) & bVar10) != 0) {
              func_0x000140311be0(&local_58,(int)uVar9 + 1,uVar3 - 1,uVar9,uVar3);
              uVar9 = (ulonglong)uVar3;
            }
            uVar3 = uVar3 + 1;
          } while (uVar3 <= uVar5);
          if ((uint)uVar9 == uVar8) {
UNWIND_INFO_14030a1a1_UnwindCodes_29__OffsetInProlog:
            uVar8 = (uint)uVar9;
            ...
            func_0x000140311be0(&local_58,(uint)uVar9 + 1 & 0xffff,uVar5,uVar9,uVar8);
            if (uVar8 != 0) {
              func_0x000140311be0(&local_58,uVar7,uVar8 - 1,uVar9,uVar8);
            }
          }
        }
UNWIND_INFO_14030a1a1_UnwindCodes_60__OffsetInProlog:
        uVar6 = uVar3;
