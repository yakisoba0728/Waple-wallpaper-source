// Function: FUN_1403df400
// Addr: 1403df400
// Size: 523 bytes


void FUN_1403df400(longlong param_1,char *param_2)

{
  ...
  if (uVar6 + 4 <= uVar5) {
    do {
      ...
      *(double *)(param_1 + 0x11c0) = dVar11 + dVar1;
      *(double *)(param_1 + 0x11c8) = dVar2;
      if (dVar11 + dVar1 < *(double *)(param_2 + 8)) {
        *(undefined8 *)(param_2 + 8) = *(undefined8 *)(param_1 + 0x11c0);
      }
      if (*(double *)(param_2 + 0x18) <= *(double *)(param_1 + 0x11c0) &&
          *(double *)(param_1 + 0x11c0) != *(double *)(param_2 + 0x18)) {
