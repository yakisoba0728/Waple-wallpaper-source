// Function: FUN_1401d4360
// Addr: 1401d4360
// Size: 153 bytes


void FUN_1401d4360(undefined8 param_1,longlong param_2,ulonglong param_3,undefined8 *param_4)
  ...
  if (bVar1 != 0xff) {
    ...
    if (((lVar2 == 0) || (*(longlong *)(lVar2 + 8) == 0)) ||
       ((ulonglong)(*(longlong *)(lVar2 + 0x2d0) - *(longlong *)(lVar2 + 0x2c8) >> 6) <=
        (ulonglong)bVar1)) {
      puVar6 = &DAT_1404e10b0;
    }
    else {
      puVar6 = (undefined *)(*(longlong *)(lVar2 + 0x2c8) + lVar5);
    }
    puVar4 = (undefined8 *)FUN_14005ecb0(local_48,puVar6,*(longlong *)(param_2 + 0x68) + lVar5);
    uVar3 = puVar4[1];
    *param_4 = *puVar4;
    param_4[1] = uVar3;
    uVar3 = puVar4[3];
