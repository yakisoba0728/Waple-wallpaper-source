...
void FUN_1402fe1b0(longlong *param_1,longlong param_2)

{
  ...
  local_48 = DAT_1404dc040 ^ (ulonglong)auStack_248;
  piVar10 = (int *)(&DAT_140438050 + (longlong)*(int *)(*param_1 + 0xc) * 8);
  local_228 = param_1;
  local_218 = piVar10;
  local_200 = param_2;
  uVar9 = FUN_1404144f0();
  ...
  do {
    ...
    while( true ) {
      ...
      if (cVar2 == '|') {
        ...
        pcVar13 = (char *)FUN_140305960(pcVar13,plVar12,uVar9,local_210);
        if (local_210[0] < 2) {
          piVar10 = (int *)FUN_1404148a0(uVar9,local_220);
          FUN_1404148b0(uVar9,local_220);
          plVar12 = local_228;
          if ((((local_220[0] != 0) && (*piVar10 != 0)) &&
              (iVar7 = FUN_1402f12d0(param_2,*piVar10,1), iVar7 == 0)) &&
