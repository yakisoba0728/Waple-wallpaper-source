...
undefined4 *
FUN_140033bd0(undefined8 param_1,undefined4 *param_2,undefined4 *param_3,longlong param_4,
...

{
  ...
  if (((uVar15 == 0x2000) && (bVar16)) &&
     (uVar15 = (uint)param_6 & _DAT_140492fd0, uVar17 = uVar17 & _UNK_140492fd4,
     DAT_1404928b0 <= (double)CONCAT44(uVar17,uVar15) &&
     (double)CONCAT44(uVar17,uVar15) != DAT_1404928b0)) {
    local_res20[0] = 0;
    FUN_1402ca370((uint)param_6,local_res20);
    iVar7 = -local_res20[0];
    if (-local_res20[0] < 0) {
      iVar7 = local_res20[0];
    }
  ...
  if (local_58 < uVar1) {
    ...
    if (local_50 - local_58 < uVar13) {
      FUN_140016cc0(&local_68,uVar13,(undefined1)local_res20[0],uVar13,
      ...
      local_58 = uVar1;
      FUN_1404217a0(lVar12,0,uVar13);
      *(undefined1 *)(lVar12 + uVar13) = 0;
    }
  }
  else {
    pppppuVar8 = &local_68;
...
LAB_140033e00:
  *(undefined1 *)((longlong)puVar10 + 3) = uVar6;
  *(undefined1 *)(puVar10 + 2) = 0;
  pppppuVar8 = &local_68;
  if (0xf < local_50) {
    pppppuVar8 = (undefined8 *****)local_68;
  }
  iVar7 = FUN_1400162a0(pppppuVar8,local_58,&local_88,uVar11 & 0xffffffff,param_6);
  uVar3 = param_3[1];
  uVar4 = param_3[2];
  uVar5 = param_3[3];
  if (iVar7 < 0) {
    *param_2 = *param_3;
    ...
    uStack_70 = uVar4;
    uStack_6c = uVar5;
    FUN_1400356e0(param_1,param_2,&local_78,param_4,param_5,pppppuVar8,(longlong)iVar7,bVar16);
  }
  if (0xf < local_50) {
    uVar11 = local_50 + 1;
    pppppuVar8 = (undefined8 *****)local_68;
    ...
    thunk_FUN_14028af80(pppppuVar8,uVar11);
  }
  return param_2;
}
