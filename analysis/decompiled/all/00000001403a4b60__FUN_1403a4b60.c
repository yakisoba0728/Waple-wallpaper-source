// Function: FUN_1403a4b60
// Addr: 1403a4b60
// Size: 279 bytes


undefined8 FUN_1403a4b60(uint *param_1,uint param_2,char param_3)

{
  ...
  if (uVar4 == 0) {
    ...
    if ((uVar2 == 0) && (*(longlong *)puVar1 != 0)) {
      lVar3 = _malloc_base((ulonglong)uVar4 << 4);
      if (lVar3 == 0) {
LAB_1403a4c64:
        if (uVar4 <= *param_1) {
          return 1;
      ...
      lVar3 = _realloc_base(*(undefined8 *)puVar1,(ulonglong)uVar4 << 4);
      if (lVar3 == 0) goto LAB_1403a4c64;
    }
  }
