// Function: FUN_1402afa20
// Addr: 1402afa20
// Size: 70 bytes


undefined8 *
FUN_1402afa20(undefined8 param_1,undefined8 *param_2,undefined8 *param_3,undefined8 param_4,
  ...
  *param_6 = *param_6 | uVar1;
  if ((uVar1 & 2) == 0) {
    if (aiStackX_10[0] < 3) {
      ...
      else if (99 < (int)param_5) goto code_r0x0001402afb18;
    }
    else {
