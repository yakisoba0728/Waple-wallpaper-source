...
void FUN_14025d4f0(longlong *param_1)

{
  ...
  if ((char)param_1[0x58] == '\0') {
    ...
    fVar10 = _UNK_1404929c4;
    if (((cVar3 != '\x01') && (cVar3 != '\x02')) && (fVar10 = _UNK_1404929c0, cVar3 != '\x03')) {
      fVar10 = _UNK_1404929bc;
    }
    fVar11 = DAT_1404927d4;
    if (((*(uint *)(lVar4 + 0x118) & 0x400) == 0) &&
       (fVar11 = _UNK_140492714, _UNK_140492714 <= *(float *)((longlong)param_1 + 0x30c))) {
      fVar11 = *(float *)((longlong)param_1 + 0x30c);
    }
    fVar14 = *(float *)(param_1 + 0x5d);
    if (*(float *)(param_1 + 0x5d) <= fVar11 + DAT_1404926f0) {
      fVar14 = fVar11 + DAT_1404926f0;
    }
    (**(code **)(**(longlong **)(lVar4 + 0x1518) + 0x10))
              (*(longlong **)(lVar4 + 0x1518),param_1 + 0x67,fVar10 * DAT_1404926f8,DAT_1404927d4,
               fVar11,fVar14);
  }
...
code_r0x00014025d910:
    do {
      ...
      if (iVar9 != 0) {
        ...
        if (iVar9 == 3) goto code_r0x00014025d943;
      }
      iVar9 = iVar9 + 1;
      fVar10 = fVar2;
      if (3 < iVar9) {
code_r0x00014025d943:
        local_188[0xc] =
             (float)((uint)(fVar10 * fVar1 + fVar11 * local_138 + fVar14 * local_188[0x10]) ^
                    DAT_1404930c0);
        fVar10 = _UNK_140492714;
        if ((*(uint *)(param_1[0x19] + 0x118) & 0x400) != 0) {
          fVar10 = DAT_1404927d4;
        }
        plVar8 = *(longlong **)(param_1[0x19] + 0x1518);
        fVar11 = *(float *)(param_1 + 0x5d);
        if (*(float *)(param_1 + 0x5d) <= fVar10 + DAT_1404926f0) {
          fVar11 = fVar10 + DAT_1404926f0;
        }
        (**(code **)(*plVar8 + 0x10))
                  (plVar8,auStack_e8,
                   (*(float *)((longlong)param_1 + 0x2f4) + *(float *)((longlong)param_1 + 0x2f4)) *
                   DAT_1404926f8,DAT_1404927d4,fVar10,fVar11);
        plVar8 = (longlong *)FUN_14005ed80(auStack_128,auStack_e8,local_188);
        lVar4 = plVar8[1];
        param_1[0x67] = *plVar8;
        param_1[0x68] = lVar4;
        lVar4 = plVar8[3];
