...
ulonglong FUN_140387700(longlong *param_1,longlong param_2,undefined8 *param_3,uint *param_4,
...

{
  ...
  if (0x40 < param_14) goto LAB_140387ae7;
  local_d8 = 0;
  local_b8 = &local_d8;
  ...
  if (0x800 < uVar15) goto LAB_140387ae7;
  *local_b8 = uVar15 + 1;
  if (param_7 != 0) {
    uVar15 = param_14;
...
LAB_14038780b:
    ...
    uStack_e8 = param_1[1];
    local_e0 = param_1[2];
    puVar10 = (undefined1 *)FUN_1403c6db0(&local_f8,param_4,param_11);
    if ((char)puVar10 == '\0') goto LAB_140387ae7;
  }
  else {
    local_158 = (uint *)(param_5 + 0x10);
    local_148 = (uint *)(param_5 + 0x14);
    local_160 = *local_148;
    if (iVar25 == 1) goto LAB_14038780b;
    if (iVar25 == 2) {
      uVar18 = param_1[2];
      iVar25 = (int)uVar18;
      uVar26 = param_1[1];
      ...
      if ((uVar26 <= uVar19) && (uVar19 <= (uVar18 & 0xffffffff) + uVar26)) {
        ...
        if (3 < (uint)((iVar25 - (int)uVar19) + iVar16)) {
          ...
          if (((uint)uVar21 <= (uint)((iVar25 - (int)uVar19) + iVar16)) && (uVar19 != 0)) {
            do {
              FUN_1403cf250(uVar19,&local_f8,&local_d0);
              puVar10 = (undefined1 *)FUN_1403a4d50(local_158,*local_148 + 5,0);
              if ((char)puVar10 == '\0') goto LAB_140387ae7;
              if (((int)*local_148 < (int)*local_158) ||
                 (cVar7 = FUN_1403a4d50(local_158,*local_148 + 1,0), cVar7 != '\0')) {
                uVar15 = *local_148;
  ...
  puVar10 = (undefined1 *)FUN_1403f87a0(local_158);
  if ((char)puVar10 == '\0') {
LAB_140387ae7:
...
LAB_140387bb8:
  ...
  iVar8 = FUN_1403c60c0(puVar4,uVar15);
  iVar9 = FUN_1403c60c0(puVar6,uVar15);
  if (local_164 != 0) {
  ...
  DAT_1404e4ff0 = DAT_14045dde0;
  DAT_1404e4ff8._0_4_ = _DAT_14045dde8;
  pfVar11 = (float *)((longlong)&DAT_1404e4ff0 + 4);
LAB_140387c8e:
  *pfVar11 = (float)(iVar16 - iVar9);
  ...
  for (iVar25 = *(int *)(param_12 + 2); iVar25 != 0; iVar25 = iVar25 + -1) {
    if (*piVar12 != 0) {
      ...
      puVar10 = (undefined1 *)
                FUN_1403ad900(*param_3,(int)param_1[4],&local_138,&local_f8,param_5,param_13,uVar24)
      ;
      if ((char)puVar10 == '\0') goto LAB_140387ae7;
      break;
    }
  ...
  if (((param_6 != (uint *)0x0) && (param_14 == 0)) && (*(int *)((longlong)param_1 + 0x24) == 2)) {
    ...
    param_6[1] = 0;
    FUN_1403a4d50(param_6,*local_148);
    if (-1 < (int)*param_6) {
      param_6[1] = 0;
      if ((*local_148 * 3 & 0x3fffffff) != 0) {
                    /* WARNING: Subroutine does not return */
        FUN_1404211c0(*(undefined8 *)(param_6 + 2),*(undefined8 *)(local_158 + 2));
      }
      param_6[1] = param_6[1] + *local_148;
    }
  }
  iVar25 = *(int *)((longlong)param_1 + 0x24);
  if (iVar25 == 0) {
    FUN_1403a4d50(param_4,param_4[1] + local_164,0);
    if (-1 < (int)*param_4) {
      if (local_164 * 3 != 0) {
                    /* WARNING: Subroutine does not return */
        FUN_1404211c0(*(longlong *)(param_4 + 2) + (ulonglong)param_4[1] * 0xc,local_150,
                      local_164 * 0xc);
      }
    ...
    if (local_164 == 0) {
      DAT_1404e4ff0 = DAT_14045dde0;
      DAT_1404e4ff8._0_4_ = _DAT_14045dde8;
      local_150 = (float *)&DAT_1404e4ff0;
    }
    fVar31 = *local_150;
    FUN_1403f87a0(local_158,local_160);
  }
  else if (iVar25 == 1) {
    ...
    if (local_164 == 0) {
      DAT_1404e4ff0 = DAT_14045dde0;
      uVar13 = DAT_1404e4ff0;
      DAT_1404e4ff8._0_4_ = _DAT_14045dde8;
      DAT_1404e4ff0._0_4_ = (float)DAT_14045dde0;
      fVar31 = (float)DAT_1404e4ff0;
      DAT_1404e4ff0 = uVar13;
    }
    else {
      fVar31 = *local_150;
    }
            ...
            do {
              ...
              if ((*(char ***)(local_118 + 8) == &local_118) ||
                ...
                if ((param_11 == '\0') ||
                  ...
                  pfStack_130 = (float *)param_12[1];
                  local_128 = param_12[2];
                  uVar13 = FUN_1403d02e0(param_3,local_b0,local_108,0);
                  cVar7 = FUN_140387700(uVar13,param_2,param_3,param_4,param_5,param_6,param_7,
                                        param_8,param_9,param_10,param_11,&local_138,param_13,
                                        param_14 + 1,local_b8);
                  if (cVar7 != '\0') goto LAB_140388088;
                }
                else {
LAB_140388088:
                  uVar20 = *local_148 - 4;
                  ...
                  if ((param_10 != '\0') &&
                    ...
                    if (uVar20 - 4 < uVar20) {
                      ...
                      DAT_1404e4ff0 = DAT_14045dde0;
                      DAT_1404e4ff8._0_4_ = _DAT_14045dde8;
                      pfVar14 = (float *)&DAT_1404e4ff0;
                    }
                    pfVar17 = local_150;
                    if (local_164 == 0) {
                      DAT_1404e4ff0 = DAT_14045dde0;
                      DAT_1404e4ff8._0_4_ = _DAT_14045dde8;
                      pfVar17 = (float *)&DAT_1404e4ff0;
                    }
                  ...
                  if (uVar20 != 0) {
                    FUN_1403cf250(pbVar27,&local_f8,&local_138);
                  ...
                  FUN_1403f87a0(param_4,param_4[1] - 4);
