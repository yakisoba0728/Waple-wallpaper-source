...
undefined8 *
FUN_1402b04b0(undefined8 param_1,undefined8 *param_2,undefined8 *param_3,undefined1 param_4,
...

{
  ...
  if (iVar6 < 0) {
    ...
    *param_2 = *param_3;
    ...
    local_80 = 0;
    local_78 = 0;
    FUN_140294ec0(&local_90,0,(longlong)iVar6);
    pppppuVar9 = &local_90;
    if (7 < local_78) {
      pppppuVar9 = (undefined8 *****)local_90;
    }
    (*(code *)PTR__guard_dispatch_icall_140426ae8)(local_c8,local_70,local_70 + iVar6,pppppuVar9);
    FUN_1402a9cf0(&local_90,uVar12,uVar5);
    local_f0 = FUN_14029d850(local_b0,&local_90);
    local_c8 = *param_3;
    uStack_c0 = param_3[1];
    local_f8 = local_d8;
    local_100 = param_6;
    local_108 = param_5;
    local_e8 = uVar5;
    FUN_1402a7ed0(local_b8,param_2,&local_c8,local_d7);
    if (7 < local_78) {
      if (DAT_140472230 != '\0') {
      ...
      *(undefined8 *)(puVar11 + -8) = 0x1402b070d;
      thunk_FUN_14028af80(pppppuVar9);
    }
  }
  *(undefined8 *)(puVar11 + -8) = 0x1402b071c;
  return param_2;
}
