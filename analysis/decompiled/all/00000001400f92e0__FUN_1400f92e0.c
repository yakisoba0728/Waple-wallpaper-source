// Function: FUN_1400f92e0
// Addr: 1400f92e0
// Size: 626 bytes


longlong * FUN_1400f92e0(float *param_1,longlong *param_2,undefined8 *param_3)
  ...
  if (*param_1 <= fVar11 && fVar11 != *param_1) {
    ...
    if (puVar9 != *(undefined8 **)(param_1 + 2)) {
      ...
      while( true ) {
        ...
        if (puVar8 == puVar2) goto LAB_1400f94da;
  ...
  *puVar9 = puVar6;
  ...
  if (puVar2 == *(undefined8 **)(param_1 + 2)) {
    *(undefined8 **)(lVar3 + uVar10 * 0x10) = puVar6;
    ...
    if (*(undefined8 **)(lVar3 + 8 + uVar10 * 0x10) != puVar9) goto LAB_1400f952a;
  }
