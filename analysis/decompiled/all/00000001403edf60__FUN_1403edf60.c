// Function: FUN_1403edf60
// Addr: 1403edf60
// Size: 664 bytes


void FUN_1403edf60(longlong param_1,longlong param_2,undefined4 param_3)

{
  ...
  if (*(longlong *)(lVar13 + 0x98) != 0) {
    uVar14 = *(undefined8 *)(*(longlong *)(lVar13 + 0x98) + 0x58);
  }
  (**(code **)(lVar13 + 0x68))
            (lVar13,*(undefined8 *)(param_2 + 0x18),&local_108,
             ...
             fVar19 + (float)((uint)bVar7 + (uint)bVar8 * 0x100),
             fVar18 + (float)(int)(short)((ushort)bVar2 * 0x100 + (ushort)bVar6),
             fVar17 + (float)(int)(short)((ushort)bVar5 + (ushort)bVar1 * 0x100),
             fVar16 + (float)((uint)bVar3 + (uint)bVar4 * 0x100),uVar14);
  return;
}
