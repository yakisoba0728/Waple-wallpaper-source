// Function: FUN_14027b760
// Addr: 14027b760
// Size: 478 bytes


void FUN_14027b760(longlong *param_1,longlong *param_2)
      ...
      if (plVar10 != (longlong *)plVar12[1]) {
        ...
        do {
          ...
          if ((uVar8 & uVar8 - 1) == 0) {
            ...
            dVar13 = (double)FUN_14041a500((*pdVar7 + (double)param_1[5]) * (double)param_1[3] -
                                           dVar5);
            iVar11 = (int)dVar13;
            dVar13 = (double)FUN_14041a500(((double)param_1[6] + pdVar7[1]) * (double)param_1[4] -
                                           dVar5);
