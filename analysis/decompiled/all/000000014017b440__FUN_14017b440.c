// Function: FUN_14017b440
// Addr: 14017b440
// Size: 406 bytes


void FUN_14017b440(longlong param_1,ulonglong param_2)
...
joined_r0x00014017b4c2:
  do {
    while( true ) {
      if (plVar7 == plVar2) {
        uStackX_10 = 0;
        func_0x00014017ba10(&uStackX_10);
        return;
      }
