// Function: FUN_1401f44c0
// Addr: 1401f44c0
// Size: 368 bytes


longlong FUN_1401f44c0(longlong param_1,char *param_2)

{
  ...
  lVar6 = *(longlong *)(DAT_1404e84f8 + 8 + (DAT_1404e8510 & uVar9) * 0x10);
  if (lVar6 != DAT_1404e84e8) {
    lVar7 = *(longlong *)(DAT_1404e84f8 + (DAT_1404e8510 & uVar9) * 0x10);
    cVar2 = FUN_14000d010(lVar6 + 0x10,param_2);
    while (cVar2 == '\0') {
      if (lVar6 == lVar7) goto LAB_1401f456e;
      lVar6 = *(longlong *)(lVar6 + 8);
      cVar2 = FUN_14000d010(lVar6 + 0x10,param_2);
    }
    if (lVar6 != 0) goto LAB_1401f4575;
  }
LAB_1401f456e:
  lVar6 = DAT_1404e84e8;
LAB_1401f4575:
