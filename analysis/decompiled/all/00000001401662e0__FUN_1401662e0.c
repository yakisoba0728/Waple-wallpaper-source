// Function: FUN_1401662e0
// Addr: 1401662e0
// Size: 772 bytes


longlong * FUN_1401662e0(longlong *param_1,char *param_2,longlong param_3,uint param_4,uint param_5)

{
  ...
  *(uint *)((longlong)&local_38 + uVar7 * 4) = uVar8;
  ...
  if ((uint)local_38 < 1000000000) {
    uVar6 = FUN_140166270(local_38 & 0xffffffff);
  }
  else {
    uVar6 = 10;
  }
    ...
    *(undefined4 *)(param_1 + 1) = 0x84;
    ...
    if ((uint)uVar7 < 10000) {
      ...
      do {
        ...
        *(undefined2 *)(param_2 + (uVar9 - uVar12) + -2) =
             *(undefined2 *)(&DAT_14048be00 + (uVar6 % 100) * 2);
    ...
    if (99 < uVar10) {
      ...
      *(undefined2 *)(param_2 + (uVar9 - uVar8) + -2) =
           *(undefined2 *)(&DAT_14048be00 + (uVar10 + uVar6 * -100) * 2);
      uVar8 = uVar12;
    }
    if (uVar6 < 10) {
      ...
      *(undefined2 *)(param_2 + (uVar9 - uVar8) + -2) = *(undefined2 *)(&DAT_14048be00 + uVar6 * 2);
    }
      ...
      if (auStack_28[uVar13] == 0) {
        ...
        do {
          ...
          *(undefined2 *)(param_2 + (7 - lVar5)) =
               *(undefined2 *)(&DAT_14048be00 + ((uVar6 % 10000) % 100) * 2);
