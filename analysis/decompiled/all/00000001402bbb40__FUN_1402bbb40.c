// Function: FUN_1402bbb40
// Addr: 1402bbb40
// Size: 711 bytes


undefined1 (*) [16] FUN_1402bbb40(undefined1 (*param_1) [16],undefined1 (*param_2) [16])
...
LAB_1402bbde6:
        ...
        if ((*param_1)[0] != (*pauVar4)[0]) goto LAB_1402bbdde;
        pauVar4 = (undefined1 (*) [16])(*pauVar4 + 1);
      }
      uVar5 = (ulonglong)((uint)pauVar4 & 0xfff);
      if (0xff0 < uVar5) goto LAB_1402bbde6;
      pcmpistri(*pauVar4,*param_1,0xc);
      if (!SBORROW8(uVar5,0xff0)) goto LAB_1402bbdde;
