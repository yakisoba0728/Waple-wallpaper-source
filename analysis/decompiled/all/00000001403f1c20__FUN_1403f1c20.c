// Function: FUN_1403f1c20
// Addr: 1403f1c20
// Size: 466 bytes


void FUN_1403f1c20(undefined8 param_1,longlong param_2,longlong param_3,int *param_4,uint param_5,
                  int param_6)

{
  ...
  local_28 = DAT_1404dc110 ^ (ulonglong)auStack_58;
  iVar1 = FUN_1403c9a70(param_2,*(undefined4 *)
                                 (*(longlong *)(param_3 + 0x70) + (ulonglong)param_5 * 0x14),
                        &local_38,1);
  if (iVar1 == 0) goto switchD_1403f1d5b_caseD_1;
  ...
  *(undefined8 *)(lVar3 + 8) = 0;
  ...
  case 0x1c:
    *(int *)(lVar3 + 8) = *param_4 - local_38;
    break;
  default:
switchD_1403f1cba_caseD_1:
    *(int *)(lVar3 + 8) = ((param_4[2] - local_30) / 2 - local_38) + *param_4;
    if (0x22 < uVar4) goto switchD_1403f1d5b_caseD_1;
    break;
  case 0x10:
  case 0x16:
  case 0x20:
  ...
  case 0x22:
    if (*(int *)(param_3 + 0x38) == 4) {
      *(int *)(lVar3 + 8) = ((param_4[2] - local_30 / 2) - local_38) + *param_4;
      ...
      if (*(int *)(param_3 + 0x38) != 5) goto switchD_1403f1cba_caseD_1;
      *(int *)(lVar3 + 8) = (*param_4 - local_30 / 2) - local_38;
    }
  }
  iVar1 = (int)((iVar1 >> 0x1f & 0xfU) + iVar1) >> 4;
                    /* WARNING: Could not find normalized switch variable to match jumptable */
  switch((&switchD_1403f1d5b::switchdataD_1403f1e40)[uVar4]) {
  default:
    goto switchD_1403f1d5b_caseD_1;
  case 0x12:
  case 0x14:
  case 0x16:
  case 0x21:
...
switchD_1403f1d5b_caseD_1:
  func_0x0001402ed2f0(local_28 ^ (ulonglong)auStack_58);
  return;
}
