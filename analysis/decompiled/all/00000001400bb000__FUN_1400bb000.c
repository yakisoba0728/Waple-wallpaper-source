// Function: FUN_1400bb000
// Addr: 1400bb000
// Size: 1571 bytes


uint * FUN_1400bb000(longlong param_1,uint *param_2,longlong *param_3,undefined1 param_4,
                    longlong *param_5)

{
  ...
  case 0:
    ...
    if (bVar4 != 0x40) {
      ...
      uVar13 = 1;
      goto switchD_1400bb074_caseD_1;
    }
  case 2:
switchD_1400bb074_caseD_2:
        ...
        *(undefined4 *)(param_1 + 0x78) = 0x54416466;
        if (3 < uVar15) {
          ...
          *(uint *)(param_1 + 0x7c) = uVar15 - 4;
          goto switchD_1400bb074_caseD_3;
        }
LAB_1400bb154:
        pcVar9 = "#png: bad chunk";
        goto LAB_1400bb67d;
      }
      if (iVar7 == 0x4c546366) goto LAB_1400bb154;
      uVar13 = 5;
      *(ulonglong *)(param_1 + 0xae38) = (ulonglong)uVar15 + 0xc;
switchD_1400bb074_caseD_5:
    ...
    break;
  case 1:
switchD_1400bb074_caseD_1:
    pcVar9 = (char *)FUN_1400ba560(param_1,0);
    if (param_3 != (longlong *)0x0) {
      puVar17 = (uint *)(param_3[3] + *param_3);
    }
    if ((uint *)pcVar9 == (uint *)0x0) goto switchD_1400bb074_caseD_2;
UNWIND_INFO_1400bb61d_UnwindCodes_28__UnwindOpCode:
    if ((byte)*(uint *)pcVar9 != 0x24) goto switchD_1400bb074_default;
    bVar6 = true;
    break;
  case 3:
switchD_1400bb074_caseD_3:
...
LAB_1400bb31f:
          ...
          *(undefined1 *)(param_1 + 0x70) = 1;
          ...
          lStack_60 = 0x400;
          uStack_50 = 0x400;
          pcVar9 = (char *)FUN_1400a2590(param_1 + 0x118,uVar15,&local_58,
            ...
            *(undefined8 *)(param_1 + 0x40) = 0;
            while( true ) {
              if (*(char *)(param_1 + 0x78) == 'I') {
                ...
                uVar15 = (uint)(byte)(&DAT_140479991)[uVar10 * 6] + *(int *)(param_1 + 0x28) >>
                         ((&DAT_140479990)[uVar10 * 6] & 0x1f);
                uVar16 = (uint)(byte)(&DAT_140479994)[uVar10 * 6] + *(int *)(param_1 + 0x2c) >>
                         ((&DAT_140479993)[uVar10 * 6] & 0x1f);
              }
              else {
              ...
              if ((uVar15 != 0) && ((uVar16 & 0xffffff) != 0)) {
                ...
                if (bVar4 == 1) {
                  ...
                  uVar10 = (ulonglong)(byte)(&DAT_1404796c0)[*(byte *)(param_1 + 0x61)] *
                           (ulonglong)(bVar4 >> 3) * (ulonglong)uVar15;
                }
                *(ulonglong *)(param_1 + 0x30) = uVar10;
                *(ulonglong *)(param_1 + 0x50) = (uVar10 + 1) * (ulonglong)(uVar16 & 0xffffff);
switchD_1400bb074_caseD_6:
                local_68 = *param_5;
                lStack_60 = param_5[1];
                if (param_3 == (longlong *)0x0) {
                  pcVar9 = (char *)FUN_1400bb6d0(param_1,0);
                }
                else {
                  param_3[3] = (longlong)puVar17 - *param_3;
                  pcVar9 = (char *)FUN_1400bb6d0(param_1,param_3);
                  puVar17 = (uint *)(param_3[3] + *param_3);
                }
                if ((uint *)pcVar9 != (uint *)0x0) {
                  ...
                  if ((byte)*(uint *)pcVar9 != 0x24) goto LAB_1400bb67d;
                  uVar13 = 6;
                  goto UNWIND_INFO_1400bb61d_UnwindCodes_28__UnwindOpCode;
                }
                local_58 = *param_5;
                uStack_50 = param_5[1];
                pcVar9 = (char *)(**(code **)(param_1 + 0x198))(param_1,param_2);
                if ((uint *)pcVar9 != (uint *)0x0) goto LAB_1400bb411;
...
LAB_1400bb411:
            if ((byte)*(uint *)pcVar9 == 0x23) goto LAB_1400bb67d;
...
LAB_1400bb251:
    ...
    break;
  case 5:
    goto switchD_1400bb074_caseD_5;
  case 6:
    goto switchD_1400bb074_caseD_6;
  default:
switchD_1400bb074_default:
    bVar6 = false;
  }
  uVar8 = 0;
  if (bVar6) {
