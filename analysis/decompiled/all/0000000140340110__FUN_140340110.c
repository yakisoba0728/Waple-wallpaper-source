// Function: FUN_140340110
// Addr: 140340110
// Size: 764 bytes


ulonglong FUN_140340110(uint *param_1,uint *param_2,int *param_3,ulonglong param_4,
                       undefined8 param_5)

{
  ...
  local_res20 = param_4;
  uVar6 = FUN_1402f7ff0(param_5,8,0,uVar11 * 2,0,&local_res20);
  *(undefined8 *)(param_1 + 4) = uVar6;
  uVar7 = local_res20 & 0xffffffff;
  if ((int)local_res20 == 0) {
    uVar6 = FUN_1402f7ff0(param_5,0x28,0,uVar11,0,&local_res20);
    *(undefined8 *)(param_1 + 2) = uVar6;
    uVar7 = local_res20 & 0xffffffff;
    if ((int)local_res20 == 0) {
      uVar6 = FUN_1402f7ff0(param_5,0x10,0,uVar11 * 2 + 1,0,&local_res20);
                  ...
                  if ((uVar13 & 4) == 0) {
                    ...
                    if (uVar13 != 0) {
                      while( true ) {
                        ...
                        break;
                        uVar13 = uVar13 - 1;
                        if (uVar13 == 0) goto LAB_140340307;
                        puVar9 = puVar9 + 1;
                      }
                      *(int **)(piVar1 + 6) = piVar2;
                    }
              ...
              if ((uVar15 & 4) == 0) {
                ...
                if (uVar14 != 0) {
                  while( true ) {
                    ...
                    uVar14 = uVar14 - 1;
                    if (uVar14 == 0) goto LAB_1403403c4;
                    puVar9 = puVar9 + 1;
                  }
                  *(int **)(piVar1 + 6) = piVar2;
                }
