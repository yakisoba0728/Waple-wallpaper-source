// Function: FUN_1404ad170
// Addr: 1404ad170
// Size: 1 bytes


/* WARNING: Control flow encountered bad instruction data */
/* WARNING: Instruction at (ram,0x0001404ad171) overlaps instruction at (ram,0x0001404ad170)
    */
/* WARNING: Removing unreachable block (ram,0x0001404ad166) */
/* WARNING: Removing unreachable block (ram,0x0001404ad0ef) */

void FUN_1404ad170(byte *param_1,char *param_2)

{
  ...
  *(uint *)CONCAT44(in_register_00000004,CONCAT22(in_register_00000002,CONCAT11(in_AH,in_AL))) =
       *(int *)CONCAT44(in_register_00000004,CONCAT22(in_register_00000002,CONCAT11(in_AH,in_AL))) +
       CONCAT22(in_register_00000002,CONCAT11(in_AH,in_AL)) + (uint)CARRY1(bVar5,unaff_BH);
  if (*(int *)CONCAT44(in_register_00000004,CONCAT22(in_register_00000002,CONCAT11(in_AH,in_AL))) <
      0) {
    while( true ) {
      in_AL = in_AL | *(byte *)CONCAT44(in_register_00000004,
                                        CONCAT22(in_register_00000002,CONCAT11(in_AH,in_AL)));
      cVar6 = (char)param_2;
      param_2 = (char *)CONCAT62((int6)((ulonglong)param_2 >> 0x10),
                                 CONCAT11((char)((ulonglong)param_2 >> 8) +
                                          *(char *)((longlong)param_1 * 2),cVar6));
      *param_2 = *param_2 + cVar6;
      bVar5 = (byte)param_1 ^ *unaff_RSI;
      param_1 = (byte *)(CONCAT71((int7)((ulonglong)param_1 >> 8),bVar5) + -1);
      if (param_1 == (byte *)0x0 || bVar5 == 0) {
      ...
      *param_1 = *param_1 + 0x4a;
      param_1 = (byte *)CONCAT71((int7)((ulonglong)param_1 >> 8),
                                 (char)param_1 +
                                 *(char *)CONCAT44(in_register_00000004,
                                                   CONCAT22(in_register_00000002,
                                                            CONCAT11(in_AH,0x4a))) + (0xb5 < bVar5))
      ;
      *param_2 = *param_2 + cVar6;
