// Function: FUN_1400380d0
// Addr: 1400380d0
// Size: 433 bytes


ulonglong *
FUN_1400380d0(ulonglong *param_1,ulonglong param_2,undefined8 param_3,longlong param_4,
...
LAB_14003819e:
    ...
    if (uVar5 < 0x10) {
      ...
      FUN_1404210f0(lVar3,param_5,param_6);
      FUN_1404210f0(lVar3 + param_6,(longlong)param_1 + param_4,lVar7);
      goto LAB_140038252;
    }
    uVar9 = *param_1;
    FUN_1404210f0(unaff_RDI,uVar9,param_4);
    FUN_1404210f0(lVar3,param_5,param_6);
    FUN_1404210f0(lVar3 + param_6,uVar9 + param_4,lVar7);
    if (0xfff < uVar5 + 1) {
...
LAB_14003821a:
  ...
  *(undefined8 *)(puVar10 + -8) = 0x140038229;
