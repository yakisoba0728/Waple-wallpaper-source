...
void FUN_140284550(double *param_1,undefined4 *param_2,longlong *param_3,longlong *param_4,
                  longlong *param_5)

{
  ...
  cVar13 = FUN_140284250(param_1,param_2,param_3,param_1 + 6);
  if (cVar13 != '\0') {
    local_e8 = param_1[6];
    ...
    uVar12 = _UNK_1404930a4;
    uVar11 = _DAT_1404930a0;
    uVar15 = SUB84(*param_1,0) & _DAT_1404930a0;
    uVar17 = (uint)((ulonglong)*param_1 >> 0x20) & _UNK_1404930a4;
    dVar24 = (double)CONCAT44((uint)((ulonglong)local_d8 >> 0x20) & _UNK_1404930a4,
                              SUB84(local_d8,0) & _DAT_1404930a0);
    ...
    *param_2 = uVar6;
    ...
    uVar10 = DAT_140492848;
    dVar4 = param_1[6] - *pdVar14;
    dVar5 = param_1[7] - pdVar14[1];
    pdVar14 = (double *)(**(code **)(*param_4 + 0x20))(param_4,&local_e8,DAT_140492848);
    ...
    uVar25 = (uint)((ulonglong)DAT_1404930b0 >> 0x20);
