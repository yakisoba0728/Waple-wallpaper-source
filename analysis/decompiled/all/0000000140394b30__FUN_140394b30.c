// Function: FUN_140394b30
// Addr: 140394b30
// Size: 277 bytes


undefined8 *
FUN_140394b30(undefined8 *param_1,longlong param_2,int param_3,undefined8 param_4,undefined8 param_5
             )

{
  ...
  if (param_3 == 0x47504f53) {
    puVar2 = (undefined8 *)FUN_1403c4fa0(param_2 + 0x148);
  }
  else {
    ...
    puVar2 = (undefined8 *)FUN_1403c5040(param_2 + 0x140);
  }
  puVar1 = &DAT_14045dde0;
...
LAB_140394b93:
  ...
  *(undefined4 *)(param_1 + 0x1f) = 0;
  func_0x0001403b6e40(param_1,param_5);
  return param_1;
}
