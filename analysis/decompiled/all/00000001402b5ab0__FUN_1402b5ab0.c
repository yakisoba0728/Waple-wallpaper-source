// Function: FUN_1402b5ab0
// Addr: 1402b5ab0
// Size: 444 bytes


void FUN_1402b5ab0(longlong param_1,undefined8 param_2,char param_3)

{
  ...
  puVar10 = (undefined4 *)FUN_140291ac0(local_48);
  uVar3 = puVar10[1];
  uVar4 = puVar10[2];
  uVar5 = puVar10[3];
  ...
  *(undefined4 *)(param_1 + 0x70) = uVar9;
  lVar11 = FUN_1402ca9c0();
  *(undefined8 *)(param_1 + 0x10) = 0;
  *(undefined8 *)(param_1 + 0x20) = 0;
  *(undefined8 *)(param_1 + 0x28) = 0;
  *(undefined8 *)(param_1 + 0x30) = 0;
  uVar12 = FUN_1400137c0(*(undefined8 *)(lVar11 + 0x38),param_1 + 0x48);
  *(undefined8 *)(param_1 + 0x10) = uVar12;
  lVar14 = 0x18;
  if (*(char *)(param_1 + 0x44) == '\0') {
    lVar14 = 0x20;
  }
  uVar12 = FUN_1400137c0(*(undefined8 *)(lVar14 + lVar11),param_1 + 0x48);
  *(undefined8 *)(param_1 + 0x20) = uVar12;
  puVar15 = &DAT_140474480;
  if (*(byte *)(lVar11 + 0x56) < 5) {
    puVar15 = *(undefined1 **)(lVar11 + 0x40);
  }
  uVar12 = FUN_1400137c0(puVar15,param_1 + 0x48);
  *(undefined8 *)(param_1 + 0x28) = uVar12;
  puVar16 = &DAT_14042bf5c;
  if (*(byte *)(lVar11 + 0x57) < 5) {
    puVar16 = *(undefined **)(lVar11 + 0x48);
  }
  uVar12 = FUN_1400137c0(puVar16,param_1 + 0x48);
...
LAB_1402b5c0a:
    if ((((uint)(int)*(char *)(lVar11 + 0x55) < 3) && ((uint)(int)*(char *)(lVar11 + 0x54) < 2)) &&
      ...
      pcVar13 = "+v$x+v$xv$+xv+$xv$+x+$vx+$vx$v+x+$vx$+vx+v $+v $v $+v +$v $++$ v+$ v$ v++$ v$+ v+xv$+ v$v$ +v+ $v$ ++x$v+ $v$v ++ $v$ +v"
    ...
    *(undefined4 *)(param_1 + 0x3c) = DAT_14042bf60;
    if (cVar1 == '\0') goto LAB_1402b5c0a;
  }
  pcVar13 = "$+xv";
LAB_1402b5c3c:
  *(undefined4 *)(param_1 + 0x40) = *(undefined4 *)pcVar13;
  if (param_3 != '\0') {
