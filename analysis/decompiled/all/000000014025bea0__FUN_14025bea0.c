// Function: FUN_14025bea0
// Addr: 14025bea0
// Size: 370 bytes


longlong FUN_14025bea0(longlong param_1,char *param_2)

{
  ...
  lVar6 = *(longlong *)(DAT_1404e88f8 + 8 + (DAT_1404e8910 & uVar9) * 0x10);
  if (lVar6 == DAT_1404e88e8) {
LAB_14025bf4e:
    lVar6 = DAT_1404e88e8;
  }
  else {
    lVar2 = *(longlong *)(DAT_1404e88f8 + (DAT_1404e8910 & uVar9) * 0x10);
    cVar4 = FUN_14000d010(lVar6 + 0x10,param_2);
    while (cVar4 == '\0') {
      if (lVar6 == lVar2) goto LAB_14025bf4e;
      lVar6 = *(longlong *)(lVar6 + 8);
      cVar4 = FUN_14000d010(lVar6 + 0x10,param_2);
    }
    if (lVar6 == 0) goto LAB_14025bf4e;
  }
  if (lVar6 != DAT_1404e88e8) {
LAB_14025bf5e:
    return lVar6 + 0x30;
  ...
  if (lVar6 != lVar2) {
    ...
    cVar4 = FUN_14000d010(lVar6 + 0x10,param_2);
    while (cVar4 == '\0') {
      if (lVar6 == lVar3) goto LAB_14025bff9;
      lVar6 = *(longlong *)(lVar6 + 8);
      cVar4 = FUN_14000d010(lVar6 + 0x10,param_2);
    }
    if (lVar6 == 0) {
    ...
    if (lVar6 != lVar2) goto LAB_14025bf5e;
  }
LAB_14025bff9:
