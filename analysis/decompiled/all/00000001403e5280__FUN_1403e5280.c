// Function: FUN_1403e5280
// Addr: 1403e5280
// Size: 647 bytes


longlong FUN_1403e5280(longlong *param_1,undefined8 param_2)
...
LAB_1403e54a2:
      FUN_1403f3480(uVar10,lVar8,param_2);
    }
    else {
      ...
      *(uint *)(lVar8 + 0x14) = uVar9;
      ...
      lVar8 = *param_1;
      if (uVar10 == 10) goto LAB_1403e54a2;
      if (uVar10 == 0xf) {
        FUN_1403f5090(lVar8);
        *(undefined4 *)(lVar8 + 0x1c) = 0;
      }
      else {
        if (uVar10 != 0x10) goto LAB_1403e54a2;
        FUN_1403f2200(lVar8);
