// Function: FUN_1400e6660
// Addr: 1400e6660
// Size: 718 bytes


void FUN_1400e6660(longlong *param_1)
    ...
    if (*(ulonglong *)(lVar3 + 0x10) < *(ulonglong *)(lVar3 + 0x38) >> 3) {
      ...
      if (plVar13 != plVar4) {
        ...
        if (plVar13[4] != 0) {
          ...
          } while (uVar9 < (ulonglong)plVar13[4]);
        }
        ...
        do {
          ...
          FUN_140017240(plVar8 + 2);
          thunk_FUN_14028af80(plVar8,0x68);
            ...
            while (plVar11 != plVar4) {
              ...
              if (plVar11[4] != 0) {
                do {
                  ...
                  uVar9 = uVar9 + 1;
                  uVar10 = (uVar10 ^ *pbVar1) * 0x100000001b3;
                } while (uVar9 < (ulonglong)plVar11[4]);
              }
...
LAB_1400e678c:
      ...
      *(undefined8 *)(lVar3 + 0x10) = 0;
      ...
      FUN_1400325c0(*(undefined8 *)(lVar3 + 0x18),*(undefined8 *)(lVar3 + 0x20),&local_res8);
    }
  }
  return;
}
