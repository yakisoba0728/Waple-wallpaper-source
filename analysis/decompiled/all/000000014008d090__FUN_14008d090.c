// Function: FUN_14008d090
// Addr: 14008d090
// Size: 550 bytes


undefined8 * FUN_14008d090(longlong *param_1,undefined4 *param_2,undefined8 param_3)
    ...
    if (uVar17 < 0x800000000000000) {
      ...
      if (uVar13 != 0) {
        if (uVar13 < 0x1000) {
          ...
          if (uVar13 + 0x27 <= uVar13) goto LAB_14008d2b2;
      ...
      ;
      *(undefined8 *)(puVar16 + -8) = 0x14008d182;
      FUN_140016fc0(puVar2,param_3);
      ...
      *(undefined8 *)(puVar16 + -8) = 0x14008d28a;
