// Function: FUN_1403f3c20
// Addr: 1403f3c20
// Size: 1370 bytes


void FUN_1403f3c20(uint param_1,longlong param_2,undefined8 param_3)

{
  ...
  if (0x122 < param_1) {
    if (param_1 == 0x123) {
      FUN_1403c48c0(param_2,param_3);
    }
    else if (param_1 == 0x124) {
      FUN_1403df100(param_2,param_3);
    }
    else {
      if (param_1 != 0x125) goto switchD_1403f3c79_caseD_2;
      FUN_1403c3d60(param_2,param_3);
    }
    goto LAB_1403f415e;
  }
  if (param_1 == 0x122) {
    if (*(int *)(param_2 + 0x1c) == 7) {
      ...
      local_38 = local_28 + *pdVar4;
      uStack_50 = dVar1;
      local_40 = dStack_60;
      local_10 = dStack_60;
      FUN_1403bce90(param_2,param_3,&local_58,&local_68,&local_48);
      FUN_1403bce90(param_2,param_3,&local_18,&local_28,&local_38);
    }
    else {
...
switchD_1403f3c79_caseD_2:
  ...
  case 4:
    ...
    if (*(int *)(param_2 + 0x1c) == 0) {
      *(undefined1 *)(param_2 + 0x18) = 1;
      DAT_1404e4f20 = DAT_14045dd10;
      dStack_60 = *(double *)(param_2 + 0x11c8) + DAT_14045dd10;
    }
    else {
    ...
    goto LAB_1403f3dd8;
  case 5:
    FUN_1403fa460(param_2,param_3);
    break;
  case 6:
    FUN_1403e0810(param_2,param_3);
    break;
  case 7:
    FUN_1404127d0(param_2,param_3);
    break;
  case 8:
    FUN_1403fae30(param_2,param_3);
    break;
  case 10:
...
LAB_1403f3dd8:
    FUN_1403ec8e0(param_2,param_3,&local_68);
    ...
    break;
  case 0x18:
    FUN_1403f68b0(param_2,param_3);
    break;
  case 0x19:
    FUN_1403f9ba0(param_2,param_3);
    break;
  case 0x1a:
    FUN_140413240(param_2,param_3);
    break;
  case 0x1b:
    FUN_1403dfac0(param_2,param_3);
    break;
  case 0x1d:
    FUN_1403b2dd0(param_2,param_2 + 0x11a0,1);
    return;
  case 0x1e:
    FUN_140411370(param_2,param_3);
    break;
  case 0x1f:
    FUN_1403e2990(param_2,param_3);
    break;
  case 0xff:
