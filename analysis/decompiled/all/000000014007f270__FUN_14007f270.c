// Function: FUN_14007f270
// Addr: 14007f270
// Size: 819 bytes


void FUN_14007f270(longlong *param_1)
    ...
    if (*(ulonglong *)(lVar2 + 0x10) < *(ulonglong *)(lVar2 + 0x38) >> 3) {
      ...
      if (plVar13 != plVar3) {
        ...
        do {
          ...
          FUN_140017240(plVar6 + 0x13);
          FUN_140017240(plVar6 + 6);
          FUN_140017240(plVar6 + 2);
          thunk_FUN_14028af80(plVar6,200);
            ...
            *plVar8 = (longlong)plVar6;
            while (plVar10 != plVar3) {
              ...
              while( true ) {
                ...
                FUN_140017240(plVar11 + 0x13);
                FUN_140017240(plVar11 + 6);
                FUN_140017240(plVar11 + 2);
                thunk_FUN_14028af80(plVar11,200);
                *(longlong *)(lVar2 + 0x10) = *(longlong *)(lVar2 + 0x10) + -1;
...
LAB_14007f3c8:
      ...
      *(undefined8 *)plVar3[1] = 0;
      ...
      while (puVar12 != (undefined8 *)0x0) {
        ...
        FUN_140017240(puVar12 + 0x13);
        FUN_140017240(puVar12 + 6);
        FUN_140017240(puVar12 + 2);
        thunk_FUN_14028af80(puVar12,200);
        puVar12 = puVar4;
      }
