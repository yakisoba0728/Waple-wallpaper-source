// Function: FUN_1403fea20
// Addr: 1403fea20
// Size: 914 bytes


ulonglong FUN_1403fea20(byte *param_1,int *param_2)

{
  ...
  case 0:
    uVar9 = FUN_14036efd0(param_2,pbVar1,param_2[0xe]);
    break;
  default:
    uVar9 = uVar9 & 0xff;
    break;
    ...
    if (cVar3 != '\0') {
      ...
      if (uVar4 != 0) {
        do {
          ...
          if (uVar11 < uVar9) goto LAB_1403fed88;
          ...
          if (((uVar12 < uVar5) ||
             ...
             (cVar3 = FUN_14036efd0(param_2,param_1 + (ulonglong)pbVar7[5] +
                                                      (ulonglong)pbVar7[4] * 0x100,
                                    (uVar12 - uVar5) + 1), cVar3 == '\0')) goto LAB_1403fed88;
          uVar8 = uVar8 + 1;
        } while (uVar8 < uVar4);
      }
      return 1;
  ...
  case 8:
    ...
    if ((uVar11 <= uVar9) && (cVar3 = FUN_14036efd0(param_2), cVar3 != '\0')) {
      return 1;
    }
    goto LAB_1403fed88;
  case 10:
