// Function: FUN_14040c230
// Addr: 14040c230
// Size: 219 bytes


void FUN_14040c230(undefined4 *param_1,ulonglong param_2,ulonglong param_3)

{
  ...
  *param_1 = 0;
  param_1[9] = 0;
  FUN_1402fc370("SANITIZE",uVar5,0,1,0,1,"start [%p..%p] (%lu bytes)",uVar5,uVar6,uVar4 - (int)uVar5
               );
  return;
}
