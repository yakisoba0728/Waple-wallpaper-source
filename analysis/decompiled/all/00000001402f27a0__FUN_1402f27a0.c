// Function: FUN_1402f27a0
// Addr: 1402f27a0
// Size: 920 bytes


undefined8 FUN_1402f27a0(ushort *param_1,undefined8 *param_2,undefined8 param_3)
    ...
    while (piVar7 < piVar16) {
      ...
      if ((pbVar10[1] & 3) == 0) {
        ...
        while( true ) {
          ...
          piVar8 = piVar7 + 2;
          pbVar11 = pbVar11 + 1;
          local_78 = iVar9 * *piVar8 - iVar2;
          iStack_74 = iVar9 * piVar7[3] - iVar2;
          if ((*pbVar10 & 3) == 1) break;
          if ((*pbVar10 & 3) != 0) {
            return 0x14;
          }
          local_48 = (local_78 + iVar5) / 2;
          local_44 = (iStack_74 + iVar13) / 2;
          uVar4 = (*(code *)param_2[2])(&local_90,&local_48,param_3);
          if ((int)uVar4 != 0) {
            return uVar4;
          }
          local_90 = CONCAT44(iStack_74,local_78);
          piVar7 = piVar8;
          iVar5 = local_78;
          iVar13 = iStack_74;
        }
        uVar4 = (*(code *)param_2[2])(&local_90,&local_78,param_3);
LAB_1402f2aac:
        piVar7 = piVar8;
        pbVar10 = pbVar11;
        if ((int)uVar4 != 0) {
