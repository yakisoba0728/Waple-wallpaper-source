// Function: FUN_1400d7510
// Addr: 1400d7510
// Size: 645 bytes


void FUN_1400d7510(longlong param_1,undefined8 param_2,longlong param_3)
  ...
  if ((*(uint *)(param_1 + 0x10) & 0x40000000) == 0) {
    if (*(longlong *)(param_3 + 0x10) != 0) {
      ...
      if (-1 < iVar4) {
        ...
        FUN_1400d83d0(param_1,param_2,*(undefined1 *)(param_1 + 0x105),
    ...
    if (*(longlong *)(param_3 + 0x20) != 0) {
      ...
      if (-1 < iVar4) {
        in_stack_ffffffffffffffb8 = local_38;
        FUN_1400d83d0(param_1,param_2,*(undefined1 *)(param_1 + 0x119),
    ...
    if (*(longlong *)(param_3 + 0x30) != 0) {
      ...
      iVar4 = (**(code **)(*plVar2 + 0x70))
                        (plVar2,local_res20,0,4,in_stack_ffffffffffffffb8 & 0xffffffff00000000,
                         &local_38);
      if (-1 < iVar4) {
        FUN_1400d83d0(param_1,param_2,*(undefined1 *)(param_1 + 0x131),
