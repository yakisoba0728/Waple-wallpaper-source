// Function: FUN_140152840
// Addr: 140152840
// Size: 57 bytes


undefined8 * FUN_140152840(float *param_1,undefined8 *param_2,byte *param_3)

{
  ...
  if (*param_1 < (float)(*(longlong *)(param_1 + 4) + 1) / (float)uVar1) {
    ...
    func_0x000140152fd0(param_1,uVar7);
    puVar8 = *(undefined8 **)(param_1 + 2);
    puVar2 = *(undefined8 **)
              (*(longlong *)(param_1 + 6) + 8 + (uVar9 & *(ulonglong *)(param_1 + 0xc)) * 0x10);
    if (puVar2 != puVar8) {
  ...
  *puVar2 = puVar4;
  ...
  if (puVar3 == *(undefined8 **)(param_1 + 2)) {
    *(undefined8 **)(lVar5 + uVar9 * 0x10) = puVar4;
    ...
    if (*(undefined8 **)(lVar5 + 8 + uVar9 * 0x10) != puVar2) goto code_r0x000140152ad3;
  }
  *(undefined8 **)(lVar5 + 8 + uVar9 * 0x10) = puVar4;
code_r0x000140152ad3:
  *param_2 = puVar4;
  *(undefined1 *)(param_2 + 1) = 1;
  return param_2;
}
