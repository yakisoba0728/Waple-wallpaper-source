// Function: FUN_14016fcd0
// Addr: 14016fcd0
// Size: 639 bytes


void FUN_14016fcd0(undefined8 param_1,ulonglong param_2)

{
  ...
  FUN_14003e510(&DAT_1404e8118,2L << (bVar12 & 0x3f),DAT_1404e8108);
  DAT_1404e8130 = lVar14 - 1;
  DAT_1404e8138 = lVar14;
  plVar6 = (longlong *)*DAT_1404e8108;
  lVar14 = DAT_1404e8118;
joined_r0x00014016fd55:
  do {
    while( true ) {
      DAT_1404e8118 = lVar14;
      if (plVar6 == plVar7) {
        local_res8 = 0;
