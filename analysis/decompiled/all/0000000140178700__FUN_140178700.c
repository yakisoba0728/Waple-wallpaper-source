// Function: FUN_140178700
// Addr: 140178700
// Size: 368 bytes


longlong FUN_140178700(longlong param_1,char *param_2)

{
  ...
  lVar6 = *(longlong *)(DAT_1404e8158 + 8 + (DAT_1404e8170 & uVar9) * 0x10);
  if (lVar6 != DAT_1404e8148) {
    lVar7 = *(longlong *)(DAT_1404e8158 + (DAT_1404e8170 & uVar9) * 0x10);
    cVar2 = FUN_14000d010(lVar6 + 0x10,param_2);
    while (cVar2 == '\0') {
      if (lVar6 == lVar7) goto LAB_1401787ae;
      lVar6 = *(longlong *)(lVar6 + 8);
      cVar2 = FUN_14000d010(lVar6 + 0x10,param_2);
    }
    if (lVar6 != 0) goto LAB_1401787b5;
  }
LAB_1401787ae:
  lVar6 = DAT_1404e8148;
LAB_1401787b5:
