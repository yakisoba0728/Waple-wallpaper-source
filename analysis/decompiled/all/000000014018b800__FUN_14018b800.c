// Function: FUN_14018b800
// Addr: 14018b800
// Size: 171 bytes


undefined8 FUN_14018b800(longlong param_1,ulonglong param_2)
...
code_r0x00014018b911:
      ...
      puVar5 = puVar6;
      while (param_2 != uVar2) {
        if (puVar5 == *(undefined8 **)(lVar1 + uVar7 * 0x10)) goto code_r0x00014018b911;
    ...
    if ((puVar5 == (undefined8 *)0x0) || (puVar5 == puVar8)) {
      ...
      puVar6 = (undefined8 *)func_0x00014028aff0(0x18);
      puVar6[2] = param_2;
