    ...
    if (*(ulonglong *)(lVar1 + 0x10) < *(ulonglong *)(lVar1 + 0x38) >> 3) {
      ...
      if (plVar3 != plVar2) {
        ...
        do {
          ...
          FUN_14003a630(plVar9 + 0x11);
          FUN_140017240(plVar9 + 0xc);
          FUN_140017240(plVar9 + 8);
          FUN_140017240(plVar9 + 4);
          thunk_FUN_14028af80(plVar9,0xa0);
            ...
            *plVar8 = (longlong)plVar7;
            while (plVar10 != plVar2) {
              ...
              while( true ) {
                ...
                FUN_14003a630(plVar11 + 0x11);
                FUN_140017240(plVar11 + 0xc);
                FUN_140017240(plVar11 + 8);
                FUN_140017240(plVar11 + 4);
                thunk_FUN_14028af80(plVar11,0xa0);
                *(longlong *)(lVar1 + 0x10) = *(longlong *)(lVar1 + 0x10) + -1;
...
LAB_140164b85:
      ...
      *(undefined8 *)plVar2[1] = 0;
      ...
      while (puVar5 != (undefined8 *)0x0) {
        ...
        FUN_14003a630(puVar5 + 0x11);
        FUN_140017240(puVar5 + 0xc);
        FUN_140017240(puVar5 + 8);
        FUN_140017240(puVar5 + 4);
        thunk_FUN_14028af80(puVar5,0xa0);
        puVar5 = puVar4;
      }
