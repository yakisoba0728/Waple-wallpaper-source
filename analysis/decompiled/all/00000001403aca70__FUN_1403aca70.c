// Function: FUN_1403aca70
// Addr: 1403aca70
// Size: 2085 bytes


ulonglong FUN_1403aca70(longlong param_1,longlong param_2)

{
  ...
  if (iVar21 == 1) {
    pbVar16 = (byte *)FUN_1403c70f0(pbVar16,*(undefined4 *)
    ...
    pbVar15 = (byte *)0x0;
    if (iVar21 != 2) goto LAB_1403ad128;
    pbVar16 = (byte *)FUN_1403c7170();
  }
  uVar23 = (uint)pbVar16;
  pbVar15 = pbVar16;
  if ((uVar23 != 0xffffffff) && (*(int *)(param_2 + 0x128) == 0x40)) {
    ...
    if (uVar23 < (uint)pbVar26[lVar11 * 2] * 0x100 + (uint)pbVar2[1]) {
      ...
      if (uVar27 == 0) {
        ...
        *(code **)(param_2 + 0x68) = FUN_1403ec150;
                  ...
                  if ((uVar22 & 0x10) == 0) {
                    ...
                    do {
                      if ((*(ulonglong *)
                           ...
                           (*puVar3 >> ((byte)(&DAT_14045c3c8)[uVar13] & 0x1f) & 0x3f) & 1) == 0)
                      goto LAB_1403accdb;
                      uVar24 = (int)uVar13 + 1;
                    ...
                    uVar13 = FUN_1403ebf20(puVar18,uVar22 >> 0x10,*puVar3);
                    if ((char)uVar13 == '\0') {
LAB_1403accdb:
                  ...
                  if ((char)pbVar15 == '\0') goto LAB_1403acdb8;
                }
                ...
                if ((*(uint *)(param_2 + 0x5c) & puVar3[1]) != 0) {
                  ...
                  if (pcVar6 == (code *)0x0) {
                    pbVar15 = (byte *)0x0;
                    if (bVar8) goto LAB_1403acdb8;
                    goto LAB_1403acdda;
                  }
                  if (pcVar6 == FUN_1403ec150) {
                    pbVar15 = (byte *)FUN_1403ec150();
                  }
                  else {
                    pbVar15 = (byte *)(*pcVar6)(puVar3,iVar21,*(undefined8 *)(param_2 + 0x70));
                  }
                  if ((char)pbVar15 != '\0') goto LAB_1403acdda;
                }
LAB_1403acdb4:
                if (!bVar8) {
                  uVar27 = *puVar1;
                ...
                if ((uVar5 & 8) != 0) {
                  if ((uVar9 & 0x10) == 0) {
                    ...
                    do {
                      ...
                      if ((uVar14 >> (*puVar3 >> ((byte)(&DAT_14045c3c8)[uVar13] & 0x1f) & 0x3f) & 1
                          ) == 0) goto LAB_1403acf95;
                      uVar22 = (int)uVar13 + 1;
                    ...
                    uVar14 = FUN_1403ebf20(puVar18,uVar9 >> 0x10,*puVar3);
                    if ((char)uVar14 == '\0') {
LAB_1403acf95:
                  ...
                  if ((char)pbVar15 == '\0') goto LAB_1403ad068;
                }
                uVar5 = (ushort)puVar3[4];
                if (((((uVar5 & 0x20) == 0) || ((puVar3[3] & 0x10) != 0)) ||
                    ((*(char *)(param_2 + 0x60) == '\0' &&
                ...
                if ((*(uint *)(param_2 + 0x5c) & puVar3[1]) != 0) {
                  ...
                  if ((char)pbVar15 != '\0') goto LAB_1403ad07f;
                }
LAB_1403ad064:
                if (!bVar8) {
                  uVar23 = *puVar1 + 1;
...
LAB_1403ad176:
      ...
      FUN_14040ef70(*(undefined8 *)(param_2 + 0xa0),uVar27,uVar25 + 1);
      ...
      *(ulonglong *)(lVar11 + 200) = *(ulonglong *)(lVar11 + 200) | 1L << (uVar23 >> 6 & 0x3f);
      ...
      if (*(char *)(param_2 + 300) != '\0') {
        uVar20 = FUN_1403cab00(*(undefined8 *)(param_2 + 0xf8),uVar23);
...
LAB_1403acdda:
  ...
  uVar25 = uVar25 + 1;
  if (uVar27 <= uVar25) goto LAB_1403ace34;
  goto LAB_1403acc00;
LAB_1403ad07f:
  pbVar15 = *(byte **)(param_2 + 0x78);
  if (pbVar15 != (byte *)0x0) {
  ...
  uVar25 = uVar25 + 1;
  if (uVar24 <= uVar25) goto LAB_1403ad176;
  goto LAB_1403aceb0;
}
