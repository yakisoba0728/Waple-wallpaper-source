// Function: FUN_1403a1ca0
// Addr: 1403a1ca0
// Size: 373 bytes


longlong FUN_1403a1ca0(int *param_1,uint param_2)
    ...
    if (lVar5 != 0) {
      ...
      if (param_1[1] != 0) {
        do {
          ...
          *(undefined4 *)(lVar1 + 0x18 + lVar5) = puVar6[6];
          *(undefined8 *)(lVar1 + 0x20 + lVar5) = *(undefined8 *)(puVar6 + 8);
