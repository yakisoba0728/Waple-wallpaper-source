// Function: FUN_1402acb70
// Addr: 1402acb70
// Size: 1312 bytes


longlong *
FUN_1402acb70(undefined8 param_1,longlong *param_2,longlong *param_3,longlong *param_4,
...
LAB_1402accc2:
    ...
    uStack_4c = *(undefined4 *)((longlong)param_4 + 0xc);
    puVar11 = (undefined4 *)
              FUN_1402a0a10(param_1,&local_78,&local_68,&local_58,lVar4,param_6,param_7,pcVar12);
    uVar1 = puVar11[1];
    uVar2 = puVar11[2];
    uVar3 = puVar11[3];
...
LAB_1402acd7a:
  ...
  if (*param_3 == 0) {
    if (*param_4 != 0) goto LAB_1402ad074;
  }
  else if (*param_4 == 0) goto LAB_1402ad074;
  *puVar5 = *puVar5 | 1;
LAB_1402ad074:
  lVar10 = param_3[1];
  *param_2 = *param_3;
