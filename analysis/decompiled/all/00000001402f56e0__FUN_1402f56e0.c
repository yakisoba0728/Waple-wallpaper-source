// Function: FUN_1402f56e0
// Addr: 1402f56e0
// Size: 335 bytes


int FUN_1402f56e0(longlong *param_1,byte *param_2,longlong param_3)

{
  ...
  while (bVar2 - 4 < 0x16) {
    switch(bVar2 - 4) {
    case 0:
      iVar4 = FUN_1402f50b0(param_1,*(undefined2 *)(param_2 + 2));
      if (iVar4 == 0) {
        puVar8 = (uint *)param_1[7];
        bVar3 = true;
        goto UNWIND_INFO_1402f5842_UnwindCodes_57__UnwindOpCode;
      }
      goto LAB_1402f58d1;
    default:
      goto switchD_1402f5770_caseD_1;
    case 4:
    case 5:
    ...
    case 9:
      ...
      goto UNWIND_INFO_1402f5842_UnwindCodes_34__OffsetInProlog;
    case 10:
    case 0xb:
      uVar7 = (uint)*(byte *)((longlong)puVar9 + 1);
      puVar8 = (uint *)((longlong)puVar9 + 2);
      sVar6 = 0x10;
      goto UNWIND_INFO_1402f5842_UnwindCodes_30__UnwindOpCode;
    case 0xc:
    case 0xd:
      puVar8 = puVar9 + 1;
    ...
    case 0x11:
      ...
      goto code_r0x0001402f5887;
    case 0x12:
    case 0x13:
      puVar8 = (uint *)((longlong)puVar9 + 3);
      sVar6 = 8;
      uVar7 = (uint)*(ushort *)((longlong)puVar9 + 1);
UNWIND_INFO_1402f5842_UnwindCodes_30__UnwindOpCode:
      bVar2 = (byte)*puVar9;
code_r0x0001402f5887:
      uVar5 = (uint)bVar2;
      uVar7 = uVar7 << 8;
UNWIND_INFO_1402f5842_UnwindCodes_34__OffsetInProlog:
      uVar7 = uVar7 | uVar5;
      break;
    case 0x14:
    case 0x15:
      ...
      if ((ulonglong)bVar2 <= (ulonglong)(param_1[8] - (longlong)puVar9)) {
        if (*param_2 == 0x18) {
          ...
          FUN_1404211c0((ulonglong)*(ushort *)(param_2 + 2) + param_3,puVar9,bVar2);
        }
...
UNWIND_INFO_1402f5842_UnwindCodes_57__UnwindOpCode:
    pbVar1 = param_2 + 4;
    param_2 = param_2 + 4;
    puVar9 = puVar8;
    bVar2 = *pbVar1;
  }
switchD_1402f5770_caseD_1:
