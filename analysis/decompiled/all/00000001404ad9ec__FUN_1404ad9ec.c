...
void FUN_1404ad9ec(uint *param_1,undefined8 param_2)

{
  ...
  uRam21004ad8bc00122b = (undefined4)in_RAX;
  bVar12 = (byte)((ulonglong)param_2 >> 8) |
           *(byte *)(CONCAT44(unaff_0000001c,unaff_EBX) + (longlong)param_1);
  iVar5 = (int)CONCAT71((int7)((ulonglong)in_RAX >> 8),(byte)in_RAX | *(byte *)(in_RAX * 2)) +
          0x40000a64;
  *(uint *)CONCAT44(uVar14,CONCAT22(uVar13,CONCAT11(bVar12,uVar11))) =
       *(uint *)CONCAT44(uVar14,CONCAT22(uVar13,CONCAT11(bVar12,uVar11))) ^
       CONCAT22(uVar13,CONCAT11(bVar12,uVar11));
  bVar15 = (byte)unaff_EBX;
  *(char *)(unaff_RSI + -0xbffedcf) = *(char *)(unaff_RSI + -0xbffedcf) + bVar15;
  cVar2 = in(0x49);
  ...
  *pbVar9 = *pbVar9 + bVar15;
  bVar1 = CARRY1(bVar4,CARRY1(bVar3,bVar15));
  bVar4 = bVar4 + CARRY1(bVar3,bVar15);
  bVar3 = bVar4 + 0x4e;
  uVar6 = CONCAT31(CONCAT21((short)((uint)iVar5 >> 0x10),cVar10 + bVar12),bVar3 - bVar1) +
          0x11e013f0 + (uint)(bVar4 < 0xb2 || bVar3 < bVar1);
  piVar8 = (int *)(ulonglong)uVar6;
  *unaff_RDI = *unaff_RDI >> 1 | *unaff_RDI << 7;
  *piVar8 = *piVar8 + CONCAT22(uVar13,CONCAT11(bVar12,uVar11));
  uVar6 = uVar6 + *piVar8;
