// Function: FUN_1402d4550
// Addr: 1402d4550
// Size: 462 bytes


ulonglong FUN_1402d4550(ulonglong param_1,ulonglong param_2,ulonglong param_3)
...
LAB_1402d46f6:
  ...
  if ((param_3 == 0) || ((param_3 & param_3 - 1) != 0)) goto LAB_1402d46f6;
  ...
  if (uVar11 < param_2) goto LAB_1402d4652;
  if (param_1 <= uVar10 + 7 + lVar4) {
    puVar7 = (undefined4 *)FUN_1402caf34();
    uVar2 = *puVar7;
    lVar8 = thunk_FUN_1402e7250(lVar4,uVar11);
    lVar6 = lVar8;
    if (lVar8 != 0) goto LAB_1402d46ab;
    puVar7 = (undefined4 *)FUN_1402caf34();
    *puVar7 = uVar2;
  }
