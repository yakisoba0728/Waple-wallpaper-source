// Function: FUN_14008f350
// Addr: 14008f350
// Size: 271 bytes


ulonglong FUN_14008f350(longlong param_1,char param_2)

{
  ...
  do {
    ...
    *(byte **)(param_1 + 0x80) = pbVar3;
    if (*(byte **)(param_1 + 0x78) <= pbVar3) goto LAB_14008f45c;
    bVar4 = *pbVar3;
    pbVar3 = pbVar3 + 1;
  } while ('/' < (char)bVar4);
  if (bVar4 == 0x2e) {
    ...
    *(byte **)(param_1 + 0x80) = pbVar3;
    if ((pbVar1 <= pbVar3) || (bVar4 = *pbVar3, (char)bVar4 < '0')) goto LAB_14008f45c;
    pbVar3 = pbVar3 + 1;
    while (bVar4 < 0x3a) {
      *(byte **)(param_1 + 0x80) = pbVar3;
      if (pbVar1 <= pbVar3) goto LAB_14008f45c;
      bVar4 = *pbVar3;
      pbVar3 = pbVar3 + 1;
      if ((char)bVar4 < '0') {
    ...
    if (pbVar3 < pbVar2) {
      ...
      if ((bVar4 == 0x2b) || (bVar4 == 0x2d)) {
        *(byte **)(param_1 + 0x80) = pbVar1;
        if (pbVar2 <= pbVar1) goto LAB_14008f45c;
        bVar4 = *pbVar1;
        pbVar1 = pbVar3 + 2;
      }
    }
