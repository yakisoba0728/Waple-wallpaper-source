// Function: FUN_1403a36a0
// Addr: 1403a36a0
// Size: 879 bytes


undefined8 FUN_1403a36a0(longlong param_1,uint param_2)

{
  ...
  lVar9 = _malloc_base((ulonglong)uVar7 * 0xc);
  if (lVar9 == 0) {
    *(undefined1 *)(param_1 + 0x10) = 0;
    ...
    if (uVar7 * 0xc != 0) {
      FUN_1404217a0(lVar9,0,uVar7 * 0xc);
    }
    ...
    *(longlong *)(param_1 + 0x28) = lVar9;
    if (uVar11 != 0) {
      ...
      lVar9 = 0;
      do {
        piVar1 = (int *)(lVar3 + lVar9 * 0xc);
        if ((((*(byte *)(lVar3 + 4 + lVar9 * 0xc) & 1) != 0) && (*(char *)(param_1 + 0x10) != '\0'))
           && ((uVar2 = piVar1[1],
               (*(uint *)(param_1 + 0x18) >> 1) + *(int *)(param_1 + 0x18) <
               *(uint *)(param_1 + 0x1c) || (cVar6 = FUN_1403a36a0(param_1), cVar6 != '\0')))) {
