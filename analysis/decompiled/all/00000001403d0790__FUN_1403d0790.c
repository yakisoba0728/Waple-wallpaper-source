// Function: FUN_1403d0790
// Addr: 1403d0790
// Size: 932 bytes


void FUN_1403d0790(longlong param_1,uint param_2)
      ...
      *(undefined4 *)(lVar16 + 0xc + uVar18 * 0x14) = 0;
      ...
      if (iVar15 == 0) {
        ...
        *(undefined4 *)(lVar16 + uVar17 * 0x14) = 0;
        ...
        cVar14 = func_0x0001403eb040(lVar7,2,1);
        if (cVar14 != '\0') {
          if (*(uint *)(lVar7 + 0x1c) < 2) {
            FUN_1403ec350(lVar7,*(int *)(lVar7 + 0x5c),*(int *)(lVar7 + 0x5c) + 2);
          }
          else {
            func_0x00014040efc0();
          }
      ...
      *(undefined4 *)(lVar16 + 0xc + uVar18 * 0x14) = 0;
      ...
      if (*(char *)(lVar7 + 0x59) != '\0') {
        if ((*(longlong *)(lVar7 + 0x78) != *(longlong *)(lVar7 + 0x70)) ||
           (*(int *)(lVar7 + 100) != *(int *)(lVar7 + 0x5c))) {
          cVar14 = func_0x0001403bf270(lVar7,*(int *)(lVar7 + 100) + 1);
          if (cVar14 == '\0') goto UNWIND_INFO_1403d0ac2_ExceptionHandler_2;
          uVar4 = *(uint *)(lVar7 + 0x5c);
          lVar16 = *(longlong *)(lVar7 + 0x70);
          uVar5 = *(uint *)(lVar7 + 100);
          puVar21 = (undefined4 *)(lVar16 + (ulonglong)uVar4 * 0x14);
...
UNWIND_INFO_1403d0ac2_ExceptionHandler_2:
    uVar4 = *(uint *)(lVar7 + 0x5c);
  } while( true );
}
