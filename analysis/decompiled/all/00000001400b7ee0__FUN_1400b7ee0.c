// Function: FUN_1400b7ee0
// Addr: 1400b7ee0
// Size: 903 bytes


/* WARNING: Removing unreachable block (ram,0x0001400b8271) */
/* WARNING: Removing unreachable block (ram,0x0001400b8245) */
/* WARNING: Removing unreachable block (ram,0x0001400b8219) */
/* WARNING: Removing unreachable block (ram,0x0001400b81f3) */

char * FUN_1400b7ee0(longlong param_1,longlong *param_2)
  ...
  case 1:
    if ((longlong)puVar13 - (longlong)puVar17 < 4) {
      *(undefined8 *)(param_1 + 0xadc8) = 0;
      uVar14 = 2;
      goto switchD_1400b7f39_caseD_2;
    }
    uVar11 = *puVar17;
    puVar17 = puVar17 + 1;
...
LAB_1400b7fda:
    if (uVar11 - 1 < 0x7fffffff) {
      ...
      *(uint *)(param_1 + 0x28) = uVar11;
      goto switchD_1400b7f39_caseD_3;
    }
    goto LAB_1400b80d5;
  case 2:
switchD_1400b7f39_caseD_2:
    if (puVar17 == puVar13) goto LAB_1400b8155;
    do {
    ...
    break;
  case 3:
switchD_1400b7f39_caseD_3:
    if ((longlong)puVar13 - (longlong)puVar17 < 4) {
      *(undefined8 *)(param_1 + 0xadc8) = 0;
      uVar14 = 4;
      goto switchD_1400b7f39_caseD_4;
    }
    uVar11 = *puVar17;
    puVar17 = puVar17 + 1;
    uVar11 = uVar11 >> 0x18 | (uVar11 & 0xff0000) >> 8 | (uVar11 & 0xff00) << 8 | uVar11 << 0x18;
LAB_1400b809a:
    if (0x7ffffffe < uVar11 - 1) goto LAB_1400b80d5;
    if (0xffffff < uVar11) {
      pcVar16 = "#png: unsupported PNG file";
      goto LAB_1400b82b3;
    }
...
LAB_1400b80d5:
      ...
      *(byte *)(param_1 + 0x60) = (byte)uVar11;
      uVar14 = 6;
switchD_1400b7f39_caseD_6:
      if (puVar17 == puVar13) goto LAB_1400b8155;
      bVar1 = (byte)*puVar17;
      puVar17 = (uint *)((longlong)puVar17 + 1);
      if ((6 < bVar1) || ((0x5dU >> (bVar1 & 0x1f) & 1) == 0)) goto LAB_1400b80d5;
      *(byte *)(param_1 + 0x61) = bVar1;
      uVar14 = 7;
switchD_1400b7f39_caseD_7:
      if (puVar17 == puVar13) goto LAB_1400b8155;
      uVar11 = *puVar17;
      puVar17 = (uint *)((longlong)puVar17 + 1);
      if ((byte)uVar11 != 0) {
...
switchD_1400b7f39_caseD_8:
      ...
      uVar14 = 9;
switchD_1400b7f39_caseD_9:
      if (puVar17 == puVar13) goto LAB_1400b8155;
      uVar11 = *puVar17;
      puVar17 = (uint *)((longlong)puVar17 + 1);
      uVar5 = 0;
      if ((byte)uVar11 != 0) {
        if ((byte)uVar11 != 1) goto LAB_1400b80d5;
        *(undefined **)(param_1 + 0x198) = &DAT_1400bd4c0;
        uVar5 = 1;
      }
      *(undefined1 *)(param_1 + 99) = uVar5;
      *(undefined1 *)(param_1 + 0x62) = 0;
      FUN_1400b8310(param_1);
      cVar2 = *(char *)(param_1 + 0x62);
      if (cVar2 == '\0') {
        pcVar16 = "#png: bad header";
        goto LAB_1400b82b3;
      }
      lVar7 = FUN_1400b84b0(param_1,*(undefined4 *)(param_1 + 0x28));
      *(ulonglong *)(param_1 + 0x48) = (lVar7 + 1) * (ulonglong)*(uint *)(param_1 + 0x2c);
      if (cVar2 == '\x03') {
        *(undefined8 *)(param_1 + 0x130) = 0x1400b62d0;
        *(code **)(param_1 + 0x138) = FUN_1400b64b0;
        lVar7 = cpuid_Version_info(1);
        uVar11 = *(uint *)(lVar7 + 0xc);
        pcVar8 = FUN_1400b68f0;
        pcVar12 = FUN_1400b6ee0;
LAB_1400b8281:
        ...
        *(code **)(param_1 + 0x140) = pcVar8;
        ...
        lVar7 = cpuid_Version_info(1);
        puVar9 = &UNK_1400b63a0;
        if ((*(uint *)(lVar7 + 0xc) & 0x900002) == 0x900002) {
          puVar9 = &LAB_1400b6cd0;
        }
        *(undefined **)(param_1 + 0x130) = puVar9;
        lVar7 = cpuid_Version_info(1);
        puVar9 = &UNK_1400b66f0;
        if ((*(uint *)(lVar7 + 0xc) & 0x900002) == 0x900002) {
          puVar9 = &UNK_1400b6d50;
        }
        *(undefined **)(param_1 + 0x138) = puVar9;
        lVar7 = cpuid_Version_info(1);
        uVar11 = *(uint *)(lVar7 + 0xc);
        pcVar8 = FUN_1400b6ab0;
        pcVar12 = FUN_1400b7250;
        goto LAB_1400b8281;
      }
...
switchD_1400b7f39_caseD_4:
    ...
    goto LAB_1400b8155;
  case 6:
    goto switchD_1400b7f39_caseD_6;
  case 7:
    goto switchD_1400b7f39_caseD_7;
  case 8:
    goto switchD_1400b7f39_caseD_8;
  case 9:
    goto switchD_1400b7f39_caseD_9;
  default:
    bVar3 = false;
  }
  uVar10 = 0;
