// Function: FUN_1401ee1d0
// Addr: 1401ee1d0
// Size: 452 bytes


void FUN_1401ee1d0(longlong param_1,undefined8 param_2,longlong param_3,undefined8 *param_4)
  ...
  do {
    ...
    if (uVar5 == 4) {
      ...
      if (*piVar6 == 0) {
        ...
        if (*piVar6 != 4) goto LAB_1401ee36d;
        pfVar8 = local_res20;
      }
LAB_1401ee362:
      ...
      if (uVar5 == 8) {
        local_58[0] = *(float *)param_4[1];
        if (*piVar6 == 0) {
          pfVar8 = local_58;
        }
        else {
          if (*piVar6 != 4) goto LAB_1401ee36d;
          local_res8[0] = (float)(int)local_58[0];
          if ((*(byte *)(piVar6 + 0xc) & 4) != 0) {
