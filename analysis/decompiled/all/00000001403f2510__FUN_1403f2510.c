// Function: FUN_1403f2510
// Addr: 1403f2510
// Size: 1697 bytes


void FUN_1403f2510(uint param_1,longlong param_2,undefined1 *param_3)

{
  ...
  if (0x122 < param_1) {
    if (param_1 == 0x123) {
      FUN_1403c40c0(param_2,param_3);
    }
    else if (param_1 == 0x124) {
      FUN_1403dea20(param_2,param_3);
    }
    else {
      if (param_1 != 0x125) goto switchD_1403f255f_caseD_2;
      FUN_1403c3340(param_2,param_3);
    }
    goto LAB_1403f2b95;
  }
  if (param_1 == 0x122) {
    if (*(int *)(param_2 + 0x1c) == 7) {
      ...
      local_40 = dStack_60;
      local_10 = dStack_60;
      FUN_1403bcb10(param_2,param_3,&local_58,&local_68,&local_48);
      FUN_1403bcb10(param_2,param_3,&local_18,&local_28,&local_38);
    }
    else {
...
switchD_1403f255f_caseD_2:
  ...
  case 4:
    ...
    *(double *)(param_2 + 0x11c8) = dVar3 + dVar4;
    ...
    goto LAB_1403f2775;
  case 5:
    FUN_1403f9f40(param_2,param_3);
    break;
  case 6:
    FUN_1403dfe20(param_2,param_3);
    break;
  case 7:
    FUN_140411de0(param_2,param_3);
    break;
  case 8:
    FUN_1403fa650(param_2,param_3);
    break;
  case 10:
...
LAB_1403f2775:
    *(undefined1 *)(param_2 + 0x1049) = 1;
    break;
  case 0x18:
    FUN_1403f5db0(param_2,param_3);
    break;
  case 0x19:
    FUN_1403f8f90(param_2,param_3);
    break;
  case 0x1a:
    FUN_140412ac0(param_2,param_3);
    break;
  case 0x1b:
    FUN_1403df330(param_2,param_3);
    break;
  case 0x1d:
    FUN_1403b2c60(param_2,param_2 + 0x11a0,1);
    return;
  case 0x1e:
    FUN_14040f510(param_2,param_3);
    break;
  case 0x1f:
    FUN_1403e0b00(param_2,param_3);
    break;
  case 0xff:
