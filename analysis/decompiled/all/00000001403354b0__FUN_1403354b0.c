// Function: FUN_1403354b0
// Addr: 1403354b0
// Size: 552 bytes


void FUN_1403354b0(longlong *param_1,int param_2,int param_3,int param_4,int param_5,int *param_6,
                  int *param_7)
    ...
    *(int *)(param_1[1] + 0x20) =
    ...
    if (iVar2 < 0) {
      ...
      *param_6 = (int)((ulonglong)(lVar3 + 0x8000 + (lVar3 >> 0x3f)) >> 0x10);
      ...
      if (iVar1 < 0) {
        if (iVar1 * -2 < iVar2) goto LAB_140335556;
        if (iVar2 * 2 < -iVar1) {
