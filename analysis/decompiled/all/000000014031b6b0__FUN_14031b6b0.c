// Function: FUN_14031b6b0
// Addr: 14031b6b0
// Size: 557 bytes


int FUN_14031b6b0(undefined1 *param_1,uint param_2,uint param_3,longlong param_4)

{
  ...
  uVar12 = *piVar15 + 1;
  uVar10 = FUN_1402f80c0(uVar11,4,*(undefined4 *)(param_1 + 0x20),uVar12,
          ...
          if (param_3 != 0) {
            do {
              ...
              if ((iVar16 != iVar8) && (iVar16 != 0)) {
                ...
                uVar9 = FUN_1402f2180(*(undefined4 *)(lVar2 + *(longlong *)(param_1 + 0x28)),iVar8,
                                      iVar16);
  ...
  *(uint *)(param_1 + 0x10) = param_2;
  ...
  uVar11 = FUN_1402f80c0(uVar11,4,*(undefined4 *)(param_1 + 0x14),(ulonglong)param_3,
                         *(undefined8 *)(param_1 + 0x18),local_res18);
  *(undefined8 *)(param_1 + 0x18) = uVar11;
  if (local_res18[0] == 0) {
                    /* WARNING: Subroutine does not return */
    FUN_1404211c0(uVar11,param_4,(ulonglong)param_3 << 2);
  }
  return local_res18[0];
}
