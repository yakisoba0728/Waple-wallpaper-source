// Function: FUN_14028f050
// Addr: 14028f050
// Size: 176 bytes


ulonglong * FUN_14028f050(ulonglong *param_1,ulonglong *param_2,byte param_3)

{
  ...
  puVar3 = param_1;
  puVar2 = param_1;
  if ((((byte)DAT_1404dc0dc & 4) != 0) && (7 < (ulonglong)((longlong)param_2 - (longlong)param_1)))
  {
    puVar3 = (ulonglong *)
    ...
    do {
      ...
      auVar4._8_8_ = 0;
      auVar4._0_8_ = *(ulonglong *)(&DAT_140427610 + uVar1 * 8);
      auVar6 = pshufb(auVar5,auVar4);
      *puVar2 = auVar6._0_8_;
      puVar2 = (ulonglong *)((longlong)puVar2 + (ulonglong)(byte)(&DAT_140427e10)[uVar1]);
