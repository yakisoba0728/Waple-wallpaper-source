// Function: FUN_1401f7ba0
// Addr: 1401f7ba0
// Size: 211 bytes


void FUN_1401f7ba0(longlong param_1,longlong param_2,char *param_3)

{
  ...
  puVar3 = DAT_1404e9748;
  puVar2 = DAT_1404e9740;
  if (param_3 != (char *)0x0) {
    iVar1 = *(int *)(param_2 + 4);
    for (puVar7 = DAT_1404e9740; puVar7 != puVar3; puVar7 = puVar7 + 5) {
...
LAB_1401f7c2f:
  ...
  if (*(code **)(param_2 + 0x28) != (code *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x0001401f7c62. Too many branches */
