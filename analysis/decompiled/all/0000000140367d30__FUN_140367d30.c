// Function: FUN_140367d30
// Addr: 140367d30
// Size: 58 bytes


void FUN_140367d30(longlong param_1,longlong param_2,ulonglong param_3,uint *param_4)

{
  ...
  while (lVar13 < lVar14) {
    ...
    if (*puVar1 < uVar6) {
      ...
      iVar11 = FUN_1403b38b0(puVar1 + 2,puVar1 + -4);
    }
    lVar12 = lVar13 * 2 + 1;
    if (-1 < iVar11) {
      lVar12 = lVar5;
  ...
  while (param_2 < lVar5) {
    ...
    if (uVar6 < *param_4) {
      ...
      iVar11 = FUN_1403b38b0(puVar2 + 2,param_4 + 2);
    }
    if (-1 < iVar11) break;
    uVar7 = puVar2[1];
    uVar8 = puVar2[2];
