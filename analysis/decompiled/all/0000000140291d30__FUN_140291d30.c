// Function: FUN_140291d30
// Addr: 140291d30
// Size: 309 bytes


ulonglong FUN_140291d30(uint param_1,undefined4 *param_2)

{
  ...
  if (param_1 < 0x100) {
    if (param_2 != (undefined4 *)0x0) {
      if ((*(byte *)(*(longlong *)(param_2 + 2) + uVar7 * 2) & 1) == 0) goto LAB_140291d74;
      goto LAB_140291daa;
    }
    iVar3 = isupper(param_1);
    if (iVar3 == 0) goto LAB_140291d74;
LAB_140291de3:
    lVar5 = FUN_1402d6668();
    uVar6 = *(ushort *)(lVar5 + (ulonglong)((int)param_1 >> 8 & 0xff) * 2) & 0x8000;
  }
  else {
    if (param_2 == (undefined4 *)0x0) goto LAB_140291de3;
LAB_140291daa:
  ...
  iVar3 = FUN_1402945f0(pwVar8,0x100,&local_res10,uVar9,&local_res18,3,uVar1,1);
  if (iVar3 != 0) {
    uVar7 = (ulonglong)local_res18;
    if (iVar3 != 1) {
      uVar7 = (ulonglong)CONCAT11(local_res18,local_res19);
    }
    return uVar7;
  }
LAB_140291d74:
