// Function: FUN_1403b32d0
// Addr: 1403b32d0
// Size: 306 bytes


undefined8 * FUN_1403b32d0(longlong param_1,longlong param_2)
  ...
  if (1 < uVar7) {
    ...
    do {
      if (uVar4 < uVar8 * 0x1000000 + iVar11 + iVar5 + (uint)*(byte *)(param_1 + 7)) {
        ...
        pbVar1 = (byte *)((longlong)&DAT_14045dd38 + 5);
        pbVar3 = (byte *)((longlong)&DAT_14045dd38 + 4);
      }
      bVar2 = *pbVar1;
      if (*pbVar1 <= *pbVar3) {
        bVar2 = *pbVar3;
