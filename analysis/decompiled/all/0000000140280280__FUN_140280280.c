...
ulonglong FUN_140280280(double *param_1,float param_2,undefined8 param_3,float *param_4,
...
LAB_1402804a8:
          ...
          if (*(char *)(param_1 + 1) == '\0') {
            ...
            if (fVar23 != fVar36) goto LAB_1402804a8;
          }
          dVar9 = 0.0;
        }
LAB_14028051e:
...
LAB_140280b81:
          ...
          dVar21 = (double)FUN_1402810a0(pdVar5 + 6,local_110 + 2);
          fVar23 = fVar39;
          if (fVar39 <= fVar41) {
            fVar23 = fVar41;
          }
          ...
          if ((double)(float)((uint)(fVar36 - fVar28) & (uint)_DAT_140493090) *
              *(double *)((longlong)dVar9 + 200) <
              (double)(float)((uint)(fVar29 - fVar28) & (uint)_DAT_140493090)) goto LAB_140280b81;
          uVar38 = 0;
          in_XMM2_Dc = 0;
          in_XMM2_Dd = 0;
        }
