// Function: thunk_FUN_14038a6f0
// Addr: 1404142c0
// Size: 5 bytes


void thunk_FUN_14038a6f0(longlong param_1,byte *param_2,uint param_3,uint param_4,uint param_5)
    ...
    if (uVar8 < 0x10000000) {
      ...
      if (cVar4 != '\0') {
          ...
          *(undefined4 *)(param_1 + 0xb0) = 0;
          if (param_2 < param_2 + uVar11) {
            ...
            do {
              ...
              pbVar6 = (byte *)FUN_1403ecf70(pbVar9,pbVar7,auStackX_8,uVar2);
              uVar3 = uVar2;
              if (pbVar6 == pbVar7) {
                pbVar10 = pbVar9;
                uVar3 = auStackX_8[0];
        ...
        while (pbVar9 = pbVar7, pbVar9 < pbVar10 + (int)uVar8) {
          pbVar7 = (byte *)FUN_1403ecf70(pbVar9,pbVar10 + (int)uVar8,auStackX_8,uVar2);
        ...
        *(undefined4 *)(param_1 + 0xb4) = 0;
        if (pbVar9 < param_2) {
          ...
          do {
            if (4 < uVar11) break;
            pbVar9 = (byte *)FUN_1403ecf70(pbVar9,param_2,auStackX_8,uVar2);
            *(undefined4 *)(param_1 + 0x9c + (ulonglong)uVar11 * 4) = auStackX_8[0];
