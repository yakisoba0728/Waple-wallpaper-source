// Function: FUN_1402694d0
// Addr: 1402694d0
// Size: 5 bytes


undefined8 * FUN_1402694d0(float *param_1,undefined8 *param_2,byte *param_3)

{
  ...
  puVar5 = (undefined8 *)func_0x00014028aff0(0x20);
  ...
  *puVar2 = puVar5;
  ...
  if (puVar4 == *(undefined8 **)(param_1 + 2)) {
    *(undefined8 **)(lVar3 + uVar6 * 0x10) = puVar5;
    ...
    if (*(undefined8 **)(lVar3 + 8 + uVar6 * 0x10) != puVar2) goto code_r0x0001402696c6;
  }
  *(undefined8 **)(lVar3 + 8 + uVar6 * 0x10) = puVar5;
code_r0x0001402696c6:
  *param_2 = puVar5;
  *(undefined1 *)(param_2 + 1) = 1;
  return param_2;
}
