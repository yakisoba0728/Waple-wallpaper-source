// Function: FUN_140131200
// Addr: 140131200
// Size: 3948 bytes


void FUN_140131200(undefined4 *param_1,undefined4 *param_2,longlong param_3,code *param_4)

{
  ...
  while (0x1187 < lVar9) {
    ...
    lVar14 = lVar9 >> 1;
    if (param_3 < 1) goto joined_r0x000140131acf;
    ...
    if (lVar9 < 0x29) {
      ...
      lVar9 = lVar9 + 1 >> 3;
      FUN_1401341e0(param_1,param_1 + lVar9 * 0x22,param_1 + lVar9 * 0x44,param_4);
      FUN_1401341e0(puVar17 + lVar9 * -0x22,puVar17,param_1 + (lVar14 + lVar9) * 0x22,param_4);
      puVar10 = param_2 + -0x22;
      puVar11 = puVar10 + lVar9 * -0x22;
      FUN_1401341e0(puVar10 + lVar9 * -0x44,puVar11,puVar10,param_4);
      puVar10 = param_1 + lVar9 * 0x22;
    }
    FUN_1401341e0(puVar10,puVar17,puVar11,param_4);
    ...
    while ((puVar17 = puVar11, puVar16 = puVar10, local_130 = puVar11, puVar19 = puVar10,
           puVar11 < param_2 &&
...
LAB_1401313d0:
    ...
    if (puVar11 < param_2) {
      do {
        ...
        if (cVar8 == '\0') {
          ...
          if (cVar8 != '\0') break;
          if (puVar17 != puVar11) {
            FUN_140133980(&local_128,puVar17);
            FUN_140132b40(puVar17,puVar11);
            FUN_140132b40(puVar11,&local_128);
            FUN_140017240(&local_d0);
    ...
    if (param_1 < puVar10) {
      do {
        puVar19 = puVar10 + -0x22;
        cVar8 = (*param_4)(puVar19,puVar16);
        local_res10 = puVar16;
        puVar11 = local_130;
        if (cVar8 == '\0') {
          ...
          if (local_res10 != puVar19) {
            ...
            *(undefined8 *)(puVar16 + -6) = 0xf;
            ...
            local_118 = uVar4;
            local_114 = uVar5;
            FUN_140132b40(local_res10,puVar19);
            puVar17 = local_90;
            *puVar19 = uVar6;
            local_90[-0x21] = uVar1;
            local_90[-0x20] = uVar2;
            ...
            local_90[-0x1e] = uVar4;
            local_90[-0x1d] = uVar5;
            FUN_14000de40(local_90 + -0x1c,&local_110);
            FUN_14000de40(puVar17 + -0x14,&local_f0);
            FUN_14000de40(puVar17 + -0xc,&local_d0);
            puVar17[-2] = local_a8;
            *(undefined8 *)(puVar17 + -4) = local_b0;
            if (0xf < local_b8) {
              ...
              if (0xfff < uVar12) {
                ...
                if (0x1f < (local_d0 - uVar13) - 8) goto LAB_140132164;
            ...
            if (0xf < local_d8) {
              ...
              if (0xfff < uVar12) {
                ...
                if (0x1f < (local_f0 - uVar13) - 8) goto LAB_140132164;
            ...
            if (0xf < local_f8) {
              ...
              if (0xfff < uVar13) {
                ...
                if (0x1f < (local_110 - lVar9) - 8U) goto LAB_140132164;
    ...
    if (puVar15 != param_1) {
      ...
      puVar19 = puVar11;
      local_90 = puVar10;
      if (puVar11 != param_2) goto LAB_14013178c;
      puVar16 = local_res10 + -0x22;
      if (puVar15 != local_res10) {
        FUN_140134250(puVar10,puVar16);
      }
      puVar17 = puVar17 + -0x22;
      local_98 = puVar17;
      FUN_140134250(puVar16,puVar17);
      puVar15 = local_98;
      puVar19 = local_90;
      goto LAB_1401313d0;
    }
    if (puVar11 != param_2) {
      if (puVar17 != puVar11) {
        FUN_140134250(local_res10,puVar17);
      }
      puVar17 = puVar17 + 0x22;
      puVar10 = puVar11;
      puVar16 = puVar15;
...
LAB_14013178c:
    ...
    FUN_140131200(puVar11,puVar10,param_3,param_4);
    param_2 = local_res10;
    lVar9 = (longlong)local_res10 - (longlong)param_1;
  }
  puVar17 = param_1;
  if (param_1 != param_2) {
    while (puVar17 = puVar17 + 0x22, puVar17 != param_2) {
      local_128 = *puVar17;
      local_124 = puVar17[1];
      local_120 = puVar17[2];
      local_11c = puVar17[3];
      ...
      if (cVar8 == '\0') {
        ...
        while (puVar15 = puVar10, cVar8 != '\0') {
          *puVar11 = *puVar15;
          ...
          puVar11[4] = puVar15[4];
          puVar11[5] = puVar15[5];
          FUN_14000de40(puVar11 + 6,puVar15 + 6);
          FUN_14000de40(puVar11 + 0xe,puVar15 + 0xe);
          FUN_14000de40(puVar11 + 0x16,puVar15 + 0x16);
        ...
        *puVar11 = local_128;
        ...
        puVar11[4] = local_118;
        puVar11[5] = local_114;
        FUN_14000de40(puVar11 + 6,&local_110);
        FUN_14000de40(puVar11 + 0xe,&local_f0);
        FUN_14000de40(puVar11 + 0x16,&local_d0);
        ...
        *(undefined8 *)(puVar11 + 0x1e) = local_b0;
        ...
        if (puVar17 != param_1) {
          do {
            ...
            FUN_14000de40(local_138 + -0x1c,puVar11 + -0x1c,puVar11,local_138);
            FUN_14000de40(local_98 + -0x14,puVar11 + -0x14);
            FUN_14000de40(local_80 + -0xc,puVar11 + -0xc);
        ...
        *param_1 = local_128;
        ...
        param_1[4] = local_118;
        param_1[5] = local_114;
        FUN_14000de40(param_1 + 6,&local_110);
        FUN_14000de40(param_1 + 0xe,&local_f0);
        FUN_14000de40(param_1 + 0x16,&local_d0);
...
joined_r0x000140131acf:
  if (0 < lVar14) {
    ...
    *(undefined1 *)(param_1 + lVar14 * 0x22 + -0xc) = 0;
    ...
    FUN_140133a50(param_1,lVar18,lVar9,&local_128,param_4);
    if (0xf < local_b8) {
      uVar12 = local_b8 + 1;
      uVar13 = local_d0;
      if (0xfff < uVar12) {
    ...
    if (0xf < local_f8) {
      ...
      lVar18 = local_110;
      if (0xfff < uVar13) {
        lVar18 = *(longlong *)(local_110 + -8);
        if (0x1f < (local_110 - lVar18) - 8U) goto LAB_140132164;
        uVar13 = local_f8 + 0x28;
      }
      thunk_FUN_14028af80(lVar18,uVar13);
    }
    goto joined_r0x000140131acf;
  }
  if (lVar9 < 2) {
    return;
  }
  do {
    if (1 < ((longlong)param_2 - (longlong)param_1 >> 3) * -0xf0f0f0f0f0f0f0f) {
      ...
      *(undefined1 *)(param_2 + -0xc) = 0;
      ...
      FUN_140132b40(puVar17,param_1);
      FUN_140133a50(param_1,0,((longlong)puVar17 - (longlong)param_1 >> 3) * -0xf0f0f0f0f0f0f0f,
                    &local_128,param_4);
      if (0xf < local_b8) {
        uVar12 = local_b8 + 1;
        uVar13 = local_d0;
