// Function: FUN_1403ed1b0
// Addr: 1403ed1b0
// Size: 529 bytes


undefined1 FUN_1403ed1b0(longlong param_1,uint *param_2,uint *param_3)

{
  ...
  cVar5 = func_0x0001403eccc0(param_1,local_res18);
  if (cVar5 == '\0') {
    *param_2 = 0xffffffff;
    *param_3 = 0xffffffff;
    return 0;
...
LAB_1403ed370:
        uVar8 = *puVar7;
        if (uVar8 == 0) goto code_r0x0001403ed37c;
        lVar3 = 0;
        if (uVar8 != 0) {
...
LAB_1403ed38f:
    ...
    do {
      ...
      if ((((*(longlong *)(lVar4 + 8 + uVar8 * 0x48) != 0) ||
        ...
        if (iVar11 != -1) goto code_r0x0001403ed450;
      }
      uVar15 = (int)uVar12 + 1;
...
LAB_1403ed291:
  ...
  goto LAB_1403ed45e;
code_r0x0001403ed37c:
  uVar15 = (int)uVar13 + 1;
  uVar13 = (ulonglong)uVar15;
  puVar7 = (ulonglong *)(lVar9 + (uVar13 + 1) * 8);
  if (7 < uVar15) goto LAB_1403ed38f;
  goto LAB_1403ed370;
code_r0x0001403ed450:
