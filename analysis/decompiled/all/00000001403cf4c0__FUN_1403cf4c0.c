// Function: FUN_1403cf4c0
// Addr: 1403cf4c0
// Size: 243 bytes


byte * FUN_1403cf4c0(byte *param_1,uint param_2,uint param_3)

{
  ...
  if (iVar4 == 0) {
    ...
    return param_1 + ((ulonglong)param_2 + 1) * 2;
  }
  if (iVar4 == 2) {
    pbVar3 = param_1 + 2;
    pbVar6 = (byte *)0x0;
    ...
    if (iVar4 == 4) {
      pbVar3 = (byte *)FUN_1403cf9e0(param_1,(ulonglong)param_2);
      return pbVar3;
    }
    if (iVar4 != 6) {
      if (iVar4 != 8) {
      ...
      if ((uVar7 <= param_2) &&
        ...
        return param_1 + ((ulonglong)param_2 + 3) * 2;
      }
      return (byte *)0x0;
    }
    pbVar3 = param_1 + 2;
