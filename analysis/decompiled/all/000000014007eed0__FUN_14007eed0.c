// Function: FUN_14007eed0
// Addr: 14007eed0
// Size: 916 bytes


void FUN_14007eed0(longlong *param_1)
    ...
    if (*(ulonglong *)(lVar2 + 0x10) < *(ulonglong *)(lVar2 + 0x38) >> 3) {
      ...
      if (plVar13 != plVar3) {
        ...
        do {
          ...
          FUN_140017240(plVar6 + 0x18);
          FUN_140017240(plVar6 + 0x14);
          FUN_140031b80(plVar6 + 0x11);
          FUN_140031170(plVar6 + 10);
          FUN_140031170(plVar6 + 7);
...
LAB_14007f049:
      ...
      *(undefined8 *)plVar3[1] = 0;
      ...
      while (puVar12 != (undefined8 *)0x0) {
        ...
        FUN_140017240(puVar12 + 0x18);
        FUN_140017240(puVar12 + 0x14);
        FUN_140031b80(puVar12 + 0x11);
        FUN_140031170(puVar12 + 10);
        FUN_140031170(puVar12 + 7);
        FUN_140017240(puVar12 + 2);
        thunk_FUN_14028af80(puVar12,0xe8);
        puVar12 = puVar4;
      }
