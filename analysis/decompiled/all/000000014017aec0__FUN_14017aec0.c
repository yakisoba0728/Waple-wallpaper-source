// Function: FUN_14017aec0
// Addr: 14017aec0
// Size: 514 bytes


void FUN_14017aec0(longlong param_1,ulonglong param_2)

{
  ...
  FUN_140037600(param_1 + 0x18,2L << (bVar9 & 0x3f),plVar1);
  *(longlong *)(param_1 + 0x38) = lVar10;
  *(longlong *)(param_1 + 0x30) = lVar10 + -1;
  plVar7 = (longlong *)**(undefined8 **)(param_1 + 8);
joined_r0x00014017af36:
  do {
    while( true ) {
      while( true ) {
        if (plVar7 == plVar1) {
          local_res10 = 0;
          FUN_14017bf40(&local_res10);
          return;
        }
