// Function: FUN_14036f0c0
// Addr: 14036f0c0
// Size: 230 bytes


ulonglong FUN_14036f0c0(int *param_1,longlong param_2,uint param_3,uint param_4)

{
  ...
  if ((param_4 == 0) || (uVar3 = 0xffffffff / (ulonglong)param_4, param_3 < (uint)uVar3)) {
