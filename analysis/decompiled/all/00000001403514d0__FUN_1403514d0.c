// Function: FUN_1403514d0
// Addr: 1403514d0
// Size: 840 bytes


bool FUN_1403514d0(longlong param_1,int param_2,int param_3,int param_4)
...
joined_r0x0001403515c5:
    do {
      if (piVar18 <= piVar10) {
        cVar2 = FUN_140351ed0(param_1,iVar3,local_res10);
        return cVar2 != '\0';
      }
      pbVar17 = pbVar16 + 1;
      piVar11 = piVar10 + 2;
      if ((pbVar16[1] & 3) == 0) {
        ...
        while( true ) {
          if (piVar18 <= piVar10) {
            cVar2 = FUN_140351080(param_1,iVar15,iVar12,iVar3,local_res10);
            goto LAB_1403517ea;
          }
          piVar11 = piVar10 + 2;
          pbVar16 = pbVar17 + 1;
          ...
          if ((*pbVar16 & 3) != 0) goto LAB_1403517f0;
          cVar2 = FUN_140351080(param_1,iVar15,iVar12,(iVar5 + iVar15) / 2,(iVar7 + iVar12) / 2);
          piVar10 = piVar11;
          iVar12 = iVar7;
          iVar15 = iVar5;
          if (cVar2 != '\0') {
        ...
        cVar2 = FUN_140351080(param_1,iVar15,iVar12,iVar5,iVar7);
      }
      else {
        if ((pbVar16[1] & 3) != 1) {
          if ((piVar18 < piVar10 + 4) || ((pbVar16[2] & 3) != 2)) goto LAB_1403517f0;
          ...
          if (piVar18 < piVar9) {
            cVar2 = FUN_140351270(param_1,iVar5,iVar13,iVar8,iVar7,iVar3,local_res10);
LAB_1403517ea:
            if (cVar2 != '\0') {
              return true;
            }
          ...
          cVar2 = FUN_140351270(param_1,iVar5,iVar13,iVar8,iVar7,iVar12,iVar15);
          if (cVar2 != '\0') {
            return true;
          }
          piVar10 = piVar9;
          pbVar16 = pbVar16 + 3;
          goto joined_r0x0001403515c5;
        }
        ...
        cVar2 = FUN_140351ed0(param_1,iVar12,iVar15);
      }
      piVar10 = piVar11;
      pbVar16 = pbVar17;
    } while (cVar2 == '\0');
