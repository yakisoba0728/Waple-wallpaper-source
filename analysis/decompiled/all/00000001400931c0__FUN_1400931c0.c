// Function: FUN_1400931c0
// Addr: 1400931c0
// Size: 368 bytes


longlong *
FUN_1400931c0(undefined8 param_1,longlong *param_2,longlong *param_3,longlong *param_4,
...

{
  ...
  uVar4 = FUN_140094550(local_38,param_3,param_4,0x800,local_48);
  ...
  if ((char)uVar4 < '\0') {
    ...
    *param_7 = uVar6;
    if ((local_res10 == local_38) || ((int)param_5 != 0)) {
      *param_6 = 2;
      *param_7 = 0;
    }
  ...
  if (*param_3 == 0) {
    if (*param_4 != 0) goto LAB_14009331d;
  }
  else if (*param_4 == 0) goto LAB_14009331d;
  *puVar3 = *puVar3 | 1;
LAB_14009331d:
  lVar2 = param_3[1];
  *param_2 = *param_3;
