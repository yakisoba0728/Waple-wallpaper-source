// Function: FUN_14022a8a0
// Addr: 14022a8a0
// Size: 648 bytes


ulonglong FUN_14022a8a0(longlong param_1,int *param_2)

{
  ...
  if (iVar1 == 1) {
    ...
    if (uVar6 <= uVar2) {
      ...
      if (3 < (uVar2 - uVar6) + 1) {
        ...
        fVar7 = fVar12;
        if (uVar2 < uVar6) goto LAB_14022aa86;
      }
      do {
        lVar5 = (longlong)(int)uVar6;
        uVar6 = uVar6 + 1;
  ...
  if (uVar6 <= uVar2) {
    ...
    if (3 < (uVar2 - uVar6) + 1) {
      ...
      if (uVar2 < uVar6) goto LAB_14022a97c;
    }
    do {
...
LAB_14022a97c:
  fVar12 = fVar12 * DAT_1404926c0;
LAB_14022aa86:
  dVar10 = (double)((fVar12 - (float)param_2[2]) / ((float)param_2[3] - (float)param_2[2]));
  dVar4 = DAT_140492778;
  if (((dVar10 < DAT_140492778) && (dVar4 = 0.0, 0.0 <= dVar10)) &&
     (dVar4 = DAT_140492778, dVar10 < DAT_140492778)) {
    dVar4 = dVar10;
  }
  fVar12 = (float)dVar4;
  uVar8 = FUN_14041e350((DAT_140492830 - (fVar12 + fVar12)) * fVar12 * fVar12,param_2[1]);
  fVar12 = (float)uVar8;
  if (fVar12 < DAT_140492704) {
    if (fVar12 < 0.0) {
      return 0;
    }
    if (fVar12 < DAT_140492704) {
