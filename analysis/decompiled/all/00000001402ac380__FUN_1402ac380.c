...
longlong *
FUN_1402ac380(undefined8 param_1,longlong *param_2,longlong *param_3,longlong *param_4,
...

{
  ...
  local_88 = &local_70;
  uVar1 = FUN_14029ba50(local_60,param_3,param_4,0x800);
  ...
  if (*param_3 == 0) {
    if (*param_4 != 0) goto LAB_1402ac4c2;
  }
  else if (*param_4 == 0) goto LAB_1402ac4c2;
  *param_6 = *param_6 | 1;
LAB_1402ac4c2:
  lVar2 = param_3[1];
  *param_2 = *param_3;
