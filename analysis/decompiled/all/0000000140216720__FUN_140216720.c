// Function: FUN_140216720
// Addr: 140216720
// Size: 148 bytes


float * FUN_140216720(float *param_1,float *param_2)

{
  ...
  *param_1 = fVar4 - (fVar5 + fVar5);
  ...
  param_1[3] = fVar7 + fVar7;
  param_1[2] = fVar5 + fVar5;
  param_1[6] = fVar10 + fVar10;
  param_1[8] = fVar4 - (fVar11 + fVar11);
  param_1[4] = fVar4 - (fVar8 + fVar8);
  param_1[7] = fVar9 + fVar9;
  param_1[5] = fVar6 + fVar6;
  return param_1;
}
