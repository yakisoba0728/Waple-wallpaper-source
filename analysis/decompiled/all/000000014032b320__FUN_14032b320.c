// Function: FUN_14032b320
// Addr: 14032b320
// Size: 517 bytes


ulonglong FUN_14032b320(longlong param_1,longlong param_2)
    ...
    do {
      if (*(int *)(*(longlong *)(param_2 + 0x140) + (ulonglong)uVar16 * 0x10) == 0x20) {
        ...
        if ((uVar16 < *(uint *)(param_1 + 0xc)) ||
           (local_res10[0] = func_0x0001402f5d60(param_1,uVar16 - *(uint *)(param_1 + 0xc)),
           local_res10[0] != 0)) {
          return 0x53;
        }
        uVar16 = func_0x0001402f5a40(param_1,local_res10);
        if (local_res10[0] != 0) {
        ...
        puVar17 = &DAT_14043ff38;
        uVar16 = uVar16 & 4;
        if (uVar16 == 0) {
          puVar17 = &DAT_14043ff18;
        }
        uVar14 = FUN_1402f56e0(param_1,puVar17,puVar1);
        ...
        if ((uVar19 <= uVar23) && (uVar23 < 0x100)) {
          ...
          if ((uVar6 <= uVar5) && (uVar5 < 0x100)) {
            ...
            uVar14 = FUN_1402f50b0(param_1,iVar21 * 2);
            local_res10[0] = (uint)uVar14;
            if (local_res10[0] == 0) {
              puVar18 = (undefined1 *)
                        ((longlong)
              ...
              *puVar8 = *puVar2;
              ...
              puVar8[2] = uVar10;
              puVar8[3] = uVar11;
              psVar15 = (short *)FUN_1402f80c0(uVar7,2,0,iVar21,0,local_res10);
                ...
                if (uVar23 <= *(ushort *)(param_2 + 0x1be)) {
                  do {
                    ...
                    if (uVar19 <= *(ushort *)(param_2 + 0x1ba)) {
                      do {
                        if (uVar16 == 0) {
                          sVar12 = FUN_1402f53a0(param_1);
                        }
                        else {
                          sVar12 = FUN_1402f5370();
                        }
                        sVar13 = -1;
                        if (sVar12 != -1) {
                          sVar13 = sVar12 + 1;
