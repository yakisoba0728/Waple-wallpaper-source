// Function: FUN_14039f620
// Addr: 14039f620
// Size: 435 bytes


void FUN_14039f620(undefined8 param_1,longlong param_2,longlong param_3)
  ...
  if (local_res20 != 0) {
    ...
    do {
      ...
      if (((*(byte *)(lVar3 + 0x10 + lVar15 * 0x14) & 0x1f) != 0x1d) ||
         ((*(byte *)(lVar3 + 0xc + lVar1) & 0x20) != 0)) goto switchD_14039f72e_default;
      ...
      if (((byte)uVar2 & 0x1f) != 0x1d) goto switchD_14039f72e_default;
      uVar7 = uVar2 >> 8;
      switch(uVar7) {
      case 1:
      case 2:
      ...
      case 0x13:
        ...
        do {
          ...
          if (iVar10 != 0) goto code_r0x00014039f96b;
          cVar12 = cVar12 + '\x01';
        } while (cVar12 < ':');
        break;
      case 0x14:
...
code_r0x00014039f96b:
      ...
      default:
        goto switchD_14039f72e_default;
      }
switchD_14039f72e_default:
      uVar13 = uVar13 + 1;
      lVar15 = lVar15 + 1;
