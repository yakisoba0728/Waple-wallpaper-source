// Function: FUN_1403a5360
// Addr: 1403a5360
// Size: 449 bytes


undefined8 FUN_1403a5360(longlong param_1,longlong param_2)

{
  ...
  if (iVar7 == 1) {
    uVar3 = FUN_1403c70f0(pbVar4,*(undefined4 *)
  ...
  if (uVar3 != 0) {
    ...
    if ((uVar5 == 0xff) && (*(char *)(param_2 + 0x130) != '\0')) {
      FUN_14040eef0(lVar1,0 >> (bVar2 & 0x1f),*(undefined4 *)(lVar1 + 0x60));
    ...
    if ((uVar5 <= uVar3) && (uVar5 != 0)) {
      ...
      FUN_1403f7ec0(param_2,(uint)pbVar6[1] + (uint)*pbVar6 * 0x100);
      return 1;
    }
  }
  return 0;
