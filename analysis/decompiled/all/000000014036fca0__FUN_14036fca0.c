// Function: FUN_14036fca0
// Addr: 14036fca0
// Size: 793 bytes


void FUN_14036fca0(byte *param_1,char *param_2,int param_3)

{
  ...
  case 0:
    FUN_1403a3350(param_2,0,param_3 + -1);
    break;
  case 1:
  case 3:
  case 5:
  ...
  case 2:
    pbVar5 = param_1 + 2;
    uVar9 = FUN_1403cbe30(pbVar5);
    uVar6 = 0;
    if (uVar9 != 0) {
      do {
        uVar7 = FUN_1403cbe30(pbVar5);
        if (uVar6 < uVar7) {
        ...
        if (iVar8 != 0xffff) {
          FUN_1403a3350(param_2,iVar8,(uint)*pbVar4 * 0x100 + (uint)pbVar4[1]);
        }
        uVar6 = uVar6 + 1;
      } while (uVar6 < uVar9);
    }
  ...
  case 4:
    ...
    if (uVar9 != 0) {
      do {
        ...
        if (iVar8 != 0xffff) {
          FUN_1403a3350(param_2,iVar8,(uint)pbVar4[1] + (uint)*pbVar4 * 0x100);
        }
        uVar6 = uVar6 + 1;
      } while (uVar6 < uVar9);
    }
      ...
      if (uVar9 != uVar6) {
        do {
          ...
          if ((uVar10 != 0xffff) && (*param_2 != '\0')) {
            ...
            param_2[6] = -1;
            param_2[7] = -1;
            puVar1 = (undefined4 *)FUN_1403ed560(param_2,uVar10,1);
  ...
  case 8:
    ...
    if ((iVar8 != 0) && (iVar3 = (uint)param_1[3] + (uint)param_1[2] * 0x100, iVar3 != 0xffff)) {
      FUN_1403a3350(param_2,iVar3,iVar8 + -1 + iVar3);
    }
    break;
  case 10:
    ...
    break;
  default:
    goto switchD_14036fce2_default;
  }
switchD_14036fce2_default:
  return;
}
