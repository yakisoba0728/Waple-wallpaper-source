// Function: FUN_1402ab3b0
// Addr: 1402ab3b0
// Size: 292 bytes


void FUN_1402ab3b0(undefined8 param_1,undefined4 *param_2,longlong *param_3,longlong *param_4,
...

{
  ...
  local_78 = &local_60;
  uVar3 = FUN_14029acd0(local_50,param_3,param_4,*(undefined4 *)(param_5 + 0x18));
  ...
  if ((char)uVar3 < '\0') {
    ...
    *param_7 = 0;
    ...
    uVar5 = func_0x000140292b30(local_50,&local_60,(int)(char)uVar3,local_68);
    *param_7 = uVar5;
  ...
  if (*param_3 == 0) {
    if (*param_4 != 0) goto LAB_1402ab4e0;
  }
  else if (*param_4 == 0) goto LAB_1402ab4e0;
  *param_6 = *param_6 | 1;
LAB_1402ab4e0:
