// Function: FUN_1403c6320
// Addr: 1403c6320
// Size: 451 bytes


void FUN_1403c6320(longlong param_1,longlong param_2,undefined8 param_3,float *param_4,
                  float *param_5)

{
  ...
  *param_5 = (float)(int)(short)((ushort)*(byte *)(param_1 + 4) * 0x100 +
  ...
  if (((*(int *)(lVar1 + 0x68) != 0) || (*(char *)(lVar1 + 0x78) != '\0')) &&
     (cVar2 = FUN_1404093d0(param_1 + 6,param_2 + 0xa8,param_1), cVar2 != '\0')) {
    bVar5 = *(byte *)(param_1 + 6);
    uVar6 = (uint)CONCAT11(bVar5,*(undefined1 *)(param_1 + 7));
    if (uVar6 != 0) {
      cVar2 = FUN_140403500((ulonglong)uVar6 + param_1,param_2 + 0xa8);
      if (cVar2 == '\0') goto LAB_1403c643e;
      bVar5 = *(byte *)(param_1 + 6);
    }
    ...
    iVar3 = FUN_1403d00b0(puVar4,lVar1,*(undefined8 *)(param_2 + 0x108),
                          *(undefined8 *)(param_2 + 0x110));
    *param_4 = (float)iVar3 + *param_4;
  }
LAB_1403c643e:
  if (((*(int *)(lVar1 + 0x6c) != 0) || (*(char *)(lVar1 + 0x78) != '\0')) &&
     (cVar2 = FUN_1404093d0(param_1 + 8,param_2 + 0xa8,param_1), cVar2 != '\0')) {
    ...
    iVar3 = FUN_1403d0160(puVar7,lVar1,*(undefined8 *)(param_2 + 0x108),
                          *(undefined8 *)(param_2 + 0x110));
