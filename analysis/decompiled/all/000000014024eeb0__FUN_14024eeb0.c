// Function: FUN_14024eeb0
// Addr: 14024eeb0
// Size: 443 bytes


void FUN_14024eeb0(undefined8 param_1,longlong *param_2)

{
  ...
  FUN_14015ab00(param_2,DAT_1404e88b0);
  puVar5 = DAT_1404e88a8;
  puVar2 = (undefined8 *)*DAT_1404e88a8;
  do {
    if (puVar2 == puVar5) {
      return;
    }
...
LAB_14024f061:
                    /* WARNING: Subroutine does not return */
        *(undefined **)(puVar9 + -8) = &UNK_14024f066;
        FUN_140017370();
      }
      uVar1 = lVar7 + 1;
      uVar6 = (uVar6 >> 1) + uVar6;
      ...
      puVar9 = auStack_48;
      if (0x1fffffffffffffff < uVar10) goto LAB_14024f061;
      uVar6 = uVar10 * 8;
      if (uVar6 == 0) {
        uVar6 = 0;
      }
        ...
        puVar9 = auStack_48;
        if (uVar6 + 0x27 <= uVar6) goto LAB_14024f061;
