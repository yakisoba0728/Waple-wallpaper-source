// Function: FUN_1403f8140
// Addr: 1403f8140
// Size: 962 bytes


void FUN_1403f8140(longlong param_1,longlong param_2,undefined8 param_3)

{
  ...
  local_a0 = DAT_1404dc110 ^ (ulonglong)auStack_128;
  ...
  for (; puVar18 != puVar1; puVar18 = puVar18 + 1) {
    ...
    uVar14 = (uint)uVar16;
    uVar12 = 0;
    if (uVar14 <= *(uint *)(local_d8 + 4)) {
      uVar12 = *(int *)(local_d8 + 4) - uVar14;
    }
    uVar14 = uVar8 - uVar14;
    if (uVar12 <= uVar14) {
      uVar14 = uVar12;
    }
    pfVar13 = (float *)(*(longlong *)(local_d8 + 8) + uVar16 * 0xc);
    fVar6 = 0.0;
    fVar7 = 0.0;
    iVar17 = 0;
    fVar4 = fStack_c4;
    fVar5 = fStack_c0;
    while (fStack_c0 = fVar5, fStack_c4 = fVar4, uVar12 = uVar14, fVar20 = fVar7, fVar19 = fVar6,
          pfVar11 = pfVar13, uVar12 != 0) {
      uVar14 = uVar12 - 1;
      pfVar13 = pfVar11 + 3;
      fVar9 = pfVar11[2];
      fVar2 = *pfVar11;
  ...
  local_d0 = 0;
  fStack_c4 = 0.0;
  func_0x0001402ed2f0(local_a0 ^ (ulonglong)auStack_128);
  return;
}
