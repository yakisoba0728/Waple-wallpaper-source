// Function: FUN_1401359c0
// Addr: 1401359c0
// Size: 640 bytes


void FUN_1401359c0(longlong param_1,undefined1 *param_2,undefined1 *param_3,uint *param_4)

{
  ...
  if ((*(longlong *)(param_1 + 0x30) != 0) ||
    ...
    for (puVar11 = *(undefined8 **)(param_1 + 0x138); puVar11 != puVar4; puVar11 = puVar11 + 5) {
      ...
      lVar6 = FUN_14007cbd0(param_1 + 0x20,local_58,puVar11,uVar13);
      ...
      do {
        ...
        for (piVar9 = (int *)plVar12[6]; piVar9 != piVar5; piVar9 = piVar9 + 2) {
          if (*piVar9 == 0) {
            ...
            lVar6 = FUN_14007cbd0(param_1 + 0xf8,local_48,plVar12 + 2,uVar13);
