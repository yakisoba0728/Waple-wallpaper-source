// Function: FUN_14031a510
// Addr: 14031a510
// Size: 587 bytes


int FUN_14031a510(longlong param_1,longlong param_2,longlong param_3)

{
    ...
    if (puVar11 <= puVar13) {
      ...
      *(uint *)(param_3 + 0x38) = uVar12;
      if ((ushort *)((ulonglong)(uVar12 * 4) + (longlong)puVar11) <= puVar13) {
        ...
        puVar8 = (undefined4 *)FUN_1402f7ff0(uVar2,0x10,0,uVar12,0,local_res10);
        *(undefined4 **)(param_3 + 0x30) = puVar8;
        if (local_res10[0] == 0) {
          ...
          for (; puVar11 < puVar13; puVar11 = puVar11 + 2) {
            uVar6 = FUN_1402f0060(param_1,(char)*puVar11);
            *puVar8 = uVar6;
            uVar6 = FUN_1402f0060(param_1,*(undefined1 *)((longlong)puVar11 + 1));
            puVar8[1] = uVar6;
          ...
          *(undefined8 *)(param_1 + 0x88) = uVar3;
          FUN_1402ea670(*(undefined8 *)(param_3 + 0x30),*(undefined4 *)(param_3 + 0x38),0x10,
                        &LAB_14031a830);
          if (local_res10[0] == 0) {
            return 0;
          }
  ...
  local_res10[0] = 2;
LAB_14031a732:
  FUN_1402f7f90(uVar2,*(undefined8 *)(param_3 + 0x30));
