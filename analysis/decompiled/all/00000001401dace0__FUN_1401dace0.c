// Function: FUN_1401dace0
// Addr: 1401dace0
// Size: 643 bytes


undefined8 * FUN_1401dace0(float *param_1,undefined8 *param_2,byte *param_3)
  ...
  *puVar3 = puVar5;
  ...
  if (puVar4 == *(undefined8 **)(param_1 + 2)) {
    *(undefined8 **)(lVar6 + uVar10 * 0x10) = puVar5;
    ...
    if (*(undefined8 **)(lVar6 + 8 + uVar10 * 0x10) != puVar3) goto LAB_1401daf45;
  }
