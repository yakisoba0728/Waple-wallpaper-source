// Function: FUN_1403b2dd0
// Addr: 1403b2dd0
// Size: 403 bytes


void FUN_1403b2dd0(undefined8 *param_1,int *param_2,undefined4 param_3)

{
  ...
  if ((((-1 < (int)uVar7) && (pbVar3 = *(byte **)(param_2 + 2), pbVar3 != (byte *)0x0)) &&
      (uVar7 < (uint)pbVar3[1] * 0x10000 + (uint)pbVar3[2] * 0x100 + (uint)*pbVar3 * 0x1000000 +
               (uint)pbVar3[3])) && (*(uint *)((longlong)param_1 + 0x105c) < 10)) {
