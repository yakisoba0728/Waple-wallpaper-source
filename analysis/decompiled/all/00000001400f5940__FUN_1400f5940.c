// Function: FUN_1400f5940
// Addr: 1400f5940
// Size: 590 bytes


void FUN_1400f5940(longlong *param_1,undefined8 param_2)
  ...
  if (uVar14 != 0) {
    do {
      ...
      if ((uVar4 != 0) && (*(char *)(lVar13 + 0x2c + lVar1) != '\0')) {
        ...
        sVar7 = strlen(pcVar2);
        FUN_1400532a0(param_2,pcVar2,sVar7);
        FUN_1400532a0(param_2," accessArray",0xc);
        puVar10 = (undefined8 *)(lVar1 + 8 + lVar13);
        if (0xf < *(ulonglong *)(lVar13 + 0x20 + lVar1)) {
          puVar10 = (undefined8 *)*puVar10;
        }
        FUN_1400532a0(param_2,puVar10,*(undefined8 *)(lVar13 + 0x18 + lVar1));
        FUN_1400534d0(param_2,0x5b);
        ppppuVar8 = local_50;
        if (0xf < local_38) {
          ppppuVar8 = (undefined8 ****)local_50[0];
        }
        FUN_1400532a0(param_2,ppppuVar8,local_40);
        FUN_1400532a0(param_2,"] = (",5);
        pcVar2 = (&PTR_s_float_140482eb8)[(longlong)*(int *)(lVar13 + lVar1) * 2];
        sVar7 = strlen(pcVar2);
        FUN_1400532a0(param_2,pcVar2,sVar7);
        FUN_1400534d0(param_2,0x5b);
