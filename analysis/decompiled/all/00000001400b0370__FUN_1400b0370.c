// Function: FUN_1400b0370
// Addr: 1400b0370
// Size: 369 bytes


char * FUN_1400b0370(longlong param_1,longlong *param_2)

{
  ...
  case 0:
    break;
  case 1:
    goto switchD_1400b03db_caseD_1;
  case 2:
    goto switchD_1400b03db_caseD_2;
  case 3:
    goto switchD_1400b03db_caseD_3;
  case 4:
    goto switchD_1400b03db_caseD_4;
  case 5:
    goto switchD_1400b03db_caseD_5;
  case 6:
    goto switchD_1400b03db_caseD_6;
  default:
    bVar3 = false;
    goto LAB_1400b0515;
  }
  uVar9 = 1;
switchD_1400b03db_caseD_1:
  if (puVar10 == puVar12) goto LAB_1400b0479;
  uVar4 = *puVar10;
...
switchD_1400b03db_caseD_4:
    ...
    do {
      ...
      *(ulonglong *)(param_1 + 0xfdd0) = uVar8;
      if (bVar7 == 8) goto code_r0x0001400b044b;
