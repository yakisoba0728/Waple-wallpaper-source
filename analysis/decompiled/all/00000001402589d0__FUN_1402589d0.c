// Function: FUN_1402589d0
// Addr: 1402589d0
// Size: 211 bytes


void FUN_1402589d0(longlong *param_1)

{
  ...
  if ((char)param_1[0x65] == '\0') {
    ...
    *(float *)((longlong)param_1 + 0x2f4) = fVar3;
    (**(code **)(*param_1 + 0xb0))
              (param_1,(longlong)fVar3,DAT_1404927d4,(longlong)fVar2,(int)(longlong)fVar3,(int)fVar2
               ,(int)fVar3);
    (**(code **)(*param_1 + 0xb8))(param_1);
    (**(code **)(*param_1 + 0xc0))(param_1);
    if ((0 < (int)param_1[100]) || ((*(byte *)((longlong)param_1 + 0x304) & 0x10) != 0)) {
      FUN_1401edf00(param_1[0x19],param_1[0x5e],0x3f8000003f800000,0x3f8000003f800000,1,
                    param_1 + 0xb6);
      lVar1 = FUN_140150040(param_1[0x19] + 0x1630,"materials/util/composelayer_clearalpha.json");
      param_1[0xb7] = lVar1;
    }
  }
  return;
