// Function: FUN_1401ec720
// Addr: 1401ec720
// Size: 848 bytes


void FUN_1401ec720(longlong *param_1,int param_2,undefined8 *param_3)
  ...
  *(longlong *)(plVar3[1] + 0x50) = *(longlong *)(plVar3[1] + 0x50) + -8;
  if ((int)lVar12 < 2) {
    if ((longlong *)**(longlong **)(plVar3[1] + 0x50) != (longlong *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x0001401eca53. Too many branches */
