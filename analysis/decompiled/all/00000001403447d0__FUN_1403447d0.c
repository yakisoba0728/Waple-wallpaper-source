// Function: FUN_1403447d0
// Addr: 1403447d0
// Size: 55 bytes


undefined8 FUN_1403447d0(longlong param_1,uint param_2,ushort *param_3)

{
  ...
  if ((iVar9 == 1) || (iVar9 == 2)) {
    ...
    *(uint *)(param_3 + 0xc) =
    ...
    uVar7 = func_0x0001402efae0((ulonglong)bVar1 << 6,*(undefined2 *)(param_1 + 0x112));
    *(undefined4 *)(param_3 + 2) = uVar7;
    uVar7 = func_0x0001402efae0((ulonglong)param_3[1] << 6,*(undefined2 *)(param_1 + 0x112));
  ...
  if (iVar9 + 4U <= *(uint *)(param_1 + 0x4d4)) {
    ...
    uVar8 = func_0x0001402f5d20(uVar5,*(int *)(param_1 + 0x4d0) + iVar9);
    if (((int)uVar8 == 0) && (uVar8 = FUN_1402f50b0(uVar5,4), (int)uVar8 == 0)) {
      uVar6 = FUN_1402f5370(uVar5);
      FUN_1402f5370(uVar5);
      func_0x0001402f51d0(uVar5);
      *param_3 = uVar6;
      param_3[1] = uVar6;
      iVar9 = func_0x0001402efae0((ulonglong)uVar6 << 6,*(undefined2 *)(param_1 + 0x112));
