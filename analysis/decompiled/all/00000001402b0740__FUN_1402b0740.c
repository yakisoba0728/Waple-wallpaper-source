...
undefined8
FUN_1402b0740(undefined8 param_1,undefined8 param_2,undefined4 *param_3,undefined1 param_4,
...

{
  ...
  uVar4 = FUN_14000f450(&local_b8);
  lVar5 = (*(code *)PTR__guard_dispatch_icall_140426ae8)(uVar1);
  if (lVar5 != 0) {
    (*(code *)PTR__guard_dispatch_icall_140426ae8)(lVar5,1);
  }
  (*(code *)PTR__guard_dispatch_icall_140426ae8)(uVar4,"0123456789-",&DAT_14042be9c,local_58);
  uVar13 = 0;
  uVar12 = 0;
  ...
  local_68 = 0;
  local_60 = 0;
  FUN_140016170(&local_78,param_7 + uVar11,uVar12 - uVar11);
  uVar3 = local_58[0];
  if (local_68 == 0) {
    if (local_60 == 0) {
      FUN_140015f90(&local_78,1,local_c8,local_58[0]);
    }
    else {
  ...
  local_e0 = FUN_140016600(local_98,&local_78);
  local_b8 = *local_a8;
  ...
  local_f8 = param_5;
  local_e8 = uVar13;
  FUN_1402a8ca0(local_a0,param_2,&local_b8,local_c8);
  if (7 < local_60) {
    if (DAT_140472230 != '\0') {
    ...
    *(undefined8 *)(puVar9 + -8) = 0x1402b0a06;
    thunk_FUN_14028af80(ppppuVar6);
  }
  *(undefined8 *)(puVar9 + -8) = 0x1402b0a15;
  return param_2;
}
