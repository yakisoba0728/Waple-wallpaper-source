// Function: FUN_1403cb540
// Addr: 1403cb540
// Size: 393 bytes


int FUN_1403cb540(longlong param_1,int param_2,int param_3,longlong param_4)

{
  ...
  pbVar8 = (byte *)((ulonglong)*(byte *)(param_1 + 0xc) * 0x100 +
  ...
  lVar5 = (ulonglong)*(byte *)(param_1 + 0xe) * 0x100 +
