// Function: FUN_1403ad550
// Addr: 1403ad550
// Size: 268 bytes


undefined8 FUN_1403ad550(longlong param_1,longlong param_2,undefined4 param_3)

{
  ...
  if ((*(uint *)(lVar2 + 0x38) & 0xfffffffe) == 4) {
    ...
    fVar10 = (float)FUN_1403cee10(puVar4,param_1,fVar10,param_3);
    FUN_14041a690(fVar10 * *(float *)(lVar3 + 0x50) + DAT_140492790);
    ...
    fVar10 = (float)FUN_1403cee10(puVar4,param_1,fVar10,param_3);
    FUN_14041a690(fVar10 * *(float *)(lVar3 + 0x54) + DAT_140492790);
    uVar5 = *(uint *)(lVar2 + 0x60);
    if (uVar5 != 0) {
      uVar9 = 0;
      uVar7 = uVar9;
