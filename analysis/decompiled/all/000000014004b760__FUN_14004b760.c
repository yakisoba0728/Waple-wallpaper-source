// Function: FUN_14004b760
// Addr: 14004b760
// Size: 5 bytes


undefined8 * FUN_14004b760(float *param_1,undefined8 *param_2,byte *param_3)
  ...
  *puVar2 = puVar5;
  ...
  if (puVar4 == *(undefined8 **)(param_1 + 2)) {
    *(undefined8 **)(lVar3 + uVar6 * 0x10) = puVar5;
    ...
    if (*(undefined8 **)(lVar3 + 8 + uVar6 * 0x10) != puVar2) goto code_r0x00014004b951;
  }
  *(undefined8 **)(lVar3 + 8 + uVar6 * 0x10) = puVar5;
code_r0x00014004b951:
  *param_2 = puVar5;
  *(undefined1 *)(param_2 + 1) = 1;
  return param_2;
}
