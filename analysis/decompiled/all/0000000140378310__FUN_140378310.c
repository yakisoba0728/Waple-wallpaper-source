// Function: FUN_140378310
// Addr: 140378310
// Size: 183 bytes


undefined8 FUN_140378310(byte *param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  if (uVar6 != 0) {
    do {
      ...
      FUN_1403783d0(pbVar3,local_res8,param_3,(uint)bVar2 * 0x100 + (uint)bVar1);
      uVar5 = uVar5 + 1;
    } while (uVar5 < uVar6);
  }
  return param_2;
