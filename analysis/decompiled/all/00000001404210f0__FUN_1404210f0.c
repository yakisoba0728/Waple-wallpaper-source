// Function: FUN_1404210f0
// Addr: 1404210f0
// Size: 1369 bytes


void FUN_1404210f0(undefined8 *param_1,undefined8 *param_2,ulonglong param_3)

{
  ...
  if (2 < DAT_1404dc008) {
    if ((0x2000 < param_3) && (param_3 < 0x180001)) {
      ...
      if ((puVar26 <= param_2) && (((byte)DAT_1404e3a8c & 2) != 0)) goto code_r0x0001404210eb;
    }
    uVar10 = *param_2;
    uVar11 = param_2[1];
    uVar12 = param_2[2];
        ...
        do {
          ...
          *(undefined8 *)(pauVar23[7] + 0x18) = uVar22;
          ...
          param_3 = param_3 - 0x100;
                    ...
                    /* WARNING: Could not recover jumptable at 0x000140421372. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(IMAGE_DOS_HEADER_140000000.e_magic +
              *(uint *)(&DAT_140497e00 + (param_3 + 0x1f >> 5) * 4)))();
    return;
  }
  if ((param_3 < 0x801) || (((byte)DAT_1404e3a8c & 2) == 0)) {
    if (0x80 < param_3) {
        ...
        do {
          ...
          *param_1 = *param_2;
          ...
          param_3 = param_3 - 0x80;
                    ...
                    /* WARNING: Could not recover jumptable at 0x000140421616. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(IMAGE_DOS_HEADER_140000000.e_magic +
              *(uint *)(&DAT_140497e48 + (param_3 + 0xf >> 4) * 4)))();
    return;
  }
code_r0x0001404210eb:
