// Function: FUN_1403cfc40
// Addr: 1403cfc40
// Size: 409 bytes


void FUN_1403cfc40(undefined8 param_1,float param_2,undefined8 param_3,undefined8 *param_4)

{
  ...
  if ((uVar1 != 1) && (uVar1 != 0)) {
    ...
    do {
      ...
      if (param_2 <= ((float)iVar4 + 0.0) * DAT_1404926c0) break;
      uVar5 = (int)uVar6 + 1;
    ...
    if ((uVar5 != 0) && (uVar5 != uVar1)) {
      ...
      if (((float)(int)((((uint)pbVar3[1] + (uint)*pbVar3 * 0x100) * 0x100 + (uint)pbVar3[2]) *
                        0x100 + (uint)pbVar3[3]) + 0.0) * DAT_1404926c0 != param_2) {
        local_28 = *param_4;
        uStack_20 = param_4[1];
        local_18 = param_4[2];
        FUN_1403e51b0(param_1,uVar5 - 1,iVar4,param_3,&local_28);
        return;
      }
    }
  }
