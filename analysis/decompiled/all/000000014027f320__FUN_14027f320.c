...
ulonglong FUN_14027f320(double *param_1,float param_2,undefined8 param_3,float *param_4,
...
LAB_14027f548:
          ...
          if (*(char *)(param_1 + 1) == '\0') {
            ...
            if (fVar23 != fVar36) goto LAB_14027f548;
          }
          dVar9 = 0.0;
        }
LAB_14027f5be:
...
LAB_14027fc21:
          ...
          dVar21 = (double)FUN_140280ee0(pdVar5 + 6,local_110 + 2);
          fVar23 = fVar39;
          if (fVar39 <= fVar41) {
            fVar23 = fVar41;
          }
          ...
          if ((double)(float)((uint)(fVar36 - fVar28) & (uint)_DAT_140492fc0) *
              *(double *)((longlong)dVar9 + 200) <
              (double)(float)((uint)(fVar29 - fVar28) & (uint)_DAT_140492fc0)) goto LAB_14027fc21;
          uVar38 = 0;
          in_XMM2_Dc = 0;
          in_XMM2_Dd = 0;
        }
