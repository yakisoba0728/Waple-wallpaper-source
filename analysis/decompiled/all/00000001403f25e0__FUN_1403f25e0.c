...
void FUN_1403f25e0(uint param_1,undefined8 *param_2,undefined1 *param_3)

{
  ...
  if (0x122 < param_1) {
    if (param_1 == 0x123) {
      FUN_1403c4190(param_2,param_3);
    }
    else if (param_1 == 0x124) {
      FUN_1403deaf0(param_2,param_3);
    }
    else {
      if (param_1 != 0x125) goto switchD_1403f262f_caseD_2;
      FUN_1403c3410(param_2,param_3);
    }
    goto LAB_1403f2c65;
  }
  if (param_1 == 0x122) {
    if (*(int *)((longlong)param_2 + 0x1c) == 7) {
      ...
      local_40 = dStack_60;
      local_10 = dStack_60;
      func_0x0001403bcbe0(param_2,param_3,&local_58,&local_68,&local_48);
      func_0x0001403bcbe0(param_2,param_3,&dStack_18,&dStack_28,&dStack_38);
    }
    else {
...
switchD_1403f262f_caseD_2:
  ...
  case 4:
    ...
    *param_3 = 0;
    ...
    goto LAB_1403f2845;
  case 5:
    FUN_1403fa010(param_2,param_3);
    break;
  case 6:
    FUN_1403dfef0(param_2,param_3);
    break;
  case 7:
    FUN_140411eb0(param_2,param_3);
    break;
  case 8:
    FUN_1403fa720(param_2,param_3);
    break;
  case 10:
    FUN_1403b2d30(param_2,param_2 + 0x236,2);
    return;
  case 0xb:
  ...
  case 0x14:
    ...
    if (*(uint *)(param_2 + 2) <
        (uint)(*(int *)((longlong)param_2 + 0x14) + *(int *)((longlong)param_2 + 0x1054))) {
      return;
    }
    *(undefined4 *)((longlong)param_2 + 0x11d4) = 0;
...
LAB_1403f2845:
    *(undefined1 *)((longlong)param_2 + 0x1049) = 1;
    break;
  case 0x18:
    FUN_1403f5e80(param_2,param_3);
    break;
  case 0x19:
    FUN_1403f9060(param_2,param_3);
    break;
  case 0x1a:
    FUN_140412b90(param_2,param_3);
    break;
  case 0x1b:
    FUN_1403df400(param_2,param_3);
    break;
  case 0x1d:
    FUN_1403b2d30(param_2,param_2 + 0x234,1);
    return;
  case 0x1e:
    FUN_14040f5e0(param_2,param_3);
    break;
  case 0x1f:
    FUN_1403e0bd0(param_2,param_3);
    break;
  case 0xff:
