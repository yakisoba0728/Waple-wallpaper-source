...
longlong *
FUN_1402aa820(undefined8 param_1,longlong *param_2,longlong *param_3,longlong *param_4,
...

{
  ...
  if ((char)uVar1 < '\0') {
    ...
    *param_7 = 0;
    ...
    uVar2 = FUN_140292770(local_50,&local_60,(int)(char)uVar1,local_68);
    *param_7 = uVar2;
  ...
  if (*param_3 == 0) {
    if (*param_4 != 0) goto LAB_1402aa950;
  }
  else if (*param_4 == 0) goto LAB_1402aa950;
  *param_6 = *param_6 | 1;
LAB_1402aa950:
  lVar3 = param_3[1];
  *param_2 = *param_3;
