// Function: FUN_1402c3edc
// Addr: 1402c3edc
// Size: 871 bytes


undefined4 FUN_1402c3edc(longlong param_1)
        ...
        while( true ) {
          ...
          *(char *)(param_1 + 0x39) = cVar2;
          ...
          if ((byte)(cVar2 - 0x20U) < 0x5b) {
            bVar4 = (&DAT_14042d3d1)[(ulonglong)((int)cVar2 - 0x20U & 0x7f) * 2];
          }
          bVar4 = (&DAT_14042d3d0)
                  [(ulonglong)((uint)bVar4 * 9 + (uint)*(byte *)(param_1 + 0x24) & 0x7f) * 2];
          *(byte *)(param_1 + 0x24) = bVar4;
          if (7 < bVar4) goto LAB_1402c4226;
          if (bVar4 == 0) {
            lVar5 = *(longlong *)(param_1 + 8);
...
LAB_1402c406a:
              ...
              lVar5 = param_1 + 0x2c;
LAB_1402c4015:
              cVar2 = FUN_1402c3a38(param_1,lVar5);
            }
LAB_1402c406c:
            if (cVar2 == '\0') {
              return 0xffffffff;
