...
void FUN_1404a76d4(undefined8 param_1,undefined8 param_2)

{
  ...
  *(uint *)CONCAT62(uVar19,CONCAT11(cVar18,cVar17)) =
  ...
  unaff_RSI[-0x7bfff5de] = unaff_RSI[-0x7bfff5de] + cVar6 + '4';
  ...
  *(char *)CONCAT62(uVar19,CONCAT11(cVar18,cVar17)) =
  ...
  unaff_RDI[0x421004b] = unaff_RDI[0x421004b] + bVar7;
