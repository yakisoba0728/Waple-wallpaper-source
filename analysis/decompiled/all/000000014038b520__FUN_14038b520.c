// Function: FUN_14038b520
// Addr: 14038b520
// Size: 137 bytes


int * FUN_14038b520(longlong param_1,longlong param_2,int param_3)

{
  ...
  *(undefined1 *)(param_1 + 0x28) = 0;
  ...
  if (lVar3 != 0) {
    cVar1 = FUN_140404000(lVar3,param_1);
    if (((cVar1 == '\0') || (cVar1 = func_0x000140409650(lVar3 + 0x14,param_1,lVar3), cVar1 == '\0')
        ) || ((uVar5 = (uint)*(byte *)(lVar3 + 0x15) * 0x10000 +
                       (uint)*(byte *)(lVar3 + 0x16) * 0x100 +
                       (uint)*(byte *)(lVar3 + 0x14) * 0x1000000 + (uint)*(byte *)(lVar3 + 0x17),
              uVar5 != 0 &&
              (cVar1 = func_0x0001404033e0((ulonglong)uVar5 + lVar3,param_1), cVar1 == '\0')))) {
      FUN_1403bf0c0(param_1);
      func_0x000140414220(piVar4);
      piVar4 = (int *)&DAT_14045dde0;
    }
    else {
      FUN_1403bf0c0(param_1);
