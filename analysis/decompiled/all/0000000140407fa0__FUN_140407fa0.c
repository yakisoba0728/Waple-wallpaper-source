// Function: FUN_140407fa0
// Addr: 140407fa0
// Size: 372 bytes


ulonglong FUN_140407fa0(byte *param_1,int *param_2)
  ...
  if (uVar10 <= uVar8) {
    ...
    if (uVar4 < 0x5555555) {
      ...
      if ((((ulonglong)(uint)param_2[6] < (ulonglong)((longlong)pbVar1 - *(longlong *)(param_2 + 2))
         ...
         (param_2[7] = param_2[7] + uVar4 * -0x30, param_2[7] <= iVar7)) {
        cVar9 = '\0';
      }
      else {
        cVar9 = '\x01';
      ...
      uVar3 = FUN_1402fc370("SANITIZE",pbVar1,0,1,*param_2 + 1,0,
                            ...
                            pbVar1 + uVar5,uVar5,*(longlong *)(param_2 + 2),
