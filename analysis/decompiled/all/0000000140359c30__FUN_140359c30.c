// Function: FUN_140359c30
// Addr: 140359c30
// Size: 1214 bytes


void FUN_140359c30(longlong *param_1,int param_2)
...
LAB_140359cd3:
  ...
  *puVar23 = *(undefined1 *)(lVar11 + 2);
  puVar23 = puVar23 + 1;
  goto LAB_14035a015;
joined_r0x000140359df8:
  lVar11 = lVar10 + uVar16 * 4;
  if ((bVar1 & 0x10) != 0) goto LAB_140359e39;
  if ((bVar1 & 0x40) != 0) {
...
LAB_14035a015:
  if ((pbVar12 <= pbVar20) || (puVar19 <= puVar23)) goto LAB_14035a084;
  goto LAB_140359cd3;
}
