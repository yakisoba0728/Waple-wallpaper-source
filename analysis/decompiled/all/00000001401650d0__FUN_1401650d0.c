// Function: FUN_1401650d0
// Addr: 1401650d0
// Size: 470 bytes


void FUN_1401650d0(longlong param_1,ulonglong param_2)

{
  ...
  FUN_14004f190(param_1 + 0x18,2L << (bVar9 & 0x3f),plVar1);
  *(longlong *)(param_1 + 0x38) = lVar10;
  *(longlong *)(param_1 + 0x30) = lVar10 + -1;
  plVar7 = (longlong *)**(undefined8 **)(param_1 + 8);
joined_r0x000140165146:
  do {
    while( true ) {
      while( true ) {
        if (plVar7 == plVar1) {
          local_res10 = 0;
          FUN_140164a20(&local_res10);
          return;
        }
      ...
      if ((int)plVar7[2] != (int)plVar4[2]) break;
    ...
    do {
      if (plVar3 == plVar4) {
        ...
        *(longlong **)(lVar10 + uVar8 * 0x10) = plVar7;
        plVar7 = plVar2;
        goto joined_r0x000140165146;
      }
      plVar4 = (longlong *)plVar4[1];
    } while ((int)plVar7[2] != (int)plVar4[2]);
    lVar10 = *plVar4;
    plVar3 = (longlong *)plVar7[1];
    *plVar3 = (longlong)plVar2;
