// Function: FUN_1402abdc0
// Addr: 1402abdc0
// Size: 292 bytes


void FUN_1402abdc0(undefined8 param_1,undefined4 *param_2,longlong *param_3,longlong *param_4,
...

{
  ...
  if (*param_3 == 0) {
    if (*param_4 != 0) goto LAB_1402abef0;
  }
  else if (*param_4 == 0) goto LAB_1402abef0;
  *param_6 = *param_6 | 1;
LAB_1402abef0:
