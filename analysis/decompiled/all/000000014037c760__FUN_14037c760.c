// Function: FUN_14037c760
// Addr: 14037c760
// Size: 497 bytes


void FUN_14037c760(longlong param_1,undefined4 param_2)

{
  ...
  puVar12 = *(undefined8 **)(*(longlong *)(param_1 + 0x98) + 0x140);
  ...
  *(undefined1 **)(param_1 + 0x148) = local_68;
  ...
  local_74 = uVar3;
  local_70 = uVar4;
  lVar7 = FUN_1403c5cd0(puVar12,param_2);
  if (lVar7 != 0) {
      ...
      do {
        if (((ulonglong)puVar9[uVar10 + 5] >>
             (*(uint *)(*(longlong *)(*(longlong *)(param_1 + 0xa0) + 0x70) +
              ...
              ((byte)(&DAT_14045c498)[uVar10] & 0x1f) & 0x3f) & 1) == 0) goto code_r0x00014037c91a;
        uVar14 = (int)uVar10 + 1;
        uVar10 = (ulonglong)uVar14;
      } while (uVar14 < 3);
      cVar6 = (*(code *)puVar9[1])(*puVar9,param_1,puVar9[4]);
      if (cVar6 != '\0') break;
code_r0x00014037c91a:
      puVar12 = puVar12 + 8;
    }
  }
