// Function: FUN_1403ea170
// Addr: 1403ea170
// Size: 1254 bytes


void FUN_1403ea170(longlong *param_1,longlong param_2,longlong param_3,uint param_4,char param_5)

{
  ...
  local_1f0 = param_2;
  local_1d8 = param_1;
  cVar10 = FUN_1403ec600(param_3,param_2,"start kern");
  if (cVar10 != '\0') {
                ...
                if ((local_1b0 & 0x10) == 0) {
                  ...
                  do {
                    if ((*(ulonglong *)
                         ...
                         (*puVar3 >> ((byte)(&DAT_14045c498)[uVar11] & 0x1f) & 0x3f) & 1) == 0)
                    goto LAB_1403ea3db;
                    uVar14 = (int)uVar11 + 1;
                  ...
                  cVar10 = FUN_1403ebff0(puVar13,local_1b0 >> 0x10,*puVar3);
                  uVar17 = (ulonglong)local_1c0;
                  if (cVar10 == '\0') {
LAB_1403ea3db:
                    bVar20 = false;
              ...
              if (((local_1ac & puVar3[1]) != 0) &&
                ...
                if (iVar19 != 0) {
                  ...
                  func_0x00014040efc0(param_3,uVar16,(int)uVar17 + 1);
                  uVar18 = local_1c0;
                }
                goto LAB_1403ea63e;
              }
