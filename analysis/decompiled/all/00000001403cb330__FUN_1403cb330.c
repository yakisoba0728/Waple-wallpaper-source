// Function: FUN_1403cb330
// Addr: 1403cb330
// Size: 185 bytes


int FUN_1403cb330(longlong param_1,uint param_2,uint param_3)

{
  ...
  iVar7 = 0;
  iVar6 = (uint)*(byte *)(param_1 + 6) * 0x100 + (*(byte *)(param_1 + 7) - 1);
  if (-1 < iVar6) {
    do {
      uVar1 = (uint)(iVar6 + iVar7) >> 1;
      uVar3 = (ulonglong)uVar1;
      puVar5 = (undefined8 *)(param_1 + 0xe + uVar3 * 6);
      uVar4 = (uint)*(byte *)(param_1 + 0xf + uVar3 * 6) +
              (uint)*(byte *)(param_1 + 0xe + uVar3 * 6) * 0x100;
