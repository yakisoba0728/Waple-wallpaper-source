// Function: FUN_14014eb50
// Addr: 14014eb50
// Size: 574 bytes


longlong * FUN_14014eb50(float *param_1,longlong *param_2,undefined8 *param_3)
  ...
  if (*param_1 <= fVar10 && fVar10 != *param_1) {
    ...
    if (puVar7 != *(undefined8 **)(param_1 + 2)) {
      ...
      while( true ) {
        ...
        if (puVar8 == puVar2) goto LAB_14014ed18;
  ...
  *puVar7 = puVar5;
  ...
  if (puVar2 == *(undefined8 **)(param_1 + 2)) {
    *(undefined8 **)(lVar3 + uVar9 * 0x10) = puVar5;
    ...
    if (*(undefined8 **)(lVar3 + 8 + uVar9 * 0x10) != puVar7) goto LAB_14014ed68;
  }
