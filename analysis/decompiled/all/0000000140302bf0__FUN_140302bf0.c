...
undefined8 FUN_140302bf0(undefined8 *param_1,longlong param_2)

{
  ...
  piVar15 = (int *)(&DAT_140438050 + (longlong)(int)puVar35[3] * 8);
  local_2a8 = piVar15;
  local_298 = param_2;
  local_258 = param_1;
  local_248 = param_1 + 0x49;
  local_230 = puVar35;
  uVar12 = FUN_1404144f0();
  iVar7 = *piVar15;
...
LAB_140302ca0:
  ...
  if (cVar37 != '\0') {
    ...
    local_2cc = 0;
    local_2d0 = 0;
    pcVar6 = &DAT_140436aa0 + iVar7;
    uVar18 = 0;
joined_r0x000140302cd5:
    while (cVar37 == ' ') {
      cVar37 = pcVar6[1];
      pcVar6 = pcVar6 + 1;
    }
    local_238 = (char *)FUN_140305960();
    uVar30 = uVar18;
    if (local_274 != 0) {
      local_2d8 = '\0';
      iVar7 = -0x80000000;
...
LAB_140302d40:
        uVar16 = local_290;
        lVar13 = FUN_1404148a0(uVar12,&local_278);
        lVar14 = FUN_1404148b0(uVar12,&local_278);
        iVar24 = iVar7;
        if (uVar16 < local_278) {
          iVar7 = *(int *)(lVar13 + (ulonglong)uVar16 * 0x14);
          if (iVar7 == 0) goto LAB_1403030c1;
          iVar2 = *(int *)(lVar14 + 0xc + (ulonglong)uVar16 * 0x14);
          iVar7 = FUN_1402f12d0(param_2,iVar7);
          lVar13 = *(longlong *)(param_2 + 0x78);
          local_288 = *(longlong *)(lVar13 + 0xa8);
          param_2 = local_298;
          iVar24 = local_2c8;
          if ((iVar7 != 0) || (*(ushort *)(lVar13 + 0x9a) < 3)) goto LAB_1403030c1;
          uVar29 = 0xffffffff;
          ...
          if (*(ushort *)(lVar13 + 0x98) != 0) {
            ...
            if ((int)uVar29 < 0) goto LAB_1403033aa;
...
LAB_140303152:
  do {
    ...
    if ((int)(*(uint *)(local_258 + 8) >> 2) < iVar10) {
      ...
      if ((iVar10 < iVar17 == iVar19 < iVar8) && ((int)uVar36 <= iVar4)) goto LAB_140303280;
    }
LAB_14030324c:
    uVar27 = uVar28;
...
LAB_140303372:
    ...
    if (iVar8 <= (int)local_260) goto LAB_140303372;
    cVar37 = '\0';
LAB_1403033a7:
    iVar7 = iVar7 + iVar2;
LAB_1403033aa:
    ...
    if ((*(byte *)(local_2a8 + 1) & 1) == 0) {
      if (iVar7 < local_2c8) goto LAB_1403030c6;
    }
    else if (local_2c8 < iVar7) goto LAB_1403030c6;
  }
LAB_1403030c1:
  iVar7 = iVar24;
  cVar37 = local_2d8;
...
LAB_1403030c6:
  ...
  if (local_274 <= local_290) goto code_r0x0001403030e0;
  goto LAB_140302d40;
code_r0x0001403030e0:
...
LAB_14030341c:
  ...
  pcVar6 = local_238;
  uVar18 = uVar30;
  if (cVar37 == '\0') goto code_r0x000140303427;
  goto joined_r0x000140302cd5;
code_r0x000140303427:
  uVar16 = (uint)uVar30;
  uVar29 = (uint)uVar22;
...
LAB_1403035e9:
  ...
  param_1 = local_258;
  local_2a8 = piVar15;
  if (iVar7 == 0x159b) goto LAB_140303620;
  goto LAB_140302ca0;
}
