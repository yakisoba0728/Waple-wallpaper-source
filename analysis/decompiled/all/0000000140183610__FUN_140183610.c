// Function: FUN_140183610
// Addr: 140183610
// Size: 1105 bytes


void FUN_140183610(longlong param_1)

{
  ...
  if ((*(uint *)(param_1 + 0x128) & 0x2000) != 0) {
    ...
    *(undefined8 *)(*(longlong *)(param_1 + 0x3190) + 0xd0) =
    ...
    FUN_140155fc0(*(undefined8 *)(param_1 + 0x3190));
    (**(code **)(**(longlong **)(param_1 + 0x58) + 8))();
    FUN_140157430(*(undefined8 *)(param_1 + 0x3190));
    iVar8 = 1;
    ...
    if (1 < iVar7) {
      do {
        ...
        *(undefined8 *)(*(longlong *)(param_1 + 0x3198) + 0xd0) =
        ...
        FUN_140155fc0(*(undefined8 *)(param_1 + 0x3198));
        (**(code **)(**(longlong **)(param_1 + 0x58) + 8))();
        FUN_140157430(*(undefined8 *)(param_1 + 0x3198));
        iVar8 = iVar8 + 1;
  ...
  **(longlong **)(lVar5 + 0x50) = (longlong)plVar3;
  (**(code **)(*plVar3 + 0x48))();
  FUN_140155fc0(*(undefined8 *)(param_1 + 0x3160));
  (**(code **)(**(longlong **)(param_1 + 0x58) + 8))();
  FUN_140157430(*(undefined8 *)(param_1 + 0x3160));
  ...
  **(longlong **)(lVar5 + 0x50) = (longlong)plVar3;
  (**(code **)(*plVar3 + 0x48))();
  FUN_140155fc0(*(undefined8 *)(param_1 + 0x3170));
  (**(code **)(**(longlong **)(param_1 + 0x58) + 8))();
  FUN_140157430(*(undefined8 *)(param_1 + 0x3170));
  ...
  **(longlong **)(lVar5 + 0x50) = (longlong)plVar3;
  (**(code **)(*plVar3 + 0x48))();
  FUN_140155fc0(*(undefined8 *)(param_1 + 0x3178));
  (**(code **)(**(longlong **)(param_1 + 0x58) + 8))();
  FUN_140157430(*(undefined8 *)(param_1 + 0x3178));
  plVar2 = *(longlong **)(param_1 + 0x30b0);
  *(longlong *)(plVar2[1] + 0x50) = *(longlong *)(plVar2[1] + 0x50) + -8;
  if ((longlong *)**(longlong **)(plVar2[1] + 0x50) == (longlong *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x000140183a5d. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(*plVar2 + 0x50))(plVar2);
    return;
  }
                    /* WARNING: Could not recover jumptable at 0x000140183a4e. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(*(longlong *)**(longlong **)(plVar2[1] + 0x50) + 0x48))();
  return;
}
