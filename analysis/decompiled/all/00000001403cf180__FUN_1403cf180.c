// Function: FUN_1403cf180
// Addr: 1403cf180
// Size: 543 bytes


ulonglong FUN_1403cf180(longlong param_1,float *param_2,float *param_3)

{
  ...
  *param_3 = (float)iVar2;
  ...
  if ((bVar1 & 8) != 0) {
    ...
    fVar8 = ((float)(int)sVar3 + 0.0) * DAT_140471a5c;
    param_2[3] = fVar8;
    *param_2 = fVar8;
  ...
  if ((bVar1 & 0x40) == 0) {
    ...
    *param_2 = ((float)(int)(short)((ushort)pbVar7[1] + (ushort)*pbVar7 * 0x100) + 0.0) *
    ...
    uVar4 = (ulonglong)uVar5;
    param_2[3] = ((float)(int)uVar5 + 0.0) * DAT_140471a5c;
  }
