// Function: FUN_140136350
// Addr: 140136350
// Size: 582 bytes


longlong * FUN_140136350(float *param_1,longlong *param_2,undefined8 *param_3)

{
  ...
  if (param_3[2] * 2 != 0) {
    do {
      pbVar1 = (byte *)(uVar5 + (longlong)puVar8);
      uVar5 = uVar5 + 1;
      uVar10 = (uVar10 ^ *pbVar1) * 0x100000001b3;
    } while (uVar5 < (ulonglong)(param_3[2] * 2));
  }
  FUN_14007cbd0(param_1,&local_28,param_3,uVar10);
  if (lStack_20 != 0) {
    *param_2 = lStack_20;
  ...
  plVar3 = (longlong *)FUN_14028af20(0x38);
  ...
  *(undefined4 *)(plVar3 + 6) = 0;
  ...
  if (*param_1 < (float)(*(longlong *)(param_1 + 4) + 1) / (float)uVar5) {
    ...
    FUN_140137670(param_1,uVar9);
    plVar4 = (longlong *)FUN_14007cbd0(param_1,&local_28,plVar3 + 2,uVar10);
    local_28 = *plVar4;
  }
  ...
  *(longlong **)(local_28 + 8) = plVar3;
  ...
  lVar2 = *(longlong *)(lVar6 + uVar10 * 0x10);
  if (lVar2 == *(longlong *)(param_1 + 2)) {
    *(longlong **)(lVar6 + uVar10 * 0x10) = plVar3;
  }
  else {
    if (lVar2 == local_28) {
      *(longlong **)(lVar6 + uVar10 * 0x10) = plVar3;
    ...
    if (*(longlong **)(lVar6 + 8 + uVar10 * 0x10) != plVar4) goto LAB_14013656c;
  }
  *(longlong **)(lVar6 + 8 + uVar10 * 0x10) = plVar3;
LAB_14013656c:
