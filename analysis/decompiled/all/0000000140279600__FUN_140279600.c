// Function: FUN_140279600
// Addr: 140279600
// Size: 399 bytes


undefined8 FUN_140279600(undefined8 param_1,undefined8 param_2)

{
  ...
  uVar3 = FUN_14000d140(local_f8,"-mdl -i \"");
  ...
  if ((((byte)local_80 & 0x22) == 2) || (uVar6 = *local_b0, uVar6 == 0)) {
    if (((local_80 & 4) != 0) || (*local_b8 == 0)) goto LAB_1402796fa;
    lVar5 = *local_d8;
