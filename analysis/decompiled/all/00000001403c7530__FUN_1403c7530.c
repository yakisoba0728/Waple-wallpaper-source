// Function: FUN_1403c7530
// Addr: 1403c7530
// Size: 21 bytes


undefined8
FUN_1403c7530(longlong param_1,uint param_2,undefined8 param_3,undefined8 param_4,undefined8 param_5
             )

{
  ...
  if (param_2 >> 0x10 < (uint)*(byte *)(param_1 + 7) + (uint)*(byte *)(param_1 + 6) * 0x100) {
    ...
    if ((ushort)((ushort)*(byte *)((longlong)puVar4 + 4) * 0x100 +
      ...
      uVar5 = func_0x00014039b140(puVar4,param_2 & 0xffff,param_3,param_4,puVar3,param_5);
      return uVar5;
    }
  }
  return 0;
