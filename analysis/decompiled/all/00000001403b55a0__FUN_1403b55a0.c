...
void FUN_1403b55a0(longlong *param_1,undefined4 *param_2,longlong param_3)

{
  ...
  *(undefined1 *)(param_2 + 2) = *(undefined1 *)((longlong)param_1 + 0x34);
  ...
  local_res10 = param_2;
  local_res18 = param_3;
  puVar8 = (undefined8 *)FUN_1403c5040(*param_1 + 0x140);
  ...
  uVar10 = FUN_1403ce520(puVar8,(int)lVar18);
  lVar11 = FUN_1403cbe90(uVar10,(int)lVar11);
  local_d0[0] = (uint)*(byte *)(lVar11 + 3) + (uint)*(byte *)(lVar11 + 2) * 0x100;
  if (local_d0[0] == 0xffff) {
    local_d0[0] = 0xffff;
  }
  local_e8[2] = FUN_1403c90a0(puVar8);
  ...
  *(undefined1 *)((longlong)param_2 + 9) = *(undefined1 *)((longlong)param_1 + 0x35);
  ...
  puVar8 = (undefined8 *)FUN_1403c4fa0(*param_1 + 0x148);
  puVar9 = &DAT_14045dde0;
  if ((undefined8 *)*puVar8 != (undefined8 *)0x0) {
    puVar9 = (undefined8 *)*puVar8;
  }
  ...
  if (*(uint *)((longlong)param_1 + 0x54) != 0) {
    ...
    if (((uint)uVar24 < *(uint *)((longlong)param_1 + 0x54)) &&
      ...
      FUN_1403a4e80(param_1 + 10,uVar24,1);
    }
  }
  FUN_14041be50(local_c8,0x30,2,&LAB_140394e40,0x140397310);
  do {
    FUN_140417160(*param_1,(&DAT_140462270)[uVar19],
  ...
  uVar28 = *(uint *)((longlong)param_1 + 0x54);
  local_108 = 0;
  uVar30 = _DAT_14045ddec;
  uVar31 = (undefined4)DAT_14045ddf0;
  uVar32 = DAT_14045ddf0._4_4_;
  uVar33 = DAT_14045ddf8;
  uVar34 = (undefined4)DAT_14045dde0;
  uVar35 = DAT_14045dde0._4_4_;
  uVar36 = _DAT_14045dde8;
  iVar26 = local_f0;
  if (uVar28 != 0) {
    do {
      if (local_108 < *(uint *)((longlong)param_1 + 0x54)) {
        ...
        DAT_1404e4ff0 = CONCAT44(uVar35,uVar34);
        DAT_1404e4ff8 = CONCAT44(uVar30,uVar36);
        _DAT_1404e5000 = CONCAT44(uVar32,uVar31);
        _DAT_1404e5008 = CONCAT44(DAT_1404e500c,uVar33);
        piVar23 = (int *)&DAT_1404e4ff0;
      }
      uVar13 = piVar23[3];
...
LAB_1403b5926:
        ...
        if (uVar16 + uVar27 < 0x1f) {
          ...
          if ((local_a0 == 0) || (lVar11 = FUN_1403bf810(local_c8,piVar23), lVar11 == 0)) {
            bVar21 = 0;
          ...
          if ((local_70 == 0) || (lVar11 = FUN_1403bf810(local_98,piVar23), lVar11 == 0)) {
            plVar4 = local_res8;
            ...
            if (bVar21 == 0) {
              if ((uVar13 & 0x10) != 0) {
                ...
                bVar21 = 0;
                do {
                  bVar6 = FUN_1403d7330(*plVar4,(&DAT_140462270)[lVar11],*piVar23,
                ...
                if (bVar21 != 0) goto LAB_1403b5a2c;
              }
              iVar26 = local_f0;
              uVar27 = local_res20[0];
              if ((*(byte *)(piVar23 + 3) & 2) == 0) goto LAB_1403b5bd7;
            }
          }
          else {
            bVar21 = 1;
...
LAB_1403b5a2c:
          ...
          cVar7 = func_0x0001403a4fa0(local_res10 + 4,uVar27);
          if (cVar7 == '\0') {
            ...
            _DAT_1404e5008 = CONCAT44(_UNK_14045ddfc,DAT_14045ddf8);
            DAT_1404e5010 = DAT_14045de00;
            piVar25 = (int *)&DAT_1404e4ff0;
          }
          else {
            uVar13 = puVar22[5];
            if ((uVar13 < uVar27) && (((uVar27 - uVar13) * 9 & 0x3fffffff) != 0)) {
              func_0x000140421870(*(longlong *)(puVar22 + 6) + (ulonglong)uVar13 * 0x24,0,
                                  (uVar27 - uVar13) * 0x24);
              return;
            }
            puVar22[5] = uVar27;
...
LAB_1403b5bd7:
  ...
  if ((char)param_1[5] != '\0') {
    ...
    if (local_res10[5] != 0) {
      ...
      FUN_140369840(*(longlong *)(local_res10 + 6),*(longlong *)(local_res10 + 6) + uVar19,
                    (longlong)(uVar19 / 0x12) >> 1,&local_res8);
    }
  }
  FUN_1403a32c0(param_1,0);
  FUN_1403a32c0(param_1);
  local_res20[0] = 0;
  local_100 = 0;
  uVar30 = (undefined4)DAT_14045dde0;
  uVar31 = DAT_14045dde0._4_4_;
  uVar32 = _DAT_14045dde8;
  uVar33 = _DAT_14045ddec;
  do {
    if (*(int *)((longlong)param_1 + local_100 * 4 + 0x48) != 0) {
      ...
      do {
        if ((iVar26 != 0xffff) && (local_e8[local_100] == uVar27)) {
          FUN_1403a2e90(param_1,puVar22,local_res20[0],iVar26,
        ...
        if (puVar20 != puVar22) {
          do {
            if (puVar20[local_100 + 3] == uVar27) {
              uVar28 = puVar20[8];
              FUN_1403a2e90(param_1,puVar5,uVar13,puVar20[local_100 + 1],
        ...
        if (uVar15 < uVar13) {
          ...
          if ((int)uVar14 != 0) {
            ...
            FUN_14036a5f0(lVar11,lVar11 + uVar14 * 0xc,(longlong)((uVar14 * 0xc) / 6) >> 1,
                          &local_res8);
            uVar30 = (undefined4)DAT_14045dde0;
            uVar31 = DAT_14045dde0._4_4_;
            uVar32 = _DAT_14045dde8;
          ...
          if ((uVar15 < uVar13) &&
             (piVar23[1] = uVar15, uVar30 = (undefined4)DAT_14045dde0, uVar31 = DAT_14045dde0._4_4_,
             uVar32 = _DAT_14045dde8, uVar33 = _DAT_14045ddec, 1 < *piVar23 + 1U)) {
            FUN_1403a4d50(piVar23,uVar15,1);
            uVar30 = (undefined4)DAT_14045dde0;
            uVar31 = DAT_14045dde0._4_4_;
            uVar32 = _DAT_14045dde8;
            uVar33 = _DAT_14045ddec;
        ...
        if (uVar28 < *local_d8) {
          if (uVar28 < *(uint *)((local_100 + 6) * 0x10 + 4 + (longlong)param_1)) {
            ...
            DAT_1404e4ff0 = CONCAT44(uVar31,uVar30);
            DAT_1404e4ff8 = CONCAT44(uVar33,uVar32);
            puVar12 = (uint *)&DAT_1404e4ff0;
          }
          if (*puVar12 == uVar27) {
            ...
            cVar7 = FUN_1403a4c30(puVar22,uVar16,0);
            if (cVar7 == '\0') {
              DAT_1404e4ff0 = CONCAT44(DAT_14045dde0._4_4_,(undefined4)DAT_14045dde0);
              DAT_1404e4ff8 = CONCAT44(_DAT_14045ddec,_DAT_14045dde8);
              puVar12 = (uint *)&DAT_1404e4ff0;
              ...
              if ((uVar15 < uVar16) && ((uVar16 - uVar15 & 0xfffffff) != 0)) {
                func_0x000140421870((ulonglong)uVar15 * 0x10 + *(longlong *)(puVar22 + 2),0,
                                    (uVar16 - uVar15) * 0x10);
                return;
              }
              puVar22[1] = uVar16;
    ...
    puVar22 = local_res10;
    if (1 < local_res20[0]) {
      FUN_14041bed0(local_c8,0x30,2,0x140397310);
      return;
    }
  } while( true );
}
