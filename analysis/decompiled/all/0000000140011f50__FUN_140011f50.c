// Function: FUN_140011f50
// Addr: 140011f50
// Size: 354 bytes


void FUN_140011f50(ulonglong *param_1,ulonglong param_2,undefined8 param_3)
...
LAB_140011fe5:
    uVar6 = *param_1;
    if (param_1[2] - uVar6 == 0) goto LAB_14001202c;
    uVar4 = uVar6;
    puVar7 = auStack_28;
    ...
    if (uVar5 + 0x27 <= uVar5) goto LAB_1400120ad;
    lVar3 = FUN_14028af20();
    if (lVar3 != 0) {
...
LAB_14001201d:
  ...
  *(undefined8 *)(puVar7 + -8) = 0x14001202c;
