// Function: FUN_1400cd3c0
// Addr: 1400cd3c0
// Size: 243 bytes


void FUN_1400cd3c0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
                  longlong param_5)

{
  ...
  if (param_3 < param_2) {
    do {
      ...
      plVar3 = (longlong *)FUN_1400ca790(param_5,local_res8,puVar1);
      plVar4 = (longlong *)FUN_1400ca790(param_5,local_res10,param_4);
      if (*plVar3 == *plVar4) {
        ...
        plVar3 = (longlong *)FUN_1400ca790(param_5,local_48,param_4);
...
LAB_1400cd485:
      ...
      *(undefined4 *)(param_1 + 0xc + param_2) = puVar1[3];
      if (param_2 != lVar5) {
        ...
        FUN_140037900(plVar4,param_1 + 0x10 + lVar5);
        ...
        FUN_140037900(plVar4,param_1 + 0x50 + lVar5);
      }
      param_2 = lVar6;
    } while (local_res18 < lVar6);
  }
  FUN_1400c93f0(param_2 * 0x90 + param_1,param_4);
  return;
}
