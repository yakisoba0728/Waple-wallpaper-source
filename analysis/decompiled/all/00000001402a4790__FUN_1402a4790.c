// Function: FUN_1402a4790
// Addr: 1402a4790
// Size: 443 bytes


void FUN_1402a4790(longlong param_1,undefined8 param_2,char param_3)

{
  ...
  *(undefined8 *)(param_1 + 0x10) = uVar12;
  ...
  uVar12 = FUN_1402a7df0(*(undefined8 *)(lVar14 + lVar11));
  *(undefined8 *)(param_1 + 0x20) = uVar12;
  puVar15 = &DAT_140474538;
  if (*(byte *)(lVar11 + 0x56) < 5) {
    puVar15 = *(undefined **)(lVar11 + 0x88);
  }
  uVar12 = FUN_1402a7df0(puVar15);
  *(undefined8 *)(param_1 + 0x28) = uVar12;
  puVar16 = &DAT_14042bf68;
  if (*(byte *)(lVar11 + 0x57) < 5) {
    puVar16 = *(undefined2 **)(lVar11 + 0x90);
  }
  uVar12 = FUN_1402a7df0(puVar16);
