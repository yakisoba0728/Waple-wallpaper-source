// Function: FUN_1402366f0
// Addr: 1402366f0
// Size: 1498 bytes


void FUN_1402366f0(longlong *param_1)
  ...
  if (param_1[0x6b] != 0) {
    ...
    if (*(int *)((longlong)param_1 + 0x344) != 0) {
      ...
      if ((*(byte *)(param_1[0x6b] + 0x1fc) & 2) != 0) {
        ...
        if ((*(byte *)(lVar3 + 0x93d) & 1) == 0) {
          *(byte *)(lVar3 + 0x93d) = *(byte *)(lVar3 + 0x93d) | 1;
          plVar12 = (longlong *)
                    FUN_1401ab410(*(longlong *)(lVar3 + 200) + 0x16c0,"_rt_FullFrameBuffer");
      ...
      while (cVar1 != '\0') {
        cVar1 = *pcVar16;
        if (cVar1 == '\x01') {
          FUN_1402298b0(*param_1,pcVar16 + 4);
LAB_140236a79:
          FUN_140155fc0(*(undefined8 *)(pcVar16 + 4));
          puVar13 = (undefined8 *)param_1[0x3f];
LAB_140236a89:
          (**(code **)(*(longlong *)*puVar13 + 8))();
          FUN_140157430(*(undefined8 *)(pcVar16 + 4));
        }
        else {
          if (cVar1 == '\x02') {
            FUN_1402298b0(*param_1,pcVar16 + 4);
    ...
    for (lVar17 = param_1[0x90]; lVar17 != lVar3; lVar17 = lVar17 + 0x10) {
      ...
      *(undefined4 *)((longlong)puVar13 + 0x7c) = *(undefined4 *)((longlong)puVar13 + 0x3c);
      if ((*(byte *)(plVar12 + 4) & 1) == 0) {
        ...
        puVar14 = (undefined8 *)FUN_14005ecb0(local_78,puVar13,plVar12 + 0x74);
        uVar9 = puVar14[1];
        *puVar13 = *puVar14;
        puVar13[1] = uVar9;
        uVar9 = puVar14[3];
      ...
      for (plVar15 = *(longlong **)(lVar17 + 8); plVar15 != plVar12; plVar15 = plVar15 + 1) {
        ...
        *(undefined4 *)((longlong)puVar13 + 0x7c) = *(undefined4 *)((longlong)puVar13 + 0x3c);
        if ((*(byte *)(plVar5 + 4) & 1) == 0) {
          ...
          puVar14 = (undefined8 *)FUN_14005ecb0(local_78,puVar13,plVar5 + 0x74);
          uVar9 = puVar14[1];
          *puVar13 = *puVar14;
          puVar13[1] = uVar9;
          uVar9 = puVar14[3];
