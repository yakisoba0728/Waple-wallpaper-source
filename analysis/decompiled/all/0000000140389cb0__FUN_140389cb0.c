// Function: FUN_140389cb0
// Addr: 140389cb0
// Size: 5 bytes


undefined8
FUN_140389cb0(longlong param_1,undefined8 param_2,undefined8 param_3,undefined8 *param_4,
...

{
  ...
  if ((uint)param_3 < *(uint *)(param_1 + 0x1c)) {
    ...
    uStack_90 = param_5[2];
    uStack_8c = param_5[3];
    uStack_88 = *(undefined8 *)(param_5 + 4);
    *(undefined4 *)(param_6 + 4) = 0;
    uVar17 = FUN_1403d02e0(uStack_98,auStack_78,param_3,0);
    cVar16 = FUN_140387700(uVar17,param_2,param_1,param_6,param_6,0,0,0,1,1,piVar12 == (int *)0x0,
                           &uStack_98,param_7,0,0);
    if (cVar16 != '\0') {
            ...
            if ((*(byte *)(lVar13 + 8 + uVar19 * 0xc) & 1) == 0) {
              ...
              if (3 < uVar22 - uVar23) {
                ...
                do {
                  ...
                  *pfVar4 = fVar6;
                  uVar23 = uVar24;
                  if (cVar16 != '\0') goto code_r0x00014038a307;
                  uVar23 = uVar24 + 1;
...
code_r0x00014038a307:
        ...
        if ((fVar27 <= *(float *)((longlong)param_4 + 0x1c)) ||
          ...
          fVar26 = (float)FUN_14041a690(*(float *)((longlong)param_4 + 0x1c) + DAT_140492790);
          *piVar12 = (int)fVar26;
          fVar26 = (float)FUN_14041a690((fVar27 - (float)(int)fVar26) + fVar6);
          fVar27 = *(float *)(param_4 + 5);
          piVar12[2] = (int)fVar26;
          fVar26 = (float)FUN_14041a690(fVar27 + fVar6);
          fVar27 = *(float *)(param_4 + 4);
          piVar12[1] = (int)fVar26;
          fVar27 = (float)FUN_14041a690((fVar27 - (float)(int)fVar26) + fVar6);
          cVar16 = *(char *)(param_4 + 3);
          piVar12[3] = (int)fVar27;
          if (cVar16 != '\0') {
            func_0x00014040a1c0(*param_4,piVar12);
          }
        }
      }
