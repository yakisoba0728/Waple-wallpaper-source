// Function: FUN_14026db20
// Addr: 14026db20
// Size: 443 bytes


void FUN_14026db20(undefined8 param_1,longlong *param_2)

{
  ...
  FUN_14015ab00(param_2,DAT_1404e8ab0);
  puVar5 = DAT_1404e8aa8;
  puVar2 = (undefined8 *)*DAT_1404e8aa8;
  do {
    if (puVar2 == puVar5) {
      return;
    }
...
LAB_14026dcd1:
                    /* WARNING: Subroutine does not return */
        *(undefined **)(puVar9 + -8) = &UNK_14026dcd6;
        FUN_140017370();
      }
      uVar1 = lVar7 + 1;
      uVar6 = (uVar6 >> 1) + uVar6;
      ...
      puVar9 = auStack_48;
      if (0x1fffffffffffffff < uVar10) goto LAB_14026dcd1;
      uVar6 = uVar10 * 8;
      if (uVar6 == 0) {
        uVar6 = 0;
      }
        ...
        puVar9 = auStack_48;
        if (uVar6 + 0x27 <= uVar6) goto LAB_14026dcd1;
