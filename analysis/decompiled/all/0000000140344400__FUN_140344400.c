// Function: FUN_140344400
// Addr: 140344400
// Size: 730 bytes


int FUN_140344400(longlong param_1,undefined8 param_2)
    ...
    *(undefined4 *)(param_1 + 0x474) = 2;
       ...
       (iVar5 = (**(code **)(param_1 + 0x2a0))(param_1,0x626c6f63,param_2,local_res8), iVar5 == 0))
    {
      *(undefined4 *)(param_1 + 0x474) = 1;
      ...
      if (iVar5 != 0) goto LAB_14034474c;
      *(undefined4 *)(param_1 + 0x474) = 3;
    }
  }
  if (7 < local_res8[0]) {
    uVar6 = func_0x0001402f5570(param_2);
    iVar5 = *(int *)(param_1 + 0x474);
    if ((iVar5 == 1) || (iVar5 == 2)) {
      iVar5 = FUN_1402f5220(param_2,local_res8[0],plVar1);
      if (iVar5 != 0) goto LAB_14034474c;
...
LAB_1403446a7:
        *(undefined8 *)(param_1 + 0x4d0) = 0;
        if (*(int *)(param_1 + 0x474) == 3) {
          ...
          *(uint *)(param_1 + 0x4d4) = local_res8[0];
                ...
                (((iVar5 = (**(code **)(param_1 + 0x2a0))(param_1,0x43424454,param_2,auStackX_18),
                  iVar5 == 0 ||
                  (iVar5 = (**(code **)(param_1 + 0x2a0))(param_1,0x45424454,param_2,auStackX_18),
                  iVar5 == 0)) ||
                 (iVar5 = (**(code **)(param_1 + 0x2a0))(param_1,0x62646174,param_2,auStackX_18),
                 iVar5 == 0)))) {
          uVar6 = func_0x0001402f5570(param_2);
          *(undefined4 *)(param_1 + 0x4d0) = uVar6;
          *(undefined4 *)(param_1 + 0x4d4) = auStackX_18[0];
        }
      ...
      iVar5 = FUN_1402f50b0(param_2,8);
      if (iVar5 != 0) goto LAB_14034474c;
      sVar3 = FUN_1402f5370(param_2);
      sVar4 = FUN_1402f5370(param_2);
      uVar7 = FUN_1402f52d0(param_2);
      ...
      if (((sVar4 - 1U & 0xfffd) == 0) && (uVar7 < 0x10000)) {
        ...
        iVar5 = func_0x0001402f5570(param_2);
        iVar5 = func_0x0001402f5d20(param_2,iVar5 + -8);
        if (iVar5 == 0) {
          iVar5 = uVar7 * 4 + 8;
          *(int *)(param_1 + 0x470) = iVar5;
          iVar5 = FUN_1402f5220(param_2,iVar5,plVar1);
          if (iVar5 == 0) {
            *(uint *)(param_1 + 0x478) = uVar7;
            goto LAB_1403446a7;
          }
