// Function: FUN_140307b10
// Addr: 140307b10
// Size: 23 bytes


undefined8 FUN_140307b10(longlong param_1,uint param_2,longlong param_3)

{
  ...
  if (((*(longlong *)(param_1 + 0x408) != 0) || (uVar6 = FUN_1403074a0(param_1,0), (int)uVar6 == 0))
     && ((puVar3 = *(uint **)(param_1 + 0x408), *(longlong *)(puVar3 + 2) != 0 ||
         (uVar6 = FUN_1403140a0(param_1,0,0,1), (int)uVar6 == 0)))) {
    uVar5 = param_2;
    if (*puVar3 < param_2) {
      uVar5 = *puVar3;
    }
