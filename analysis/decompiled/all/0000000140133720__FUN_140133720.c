// Function: FUN_140133720
// Addr: 140133720
// Size: 389 bytes


void FUN_140133720(ulonglong *param_1,ulonglong param_2)
...
LAB_1401337e5:
    ...
    if (uVar6 + 0x27 <= uVar6) goto LAB_1401338a1;
    lVar2 = FUN_14028af20();
    if (lVar2 != 0) {
...
LAB_140133856:
  ...
  *(undefined8 *)(puVar7 + -8) = 0x140133865;
