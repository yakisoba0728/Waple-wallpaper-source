// Function: FUN_1400f1d10
// Addr: 1400f1d10
// Size: 178 bytes


undefined8 FUN_1400f1d10(longlong param_1,int param_2,longlong param_3,int param_4)

{
  ...
  if (param_2 == 5) {
    ...
    *(undefined1 *)(lVar1 + 0x90) = 0;
    ...
    else if ((*(char *)(lVar1 + 0x93) == '\0') && (param_3 - 3U < 2)) {
      if (*(longlong *)(lVar1 + 0xd0) != 0) {
        (*DAT_140426a98)(*(longlong *)(lVar1 + 0xd0),0x8003,3,0);
        return 0;
      }
      LOCK();
