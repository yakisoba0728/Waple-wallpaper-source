// Function: FUN_140379370
// Addr: 140379370
// Size: 626 bytes


ulonglong FUN_140379370(longlong param_1,int *param_2)

{
  ...
  if (cVar3 == '\x01') {
    ...
    if ((uVar7 < uVar8) || (cVar3 = FUN_140400c40(param_1 + 8,param_2), cVar3 == '\0')) {
      return 0;
    }
  }
  else {
    ...
    if (cVar3 == '\x03') {
      ...
      FUN_1402fc370("SANITIZE",lVar1,0,1,*param_2 + 1,0,"check_point [%p] in [%p..%p] -> %s",lVar1,
                    *(longlong *)(param_2 + 2),*(undefined8 *)(param_2 + 4),pcVar4);
      if (uVar8 <= uVar7) {
        uVar2 = (uint)*(byte *)(param_1 + 0xc) * (uint)*(byte *)(param_1 + 0xb) +
                ((uint)*(byte *)(param_1 + 9) + (uint)*(byte *)(param_1 + 8) * 0x100 +
                (uint)*(byte *)(param_1 + 10)) * 2;
