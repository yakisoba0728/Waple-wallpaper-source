// Function: FUN_14029d610
// Addr: 14029d610
// Size: 277 bytes


longlong FUN_14029d610(longlong param_1)

{
  ...
  lVar4 = DAT_1404e4248;
  local_res18 = DAT_1404e4248;
  if (DAT_1404e41b0 == 0) {
    FUN_1402914b0(&local_res8,0);
    if (DAT_1404e41b0 == 0) {
      DAT_1404e3c90 = DAT_1404e3c90 + 1;
      DAT_1404e41b0 = (ulonglong)DAT_1404e3c90;
    }
    FUN_140291550();
  }
  uVar2 = DAT_1404e41b0;
  lVar3 = *(longlong *)(param_1 + 8);
  lVar1 = DAT_1404e41b0 * 8;
  if (DAT_1404e41b0 < *(ulonglong *)(lVar3 + 0x18)) {
    lVar5 = *(longlong *)(lVar1 + *(longlong *)(lVar3 + 0x10));
    if (lVar5 != 0) goto LAB_14029d6a3;
  }
  else {
    lVar5 = 0;
  }
...
LAB_14029d6d8:
  ...
  lVar5 = lVar4;
  if (lVar4 == 0) {
    lVar4 = FUN_14029fb90(&local_res18,param_1);
    lVar5 = local_res18;
    if (lVar4 == -1) {
