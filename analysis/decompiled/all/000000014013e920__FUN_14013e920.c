...
LPSTR ****** FUN_14013e920(longlong param_1,LPSTR ******param_2)

{
  ...
  *(undefined1 *)param_2 = 0;
  (**(code **)(**(longlong **)(param_1 + 0x20) + 0x40))
            (*(longlong **)(param_1 + 0x20),0,&local_res18);
  if (local_res18 == (longlong *)0x0) {
    return param_2;
  }
  local_res8[0] = 0;
  (**(code **)(*local_res18 + 0x18))(local_res18,local_res8);
  if (local_res8[0] == 0) goto LAB_14013eef7;
  local_f8 = (longlong *)0x0;
  (**(code **)(*local_res18 + 0x20))(local_res18,0,&DAT_14048ae10,&local_f8);
  plVar5 = local_f8;
  if (local_f8 == (longlong *)0x0) goto LAB_14013eef7;
  local_b8 = (LPSTR *****)0x0;
  uStack_c0 = 0;
...
LAB_14013ec99:
    ...
    if ((LPSTR *******)param_2 != &local_c8) {
      ...
      if (ppppppCVar20 < ppppppCVar15) {
        ...
        if ((LPSTR *****)0x7fffffffffffffff < ppppppCVar15) goto LAB_14013ef24;
...
LAB_14013edf9:
          ...
          if (pppppCVar9 == (LPSTR ****)0x0) goto LAB_14013ef1d;
...
LAB_14013ef24:
                    /* WARNING: Subroutine does not return */
  *(undefined **)(puVar18 + -8) = &UNK_14013ef29;
  FUN_1400172e0();
}
