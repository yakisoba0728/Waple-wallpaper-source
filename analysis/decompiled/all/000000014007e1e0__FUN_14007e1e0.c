// Function: FUN_14007e1e0
// Addr: 14007e1e0
// Size: 683 bytes


void FUN_14007e1e0(longlong param_1,ulonglong param_2)

{
  ...
  FUN_14003e510(param_1 + 0x18,2L << (bVar11 & 0x3f),plVar2);
  *(longlong *)(param_1 + 0x38) = lVar14;
  *(longlong *)(param_1 + 0x30) = lVar14 + -1;
  plVar6 = (longlong *)**(undefined8 **)(param_1 + 8);
joined_r0x00014007e262:
  do {
    while( true ) {
      if (plVar6 == plVar2) {
        local_res10 = 0;
        FUN_14007eba0(&local_res10);
        return;
      }
      uVar16 = plVar6[5];
      plVar10 = plVar6 + 2;
