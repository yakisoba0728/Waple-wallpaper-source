// Function: FUN_1402baf60
// Addr: 1402baf60
// Size: 82 bytes


undefined8 * FUN_1402baf60(undefined8 *param_1,int *param_2,int param_3)

{
  ...
  iVar11 = 0;
  local_38 = param_2;
  FUN_1402bb390(param_2,&local_38);
  if (*param_2 != 0) {
    uVar10 = param_2[6];
    iVar9 = 0;
    ...
    do {
      ...
      iVar7 = iVar4;
      iVar9 = iVar9 + 1;
      lVar8 = (longlong)(char)(&DAT_14042c488)[*pbVar12 & 0xf];
      bVar1 = (&DAT_14042c498)[*pbVar12 & 0xf];
      pbVar5 = pbVar12 + -lVar8;
      uVar10 = *(uint *)(pbVar5 + -4);
      *(byte **)(param_2 + 2) = pbVar5;
      uVar10 = uVar10 >> (bVar1 & 0x1f);
      param_2[6] = uVar10;
      cVar2 = (&DAT_14042c488)[*pbVar5 & 0xf];
      bVar1 = (&DAT_14042c498)[*pbVar5 & 0xf];
      pbVar5 = pbVar12 + (-lVar8 - (longlong)cVar2);
      uVar3 = *(uint *)(pbVar5 + -4);
      *(byte **)(param_2 + 2) = pbVar5;
      param_2[7] = uVar3 >> (bVar1 & 0x1f);
      bVar1 = (&DAT_14042c498)[*pbVar5 & 0xf];
      pbVar12 = pbVar12 + ((-(longlong)cVar2 - (longlong)(char)(&DAT_14042c488)[*pbVar5 & 0xf]) -
                          lVar8);
