// Function: FUN_1403c6120
// Addr: 1403c6120
// Size: 561 bytes


void FUN_1403c6120(longlong param_1,longlong param_2,ulonglong param_3,float *param_4,float *param_5
                  )
...
LAB_1403c6364:
    *param_4 = (float)(int)(short)((ushort)*(byte *)(param_1 + 2) * 0x100 +
    ...
    if (iVar6 == 0) goto LAB_1403c6361;
    if (*(float *)(lVar3 + 0x4c) != 0.0) {
      fVar9 = (float)FUN_14041a690((float)local_44 * *(float *)(lVar3 + 0x4c) + DAT_140492790);
    ...
    if (iVar6 == 0) {
      ...
      if (iVar6 != 0) {
        ...
        FUN_1403d06a0(lVar3,param_3 & 0xffffffff,&local_40,&local_3c);
