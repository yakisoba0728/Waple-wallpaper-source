// Function: FUN_140331180
// Addr: 140331180
// Size: 323 bytes


int FUN_140331180(longlong param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  *(undefined4 *)(param_1 + 0x58) = 3;
  ...
  if (*(uint *)(lVar4 + 0xc) < *(ushort *)(lVar4 + 0x60) + 1 + (uint)*(ushort *)(lVar4 + 0x18)) {
    iVar7 = FUN_1402f0870(lVar4,0,1);
    if (iVar7 == 0) goto LAB_140331212;
  }
  else {
    iVar7 = 0;
LAB_140331212:
...
LAB_140331234:
  ...
  if ((*(ushort *)(lVar4 + 0x62) + 1 + (uint)*(ushort *)(lVar4 + 0x1a) <= *(uint *)(lVar4 + 8)) ||
     (iVar6 = FUN_1402f0870(lVar4,1,0), iVar6 == 0)) {
    ...
    if (*(char *)(param_1 + 0x5c) != '\0') {
      ...
      iVar7 = FUN_1402f4b60(param_2);
      *piVar1 = iVar7 >> 0x10;
      iVar7 = FUN_1402f4b60(param_3);
      piVar1[1] = iVar7 >> 0x10;
