// Function: FUN_14003e510
// Addr: 14003e510
// Size: 309 bytes


void FUN_14003e510(ulonglong *param_1,ulonglong param_2,undefined8 param_3)
...
LAB_14003e5a7:
    uVar3 = *param_1;
    if (param_1[2] - uVar3 == 0) goto LAB_14003e5ee;
    uVar6 = uVar3;
    puVar7 = auStack_28;
    ...
    if (uVar2 + 0x27 <= uVar2) goto LAB_14003e640;
    lVar5 = FUN_14028af20();
    if (lVar5 != 0) {
...
LAB_14003e5df:
  ...
  *(undefined8 *)(puVar7 + -8) = 0x14003e5ee;
