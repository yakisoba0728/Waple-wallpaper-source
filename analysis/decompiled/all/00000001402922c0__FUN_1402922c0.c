// Function: FUN_1402922c0
// Addr: 1402922c0
// Size: 309 bytes


ulonglong FUN_1402922c0(uint param_1,undefined4 *param_2)

{
  ...
  if (param_1 < 0x100) {
    if (param_2 != (undefined4 *)0x0) {
      if ((*(byte *)(*(longlong *)(param_2 + 2) + uVar7 * 2) & 2) == 0) goto LAB_140292304;
      goto LAB_14029233a;
    }
    iVar3 = islower(param_1);
    if (iVar3 == 0) goto LAB_140292304;
LAB_140292373:
    lVar5 = FUN_1402d6668();
    uVar6 = *(ushort *)(lVar5 + (ulonglong)((int)param_1 >> 8 & 0xff) * 2) & 0x8000;
  }
  else {
    if (param_2 == (undefined4 *)0x0) goto LAB_140292373;
LAB_14029233a:
  ...
  iVar3 = FUN_1402945f0(pwVar8,0x200,&local_res10,uVar9,&local_res18,3,uVar1,1);
  if (iVar3 != 0) {
