// Function: FUN_1400add60
// Addr: 1400add60
// Size: 304 bytes


char * FUN_1400add60(int *param_1,undefined8 param_2,longlong param_3)

{
  ...
  param_1[1] = 0;
  if ((param_1[0x32] == 0) || (param_1[0x32] == 1)) {
    pcVar1 = (char *)FUN_1400ade90(param_1);
    ...
    if (*pcVar1 != '$') goto LAB_1400ade7a;
    iVar2 = 1;
    param_1[0x32] = 1;
    if (*pcVar1 != '$') goto LAB_1400ade70;
  }
  else {
    param_1[0x32] = 0;
    pcVar1 = (char *)0x0;
