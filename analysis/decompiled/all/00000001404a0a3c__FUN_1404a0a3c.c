...
void FUN_1404a0a3c(char *param_1,uint *param_2)

{
  ...
  *(char *)puVar3 = (char)*puVar3 + (char)uVar2;
  ...
  uVar2 = uVar2 + *puVar3 + *(int *)(ulonglong)(uVar2 + *puVar3);
  puVar3 = (uint *)(ulonglong)uVar2;
  *param_2 = *param_2 | (uint)param_1;
  *puVar3 = *puVar3 & uVar2;
  ...
  *(char *)(unaff_RDI + uVar4) = *(char *)(unaff_RDI + uVar4) + (char)((ulonglong)param_2 >> 8);
  pcVar1 = (char *)((longlong)unaff_retaddr + uVar4 + 4);
