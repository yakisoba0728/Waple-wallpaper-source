// Function: FUN_14013c240
// Addr: 14013c240
// Size: 494 bytes


void FUN_14013c240(longlong param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  if (iVar4 < 0) {
UNWIND_INFO_14013c3f9_UnwindCodes_16__OffsetInProlog:
    if (local_48 < 8) {
      return;
    }
    uVar11 = local_48 * 2 + 2;
...
code_r0x00014013c45a:
    ...
    if ((ulonglong)((longlong)local_60[0] + (-8 - (longlong)pppppppuVar10)) < 0x20) {
      ...
      goto code_r0x00014013c45a;
    }
  }
  else {
    local_res20 = (longlong *)0x0;
    iVar4 = (**(code **)(**(longlong **)(param_1 + 0x20) + 0x68))
                      (*(longlong **)(param_1 + 0x20),local_80,&local_res20);
    if (iVar4 < 0) goto UNWIND_INFO_14013c3f9_UnwindCodes_16__OffsetInProlog;
    ...
    if (uVar5 == 0) {
      ...
      if (puVar7 == (undefined4 *)0x0) goto LAB_14013c484;
      puVar1 = puVar7 + 7;
      *puVar7 = 0;
    ...
    if (local_28 < 8) {
      ...
      goto UNWIND_INFO_14013c3f9_UnwindCodes_16__OffsetInProlog;
    }
    uVar11 = local_28 * 2 + 2;
    lVar9 = local_40[0];
    if (uVar11 < 0x1000) {
LAB_14013c3bc:
  ...
  puVar12 = auStack_a0;
LAB_14013c484:
  *(undefined8 *)(puVar12 + -8) = 0x14013c48e;
  FUN_1401414f0(puVar12 + 0x38);
  *(undefined **)(puVar12 + -8) = &UNK_14013c49f;
