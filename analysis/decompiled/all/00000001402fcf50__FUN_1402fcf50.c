// Function: FUN_1402fcf50
// Addr: 1402fcf50
// Size: 1 bytes


uint FUN_1402fcf50(longlong param_1,int param_2,uint param_3)
...
code_r0x0001402fd0e1:
    ...
    if ((uVar2 & 8) == 0) {
      ...
      uVar2 = uVar7 + 0x16;
      if ((int)uVar7 < 0x80) goto code_r0x0001402fd107;
    }
    else if ((int)uVar7 < 0x40) goto code_r0x0001402fd0e1;
    uVar2 = uVar7 + 0x20;
  }
code_r0x0001402fd107:
  uVar2 = uVar2 & 0xffffffc0;
code_r0x0001402fd10a:
  uVar4 = -uVar2;
  if (-1 < (int)param_3) {
    uVar4 = uVar2;
  }
