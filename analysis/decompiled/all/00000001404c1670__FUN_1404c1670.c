...
void FUN_1404c1670(uint *param_1,char *param_2,char param_3,char param_4)

{
  ...
  *(char *)((longlong)in_RAX + -0x4a) = *(char *)((longlong)in_RAX + -0x4a) + bVar7;
  pcVar6 = (char *)(CONCAT71((uint7)(uint3)((uint)((int)in_RAX - *in_RAX) >> 8),0x15) + -0x47);
