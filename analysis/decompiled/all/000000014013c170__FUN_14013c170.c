// Function: FUN_14013c170
// Addr: 14013c170
// Size: 646 bytes


void FUN_14013c170(longlong param_1)
...
LAB_14013c38a:
    ...
    if (uVar5 == 0) {
      ...
      if (puVar7 == (undefined4 *)0x0) goto LAB_14013c3b4;
      puVar8 = puVar7 + 7;
      *puVar7 = 0;
...
LAB_14013c2ec:
  ...
  puVar13 = auStack_a0;
LAB_14013c3b4:
  *(undefined8 *)(puVar13 + -8) = 0x14013c3be;
  FUN_140141420(puVar13 + 0x38);
                    /* WARNING: Subroutine does not return */
  *(undefined **)(puVar13 + -8) = &UNK_14013c3cf;
