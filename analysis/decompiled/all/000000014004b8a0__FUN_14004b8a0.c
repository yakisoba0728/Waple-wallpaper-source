// Function: FUN_14004b8a0
// Addr: 14004b8a0
// Size: 643 bytes


undefined8 * FUN_14004b8a0(float *param_1,undefined8 *param_2,byte *param_3)

{
  ...
  puVar5 = (undefined8 *)FUN_14028af20(0x20);
  ...
  *puVar3 = puVar5;
  ...
  if (puVar4 == *(undefined8 **)(param_1 + 2)) {
    *(undefined8 **)(lVar6 + uVar10 * 0x10) = puVar5;
    ...
    if (*(undefined8 **)(lVar6 + 8 + uVar10 * 0x10) != puVar3) goto LAB_14004bb05;
  }
