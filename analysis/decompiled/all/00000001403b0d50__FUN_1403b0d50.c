// Function: FUN_1403b0d50
// Addr: 1403b0d50
// Size: 228 bytes


bool FUN_1403b0d50(byte *param_1,longlong param_2,longlong param_3,byte *param_4,int *param_5)

{
  ...
  if ((uVar14 & 0x10) != 0) {
    if (bVar5) {
      ...
      cVar7 = func_0x0001404094a0(param_4,lVar1);
      if (cVar7 == '\0') {
code_r0x0001403b0f7d:
        puVar12 = &DAT_14045dde0;
      }
      else {
        bVar13 = param_4[1];
        uVar11 = (uint)*param_4 * 0x100 + (uint)bVar13;
        if (uVar11 != 0) {
          cVar7 = func_0x0001404035d0((ulonglong)uVar11 + param_3,lVar1);
          if (cVar7 == '\0') goto code_r0x0001403b0f7d;
          bVar13 = param_4[1];
        }
        uVar11 = (uint)bVar13 + (uint)*param_4 * 0x100;
        if (uVar11 == 0) goto code_r0x0001403b0f7d;
        puVar12 = (undefined8 *)((ulonglong)uVar11 + param_3);
      }
      iVar9 = FUN_1403d0180(puVar12,lVar2,uVar3,uVar4);
      param_5[2] = param_5[2] + iVar9;
    }
    param_4 = param_4 + 2;
  }
  if ((uVar14 & 0x20) == 0) goto code_r0x0001403b102c;
  if (bVar6) {
    bVar17 = (bool)(bVar17 | (ushort)((ushort)*param_4 * 0x100 + (ushort)param_4[1]) != 0);
    cVar7 = func_0x0001404094a0(param_4,lVar1,param_3);
    if (cVar7 == '\0') {
code_r0x0001403b100e:
      puVar12 = &DAT_14045dde0;
    }
    else {
      bVar13 = param_4[1];
      ...
      if (uVar11 != 0) {
        cVar7 = func_0x0001404035d0((ulonglong)uVar11 + param_3,lVar1);
        if (cVar7 == '\0') goto code_r0x0001403b100e;
        bVar13 = param_4[1];
      }
      uVar11 = (uint)bVar13 + (uint)*param_4 * 0x100;
      if (uVar11 == 0) goto code_r0x0001403b100e;
      puVar12 = (undefined8 *)((ulonglong)uVar11 + param_3);
    }
    iVar9 = FUN_1403d0230(puVar12,lVar2,uVar3,uVar4);
    param_5[3] = param_5[3] + iVar9;
  }
  param_4 = param_4 + 2;
code_r0x0001403b102c:
  if ((uVar14 & 0x40) != 0) {
    if ((uVar16 == 4) && (bVar5)) {
      bVar17 = (bool)(bVar17 | (ushort)((ushort)*param_4 * 0x100 + (ushort)param_4[1]) != 0);
      cVar7 = func_0x0001404094a0(param_4,lVar1,param_3);
      if ((cVar7 == '\0') ||
         (((uVar11 = (uint)*param_4 * 0x100 + (uint)param_4[1], uVar11 != 0 &&
           (cVar7 = func_0x0001404035d0((ulonglong)uVar11 + param_3,lVar1), cVar7 == '\0')) ||
          (uVar11 = (uint)*param_4 * 0x100 + (uint)param_4[1], uVar11 == 0)))) {
        puVar12 = &DAT_14045dde0;
      }
      else {
      ...
      iVar9 = *param_5;
      iVar10 = FUN_1403d0180(puVar12,lVar2,uVar3,uVar4);
  ...
  if ((((char)uVar14 < '\0') && (uVar16 != 4)) && (bVar6)) {
    bVar17 = (bool)(bVar17 | (ushort)((ushort)*param_4 * 0x100 + (ushort)param_4[1]) != 0);
    cVar7 = func_0x0001404094a0(param_4,param_2 + 0xa8,param_3);
    if (((cVar7 != '\0') &&
        ((uVar14 = (uint)*param_4 * 0x100 + (uint)param_4[1], uVar14 == 0 ||
         (cVar7 = func_0x0001404035d0((ulonglong)uVar14 + param_3,param_2 + 0xa8), cVar7 != '\0'))))
       && (uVar14 = (uint)*param_4 * 0x100 + (uint)param_4[1], uVar14 != 0)) {
      puVar15 = (undefined8 *)((ulonglong)uVar14 + param_3);
    }
    iVar9 = FUN_1403d0230(puVar15,lVar2,uVar3,uVar4);
