...
LPSTR ****** FUN_14013fec0(longlong param_1,LPSTR ******param_2)

{
  ...
  *(undefined1 *)param_2 = 0;
  ...
  if (local_res8[0] == 0) goto LAB_140140497;
  local_f8 = (longlong *)0x0;
  (**(code **)(*local_res18 + 0x20))(local_res18,0,&DAT_14048ae10,&local_f8);
  plVar5 = local_f8;
  if (local_f8 == (longlong *)0x0) goto LAB_140140497;
  local_b8 = (LPSTR *****)0x0;
  uStack_c0 = 0;
...
LAB_140140239:
    ...
    if ((LPSTR *******)param_2 != &local_c8) {
      ...
      if (ppppppCVar20 < ppppppCVar15) {
        ...
        if ((LPSTR *****)0x7fffffffffffffff < ppppppCVar15) goto LAB_1401404c4;
...
LAB_140140399:
          ...
          if (pppppCVar9 == (LPSTR ****)0x0) goto LAB_1401404bd;
...
LAB_1401404c4:
                    /* WARNING: Subroutine does not return */
  *(undefined **)(puVar18 + -8) = &UNK_1401404c9;
  FUN_1400172e0();
}
