// Function: FUN_140038ce0
// Addr: 140038ce0
// Size: 439 bytes


ulonglong *
FUN_140038ce0(ulonglong *param_1,ulonglong param_2,undefined8 param_3,longlong param_4,
...
LAB_140038dae:
    ...
    lVar7 = (uVar4 - param_4) + 1;
    if (uVar5 < 0x10) {
      FUN_1404210f0(unaff_RDI,param_1,param_4);
      FUN_1404217a0(lVar3,(int)param_6,param_5);
      FUN_1404210f0(lVar3 + param_5,(longlong)param_1 + param_4,lVar7);
      goto LAB_140038e68;
    }
    uVar9 = *param_1;
    FUN_1404210f0(unaff_RDI,uVar9,param_4);
    FUN_1404217a0(lVar3,(int)param_6,param_5);
    FUN_1404210f0(lVar3 + param_5,uVar9 + param_4,lVar7);
    if (0xfff < uVar5 + 1) {
...
LAB_140038e31:
  ...
  *(undefined8 *)(puVar10 + -8) = 0x140038e40;
