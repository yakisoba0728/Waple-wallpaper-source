// Function: FUN_1403b2f70
// Addr: 1403b2f70
// Size: 517 bytes


undefined8 FUN_1403b2f70(longlong param_1)

{
  ...
  *(undefined1 *)(param_1 + 0x30) = uVar4;
  ...
  fVar10 = (float)FUN_14041a5c0((float)iVar5 * *(float *)(param_1 + 0x34) + DAT_1404926c0);
  *(int *)(param_1 + 0x40) = (int)fVar10;
  iVar5 = -iVar2;
  if (-iVar2 < 0) {
    iVar5 = iVar2;
  }
  fVar10 = (float)FUN_14041a5c0((float)iVar5 * *(float *)(param_1 + 0x38) + DAT_1404926c0);
  ...
  *(float *)(param_1 + 0x4c) = fVar10;
  if ((*(undefined8 **)(param_1 + 0xb0) != (undefined8 *)0x0) &&
     (*(undefined8 **)(param_1 + 0xb0) != &DAT_14045dd10)) {
    thunk_FUN_1402d9040();
  }
