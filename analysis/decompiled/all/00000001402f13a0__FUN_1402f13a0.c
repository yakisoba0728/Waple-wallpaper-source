// Function: FUN_1402f13a0
// Addr: 1402f13a0
// Size: 1812 bytes


ulonglong FUN_1402f13a0(longlong param_1,undefined4 param_2,uint param_3)

{
  ...
  *(undefined8 *)(lVar6 + 0xdc) = 0;
  ...
  if (((plVar8 == (longlong *)0x0) || ((uVar11 & 0x8002) != 0)) ||
     ((*(uint *)(param_1 + 8) & 0x2001) != 1)) goto LAB_1402f1591;
  if ((uVar11 >> 0xb & 1) == 0) {
    iVar14 = **(int **)(param_1 + 0xd0);
    if ((*(int **)(param_1 + 0xd0))[2] == 0) {
      if (iVar14 != 0) goto LAB_1402f16a1;
    }
    else if (iVar14 == 0) goto LAB_1402f16a1;
LAB_1402f1591:
...
LAB_1402f16a1:
    if (((uVar11 & 0x20) == 0) && ((*(uint *)*puVar7 & 0x400) != 0)) {
      ...
      lVar20 = FUN_1402bbc10(uVar31,"Type 1");
  ...
  *(undefined4 *)(lVar6 + 0x5c) = uVar15;
  ...
  if ((uVar11 >> 0xb & 1) != 0) goto UNWIND_INFO_1402f1ab7_UnwindCodes_18__OffsetInProlog;
  piVar10 = *(int **)(param_1 + 0xd0);
  if (piVar10[6] == 0) goto UNWIND_INFO_1402f1ab7_UnwindCodes_18__OffsetInProlog;
  ...
  if ((uVar29 == 0) || (*(int *)(uVar29 + 0x20) != *(int *)(lVar6 + 0x60))) {
    ...
    if (uVar29 != 0) goto LAB_1402f199f;
    if (*(int *)(lVar6 + 0x60) == 0x6f75746c) {
...
LAB_1402f199f:
  ...
  FUN_1402f6100(lVar6 + 0x58,piVar10);
UNWIND_INFO_1402f1ab7_UnwindCodes_18__OffsetInProlog:
  ...
  *(uint *)(*(longlong *)(lVar6 + 0xf0) + 0x30) = uVar11;
  if ((((int)uVar31 == 0) && ((uVar11 & 1) == 0)) &&
    ...
    if ((uVar11 & 4) == 0) {
      func_0x0001402f72d0(lVar6,uVar13,0);
    }
    else if (*(longlong *)(lVar6 + 8) == 0) {
      uVar31 = 6;
    }
    else {
      uVar13 = FUN_1402f4400(*(undefined8 *)(*(longlong *)(*(longlong *)(lVar6 + 8) + 0x90) + 8),
                             lVar6,uVar13);
      uVar31 = (ulonglong)uVar13;
    }
  }
