// Function: FUN_14029cf60
// Addr: 14029cf60
// Size: 546 bytes


ulonglong *
FUN_14029cf60(ulonglong *param_1,ulonglong param_2,undefined8 param_3,undefined2 param_4)

{
  ...
  if ((uVar6 < 0x7fffffffffffffff) && (uVar11 <= 0x7ffffffffffffffe - (uVar11 >> 1))) {
    ...
    if (0x7fffffffffffffff < uVar9 + 1) goto LAB_14029d17e;
    uVar6 = (uVar9 + 1) * 2;
    if (uVar6 != 0) goto LAB_14029cffb;
    unaff_RSI = 0;
LAB_14029d038:
    ...
    param_1[3] = uVar9;
    if (uVar11 < 8) {
      FUN_1404210f0(unaff_RSI,param_1,lVar5);
      *(undefined2 *)(lVar5 + unaff_RSI) = param_4;
      *(undefined2 *)(lVar5 + 2 + unaff_RSI) = 0;
      goto LAB_14029d103;
    }
    uVar9 = *param_1;
    FUN_1404210f0(unaff_RSI,uVar9,lVar5);
    *(undefined2 *)(lVar5 + unaff_RSI) = param_4;
    *(undefined2 *)(lVar5 + 2 + unaff_RSI) = 0;
    puVar8 = auStack_38;
    if (0xfff < uVar11 * 2 + 2) {
...
LAB_14029d0dd:
  ...
  *(undefined8 *)(puVar8 + -8) = 0x14029d0ec;
...
LAB_14029d103:
  *param_1 = unaff_RSI;
  ...
  if ((7 < uVar12) && (DAT_140472230 != '\0')) {
    ...
    *(undefined8 *)(puVar8 + -8) = 0x14029d157;
