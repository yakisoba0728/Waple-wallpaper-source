// Function: FUN_14015c550
// Addr: 14015c550
// Size: 279 bytes


void FUN_14015c550(int param_1,byte *param_2,longlong param_3,longlong param_4,int param_5)
  ...
  if ((*param_2 & 1) == 0) {
    ...
    case 0:
      if (*(int *)(param_2 + 0x20) != 0) {
        ...
        FUN_1404211c0((ulonglong)
                      (uint)((*(int *)(param_2 + 0x18) * param_5 + *(int *)(param_2 + 0x14)) * 4) +
                      param_4,param_3,*(int *)(param_2 + 0x1c) * 4);
      }
      break;
    case 4:
    case 6:
    ...
    case 7:
      if (*(int *)(param_2 + 0x20) != 0) {
        ...
        FUN_1404211c0((ulonglong)
                      ((uint)(*(int *)(param_2 + 0x18) * param_5 + *(int *)(param_2 + 0x14) * 4) >>
                      1) + param_4,param_3,*(int *)(param_2 + 0x1c) * 2);
      }
      break;
    case 8:
      if (*(int *)(param_2 + 0x20) != 0) {
                    /* WARNING: Subroutine does not return */
        FUN_1404211c0((ulonglong)
                      (uint)((*(int *)(param_2 + 0x18) * param_5 + *(int *)(param_2 + 0x14)) * 2) +
                      param_4,param_3,*(int *)(param_2 + 0x1c) * 2);
      }
      break;
    case 9:
      if (*(int *)(param_2 + 0x20) != 0) {
                    /* WARNING: Subroutine does not return */
        FUN_1404211c0((ulonglong)
                      (uint)(*(int *)(param_2 + 0x18) * param_5 + *(int *)(param_2 + 0x14)) +
                      param_4,param_3,*(undefined4 *)(param_2 + 0x1c));
      }
    }
  }
