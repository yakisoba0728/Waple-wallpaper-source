// Function: FUN_1403a06a0
// Addr: 1403a06a0
// Size: 4372 bytes


void FUN_1403a06a0(undefined8 param_1,longlong param_2)
...
LAB_1403a0fd8:
              ...
              cVar11 = func_0x0001403bf270(param_2,*(int *)(param_2 + 100) + 1);
              if (cVar11 != '\0') {
            ...
            if (bVar16) {
              cVar11 = func_0x0001403eb040(param_2,0,1);
              if (cVar11 != '\0') {
                uVar12 = (ulonglong)*(uint *)(param_2 + 0x5c);
              ...
              *puVar3 = *puVar3 & 0xff7f;
              if (*(char *)(param_2 + 0x59) != '\0') {
                if ((*(longlong *)(param_2 + 0x78) != *(longlong *)(param_2 + 0x70)) ||
                  ...
                  cVar11 = func_0x0001403bf270(param_2,*(int *)(param_2 + 100) + 1);
                  if (cVar11 == '\0') goto LAB_1403a10cb;
                  uVar5 = *(uint *)(param_2 + 0x5c);
                  lVar13 = *(longlong *)(param_2 + 0x70);
                  uVar6 = *(uint *)(param_2 + 100);
                  puVar1 = (undefined4 *)(lVar13 + (ulonglong)uVar5 * 0x14);
          ...
          if (1 < uVar4) {
            ...
            do {
              ...
              if (iVar14 == 0xa05) {
                ...
                if ((iVar14 == 0xa3e) || (iVar14 == 0xa48)) goto LAB_1403a0bb8;
                bVar17 = iVar14 == 0xa4c;
LAB_1403a0bb6:
                if (bVar17) goto LAB_1403a0bb8;
              }
              else {
                if (iVar14 == 0xa72) {
                  iVar14 = *(int *)(lVar13 + (ulonglong)(iVar15 + 1) * 0x14);
                  ...
                  if (iVar14 != 0xa73) goto LAB_1403a0bbb;
                  iVar14 = *(int *)(lVar13 + (ulonglong)(iVar15 + 1) * 0x14);
          ...
          if (1 < uVar4) {
            ...
            do {
              ...
              if (iVar14 == 0x905) {
                ...
                case 0x956:
                case 0x957:
switchD_1403a0977_caseD_93a:
                  FUN_1403ed0a0(param_2);
                  break;
                default:
                  goto switchD_1403a0977_caseD_93c;
                }
LAB_1403a08d9:
                FUN_1403ed5a0(param_2,0x25cc);
                uVar12 = (ulonglong)(*(int *)(param_2 + 100) - 1);
...
LAB_1403a0939:
                  ...
                  if (((iVar14 == 0x930) &&
                    ...
                    FUN_1403ed0a0(param_2);
                    goto switchD_1403a0977_caseD_93a;
                  }
                }
switchD_1403a0977_caseD_93c:
                FUN_1403ed0a0(param_2);
                if (bVar16) goto LAB_1403a08d9;
              }
              uVar12 = (ulonglong)*(uint *)(param_2 + 0x5c);
            } while (*(uint *)(param_2 + 0x5c) + 1 < uVar4);
          }
          ...
          do {
            ...
            if (iVar14 == 0xa85) {
              ...
              case 0xacc:
                ...
                break;
              default:
                goto switchD_1403a0801_caseD_abf;
              }
LAB_1403a079c:
              FUN_1403ed5a0(param_2,0x25cc);
              uVar12 = (ulonglong)(*(int *)(param_2 + 100) - 1);
...
switchD_1403a0801_caseD_abf:
              FUN_1403ed0a0(param_2);
              if (bVar16) goto LAB_1403a079c;
            }
            uVar12 = (ulonglong)*(uint *)(param_2 + 0x5c);
          } while (*(uint *)(param_2 + 0x5c) + 1 < uVar4);
        }
...
LAB_1403a0d10:
            ...
            if ((iVar14 != 0xd12) ||
               ((iVar14 = *(int *)(lVar13 + (ulonglong)(iVar15 + 1) * 0x14), iVar14 != 0xd3e &&
                (iVar14 != 0xd57)))) goto LAB_1403a0d10;
            FUN_1403ed0a0(param_2);
LAB_1403a0d1d:
            FUN_1403ed5a0(param_2,0x25cc);
            uVar12 = (ulonglong)(*(int *)(param_2 + 100) - 1);
        ...
        do {
          ...
          case 0xd91:
            ...
            case 0xdde:
              ...
              break;
            default:
              goto switchD_1403a115f_caseD_d86;
            }
            goto LAB_1403a11a3;
          }
switchD_1403a115f_caseD_d86:
          FUN_1403ed0a0(param_2);
          if (bVar16) {
LAB_1403a11a3:
            FUN_1403ed5a0(param_2,0x25cc);
      ...
      if (1 < uVar4) {
        ...
        do {
          ...
          if (*(char *)(param_2 + 0x59) == '\0') {
UNWIND_INFO_1403a175d_UnwindCodes_4__OffsetInProlog:
            *(int *)(param_2 + 0x5c) = iVar14 + 1;
          }
          else {
            if ((*(longlong *)(param_2 + 0x78) == lVar13) && (*(int *)(param_2 + 100) == iVar14)) {
UNWIND_INFO_1403a175d_UnwindCodes_2__UnwindOpCode:
              *(int *)(param_2 + 100) = *(int *)(param_2 + 100) + 1;
              goto UNWIND_INFO_1403a175d_UnwindCodes_4__OffsetInProlog;
            }
            cVar11 = func_0x0001403bf270(param_2,*(int *)(param_2 + 100) + 1);
            if (cVar11 != '\0') {
              lVar13 = *(longlong *)(param_2 + 0x70);
              ...
              *(undefined4 *)(lVar7 + (ulonglong)uVar6 * 0x14 + 0x10) =
              ...
              goto UNWIND_INFO_1403a175d_UnwindCodes_2__UnwindOpCode;
            }
          }
          if (bVar16) {
            cVar11 = func_0x0001403eb040(param_2,0,1);
...
LAB_1403a155c:
          ...
          if ((iVar14 != 0x114aa) ||
             ((iVar14 = *(int *)(lVar13 + (ulonglong)(iVar15 + 1) * 0x14), iVar14 != 0x114b5 &&
              (iVar14 != 0x114b6)))) goto LAB_1403a155c;
          FUN_1403ed0a0(param_2);
LAB_1403a1569:
          FUN_1403ed5a0(param_2,0x25cc);
          uVar12 = (ulonglong)(*(int *)(param_2 + 100) - 1);
    ...
    if ((*(char *)(param_2 + 0x58) != '\0') &&
       (cVar11 = func_0x0001403ed130(param_2,*(int *)(param_2 + 0x60) - *(int *)(param_2 + 0x5c)),
       cVar11 != '\0')) {
      if (*(longlong *)(param_2 + 0x78) != *(longlong *)(param_2 + 0x70)) {
