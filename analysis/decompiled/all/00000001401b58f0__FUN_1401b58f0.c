// Function: FUN_1401b58f0
// Addr: 1401b58f0
// Size: 642 bytes


undefined8 * FUN_1401b58f0(float *param_1,undefined8 *param_2,byte *param_3)

{
  ...
  puVar5 = (undefined8 *)FUN_14028af20(0x28);
  ...
  *puVar3 = puVar5;
  ...
  if (puVar4 == *(undefined8 **)(param_1 + 2)) {
    *(undefined8 **)(lVar6 + uVar10 * 0x10) = puVar5;
    ...
    if (*(undefined8 **)(lVar6 + 8 + uVar10 * 0x10) != puVar3) goto LAB_1401b5b54;
  }
