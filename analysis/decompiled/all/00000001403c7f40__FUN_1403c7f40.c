// Function: FUN_1403c7f40
// Addr: 1403c7f40
// Size: 336 bytes


ulonglong FUN_1403c7f40(undefined8 *param_1,undefined8 param_2,uint param_3,int *param_4,
                       char param_5)

{
  ...
  puVar2 = (undefined1 *)FUN_1403b33a0(puVar5);
  puVar10 = &DAT_14045dde0;
  puVar5 = &DAT_14045dde0;
  if (puVar6 != (undefined8 *)0x0) {
    puVar5 = puVar6;
  ...
  pbVar3 = (byte *)FUN_1403c28a0(lVar12,param_3,
  ...
  if (((pbVar3 != (byte *)0x0) && (puVar2[0x2c] != '\0')) && (puVar2[0x2d] != '\0')) {
    ...
    if ((uVar9 <= param_3) &&
      ...
      pbVar4 = (byte *)FUN_1403cae20(puVar6,param_3 - uVar9,local_res8,&local_68,local_64);
      if ((char)pbVar4 != '\0') {
          ...
          if (!bVar13) {
            ...
            *param_4 = (int)*(char *)(uVar11 + 2 + (longlong)puVar8);
            ...
            if (param_5 != '\0') {
              ...
              fVar15 = DAT_140492790;
              fVar16 = (float)*(uint *)(param_1 + 2) / (float)(byte)puVar2[0x2c];
              fVar17 = (float)*(uint *)(param_1 + 2) / (float)(byte)puVar2[0x2d];
              fVar14 = (float)FUN_14041a690((float)*param_4 * fVar16 + DAT_140492790);
              *param_4 = (int)fVar14;
              fVar14 = (float)FUN_14041a690((float)param_4[1] * fVar17 + fVar15);
              param_4[1] = (int)fVar14;
              fVar14 = (float)FUN_14041a690((float)param_4[2] * fVar16 + fVar15);
              param_4[2] = (int)fVar14;
              fVar15 = (float)FUN_14041a690((float)param_4[3] * fVar17 + fVar15);
              iVar1 = (int)fVar15;
              param_4[3] = iVar1;
            }
