// Function: FUN_140386b10
// Addr: 140386b10
// Size: 450 bytes


void FUN_140386b10(uint *param_1,longlong param_2)
    ...
    if (uVar11 < param_1[1] + 1) {
      ...
      if (uVar6 == 0) {
        ...
        if ((uVar11 == 0) && (*(longlong *)puVar1 != 0)) {
          lVar5 = thunk_FUN_1402da070((ulonglong)uVar6 << 2);
          if (lVar5 == 0) {
LAB_140386c6f:
            uVar11 = *param_1;
            if (uVar11 < uVar6) {
          ...
          if (param_1[1] != 0) {
            ...
            FUN_1404211c0(lVar5,*(undefined8 *)puVar1);
          }
        }
        else {
          lVar5 = func_0x0001402cb2b0(*(undefined8 *)puVar1,(ulonglong)uVar6 << 2);
          if (lVar5 == 0) goto LAB_140386c6f;
        }
      }
      ...
      do {
        ...
        if (iVar13 < 1) {
          if (pbVar10 < pbVar4) {
            ...
            if (pbVar10 + uVar7 * iVar13 <= pbVar4)
            goto UNWIND_INFO_140386cbb_UnwindCodes_17__UnwindOpCode;
            iVar13 = 0;
            iVar9 = 0;
          }
          else {
...
UNWIND_INFO_140386cbb_UnwindCodes_17__UnwindOpCode:
          if (uVar7 == 0) {
            iVar9 = 0;
          }
          else if (uVar7 == 1) {
