// Function: FUN_1402c6b40
// Addr: 1402c6b40
// Size: 530 bytes


undefined8 FUN_1402c6b40(undefined8 *param_1)

{
  ...
  *(uint *)(param_1 + 5) = *(uint *)(param_1 + 5) | 0x10;
  ...
  cVar3 = func_0x0001402c196c(param_1 + 10,(longlong)(iVar4 + 0x15d),param_1[1]);
  uVar13 = 0x200;
  if (cVar3 == '\0') {
    if (param_1[0x8b] == 0) {
      iVar4 = 0x200;
  ...
  func_0x0001402dabe0(&local_res8,puVar5,uVar13,puVar11,uVar6,
                      (int)*(char *)((longlong)param_1 + 0x39),iVar4,*param_1,1,param_1[1]);
  ...
  if (((*(char *)((longlong)param_1 + 0x39) + 0xb9U & 0xdf) == 0) &&
     ((*(uint *)(param_1 + 5) >> 5 & 1) == 0)) {
    if (*(char *)(param_1[1] + 0x28) == '\0') {
      FUN_1402c0e60(param_1[1]);
    }
    FUN_1402c3a9c(param_1[8]);
  }
