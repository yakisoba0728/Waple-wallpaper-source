// Function: FUN_1400127d0
// Addr: 1400127d0
// Size: 363 bytes


undefined8 FUN_1400127d0(longlong *param_1,longlong param_2)

{
  ...
  if ((param_1 != (longlong *)0x0) && (*param_1 == 0)) {
    ...
    *puVar2 = std::num_put<wchar_t,std::ostreambuf_iterator<wchar_t,std::char_traits<wchar_t>_>_>::
              vftable;
