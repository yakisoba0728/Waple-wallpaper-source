// Function: FUN_1402cc3a4
// Addr: 1402cc3a4
// Size: 25 bytes


int FUN_1402cc3a4(undefined8 *param_1,longlong param_2,int param_3,longlong param_4)

{
  ...
  if ((*(uint *)((longlong)param_1 + 0x14) >> 0xd & 1) == 0) {
    ...
    *(uint *)((longlong)param_1 + 0x14) = *(uint *)((longlong)param_1 + 0x14) & 0xfffffff7;
    UNLOCK();
    cVar1 = func_0x0001402cc2a8();
    if (cVar1 == '\0') {
      if (param_3 == 1) {
        lVar3 = func_0x0001402e059c(param_1,param_4);
        param_2 = param_2 + lVar3;
        param_3 = 0;
      }
      func_0x0001402cbda4(param_1,param_4);
      *param_1 = param_1[1];
      *(undefined4 *)(param_1 + 2) = 0;
      ...
      lVar3 = func_0x0001402e0000(*(undefined4 *)(param_1 + 3),param_2,param_3,param_4);
      iVar2 = (lVar3 != -1) - 1;
    }
    else {
      iVar2 = 0;
