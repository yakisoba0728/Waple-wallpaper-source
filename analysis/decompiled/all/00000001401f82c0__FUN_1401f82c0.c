...
void FUN_1401f82c0(longlong param_1,longlong *param_2)

{
  ...
  FUN_14015abd0(param_2,*(longlong *)(param_1 + 0x250) + _DAT_1404e8640);
  FUN_1401e15d0(param_1,param_2);
  puVar3 = DAT_1404e8638;
  for (puVar1 = (undefined8 *)*DAT_1404e8638; puVar1 != puVar3; puVar1 = (undefined8 *)*puVar1) {
    plVar2 = (longlong *)param_2[1];
    if (plVar2 == (longlong *)param_2[2]) {
      uVar8 = (longlong)plVar2 - *param_2;
      lVar6 = (longlong)uVar8 >> 3;
      if (lVar6 == 0x1fffffffffffffff) goto LAB_1401f85b0;
  ...
  if (uVar5 <= 0x1fffffffffffffff - (uVar5 >> 1)) {
    ...
    if (uVar7 < 0x2000000000000000) {
      ...
      if (uVar7 == 0) {
        ...
        if (uVar7 + 0x27 <= uVar7) goto LAB_1401f85b6;
