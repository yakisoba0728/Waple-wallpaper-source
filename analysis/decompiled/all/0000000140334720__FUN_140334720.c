...
void FUN_140334720(longlong param_1,int *param_2,int *param_3,undefined8 param_4,longlong param_5,
                  char param_6)
...
LAB_1403348e4:
  ...
  do {
    ...
    FUN_1403356e0(param_4,local_88[lVar8 + 2],local_88[lVar8 + 3],local_88[lVar8 + 4]);
    iVar9 = iVar9 + 6;
    lVar8 = lVar8 + 6;
  } while (iVar9 != 0xc);
