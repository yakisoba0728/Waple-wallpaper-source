// Function: FUN_1400ba490
// Addr: 1400ba490
// Size: 1622 bytes


char * FUN_1400ba490(longlong param_1,undefined4 *param_2,longlong *param_3)
  ...
  case 0:
    ...
    if (bVar1 != 0x20) {
      if (bVar1 < 0x20) {
        ...
        uVar19 = 1;
        goto switchD_1400ba524_caseD_1;
      }
      if (bVar1 != 0x28) {
        if (bVar1 != 0x40) goto LAB_1400ba9c5;
        if (param_3 != (longlong *)0x0) {
          param_3[3] = (longlong)puVar18 - *param_3;
        }
        uVar19 = 2;
        goto switchD_1400ba524_caseD_2;
      }
      if (param_3 != (longlong *)0x0) {
    ...
    goto LAB_1400ba5df;
  case 1:
switchD_1400ba524_caseD_1:
    pcVar10 = (char *)FUN_1400b7510(param_1,0,param_3);
    goto LAB_1400ba5c7;
  case 2:
switchD_1400ba524_caseD_2:
    pcVar10 = (char *)FUN_1400bab20(param_1,param_3);
LAB_1400ba5c7:
    if (param_3 != (longlong *)0x0) {
...
switchD_1400ba524_caseD_3:
          do {
            if ((longlong)puVar20 - (longlong)puVar18 < 4) {
              *(undefined8 *)(param_1 + 0xae28) = 0;
              uVar19 = 4;
switchD_1400ba524_caseD_4:
              while( true ) {
                if (puVar18 == puVar20) goto LAB_1400ba8ef;
...
switchD_1400ba524_caseD_5:
            if ((longlong)puVar20 - (longlong)puVar18 < 4) {
              *(undefined8 *)(param_1 + 0xae28) = 0;
              uVar19 = 6;
switchD_1400ba524_caseD_6:
              while( true ) {
                if (puVar18 == puVar20) goto LAB_1400ba8ef;
            ...
            *(int *)(param_1 + 0x74) = iVar15;
            if (iVar15 == 0x444e4549) {
              if (*(int *)(param_1 + 0x7c) == 0) goto switchD_1400ba524_caseD_7;
LAB_1400ba904:
              pcVar10 = "#png: bad chunk";
              goto LAB_1400ba9f6;
            }
            if (iVar15 == 0x54416466) goto LAB_1400ba904;
            if (iVar15 == 0x4c546366) {
              ...
              uVar19 = 9;
              goto switchD_1400ba524_caseD_9;
            }
            if (param_3 != (longlong *)0x0) {
              param_3[3] = (longlong)puVar18 - *param_3;
            }
            uVar19 = 0xb;
switchD_1400ba524_caseD_b:
            pcVar10 = (char *)FUN_1400b8430(param_1,param_3,1);
            if (param_3 != (longlong *)0x0) {
              puVar18 = (uint *)(param_3[3] + *param_3);
            }
            if ((uint *)pcVar10 != (uint *)0x0) goto LAB_1400ba9d8;
            if (*(int *)(param_1 + 0xec) != 0) goto LAB_1400ba5e8;
            *(undefined8 *)(param_1 + 0xae28) = 4;
            uVar19 = 0xc;
switchD_1400ba524_caseD_c:
            uVar12 = *(ulonglong *)(param_1 + 0xae28);
            if ((ulonglong)((longlong)puVar20 - (longlong)puVar18) < uVar12) goto LAB_1400ba833;
...
switchD_1400ba524_default:
      bVar7 = false;
      puVar20 = puVar18;
    }
    break;
  case 3:
    goto switchD_1400ba524_caseD_3;
  case 4:
    goto switchD_1400ba524_caseD_4;
  case 5:
    goto switchD_1400ba524_caseD_5;
  case 6:
    goto switchD_1400ba524_caseD_6;
  case 7:
switchD_1400ba524_caseD_7:
...
LAB_1400ba8ef:
      ...
      do {
        ...
        *(ulonglong *)(param_1 + 0xae28) = uVar12;
        if (bVar1 == 0x18) goto LAB_1400ba92c;
    ...
    break;
  case 9:
switchD_1400ba524_caseD_9:
    pcVar10 = (char *)FUN_1400b95c0(param_1,param_3);
    if (param_3 != (longlong *)0x0) {
      puVar18 = (uint *)(param_3[3] + *param_3);
    }
    if ((uint *)pcVar10 == (uint *)0x0) {
      *(undefined8 *)(param_1 + 0xae28) = 4;
      uVar19 = 10;
      goto switchD_1400ba524_caseD_a;
    }
    goto LAB_1400ba9d8;
  case 10:
switchD_1400ba524_caseD_a:
    uVar12 = *(ulonglong *)(param_1 + 0xae28);
    ...
    goto LAB_1400baa33;
  case 0xb:
    goto switchD_1400ba524_caseD_b;
  case 0xc:
    goto switchD_1400ba524_caseD_c;
  default:
    goto switchD_1400ba524_default;
  }
LAB_1400ba9e7:
  uVar13 = 0;
  if (bVar7) {
