// Function: FUN_140346a60
// Addr: 140346a60
// Size: 537 bytes


int FUN_140346a60(longlong param_1,uint param_2)

{
  ...
  if (*(ushort *)(lVar2 + 2) == 0) {
UNWIND_INFO_140346c71_UnwindCodes_25__OffsetInProlog:
    iVar7 = 8;
  }
  else {
...
LAB_140346bc1:
        ...
        if ((uVar6 <= uVar15) && (uVar13 <= uVar15 - uVar6)) {
          ...
          if ((6 < uVar13) &&
            ...
            pcVar8 = (char *)FUN_1402f8070(uVar4,local_res18[0],local_res8);
            if (local_res8[0] != 0) {
              return local_res8[0];
            }
            local_res8[0] = func_0x0001403570a0(uVar4,pcVar8,local_res18,pcVar14,uVar13);
            if (local_res8[0] != 0) {
                    /* WARNING: Subroutine does not return */
              FUN_1402f8060(uVar4,pcVar8);
            }
        ...
        goto UNWIND_INFO_140346c71_UnwindCodes_25__OffsetInProlog;
      }
    }
    iVar7 = 0x10;
  }
