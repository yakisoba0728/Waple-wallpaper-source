...
undefined4
FUN_140296360(longlong *param_1,longlong *param_2,ulonglong param_3,short *param_4,char param_5)

{
  ...
  local_80 = lVar7;
  local_90 = FUN_14029d190(&local_88);
  local_88 = 1;
...
LAB_14029666b:
          ...
          else if (*param_2 == 0) goto LAB_140296572;
        }
        ppppuVar8 = local_78;
        if (0xf < local_60) {
          ppppuVar8 = (undefined8 ****)local_78[0];
...
LAB_1402966a8:
    ...
    if (local_98 != '\0') {
      ...
      lVar7 = *param_1;
      if (lVar7 == 0) {
        if (*param_2 == 0) goto LAB_14029676c;
        uVar11 = local_88 + 1;
LAB_1402966f1:
        *param_1 = 0;
        uVar4 = 1;
