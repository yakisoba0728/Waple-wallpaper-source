// Function: FUN_1401a3450
// Addr: 1401a3450
// Size: 429 bytes


void FUN_1401a3450(undefined8 param_1,longlong param_2,undefined8 param_3,longlong param_4,
...

{
    ...
    if ((param_12 < param_4) || (param_7 < param_4)) {
      if (param_7 < param_12) {
        ...
        if ((param_9 != param_2) && (lVar1 = param_9, param_2 != param_10)) {
          ...
          lVar1 = (param_10 - param_2 & 0xfffffffffffffff0U) + param_9;
        }
      }
      else {
  ...
  FUN_1401a1360(param_1,param_9,lVar1,param_11,param_12,param_6,param_7,param_8);
  FUN_1401a1360(lVar1,param_10,param_3,param_4);
  return;
}
