// Function: FUN_140334b50
// Addr: 140334b50
// Size: 378 bytes


void FUN_140334b50(longlong param_1,longlong param_2,longlong param_3,int *param_4,char *param_5,
                  int param_6)
  ...
  if (*(char *)(*(longlong *)(param_1 + 0xf0) + 0x340) == '\0') {
    ...
    while (uVar7 < (uint)uVar12) {
      ...
      if (uVar7 < (uint)(lVar4 - lVar6 >> 3)) {
        ...
        if (iVar5 == 1) {
          iVar5 = *piVar1;
          iStack_34 = iVar5 + (iVar5 >> 0x1f) + 0x2000 >> 0xe;
        }
        else {
          iStack_34 = *piVar1;
          if (iVar5 == 2) {
      ...
      param_6 = iStack_34 + param_6;
      auStack_38[0] = 0;
      uStack_2c = 0;
      iStack_30 = param_6;
      if ((*(longlong *)(param_3 + 0x20) != *(longlong *)(param_3 + 0x18)) ||
         (cVar2 = func_0x000140333bb0(param_3,*(longlong *)(param_3 + 0x18) * 2 + 0x10),
         cVar2 != '\0')) {
                    /* WARNING: Subroutine does not return */
        FUN_1404211c0(*(longlong *)(param_3 + 0x10) * *(longlong *)(param_3 + 0x20) +
                      *(longlong *)(param_3 + 0x30),auStack_38);
      }
      uVar7 = uVar7 + 2;
