// Function: FUN_14029f9d0
// Addr: 14029f9d0
// Size: 433 bytes


undefined8 FUN_14029f9d0(longlong *param_1,longlong param_2)

{
  ...
  if ((param_1 != (longlong *)0x0) && (*param_1 == 0)) {
    ...
    if (puVar2 != (undefined8 *)0x0) {
      ...
      *puVar2 = std::_Mpunct<wchar_t>::vftable;
      *(undefined1 *)((longlong)puVar2 + 0x44) = 1;
      FUN_1402a4790(puVar2,local_98,1);
      *puVar2 = std::moneypunct<wchar_t,1>::vftable;
      puVar3 = puVar2;
