// Function: FUN_14025e9e0
// Addr: 14025e9e0
// Size: 211 bytes


void FUN_14025e9e0(longlong param_1,longlong param_2,char *param_3)

{
  ...
  puVar3 = DAT_1404e9cd8;
  puVar2 = DAT_1404e9cd0;
  if (param_3 != (char *)0x0) {
    iVar1 = *(int *)(param_2 + 4);
    for (puVar7 = DAT_1404e9cd0; puVar7 != puVar3; puVar7 = puVar7 + 5) {
...
LAB_14025ea6f:
  ...
  if (*(code **)(param_2 + 0x28) != (code *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00014025eaa2. Too many branches */
