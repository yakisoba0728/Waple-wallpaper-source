// Function: FUN_140269400
// Addr: 140269400
// Size: 532 bytes


undefined8 * FUN_140269400(float *param_1,undefined8 *param_2,byte *param_3)
  ...
  *puVar2 = puVar5;
  ...
  if (puVar4 == *(undefined8 **)(param_1 + 2)) {
    *(undefined8 **)(lVar3 + uVar6 * 0x10) = puVar5;
    ...
    if (*(undefined8 **)(lVar3 + 8 + uVar6 * 0x10) != puVar2) goto LAB_1402695f6;
  }
