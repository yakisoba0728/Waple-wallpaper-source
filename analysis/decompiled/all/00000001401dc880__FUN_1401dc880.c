// Function: FUN_1401dc880
// Addr: 1401dc880
// Size: 220 bytes


void FUN_1401dc880(longlong param_1,ulonglong param_2)

{
  ...
  FUN_14004f260(param_1 + 0x18,2L << (bVar9 & 0x3f),plVar1);
  *(longlong *)(param_1 + 0x38) = lVar10;
  *(longlong *)(param_1 + 0x30) = lVar10 + -1;
  plVar7 = (longlong *)**(undefined8 **)(param_1 + 8);
joined_r0x0001401dc8f6:
  do {
    while( true ) {
      while( true ) {
        if (plVar7 == plVar1) {
          uStackX_10 = 0;
          func_0x0001401dcf50(&uStackX_10);
          return;
        }
