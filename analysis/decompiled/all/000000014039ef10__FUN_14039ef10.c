// Function: FUN_14039ef10
// Addr: 14039ef10
// Size: 272 bytes


void FUN_14039ef10(uint *param_1,longlong param_2)
    ...
    *(uint *)(param_2 + 0xd8) = *(uint *)(param_2 + 0xd8) | 2;
    ...
    if (uVar1 == 0x200c) {
      ...
      if (((2 < uVar1 - 0x180b) && (uVar1 != 0x180f)) && (0x5f < uVar1 - 0xe0020)) {
        if (uVar1 != 0x34f) goto LAB_14039efa9;
...
LAB_14039efa9:
  ...
  if ((uVar6 & 0x1c00) != 0) {
    *(uint *)(param_2 + 0xd8) = *(uint *)(param_2 + 0xd8) | 0x80;
    ...
    uVar5 = uVar5 | (ushort)(byte)(&DAT_14045c270)[iVar4] << 8 | 0x80;
  }
