...
double FUN_140420380(double param_1)
  ...
  if ((0x7fd < uVar15 - 1) || (0x7f < (uVar20 & 0x7ff) - 0x3be)) {
    ...
    if (0xffdffffffffffffe < (longlong)param_1 * 2 - 1U) {
      ...
      if ((((((ulonglong)param_1 & 0x8000000000000000) != 0) &&
        ...
        dVar38 = (double)((ulonglong)dVar38 ^ DAT_1404930b0);
        lVar18 = 1;
      }
      if ((longlong)param_1 * 2 == 0) {
        ...
        dVar21 = (double)FUN_140420b80(lVar18);
        return dVar21;
      }
      if (((ulonglong)dVar21 & 0x8000000000000000) == 0) {
        return dVar38;
      }
      return DAT_140492848 / dVar38;
    }
    if (((ulonglong)param_1 & 0x8000000000000000) != 0) {
      uVar15 = uVar11 >> 0x14 & 0x7ff;
      if (uVar15 < 0x3ff) {
LAB_140420654:
        dVar21 = (double)FUN_140420be0();
        return dVar21;
      }
      if (uVar15 < 0x434) {
        uVar14 = 1L << ((ulonglong)(0x433 - uVar15) & 0x3f);
        if (((ulonglong)dVar21 & uVar14 - 1) != 0) goto LAB_140420654;
    ...
    if (0x7f < (uVar20 & 0x7ff) - 0x3be) {
      ...
      if ((uVar20 & 0x7ff) < 0x3be) {
        if (0x3ff0000000000000 < (ulonglong)dVar38) {
          return dVar21 + DAT_140492848;
        }
        return DAT_140492848 - dVar21;
      }
      if (0x3ff0000000000000 < (ulonglong)dVar38 == uVar20 < 0x800) {
        dVar21 = (double)FUN_140420c20();
        return dVar21;
      }
      dVar21 = (double)func_0x000140420c70(0);
      return dVar21;
    }
    if (uVar15 == 0) {
      dVar38 = (double)((longlong)ABS(param_1 * _DAT_140494130) + 0xfcc0000000000000);
    }
  }
  if (dVar21 != 1.0) {
    if (dVar38 == 1.0) {
      auVar39._8_8_ = 0;
      auVar39._0_8_ = DAT_140492848;
      auVar42._0_8_ = -(ulonglong)(lVar18 == 0);
      auVar42._8_8_ = 0xffffffffffffffff;
      auVar22._8_8_ = 0;
      auVar22._0_8_ = DAT_140492aa0;
      auVar22 = vblendvpd_avx(auVar22,auVar39,auVar42);
      param_1 = auVar22._0_8_;
    }
    else {
      auVar34._8_8_ = 0;
      auVar34._0_8_ = _DAT_140496c10;
      auVar40._8_8_ = 0;
      auVar40._0_8_ = _DAT_140496be8;
      auVar53._8_8_ = 0;
      auVar53._0_8_ = _DAT_140496be0;
      auVar57._8_8_ = 0;
      auVar57._0_8_ = DAT_140492aa0;
      ...
      auVar56._8_8_ = 0;
      auVar55._8_8_ = 0;
      auVar55._0_8_ = *(ulonglong *)(&DAT_140496c28 + lVar17);
      auVar1._8_8_ = 0;
      auVar1._0_8_ = *(ulonglong *)(&DAT_140496c38 + lVar17);
      auVar22 = vfmadd213sd_fma(auVar53,auVar56,auVar1);
      auVar2._8_8_ = 0;
      auVar2._0_8_ = *(ulonglong *)(&DAT_140496c40 + lVar17);
      ...
      auVar3._8_8_ = 0;
      auVar3._0_8_ = _DAT_140496c08;
      auVar1 = vfmadd213sd_fma(auVar34,auVar42,auVar3);
      dVar54 = auVar42._0_8_;
      auVar24._8_8_ = 0;
      auVar24._0_8_ = _DAT_140496c00;
      dVar50 = dVar54 * _DAT_140496bf0 * dVar54;
      dVar38 = auVar22._0_8_ + dVar54;
      dVar13 = dVar50 + dVar38;
      auVar4._8_8_ = 0;
      auVar4._0_8_ = _UNK_140496bf8;
      auVar2 = vfmadd213sd_fma(auVar42,auVar24,auVar4);
      auVar25._8_8_ = 0;
      auVar25._0_8_ = _DAT_140496c20;
      auVar5._8_8_ = 0;
      auVar5._0_8_ = _DAT_140496c18;
      auVar3 = vfmadd213sd_fma(auVar25,auVar42,auVar5);
      auVar46._8_8_ = 0;
      auVar46._0_8_ = dVar50;
      auVar1 = vfmadd231sd_fma(auVar1,auVar46,auVar3);
      auVar26._0_8_ = (ulonglong)dVar50 ^ DAT_1404930b0;
      auVar26._8_8_ = _UNK_1404930b8;
      auVar43._8_8_ = 0;
      auVar43._0_8_ = dVar54 * _DAT_140496bf0;
      ...
      auVar27._0_8_ = (ulonglong)dVar21 ^ DAT_1404930b0;
      auVar27._8_8_ = _UNK_1404930b8;
      ...
      if (0x3e < uVar19 - 0x3c9) {
        if (0x7fffffff < uVar19 - 0x3c9) {
          ...
          return (double)((ulonglong)(dVar21 + DAT_140492848) ^ DAT_1404930b0);
        }
        uVar15 = 0;
        if (0x408 < uVar19) {
          if (((ulonglong)dVar21 & 0x8000000000000000) != 0) {
            dVar21 = (double)func_0x000140420c70();
            return dVar21;
          }
          dVar21 = (double)FUN_140420c20(lVar18);
          return dVar21;
        }
      }
      auVar28._8_8_ = 0;
      auVar28._0_8_ = _UNK_140495b70;
      auVar44._8_8_ = 0;
      auVar44._0_8_ = dVar21;
      auVar6._8_8_ = 0;
      auVar6._0_8_ = _UNK_140495b78;
      ...
      auVar7._8_8_ = 0;
      auVar7._0_8_ = _UNK_140495b80;
      auVar39 = vfmadd231sd_fma(auVar44,auVar29,auVar7);
      auVar8._8_8_ = 0;
      auVar8._0_8_ = _UNK_140495b88;
      auVar39 = vfmadd231sd_fma(auVar39,auVar29,auVar8);
      auVar30._8_8_ = 0;
      auVar30._0_8_ = _UNK_140495ba8;
      dVar21 = auVar39._0_8_ + auVar22._0_8_;
      auVar37._8_8_ = 0;
      auVar37._0_8_ = _UNK_140495b98;
      dVar38 = dVar21 * dVar21;
      auVar48._8_8_ = 0;
      auVar48._0_8_ = dVar21;
      auVar9._8_8_ = 0;
      auVar9._0_8_ = _UNK_140495b90;
      auVar22 = vfmadd213sd_fma(auVar48,auVar37,auVar9);
      uVar14 = (lVar18 + uVar16 << 0x2c) + *(longlong *)(&UNK_140495be8 + (uVar16 & 0xff) * 0x10);
      auVar10._8_8_ = 0;
      auVar10._0_8_ = _UNK_140495ba0;
      auVar39 = vfmadd213sd_fma(auVar48,auVar30,auVar10);
      auVar45._8_8_ = 0;
      auVar45._0_8_ = dVar38;
      auVar52._8_8_ = 0;
      auVar52._0_8_ = dVar21 + *(double *)(&UNK_140495be0 + (uVar16 & 0xff) * 0x10);
      ...
      if (uVar15 == 0) {
        if ((uVar16 & 0x80000000) == 0) {
          ...
          param_1 = (double)func_0x000140420b10(auVar22._0_8_ * _UNK_140494138);
        }
        else {
          auVar49._8_8_ = 0;
          auVar49._0_8_ = DAT_140492848;
          dVar13 = (double)(uVar14 + 0x3fe0000000000000);
          dVar38 = dVar13 * auVar22._0_8_;
          dVar21 = dVar13 + dVar38;
          auVar41._8_8_ = 0;
          auVar41._0_8_ = dVar21;
          auVar22 = vandpd_avx(auVar41,_DAT_1404930a0);
          if (auVar22._0_8_ < DAT_140492848) {
          ...
          param_1 = (double)func_0x000140420b50(dVar21 * _UNK_140471b20);
        }
      }
      else {
        auVar33._8_8_ = 0;
