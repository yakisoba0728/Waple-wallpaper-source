// Function: thunk_FUN_14028e250
// Addr: 14028ef70
// Size: 5 bytes


ulonglong thunk_FUN_14028e250(longlong param_1,longlong param_2,ulonglong param_3)

{
  ...
  uVar6 = 0;
  if ((DAT_1404dc00c & 0x20) == 0) {
    if ((DAT_1404dc00c & 4) == 0) goto joined_r0x00014028e31b;
    ...
    if ((uVar8 & 0xffffffffffffffe0) != 0) {
      do {
        ...
        if (uVar7 != 0) goto LAB_14028e334;
        uVar6 = uVar6 + 0x20;
      } while (uVar6 != (uVar8 & 0xffffffffffffffe0));
    }
    uVar9 = (ulonglong)((uint)uVar8 & 0x1c);
    if ((uVar8 & 0x1c) != 0) {
      auVar4 = vpmaskmovd_avx2(*(undefined1 (*) [32])(&DAT_140429a50 + -uVar9),
                               *(undefined1 (*) [32])(uVar6 + param_2));
      auVar5 = vpmaskmovd_avx2(*(undefined1 (*) [32])(&DAT_140429a50 + -uVar9),
                               *(undefined1 (*) [32])(uVar6 + param_1));
