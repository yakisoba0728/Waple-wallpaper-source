...
ulonglong FUN_1403195f0(longlong *param_1,longlong param_2)

{
  ...
  if (*(char *)((longlong)param_1 + 0xb4) == '\0') {
    ...
    *plVar17 = (longlong)pcVar14;
    while (pcVar2 < pcVar14) {
      if ((((*pcVar2 == 'e') && (pcVar2 + 9 < pcVar14)) && (pcVar2[1] == 'e')) &&
        ...
        *plVar17 = (ulonglong)*(uint *)(param_1 + 0x14) + param_1[0x13];
        ...
        pbVar3 = (byte *)*plVar17;
        uVar8 = FUN_140420f50(pbVar13,10,(longlong)pbVar3 - (longlong)pbVar13);
        if ((uVar8 == 0) ||
           (uVar10 = FUN_140420f50(pbVar13,0xd,(longlong)pbVar3 - (longlong)pbVar13), uVar10 < uVar8
           )) {
          bVar4 = true;
        }
        else {
        ...
        if (*(char *)((longlong)param_1 + 0xb5) == '\0') {
          ...
          *(undefined1 *)((longlong)param_1 + 0xb6) = 1;
          ...
          lVar11 = FUN_1402f7fa0(lVar9,uVar16 + 1,local_res8);
          *plVar17 = lVar11;
          if (local_res8[0] != 0) {
        ...
        *(uint *)(param_1 + 0x16) = uVar16;
        if (((((pbVar13 + 3 < pbVar3) &&
              (((bVar1 = *pbVar13, bVar1 - 0x30 < 10 || (bVar1 - 0x61 < 6)) || (bVar1 - 0x41 < 6))))
             && (((bVar1 = pbVar13[1], bVar1 - 0x30 < 10 || (bVar1 - 0x61 < 6)) ||
                 (bVar1 - 0x41 < 6)))) &&
            (((bVar1 = pbVar13[2], bVar1 - 0x30 < 10 || (bVar1 - 0x61 < 6)) || (bVar1 - 0x41 < 6))))
           && (((bVar1 = pbVar13[3], bVar1 - 0x30 < 10 || (bVar1 - 0x61 < 6)) || (bVar1 - 0x41 < 6))
              )) {
          ...
          *(undefined1 *)((ulonglong)local_res18[0] + *plVar17) = 0;
          ...
          FUN_1404210f0(lVar11,pbVar13,uVar16);
          lVar9 = local_res10;
        }
        goto LAB_1403199e7;
      }
    ...
    lVar11 = param_1[0x12];
    uVar6 = FUN_1402f54a0(lVar11);
    puVar15 = (uint *)(param_1 + 0x16);
    *puVar15 = 0;
    while( true ) {
      sVar5 = FUN_1402f5ac0(lVar11,local_res18);
      iVar12 = 0;
      if (local_res18[0] == 0) {
        if (((ushort)(sVar5 + 0x7fffU) < 2) &&
           (iVar7 = FUN_1402f5970(lVar11,local_res18), iVar12 = 0, local_res18[0] == 0)) {
          iVar12 = iVar7;
        }
      }
      else {
      ...
      *puVar15 = *puVar15 + iVar12;
      uVar8 = FUN_1402f5c90(lVar11,iVar12);
    ...
    if (*puVar15 != 0) {
      uVar8 = FUN_1402f5c50(lVar11,uVar6);
      local_res8[0] = (uint)uVar8;
      if (local_res8[0] != 0) {
        return uVar8;
      }
      lVar9 = FUN_1402f7fa0(lVar9,*puVar15,local_res8);
      param_1[0x15] = lVar9;
      if (local_res8[0] != 0) {
        return (ulonglong)local_res8[0];
      }
      *puVar15 = 0;
      while( true ) {
        ...
        if (local_res18[0] == 0) {
          if ((ushort)(sVar5 + 0x7fffU) < 2) {
            iVar7 = FUN_1402f5970(lVar11,local_res18);
            iVar12 = 0;
            if (local_res18[0] == 0) {
              iVar12 = iVar7;
            }
        ...
        uVar8 = FUN_1402f54b0(lVar11,(ulonglong)*puVar15 + param_1[0x15],iVar12);
        if ((int)uVar8 != 0) {
          return uVar8;
        }
        *puVar15 = *puVar15 + iVar12;
