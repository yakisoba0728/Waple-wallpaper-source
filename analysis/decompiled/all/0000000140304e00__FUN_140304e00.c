// Function: FUN_140304e00
// Addr: 140304e00
// Size: 344 bytes


undefined8 FUN_140304e00(undefined8 param_1,longlong param_2,undefined8 param_3)

{
  ...
  do {
    ...
    do {
      uVar3 = *puVar17;
      uVar4 = puVar17[1];
      puVar6 = (uint *)func_0x0001402f7860(uVar10,param_1);
      if (puVar6 == (uint *)0x0) {
        uVar7 = FUN_1402f77b0(uVar10,CONCAT11(uVar3,uVar4),param_1,param_3);
        if ((int)uVar7 != 0) {
          return uVar7;
        }
      }
      else {
        uVar7 = FUN_1402f77b0((*puVar6 & 0xffff0000) + 0x10000 | (uint)uVar10,CONCAT11(uVar3,uVar4),
                              param_1,param_3);
        if ((int)uVar7 != 0) {
          return uVar7;
        }
