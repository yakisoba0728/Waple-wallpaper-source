// Function: FUN_1403efa50
// Addr: 1403efa50
// Size: 457 bytes


void FUN_1403efa50(longlong param_1,longlong param_2,undefined4 param_3)

{
  ...
  fVar12 = ((float)(int)(short)((ushort)*(byte *)(param_1 + 5) +
  ...
  fVar11 = ((float)(int)(short)((ushort)*(byte *)(param_1 + 6) * 0x100 +
                               (ushort)*(byte *)(param_1 + 7)) + fVar9) * DAT_140471a5c;
  fVar9 = (float)FUN_1403993a0(*(undefined8 *)(param_2 + 0x48),param_3,2);
  bVar3 = *(byte *)(param_1 + 10);
  bVar4 = *(byte *)(param_1 + 0xb);
  fVar10 = (float)FUN_1403993a0(*(undefined8 *)(param_2 + 0x48),param_3,3);
  FUN_1403f5ad0(*(undefined8 *)(param_2 + 0x10),*(undefined8 *)(param_2 + 0x18),fVar12,fVar11,
                fVar9 + (float)(int)(short)((ushort)bVar2 * 0x100 + (ushort)bVar1),
  ...
  if (*(longlong *)(lVar5 + 0x98) != 0) {
    uVar8 = *(undefined8 *)(*(longlong *)(lVar5 + 0x98) + 8);
                    ...
                    /* WARNING: Could not recover jumptable at 0x0001403efc15. Too many branches */
