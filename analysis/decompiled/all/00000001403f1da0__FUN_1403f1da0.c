...
void FUN_1403f1da0(char *param_1,code *param_2,char param_3,char param_4,longlong param_5)

{
  ...
  if (param_3 == '\0') {
    ...
    if (uVar19 != 0) {
      if ((0x3ffffffe < uVar19) || (lVar12 = _realloc_base(), lVar12 == 0)) {
        *param_1 = '\0';
        lVar12 = 0;
        uVar22 = 0xffffffff;
        goto LAB_1403f21c6;
      ...
      local_b0 = uVar19;
      local_a0 = lVar12;
      if ((uVar19 != 0) && ((uVar19 & 0x3fffffff) != 0)) {
        FUN_1404217a0(lVar12);
      }
    }
...
LAB_1403f1ed4:
        ...
        if (uVar19 <= uVar5) {
          if (param_4 != '\0') goto LAB_1403f1ed2;
          goto LAB_1403f1ed4;
        }
        if (param_3 != '\0') {
          uVar21 = (ulonglong)((int)uVar21 + 1);
  ...
  if (param_3 == '\0') {
    FUN_1403b48c0(param_1,&local_a8,uVar23);
    local_b0 = (uint)local_a8;
    uVar16 = uVar23;
  }
  cVar11 = FUN_1403f8740(param_1,uVar21,1,0);
  lVar12 = local_a0;
  uVar22 = local_b0;
  if (cVar11 != '\0') {
    uVar15 = uVar16;
...
LAB_1403f20c1:
    ...
    FUN_1403f8740(param_1,uVar18,1,0);
    lVar12 = local_a0;
    uVar22 = local_b0;
  }
LAB_1403f21c6:
  if (1 < uVar22 + 1) {
    thunk_FUN_1402d9040(lVar12);
  }
  return;
}
