// Function: FUN_14015f400
// Addr: 14015f400
// Size: 957 bytes


undefined4 FUN_14015f400(longlong param_1,longlong *param_2)
  ...
  *piVar1 = *piVar1 + 1;
  ...
  if (puVar12 != puVar18) {
    ...
    while (puVar12 = puVar18, *(int *)(lVar15 + 0x1458) != iVar2) {
      if (puVar18 == *(undefined8 **)(lVar4 + uVar14 * 0x10)) goto LAB_14015f4ca;
      puVar18 = (undefined8 *)puVar18[1];
      iVar2 = *(int *)(puVar18 + 2);
    }
    goto UNWIND_INFO_14015f7a6_UnwindCodes_53__UnwindOpCode;
  }
LAB_14015f4ca:
  ...
  puVar12 = (undefined8 *)func_0x00014028aff0(0x58);
  *(undefined4 *)(puVar12 + 2) = *(undefined4 *)(lVar15 + 0x1458);
  ...
  if (*(float *)(param_1 + 0xf0) < fVar20 / (float)uVar14) {
    fVar20 = (float)func_0x00014041a070(fVar20 / *(float *)(param_1 + 0xf0));
    lVar15 = 0;
    if ((DAT_140492a44 <= fVar20) && (fVar20 = fVar20 - DAT_140492a44, fVar20 < DAT_140492a44)) {
...
UNWIND_INFO_14015f7a6_UnwindCodes_53__UnwindOpCode:
  FUN_1400cb0e0(puVar12 + 3,param_2);
