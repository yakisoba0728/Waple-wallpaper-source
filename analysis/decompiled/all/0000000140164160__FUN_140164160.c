// Function: FUN_140164160
// Addr: 140164160
// Size: 694 bytes


longlong * FUN_140164160(float *param_1,longlong *param_2,undefined8 *param_3)

{
  ...
  if (*(longlong *)(param_1 + 4) == 0x276276276276276) {
                    /* WARNING: Subroutine does not return */
    FUN_14028c2e0("unordered_map/set too long");
  }
  puVar4 = (undefined8 *)FUN_14028af20(0x68);
  ...
  if (*param_1 < (float)(*(longlong *)(param_1 + 4) + 1) / (float)uVar5) {
    ...
    if (puVar8 != *(undefined8 **)(param_1 + 2)) {
      ...
      while( true ) {
        ...
        if (local_38 == puVar2) goto LAB_14016439e;
  ...
  *puVar8 = puVar4;
  ...
  if (puVar2 == *(undefined8 **)(param_1 + 2)) {
    *(undefined8 **)(lVar6 + uVar10 * 0x10) = puVar4;
    ...
    if (*(undefined8 **)(lVar6 + 8 + uVar10 * 0x10) != puVar8) goto LAB_1401643ee;
  }
