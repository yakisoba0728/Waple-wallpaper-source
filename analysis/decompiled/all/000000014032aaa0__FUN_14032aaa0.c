// Function: FUN_14032aaa0
// Addr: 14032aaa0
// Size: 679 bytes


int FUN_14032aaa0(longlong param_1,longlong *param_2,uint param_3,uint param_4)

{
  ...
  if (lVar2 == 0) {
    ...
    *(int *)(param_1 + 0x34) = *(int *)(param_1 + 0x68) << 6;
    FUN_1402f8f80((int *)(param_1 + 0x30),(*(int *)(lVar2 + 0x154) + *(int *)(lVar2 + 0x150)) * 0x40
                 );
    if ((param_4 >> 0x16 & 1) == 0) {
      iVar9 = *(int *)(param_1 + 0x70);
      iVar1 = *(int *)(param_1 + 0x68);
      iVar7 = FUN_1402f6fb0(param_1);
      if ((iVar7 == 0) && (iVar7 = FUN_1402f5c50(uVar3,*(undefined4 *)(psVar12 + 6)), iVar7 == 0)) {
        uVar6 = iVar9 * iVar1;
        iVar7 = FUN_1402f54b0(uVar3,*(undefined8 *)(param_1 + 0x78),uVar6);
        if (iVar7 == 0) {
