// Function: FUN_1400302d0
// Addr: 1400302d0
// Size: 413 bytes


undefined8 * FUN_1400302d0(longlong *param_1,undefined8 *param_2)
...
LAB_140030469:
  ...
  if (0x1fffffffffffffff < uVar9) goto LAB_140030469;
  uVar4 = uVar9 * 8;
  if (uVar4 == 0) {
...
LAB_1400303b1:
    ...
    *puVar11 = *param_2;
    ...
    lVar10 = *param_1;
    if (lVar10 == 0) goto LAB_14003043e;
    lVar6 = lVar10;
    puVar8 = auStack_58;
    ...
    if (uVar4 + 0x27 <= uVar4) goto LAB_140030469;
...
LAB_14003042c:
  ...
  *(undefined8 *)(puVar8 + -8) = 0x14003043e;
