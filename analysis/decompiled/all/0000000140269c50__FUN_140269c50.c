// Function: FUN_140269c50
// Addr: 140269c50
// Size: 486 bytes


ulonglong FUN_140269c50(ulonglong *param_1,ulonglong param_2,undefined4 *param_3)
...
LAB_140269e32:
  ...
  if (0xccccccccccccccc < uVar8) goto LAB_140269e32;
  uVar8 = uVar8 * 0x14;
  if (uVar8 == 0) {
    unaff_RBX = 0;
LAB_140269d35:
    ...
    *(undefined4 *)(uVar12 + 0x10) = param_3[4];
    ...
    if (uVar8 + 0x27 <= uVar8) goto LAB_140269e32;
...
LAB_140269de4:
  ...
  *(undefined8 *)(puVar10 + -8) = 0x140269df6;
