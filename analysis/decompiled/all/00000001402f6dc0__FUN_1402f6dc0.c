// Function: FUN_1402f6dc0
// Addr: 1402f6dc0
// Size: 51 bytes


undefined8 FUN_1402f6dc0(longlong param_1)
...
code_r0x0001402f6e68:
          if (bVar9) {
code_r0x0001402f6eb3:
            lVar7 = *plVar8;
            goto code_r0x0001402f6eb6;
          }
        }
        else if (*(short *)((longlong)plVar2 + 0xc) == 0) {
          if (*(short *)((longlong)plVar2 + 0xe) == 4) goto code_r0x0001402f6eb3;
          if (((*(short *)((longlong)plVar2 + 0xe) == 6) && (plVar2 != (longlong *)0x0)) &&
            ...
            if (((pcVar4 != (code *)0x0) &&
               ...
               && (iVar5 = (*(code *)*puVar6)(plVar2,auStackX_8), iVar5 == 0)) {
              bVar9 = iStackX_c == 0xd;
              goto code_r0x0001402f6e68;
            }
          }
        }
      }
