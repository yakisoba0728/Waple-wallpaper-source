// Function: FUN_1400b9010
// Addr: 1400b9010
// Size: 1467 bytes


char * FUN_1400b9010(longlong param_1,longlong *param_2)

{
  ...
  case 1:
    break;
  case 2:
    goto switchD_1400b906d_caseD_2;
  case 3:
    goto switchD_1400b906d_caseD_3;
  case 4:
    goto switchD_1400b906d_caseD_4;
  case 5:
    goto switchD_1400b906d_caseD_5;
  case 6:
    goto switchD_1400b906d_caseD_6;
  case 7:
    goto switchD_1400b906d_caseD_7;
  case 8:
    goto switchD_1400b906d_caseD_8;
  case 9:
    goto switchD_1400b906d_caseD_9;
  case 10:
    goto switchD_1400b906d_caseD_a;
  case 0xb:
    goto switchD_1400b906d_caseD_b;
  case 0xc:
    goto switchD_1400b906d_caseD_c;
  case 0xd:
    goto switchD_1400b906d_caseD_d;
  case 0xe:
    goto switchD_1400b906d_caseD_e;
  case 0xf:
    goto switchD_1400b906d_caseD_f;
  case 0x10:
    goto switchD_1400b906d_caseD_10;
  default:
    goto switchD_1400b906d_default;
  }
  if ((longlong)puVar10 - (longlong)puVar9 < 4) {
    *(undefined8 *)(param_1 + 0xade0) = 0;
    uVar8 = 2;
switchD_1400b906d_caseD_2:
...
LAB_1400b9146:
    *(ulonglong *)(param_1 + 0xf0) = *(ulonglong *)(param_1 + 0xf0) | (ulonglong)(uVar11 & 0xffffff)
    ;
switchD_1400b906d_caseD_3:
    if ((longlong)puVar10 - (longlong)puVar9 < 4) {
      *(undefined8 *)(param_1 + 0xade0) = 0;
      uVar8 = 4;
switchD_1400b906d_caseD_4:
      if (puVar9 == puVar10) goto LAB_1400b9131;
      do {
        uVar11 = *(uint *)(param_1 + 0xade0);
        uVar6 = *(ulonglong *)(param_1 + 0xade0) & 0xffffffffffffff00;
        uVar7 = uVar11 & 0xff;
...
switchD_1400b906d_caseD_5:
      if ((longlong)puVar10 - (longlong)puVar9 < 4) {
        *(undefined8 *)(param_1 + 0xade0) = 0;
        uVar8 = 6;
switchD_1400b906d_caseD_6:
        if (puVar9 == puVar10) goto LAB_1400b9131;
        do {
          uVar11 = *(uint *)(param_1 + 0xade0);
          uVar6 = *(ulonglong *)(param_1 + 0xade0) & 0xffffffffffffff00;
...
switchD_1400b906d_caseD_7:
        if ((longlong)puVar10 - (longlong)puVar9 < 4) {
          *(undefined8 *)(param_1 + 0xade0) = 0;
          uVar8 = 8;
switchD_1400b906d_caseD_8:
          if (puVar9 == puVar10) goto LAB_1400b9131;
          do {
            uVar11 = *(uint *)(param_1 + 0xade0);
            uVar6 = *(ulonglong *)(param_1 + 0xade0) & 0xffffffffffffff00;
...
switchD_1400b906d_caseD_9:
          if ((longlong)puVar10 - (longlong)puVar9 < 4) {
            *(undefined8 *)(param_1 + 0xade0) = 0;
            uVar8 = 10;
switchD_1400b906d_caseD_a:
            if (puVar9 == puVar10) goto LAB_1400b9131;
            do {
              uVar11 = *(uint *)(param_1 + 0xade0);
              uVar6 = *(ulonglong *)(param_1 + 0xade0) & 0xffffffffffffff00;
...
switchD_1400b906d_caseD_b:
            if ((longlong)puVar10 - (longlong)puVar9 < 4) {
              *(undefined8 *)(param_1 + 0xade0) = 0;
              uVar8 = 0xc;
switchD_1400b906d_caseD_c:
              if (puVar9 == puVar10) goto LAB_1400b9131;
              do {
                uVar11 = *(uint *)(param_1 + 0xade0);
                uVar6 = *(ulonglong *)(param_1 + 0xade0) & 0xffffffffffffff00;
...
switchD_1400b906d_caseD_d:
              if ((longlong)puVar10 - (longlong)puVar9 < 4) {
                *(undefined8 *)(param_1 + 0xade0) = 0;
                uVar8 = 0xe;
switchD_1400b906d_caseD_e:
                if (puVar9 == puVar10) goto LAB_1400b9131;
                do {
                  uVar11 = *(uint *)(param_1 + 0xade0);
                  uVar6 = *(ulonglong *)(param_1 + 0xade0) & 0xffffffffffffff00;
...
switchD_1400b906d_caseD_f:
                if (3 < (longlong)puVar10 - (longlong)puVar9) {
                  uVar11 = *puVar9;
                  puVar9 = puVar9 + 1;
                  uVar6 = (ulonglong)
                          (uVar11 >> 0x18 | (uVar11 & 0xff0000) >> 8 | (uVar11 & 0xff00) << 8);
code_r0x0001400b9603:
