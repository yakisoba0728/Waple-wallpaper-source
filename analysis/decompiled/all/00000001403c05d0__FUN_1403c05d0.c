// Function: FUN_1403c05d0
// Addr: 1403c05d0
// Size: 360 bytes


longlong FUN_1403c05d0(longlong param_1,ushort param_2,ushort param_3)
    ...
    do {
      ...
      if ((iVar2 == 0) &&
         (((uint)(param_3 >> 8) * 0x100 + (uint)(byte)param_3 == 0xffff ||
          ...
          iVar2 = (uint)(uVar6 < uVar3) - (uint)(uVar3 < uVar6), iVar2 == 0)))) goto LAB_1403c06e6;
      if (iVar2 < 0) {
        iVar4 = uVar1 - 1;
      }
      else {
        if (iVar2 < 1) goto LAB_1403c06e6;
        iVar8 = uVar1 + 1;
      }
    } while (iVar8 <= iVar4);
  }
