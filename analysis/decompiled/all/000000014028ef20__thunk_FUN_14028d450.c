// Function: thunk_FUN_14028d450
// Addr: 14028ef20
// Size: 5 bytes


undefined1 (*) [32]
thunk_FUN_14028d450(undefined1 (*param_1) [32],undefined1 (*param_2) [32],short param_3)

{
  ...
  pauVar12 = param_2;
  if (((uVar13 & 0xffffffffffffffe0) == 0) || ((DAT_1404dc00c & 0x20) == 0)) {
    if (((uVar13 & 0xfffffffffffffff0) != 0) && ((DAT_1404dc00c & 4) != 0)) {
      do {
        pauVar3 = pauVar12 + -1;
        pauVar4 = pauVar12 + -1;
        pauVar5 = pauVar12 + -1;
    ...
    do {
      ...
      if (uVar11 != 0) goto LAB_14028d50b;
    ...
    if ((uVar13 & 0x1c) != 0) {
      ...
      auVar2 = vpmaskmovd_avx2(*(undefined1 (*) [32])(&DAT_140429a50 + -uVar14),*pauVar12);
      auVar16 = vpcmpeqw_avx2(auVar2,auVar16);
      auVar16 = vpand_avx2(auVar16,*(undefined1 (*) [32])(&DAT_140429a50 + -uVar14));
