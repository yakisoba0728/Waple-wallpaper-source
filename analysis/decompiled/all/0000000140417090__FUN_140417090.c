// Function: FUN_140417090
// Addr: 140417090
// Size: 518 bytes


void FUN_140417090(longlong param_1,int param_2,undefined4 param_3,undefined4 param_4,
                  undefined8 param_5)

{
  ...
  if (param_2 == 0x47504f53) {
    puVar2 = (undefined8 *)FUN_1403c4ed0(param_1 + 0x148);
  }
  else {
    ...
    puVar2 = (undefined8 *)FUN_1403c4f70(param_1 + 0x140);
  }
...
LAB_140417101:
  uVar3 = FUN_1403ce450(pbVar8,param_3);
  lVar4 = FUN_1403cbdc0(uVar3,param_4);
  uVar10 = (uint)*(byte *)(lVar4 + 4) * 0x100 + (uint)*(byte *)(lVar4 + 5);
  uVar11 = (ulonglong)uVar10;
  FUN_1403a36a0(param_5,uVar11);
  while( true ) {
    if (uVar10 == 0) {
      return;
    }
    ...
    if (local_res10[0] == 0xffff) {
      ...
      local_28[0] = (uint)pbVar7[1] * 0x10000 + (uint)pbVar7[2] * 0x100 + (uint)*pbVar7 * 0x1000000
                    + (uint)pbVar7[3];
    }
    FUN_14038e100(param_5,local_28,local_28[0] * -0x61c8864f,local_res10,1);
  }
  return;
}
