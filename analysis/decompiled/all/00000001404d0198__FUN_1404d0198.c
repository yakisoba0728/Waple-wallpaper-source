...
void FUN_1404d0198(longlong param_1,uint param_2)

{
  ...
  cRam21004d00940036f2 = (char)in_RAX;
  *in_RAX = *in_RAX + cRam21004d00940036f2;
  cVar8 = (char)(param_2 >> 8);
  in_RAX[-0x74ffc90f] = in_RAX[-0x74ffc90f] + cVar8;
  in_RAX[0x1004bee] = in_RAX[0x1004bee] + (char)((ulonglong)in_RAX >> 8);
  piVar4 = (int *)((ulonglong)in_RAX ^ 6);
