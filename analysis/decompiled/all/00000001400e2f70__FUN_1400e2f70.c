// Function: FUN_1400e2f70
// Addr: 1400e2f70
// Size: 4502 bytes


bool FUN_1400e2f70(longlong *param_1,longlong param_2)
...
LAB_1400e40d9:
  ...
  do {
    do {
      uVar26 = 4;
      if (*param_1 < 1) goto LAB_1400e40fc;
      *param_1 = *param_1 + -1;
...
LAB_1400e30d1:
          ...
          if (pbVar4 != (byte *)param_1[0x1b]) {
            local_res10 = (uint)((uint)((&DAT_140486df0)[pbVar4[-1]] != (&DAT_140486df0)[*pbVar4])
                                == (*(uint *)(param_2 + 0xc) & 1));
            uVar31 = local_res10;
            break;
          }
      ...
      case 6:
        ...
        if ((*(uint *)(param_1 + 0x1c) & 0x100) == 0) {
          for (; pcVar32 != pcVar5; pcVar32 = pcVar32 + 1) {
            bVar35 = true;
            if (pcVar25 == pcVar34) goto LAB_1400e321d;
            lVar24 = lVar24 + 1;
            if (*pcVar32 != *pcVar25) goto LAB_1400e3221;
            pcVar25 = pcVar25 + 1;
          }
...
LAB_1400e321d:
          ...
          for (; (pcVar32 != pcVar5 && (pcVar25 != pcVar34)); pcVar25 = pcVar25 + 1) {
            ...
            if (cVar11 != cVar12) goto LAB_1400e3221;
            pcVar32 = pcVar32 + 1;
          }
          if (pcVar25 == pcVar34) {
            pcVar33 = pcVar32;
...
LAB_1400e3221:
        ...
        if (*param_1 < lVar24) goto LAB_1400e40fc;
        *param_1 = *param_1 - lVar24;
        uVar31 = local_res10;
        break;
      case 7:
        if ((param_1[1] == param_1[0x1b]) || (lVar24 = FUN_1400e2e50(param_1), lVar24 == param_1[1])
           ) goto LAB_1400e3153;
        param_1[1] = lVar24;
        break;
      case 10:
        FUN_1400e6100(param_1,1,param_2);
        lVar15 = *(longlong *)(param_2 + 0x20);
        break;
      case 0xb:
        FUN_1400e6100(param_1,2,param_2);
        lVar15 = *(longlong *)(param_2 + 0x20);
        break;
      case 0xc:
              ...
              if ((uVar21 <= uVar28) && (uVar28 = uVar28 + 1, uVar21 < uVar28)) {
                ...
                *puVar1 = *puVar1 & (1L << ((byte)uVar26 & 0x3f)) - 1U;
                ...
                if (uVar26 < uVar20) {
                  ...
                  FUN_1404217a0(lVar24,0,(uVar20 * 8 - lVar24) + param_1[5] & 0xfffffffffffffff8);
                }
              }
              goto switchD_1400e2fe7_caseD_1;
            }
            if (iVar3 == 0xd) {
              uVar18 = piVar19[1];
              uVar13 = uVar18;
      ...
      case 0xd:
        ...
        lVar16 = FUN_1400e6100(param_1,0xc,param_2);
        lVar30 = param_1[0x12];
      ...
      case 0xe:
        ...
        if (iVar3 != 0) {
          ...
          lVar16 = FUN_1400e6100(param_1,((*(ulonglong *)(param_1[5] + uVar26 * 8) >>
                                           (uVar28 & 0x3f) & 1) != 0) + '\r');
          lVar30 = param_1[0x12];
          *(undefined8 *)(lVar30 + 0x10 + lVar16 * 0x20) =
...
LAB_1400e3627:
            ...
            if ((*(uint *)(param_1 + 0x1c) & 0x100) == 0) {
              for (; pcVar34 != pcVar32; pcVar34 = pcVar34 + 1) {
                bVar35 = true;
                if (pcVar33 == pcVar5) goto LAB_1400e3613;
                lVar24 = lVar24 + 1;
                if (*pcVar34 != *pcVar33) goto LAB_1400e3617;
                pcVar33 = pcVar33 + 1;
              }
            }
            else {
              ...
              for (; (pcVar34 != pcVar32 && (pcVar33 != pcVar5)); pcVar33 = pcVar33 + 1) {
                ...
                if (cVar11 != cVar12) goto LAB_1400e3617;
                pcVar34 = pcVar34 + 1;
              }
            }
...
LAB_1400e3617:
            uVar31 = local_res10;
            if (pcVar25 != (char *)param_1[1]) goto LAB_1400e3627;
            uVar31 = 1;
          }
          lVar24 = (longlong)(lVar24 + (ulonglong)((uint)(lVar24 >> 0x3f) & 0x3f)) >> 6;
          if (*param_1 < lVar24) {
      ...
      case 0x12:
        ...
        if ((*(int *)(param_1[0xf] + 0xc + (ulonglong)*(uint *)(param_2 + 0x30) * 0x18) == 0) &&
           (((*(byte *)(param_1 + 0x1c) & 0x3e) != 0 ||
            (cVar12 = FUN_1400e7880(param_1,lVar15,lVar24), cVar12 == '\0')))) {
        ...
        if (*(int *)(param_2 + 0x34) == 1) {
          lVar30 = FUN_1400e6100(param_1,uVar26 & 0xffffffff,param_2);
          *(longlong *)(lVar24 + uVar20 * 0x18) = lVar30;
          if ((*(int *)(param_2 + 0x20) < 1) &&
            ...
            *(undefined4 *)(lVar24 + 8 + uVar20 * 0x18) = 0;
            ...
            if (*(int *)(param_2 + 0x24) != 0) {
              FUN_1400e6100(param_1,5,param_2);
            }
          }
          else {
          ...
          lVar15 = *(longlong *)(*(longlong *)(param_2 + 0x28) + 0x10);
          if (*(int *)(param_2 + 0x24) != 0) {
            lVar16 = FUN_1400e6100(param_1,9,param_2);
            lVar30 = param_1[0x12];
          ...
          lVar16 = FUN_1400e6100(param_1,(*(int *)(param_2 + 0x20) != 0) + '\n',param_2);
          lVar30 = param_1[0x12];
      ...
      case 0x13:
        ...
        if ((*(uint *)(lVar24 + 0xc) & 0x1000) == 0 && *(int *)(lVar24 + 0x34) == 0) {
          ...
          if (iVar3 < *(int *)(lVar24 + 0x20)) {
            lVar14 = FUN_1400e6100(param_1,0xb,lVar24);
            lVar15 = param_1[0x12];
              ...
              do {
                ...
                if ((uVar23 >> (uVar28 & 0x3f) & 1) != 0) {
                  *(ulonglong *)(param_1[5] + (uVar20 >> 6) * 8) = uVar23 & ~(1L << (uVar28 & 0x3f))
                  ;
                  lVar15 = FUN_1400e6100(param_1,0xf,0);
...
LAB_1400e3a49:
            ...
            if (iVar3 != *(int *)(lVar24 + 0x24)) {
              lVar16 = FUN_1400e6100(param_1,9,lVar24);
              lVar24 = param_1[0x12];
            ...
            lVar16 = FUN_1400e6100(param_1,10,lVar24);
            lVar15 = param_1[0x12];
            ...
            for (uVar28 = *(uint *)(lVar30 + 0xc + uVar26 * 0x18);
              ...
              if ((uVar26 >> (uVar28 & 0x3f) & 1) != 0) {
                *(ulonglong *)(param_1[5] + (ulonglong)(uVar28 >> 6) * 8) =
                ...
                lVar30 = FUN_1400e6100(param_1,0xf,0);
          ...
          if (*(int *)(lVar30 + 8 + uVar26 * 0x18) == 1) {
            ...
            *(longlong *)(lVar30 + 0x10 + uVar26 * 0x18) = lVar17;
            ...
            lVar16 = FUN_1400e6100(param_1,uVar22,lVar24);
...
LAB_1400e3c1d:
            ...
            *(longlong *)(lVar16 + 0x10 + uVar20) = lVar17;
            ...
            if (iVar3 == *(int *)(lVar24 + 0x24)) {
              ...
              lVar24 = *plVar29;
              *(longlong *)(lVar16 + 0x10 + uVar20) = lVar17;
              if (lVar17 == *(longlong *)(param_1[0x12] + 0x10 + lVar24 * 0x20)) goto LAB_1400e3c1d;
...
LAB_1400e3d9d:
            param_1[8] = param_1[1];
            FUN_1404210f0(param_1[9],param_1[2],param_1[3] - param_1[2]);
            FUN_1404210f0(param_1[0xc],param_1[5],param_1[6] - param_1[5]);
            *(undefined1 *)((longlong)param_1 + 0xf2) = 1;
          }
          else if (param_1[8] == param_1[1]) {
...
LAB_1400e3ddd:
    cVar12 = (char)uVar31;
    lVar15 = param_1[0x16];
    if (lVar15 == 0) goto LAB_1400e40d9;
    while (param_2 == 0) {
      ...
      case 9:
        ...
        *(undefined4 *)(lVar24 + lVar30) = 0xb;
        param_1[0x16] = param_1[0x16] + 1;
        FUN_1400e62f0(param_1,*(undefined4 *)(lVar16 + 0xc + uVar26 * 0x18));
        break;
      case 10:
        uVar31 = 0;
        local_res10 = 0;
...
LAB_1400e40b5:
      ...
      cVar12 = (char)uVar31;
      lVar15 = param_1[0x16];
      if (lVar15 == 0) goto joined_r0x0001400e2f95;
    }
  } while( true );
}
