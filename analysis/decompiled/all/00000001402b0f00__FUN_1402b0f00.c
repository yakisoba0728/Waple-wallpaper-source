...
undefined4 *
FUN_1402b0f00(undefined8 param_1,undefined4 *param_2,undefined4 *param_3,longlong param_4,
  ...
  *(undefined1 *)((longlong)puVar10 + 3) = 0;
  ...
  if (iVar6 < 0) {
    *param_2 = *param_3;
    ...
    param_2[3] = uVar4;
    puVar13 = auStack_d8;
    if (local_60 < 0x10) goto LAB_1402b1215;
    if (DAT_140472230 != '\0') {
...
LAB_1402b11d6:
  ...
  *(undefined8 *)(puVar13 + -8) = 0x1402b1215;
  thunk_FUN_14028af80(ppppuVar7);
LAB_1402b1215:
  *(undefined8 *)(puVar13 + -8) = 0x1402b1224;
  return param_2;
}
