// Function: FUN_140309880
// Addr: 140309880
// Size: 210 bytes


void FUN_140309880(longlong *param_1,ulonglong param_2)

{
  ...
  if (uVar6 == 0) {
    if (uVar5 != 0) {
      func_0x000140421870(param_2,0,(ulonglong)uVar5 << 2);
    }
    goto LAB_1403099cc;
  }
  if (uVar5 == 0) goto LAB_1403099cc;
  uVar12 = 0;
  if ((uVar5 < 2) ||
     ((param_2 <= uVar6 + (ulonglong)(uVar5 - 1) * 4 &&
      (uVar6 <= param_2 + (ulonglong)(uVar5 - 1) * 4)))) goto LAB_140309990;
  if (uVar5 < 0x10) {
LAB_140309961:
    do {
    ...
    if (1 < ((byte)uVar5 & 0xf)) goto LAB_140309961;
  }
