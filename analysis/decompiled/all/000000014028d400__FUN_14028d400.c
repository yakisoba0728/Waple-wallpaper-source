// Function: FUN_14028d400
// Addr: 14028d400
// Size: 181 bytes


undefined1 (*) [32]
FUN_14028d400(undefined1 (*param_1) [32],undefined1 (*param_2) [32],byte param_3)

{
  ...
  pauVar20 = param_2;
  if (((uVar21 & 0xffffffffffffffe0) == 0) || ((DAT_1404dc0dc & 0x20) == 0)) {
    if (((uVar21 & 0xfffffffffffffff0) != 0) && ((DAT_1404dc0dc & 4) != 0)) {
    ...
    do {
      ...
      if (uVar19 != 0) goto code_r0x00014028d4b9;
    ...
    if ((uVar21 & 0x1c) != 0) {
      ...
      auVar2 = vpmaskmovd_avx2(*(undefined1 (*) [32])(&DAT_140429b20 + -uVar22),*pauVar20);
      auVar25 = vpcmpeqb_avx2(auVar2,auVar25);
      auVar25 = vpand_avx2(auVar25,*(undefined1 (*) [32])(&DAT_140429b20 + -uVar22));
