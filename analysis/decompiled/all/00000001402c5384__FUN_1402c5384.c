// Function: FUN_1402c5384
// Addr: 1402c5384
// Size: 219 bytes


ulonglong FUN_1402c5384(byte *param_1)
...
LAB_1402c53bb:
    ...
    if (*(int *)(param_1 + 0x34) != 0) goto LAB_1402c53bb;
    if (uVar1 == 0x49) {
      ...
      if (uVar1 == 0x68) {
        ...
        if (uVar1 == 0x6a) {
          ...
          param_1[0x36] = 0;
          param_1[0x37] = 0;
          goto UNWIND_INFO_1402c5461_UnwindCodes_98__UnwindOpCode;
        }
        if (uVar1 != 0x6c) {
          if (uVar1 == 0x74) {
            param_1[0x34] = 7;
...
UNWIND_INFO_1402c5461_UnwindCodes_98__UnwindOpCode:
