...
uint FUN_1403d1e80(longlong param_1,undefined8 param_2,uint param_3,undefined4 *param_4,uint param_5
...

{
  ...
  local_48 = DAT_1404dc040 ^ (ulonglong)auStack_678;
...
LAB_1403d1f21:
      ...
      if (param_3 != 0) {
        do {
          ...
          if (uVar2 != 0) {
            do {
              if (local_248[uVar5] == 0) {
                return (int)uVar5 + uVar7;
              }
