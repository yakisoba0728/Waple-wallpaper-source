// Function: FUN_14007e010
// Addr: 14007e010
// Size: 394 bytes


void FUN_14007e010(longlong param_1,ulonglong param_2)

{
  ...
  FUN_14003e5e0(param_1 + 0x18,2L << (bVar12 & 0x3f),plVar2);
  *(longlong *)(param_1 + 0x38) = lVar16;
  *(longlong *)(param_1 + 0x30) = lVar16 + -1;
  plVar7 = (longlong *)**(undefined8 **)(param_1 + 8);
joined_r0x00014007e092:
  do {
    while( true ) {
      if (plVar7 == plVar2) {
        uStackX_10 = 0;
        func_0x00014007f340(&uStackX_10);
        return;
      }
