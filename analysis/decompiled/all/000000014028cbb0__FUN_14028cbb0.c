...
undefined1 (*) [16]
FUN_14028cbb0(undefined1 (*param_1) [16],undefined1 (*param_2) [16],undefined1 (*param_3) [16],
             ulonglong param_4)
  ...
  if (param_4 != 0) {
    ...
    if (param_4 <= uVar11) {
      ...
      if (param_4 < 0x11) {
        ...
        puVar2 = *param_1;
        uVar17 = (uint)((ulonglong)local_78 >> 0x20);
            ...
            if (uVar10 != 0) {
              ...
              if (uVar8 != 0) {
                do {
                  ...
                  auVar15._0_4_ = (uint)local_78 ^ *(uint *)*pauVar7;
          ...
          if (uVar4 != 0) {
            ...
            if (uVar10 != 0) {
              do {
                ...
                auVar14._0_4_ = *(uint *)*pauVar7 ^ (uint)local_78;
        ...
        if ((auVar12 == (undefined1  [16])0x0) &&
           (local_78 = param_2, iVar5 = memcmp(param_2 + 1,param_3,param_4 - 0x10), iVar5 == 0)) {
          return param_2;
        }
        ...
        if (((uVar11 != 0) &&
           ...
           (local_78 = param_1, cVar3 = FUN_14028eb70(local_a8), cVar3 != '\0')) {
          return local_78;
        }
      }
    }
