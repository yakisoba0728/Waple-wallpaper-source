// Function: FUN_1400cb480
// Addr: 1400cb480
// Size: 13 bytes


undefined8 * FUN_1400cb480(float *param_1,undefined8 *param_2,uint *param_3)

{
  ...
  *(uint *)(puVar7 + 2) = *param_3;
  ...
  if (*param_1 < (float)(*(longlong *)(param_1 + 4) + 1) / (float)uVar4) {
    ...
    func_0x0001400cd670(param_1,uVar10);
    puVar11 = *(undefined8 **)(param_1 + 2);
    puVar5 = *(undefined8 **)
              (*(longlong *)(param_1 + 6) + 8 + (uVar12 & *(ulonglong *)(param_1 + 0xc)) * 0x10);
    if (puVar5 != puVar11) {
  ...
  *puVar5 = puVar7;
  ...
  if (puVar6 == *(undefined8 **)(param_1 + 2)) {
    *(undefined8 **)(lVar8 + uVar12 * 0x10) = puVar7;
    ...
    if (*(undefined8 **)(lVar8 + 8 + uVar12 * 0x10) != puVar5) goto code_r0x0001400cb6e1;
  }
  *(undefined8 **)(lVar8 + 8 + uVar12 * 0x10) = puVar7;
code_r0x0001400cb6e1:
  *param_2 = puVar7;
  *(undefined1 *)(param_2 + 1) = 1;
  return param_2;
}
