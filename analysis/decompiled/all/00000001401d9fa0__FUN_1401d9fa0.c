// Function: FUN_1401d9fa0
// Addr: 1401d9fa0
// Size: 1402 bytes


void FUN_1401d9fa0(longlong *param_1,longlong *param_2,longlong param_3,undefined1 param_4)
      ...
      if (param_1 != param_2) {
        for (plVar9 = param_1 + 1; plVar9 != param_2; plVar9 = plVar9 + 1) {
          ...
          if (*(uint *)(lVar4 + 4) < *(uint *)(*param_1 + 4)) {
            FUN_1404210f0(param_1 + 1,param_1,(longlong)plVar9 - (longlong)param_1);
            *param_1 = lVar4;
          }
          else {
            plVar8 = plVar9;
    ...
    if (param_3 < 1) {
      ...
      do {
        if (1 < (longlong)param_2 - (longlong)param_1 >> 3) {
          ...
          param_2[-1] = *param_1;
          FUN_1401dc510(param_1,0,(longlong)(param_2 + -1) - (longlong)param_1 >> 3,&local_res8,
                        param_4);
        }
        param_2 = param_2 + -1;
...
joined_r0x0001401da1d3:
    if (plVar8 < param_2) {
      uVar1 = *(uint *)(*plVar8 + 4);
      if (uVar1 <= *(uint *)(*plVar7 + 4)) {
        if (*(uint *)(*plVar7 + 4) != uVar1) goto joined_r0x0001401da20f;
        if (plVar9 != plVar8) {
          lVar4 = *plVar9;
          *plVar9 = *plVar8;
          *plVar8 = lVar4;
      ...
      plVar8 = plVar8 + 1;
      goto joined_r0x0001401da1d3;
    }
joined_r0x0001401da20f:
    ...
    if ((longlong)plVar7 - (longlong)param_1 >> 3 < (longlong)param_2 - (longlong)plVar9 >> 3) {
      FUN_1401d9fa0(param_1,plVar7,param_3,param_4);
      plVar7 = param_2;
      param_1 = plVar9;
    }
    else {
      FUN_1401d9fa0(plVar9,param_2,param_3,param_4);
    }
