...
void FUN_14035e030(longlong param_1)

{
  ...
  lVar1 = param_1 + 0x28;
  FUN_1403a31f0(lVar1,0,FUN_14040b580);
  ...
  *(undefined4 *)(puVar6 + 3) = *(undefined4 *)(param_1 + 0x74);
  uVar7 = 0;
  FUN_1403a31f0(lVar1,0,FUN_1403e4f90);
  lVar9 = 0;
  do {
    FUN_1403a2cd0(lVar1,(&DAT_14045c110)[lVar9 * 2],*(undefined4 *)(&DAT_14045c114 + lVar9 * 8),1);
    FUN_1403a31f0(lVar1,0,0);
    uVar8 = (int)uVar7 + 1;
    uVar7 = (ulonglong)uVar8;
    lVar9 = lVar9 + 1;
  } while (uVar8 < 0xb);
  FUN_1403a31f0(lVar1,0,FUN_1403bf8f0);
  while (uVar8 < 0x11) {
    FUN_1403a2cd0(lVar1,(&DAT_14045c110)[uVar7 * 2],*(undefined4 *)(&DAT_14045c114 + uVar7 * 8),1);
    uVar8 = (int)uVar7 + 1;
    uVar7 = (ulonglong)uVar8;
  }
  return;
