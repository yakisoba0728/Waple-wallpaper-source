// Function: FUN_1402ee6f0
// Addr: 1402ee6f0
// Size: 198 bytes


int FUN_1402ee6f0(undefined8 *param_1,longlong param_2)

{
  ...
  *(undefined8 *)(param_2 + 100) = *(undefined8 *)((longlong)param_1 + 100);
  uVar6 = FUN_1402f7fa0(uVar6,uVar1,local_res8);
  *(undefined8 *)(param_2 + 0x20) = uVar6;
  if (local_res8[0] == 0) {
    FUN_1404210f0(uVar6,param_1[4],*(undefined4 *)(param_2 + 0x28));
  }
  return local_res8[0];
}
