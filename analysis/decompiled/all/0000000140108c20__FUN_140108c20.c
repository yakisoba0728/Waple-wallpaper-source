// Function: FUN_140108c20
// Addr: 140108c20
// Size: 1364 bytes


void FUN_140108c20(int *param_1,int *param_2,int param_3,float *param_4,int *param_5,int *param_6)

{
  ...
  if (param_3 == 1) {
    fVar8 = param_4[3];
    fVar15 = (DAT_140492704 - fVar8) + (DAT_140492704 - fVar8);
    if (fVar16 / fVar17 < fVar10 / fVar11) {
      fVar7 = (fVar16 - (fVar17 / fVar11) * fVar10) * DAT_1404926c0;
      fVar8 = fVar8 * fVar7;
      fVar7 = fVar15 * fVar7;
      fVar14 = fVar8 + fVar8;
      goto LAB_140108f57;
    ...
    if (param_3 == 2) goto LAB_140108f57;
    if (param_3 == 3) {
      fVar14 = (fVar16 - fVar10) * *param_4;
      fVar7 = (DAT_140492704 - *param_4) * (fVar16 - fVar10);
      fVar9 = (DAT_140492704 - param_4[1]) * (fVar17 - fVar11);
    ...
    if (param_3 == 4) {
      fVar15 = *param_4;
      fVar1 = param_4[1];
      fVar12 = DAT_140492704 - fVar15;
      fVar13 = DAT_140492704 - fVar1;
      ...
      fVar11 = (float)FUN_14041e350((DAT_140492704 - param_4[2]) + DAT_140492704);
      fVar10 = DAT_1404929b0;
      if (DAT_1404929b0 <= fVar11 - fVar8) {
        fVar10 = fVar11 - fVar8;
      }
    ...
    if (fVar10 / fVar11 < fVar16 / fVar17) {
      fVar14 = (fVar16 - (fVar17 / fVar11) * fVar10) * DAT_1404926c0;
      fVar8 = fVar8 * fVar14;
  ...
  fVar14 = 0.0;
  fVar7 = 0.0;
  fVar9 = (fVar17 - (fVar16 / fVar10) * fVar11) * DAT_1404926c0;
  fVar8 = fVar8 * fVar9;
  fVar9 = fVar15 * fVar9;
  fVar18 = fVar8 + fVar8;
LAB_140108f57:
