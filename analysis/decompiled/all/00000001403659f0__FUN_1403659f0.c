// Function: FUN_1403659f0
// Addr: 1403659f0
// Size: 918 bytes


void FUN_1403659f0(ulonglong *param_1,uint *param_2,uint *param_3,uint *param_4)
...
joined_r0x000140365bc3:
  do {
    puVar11 = param_3;
    if (param_4 <= puVar13) {
joined_r0x000140365cb0:
    ...
    if (-1 < (int)((uint)(uVar6 < uVar12) - (uint)(uVar12 < uVar6))) {
      ...
      if ((int)((uint)(uVar7 < uVar10) - (uint)(uVar10 < uVar7)) < 0) goto joined_r0x000140365cb0;
      if (puVar14 != puVar13) {
        uVar1 = *(undefined8 *)(puVar13 + 2);
