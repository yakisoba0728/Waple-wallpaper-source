// Function: FUN_140137670
// Addr: 140137670
// Size: 687 bytes


void FUN_140137670(longlong param_1,ulonglong param_2)

{
  ...
  FUN_14004f190(param_1 + 0x18,2L << (bVar9 & 0x3f),plVar2);
  *(longlong *)(param_1 + 0x38) = lVar13;
  *(longlong *)(param_1 + 0x30) = lVar13 + -1;
  plVar6 = (longlong *)**(undefined8 **)(param_1 + 8);
joined_r0x0001401376f3:
  do {
    while( true ) {
      while( true ) {
        if (plVar6 == plVar2) {
          local_res10 = 0;
          FUN_140138370(&local_res10);
          return;
        }
        plVar12 = plVar6 + 2;
