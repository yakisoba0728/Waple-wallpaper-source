// Function: FUN_1401dd8a0
// Addr: 1401dd8a0
// Size: 81 bytes


undefined8 * FUN_1401dd8a0(longlong param_1,undefined8 *param_2)

{
  ...
  *(undefined4 *)(param_2 + 5) = *(undefined4 *)(param_1 + 0x16c);
  ...
  if (plVar1 != (longlong *)0x0) {
    ...
    uVar2 = FUN_1401dd8a0(*(undefined8 *)(param_1 + 0x180),auStack_88);
    puVar3 = (undefined8 *)FUN_14005ed80(auStack_48,uVar2,param_2);
    uVar2 = puVar3[1];
    *param_2 = *puVar3;
    param_2[1] = uVar2;
    uVar2 = puVar3[3];
