// Function: FUN_1403bc130
// Addr: 1403bc130
// Size: 908 bytes


int * FUN_1403bc130(longlong param_1,int *param_2,int param_3)

{
  ...
  do {
    pcVar23 = (char *)&DAT_1404e4f20;
    cVar13 = FUN_1403f88b0(param_2,param_2[1] + 1,1,0);
    if (cVar13 == '\0') {
      lVar19 = 4;
    ...
    if (cVar13 == '\0') {
      ...
      for (pbVar21 = puVar24 + 0x10;
        ...
        if (*pcVar23 != '\0') {
          ...
          pcVar23[6] = -1;
          pcVar23[7] = -1;
          puVar15 = (undefined4 *)FUN_1403ed560(pcVar23,uVar22,1);
        ...
        if (pcVar23[0x30] != '\0') {
          ...
          pcVar23[0x36] = -1;
          pcVar23[0x37] = -1;
          puVar15 = (undefined4 *)FUN_1403ed560(pcVar23 + 0x30,uVar22,1);
          if (puVar15 != (undefined4 *)0x0) {
            uVar18 = (ulonglong)(uVar22 >> 6 & 7);
            *(ulonglong *)(puVar15 + uVar18 * 2 + 2) =
                 *(ulonglong *)(puVar15 + uVar18 * 2 + 2) | 1L << (ulonglong)(uVar22 & 0x3f);
      ...
      FUN_140371340(puVar24 + 8,pcVar23,param_3);
    }
    else if (cVar13 == '\x02') {
      FUN_14036fbd0(puVar24 + (ulonglong)(byte)puVar24[10] * 0x100 + (ulonglong)(byte)puVar24[0xb],
                    pcVar23,param_3);
      FUN_14036fbd0(puVar24 + (ulonglong)(byte)puVar24[0xd] + (ulonglong)(byte)puVar24[0xc] * 0x100,
                    pcVar23 + 0x30,param_3);
    }
    else if ((cVar13 == '\x03') && ((uint)(byte)puVar24[8] * 0x100 + (uint)(byte)puVar24[9] != 0)) {
      FUN_1403a3350(pcVar23,0,param_3 + -1);
      FUN_1403a3350(pcVar23 + 0x30,0,param_3 + -1);
    }
