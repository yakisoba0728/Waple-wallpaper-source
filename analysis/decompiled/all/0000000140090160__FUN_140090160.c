// Function: FUN_140090160
// Addr: 140090160
// Size: 436 bytes


ulonglong FUN_140090160(undefined8 param_1,undefined8 param_2,longlong *param_3,longlong param_4,
                       uint *param_5)

{
  ...
  uVar17 = FUN_140090360(param_1,param_2,param_3,param_4,param_5);
  if ((char)uVar17 == '\0') {
LAB_14009034f:
...
LAB_1400902d6:
  ...
  if (param_4 - (longlong)pcVar18 < 6) {
    local_58 = 0;
    local_60 = (char *)func_0x00014028aff0(0x50);
    ...
    *(undefined8 *)local_60 = s_additional_six_characters_expect_1404853e0._0_8_;
    ...
    *param_3 = (longlong)pcVar19;
    if (cVar1 == '\\') {
      ...
      *param_3 = (longlong)(pcVar18 + 2);
      pcVar19 = pcVar18 + 2;
      if (cVar1 == 'u') {
        uVar17 = FUN_140090360(param_1,param_2,param_3,param_4,auStack_68);
        if ((char)uVar17 == '\0') goto LAB_14009034f;
        *param_5 = *param_5 & 0x3ff;
        uVar16 = auStack_68[0] & 0x3ff;
    ...
    *(undefined8 *)local_60 = s_expecting_another__u_token_to_be_140485390._0_8_;
    *(undefined8 *)(local_60 + 8) = uVar4;
  ...
  local_48 = 0x4f;
  bVar15 = FUN_1400905b0(param_1,&local_60,param_2,pcVar19);
  if (0xf < local_48) {
    uVar17 = local_48 + 1;
    pcVar18 = local_60;
    if (0xfff < uVar17) {
    ...
    func_0x00014028b040(pcVar18,uVar17);
  }
