// Function: FUN_140219880
// Addr: 140219880
// Size: 317 bytes


void FUN_140219880(undefined4 *param_1,undefined8 param_2,undefined4 *param_3,longlong param_4,
                  code *param_5)

{
  ...
  do {
    if (param_4 < 0x21) {
      FUN_140219d80(param_1,param_2,param_3);
      return;
    }
    lVar1 = param_4 + -0x20;
    ...
    while( true ) {
      while (cVar6 = (*param_5)(puVar7,puVar8), cVar6 == '\0') {
        ...
        *(undefined8 *)(param_3 + 0xe) = uVar4;
        if (puVar8 == param_1 + 0x1f0) goto code_r0x000140219a2f;
        puVar8 = puVar8 + 0x10;
    ...
    lVar11 = 0x800;
    puVar7 = puVar8;
code_r0x000140219a2f:
    param_3 = (undefined4 *)FUN_140219d80(puVar7,(longlong)param_1 + lVar11);
    param_1 = puVar2;
    param_4 = lVar9;
  } while( true );
}
