// Function: FUN_1402f53d0
// Addr: 1402f53d0
// Size: 298 bytes


int FUN_1402f53d0(longlong *param_1,uint *param_2,undefined8 *param_3)
...
LAB_1402f544d:
    ...
    if (uVar3 == 4) {
      puVar5 = (undefined8 *)(**(code **)(lVar1 + 8))(lVar1,0x48);
      if (puVar5 == (undefined8 *)0x0) goto LAB_1402f544d;
      *puVar5 = 0;
      puVar5[1] = 0;
      puVar5[2] = 0;
      puVar5[3] = 0;
      ...
      puVar5[8] = 0;
      puVar5[6] = lVar1;
      iVar4 = FUN_1402fb390(puVar5,*(undefined8 *)(param_2 + 6));
      if (iVar4 != 0) {
