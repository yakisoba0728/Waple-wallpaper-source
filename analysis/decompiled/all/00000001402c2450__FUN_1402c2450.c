// Function: FUN_1402c2450
// Addr: 1402c2450
// Size: 515 bytes


ulonglong FUN_1402c2450(longlong param_1,undefined1 param_2)
...
LAB_1402c24ce:
  ...
  if (*(int *)(param_1 + 0x30) < 0) {
    ...
    *(uint *)(param_1 + 0x28) = uVar6 & 0xfffffff7;
    FUN_1402c189c(param_1 + 0x50,(longlong)*(int *)(param_1 + 0x30),*(undefined8 *)(param_1 + 8));
  }
  if (uVar7 == 0) {
  ...
  *(undefined1 *)(param_1 + 0x4c) = 0;
  if (lVar8 == 8) {
    FUN_1402c3404(param_1,uVar7);
  }
  else {
    FUN_1402c3080(param_1,uVar7 & 0xffffffff,param_2);
  }
