// Function: FUN_140372f00
// Addr: 140372f00
// Size: 1157 bytes


undefined8
FUN_140372f00(ulonglong *param_1,longlong param_2,float param_3,byte *param_4,uint param_5)
        ...
        *param_1 = (ulonglong)pbVar11;
        if (uVar13 < uVar8) {
          ...
          if (3 < uVar8 - uVar13) {
            do {
              iVar9 = (int)uVar14;
              *(float *)(lVar6 + 4 + uVar14 * 0xc) =
                   (float)(int)(char)*pbVar11 * param_3 + *(float *)(lVar6 + 4 + uVar14 * 0xc);
              *(float *)(lVar6 + 4 + (ulonglong)(iVar9 + 1) * 0xc) =
                   (float)(int)(char)pbVar11[1] * param_3 +
                   *(float *)(lVar6 + 4 + (ulonglong)(iVar9 + 1) * 0xc);
              uVar13 = iVar9 + 4;
              uVar14 = (ulonglong)uVar13;
              *(float *)(lVar6 + 4 + (ulonglong)(iVar9 + 2) * 0xc) =
                   (float)(int)(char)pbVar11[2] * param_3 +
                   *(float *)(lVar6 + 4 + (ulonglong)(iVar9 + 2) * 0xc);
              pbVar5 = pbVar11 + 3;
              pbVar11 = pbVar11 + 4;
              *(float *)(lVar6 + 4 + (ulonglong)(iVar9 + 3) * 0xc) =
                   (float)(int)(char)*pbVar5 * param_3 +
                   *(float *)(lVar6 + 4 + (ulonglong)(iVar9 + 3) * 0xc);
            } while (uVar13 < uVar8 - 3);
            uVar10 = uVar14;
            if (uVar8 <= uVar13) goto LAB_140373405;
          }
          do {
            bVar4 = *pbVar11;
            pbVar11 = pbVar11 + 1;
            uVar13 = (int)uVar10 + 1;
            uVar14 = (ulonglong)uVar13;
            *(float *)(lVar6 + 4 + uVar10 * 0xc) =
                 (float)(int)(char)bVar4 * param_3 + *(float *)(lVar6 + 4 + uVar10 * 0xc);
            uVar10 = uVar14;
          } while (uVar13 < uVar8);
        }
LAB_140373405:
        ...
        *param_1 = (ulonglong)pbVar11;
        if (uVar13 < uVar8) {
          lVar6 = *(longlong *)(param_2 + 8);
          if (uVar8 - uVar13 < 4) goto LAB_1403732b1;
          do {
            iVar9 = (int)uVar14;
            *(float *)(lVar6 + 4 + uVar14 * 0xc) =
                 ...
                 *(float *)(lVar6 + 4 + uVar14 * 0xc);
            *(float *)(lVar6 + 4 + (ulonglong)(iVar9 + 1) * 0xc) =
                 (float)(int)(short)((ushort)pbVar11[3] + (ushort)pbVar11[2] * 0x100) * param_3 +
                 *(float *)(lVar6 + 4 + (ulonglong)(iVar9 + 1) * 0xc);
          ...
          if (3 < uVar8 - uVar13) {
            do {
              ...
              *(float *)(lVar6 + 4 + uVar14 * 0xc) =
                   ...
                   *(float *)(lVar6 + 4 + uVar14 * 0xc);
              *(float *)(lVar6 + 4 + (ulonglong)(iVar9 + 1) * 0xc) =
                   (float)(int)((((uint)pbVar11[5] + (uint)pbVar11[4] * 0x100) * 0x100 +
                                (uint)pbVar11[6]) * 0x100 + (uint)pbVar11[7]) * param_3 +
                   *(float *)(lVar6 + 4 + (ulonglong)(iVar9 + 1) * 0xc);
              uVar13 = iVar9 + 4;
              uVar14 = (ulonglong)uVar13;
              *(float *)(lVar6 + 4 + (ulonglong)(iVar9 + 2) * 0xc) =
                   (float)(int)((((uint)pbVar11[9] + (uint)pbVar11[8] * 0x100) * 0x100 +
            ...
            uVar10 = uVar14;
            if (uVar8 <= uVar13) goto LAB_14037316c;
          }
          do {
            pbVar5 = pbVar11 + 1;
            bVar4 = *pbVar11;
