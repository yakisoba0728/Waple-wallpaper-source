...
undefined4 *
FUN_1402aa310(undefined8 param_1,undefined4 *param_2,longlong *param_3,longlong *param_4,
...

{
  ...
  local_80 = param_6;
  local_88 = param_5;
  FUN_1402a2b80(param_1,local_68);
  if ((char)param_3[1] == '\0') {
  ...
  if (*param_3 == 0) {
    if (*param_4 != 0) goto LAB_1402aa3b4;
  }
  else if (*param_4 == 0) goto LAB_1402aa3b4;
  *param_7 = *param_7 | 1;
LAB_1402aa3b4:
  if (local_58 == 0) {
    *param_7 = *param_7 | 2;
    ...
    if ((ulonglong)param_8[2] < local_58) {
      FUN_140015830(param_8,local_58 - param_8[2],0);
    }
    else {
      FUN_140015650();
    }
