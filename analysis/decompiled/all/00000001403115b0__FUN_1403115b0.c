// Function: FUN_1403115b0
// Addr: 1403115b0
// Size: 151 bytes


longlong FUN_1403115b0(longlong param_1,uint *param_2)

{
  ...
  *param_2 = 0;
  ...
  if ((char)bVar2 < '\0') {
    bVar3 = FUN_1402f52b0(param_1);
    uVar8 = (bVar2 & 0x7f) << 8 | (uint)bVar3;
  }
  lVar4 = FUN_1402f80c0(uVar1,2,0,uVar8,0,local_res8);
  if (local_res8[0] == 0) {
...
code_r0x000140311713:
        ...
        if ((char)*pbVar6 < '\0') {
          if (uVar7 < uVar11 * 2) goto code_r0x000140311713;
          uVar7 = 0;
          pbVar6 = pbVar5;
          if (uVar11 != 0) {
            do {
          ...
          if (uVar7 < uVar11) goto code_r0x000140311713;
          uVar7 = 0;
          pbVar6 = pbVar5;
          if (uVar11 != 0) {
            do {
