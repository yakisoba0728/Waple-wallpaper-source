// Function: FUN_1403ef5a0
// Addr: 1403ef5a0
// Size: 96 bytes


void FUN_1403ef5a0(longlong param_1,longlong param_2)

{
  ...
  FUN_1403f59b0(*(undefined8 *)(param_2 + 0x10),*(undefined8 *)(param_2 + 0x18),
  ...
  FUN_1403f58d0(*(undefined8 *)(param_2 + 0x10),*(undefined8 *)(param_2 + 0x18),
                *(undefined8 *)(param_2 + 0x20));
  ...
  if ((0 < *(int *)(param_2 + 0x80)) && (0 < *(int *)(param_2 + 0x84))) {
    ...
    *(int *)(param_2 + 0x84) = *(int *)(param_2 + 0x84) + -1;
    FUN_1403787c0(puVar3,auStackX_8,param_2);
    *(int *)(param_2 + 0x80) = *(int *)(param_2 + 0x80) + 1;
  }
  lVar1 = *(longlong *)(param_2 + 0x10);
  if (*(longlong *)(lVar1 + 0x98) == 0) {
  ...
  if (*(longlong *)(lVar1 + 0x98) != 0) {
    uVar2 = *(undefined8 *)(*(longlong *)(lVar1 + 0x98) + 8);
                    ...
                    /* WARNING: Could not recover jumptable at 0x0001403ef6cd. Too many branches */
