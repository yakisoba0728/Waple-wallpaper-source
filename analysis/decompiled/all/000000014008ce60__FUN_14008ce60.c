// Function: FUN_14008ce60
// Addr: 14008ce60
// Size: 304 bytes


longlong * FUN_14008ce60(longlong *param_1,byte param_2)

{
  ...
  if (*(int *)((longlong)iVar9 + 0x10 + (longlong)param_1) == 0) {
    ...
    if ((plVar2 != (longlong *)0x0) && (plVar2 != param_1)) {
      ...
      iVar9 = *(int *)(lVar10 + 4);
      uVar12 = 0;
      if (*(int *)((longlong)iVar9 + 0x10 + (longlong)param_1) != 0) goto LAB_14008d023;
    }
...
LAB_14008cf68:
      ...
      do {
        lVar10 = *param_1;
        if (lVar11 < 1) goto LAB_14008cf68;
...
LAB_14008d023:
  *(undefined8 *)((longlong)*(int *)(*param_1 + 4) + 0x28 + (longlong)param_1) = 0;
  ...
  func_0x000140013c20(lVar10,uVar8 | *(uint *)(lVar10 + 0x10) | uVar12,0);
  ...
  if (((*(int *)(lVar10 + 0x10 + (longlong)param_1) == 0) &&
     ...
     iVar9 == -1)) {
    lVar10 = (longlong)*(int *)(*param_1 + 4) + (longlong)param_1;
    func_0x000140013c20(lVar10,*(uint *)(lVar10 + 0x10) | 4,0);
  }
  plVar2 = *(longlong **)((longlong)*(int *)(*param_1 + 4) + 0x48 + (longlong)param_1);
  if (plVar2 != (longlong *)0x0) {
    (**(code **)(*plVar2 + 0x10))();
