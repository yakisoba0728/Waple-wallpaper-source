...
void FUN_1404a8c58(undefined8 param_1,undefined8 param_2)

{
  ...
  *(int *)((longlong)&puStack_18 + (longlong)piVar7) =
       *(int *)((longlong)&puStack_18 + (longlong)piVar7) + -0x43fff405;
