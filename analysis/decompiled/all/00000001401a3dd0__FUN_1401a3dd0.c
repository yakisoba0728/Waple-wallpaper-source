// Function: FUN_1401a3dd0
// Addr: 1401a3dd0
// Size: 493 bytes


void FUN_1401a3dd0(longlong param_1,longlong *param_2)

{
  ...
  if (lVar6 != *(longlong *)(param_1 + 0x40)) {
    *(undefined8 *)(lVar6 + 0x38) = 0;
    FUN_140037830(lVar6);
    *(longlong *)(param_1 + 0x38) = *(longlong *)(param_1 + 0x38) + 0x40;
    goto LAB_1401a3f89;
  }
  uVar14 = lVar6 - *(longlong *)(param_1 + 0x30);
  ...
  uVar1 = lVar5 + 1;
  uVar7 = *(longlong *)(param_1 + 0x40) - *(longlong *)(param_1 + 0x30) >> 6;
  uVar12 = 0;
...
LAB_1401a3f63:
    ...
    puVar10 = auStack_60;
LAB_1401a3f6d:
    *(undefined8 *)(puVar10 + -8) = 0x1401a3f72;
...
LAB_1401a3fb9:
    ...
    if (uVar13 != 0) {
      if (0xfff < uVar13) {
        uVar7 = uVar13 | 0x27;
        if (uVar7 <= uVar13) goto LAB_1401a3fb9;
        goto LAB_1401a3e9e;
      }
...
LAB_1401a3ec2:
    ...
    *(undefined8 *)(lVar15 + 0x38) = 0;
    ...
    uVar14 = uVar12;
    if (lVar6 != lVar5) {
      FUN_1401a5bd0(*(longlong *)(param_1 + 0x30),lVar6,uVar12);
      lVar5 = *(longlong *)(param_1 + 0x38);
      uVar14 = lVar15 + 0x40;
      lVar8 = lVar6;
    }
    ...
    if (plVar9 != (longlong *)0x0) {
      ...
      if ((0xfff < (*(longlong *)(param_1 + 0x40) - lVar6 & 0xffffffffffffffc0U)) &&
         (lVar5 = lVar6 - *(longlong *)(lVar6 + -8), lVar6 = *(longlong *)(lVar6 + -8),
         puVar10 = auStack_68, 0x1f < lVar5 - 8U)) goto LAB_1401a3f63;
      goto LAB_1401a3f6d;
    }
  }
  *(ulonglong *)(param_1 + 0x30) = uVar12;
  *(ulonglong *)(param_1 + 0x38) = uVar1 * 0x40 + uVar12;
  *(ulonglong *)(param_1 + 0x40) = uVar13 + uVar12;
LAB_1401a3f89:
  plVar9 = (longlong *)param_2[7];
  if (plVar9 != (longlong *)0x0) {
    pcVar4 = *(code **)(*plVar9 + 0x20);
    *(undefined8 *)(puVar11 + -8) = 0x1401a3f9e;
