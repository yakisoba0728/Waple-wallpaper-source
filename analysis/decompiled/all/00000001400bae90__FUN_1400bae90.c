// Function: FUN_1400bae90
// Addr: 1400bae90
// Size: 305 bytes


char * FUN_1400bae90(int *param_1,longlong param_2,longlong param_3)

{
  ...
  if ((param_1[0x61] == 0) || (param_1[0x61] == 1)) {
    pcVar2 = (char *)FUN_1400bb000(param_1);
    ...
    if (*pcVar2 != '$') goto LAB_1400bafcd;
    bVar1 = 1;
    param_1[0x61] = 1;
    if (*pcVar2 != '$') goto code_r0x0001400bafbc;
  }
  else {
    param_1[0x61] = 0;
    pcVar2 = (char *)0x0;
code_r0x0001400bafbc:
    bVar1 = 0;
  }
