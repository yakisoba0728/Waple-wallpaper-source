// Function: FUN_1400ac690
// Addr: 1400ac690
// Size: 1711 bytes


char * FUN_1400ac690(longlong param_1,longlong *param_2,longlong *param_3)

{
  ...
  if (uVar25 < 8) {
    ...
    if (*(uint *)(param_1 + 0x28) >> bVar14 != 0) goto LAB_1400acd34;
...
LAB_1400ac8e1:
        ...
        if ((uVar19 & 0xf0) != 0) {
          uVar19 = uVar19 >> 4 & 0xf;
          uVar24 = (*(uint *)(&DAT_1404827b0 + (ulonglong)uVar19 * 8) & (uint)uVar27) +
                   (uVar24 & 0xff);
        ...
        if (uVar19 >> 0x18 == 0x40) {
          ...
          uVar19 = (*(uint *)(&DAT_1404827b0 + (ulonglong)uVar11 * 8) & (uint)uVar28) +
                   (uVar19 >> 8) & 0x7fff;
          uVar28 = (ulonglong)(uVar19 + 1);
          if (uVar28 <= (ulonglong)((longlong)puVar23 - local_80)) goto LAB_1400aca8c;
          ...
          if ((uint)(iVar21 + 1 + iVar26) <= *(uint *)(param_1 + 0x38)) goto code_r0x0001400ac9f0;
      ...
      if (uVar19 < 0x20000000) {
        ...
        uVar27 = uVar27 >> (sbyte)(uVar19 & 0xf);
        if ((int)uVar19 < 0) goto LAB_1400acb93;
        if (0x3fffffff < uVar19) goto LAB_1400ac8e1;
        if (uVar19 < 0x20000000) {
          pcVar12 = "#deflate: internal error: inconsistent Huffman decoder state";
...
LAB_1400acd34:
    pcVar12 = "#deflate: internal error: inconsistent n_bits";
LAB_1400acc2a:
    if (param_2 == (longlong *)0x0) goto LAB_1400acc46;
  }
  if (*param_2 != 0) {
...
code_r0x0001400ac9f0:
  ...
  if (uVar22 != 0) {
    FUN_1404210f0(puVar23,uVar20 + param_1 + 0x2070,uVar22);
    puVar23 = (undefined8 *)((longlong)puVar23 + uVar22);
  }
  if (uVar24 != 0) {
