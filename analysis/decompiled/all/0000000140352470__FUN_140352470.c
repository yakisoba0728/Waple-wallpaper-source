// Function: FUN_140352470
// Addr: 140352470
// Size: 433 bytes


void FUN_140352470(longlong param_1,undefined8 param_2,int param_3,int param_4)

{
  ...
  local_48 = DAT_1404dc110 ^ (ulonglong)auStack_e8;
  iVar9 = 0;
LAB_1403524ac:
  do {
    iVar8 = 0;
    ...
    if (*(short *)(param_1 + 0x78) != 0) {
      do {
        ...
        *(undefined8 *)(param_1 + 0x68) = 0;
        ...
        cVar5 = FUN_1403515a0(param_1,iVar7,uVar10);
        if (cVar5 != '\0') {
LAB_1403525fe:
          if ((*(int *)(param_1 + 0x38) != 0x62) || (param_3 == param_4)) goto LAB_14035262b;
        ...
        if (*(longlong *)(param_1 + 0x68) != 0) {
          ...
          cVar5 = FUN_140351cb0(param_1);
          if (cVar5 != '\0') goto LAB_1403525fe;
    ...
    if (*(undefined8 **)(param_1 + 0x60) != (undefined8 *)0x0) {
      ...
      *puVar4 = 0;
      if (*(longlong *)(param_1 + 0x60) != 0) {
        FUN_1403518f0(param_1);
      }
    }
    if (iVar9 + -1 < 0) {
LAB_14035262b:
      func_0x0001402ed2f0(local_48 ^ (ulonglong)auStack_e8);
      return;
    }
    param_4 = param_3 + -1;
