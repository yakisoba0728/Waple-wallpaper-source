...
longlong * FUN_1400118f0(longlong param_1)
...
LAB_1400119c8:
  ...
  if (plVar2 == (longlong *)0x0) {
    plVar5 = (longlong *)FUN_14028af20(0x30);
    ...
    *plVar5 = (longlong)std::numpunct<wchar_t>::vftable;
    FUN_140013500(plVar5,local_98,1);
