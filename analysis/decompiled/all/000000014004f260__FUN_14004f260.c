// Function: FUN_14004f260
// Addr: 14004f260
// Size: 110 bytes


void FUN_14004f260(ulonglong *param_1,ulonglong param_2,undefined8 param_3)
...
code_r0x00014004f2f7:
    uVar3 = *param_1;
    if (param_1[2] - uVar3 < 8) goto code_r0x00014004f342;
    uVar6 = uVar3;
    puVar7 = auStack_28;
    if ((0xfff < (ulonglong)(((longlong)(param_1[2] - uVar3) >> 3) * 8)) &&
       (uVar6 = *(ulonglong *)(uVar3 - 8), puVar7 = auStack_28, 0x1f < (uVar3 - uVar6) - 8))
    goto code_r0x00014004f333;
  }
  else {
    if (uVar2 < 0x1000) {
      unaff_RDI = (undefined8 *)func_0x00014028aff0(uVar2);
      goto code_r0x00014004f2f7;
    }
    if (uVar2 + 0x27 <= uVar2) goto LAB_14004f39e;
...
code_r0x00014004f333:
    pcVar4 = (code *)swi(0x29);
    uVar6 = (*pcVar4)(5);
    puVar7 = auStack_20;
  }
  *(undefined **)(puVar7 + -8) = &UNK_14004f342;
  func_0x00014028b040(uVar6);
code_r0x00014004f342:
