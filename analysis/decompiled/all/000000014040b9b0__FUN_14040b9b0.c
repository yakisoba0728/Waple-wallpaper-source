// Function: FUN_14040b9b0
// Addr: 14040b9b0
// Size: 67 bytes


ulonglong FUN_14040b9b0(longlong param_1,undefined8 param_2,longlong param_3)

{
  ...
  *(byte *)(param_3 + 0xd0) = *(byte *)(param_3 + 0xd0) | 8;
      ...
      do {
        ...
        if ((uVar8 == 0xffffffff) || (uVar8 - (int)uVar6 < 0x100)) {
          ...
          if (1 < (uint)((int)uVar5 - (int)uVar6)) {
            uVar4 = FUN_1403a1af0(param_3,*(undefined8 *)(param_3 + 0x70),uVar6,uVar5,0xffffffff);
            FUN_1403a1c90(param_3,*(undefined8 *)(param_3 + 0x70),uVar6,uVar5,uVar4,3);
          }
        }
        uVar5 = uVar7;
        do {
  ...
  uVar5 = func_0x00014040bba0(param_1,param_3);
