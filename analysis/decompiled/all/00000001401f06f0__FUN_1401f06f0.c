// Function: FUN_1401f06f0
// Addr: 1401f06f0
// Size: 443 bytes


void FUN_1401f06f0(undefined8 param_1,longlong *param_2)

{
  ...
  FUN_14015ab00(param_2,DAT_1404e8430);
  puVar5 = DAT_1404e8428;
  puVar2 = (undefined8 *)*DAT_1404e8428;
  do {
    if (puVar2 == puVar5) {
      return;
    }
...
LAB_1401f08a1:
                    /* WARNING: Subroutine does not return */
        *(undefined **)(puVar9 + -8) = &UNK_1401f08a6;
        FUN_140017370();
      }
      uVar1 = lVar7 + 1;
      uVar6 = (uVar6 >> 1) + uVar6;
      ...
      puVar9 = auStack_48;
      if (0x1fffffffffffffff < uVar10) goto LAB_1401f08a1;
      uVar6 = uVar10 * 8;
      if (uVar6 == 0) {
        uVar6 = 0;
      }
        ...
        puVar9 = auStack_48;
        if (uVar6 + 0x27 <= uVar6) goto LAB_1401f08a1;
