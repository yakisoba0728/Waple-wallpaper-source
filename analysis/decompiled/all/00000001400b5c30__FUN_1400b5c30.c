// Function: FUN_1400b5c30
// Addr: 1400b5c30
// Size: 1379 bytes


/* WARNING: Removing unreachable block (ram,0x0001400b5ff7) */

char * FUN_1400b5c30(longlong param_1,longlong *param_2,longlong *param_3,undefined4 *param_4)
...
LAB_1400b5f18:
      *(undefined1 *)(param_1 + 0x29) = 1;
      goto switchD_1400b5cfd_caseD_5;
    }
    if (*(char *)(param_1 + 0x2b) == '\0') goto switchD_1400b5cfd_caseD_1;
    if (*(int *)(param_1 + 0x30) == *(int *)(param_1 + 0x34)) goto LAB_1400b5f18;
...
joined_r0x0001400b5e8f:
    ...
    break;
  case 4:
    goto joined_r0x0001400b5e8f;
  case 5:
switchD_1400b5cfd_caseD_5:
    ...
    pcVar14 = (char *)FUN_1400aaf60(param_1 + 0xb0,param_2,param_3,&local_48);
    if (param_2 != (longlong *)0x0) {
    ...
    if (pcVar14 == (char *)0x0) {
      pcVar14 = pcVar13;
      if (*(char *)(param_1 + 0x2c) == '\0') goto switchD_1400b5cfd_caseD_6;
      goto LAB_1400b5efa;
    }
    if (*pcVar14 != '$') goto LAB_1400b6137;
    iVar15 = 5;
    break;
  case 6:
switchD_1400b5cfd_caseD_6:
    if ((longlong)puVar17 - (longlong)puVar16 < 4) {
      *(undefined8 *)(param_1 + 0xa3d8) = 0;
      iVar15 = 7;
      goto switchD_1400b5cfd_caseD_7;
    }
    uVar8 = *puVar16;
    puVar16 = puVar16 + 1;
    uVar8 = uVar8 >> 0x18 | (uVar8 & 0xff0000) >> 8 | (uVar8 & 0xff00) << 8 | uVar8 << 0x18;
LAB_1400b60ec:
    ...
    goto LAB_1400b5efa;
  case 7:
switchD_1400b5cfd_caseD_7:
    if (puVar16 == puVar17) goto LAB_1400b5dcf;
    do {
      uVar8 = *(uint *)(param_1 + 0xa3d8);
      uVar12 = *(ulonglong *)(param_1 + 0xa3d8) & 0xffffffffffffff00;
      uVar11 = uVar8 & 0xff;
