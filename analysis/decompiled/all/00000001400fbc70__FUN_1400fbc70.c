...
float * FUN_1400fbc70(longlong param_1,float *param_2,uint param_3,float param_4,float *param_5,
...

{
  ...
  fStack_e0 = fVar35;
  fStack_dc = fVar36;
  pfVar12 = (float *)FUN_1400fbe90(param_1,local_d8,&local_e8,&local_f8,&local_108);
  ...
  if (1 < param_3) {
    do {
      ...
      fStack_e0 = fVar31;
      fStack_dc = fVar32;
      pfVar12 = (float *)FUN_1400fbe90(param_1,local_d8,&local_108,&local_f8,&local_e8);
      uVar13 = uVar13 + 1;
      fVar14 = *pfVar12;
      fVar15 = pfVar12[1];
      fVar16 = pfVar12[2];
