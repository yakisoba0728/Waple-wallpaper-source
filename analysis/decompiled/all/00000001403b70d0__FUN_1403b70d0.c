// Function: FUN_1403b70d0
// Addr: 1403b70d0
// Size: 2142 bytes


void FUN_1403b70d0(longlong param_1)

{
  ...
  if ((*(char *)(param_1 + 0x1c) != '\0') && (*(char *)(param_1 + 0x34) != '\0')) {
    ...
    fVar17 = (fVar2 + *(float *)(lVar11 + param_1)) * DAT_1404926c0;
    plVar10 = *(longlong **)(param_1 + 8);
    plVar1 = plVar10 + 2;
    fVar16 = (fVar3 + *(float *)(lVar12 + param_1)) * DAT_1404926c0;
    lVar11 = plVar10[1];
    lVar12 = *plVar10;
