// Function: FUN_140219e20
// Addr: 140219e20
// Size: 141 bytes


undefined4 * FUN_140219e20(undefined4 *param_1,undefined4 *param_2,undefined4 *param_3)
    ...
    *param_3 = *param_1;
    ...
    if (param_3 != param_1) {
      ...
      if (lVar2 != 0) {
        ...
        if (0xfff < uVar4) {
          if (0x1f < (lVar2 - *(longlong *)(lVar2 + -8)) - 8U) goto LAB_140219f6e;
          uVar4 = uVar4 + 0x27;
          lVar2 = *(longlong *)(lVar2 + -8);
        }
        func_0x00014028b040(lVar2,uVar4);
