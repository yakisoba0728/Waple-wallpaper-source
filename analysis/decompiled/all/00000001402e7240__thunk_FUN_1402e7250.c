// Function: thunk_FUN_1402e7250
// Addr: 1402e7240
// Size: 5 bytes


LPCVOID thunk_FUN_1402e7250(LPCVOID param_1,ulonglong param_2)
    ...
    *puVar4 = 0x16;
    ...
    if ((param_2 <= SVar5) && (SVar5 < 0x4001)) {
      ...
      BVar1 = HeapQueryInformation
                        (DAT_1404e4ed0,HeapCompatibilityInformation,aiStackX_8,4,(PSIZE_T)0x0);
      if (BVar1 == 0) {
        return param_1;
      }
      if (aiStackX_8[0] == 2) {
