// Function: FUN_1403fdda0
// Addr: 1403fdda0
// Size: 930 bytes


ulonglong FUN_1403fdda0(byte *param_1,int *param_2)

{
  ...
  case 0:
    uVar9 = FUN_14036f0c0(param_2,pbVar1,param_2[0xe],2);
    break;
  default:
    uVar9 = uVar9 & 0xff;
    break;
    ...
    if (cVar3 != '\0') {
      ...
      if (uVar4 != 0) {
        do {
          ...
          if (uVar11 < uVar9) goto LAB_1403fe118;
          ...
          if (((uVar12 < uVar5) ||
             ...
             (cVar3 = FUN_14036f0c0(param_2,param_1 + (ulonglong)pbVar7[5] +
                                                      (ulonglong)pbVar7[4] * 0x100,
                                    (uVar12 - uVar5) + 1,2), cVar3 == '\0')) goto LAB_1403fe118;
          uVar8 = uVar8 + 1;
        } while (uVar8 < uVar4);
      }
      return 1;
