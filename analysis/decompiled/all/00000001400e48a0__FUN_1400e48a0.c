// Function: FUN_1400e48a0
// Addr: 1400e48a0
// Size: 422 bytes


void FUN_1400e48a0(longlong param_1,ulonglong param_2)

{
  ...
  FUN_140012020(param_1 + 0x18,2L << (bVar11 & 0x3f),plVar2);
  *(longlong *)(param_1 + 0x38) = lVar15;
  *(longlong *)(param_1 + 0x30) = lVar15 + -1;
  plVar6 = (longlong *)**(undefined8 **)(param_1 + 8);
joined_r0x0001400e4922:
  do {
    while( true ) {
      if (plVar6 == plVar2) {
        uStackX_10 = 0;
        FUN_1400e6450(&uStackX_10);
        return;
      }
      uVar17 = plVar6[5];
      plVar10 = plVar6 + 2;
