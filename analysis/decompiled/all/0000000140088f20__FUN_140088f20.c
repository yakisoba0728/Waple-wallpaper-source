// Function: FUN_140088f20
// Addr: 140088f20
// Size: 302 bytes


void FUN_140088f20(longlong *param_1,ulonglong param_2)
  ...
  if ((ulonglong)(param_1[2] - lVar1 >> 5) < param_2) {
    ...
    if (uVar12 != 0) {
      if (uVar12 < 0x1000) {
        ...
        lVar10 = FUN_14028af20(uVar12 + 0x27);
        lVar13 = lVar10;
        if (lVar10 == 0) {
          lVar13 = 5;
    ...
    *(undefined8 *)(puVar16 + -8) = 0x14008902a;
    FUN_140013070(param_1,puVar11,lVar2 - lVar1 >> 5,param_2);
  }
  return;
}
