// Function: FUN_140057360
// Addr: 140057360
// Size: 481 bytes


int FUN_140057360(longlong *param_1)
...
LAB_140057413:
    if (bVar13 != 0) {
      ...
      if (puVar7 == *(undefined8 **)(lVar6 + 0x58)) {
        func_0x0001400570d0(lVar6 + 0x48,puVar7,lVar6 + 0x40);
      }
      else {
      ...
      iVar15 = FUN_14003aec0(lVar6 + 0x20,*(undefined4 *)(lVar6 + 0x60),lVar6 + 0x40,local_268);
      goto LAB_1400574a8;
    }
  }
  else {
    ...
    if ((*(byte *)(lVar6 + 0x60) & 1) == 0) goto LAB_140057413;
    plVar18 = (longlong *)(lVar6 + 0x20);
    if (7 < *(ulonglong *)(lVar6 + 0x38)) {
      plVar18 = (longlong *)*plVar18;
    }
    iVar15 = FUN_140290300(plVar18,local_288,3,uVar5);
    if (iVar15 == 0) {
      bVar13 = (byte)(uStack_278 >> 4) & 1;
      goto LAB_140057413;
    }
    cVar14 = func_0x00014003bc00(iVar15);
    if ((cVar14 == '\0') && ((iVar15 != 5 || ((*(byte *)(lVar6 + 0x60) & 2) == 0)))) {
      FUN_140057300(param_1);
      return iVar15;
    }
  }
  iVar15 = func_0x00014028fea0(*(undefined8 *)(lVar6 + 0x40),local_268);
  if (iVar15 == 0) {
    uVar8 = *(undefined8 *)(lVar6 + 0x40);
    do {
      ...
      iVar15 = func_0x00014028fea0(uVar8,local_268);
    } while (iVar15 == 0);
  }
LAB_1400574a8:
  *(undefined1 *)(lVar6 + 100) = 1;
  do {
    if (iVar15 == 0) {
      FUN_14003b550(lVar6,local_268);
      return 0;
    }
    do {
      if (iVar15 != 0x12) {
UNWIND_INFO_14005762b_UnwindCodes_16__UnwindOpCode:
      ...
      if (*(longlong *)(lVar6 + 0x48) == lVar21) {
        iVar15 = 0;
        goto UNWIND_INFO_14005762b_UnwindCodes_16__UnwindOpCode;
      }
      uVar8 = *(undefined8 *)(lVar21 + -8);
      *(undefined8 *)(lVar21 + -8) = 0xffffffffffffffff;
      uVar9 = *(undefined8 *)(lVar6 + 0x40);
      *(undefined8 *)(lVar6 + 0x40) = uVar8;
      func_0x00014028fec0(uVar9);
      func_0x00014028fec0(*(undefined8 *)(*(longlong *)(lVar6 + 0x50) + -8));
      *(longlong *)(lVar6 + 0x50) = *(longlong *)(lVar6 + 0x50) + -8;
      ...
      psVar16 = (short *)FUN_140015f60(lVar21);
