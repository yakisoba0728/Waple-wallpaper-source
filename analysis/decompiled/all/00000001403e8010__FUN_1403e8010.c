// Function: FUN_1403e8010
// Addr: 1403e8010
// Size: 1201 bytes


void FUN_1403e8010(longlong *param_1,longlong param_2,longlong param_3,uint param_4,char param_5)

{
  ...
  local_1f0 = param_1;
  local_1e0 = param_2;
  cVar7 = FUN_1403ec600(param_3,param_2,"start kern");
  if (cVar7 != '\0') {
    uVar13 = 0;
                ...
                if ((local_1b0 & 0x10) == 0) {
                  ...
                  do {
                    if ((*(ulonglong *)
                         ...
                         (*puVar1 >> ((byte)(&DAT_14045c498)[uVar8] & 0x1f) & 0x3f) & 1) == 0)
                    goto LAB_1403e826b;
                    uVar11 = (int)uVar8 + 1;
                  ...
                  cVar7 = FUN_1403ebff0(puVar10,local_1b0 >> 0x10,*puVar1);
                  uVar14 = (ulonglong)local_1c0;
                  if (cVar7 == '\0') {
LAB_1403e826b:
                    bVar17 = false;
              ...
              if (((local_1ac & puVar1[1]) != 0) &&
                ...
                cVar7 = FUN_1403c59b0(*(undefined8 *)(puVar10[1] + 0x98),uVar5);
                uVar15 = local_1c0;
                if (((cVar7 != '\0') &&
                    (cVar7 = FUN_1403c59b0(*(undefined8 *)(puVar10[1] + 0xa0),uVar4),
                    uVar15 = local_1c0, cVar7 != '\0')) &&
                   (iVar16 = func_0x0001403cb400(*puVar10,uVar5,uVar4,puVar10[1]),
                   uVar15 = local_1c0, iVar16 != 0)) {
                  if (local_200 == 4) {
                    if (param_5 != '\0') {
                  ...
                  func_0x00014040efc0(param_3,uVar13,uVar11 + 1);
                  uVar15 = local_1c0;
                }
                goto LAB_1403e84c1;
              }
