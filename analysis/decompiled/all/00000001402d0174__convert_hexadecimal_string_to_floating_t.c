// Function: __crt_strtox::convert_hexadecimal_string_to_floating_type_common
// Addr: 1402d0174
// Size: 172 bytes
...

{
  ...
  SVar2 = FUN_1402cdf5c(uVar3,iVar6,CONCAT71((int7)((ulonglong)pfVar4 >> 8),param_1[0x308]),bVar5,
                        param_2);
  return SVar2;
}
