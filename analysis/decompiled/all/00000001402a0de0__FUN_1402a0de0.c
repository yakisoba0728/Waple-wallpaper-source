// Function: FUN_1402a0de0
// Addr: 1402a0de0
// Size: 972 bytes


longlong *
FUN_1402a0de0(undefined8 param_1,longlong *param_2,longlong *param_3,longlong *param_4,
...

{
  ...
  while (cVar6 != '\0') {
    ...
    lVar9 = *param_3;
    if (lVar9 != 0) {
      if (*param_4 == 0) goto LAB_1402a0ef0;
LAB_1402a0eac:
      *param_6 = *param_6 | 2;
      break;
    }
    if (*param_4 == 0) goto LAB_1402a0eac;
LAB_1402a0ef0:
    if (*param_8 == '%') {
      param_8 = param_8 + 1;
...
LAB_1402a0f60:
        ...
        if (*param_3 == 0) {
          if (*param_4 == 0) goto LAB_1402a10f5;
        }
        else if (*param_4 != 0) goto LAB_1402a10f5;
        if ((char)param_3[1] == '\0') {
          FUN_1402a7e60(param_3);
        }
        cVar6 = (*(code *)PTR__guard_dispatch_icall_140426ae8)(uVar8,0x48);
        if (cVar6 == '\0') goto LAB_1402a10f5;
        lVar9 = *param_3;
        if (lVar9 == 0) {
LAB_1402a101d:
          *param_3 = 0;
...
LAB_1402a1070:
      ...
      if (cVar6 != *param_8) goto LAB_1402a0eac;
      lVar9 = *param_3;
      if (lVar9 != 0) {
        if (**(longlong **)(lVar9 + 0x38) == 0) {
LAB_1402a10cd:
...
LAB_1402a1123:
  ...
  if ((char)param_4[1] == '\0') {
    ...
    if (lVar9 != 0) {
      ...
      if (sVar7 != -1) goto LAB_1402a1174;
    }
    *param_4 = 0;
  }
LAB_1402a1174:
  if (*param_3 == 0) {
    if (*param_4 != 0) goto LAB_1402a118d;
  }
  else if (*param_4 == 0) goto LAB_1402a118d;
  *param_6 = *param_6 | 1;
LAB_1402a118d:
  lVar9 = param_3[1];
  *param_2 = *param_3;
