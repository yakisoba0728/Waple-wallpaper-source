// Function: FUN_1403f88b0
// Addr: 1403f88b0
// Size: 430 bytes


undefined8 FUN_1403f88b0(uint *param_1,uint param_2,char param_3,char param_4)

{
  ...
  if (-1 < (int)uVar1) {
    if (param_4 == '\0') {
      uVar5 = uVar1;
      if (param_2 <= uVar1) goto LAB_1403f895e;
      do {
      ...
      if ((uVar5 <= uVar1) && (uVar1 >> 2 <= uVar5)) goto LAB_1403f895e;
    }
    if (uVar5 < 0x6bca1a) {
      lVar2 = FUN_1403a22a0(param_1);
      if ((uVar5 == 0) || (lVar2 != 0)) {
