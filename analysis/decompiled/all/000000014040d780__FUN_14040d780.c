// Function: FUN_14040d780
// Addr: 14040d780
// Size: 1952 bytes


void FUN_14040d780(longlong *param_1,longlong param_2,undefined8 param_3,longlong param_4)

{
  ...
  if ((((char)param_1[4] == '\0') ||
     ...
     *(uint *)(param_2 + 0x60) <= *(uint *)(param_2 + 0x5c))) goto LAB_14040deed;
  ...
  if (iVar9 == 0) {
    ...
    cVar8 = FUN_14036f0c0(*param_1 + 0x28,pbVar12,2);
    if (cVar8 == '\0') {
      return;
    }
    bVar1 = pbVar12[2];
    ...
    if (*(float *)(lVar6 + 0x4c) != 0.0) {
      fVar19 = (float)FUN_14041a5c0((float)local_68 * *(float *)(lVar6 + 0x4c) + DAT_1404926c0);
    ...
    if (iVar17 == 0) {
      ...
      if (iVar10 != 0) {
        ...
        FUN_1403d05d0(lVar6,uVar5,&local_60,local_58);
    ...
    if (*(float *)(lVar7 + 0x4c) != 0.0) {
      fVar19 = (float)FUN_14041a5c0((float)local_64 * *(float *)(lVar7 + 0x4c) + DAT_1404926c0);
    ...
    if (iVar17 == 0) {
      ...
      if (iVar17 == 0) goto LAB_14040de91;
      if (*(char *)(lVar7 + 0x3c) == '\0') {
        iVar17 = -*(int *)(lVar7 + 0x40);
        if (-1 < *(int *)(lVar7 + 0x28)) {
          iVar17 = *(int *)(lVar7 + 0x40);
      ...
      FUN_1403d05d0(lVar7,uVar5,local_58,&local_60);
...
LAB_14040deb2:
    *(int *)(lVar18 + 0xc + uVar11 * 0x14) = local_68;
    ...
    if (iVar9 == 1) {
      ...
      pbVar12 = (byte *)FUN_1403c64f0(*(undefined8 *)(lVar18 + 0x68),
                                      *(undefined4 *)
                                       (lVar7 + (ulonglong)*(uint *)((longlong)param_1 + 0x24) *
                                                0x14),(uint)*pbVar12 * 0x100 + (uint)pbVar12[1],
                                      *(undefined4 *)(lVar18 + 0x60));
      pbVar13 = (byte *)FUN_1403c64f0(*(undefined8 *)(lVar18 + 0x68),
                                      *(undefined4 *)
    ...
    if (iVar9 == 2) {
      ...
      cVar8 = FUN_14036f0c0(*param_1 + 0x28,pbVar12,4,2);
      if (cVar8 == '\0') {
        return;
      }
      bVar1 = pbVar12[2];
