// Function: FUN_1404c0a58
// Addr: 1404c0a58
// Size: 1 bytes


/* WARNING: Control flow encountered bad instruction data */
/* WARNING: Instruction at (ram,0x0001404c0a59) overlaps instruction at (ram,0x0001404c0a58)
    */

void FUN_1404c0a58(char *param_1,uint *param_2)

{
  ...
  bVar10 = (byte)param_1;
  while( true ) {
    uVar3 = uRam21004c0940002885;
    *(char *)((ulonglong)uRam21004c0940002885 * 2) =
         *(char *)((ulonglong)uRam21004c0940002885 * 2) + bVar10;
    uVar7 = CONCAT31((int3)(uVar3 >> 8),(char)uVar3 + unaff_BH) + 0x6e80000;
    ...
    *pcVar8 = *pcVar8 + cVar5;
    *(char *)(unaff_RSI + -0x5effd77c) = *(char *)(unaff_RSI + -0x5effd77c) + (char)(uVar3 >> 8);
