// Function: FUN_1403fb230
// Addr: 1403fb230
// Size: 576 bytes


undefined8 FUN_1403fb230(byte *param_1,int *param_2)
    ...
    if (uVar7 < uVar7 + 1) {
      ...
      if (uVar9 <= uVar8) {
        ...
        if ((bVar2 - 1 < 4) && ((bVar2 == 0 || (uVar4 < (uint)(0xffffffff / (ulonglong)bVar2))))) {
          cVar3 = FUN_14036f0c0(param_2,param_1 + 3,(ulonglong)bVar2,
                                param_1[1] + 1 + (uint)*param_1 * 0x100,iVar6,uVar11,pcVar12,pbVar13
                                ,lVar14,uVar15,pcVar5);
          uVar16 = (undefined4)((ulonglong)uVar15 >> 0x20);
          if (cVar3 != '\0') {
            iVar6 = (uint)*param_1 * 0x100 + (uint)param_1[1];
            uVar4 = FUN_1403ed3b0(param_1,iVar6);
            param_1 = param_1 + (ulonglong)((iVar6 + 1) * (uint)*pbVar1) + 2;
