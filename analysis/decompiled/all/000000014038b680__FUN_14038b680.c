// Function: FUN_14038b680
// Addr: 14038b680
// Size: 282 bytes


int * FUN_14038b680(int *param_1,longlong param_2,int param_3)

{
  ...
  if ((param_3 != 0) && (*(code **)(param_2 + 0x20) != (code *)0x0)) {
    ...
    if (piVar2 != (int *)0x0) goto LAB_14038b6f7;
  }
...
LAB_14038b6f7:
  ...
  *(undefined1 *)(param_1 + 10) = 0;
  ...
  pcVar3 = "OUT-OF-RANGE";
  if (0x1f < (uint)param_1[6]) {
    pcVar3 = "OK";
  }
                    /* WARNING: Subroutine does not return */
  FUN_1402fc440("SANITIZE",lVar1 + 0x20,0,1,*param_1 + 1,0,"check_point [%p] in [%p..%p] -> %s",
                lVar1 + 0x20,lVar1,*(undefined8 *)(param_1 + 4),pcVar3);
}
