// Function: FUN_14035fca0
// Addr: 14035fca0
// Size: 307 bytes


bool FUN_14035fca0(longlong param_1,undefined8 param_2,undefined8 param_3,int *param_4,int *param_5)

{
  ...
  uVar5 = 0;
  pcVar1 = *(code **)(*(longlong *)(param_1 + 0x90) + 0x78);
  if (pcVar1 != (code *)PTR_FUN_1404df4a0) {
  ...
  *param_4 = 0;
  ...
  iVar4 = (**(code **)(*(longlong *)(lVar2 + 0x90) + 0x68))
  ...
  FUN_1403f07f0(param_1,param_4,param_5);
  return bVar6;
}
