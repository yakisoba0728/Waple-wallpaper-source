...
int FUN_140332e50(ulonglong *param_1,byte *param_2,int param_3)

{
  ...
  if (pbVar9 < param_2) {
    ...
    local_res20 = pbVar9;
    if (bVar2 != 0x2e) {
      iVar5 = FUN_1403330d0(&local_res20);
    ...
    if ((local_res20 < param_2) && (iVar7 = 0, *local_res20 == 0x2e)) {
      while (pbVar9 = pbVar9 + 1, pbVar9 < param_2) {
        ...
        if ((((bVar2 < 0x21) && ((0x100003601U >> ((ulonglong)bVar2 & 0x3f) & 1) != 0)) ||
            (0x7f < bVar2)) || (9 < (byte)(&DAT_140441580)[bVar2 & 0x7f])) break;
        if ((iVar8 < 0xccccccc) && (iVar7 < 0xccccccc)) {
          iVar7 = (int)(char)(&DAT_140441580)[bVar2 & 0x7f] + iVar7 * 10;
    ...
    if ((pbVar1 < param_2) && ((*pbVar9 + 0xbb & 0xdf) == 0)) {
      local_res20 = pbVar1;
      iVar6 = FUN_1403330d0(&local_res20,param_2);
...
LAB_14033309f:
        ...
        for (; 0 < param_3; param_3 = param_3 + -1) {
          if (0xccccccb < iVar5) goto LAB_14033309f;
          if (iVar7 < 0xccccccc) {
            iVar7 = iVar7 * 10;
          }
          else {
            if (iVar8 == 1) goto LAB_14033309f;
            iVar8 = iVar8 / 10;
          }
          iVar5 = iVar5 * 10;
        }
        ...
        if (iVar7 != 0) {
          iVar7 = FUN_1402efa10(iVar7,iVar8);
          if (!bVar10) {
            return iVar5 + iVar7;
          }
          return -(iVar5 + iVar7);
