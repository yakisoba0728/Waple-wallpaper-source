...
void FUN_1401d1670(longlong *param_1,longlong param_2,longlong param_3,float *param_4,
                  longlong param_5)

{
  ...
  undefined1 auStack_d4 [172];
  
  fVar14 = DAT_140492930;
  dVar6 = DAT_140492880;
  fVar7 = DAT_1404927d4;
  fVar28 = DAT_1404927d4;
  ...
  uVar22 = SUB84(DAT_140492880,0);
  uVar24 = (undefined4)((ulonglong)DAT_140492880 >> 0x20);
  ...
  *(undefined4 *)(param_5 + 0x3ec) = *(undefined4 *)(param_3 + 200);
  if (cVar1 != '\0') {
    ...
    if ((fVar27 < _DAT_1404926bc) || (fVar11 <= 0.0)) {
      fVar27 = 0.0;
      fVar28 = 0.0;
    }
    else {
      ...
      if (fVar16 < fVar11) {
        if (fVar12 < fVar11) {
          dVar6 = (double)((fVar16 - fVar12) / fVar27) + _DAT_1404928a8;
        }
        else {
  ...
  if (pcVar4 != (char *)0x0) {
    cVar2 = *pcVar4;
    fVar16 = DAT_140492790;
    while (cVar2 != '\0') {
      uVar23 = SUB84(DAT_140492880,0);
      uVar25 = (undefined4)((ulonglong)DAT_140492880 >> 0x20);
      pcVar10 = pcVar4;
      switch(*pcVar4) {
      case '\x01':
      ...
      case '\x03':
        ...
        fVar12 = *(float *)((ulonglong)*(uint *)(pcVar4 + 0x18) + param_3) *
                 *(float *)(pcVar4 + 0x14);
        if (fVar12 <= DAT_1404926cc) {
          fVar12 = DAT_1404926cc;
        }
      ...
      case '\v':
        ...
        if (cVar1 != '\0') {
          ...
          if ((fVar21 < _DAT_1404926bc) || (fVar13 <= 0.0)) {
            fStackX_8 = 0.0;
            fVar21 = 0.0;
            uVar23 = uVar22;
            uVar25 = uVar24;
            ...
            fStackX_8 = fVar21 / fVar13;
            if (fVar16 < fVar13) {
              if (fVar12 < fVar13) {
                dVar6 = (double)((fVar16 - fVar12) / fVar21) + _DAT_1404928a8;
              }
              else {
                dVar6 = (double)((fVar15 - fVar16) / fVar21) + DAT_140492880;
              }
              fVar21 = (float)dVar6;
            }
            else {
          ...
          if ((fVar20 < _DAT_1404926bc) || (fVar26 <= 0.0)) {
            param_5._0_4_ = 0.0;
            fVar20 = 0.0;
          }
          else {
            ...
            if (fVar18 < fVar26) {
              if (fVar17 < fVar26) {
                dVar6 = (double)((fVar18 - fVar17) / fVar20) + _DAT_1404928a8;
              }
              else {
          ...
          fStack_138 = (float)FUN_14041a690(fVar21);
          fStack_138 = fVar21 - fStack_138;
          fStackX_8 = (fVar28 - fVar14) + fStackX_8;
          fVar16 = 0.0;
          if (0.0 <= fStackX_8) {
            fVar16 = fStackX_8;
          }
          ...
          pfVar8 = (float *)FUN_1401b8d40(auStack_f8,&fStack_138);
          fVar15 = pfVar8[2];
          fVar16 = *pfVar8;
          fVar12 = pfVar8[1];
          fStack_128 = (float)FUN_14041a690(fVar20);
          param_5._0_4_ = (fVar28 - fVar14) + (float)param_5;
          fVar26 = (fVar11 - fVar18) + fVar26;
          fStack_128 = fVar20 - fStack_128;
          fVar14 = 0.0;
          ...
          pfVar8 = (float *)FUN_1401b8d40(auStack_ec,&fStack_128);
          uVar22 = SUB84(DAT_140492880,0);
          uVar24 = (undefined4)((ulonglong)DAT_140492880 >> 0x20);
          fVar18 = *pfVar8;
          fVar17 = pfVar8[1];
      ...
      case '\f':
        ...
        if (cVar1 != '\0') {
          ...
          fVar20 = (fVar27 - *(float *)(pcVar4 + 0x2c)) + fVar20;
          fVar21 = (fVar27 - *(float *)(pcVar4 + 0x2c)) + fVar21;
          fStack_118 = (float)FUN_14041a690(fVar21);
          fStack_118 = fVar21 - fStack_118;
          fStackX_8 = (fVar28 - fVar14) + fStackX_8;
          fVar16 = 0.0;
          if (0.0 <= fStackX_8) {
            fVar16 = fStackX_8;
          ...
          pfVar8 = (float *)FUN_1401b8d40(auStack_e0,&fStack_118);
          fVar15 = pfVar8[2];
          fVar16 = *pfVar8;
          fVar12 = pfVar8[1];
          fStack_108 = (float)FUN_14041a690(fVar20);
          param_5._0_4_ = (fVar28 - fVar14) + (float)param_5;
          fVar26 = (fVar11 - fVar18) + fVar26;
          fStack_108 = fVar20 - fStack_108;
          fVar14 = 0.0;
          if (0.0 <= (float)param_5) {
            fVar14 = (float)param_5;
          }
          ...
          pfVar8 = (float *)FUN_1401b8d40(auStack_d4,&fStack_108);
          uVar22 = SUB84(DAT_140492880,0);
          uVar24 = (undefined4)((ulonglong)DAT_140492880 >> 0x20);
          fVar18 = *pfVar8;
          fVar17 = pfVar8[1];
