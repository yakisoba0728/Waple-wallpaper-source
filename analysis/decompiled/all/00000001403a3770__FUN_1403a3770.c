// Function: FUN_1403a3770
// Addr: 1403a3770
// Size: 324 bytes


undefined8 FUN_1403a3770(longlong param_1,uint param_2)

{
  ...
  lVar10 = thunk_FUN_1402da070((ulonglong)uVar8 * 0xc);
  if (lVar10 == 0) {
    *(undefined1 *)(param_1 + 0x10) = 0;
    uVar11 = 0;
  }
  else {
    if ((uVar8 * 3 & 0x3fffffff) != 0) {
      uVar11 = func_0x000140421870(lVar10,0,uVar8 * 0xc);
      return uVar11;
    }
    *(undefined8 *)(param_1 + 0x14) = 0;
    ...
    uVar6 = *(int *)(param_1 + 0x1c) + 1;
    if (*(int *)(param_1 + 0x1c) == 0) {
      uVar6 = 0;
    }
    *(uint *)(param_1 + 0x1c) = uVar8 - 1;
    uVar9 = 0x7fffffff;
    ...
    *(longlong *)(param_1 + 0x28) = lVar10;
    if (uVar6 != 0) {
      ...
      lVar10 = 0;
      do {
        piVar1 = (int *)(lVar3 + lVar10 * 0xc);
        if ((((*(byte *)(lVar3 + 4 + lVar10 * 0xc) & 1) != 0) && (*(char *)(param_1 + 0x10) != '\0')
            ) && ((uVar2 = piVar1[1],
                  (*(uint *)(param_1 + 0x18) >> 1) + *(int *)(param_1 + 0x18) <
                  *(uint *)(param_1 + 0x1c) || (cVar7 = FUN_1403a3770(param_1), cVar7 != '\0')))) {
          lVar4 = *(longlong *)(param_1 + 0x28);
          uVar13 = 0xffffffff;
          uVar12 = (ulonglong)(uVar2 >> 2) % (ulonglong)*(uint *)(param_1 + 0x20);
          if ((*(uint *)(lVar4 + 4 + uVar12 * 0xc) >> 1 & 1) == 0) {
            uVar15 = 0;
          }
          else {
            uVar15 = 0;
            do {
              if (*(int *)(lVar4 + uVar12 * 0xc) == *piVar1) break;
              if (((*(byte *)(lVar4 + 4 + uVar12 * 0xc) & 1) == 0) && (uVar13 == 0xffffffff)) {
                uVar13 = (uint)uVar12;
              }
              uVar15 = uVar15 + 1;
              uVar12 = (ulonglong)((uint)uVar12 + uVar15 & *(uint *)(param_1 + 0x1c));
            } while ((*(uint *)(lVar4 + 4 + uVar12 * 0xc) >> 1 & 1) != 0);
          }
          uVar14 = (ulonglong)uVar13;
          if (uVar13 == 0xffffffff) {
            uVar14 = uVar12;
          }
          if ((*(uint *)(lVar4 + 4 + uVar14 * 0xc) >> 1 & 1) != 0) {
            *(int *)(param_1 + 0x18) = *(int *)(param_1 + 0x18) + -1;
            *(int *)(param_1 + 0x14) =
                 *(int *)(param_1 + 0x14) - (*(byte *)(lVar4 + 4 + uVar14 * 0xc) & 1);
          }
          *(int *)(lVar4 + uVar14 * 0xc) = *piVar1;
          *(int *)(lVar4 + 8 + uVar14 * 0xc) = piVar1[2];
          *(uint *)(lVar4 + 4 + uVar14 * 0xc) = uVar2 | 3;
          *(int *)(param_1 + 0x18) = *(int *)(param_1 + 0x18) + 1;
          *(int *)(param_1 + 0x14) = *(int *)(param_1 + 0x14) + 1;
          if ((*(ushort *)(param_1 + 0x12) < uVar15) &&
             (*(uint *)(param_1 + 0x1c) < (uint)(*(int *)(param_1 + 0x18) * 8))) {
            FUN_1403a3770(param_1);
          }
        }
        uVar8 = uVar8 + 1;
        lVar10 = lVar10 + 1;
