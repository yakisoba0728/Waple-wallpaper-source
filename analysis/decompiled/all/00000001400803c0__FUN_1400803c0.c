...
void FUN_1400803c0(longlong param_1,undefined1 (*param_2) [16])

{
  ...
  if ((DAT_1404dc0d8 < 2) ||
    ...
    local_188 = pshufb(*param_2,_DAT_140492e20);
    local_168 = pshufb(param_2[2],_DAT_140492e20);
    local_178 = pshufb(param_2[1],_DAT_140492e20);
    local_158 = pshufb(param_2[3],_DAT_140492e20);
  }
  lVar6 = 0x10;
  do {
