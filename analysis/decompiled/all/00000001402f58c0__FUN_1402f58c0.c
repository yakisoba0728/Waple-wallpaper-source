// Function: FUN_1402f58c0
// Addr: 1402f58c0
// Size: 162 bytes


undefined4 FUN_1402f58c0(longlong *param_1,undefined4 *param_2)
...
LAB_1402f594f:
  ...
  if ((code *)param_1[4] == (code *)0x0) {
    ...
    if (puVar3 == (undefined1 *)0x0) goto LAB_1402f5935;
  }
  else {
    iVar1 = (*(code *)param_1[4])(param_1,uVar4,local_18,4);
    if (iVar1 != 4) goto LAB_1402f594f;
    uVar4 = *(uint *)((longlong)param_1 + 0xc);
    puVar3 = local_18;
  }
