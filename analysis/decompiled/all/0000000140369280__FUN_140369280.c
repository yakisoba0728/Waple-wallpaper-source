// Function: FUN_140369280
// Addr: 140369280
// Size: 479 bytes


void FUN_140369280(undefined4 *param_1,undefined8 *param_2,longlong param_3,undefined8 param_4)

{
  ...
  do {
    if ((longlong)(uVar6 & 0xfffffffffffffff0) < 0x201) {
      FUN_140363250(param_1,param_2,param_4);
LAB_140369403:
    ...
    uVar6 = (longlong)param_2 - (longlong)param_1;
    if (param_3 < 1) {
      FUN_140363d00(param_1,param_2,param_4);
      while (0x1f < (longlong)(uVar6 & 0xfffffffffffffff0)) {
        ...
        if (0x1f < (longlong)((longlong)param_2 - (longlong)param_1 & 0xfffffffffffffff0U)) {
          ...
          *(undefined4 *)((longlong)param_2 + -4) = uVar4;
          local_68 = param_4;
          FUN_140367f00(param_1,0,(longlong)puVar1 - (longlong)param_1 >> 4,&local_50);
        }
        param_2 = puVar1;
    ...
    if (0x28 < lVar9) {
      ...
      FUN_140364d30(param_1,puVar7,param_1 + lVar9 * 8,param_4);
      FUN_140364d30(local_58 + lVar9 * -4,local_58,local_58 + lVar9 * 4,param_4);
      puVar8 = puVar8 + lVar9 * -4;
      FUN_140364d30((undefined4 *)((longlong)param_2 + -0x10) + lVar9 * -8,puVar8,
                    (undefined4 *)((longlong)param_2 + -0x10),param_4);
    }
    puVar5 = local_58;
    FUN_140364d30(puVar7,local_58,puVar8,param_4);
    local_68 = param_4;
    FUN_1403662c0(&local_50,param_1,puVar5,param_2);
    puVar7 = puStack_48;
    puVar8 = local_50;
    ...
    if ((longlong)((longlong)local_50 - (longlong)param_1 & 0xfffffffffffffff0U) <
      ...
      FUN_140369280(param_1,local_50,param_3,param_4);
      puVar8 = (undefined4 *)param_2;
      param_1 = puVar7;
    }
    else {
      FUN_140369280(puStack_48,param_2,param_3,param_4);
    }
