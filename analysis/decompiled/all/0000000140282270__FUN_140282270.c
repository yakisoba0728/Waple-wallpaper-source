// Function: FUN_140282270
// Addr: 140282270
// Size: 411 bytes


undefined4 * FUN_140282270(longlong *param_1,longlong param_2,undefined4 *param_3)
...
LAB_140282407:
  ...
  if (0xfffffffffffffff < uVar9) goto LAB_140282407;
  uVar7 = uVar9 * 0x10;
  if (uVar7 == 0) {
...
LAB_14028233e:
    ...
    *puVar12 = *param_3;
    ...
    if (uVar7 + 0x27 <= uVar7) goto LAB_140282407;
    lVar6 = FUN_14028af20();
    if (lVar6 != 0) {
...
LAB_1402823ba:
  ...
  *(undefined8 *)(puVar10 + -8) = 0x1402823c9;
