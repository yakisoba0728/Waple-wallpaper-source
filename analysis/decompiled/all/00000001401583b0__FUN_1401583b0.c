// Function: FUN_1401583b0
// Addr: 1401583b0
// Size: 211 bytes


void FUN_1401583b0(longlong param_1,longlong param_2,char *param_3)

{
  ...
  puVar3 = DAT_1404e9360;
  puVar2 = DAT_1404e9358;
  if (param_3 != (char *)0x0) {
    iVar1 = *(int *)(param_2 + 4);
    for (puVar7 = DAT_1404e9358; puVar7 != puVar3; puVar7 = puVar7 + 5) {
...
LAB_14015843f:
  ...
  if (*(code **)(param_2 + 0x28) != (code *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x000140158472. Too many branches */
