// Function: FUN_1403b7930
// Addr: 1403b7930
// Size: 623 bytes


float FUN_1403b7930(longlong param_1)
        ...
        if (3 < uVar2 - uVar11) {
          do {
            ...
            if (uVar14 < uVar3) {
              ...
              pfVar16 = (float *)&DAT_14045dd10;
            }
            if (uVar15 < uVar3) {
              pfVar5 = (float *)(*(longlong *)(param_1 + 8) + (ulonglong)uVar15 * 0xc);
            }
            else {
              pfVar5 = (float *)&DAT_14045dd10;
            }
            uVar14 = uVar8 + 3;
            uVar15 = uVar11;
            if (uVar14 < uVar2) {
            ...
            if (uVar12 < uVar3) {
              ...
              pfVar17 = (float *)&DAT_14045dd10;
            }
            if (uVar15 < uVar3) {
              pfVar6 = (float *)(*(longlong *)(param_1 + 8) + (ulonglong)uVar15 * 0xc);
            }
            else {
              pfVar6 = (float *)&DAT_14045dd10;
            }
            uVar8 = uVar8 + 4;
            ...
            if (uVar14 < uVar3) {
              ...
              pfVar13 = (float *)&DAT_14045dd10;
            }
            if (uVar15 < uVar3) {
              pfVar7 = (float *)(*(longlong *)(param_1 + 8) + (ulonglong)uVar15 * 0xc);
            }
            else {
              pfVar7 = (float *)&DAT_14045dd10;
            }
          ...
          if (uVar2 <= uVar8) goto LAB_1403b7b5f;
        }
        do {
          uVar15 = (uint)uVar9 + 1;
          uVar8 = uVar11;
