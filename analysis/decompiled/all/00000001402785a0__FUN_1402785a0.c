// Function: FUN_1402785a0
// Addr: 1402785a0
// Size: 536 bytes


ulonglong FUN_1402785a0(undefined8 param_1)

{
  ...
  FUN_140277ef0(&local_d8,&DAT_140492324);
  local_b8[2] = 0;
  local_b8[3] = 0;
  local_b8[0] = 0;
  local_b8[1] = 0;
  ...
  bVar2 = FUN_1402782c0(pppppuVar5,uVar3,"MDLV0023");
  ...
  if (7 < local_b8[3]) {
    ...
    if (0xfff < uVar4) {
      ...
      if (0x1f < (local_b8[0] - uVar6) - 8) goto LAB_1402787b0;
  ...
  if (7 < local_c0) {
    ...
    if (0xfff < uVar4) {
      ...
      if (0x1f < (ulonglong)((longlong)local_d8 + (-8 - (longlong)pppppuVar5))) goto LAB_1402787b0;
