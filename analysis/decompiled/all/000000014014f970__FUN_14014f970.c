// Function: FUN_14014f970
// Addr: 14014f970
// Size: 394 bytes


void FUN_14014f970(longlong param_1,ulonglong param_2)

{
  ...
  func_0x0001400376d0(param_1 + 0x18,2L << (bVar12 & 0x3f),plVar2);
  *(longlong *)(param_1 + 0x38) = lVar16;
  *(longlong *)(param_1 + 0x30) = lVar16 + -1;
  plVar7 = (longlong *)**(undefined8 **)(param_1 + 8);
joined_r0x00014014f9f2:
  do {
    while( true ) {
      if (plVar7 == plVar2) {
        uStackX_10 = 0;
        FUN_14003a140(&uStackX_10);
        return;
      }
