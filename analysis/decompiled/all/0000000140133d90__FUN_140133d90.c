// Function: FUN_140133d90
// Addr: 140133d90
// Size: 667 bytes


void FUN_140133d90(longlong param_1,ulonglong param_2)

{
  ...
  FUN_1400374c0(param_1 + 0x18,2L << (bVar11 & 0x3f),plVar2);
  *(longlong *)(param_1 + 0x38) = lVar14;
  *(longlong *)(param_1 + 0x30) = lVar14 + -1;
  plVar6 = (longlong *)**(undefined8 **)(param_1 + 8);
joined_r0x000140133e12:
  do {
    while( true ) {
      if (plVar6 == plVar2) {
        local_res10 = 0;
        FUN_140134470(&local_res10);
        return;
      }
