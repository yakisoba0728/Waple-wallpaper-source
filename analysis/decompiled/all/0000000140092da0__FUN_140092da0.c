// Function: FUN_140092da0
// Addr: 140092da0
// Size: 533 bytes


longlong * FUN_140092da0(longlong param_1)

{
  ...
  lVar1 = DAT_1404e91b8 * 8;
  if ((DAT_1404e91b8 < *(ulonglong *)(lVar4 + 0x18)) &&
     (plVar5 = *(longlong **)(lVar1 + *(longlong *)(lVar4 + 0x10)), plVar5 != (longlong *)0x0))
  goto LAB_140092e39;
  if (*(char *)(lVar4 + 0x24) == '\0') {
LAB_140092e78:
    if (plVar5 != (longlong *)0x0) goto LAB_140092e39;
  }
  else {
    lVar4 = FUN_1402916f0();
  ...
  if (plVar2 == (longlong *)0x0) {
    ...
    *plVar5 = (longlong)
              std::num_get<char,std::istreambuf_iterator<char,std::char_traits<char>_>_>::vftable;
