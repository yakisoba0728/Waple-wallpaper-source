// Function: FUN_1403c7170
// Addr: 1403c7170
// Size: 211 bytes


int FUN_1403c7170(longlong param_1,uint param_2)
  ...
  if (-1 < iVar4) {
    do {
      ...
      if (param_2 < (uint)*(byte *)(param_1 + 5 + (ulonglong)uVar1 * 6) + uVar3 * 0x100) {
        ...
        if (param_2 <= (uint)pbVar2[3] + (uint)pbVar2[2] * 0x100) goto LAB_1403c71f4;
        iVar5 = uVar1 + 1;
      }
    } while (iVar5 <= iVar4);
  }
  uVar3 = (uint)DAT_14045f0e8;
  pbVar2 = &DAT_14045f0e8;
LAB_1403c71f4:
