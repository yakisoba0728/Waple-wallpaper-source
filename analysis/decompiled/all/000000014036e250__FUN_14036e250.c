// Function: FUN_14036e250
// Addr: 14036e250
// Size: 2688 bytes


undefined8
FUN_14036e250(longlong param_1,uint param_2,undefined8 param_3,uint param_4,undefined8 param_5,
          ...
          do {
            *(uint *)(param_1 + 8) = iVar23 + 1U;
            ...
            if ((uVar6 & uVar27 & 0xe) == 0) {
              ...
              if ((uVar6 & 8) != 0) {
                if ((uVar27 & 0x10) == 0) {
                  if ((uVar27 & 0xff00) == 0) goto LAB_14036e463;
                  ...
                  do {
                    if ((*(ulonglong *)
                         ...
                         (*puVar1 >> ((byte)(&DAT_14045c498)[uVar15] & 0x1f) & 0x3f) & 1) == 0)
                    goto LAB_14036e44a;
                    uVar13 = (int)uVar15 + 1;
                  ...
                  cVar12 = FUN_1403ebff0(puVar16,uVar27 >> 0x10);
                  if (cVar12 == '\0') {
LAB_14036e44a:
                    bVar28 = false;
                  }
...
LAB_14036e463:
              ...
              if (((*(uint *)(param_1 + 0x1c) & puVar1[1]) != 0) &&
                ...
                if (cVar12 != '\0') goto LAB_14036e594;
              }
              if (!bVar28) break;
            }
LAB_14036e518:
            ...
            do {
              *(uint *)(param_1 + 0x48) = iVar20 + 1U;
              ...
              if ((uVar6 & uVar21 & 0xe) == 0) {
                ...
                if ((uVar6 & 8) != 0) {
                  if ((uVar21 & 0x10) == 0) {
                    if ((uVar21 & 0xff00) == 0) goto LAB_14036e944;
                    ...
                    cVar12 = FUN_1403ebff0(puVar16,uVar21 >> 0x10,*puVar1);
                    if (cVar12 == '\0') {
LAB_14036e92b:
                      bVar28 = false;
                    }
...
LAB_14036e944:
                ...
                if (((*(uint *)(param_1 + 0x5c) & puVar1[1]) != 0) &&
                  ...
                  if (cVar12 != '\0') goto LAB_14036ea0d;
                }
                if (!bVar28) {
...
LAB_14036ea2a:
      ...
      if (param_2 == 0) {
        ...
        *(undefined1 *)(param_1 + 100) = uVar5;
        if (param_2 != 0) {
code_r0x00014036ead0:
          uVar13 = *puVar1;
          if (uVar13 == 0) {
LAB_14036ec7e:
            uVar15 = 0;
code_r0x00014036ec80:
            lVar18 = *(longlong *)(param_1 + 0xa0);
          ...
          do {
            ...
            *puVar1 = uVar13;
            ...
            if ((uVar6 & uVar26 & 0xe) == 0) {
              ...
              if ((uVar6 & 8) != 0) {
                if ((uVar26 & 0x10) == 0) {
                  if ((uVar26 & 0xff00) == 0) goto LAB_14036ebc1;
                  ...
                  do {
                    if ((*(ulonglong *)
                         ...
                         (*puVar2 >> ((byte)(&DAT_14045c498)[uVar15] & 0x1f) & 0x3f) & 1) == 0)
                    goto LAB_14036eba8;
                    uVar13 = (int)uVar15 + 1;
                    uVar15 = (ulonglong)uVar13;
                  } while (uVar13 < 3);
                  ...
                  cVar12 = FUN_1403ebff0(puVar16,uVar26 >> 0x10,*puVar2);
                  if (cVar12 == '\0') {
LAB_14036eba8:
                    bVar28 = false;
                  }
...
LAB_14036ebc1:
              ...
              if (((*(uint *)(param_1 + 0x5c) & puVar2[1]) != 0) &&
                ...
                if (*(code **)(param_1 + 0x68) == (code *)0x0) {
                  if (bVar28) goto LAB_14036ec74;
                  goto UNWIND_INFO_14036ece1_UnwindCodes_24__OffsetInProlog;
                }
                cVar12 = (**(code **)(param_1 + 0x68))
                                   (puVar2,iVar20,*(undefined8 *)(param_1 + 0x70));
                if (cVar12 != '\0') goto UNWIND_INFO_14036ece1_UnwindCodes_24__OffsetInProlog;
              }
              if (!bVar28) {
                uVar21 = *puVar1;
                if (uVar21 < 2) {
                ...
                goto code_r0x00014036ec80;
              }
            }
LAB_14036ec74:
            uVar13 = *puVar1;
            if (uVar13 == 0) goto LAB_14036ec7e;
          } while( true );
        }
UNWIND_INFO_14036ece1_UnwindCodes_38__OffsetInProlog:
        uVar21 = *puVar1;
        lVar18 = *(longlong *)(param_1 + 0xa0);
      }
      FUN_14040f040(lVar18,uVar21,uVar27);
      FUN_1403b0330(param_1,param_4,param_8,param_9,uVar19);
      return 1;
    }
    uVar21 = 0;
LAB_14036e529:
...
LAB_14036e594:
  ...
  if (*(uint *)(param_1 + 0x144) < uVar27) {
    ...
    FUN_1403a4650(param_1 + 0x140,uVar27,0);
  }
  *(undefined4 *)(*(longlong *)(param_1 + 0x148) + (ulonglong)uVar19 * 4) =
  ...
  if ((bVar10 == 0) || (bVar22 == 0)) {
    if ((bVar11 != 0) && ((bVar25 != 0 && (bVar11 != bVar10)))) goto LAB_14036e529;
  }
    ...
    if (iVar20 == 0) {
      ...
      if ((uVar6 & uVar19 & 0xe) == 0) {
        if ((uVar6 & 8) == 0) goto LAB_14036e529;
        if ((uVar19 & 0x10) == 0) {
          if ((uVar19 & 0xff00) == 0) goto LAB_14036e529;
          ...
          do {
            if ((*(ulonglong *)(puVar16[2] + (ulonglong)(uVar19 >> 0x10) * 0x18 + uVar15 * 8) >>
                 (uVar13 >> ((byte)(&DAT_14045c498)[uVar15] & 0x1f) & 0x3f) & 1) == 0)
            goto LAB_14036e744;
            uVar26 = (int)uVar15 + 1;
          ...
          cVar12 = FUN_1403ebff0(puVar16,uVar19 >> 0x10,uVar13);
          if (cVar12 == '\0') {
LAB_14036e744:
            bVar28 = false;
          }
        ...
        if (bVar28) goto LAB_14036e529;
      }
      iVar20 = 2;
    }
    else if (iVar20 == 1) goto LAB_14036e529;
  }
  uVar19 = uVar27;
  if (param_4 <= uVar27) goto LAB_14036e7a2;
  goto LAB_14036e360;
LAB_14036ea0d:
  ...
  uVar27 = uVar27 + 1;
  if (param_6 <= uVar27) goto LAB_14036ea2a;
  goto LAB_14036e840;
UNWIND_INFO_14036ece1_UnwindCodes_24__OffsetInProlog:
  if (*(longlong *)(param_1 + 0x78) != 0) {
    *(longlong *)(param_1 + 0x78) = *(longlong *)(param_1 + 0x78) + 2;
  }
  uVar21 = uVar21 + 1;
  if (param_2 <= uVar21) goto UNWIND_INFO_14036ece1_UnwindCodes_38__OffsetInProlog;
  goto code_r0x00014036ead0;
}
