// Function: FUN_1402aabb0
// Addr: 1402aabb0
// Size: 177 bytes


void FUN_1402aabb0(undefined8 param_1,undefined4 *param_2,longlong *param_3,longlong *param_4,
...

{
  ...
  *param_7 = 0;
  ...
  if (*param_3 == 0) {
    if (*param_4 != 0) goto LAB_1402aacfb;
  }
  else if (*param_4 == 0) goto LAB_1402aacfb;
  *param_6 = *param_6 | 1;
LAB_1402aacfb:
