// Function: FUN_14013b5e0
// Addr: 14013b5e0
// Size: 1013 bytes


longlong * FUN_14013b5e0(longlong *param_1,longlong *param_2)
...
LAB_14013b855:
    local_res8 = 0;
    (**(code **)(*param_2 + 0x28))(param_2,&local_res8);
    if (local_res8 == 0) {
      return param_1;
    }
      ...
      if (plVar6 == &local_88) {
        if (0xf < uVar12) {
          ...
          if (0xfff < uVar10) {
            ...
            goto UNWIND_INFO_14013ba16_UnwindCodes_60__UnwindOpCode;
            uVar10 = uVar12 + 0x28;
          }
...
LAB_14013b9b6:
      ...
      if (7 < local_d0) {
        ...
        func_0x00014028b040(pppppppuVar9,uVar12);
      }
    }
    lVar8 = local_res8;
    if (local_res8 == 0) {
...
LAB_14013b752:
    ...
    if (param_1 == &local_a8) {
      if (uVar10 < 0x10) goto LAB_14013b806;
      uVar12 = uVar10 + 1;
      lVar8 = local_a8;
      if (uVar12 < 0x1000) {
LAB_14013b801:
...
UNWIND_INFO_14013ba16_UnwindCodes_60__UnwindOpCode:
  ...
  *(undefined8 *)(puVar11 + -8) = 0x14013baa1;
  FUN_1402c98b4();
}
