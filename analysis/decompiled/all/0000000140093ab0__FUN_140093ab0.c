// Function: FUN_140093ab0
// Addr: 140093ab0
// Size: 320 bytes


longlong *
FUN_140093ab0(undefined8 param_1,longlong *param_2,longlong *param_3,longlong *param_4,
...

{
  ...
  if ((char)uVar4 < '\0') {
    ...
    *param_7 = 0;
    ...
    uVar5 = FUN_140292860(local_38,&local_res10,(int)(char)uVar4,&param_5);
    *param_7 = uVar5;
  ...
  if (*param_3 == 0) {
    if (*param_4 != 0) goto LAB_140093bd1;
  }
  else if (*param_4 == 0) goto LAB_140093bd1;
  *puVar3 = *puVar3 | 1;
LAB_140093bd1:
  lVar2 = param_3[1];
  *param_2 = *param_3;
