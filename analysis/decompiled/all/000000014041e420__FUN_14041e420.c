// Function: FUN_14041e420
// Addr: 14041e420
// Size: 3410 bytes


/* WARNING: Removing unreachable block (ram,0x00014041e8ef) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

ulonglong FUN_14041e420(undefined8 param_1,double param_2,undefined8 param_3)

{
  ...
  if (DAT_1404e4fb0 != 0) {
    ...
    if ((uint)fVar10 < 0x7f800000) {
      if ((uint)fVar10 < 0x3f800001) {
        if (fVar10 == 0.0) {
          ...
          uVar14 = FUN_140420c90(fVar11,(uint)fVar11 | 0x400000,(uint)fVar11 | 0x400000,
                                 DAT_140494148);
          return uVar14;
        }
        if (fVar22 == 1.0) {
          ...
          uVar14 = FUN_140420c90(fVar11,(uint)fVar31 | 0x400000,(uint)fVar31 | 0x400000,
                                 DAT_140494148);
          return uVar14;
        }
      }
      if ((uint)fVar11 < 0x7f800000) {
        ...
        if ((int)fVar31 < 0x3f880000) {
          ...
          if ((int)fVar31 < 1) {
            if (fVar11 == 0.0) {
              ...
              uVar14 = FUN_140420c90(uVar12,uVar24,uVar12,DAT_140494144);
              return uVar14;
            }
            if (((uint)fVar22 & 0x7f800000) < 0x4b000001) {
              auVar35 = vroundss_avx(auVar35,auVar27,8);
              if (auVar35._0_4_ != fVar22) {
                uVar14 = FUN_140420c90(fVar11,0xffc00000,0xffc00000,DAT_140494154);
                return uVar14;
              }
              if (((int)ROUND(fVar22) & 1U) != 0) {
                auVar36 = ZEXT416(DAT_1404941ac);
              }
            }
          }
          auVar35 = vpshufd_avx(auVar45,0xee);
          dVar23 = auVar35._0_8_ - DAT_14049419c;
          param_2 = ABS(dVar23);
          if ((ulonglong)param_2 < (ulonglong)DAT_140494194) {
            vpshufd_avx(auVar36,0x44);
            dVar44 = dVar23 / (dVar23 + DAT_1404941a4);
            ...
            auVar37._0_8_ = auVar27._0_8_ * (auVar35._0_8_ * _DAT_1404941c0 + _DAT_1404941d0);
            auVar37._8_8_ = auVar27._8_8_ * (auVar35._8_8_ * _UNK_1404941c8 + _UNK_1404941d8);
        ...
        uVar14 = FUN_140420c90(&DAT_140494230,dVar23,auVar35._0_8_,DAT_140494158);
        return uVar14;
      }
      if (fVar10 == 0.0) {
        return 0x3f800000;
      ...
      if (0x7f800000 < (uint)fVar10) {
        if (0x7f800000 < (uint)fVar11) {
          if (fVar31 != -NAN) {
            uVar14 = FUN_140420c90((uint)fVar31 | 0x400000,uVar24,(uint)fVar31 | 0x400000,
                                   DAT_140494150);
            return uVar14;
          }
          uVar14 = FUN_140420c90(0x7fc00000,uVar24,(uint)fVar22 | 0x400000,DAT_140494150);
          return uVar14;
        }
        if (fVar31 == 1.0) {
          ...
          uVar14 = FUN_140420c90(0x3f800000,0x3f800000,0x3f800000,DAT_14049414c);
          return uVar14;
        }
        uVar14 = FUN_140420c90(uVar24,uVar24,(uint)fVar22 | 0x400000,DAT_14049414c);
        return uVar14;
      }
      if ((uint)fVar11 < 0x7f800001) {
        if (fVar11 == 1.0) {
    ...
    uVar14 = FUN_140420c90((uint)fVar31 | 0x400000,uVar24,(uint)fVar31 | 0x400000,DAT_140494148);
    return uVar14;
  }
  ...
  if (0x7f7fffff < (uint)fVar10) {
    if (0x7f800000 < (uint)fVar10) {
      if (0x7f800000 < (uint)fVar11) {
        if (fVar31 != -NAN) {
          uVar14 = FUN_140420c90((uint)fVar31 | 0x400000,auVar28._0_8_,param_3,DAT_140494150);
          return uVar14;
        }
        uVar14 = FUN_140420c90(0x7fc00000,auVar28._0_8_,param_3,DAT_140494150);
        return uVar14;
      }
      if (fVar31 == 1.0) {
        if (0x7fbfffff < (uint)fVar10) {
        ...
        uVar14 = FUN_140420c90(0x3f800000,0x3f800000,param_3,DAT_14049414c);
        return uVar14;
      }
      uVar14 = FUN_140420c90(fVar11,auVar28._0_8_,param_3,DAT_14049414c);
      return uVar14;
    }
    if ((uint)fVar11 < 0x7f800001) {
      if (fVar11 == 1.0) {
...
LAB_14041ea90:
    uVar14 = FUN_140420c90((uint)fVar31 | 0x400000,auVar28._0_8_,param_3,DAT_140494148);
    return uVar14;
  }
  if ((uint)fVar10 < 0x3f800001) {
    if (fVar10 == 0.0) {
      ...
      uVar14 = FUN_140420c90(fVar11,(uint)fVar11 | 0x400000,param_3,DAT_140494148);
      return uVar14;
    }
    ...
    if (fVar22 == 1.0) {
      ...
      uVar14 = FUN_140420c90(fVar11,(uint)fVar31 | 0x400000,param_3,DAT_140494148);
      return uVar14;
    }
  }
  ...
  if ((int)fVar31 < 0x3f880000) {
    if ((int)fVar31 < 1) {
      if (fVar11 == 0.0) {
        ...
        if (fVar11 != 0.0) {
          uVar14 = FUN_140420c90(uVar12 | (uint)fVar10,auVar28._0_8_,uVar13,DAT_140494144);
        }
        return uVar14;
      }
      if (((uint)fVar22 & 0x7f800000) < 0x4b000001) {
        ...
        if (fVar31 != fVar22) {
          uVar14 = FUN_140420c90(fVar11,0xffc00000,param_3,DAT_140494154);
          return uVar14;
        }
        if (((int)ROUND(fVar22) & 1U) != 0) {
          uVar14 = (ulonglong)DAT_1404941ac;
        }
      }
    }
    ...
    in_ZMM3._0_8_ = auVar20._8_8_ - DAT_14049419c;
    param_2 = ABS(in_ZMM3._0_8_);
    if ((ulonglong)param_2 < (ulonglong)DAT_140494194) {
      dVar46 = in_ZMM3._0_8_ / (in_ZMM3._0_8_ + DAT_1404941a4);
      ...
      dVar23 = in_ZMM3._0_8_ +
               ((dVar33 * dVar23 * (dVar23 * _DAT_1404941c0 + _DAT_1404941d0) +
                dVar23 * dVar23 * dVar33 * dVar23 *
                (auVar42._8_8_ * _UNK_1404941c8 + _UNK_1404941d8)) - dVar46 * in_ZMM3._0_8_);
      goto LAB_14041e51e;
    }
  }
  ...
  auVar34 = auVar34 & _DAT_140494220;
  uVar12 = (auVar34._4_4_ >> 0xc) + (uint)((auVar34._0_8_ >> 0x2b & 1) != 0);
  auVar7._8_8_ = _UNK_140494208;
  auVar7._0_8_ = DAT_140494200;
  ...
  dVar23 = ((double)((ulonglong)(uVar12 | 0x3fe00) << 0x2c) - SUB168(auVar34 | auVar7,0)) *
           *(double *)(&DAT_140435ce0 + (ulonglong)uVar12 * 8);
  dVar23 = ((double)(int)(((auVar6._0_8_ & 0xffffffff) >> 0x14) - _DAT_140494210) * DAT_14049416c +
           *(double *)(&DAT_140494230 + (ulonglong)uVar12 * 8)) -
           (dVar23 * dVar23 * (DAT_140494164 * dVar23 + DAT_140494200) + dVar23);
LAB_14041e51e:
  auVar18._8_56_ = auVar20._8_56_;
  dVar23 = auVar20._0_8_ * dVar23;
  if (DAT_140494174 < dVar23) {
    uVar14 = FUN_140420c90(dVar23,0x7f800000,param_3,DAT_140494160);
    return uVar14;
  }
  if (DAT_14049417c < dVar23) {
    uVar12 = (uint)(dVar23 * _DAT_1404941f0);
    dVar23 = dVar23 - (double)(int)uVar12 * DAT_140494184;
    auVar18._0_8_ =
         (dVar23 * dVar23 * (DAT_14049418c * dVar23 + DAT_140494200) + dVar23) *
         *(double *)(&DAT_140497c30 + (ulonglong)(uVar12 & 0x3f) * 8) +
         *(double *)(&DAT_140497c30 + (ulonglong)(uVar12 & 0x3f) * 8);
  ...
  uVar14 = FUN_140420c90(dVar23,param_2,param_3,DAT_140494158);
  return uVar14;
}
