// Function: FUN_1402c2b34
// Addr: 1402c2b34
// Size: 465 bytes


ulonglong FUN_1402c2b34(longlong param_1,undefined1 param_2)
...
LAB_1402c2b82:
    if (iVar9 == 1) goto LAB_1402c2c87;
    if (iVar9 != 2) {
      lVar8 = *(longlong *)(param_1 + 8);
      *(undefined1 *)(lVar8 + 0x30) = 1;
      *(undefined4 *)(lVar8 + 0x2c) = 0x16;
      uVar7 = FUN_1402cada4(0,0,0,0,0,*(undefined8 *)(param_1 + 8));
...
LAB_1402c2bb2:
  ...
  if (*(int *)(param_1 + 0x30) < 0) {
    ...
    *(uint *)(param_1 + 0x28) = uVar6 & 0xfffffff7;
    FUN_1402c1a14(param_1 + 0x50,(longlong)*(int *)(param_1 + 0x30),*(undefined8 *)(param_1 + 8));
  }
  if (uVar7 == 0) {
  ...
  *(undefined1 *)(param_1 + 0x4c) = 1;
  if (lVar8 == 8) {
    func_0x0001402c367c(param_1,uVar7);
  }
  else {
    FUN_1402c32f0(param_1,uVar7 & 0xffffffff,param_2);
  }
