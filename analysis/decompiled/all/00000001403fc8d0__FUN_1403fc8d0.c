// Function: FUN_1403fc8d0
// Addr: 1403fc8d0
// Size: 454 bytes


ulonglong FUN_1403fc8d0(longlong param_1,int *param_2)

{
  ...
  if (uVar8 <= uVar6) {
    ...
    if ((char)uVar3 != '\0') {
      uVar3 = FUN_140373920(param_2,(ulonglong)*(byte *)(param_1 + 10) * 0x100 +
                                    (ulonglong)*(byte *)(param_1 + 0xb) + param_1);
      if ((char)uVar3 != '\0') {
        uVar3 = FUN_1404093d0(param_1 + 0xc,param_2,param_1);
        if ((char)uVar3 != '\0') {
          uVar3 = FUN_140373920(param_2,(ulonglong)*(byte *)(param_1 + 0xd) +
                                        (ulonglong)*(byte *)(param_1 + 0xc) * 0x100 + param_1);
          if ((char)uVar3 != '\0') {
            uVar5 = (uint)*(byte *)(param_1 + 0xe) * 0x100 + (uint)*(byte *)(param_1 + 0xf);
