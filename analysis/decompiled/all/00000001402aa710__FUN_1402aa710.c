// Function: FUN_1402aa710
// Addr: 1402aa710
// Size: 260 bytes


void FUN_1402aa710(undefined8 param_1,undefined4 *param_2,longlong *param_3,undefined4 *param_4,
...

{
  ...
  local_b8 = &local_90;
  uVar1 = FUN_14029acd0(local_68,&local_a8,&local_78,*(undefined4 *)(param_5 + 0x18));
...
code_r0x0001402aa84b:
      ...
      if (sVar2 == -1) goto code_r0x0001402aa84b;
  ...
  if ((char)uStack_70 == '\0') {
    if (lVar5 != 0) {
      ...
      if (sVar2 != -1) goto code_r0x0001402aa89a;
    }
    lVar5 = 0;
  }
code_r0x0001402aa89a:
  if (lVar4 == 0) {
    if (lVar5 != 0) goto code_r0x0001402aa8ae;
  }
  else if (lVar5 == 0) goto code_r0x0001402aa8ae;
  *param_6 = *param_6 | 1;
code_r0x0001402aa8ae:
  *param_7 = uVar3;
