...
bool FUN_1403be510(longlong param_1,undefined4 param_2,undefined8 param_3,undefined8 param_4,
                  int param_5)

{
  ...
  if (((char)param_5 == '\0') || ((!bVar21 && (fVar26 == 0.0)))) {
    ...
    while (puVar16 = DAT_1404e52c8, DAT_1404e52c8 = puVar16, puVar16 == (undefined *)0x0) {
      puVar5 = (undefined *)FUN_1403bb4a0();
      puVar16 = &DAT_1404df1c8;
      if (puVar5 != (undefined *)0x0) {
        puVar16 = puVar5;
      }
      LOCK();
      bVar20 = DAT_1404e52c8 == (undefined *)0x0;
      puVar5 = puVar16;
      if (!bVar20) {
        puVar5 = DAT_1404e52c8;
      }
      DAT_1404e52c8 = puVar5;
      UNLOCK();
      if (bVar20) break;
      if ((puVar16 != (undefined *)0x0) && (puVar16 != &DAT_1404df1c8)) {
        FUN_140414f40(puVar16);
      }
    }
    iVar4 = (**(code **)(*(longlong *)(param_1 + 0x90) + 0xb8))
    ...
    if (iVar4 == 0) {
      ...
      if (bVar21) {
        if (*(char *)(param_1 + 0x3c) == '\0') {
          local_res8[0] = (float)*(int *)(param_1 + 0x40) * DAT_140492790;
        }
        else {
          local_res8[0] = 0.0;
        }
        fVar26 = (float)*(int *)(param_1 + 0x44) * DAT_140492790;
        if (*(int *)(param_1 + 0x28) < 0) {
          local_res8[0] = (float)((uint)local_res8[0] ^ DAT_1404930c0);
        }
        local_114 = fVar26;
        if (*(int *)(param_1 + 0x2c) < 0) {
          local_114 = (float)((uint)fVar26 ^ DAT_1404930c0);
        }
        if ((((float)*(int *)(param_1 + 0x40) != 0.0) || ((float)*(int *)(param_1 + 0x44) != 0.0))
           && (local_100._4_4_ != 0)) {
          fVar27 = (float)*(int *)(param_1 + 0x40) * DAT_140492790;
          fVar22 = (float)FUN_1403b7a00(&local_100);
          cVar15 = fVar22 < 0.0;
          param_5 = CONCAT31(param_5._1_3_,cVar15);
          local_10c = 0;
          if (local_f0._4_4_ != 0) {
            uVar9 = ram0x00014045dde4;
            uVar6 = uVar13;
            uVar12 = local_f0._4_4_;
            uVar11 = (uint)DAT_14045dde0;
            if (local_f0._4_4_ != 0) goto LAB_1403be8ac;
            DAT_1404e4ff0._0_4_ = (uint)DAT_14045dde0;
            uVar10 = (uint)DAT_14045dde0;
            do {
              uVar1 = uVar10 - 1;
              uVar18 = (uint)uVar13;
              if ((uint)uVar6 != uVar1) {
...
LAB_1403be9e9:
                    ...
                    if (fVar22 != 0.0) {
                      ...
                      if (fVar28 <= _DAT_140471b68) {
                        fVar28 = 0.0;
                        fVar25 = 0.0;
                      }
                      else {
                        fVar28 = fVar28 + DAT_1404927d4;
                        fVar24 = fVar32 + fVar25;
                        fVar30 = fVar33 + fVar29;
                        fVar29 = fVar33 * fVar25 - fVar32 * fVar29;
                        if (cVar15 == '\0') {
                          fVar30 = (float)((uint)fVar30 ^ DAT_1404930c0);
                        }
                        else {
                          fVar29 = (float)((uint)fVar29 ^ DAT_1404930c0);
                          fVar24 = (float)((uint)fVar24 ^ DAT_1404930c0);
                        }
                        if (fVar31 <= fVar22) {
                          fVar22 = fVar31;
                        }
                      ...
                      if (uVar12 != uVar18) {
                        do {
                          ...
                          if (uVar12 < local_100._4_4_) {
                            ...
                            pfVar8 = (float *)&DAT_1404e4ff0;
                            DAT_1404e4ff0._0_4_ = uVar11;
                    ...
                    fVar30 = pfVar17[1];
                    fVar2 = pfVar7[1];
                    fVar23 = (float)FUN_140419d30(fVar28 - fVar24);
                    uVar14 = uVar13;
                    fVar31 = fVar22;
                    fVar32 = fVar25;
                    fVar33 = fVar29;
