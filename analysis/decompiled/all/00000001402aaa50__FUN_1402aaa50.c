// Function: FUN_1402aaa50
// Addr: 1402aaa50
// Size: 292 bytes


void FUN_1402aaa50(undefined8 param_1,undefined4 *param_2,longlong *param_3,longlong *param_4,
...

{
  ...
  local_78 = &local_60;
  uVar2 = FUN_14029acd0(local_50,param_3,param_4,*(undefined4 *)(param_5 + 0x18));
  ...
  if ((char)uVar2 < '\0') {
    ...
    *param_7 = 0;
    ...
    uVar3 = func_0x000140292930(local_50,&local_60,(int)(char)uVar2,local_68);
    *param_7 = uVar3;
  ...
  if (*param_3 == 0) {
    if (*param_4 != 0) goto LAB_1402aab80;
  }
  else if (*param_4 == 0) goto LAB_1402aab80;
  *param_6 = *param_6 | 1;
LAB_1402aab80:
