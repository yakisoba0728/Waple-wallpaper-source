// Function: FUN_14003e5e0
// Addr: 14003e5e0
// Size: 68 bytes


void FUN_14003e5e0(ulonglong *param_1,ulonglong param_2,undefined8 param_3)

{
  ...
  if (param_2 <= (ulonglong)((longlong)(param_1[1] - *param_1) >> 3)) {
    func_0x00014000f8a0(*param_1,param_1[1],&local_res18);
    return;
  }
  if (0x1fffffffffffffff < param_2) {
code_r0x00014003e710:
...
code_r0x00014003e677:
    uVar3 = *param_1;
    if (param_1[2] - uVar3 == 0) goto code_r0x00014003e6be;
    uVar6 = uVar3;
    puVar7 = auStack_28;
    if ((0xfff < (ulonglong)(((longlong)(param_1[2] - uVar3) >> 3) * 8)) &&
       (uVar6 = *(ulonglong *)(uVar3 - 8), puVar7 = auStack_28, 0x1f < (uVar3 - uVar6) - 8))
    goto code_r0x00014003e6af;
  }
  else {
    if (uVar2 < 0x1000) {
      unaff_RDI = (undefined8 *)func_0x00014028aff0(uVar2);
      goto code_r0x00014003e677;
    }
    if (uVar2 + 0x27 <= uVar2) goto code_r0x00014003e710;
...
code_r0x00014003e6af:
    pcVar4 = (code *)swi(0x29);
    uVar6 = (*pcVar4)(5);
    puVar7 = auStack_20;
  }
  *(undefined8 *)(puVar7 + -8) = 0x14003e6be;
  func_0x00014028b040(uVar6);
code_r0x00014003e6be:
