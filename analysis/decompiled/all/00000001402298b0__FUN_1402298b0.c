...
void FUN_1402298b0(longlong param_1,longlong param_2)

{
  ...
  fVar7 = pfVar1[8];
  if (*(int *)(param_2 + 8) == 0) {
    fVar8 = (float)(*(uint *)(param_1 + 0x168) ^ DAT_140492ff0);
    fVar4 = (float)((uint)*(undefined8 *)(param_1 + 0x160) ^ DAT_140492ff0);
    fVar5 = (float)((uint)((ulonglong)*(undefined8 *)(param_1 + 0x160) >> 0x20) ^ _UNK_140492ff4);
    ...
    *(ulonglong *)(param_1 + 0x184) = CONCAT44(fVar5,fVar4);
    if (bVar2 == 0) {
      ...
      fStack_c4 = _DAT_140492e30 * fVar15 + fVar11 * 0.0 + fVar14 * 0.0;
      local_c0 = _UNK_140492e34 * fVar13 + fVar12 * 0.0 + fVar16 * 0.0;
    }
