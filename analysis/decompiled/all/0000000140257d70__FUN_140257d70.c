// Function: FUN_140257d70
// Addr: 140257d70
// Size: 733 bytes


void FUN_140257d70(longlong param_1)
  ...
  if (*(longlong *)(param_1 + 0x5a8) != 0) {
    ...
    *(undefined1 *)(*(longlong *)(param_1 + 200) + 0x1ca) = 1;
    if ((*(int *)(param_1 + 0x518) != 0) && (lVar9 = *(longlong *)(param_1 + 0x5a8), lVar9 != 0)) {
      ...
      uStack_90 = 0;
      uStack_88 = 0;
      FUN_140258b80(param_1,&local_a8);
      *(undefined8 *)(lVar9 + 0x1c) = local_a8;
      *(undefined8 *)(lVar9 + 0x24) = uStack_a0;
      *(undefined8 *)(lVar9 + 0x2c) = local_98;
    ...
    local_b0 = fVar11 * *(float *)(param_1 + 0x338);
    local_b8 = CONCAT44((float)((ulonglong)*(undefined8 *)(param_1 + 0x330) >> 0x20) * fVar11,
                        (float)*(undefined8 *)(param_1 + 0x330) * fVar11);
    FUN_1401b3430(lVar10,*(undefined8 *)(param_1 + 0x5a8),0,0,&local_b8,
