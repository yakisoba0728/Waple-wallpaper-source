// Function: FUN_1400b4a60
// Addr: 1400b4a60
// Size: 84 bytes


char * FUN_1400b4a60(int *param_1,undefined8 param_2,longlong param_3)

{
  ...
  if ((param_1[0x16] == 0) || (param_1[0x16] == 1)) {
    pcVar1 = (char *)func_0x0001400b4b90(param_1);
    ...
    if (*pcVar1 != '$') goto code_r0x0001400b4b6e;
    iVar2 = 1;
    param_1[0x16] = 1;
    if (*pcVar1 != '$') goto code_r0x0001400b4b64;
  }
  else {
    param_1[0x16] = 0;
    pcVar1 = (char *)0x0;
code_r0x0001400b4b64:
    iVar2 = 0;
  }
  param_1[1] = iVar2;
  if (pcVar1 == (char *)0x0) {
