// Function: FUN_140257d00
// Addr: 140257d00
// Size: 103 bytes


void FUN_140257d00(longlong *param_1)

{
  ...
  if ((*(byte *)((longlong)param_1 + 0x594) & 2) == 0) {
    ...
    *puVar4 = *puVar20;
    ...
    puVar4[0xe] = uVar18;
    puVar4[0xf] = uVar19;
    FUN_140156090(param_1[0xb7]);
    (**(code **)(*(longlong *)param_1[0xb6] + 8))();
    FUN_140157500(param_1[0xb7]);
    lVar2 = param_1[0x19];
  ...
  (**(code **)(**(longlong **)(lVar2 + 0x1518) + 0x118))
             ...
             *(undefined4 *)((longlong)param_1 + 0x33c));
                    /* WARNING: Could not recover jumptable at 0x000140257d8e. Too many branches */
