// Function: FUN_1401a28f0
// Addr: 1401a28f0
// Size: 5 bytes


void FUN_1401a28f0(float *param_1)

{
  ...
  fVar13 = (float)func_0x00014041a070((float)(*(longlong *)(param_1 + 4) + 1) / *param_1);
  lVar10 = 0;
  if ((DAT_140492a44 <= fVar13) && (fVar13 = fVar13 - DAT_140492a44, fVar13 < DAT_140492a44)) {
    lVar10 = -0x8000000000000000;
  }
  uVar11 = 8;
  if (8 < (ulonglong)((longlong)fVar13 + lVar10)) {
    uVar11 = (longlong)fVar13 + lVar10;
  }
  uVar12 = uVar8;
  if ((uVar8 < uVar11) && ((0x1ff < uVar8 || (uVar12 = uVar8 * 8, uVar8 * 8 < uVar11)))) {
    uVar12 = uVar11;
  }
  for (lVar10 = 0x3f; 0xfffffffffffffffU >> lVar10 == 0; lVar10 = lVar10 + -1) {
  }
  if ((ulonglong)(1L << ((byte)lVar10 & 0x3f)) < uVar12) {
  ...
  func_0x0001400376d0(param_1 + 6,2L << (bVar9 & 0x3f),plVar1);
  *(longlong *)(param_1 + 0xe) = lVar10;
  *(longlong *)(param_1 + 0xc) = lVar10 + -1;
  plVar7 = (longlong *)**(undefined8 **)(param_1 + 2);
joined_r0x0001401a3146:
  do {
    while( true ) {
      while( true ) {
        if (plVar7 == plVar1) {
          uStackX_10 = 0;
          func_0x00014005b1b0(&uStackX_10);
          return;
        }
        lVar10 = *(longlong *)(param_1 + 6);
        plVar2 = (longlong *)*plVar7;
        uVar8 = *(ulonglong *)(param_1 + 0xc) &
