// Function: FUN_140159900
// Addr: 140159900
// Size: 368 bytes


longlong FUN_140159900(longlong param_1,char *param_2)

{
  ...
  lVar6 = *(longlong *)(DAT_1404e7fe8 + 8 + (DAT_1404e8000 & uVar9) * 0x10);
  if (lVar6 != DAT_1404e7fd8) {
    lVar7 = *(longlong *)(DAT_1404e7fe8 + (DAT_1404e8000 & uVar9) * 0x10);
    cVar2 = FUN_14000d010(lVar6 + 0x10,param_2);
    while (cVar2 == '\0') {
      if (lVar6 == lVar7) goto LAB_1401599ae;
      lVar6 = *(longlong *)(lVar6 + 8);
      cVar2 = FUN_14000d010(lVar6 + 0x10,param_2);
    }
    if (lVar6 != 0) goto LAB_1401599b5;
  }
LAB_1401599ae:
  lVar6 = DAT_1404e7fd8;
LAB_1401599b5:
