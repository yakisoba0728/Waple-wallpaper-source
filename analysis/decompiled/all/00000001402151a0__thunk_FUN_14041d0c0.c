...
ulonglong thunk_FUN_14041d0c0(ulonglong param_1,float param_2)
...
LAB_14041d373:
    ...
    if (uVar4 - 1 < 0x7fe) {
      ...
      if ((ulonglong)dVar7 <= (ulonglong)dVar6) {
        ...
        auVar9 = auVar15;
        if (fVar8 < 0.0) {
          auVar9._0_4_ = SUB84(auVar15._0_8_,0) ^ (uint)DAT_140492fe0;
          auVar9._4_4_ = (uint)((ulonglong)auVar15._0_8_ >> 0x20) ^ DAT_140492fe0._4_4_;
          auVar9._8_4_ = auVar14._8_4_ ^ _UNK_140492fe8;
          auVar9._12_4_ = auVar14._12_4_ ^ _UNK_140492fec;
        }
      ...
      if (fVar8 < 0.0) {
        dVar6 = (double)CONCAT44((uint)((ulonglong)dVar6 >> 0x20) ^ DAT_140492fe0._4_4_,
                                 SUB84(dVar6,0) ^ (uint)DAT_140492fe0);
      }
  ...
  if (((ulonglong)dVar12 & 0xfffffffffffff) != 0) {
    uVar3 = FUN_1402ecca0(param_1 & 0xffffffff);
    return uVar3;
  }
LAB_14041d3d3:
  uVar3 = FUN_1402ecb40("fmodf",0x16,0xffc00000,1,8,0x21,fVar8,param_2,2);
  return uVar3;
}
