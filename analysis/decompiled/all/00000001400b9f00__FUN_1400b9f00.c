// Function: FUN_1400b9f00
// Addr: 1400b9f00
// Size: 1069 bytes


char * FUN_1400b9f00(longlong param_1,longlong *param_2)
    ...
    if (cVar1 == '\0') {
      ...
      *(undefined4 *)(param_1 + 0x8c) = uVar9;
      if (*(int *)(param_1 + 0x7c) == 2) {
        *(undefined4 *)(param_1 + 0x7c) = 0;
        uVar18 = uVar13;
        goto switchD_1400b9f7f_caseD_1;
      }
    }
    else if (cVar1 == '\x02') {
      *(code **)(param_1 + 0x198) = FUN_1400bd3f0;
      ...
      *(undefined4 *)(param_1 + 0x8c) = uVar9;
      if (*(int *)(param_1 + 0x7c) == 6) {
        *(undefined4 *)(param_1 + 0x7c) = 0;
        uVar13 = uVar18;
        goto switchD_1400b9f7f_caseD_3;
      }
    }
    else if (cVar1 == '\x03') {
...
LAB_1400ba2c0:
      if (uVar13 <= (uint)puVar19) goto LAB_1400ba10b;
      iVar15 = 5;
    }
    break;
  default:
    goto switchD_1400b9f7f_default;
  }
  bVar5 = true;
  pcVar8 = "$base: short read";
switchD_1400b9f7f_default:
