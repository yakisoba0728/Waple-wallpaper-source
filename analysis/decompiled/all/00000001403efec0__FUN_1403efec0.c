// Function: FUN_1403efec0
// Addr: 1403efec0
// Size: 448 bytes


void FUN_1403efec0(longlong param_1,longlong param_2,undefined4 param_3)

{
  ...
  fVar7 = ((float)(int)(short)((ushort)*(byte *)(param_1 + 5) +
                              (ushort)*(byte *)(param_1 + 4) * 0x100) + fVar5) * DAT_140471a5c;
  fVar5 = (float)FUN_1403993a0(*(undefined8 *)(param_2 + 0x48),param_3,1);
  lVar1 = *(longlong *)(param_2 + 0x10);
  fVar7 = (float)((uint)fVar7 ^ DAT_140492ff0) * DAT_140492834;
  fVar5 = ((float)(int)(short)((ushort)*(byte *)(param_1 + 6) * 0x100 +
                              (ushort)*(byte *)(param_1 + 7)) + fVar5) * DAT_140471a5c *
          DAT_140492834;
  if (fVar5 == 0.0) {
    uVar8 = 0;
  }
  else {
    uVar8 = FUN_14041b0d0(fVar5);
  }
  if (fVar7 == 0.0) {
    uVar6 = 0;
  }
  else {
    uVar6 = FUN_14041b0d0(fVar7);
  }
  uVar2 = 0;
  ...
  (**(code **)(lVar1 + 0x10))
            (lVar1,*(undefined8 *)(param_2 + 0x18),DAT_140492704,uVar8,uVar6,DAT_140492704,0,0,uVar2
            );
  ...
  if (*(longlong *)(lVar1 + 0x98) != 0) {
    uVar2 = *(undefined8 *)(*(longlong *)(lVar1 + 0x98) + 8);
                    ...
                    /* WARNING: Could not recover jumptable at 0x0001403f007c. Too many branches */
