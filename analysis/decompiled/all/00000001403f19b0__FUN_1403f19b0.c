// Function: FUN_1403f19b0
// Addr: 1403f19b0
// Size: 403 bytes


void FUN_1403f19b0(longlong param_1,longlong param_2)
  ...
  if (*(char *)(param_2 + 0x5a) == '\0') {
    ...
    *(undefined4 *)(param_2 + 100) = 0;
    if ((uVar1 * 5 & 0x3fffffff) != 0) {
      FUN_1404217a0(*(undefined8 *)(param_2 + 0x80),0,uVar1 * 0x14);
    }
  }
...
LAB_1403f1a12:
      ...
      if (uVar1 != 0) {
        do {
          if (*(short *)(lVar4 + 0x10 + uVar8 * 0x14) != 0) {
            FUN_1403f5100(lVar4,uVar1,uVar8);
          }
          uVar5 = (uint)uVar6;
          uVar7 = (int)uVar8 + 1;
  ...
  if (((*(float *)(param_1 + 0x4c) != 0.0) && ((uVar5 & 0xfffffffe) == 4)) &&
    ...
    do {
      ...
      if (iVar2 != 0) {
        fVar10 = (float)FUN_14041a5c0((float)iVar2 * *(float *)(param_1 + 0x4c) + fVar3);
