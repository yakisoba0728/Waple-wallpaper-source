// Function: FUN_140370340
// Addr: 140370340
// Size: 5 bytes


void FUN_140370340(byte *param_1,char *param_2,undefined8 param_3,longlong param_4)

{
  ...
  if ((uint)param_1[2] * 0x100 + (uint)param_1[3] != 0) {
    do {
      if ((((*(ulonglong *)(param_4 + 8 + (ulonglong)(param_1[uVar4 + 4] >> 6) * 8) >>
             (param_1[uVar4 + 4] & 0x3f) & 1) != 0) && (*param_2 != '\0')) &&
         (uVar3 = (uint)param_1[1] + (uint)*param_1 * 0x100 + (int)uVar4, uVar3 != 0xffffffff)) {
        param_2[4] = -1;
        param_2[5] = -1;
        param_2[6] = -1;
        param_2[7] = -1;
        puVar1 = (undefined4 *)FUN_1403ed630(param_2,uVar3,1);
