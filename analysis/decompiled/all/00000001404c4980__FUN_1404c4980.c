...
void FUN_1404c4980(byte *param_1,undefined8 param_2)

{
  ...
  bVar5 = ((byte)in_EAX |
          *(byte *)(CONCAT44(in_register_00000004,in_EAX) + CONCAT44(in_register_00000004,in_EAX)))
          + 1;
