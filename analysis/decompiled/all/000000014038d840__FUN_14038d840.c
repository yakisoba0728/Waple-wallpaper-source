// Function: FUN_14038d840
// Addr: 14038d840
// Size: 452 bytes


bool FUN_14038d840(short *param_1,longlong param_2,undefined8 *param_3)

{
  ...
  lVar3 = func_0x000140386e30(param_2,param_1);
  if (lVar3 == 0) {
    return false;
  }
  puVar16 = param_3;
  ...
  if (*(int *)(puVar8 + 2) != 0) {
    ...
    if (*(int *)(puVar8 + 2) != 0) {
      ...
      if (*(int *)(puVar16 + 2) == 0) {
        DAT_1404e4ff0._0_2_ = (ushort)DAT_14045dde0;
        pbVar17 = (byte *)&DAT_1404e4ff0;
        uVar6 = (ushort)DAT_14045dde0 & 0xff;
      }
      else {
      ...
      while( true ) {
        ...
        if (iVar15 == 0) {
          DAT_1404e4ff0._0_2_ = (ushort)DAT_14045dde0;
          uVar7 = (ushort)DAT_14045dde0 & 0xff;
          pbVar17 = (byte *)&DAT_1404e4ff0;
        }
        else {
          uVar7 = (uint)*pbVar11;
      ...
      goto code_r0x00014038d9db;
    }
  }
  uVar6 = 0;
code_r0x00014038d9db:
  bVar5 = 2;
code_r0x00014038d9dd:
  local_res8 = (ushort)bVar5 << 8;
  *param_1 = local_res8;
  if (bVar5 == 1) {
    lVar3 = func_0x000140386ed0(param_2,param_1);
    if (lVar3 != 0) {
      param_1[1] = 0;
      uVar4 = FUN_14038afe0(param_2);
      local_98 = *param_3;
      uStack_90 = param_3[1];
      uStack_88 = param_3[2];
      uStack_80 = param_3[3];
      local_60 = &DAT_14047061e;
      uStack_78 = param_3[4];
      psStack_70 = (short *)param_3[5];
      uStack_68 = param_3[6];
      cVar1 = FUN_14038d1f0(uVar4,param_2,&local_98);
      if (cVar1 != '\0') {
        uVar2 = FUN_1403f0e00(param_2,1);
        func_0x00014036b9d0(param_2,param_1 + 1,uVar2,0,0);
        bVar5 = (byte)(uVar6 >> 8);
    ...
    cVar1 = FUN_14040a530(param_1 + 2,param_2,uVar21,0);
    if (cVar1 == '\0') {
      return false;
    }
    if ((uint)uVar21 != 0) {
    ...
    cVar1 = FUN_14038dc50(param_1 + 1,param_2,&local_98);
    return cVar1 != '\0';
  }
  return false;
}
