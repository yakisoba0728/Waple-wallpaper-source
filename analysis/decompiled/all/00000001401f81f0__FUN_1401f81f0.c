...
void FUN_1401f81f0(longlong param_1,longlong *param_2)

{
  ...
  FUN_14015ab00(param_2,*(longlong *)(param_1 + 0x250) + _DAT_1404e8570);
  FUN_1401e1500(param_1,param_2);
  puVar2 = DAT_1404e8568;
  for (puVar1 = (undefined8 *)*DAT_1404e8568; puVar1 != puVar2; puVar1 = (undefined8 *)*puVar1) {
    plVar8 = (longlong *)param_2[1];
    if (plVar8 == (longlong *)param_2[2]) {
      uVar9 = (longlong)plVar8 - *param_2;
      lVar6 = (longlong)uVar9 >> 3;
      if (lVar6 == 0x1fffffffffffffff) goto LAB_1401f84e0;
      uVar5 = param_2[2] - *param_2 >> 3;
      if (0x1fffffffffffffff - (uVar5 >> 1) < uVar5) goto LAB_1401f84e6;
      uVar10 = lVar6 + 1;
      uVar5 = (uVar5 >> 1) + uVar5;
      uVar7 = uVar10;
      if (uVar10 <= uVar5) {
      ...
      if (0x1fffffffffffffff < uVar7) goto LAB_1401f84e6;
      uVar5 = uVar7 * 8;
      if (uVar5 == 0) {
        uVar5 = 0;
      }
        ...
        if (uVar5 + 0x27 <= uVar5) goto LAB_1401f84e6;
        lVar6 = FUN_14028af20(uVar5 + 0x27);
        if (lVar6 == 0) goto LAB_1401f84c4;
...
LAB_1401f84e6:
      ...
      if (0x1fffffffffffffff < uVar10) goto LAB_1401f84e6;
      uVar5 = uVar10 * 8;
      if (uVar5 == 0) {
        uVar5 = 0;
      }
