// Function: FUN_140363a40
// Addr: 140363a40
// Size: 463 bytes


void FUN_140363a40(longlong param_1,longlong param_2)
    ...
    do {
      ...
      while (lVar11 < lVar15) {
        ...
        if (*puVar1 < uVar6) {
          ...
          iVar12 = FUN_1403b38b0(puVar1 + 2,puVar1 + -4);
        }
        lVar14 = lVar11 * 2 + 1;
        if (-1 < iVar12) {
          lVar14 = lVar16;
      ...
      while (lVar13 < lVar11) {
        ...
        if (uVar6 < uVar5) {
          ...
          iVar12 = FUN_1403b38b0(puVar2 + 2,&local_58);
        }
        lVar15 = local_70;
        if (-1 < iVar12) break;
        uVar8 = puVar2[1];
