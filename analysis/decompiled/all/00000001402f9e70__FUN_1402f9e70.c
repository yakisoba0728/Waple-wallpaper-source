// Function: FUN_1402f9e70
// Addr: 1402f9e70
// Size: 607 bytes


undefined8 FUN_1402f9e70(longlong param_1,undefined8 param_2,byte *param_3,char param_4)

{
  ...
  iVar7 = FUN_140421e50(param_2,"darkening-parameters");
  if (iVar7 != 0) {
    iVar7 = FUN_140421e50(param_2,"hinting-engine");
    if (iVar7 == 0) {
      lVar10 = 0;
      if (param_4 == '\0') {
        if (*(int *)param_3 != 1) {
        ...
        do {
          lVar11 = lVar10 + 1;
          if (param_3[lVar10] != (&DAT_140436990)[lVar10]) {
            return 6;
          }
          lVar10 = lVar11;
        } while (lVar11 != 6);
    ...
    iVar7 = FUN_140421e50(param_2,"no-stem-darkening");
    if (iVar7 == 0) {
      if (param_4 != '\0') {
        iVar7 = FUN_1402c1004(param_3,0,10);
    ...
    iVar7 = FUN_140421e50(param_2,"random-seed");
    if (iVar7 != 0) {
      return 0xc;
    }
    if (param_4 != '\0') {
  ...
  if (param_4 != '\0') {
    uVar13 = 0;
    do {
      uVar8 = FUN_1402c1004(param_3,&local_48,10);
