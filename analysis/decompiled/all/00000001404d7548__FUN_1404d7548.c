...
void FUN_1404d7548(char *param_1,longlong param_2)

{
  ...
  iVar3 = *(int *)((longlong)unaff_RDI + (longlong)param_1);
  ...
  *(char *)(CONCAT71(unaff_00000019,unaff_BL + (char)((ulonglong)param_1 >> 8)) + 0x4d) =
  ...
  *unaff_RDI = *unaff_RDI & unaff_ESI + iVar3 + (uint)in_CF;
