...

{
  ...
  *(undefined1 *)(param_1 + 0x6b4) = 0;
  ...
  while (cVar1 != '\0') {
    cVar1 = *pcVar8;
    if (((cVar1 != '\x01') && (cVar1 != '\x02')) && (cVar1 != '\x03')) goto LAB_14024c6f7;
  ...
  if (lVar9 != lVar13) {
    do {
      FUN_14022f640(*(undefined8 *)(lVar9 + 8));
      lVar9 = lVar9 + 0x10;
    } while (lVar9 != lVar13);
  }
LAB_14024c6f7:
  *(undefined4 *)(param_1 + 0x770) = 0;
  FUN_14022f6c0(param_1 + 0x2c0);
  if (*(int *)(param_1 + 0x600) != 0) {
    *(undefined8 *)(param_1 + 0x600) = 0;
    *(undefined4 *)(param_1 + 0x610) = 0;
    FUN_1404217a0(*(undefined8 *)(param_1 + 0x520),0,(ulonglong)*(uint *)(param_1 + 0x60c) << 2);
  ...
  for (lVar9 = *(longlong *)(param_1 + 0x740); lVar9 != lVar13; lVar9 = lVar9 + 0x10) {
    FUN_14022fd90(*(undefined8 *)(lVar9 + 8));
  }
  ...
  if (*(ulonglong *)(param_1 + 0x708) != 0) {
    ...
    if (*(ulonglong *)(param_1 + 0x708) < *(ulonglong *)(param_1 + 0x730) >> 3) {
      ...
      if (plVar10 != plVar2) {
        ...
        local_res8 = *(longlong *)(lVar13 + uVar14 * 0x10);
            ...
            while (plVar12 != plVar2) {
              ...
              while( true ) {
                ...
                *(longlong *)(param_1 + 0x708) = *(longlong *)(param_1 + 0x708) + -1;
                ...
                plVar7 = plVar12;
                if (plVar12 == plVar2) goto LAB_14024c8bd;
              }
              *(longlong **)(lVar13 + uVar14 * 0x10) = plVar2;
...
LAB_14024c8c1:
      ...
      *(undefined8 *)(param_1 + 0x708) = 0;
      local_res8 = *(longlong *)(param_1 + 0x700);
      FUN_14000f7d0(*(undefined8 *)(param_1 + 0x710),*(undefined8 *)(param_1 + 0x718),&local_res8);
    }
  }
  return;
}
