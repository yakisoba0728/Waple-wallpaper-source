// Function: FUN_14038a620
// Addr: 14038a620
// Size: 555 bytes


void FUN_14038a620(longlong param_1,byte *param_2,uint param_3,uint param_4,uint param_5)
    ...
    if (uVar9 < 0x10000000) {
      ...
      if (cVar4 != '\0') {
          ...
          *(undefined4 *)(param_1 + 0xb0) = 0;
          if (param_2 < param_2 + uVar12) {
            ...
            do {
              ...
              pbVar7 = (byte *)FUN_1403ecea0(pbVar10,pbVar8,local_res8,uVar2);
              uVar3 = uVar2;
              if (pbVar7 == pbVar8) {
                pbVar11 = pbVar10;
                uVar3 = local_res8[0];
        ...
        while (pbVar10 = pbVar8, pbVar10 < pbVar11 + (int)uVar9) {
          pbVar8 = (byte *)FUN_1403ecea0(pbVar10,pbVar11 + (int)uVar9,local_res8,uVar2);
        ...
        *(undefined4 *)(param_1 + 0xb4) = 0;
        if (pbVar10 < param_2) {
          ...
          do {
            if (4 < uVar12) break;
            pbVar10 = (byte *)FUN_1403ecea0(pbVar10,param_2,local_res8,uVar2);
            *(undefined4 *)(param_1 + 0x9c + (ulonglong)uVar12 * 4) = local_res8[0];
