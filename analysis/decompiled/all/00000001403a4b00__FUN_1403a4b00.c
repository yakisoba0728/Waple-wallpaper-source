// Function: FUN_1403a4b00
// Addr: 1403a4b00
// Size: 200 bytes


undefined8 FUN_1403a4b00(uint *param_1,uint param_2,char param_3)

{
  ...
  if (uVar4 == 0) {
    ...
    if ((uVar2 == 0) && (*(longlong *)puVar1 != 0)) {
      lVar3 = thunk_FUN_1402da070(uVar5 * 0x18);
      if (lVar3 == 0) {
LAB_1403a4c0b:
        if (uVar4 <= *param_1) {
          return 1;
      ...
      lVar3 = func_0x0001402cb2b0(*(undefined8 *)puVar1,uVar5 * 0x18);
      if (lVar3 == 0) goto LAB_1403a4c0b;
    }
  }
