...
void FUN_140254040(float *param_1,longlong param_2)

{
  ...
  if (uVar4 != 0) {
    ...
    do {
      ...
      fVar64 = fVar63 * _DAT_140492f40;
      fVar66 = fVar65 * _UNK_140492f44;
      fVar68 = fVar67 * _UNK_140492f48;
      fVar70 = fVar69 * _UNK_140492f4c;
      fVar42 = param_1[0x1c];
      fVar43 = param_1[0x1d];
      fVar44 = param_1[0x1e];
      fVar45 = param_1[0x1f];
      ...
      uVar72 = -(uint)(((0.0 < fVar47 + (*pfVar2 - param_1[8]) * fVar14 +
                       ...
                       (float)((uint)(fVar59 * param_1[0x24] + fVar55 * param_1[0x20] +
                                     fVar51 * param_1[0x28]) & _DAT_140483860) < param_1[0x2c]) &&
                      (float)((uint)(fVar59 * param_1[0x34] + fVar55 * param_1[0x30] +
                                    fVar51 * param_1[0x38]) & _DAT_140483860) < param_1[0x3c]);
      uVar74 = -(uint)(((0.0 < fVar48 + (pfVar2[1] - param_1[9]) * fVar15 +
                       ...
                       (float)((uint)(fVar60 * param_1[0x25] + fVar56 * param_1[0x21] +
                                     fVar52 * param_1[0x29]) & _UNK_140483864) < param_1[0x2d]) &&
                      (float)((uint)(fVar60 * param_1[0x35] + fVar56 * param_1[0x31] +
                                    fVar52 * param_1[0x39]) & _UNK_140483864) < param_1[0x3d]);
      uVar76 = -(uint)(((0.0 < fVar49 + (pfVar2[2] - param_1[10]) * fVar16 +
                       ...
                       (float)((uint)(fVar61 * param_1[0x26] + fVar57 * param_1[0x22] +
                                     fVar53 * param_1[0x2a]) & _UNK_140483868) < param_1[0x2e]) &&
                      (float)((uint)(fVar61 * param_1[0x36] + fVar57 * param_1[0x32] +
                                    fVar53 * param_1[0x3a]) & _UNK_140483868) < param_1[0x3e]);
      uVar78 = -(uint)(((0.0 < fVar50 + (pfVar2[3] - param_1[0xb]) * fVar17 +
                       ...
                       (float)((uint)(fVar62 * param_1[0x27] + fVar58 * param_1[0x23] +
                                     fVar54 * param_1[0x2b]) & _UNK_14048386c) < param_1[0x2f]) &&
                      (float)((uint)(fVar62 * param_1[0x37] + fVar58 * param_1[0x33] +
                                    fVar54 * param_1[0x3b]) & _UNK_14048386c) < param_1[0x3f]);
