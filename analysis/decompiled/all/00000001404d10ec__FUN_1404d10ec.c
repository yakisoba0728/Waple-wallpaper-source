...
void FUN_1404d10ec(char *param_1,uint *param_2,longlong param_3)

{
  ...
  cVar7 = (char)param_2;
  *(char *)(in_RAX + 0x6e) = *(char *)(in_RAX + 0x6e) + unaff_BL;
  *(char *)(in_RAX + -0x45efffd5) = *(char *)(in_RAX + -0x45efffd5) + -2;
  uVar5 = (int)in_RAX + 0xee045c08;
