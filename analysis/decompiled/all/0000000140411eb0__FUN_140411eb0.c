// Function: FUN_140411eb0
// Addr: 140411eb0
// Size: 392 bytes


void FUN_140411eb0(longlong param_1,char *param_2)

{
  ...
  if (1 < uVar8) {
    do {
      ...
      dVar9 = *(double *)(param_1 + 0x11c8) + *pdVar5;
      if (*param_2 == '\0') {
        *param_2 = '\x01';
  ...
  if ((uint)uVar7 < uVar8) {
    dVar3 = *(double *)(param_1 + 0x20 + uVar7 * 8);
    ...
    *pdVar2 = dVar4;
    *(double *)(param_1 + 0x11c8) = dVar3 + dVar9;
    if (dVar4 < *(double *)(param_2 + 8)) {
      *(double *)(param_2 + 8) = *pdVar2;
    }
    if (*(double *)(param_2 + 0x18) <= *pdVar2 && *pdVar2 != *(double *)(param_2 + 0x18)) {
      *(double *)(param_2 + 0x18) = *pdVar2;
