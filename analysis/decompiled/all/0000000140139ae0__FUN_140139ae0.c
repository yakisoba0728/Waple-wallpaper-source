// Function: FUN_140139ae0
// Addr: 140139ae0
// Size: 295 bytes


undefined8 FUN_140139ae0(longlong param_1,undefined8 param_2)

{
  ...
  *(undefined8 *)(param_1 + 0x10) = param_2;
  ...
  if (local_res10 != (longlong *)0x0) {
    (**(code **)(*local_res10 + 0x18))(local_res10,&DAT_1404838a0,&DAT_14048adf0,param_1 + 0x20);
    if (*(longlong *)(param_1 + 0x20) != 0) {
      ...
      (**(code **)(*(longlong *)(param_1 + -8) + 0x48))(param_1 + -8);
    }
