// Function: FUN_140061950
// Addr: 140061950
// Size: 181 bytes


undefined8 * FUN_140061950(undefined8 *param_1,undefined8 *param_2)

{
  ...
  if (param_1 != param_2) {
    ...
    FUN_14000f880(param_1,puVar5,param_2[2]);
  }
  ...
  *(undefined4 *)((longlong)param_1 + 100) = uVar3;
  if (param_1 != param_2) {
    ...
    FUN_14000f880(param_1 + 0xd,plVar6,param_2[0xf]);
  }
