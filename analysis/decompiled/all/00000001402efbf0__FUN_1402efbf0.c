// Function: FUN_1402efbf0
// Addr: 1402efbf0
// Size: 405 bytes


undefined8 FUN_1402efbf0(longlong *param_1)
  ...
  if ((int)param_1[0x2e] < 1) {
    ...
    if (*(int *)((longlong)param_1 + 0x14) != 0) {
      do {
        ...
        do {
          uVar7 = uVar6 + 1;
          if (*(char *)(*(longlong *)((byte *)*puVar3 + 8) + uVar6) != (&DAT_14043687c)[uVar6])
          goto LAB_1402efc96;
          uVar6 = uVar7;
        } while (uVar7 != 7);
        if ((*(byte *)*puVar3 & 1) != 0) {
          lVar4 = puVar3[4];
          while (lVar4 != 0) {
            FUN_1402efa80(*(undefined8 *)(lVar4 + 0x10));
            lVar4 = puVar3[4];
          }
        }
LAB_1402efc96:
      ...
      while (uVar8 != 0) {
        ...
        if (lVar4 != 0) {
          ...
          if (plVar5 < plVar1) {
LAB_1402efd20:
            if (*plVar5 != lVar4) goto code_r0x0001402efd25;
...
LAB_1402efd5e:
  ...
  return 0;
code_r0x0001402efd25:
  plVar5 = plVar5 + 1;
  if (plVar1 <= plVar5) goto LAB_1402efd5e;
  goto LAB_1402efd20;
}
