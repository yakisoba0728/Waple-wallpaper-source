// Function: FUN_1402f9d90
// Addr: 1402f9d90
// Size: 5 bytes


undefined8 FUN_1402f9d90(longlong param_1,undefined8 param_2,undefined4 *param_3)

{
  int iVar1;
  
  iVar1 = FUN_140421e50(param_2,"darkening-parameters");
  if (iVar1 == 0) {
  ...
  iVar1 = FUN_140421e50(param_2,"hinting-engine");
  if (iVar1 == 0) {
    *param_3 = *(undefined4 *)(param_1 + 0x38);
    return 0;
  }
  iVar1 = FUN_140421e50(param_2,"no-stem-darkening");
  if (iVar1 == 0) {
