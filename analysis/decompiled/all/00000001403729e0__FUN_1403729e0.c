// Function: FUN_1403729e0
// Addr: 1403729e0
// Size: 1128 bytes


undefined8
FUN_1403729e0(ulonglong *param_1,longlong param_2,float param_3,byte *param_4,uint param_5)
        ...
        *param_1 = (ulonglong)pbVar11;
        if (uVar13 < uVar8) {
          ...
          if (3 < uVar8 - uVar13) {
            ...
            uVar10 = uVar14;
            if (uVar8 <= uVar13) goto LAB_140372ecb;
          }
          do {
            bVar4 = *pbVar11;
            pbVar11 = pbVar11 + 1;
...
LAB_140372ecb:
        ...
        *param_1 = (ulonglong)pbVar11;
        if (uVar13 < uVar8) {
          lVar6 = *(longlong *)(param_2 + 8);
          if (uVar8 - uVar13 < 4) goto LAB_140372d7b;
          do {
            iVar9 = (int)uVar14;
            *(float *)(lVar6 + uVar14 * 0xc) =
        ...
        *param_1 = (ulonglong)pbVar11;
        if (uVar13 < uVar8) {
          ...
          if (3 < uVar8 - uVar13) {
            ...
            uVar10 = uVar14;
            if (uVar8 <= uVar13) goto LAB_140372c42;
          }
          do {
            pbVar5 = pbVar11 + 1;
            bVar4 = *pbVar11;
