// Function: FUN_14007a1d0
// Addr: 14007a1d0
// Size: 1440 bytes


undefined8 * FUN_14007a1d0(float *param_1,undefined8 *param_2)

{
  ...
  puVar7 = (undefined8 *)FUN_14028af20(0x90);
  puVar16 = puVar7 + 2;
  ...
  if (*param_1 < (float)(*(longlong *)(param_1 + 4) + 1) / (float)uVar8) {
    ...
    *(longlong *)(param_1 + 0xc) = lVar13 + -1;
    ...
    while (plVar5 != plVar3) {
      ...
      if (uVar8 != 0) {
        do {
          pbVar2 = (byte *)(uVar11 + (longlong)plVar9);
          uVar11 = uVar11 + 1;
          uVar21 = (uVar21 ^ *pbVar2) * 0x100000001b3;
          pfVar20 = local_res8;
        } while (uVar11 < uVar8);
...
LAB_14007a610:
    ...
    if (puVar19 != *(undefined8 **)(param_1 + 2)) {
      ...
      while( true ) {
        ...
        puVar17 = puVar19;
        if (puVar19 == puVar12) goto LAB_14007a6f2;
  ...
  *puVar16 = puVar7;
  ...
  if (puVar19 == *(undefined8 **)(param_1 + 2)) {
    *(undefined8 **)(lVar13 + uVar11 * 0x10) = puVar7;
    ...
    if (*(undefined8 **)(lVar13 + 8 + uVar11 * 0x10) != puVar16) goto LAB_14007a73f;
  }
