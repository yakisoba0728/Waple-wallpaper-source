// Function: FUN_1402f4650
// Addr: 1402f4650
// Size: 286 bytes


undefined4 FUN_1402f4650(longlong param_1,int *param_2)

{
  ...
  if (iVar3 == 0) {
    ...
    uVar8 = uVar5;
UNWIND_INFO_1402f4724_UnwindCodes_1__OffsetInProlog:
    local_res18 = -uVar5;
    if ((int)-uVar5 < 0) {
      local_res18 = uVar5;
    }
    ...
    if (iVar3 == 1) {
      ...
      uVar8 = uVar5;
      goto UNWIND_INFO_1402f4724_UnwindCodes_1__OffsetInProlog;
    }
    if (iVar3 == 2) {
  ...
  if ((iVar10 != 0) || (iVar3 == 0)) {
    ...
    uVar2 = func_0x0001402efae0(iVar4,uVar8);
    *(undefined4 *)(lVar1 + 0x20) = uVar2;
  }
  if (param_2[1] == 0) {
    iVar11 = FUN_1402f2180(iVar4,local_res18,uVar8);
    ...
    iVar3 = func_0x0001402efae0(iVar11,local_res18);
  }
  piVar9 = (int *)(lVar1 + 0x20);
  *(int *)(lVar1 + 0x1c) = iVar3;
  if (param_2[2] == 0) {
    *piVar9 = iVar3;
    iVar4 = FUN_1402f2180(iVar11,uVar8,local_res18);
  }
  if (*param_2 == 3) {
    iVar10 = *piVar9;
    if (iVar3 < iVar10) {
