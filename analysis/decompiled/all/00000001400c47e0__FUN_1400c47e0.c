// Function: FUN_1400c47e0
// Addr: 1400c47e0
// Size: 28 bytes


void FUN_1400c47e0(longlong param_1,undefined8 *param_2,undefined4 *param_3)

{
  ...
  if (*(char *)(param_1 + 0x104) == '\0') {
    func_0x000140421870(param_2,0,0x200);
    *param_3 = 0;
    return;
  }
  iVar5 = func_0x000140290e50(param_1 + 0x20);
  if (iVar5 == 0) {
