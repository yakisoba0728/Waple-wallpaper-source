// Function: FUN_1401b3240
// Addr: 1401b3240
// Size: 486 bytes


void FUN_1401b3240(undefined8 param_1,ulonglong param_2)
  ...
  if (param_2 != 0) {
    ...
    *piVar1 = *piVar1 + -1;
    ...
    uVar10 = ((((((((param_2 & 0xff ^ 0xcbf29ce484222325) * 0x100000001b3 ^
             ...
             ) * 0x100000001b3 & *(ulonglong *)(lVar4 + 0xe8);
...
LAB_1401b3391:
      ...
      uVar7 = plVar9[2];
      while (param_2 != uVar7) {
        if (plVar9 == *(longlong **)(lVar6 + uVar10 * 0x10)) goto LAB_1401b3391;
    ...
    FUN_14000d9e0(param_2 + 0xd8);
    FUN_140049340(param_2 + 200);
    FUN_140017240(param_2 + 0x58);
    thunk_FUN_14028af80(param_2,0x108);
  }
  return;
}
