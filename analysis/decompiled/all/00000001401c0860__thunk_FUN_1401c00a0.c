// Function: thunk_FUN_1401c00a0
// Addr: 1401c0860
// Size: 5 bytes


void thunk_FUN_1401c00a0(undefined8 param_1)

{
  ...
  if (lVar2 == 0) {
    uStack_50 = CONCAT31(uStack_50._1_3_,3);
    uVar7 = uStack_50 & 0xfffffeff;
    puVar3 = (undefined8 *)FUN_140086de0(param_1,"bouncefactor","");
    uStack_50 = *(uint *)(puVar3 + 1);
    *(uint *)(puVar3 + 1) = uVar7;
    uStack_58 = *puVar3;
  ...
  if (lVar2 == 0) {
    ...
    uVar7 = uStack_50 | 0x100;
    puVar4 = (undefined4 *)_malloc_base(0xb);
    if (puVar4 == (undefined4 *)0x0) {
      FUN_140017170(&uStack_58,
                    "in Json::Value::duplicateAndPrefixStringValue(): Failed to allocate string value buffer"
                   );
                    /* WARNING: Subroutine does not return */
      FUN_140084bc0(&uStack_58);
    }
    *puVar4 = 6;
  ...
  if (lVar2 == 0) {
    ...
    uVar7 = *(uint *)(plVar5 + 1);
    *(uint *)(plVar5 + 1) = uStack_50 & 0xfffffeff;
    lVar2 = *plVar5;
    *plVar5 = 0;
    lVar1 = plVar5[2];
    plVar5[2] = 0;
  ...
  if (lVar2 == 0) {
    uStack_50 = CONCAT31(uStack_50._1_3_,1);
    uStack_50 = uStack_50 & 0xfffffeff;
    uStack_38 = 0;
    uStack_58 = 0;
    lStack_48 = 0;
    uStack_40 = 0;
    uVar6 = FUN_140086de0(param_1,"controlpoint","");
    FUN_140085610(uVar6,&uStack_58);
    FUN_140085440(&uStack_58);
  }
  return;
}
