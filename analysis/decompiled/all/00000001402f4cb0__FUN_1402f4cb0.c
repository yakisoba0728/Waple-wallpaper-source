// Function: FUN_1402f4cb0
// Addr: 1402f4cb0
// Size: 282 bytes


undefined8 FUN_1402f4cb0(longlong param_1,uint param_2)

{
  ...
  if ((-1 < (int)param_2) && ((int)param_2 < *(int *)(param_1 + 0x28))) {
    ...
    if (UNRECOVERED_JUMPTABLE != (code *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x0001402f4d17. Too many branches */
    ...
    *(short *)(lVar1 + 0x1a) = (short)(*(int *)(psVar4 + 6) + 0x20 >> 6);
    if ((*(byte *)(param_1 + 8) & 1) == 0) {
      ...
      *(undefined4 *)(lVar1 + 0x30) = *(undefined4 *)(psVar4 + 4);
      ...
      uVar2 = FUN_1402efa10(*(undefined4 *)(psVar4 + 4),*(undefined2 *)(param_1 + 0x68));
      *(undefined4 *)(lVar1 + 0x1c) = uVar2;
      uVar2 = FUN_1402efa10(*(undefined4 *)(psVar4 + 6),*(undefined2 *)(param_1 + 0x68));
