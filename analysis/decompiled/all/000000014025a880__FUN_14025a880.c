// Function: FUN_14025a880
// Addr: 14025a880
// Size: 211 bytes


void FUN_14025a880(longlong param_1,longlong param_2,char *param_3)

{
  ...
  puVar3 = DAT_1404e99a8;
  puVar2 = DAT_1404e99a0;
  if (param_3 != (char *)0x0) {
    iVar1 = *(int *)(param_2 + 4);
    for (puVar7 = DAT_1404e99a0; puVar7 != puVar3; puVar7 = puVar7 + 5) {
...
LAB_14025a90f:
  ...
  if (*(code **)(param_2 + 0x28) != (code *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00014025a942. Too many branches */
