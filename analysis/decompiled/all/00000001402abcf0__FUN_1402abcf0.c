...
longlong *
FUN_1402abcf0(undefined8 param_1,longlong *param_2,longlong *param_3,longlong *param_4,
...

{
  ...
  if (*param_3 == 0) {
    if (*param_4 != 0) goto LAB_1402abe20;
  }
  else if (*param_4 == 0) goto LAB_1402abe20;
  *param_6 = *param_6 | 1;
LAB_1402abe20:
  lVar3 = param_3[1];
  *param_2 = *param_3;
