// Function: FUN_140322c50
// Addr: 140322c50
// Size: 111 bytes


ulonglong FUN_140322c50(longlong param_1,int param_2,uint *param_3,uint *param_4,uint *param_5)

{
  ...
  uVar3 = func_0x0001402f5d20(lVar2,(*(int *)(param_1 + 0x1a8) + *(int *)(param_1 + 0x1a4)) *
                                    param_2 + *(int *)(param_1 + 0x1c0) + *(int *)(param_1 + 0x1a0))
  ;
  if ((int)uVar3 == 0) {
    uVar3 = FUN_1402f50b0(lVar2);
