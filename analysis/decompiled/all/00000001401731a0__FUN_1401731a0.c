// Function: FUN_1401731a0
// Addr: 1401731a0
// Size: 38 bytes


void FUN_1401731a0(undefined8 param_1,longlong *param_2,longlong *param_3)
  ...
  if ((char)param_3[1] == '\a') {
    ...
    while( true ) {
      ...
      if ((lVar8 != 0) && ((*(byte *)(lVar8 + 0x30) & 2) == 0)) {
        (**(code **)(lVar8 + 8))(&uStack_28,lVar8,plVar10 + 6);
      }
