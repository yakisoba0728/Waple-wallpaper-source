...
void FUN_1402fe640(longlong *param_1,longlong param_2)

{
  ...
  local_30 = 0x1402fe664;
  local_38 = DAT_1404dc040 ^ (ulonglong)auStack_2848;
  ...
  *(undefined4 *)(param_1 + 0x42) = 0;
  ...
  while (cVar2 != '\0') {
    ...
    pcVar10 = (char *)FUN_140305960(pcVar10,param_1,uVar5,local_2824);
    if (local_2824[0] < 2) {
      puVar6 = (uint *)FUN_1404148a0(uVar5,&local_2828);
      FUN_1404148b0(uVar5,&local_2828);
      uVar11 = uVar13;
      if (local_2828 != 0) {
        uVar14 = *puVar6;
  ...
  if (((uVar14 != 0) && (iVar4 = FUN_1402f12d0(param_2,uVar14,1), iVar4 == 0)) &&
    ...
    local_27f0 = 0;
    uStack_27e8 = 0;
    FUN_1404217a0(local_27d4,0,0x38c);
    local_27d8 = (undefined4)param_1[8];
    local_12c8 = &local_2818;
    local_2808 = _DAT_14043b3b0;
    uStack_2800 = _UNK_14043b3b8;
    local_27f8 = 0;
    local_12d0 = 0;
    local_2810 = param_2;
    ...
    if (iVar4 == 0) {
      do {
        local_2828 = 0;
        iVar4 = FUN_140301ff0(&local_2448,uVar11);
        if (iVar4 != 0) break;
        FUN_140302930(&local_2448,0,0,uVar11);
        uVar7 = auStack_23f8[uVar11 * 0x113];
        uVar1 = uVar7 + (ulonglong)local_2400[uVar11 * 0x226] * 0x48;
        uVar12 = uVar13;
        if (uVar7 < uVar1) {
          do {
            ...
            if (((uVar3 != 0) && (*(ulonglong *)(uVar3 + 0x20) == uVar7)) && (uVar7 < uVar3)) {
              ...
              if ((uint)uVar12 < 0x10) {
                ...
                *(int *)((longlong)param_1 + lVar8 * 0xc + uVar11 * 0x1c4 + 0x44) = iVar4;
              }
            }
            uVar7 = uVar7 + 0x48;
          } while (uVar7 < uVar1);
          local_2828 = (int)uVar12;
        }
        FUN_140305f60(&local_2828,(longlong)param_1 + uVar11 * 0x1c4 + 0x50);
        uVar14 = (int)uVar11 + 1;
        *(int *)((longlong)param_1 + uVar11 * 0x1c4 + 0x4c) = local_2828;
        uVar11 = (ulonglong)uVar14;
      } while ((int)uVar14 < 2);
    }
  }
  ...
  *(int *)(param_1 + 0x22) = iVar4 / 5;
  if ((int)param_1[0x42] == 0) {
    ...
    iVar4 = *(int *)((longlong)param_1 + 0x214);
  }
  *(int *)((longlong)param_1 + 0x2d4) = iVar4 / 5;
  *(int *)(param_1 + 0x5b) = iVar4;
  *(undefined1 *)((longlong)param_1 + 0x2dc) = 0;
