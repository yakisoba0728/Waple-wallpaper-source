// Function: FUN_14025eeb0
// Addr: 14025eeb0
// Size: 370 bytes


longlong FUN_14025eeb0(longlong param_1,char *param_2)

{
  ...
  lVar6 = *(longlong *)(DAT_1404e8978 + 8 + (DAT_1404e8990 & uVar9) * 0x10);
  if (lVar6 == DAT_1404e8968) {
LAB_14025ef5e:
    lVar6 = DAT_1404e8968;
  }
  else {
    lVar2 = *(longlong *)(DAT_1404e8978 + (DAT_1404e8990 & uVar9) * 0x10);
    cVar4 = FUN_14000d010(lVar6 + 0x10,param_2);
    while (cVar4 == '\0') {
      if (lVar6 == lVar2) goto LAB_14025ef5e;
      lVar6 = *(longlong *)(lVar6 + 8);
      cVar4 = FUN_14000d010(lVar6 + 0x10,param_2);
    }
    if (lVar6 == 0) goto LAB_14025ef5e;
  }
  if (lVar6 != DAT_1404e8968) {
LAB_14025ef6e:
    return lVar6 + 0x30;
  ...
  if (lVar6 != lVar2) {
    ...
    cVar4 = FUN_14000d010(lVar6 + 0x10,param_2);
    while (cVar4 == '\0') {
      if (lVar6 == lVar3) goto LAB_14025f009;
      lVar6 = *(longlong *)(lVar6 + 8);
      cVar4 = FUN_14000d010(lVar6 + 0x10,param_2);
    }
    if (lVar6 == 0) {
    ...
    if (lVar6 != lVar2) goto LAB_14025ef6e;
  }
LAB_14025f009:
