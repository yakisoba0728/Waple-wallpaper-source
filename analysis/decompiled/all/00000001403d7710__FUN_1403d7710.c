// Function: FUN_1403d7710
// Addr: 1403d7710
// Size: 533 bytes


void FUN_1403d7710(undefined8 *param_1)
  ...
  if ((*(uint *)(lVar3 + 0x38) & 0xfffffffe) == 4) {
    ...
    if (((*(undefined **)(lVar4 + 0x68) != PTR_FUN_1404df490) ||
        (((puVar7 = *(undefined **)(lVar3 + 0x18), puVar7 != (undefined *)0x0 &&
          (puVar7 != &DAT_1404ded88)) && (cVar8 = FUN_1403d0d40(puVar7,9), cVar8 != '\0')))) ||
       ((*(undefined **)(lVar4 + 0x78) != PTR_FUN_1404df4a0 ||
        (((puVar7 != (undefined *)0x0 && (puVar7 != &DAT_1404ded88)) &&
         (cVar8 = FUN_1403d0d40(puVar7,0xb), cVar8 != '\0')))))) {
      FUN_1403afa50(lVar3,param_1[3],0xffffffff);
    }
  }
  else {
    uVar9 = 0;
    ...
    FUN_1403afe50(param_1[1],param_1[3],0xffffffff);
  }
  if ((*(byte *)(param_1[3] + 0xd8) & 4) == 0) {
    return;
  }
  FUN_14039f550(*param_1,param_1[1]);
  return;
}
