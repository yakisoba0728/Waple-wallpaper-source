// Function: FUN_14039a180
// Addr: 14039a180
// Size: 184 bytes


undefined8 FUN_14039a180(longlong param_1,uint param_2,uint param_3,undefined8 *param_4)

{
  ...
  FUN_14039a240(param_1 + -8,param_2);
  for (; param_3 != 0; param_3 = param_3 - piVar2[1]) {
    piVar2 = *(int **)(param_1 + 0x28);
    if (param_3 < (uint)piVar2[1]) {
      FUN_14039a240(param_1 + -8,*piVar2 + param_3);
    }
    else {
