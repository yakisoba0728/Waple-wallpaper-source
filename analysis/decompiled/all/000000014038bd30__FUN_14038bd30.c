// Function: FUN_14038bd30
// Addr: 14038bd30
// Size: 606 bytes


undefined8 FUN_14038bd30(byte *param_1,int *param_2)
        ...
        if (cVar4 != '\0') {
          ...
          if (uVar14 != 0) {
            do {
              ...
              if ((uVar8 != 0) &&
                 (cVar4 = FUN_14037aeb0(param_1 + uVar8,param_2,(uint)bVar2 * 0x100 + (uint)bVar3),
                 cVar4 == '\0')) {
                return 0;
              }
              uVar8 = (int)uVar10 + 1;
          ...
          if ((uint)*param_1 * 0x100 + (uint)param_1[1] == 9) {
