// Function: FUN_1402671a0
// Addr: 1402671a0
// Size: 986 bytes


void FUN_1402671a0(undefined8 *param_1)

{
  ...
  for (lVar8 = param_1[0x18]; lVar8 != lVar7; lVar8 = lVar8 + 0x158) {
    ...
    for (lVar4 = *(longlong *)(lVar8 + 0x138); lVar4 != lVar1; lVar4 = lVar4 + 0x20) {
      ...
      for (lVar6 = *(longlong *)(lVar4 + 8); lVar6 != lVar3; lVar6 = lVar6 + 0x10) {
        FUN_1402d3dd0(*(undefined8 *)(lVar6 + 8));
      }
    }
    ...
    FUN_1402d3dd0(*(undefined8 *)(lVar8 + 0x70));
    FUN_1402d3dd0(*(undefined8 *)(lVar8 + 0x78));
    FUN_1402d3dd0(*(undefined8 *)(lVar8 + 0x80));
    FUN_1402d3dd0(*(undefined8 *)(lVar8 + 0x88));
    thunk_FUN_14028af80(*(undefined8 *)(lVar8 + 0x150),0xc0);
  }
  lVar8 = param_1[3];
  for (lVar7 = param_1[2]; lVar7 != lVar8; lVar7 = lVar7 + 200) {
    thunk_FUN_14028af80(*(undefined8 *)(lVar7 + 0x98));
  }
  *param_1 = 0;
  lVar8 = param_1[3];
  lVar7 = param_1[2];
  if (lVar7 != lVar8) {
    do {
      FUN_1401dcd40(lVar7 + 0xb0);
      FUN_1401d9d50(lVar7 + 0x68);
      FUN_14000d9e0(lVar7);
      lVar7 = lVar7 + 200;
    } while (lVar7 != lVar8);
    param_1[3] = param_1[2];
  ...
  *(undefined4 *)(param_1 + 5) = 0;
  ...
  if (lVar7 != lVar8) {
    do {
      FUN_14000d9e0(lVar7 + 0x18);
      FUN_14003de70(lVar7 + 8);
      lVar7 = lVar7 + 0x40;
    } while (lVar7 != lVar8);
  ...
  FUN_140161c50(param_1 + 0x24);
  FUN_140161c50(param_1 + 0x2c);
