// Function: FUN_1403e0bd0
// Addr: 1403e0bd0
// Size: 2605 bytes


void FUN_1403e0bd0(longlong param_1,char *param_2)
  ...
  if (((byte)uVar6 & 7) < 4) {
    ...
    if (7 < uVar6) {
      do {
        ...
        *(double *)(param_1 + 0x11c8) = dVar15 + dVar3;
        ...
        if ((uVar6 - uVar7 < 0x10) && ((uVar6 & 1) != 0)) {
          if (uVar7 + 8 < uVar6) {
            dVar11 = dVar13 + *(double *)(param_1 + ((ulonglong)(uVar7 + 8) + 4) * 8);
          }
          else {
            *(undefined1 *)(param_1 + 0x18) = 1;
            DAT_1404e4ff0 = DAT_14045dde0;
            dVar11 = dVar13 + DAT_14045dde0;
          }
        }
        if (*param_2 == '\0') {
          *param_2 = '\x01';
        ...
        *(double *)(param_1 + 0x11c0) = dVar15 + dVar3;
        *(double *)(param_1 + 0x11c8) = dVar11;
        if (dVar15 + dVar3 < *(double *)(param_2 + 8)) {
          *(undefined8 *)(param_2 + 8) = *(undefined8 *)(param_1 + 0x11c0);
        }
        if (*(double *)(param_2 + 0x18) <= *(double *)(param_1 + 0x11c0) &&
            *(double *)(param_1 + 0x11c0) != *(double *)(param_2 + 0x18)) {
    ...
    if (0xb < uVar6) {
      do {
        ...
        *(double *)(param_1 + 0x11c8) = dVar3;
        ...
        dVar15 = *(double *)(param_1 + 0x11c8) + *pdVar4;
        if (uVar7 + 2 < *(uint *)(param_1 + 0x1c)) {
          pdVar4 = (double *)(param_1 + ((ulonglong)(uVar7 + 2) + 4) * 8);
        }
        else {
    ...
    dVar11 = dVar14;
    if (uVar8 < uVar6) {
      dVar11 = dVar14 + *(double *)(param_1 + 0x20 + (ulonglong)uVar8 * 8);
    }
    if (*param_2 == '\0') {
      *param_2 = '\x01';
      if (*(double *)(param_1 + 0x11c0) <= *(double *)(param_2 + 8) &&
