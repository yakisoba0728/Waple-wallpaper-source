...
longlong *
FUN_1402ac7b0(undefined8 param_1,longlong *param_2,longlong *param_3,longlong *param_4,
...
LAB_1402aca4e:
    ...
    *(undefined8 *)(puVar14 + -8) = 0x1402aca63;
    (*(code *)PTR__guard_dispatch_icall_140426ae8)();
    *(longlong ***)(puVar14 + 0x20) = &local_b0;
    uVar2 = *(undefined4 *)(param_5 + 0x18);
    *(undefined8 *)(puVar14 + -8) = 0x1402aca80;
    uVar5 = FUN_14029ba50(local_60,param_3,param_4,uVar2);
    local_b8 = uVar5;
    if (local_a8 != 0) {
      *(undefined8 *)(puVar14 + -8) = 0x1402aca9d;
      lVar9 = (*(code *)PTR__guard_dispatch_icall_140426ae8)();
      if (lVar9 != 0) {
        *(undefined8 *)(puVar14 + -8) = 0x1402acab6;
    ...
    if ((char)uVar5 < '\0') {
      ...
      *(undefined8 *)(puVar14 + -8) = 0x1402acad4;
    ...
    *param_6 = 2;
    ...
    FUN_140080290(&local_a0,local_80);
    ...
    if (local_90 < local_88) {
      ...
      *(undefined4 *)((longlong)ppppuVar10 + param_5 * 2) = 0;
      ...
      FUN_140015f90(&local_a0,1,(undefined1)local_b8,0);
    }
    (*(code *)PTR__guard_dispatch_icall_140426ae8)(uVar8,local_80);
    FUN_140080290(&local_a0,local_80);
    FUN_140016770(local_80);
    ...
    local_c8 = 1;
    iVar6 = FUN_1402967a0(param_3,param_4,2,ppppuVar10);
    if (iVar6 == 0) {
      *param_7 = 0;
    }
    else if (iVar6 == 1) {
...
LAB_1402acafe:
  if ((char)param_3[1] == '\0') {
    *(undefined8 *)(puVar14 + -8) = 0x1402acb0d;
    FUN_1402a7e60(param_3);
  }
  if ((char)param_4[1] == '\0') {
    *(undefined8 *)(puVar14 + -8) = 0x1402acb1c;
    FUN_1402a7e60(param_4);
  }
  if (*param_3 == 0) {
    if (*param_4 != 0) goto LAB_1402acb33;
  }
  else if (*param_4 == 0) goto LAB_1402acb33;
  *param_6 = *param_6 | 1;
LAB_1402acb33:
  lVar9 = param_3[1];
  *param_2 = *param_3;
  param_2[1] = lVar9;
  *(undefined8 *)(puVar14 + -8) = 0x1402acb4b;
  return param_2;
}
