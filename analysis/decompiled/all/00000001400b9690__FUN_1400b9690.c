// Function: FUN_1400b9690
// Addr: 1400b9690
// Size: 1643 bytes


uint * FUN_1400b9690(longlong param_1,longlong *param_2)
...
switchD_1400b971f_caseD_3:
      if ((longlong)puVar17 - (longlong)puVar16 < 4) {
        *(undefined8 *)(param_1 + 0xadf8) = 0;
        iVar13 = 4;
        goto switchD_1400b971f_caseD_4;
      }
      uVar12 = *puVar16;
      puVar16 = puVar16 + 1;
      uVar12 = uVar12 >> 0x18 | (uVar12 & 0xff0000) >> 8 | (uVar12 & 0xff00) << 8 | uVar12 << 0x18;
switchD_1400b971f_caseD_5:
      if ((longlong)puVar17 - (longlong)puVar16 < 4) {
        *(undefined8 *)(param_1 + 0xadf8) = 0;
        iVar13 = 6;
        goto switchD_1400b971f_caseD_6;
      }
      uVar18 = *puVar16;
      puVar16 = puVar16 + 1;
      uVar18 = uVar18 >> 0x18 | (uVar18 & 0xff0000) >> 8 | (uVar18 & 0xff00) << 8 | uVar18 << 0x18;
switchD_1400b971f_caseD_7:
      if ((longlong)puVar17 - (longlong)puVar16 < 4) {
        *(undefined8 *)(param_1 + 0xadf8) = 0;
        iVar13 = 8;
        goto switchD_1400b971f_caseD_8;
      }
      uVar14 = *puVar16;
      puVar16 = puVar16 + 1;
      uVar14 = uVar14 >> 0x18 | (uVar14 & 0xff0000) >> 8 | (uVar14 & 0xff00) << 8 | uVar14 << 0x18;
switchD_1400b971f_caseD_9:
      if ((longlong)puVar17 - (longlong)puVar16 < 4) {
        *(undefined8 *)(param_1 + 0xadf8) = 0;
        iVar13 = 10;
        goto switchD_1400b971f_caseD_a;
      }
      uVar10 = *puVar16;
      puVar16 = puVar16 + 1;
...
LAB_1400b9a99:
      ...
      if (((((uVar14 < uVar12) && (uVar14 <= *(uint *)(param_1 + 0x28))) &&
        ...
        *(uint *)(param_1 + 0xac) = uVar18;
        goto switchD_1400b971f_caseD_b;
      }
    }
    goto LAB_1400b9730;
  }
  ...
  switch(iVar13) {
  case 1:
    goto switchD_1400b971f_caseD_1;
  case 2:
switchD_1400b971f_caseD_2:
    while (puVar16 != puVar17) {
      ...
      *(ulonglong *)(param_1 + 0xadf8) = uVar8;
      if (uVar11 == 0x18) {
        ...
        goto code_r0x0001400b9832;
      }
      *(ulonglong *)(param_1 + 0xadf8) = uVar11 + 8 | uVar8;
    }
    break;
  case 3:
    goto switchD_1400b971f_caseD_3;
  case 4:
switchD_1400b971f_caseD_4:
    while (puVar16 != puVar17) {
      uVar10 = *(uint *)(param_1 + 0xadf8);
      uVar8 = *(ulonglong *)(param_1 + 0xadf8) & 0xffffffffffffff00;
      uVar11 = uVar10 & 0xff;
      ...
      *(ulonglong *)(param_1 + 0xadf8) = uVar8;
      if (uVar11 == 0x18) {
        ...
        goto switchD_1400b971f_caseD_5;
      }
      *(ulonglong *)(param_1 + 0xadf8) = uVar11 + 8 | uVar8;
    }
    break;
    ...
    while (puVar16 != puVar17) {
      ...
      *(ulonglong *)(param_1 + 0xadf8) = uVar8;
      if (uVar11 == 0x18) {
        ...
        goto switchD_1400b971f_caseD_7;
      }
      *(ulonglong *)(param_1 + 0xadf8) = uVar11 + 8 | uVar8;
    }
    break;
...
switchD_1400b971f_caseD_8:
    while (puVar16 != puVar17) {
      ...
      *(ulonglong *)(param_1 + 0xadf8) = uVar8;
      if (uVar11 == 0x18) {
        uVar14 = (uint)(uVar8 >> 0x20);
        goto switchD_1400b971f_caseD_9;
      }
      *(ulonglong *)(param_1 + 0xadf8) = uVar11 + 8 | uVar8;
    }
    break;
...
switchD_1400b971f_caseD_a:
    ...
    break;
  case 0xb:
switchD_1400b971f_caseD_b:
    if ((longlong)puVar17 - (longlong)puVar16 < 2) {
      *(undefined8 *)(param_1 + 0xadf8) = 0;
      iVar13 = 0xc;
      goto switchD_1400b971f_caseD_c;
    }
...
switchD_1400b971f_caseD_10:
        if (puVar16 != puVar17) {
          ...
          if ((byte)uVar14 == 0) {
            ...
            if ((byte)uVar14 != 1) goto LAB_1400b9730;
            uVar9 = 0;
          }
...
switchD_1400b971f_caseD_c:
    ...
    break;
  case 0xe:
    goto switchD_1400b971f_caseD_e;
  case 0xf:
    goto switchD_1400b971f_caseD_f;
  case 0x10:
    goto switchD_1400b971f_caseD_10;
  default:
    goto switchD_1400b971f_default;
  }
  bVar3 = true;
  pcVar15 = "$base: short read";
switchD_1400b971f_default:
