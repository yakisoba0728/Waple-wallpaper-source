// Function: FUN_1402890d0
// Addr: 1402890d0
// Size: 435 bytes


void FUN_1402890d0(longlong *param_1,double *param_2,double *param_3,double *param_4,double *param_5
                  )

{
  ...
  dVar12 = (double)param_1[7] * DAT_140492898;
  dVar7 = dVar1 - dVar3;
  dVar13 = dVar1 * DAT_140492898;
  dVar6 = ((double)param_1[6] - dVar2) - (dVar2 - (double)param_1[2]);
  dVar1 = ((double)param_1[7] - dVar1) - dVar7;
  iVar8 = FUN_140285460(local_a8,(((double)param_1[8] - (double)param_1[6] * DAT_140492898) +
                                 dVar2 * DAT_140492898) - (double)param_1[2],dVar6 + dVar6);
  dVar2 = DAT_140492848;
  uVar11 = 0;
  if (0 < iVar8) {
    do {
  ...
  iVar8 = FUN_140285460(local_a8,((dVar4 - dVar12) + dVar13) - dVar3,dVar1 + dVar1,dVar7);
  uVar11 = 0;
  if (0 < iVar8) {
    do {
      if ((0.0 < local_a8[uVar11]) && (local_a8[uVar11] < dVar2)) {
