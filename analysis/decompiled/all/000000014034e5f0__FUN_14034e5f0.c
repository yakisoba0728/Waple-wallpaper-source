// Function: FUN_14034e5f0
// Addr: 14034e5f0
// Size: 1270 bytes


undefined8
FUN_14034e5f0(longlong param_1,uint param_2,undefined4 param_3,undefined4 param_4,uint param_5,
             undefined1 param_6)
  ...
  if (param_5 < 0x65) {
    ...
    for (iVar20 = *(int *)(param_1 + 0x30); iVar20 != 0; iVar20 = iVar20 + -1) {
      ...
      if ((uVar17 <= param_2) && (param_2 <= CONCAT11(puVar18[2],puVar18[3]))) {
        ...
        if ((uint)((int)pcVar11 - (int)puVar16) < uVar14) goto LAB_14034eac9;
        ...
        if ((pcVar15 <= pcVar11) && (CONCAT11(*puVar16,puVar16[1]) - 1 < 0x13)) {
          ...
          case 1:
            ...
            if (pcVar15 + 8 <= pcVar11) {
              ...
              if (uVar14 != uVar17) goto LAB_14034ea62;
            }
            break;
          case 2:
          ...
          case 4:
            ...
            if ((((pcVar19 <= pcVar11) && (puVar16 + 0x10 <= pcVar11)) &&
               ...
               (uVar14 = 0, uVar17 != 0)) goto LAB_14034e8e0;
            break;
          case 5:
          case 0x13:
              ...
              if (puVar16 + 0x14 <= pcVar11) {
                ...
                *(undefined1 *)(param_1 + 0x20) = 1;
                ...
                if ((uVar17 <= (uint)((longlong)pcVar11 - (longlong)puVar18 >> 1)) &&
                   (uVar14 = 0, uVar17 != 0)) goto LAB_14034ea00;
              }
            }
          }
        }
...
LAB_14034eac9:
  ...
  return uVar13;
LAB_14034ea00:
  if (CONCAT11(*puVar18,puVar18[1]) != param_2) goto code_r0x00014034ea16;
  iVar20 = CONCAT31(CONCAT21(CONCAT11(cVar7,uVar8),uVar9),uVar10);
  uVar14 = iVar20 * uVar14;
LAB_14034ea3b:
  uVar17 = iVar20 + uVar14;
  goto LAB_14034ea62;
code_r0x00014034ea16:
  uVar14 = uVar14 + 1;
  puVar18 = puVar18 + 2;
  if (uVar17 <= uVar14) goto switchD_14034e72e_caseD_6;
  goto LAB_14034ea00;
LAB_14034e8e0:
  if (CONCAT11(*pcVar19,pcVar19[1]) != param_2) goto code_r0x00014034e8f2;
  uVar14 = (uint)CONCAT11(pcVar19[2],pcVar19[3]);
  uVar17 = (uint)CONCAT11(pcVar19[6],pcVar19[7]);
LAB_14034ea62:
  if (uVar14 <= uVar17) {
    uVar13 = FUN_14034dec0(param_1,CONCAT11(uVar1,uVar2),
                           CONCAT31(CONCAT21(CONCAT11(uVar3,uVar4),uVar5),uVar6) + uVar14,
                           uVar17 - uVar14,param_3,param_4,param_5,param_6);
    return uVar13;
  }
  goto switchD_14034e72e_caseD_6;
code_r0x00014034e8f2:
  uVar14 = uVar14 + 1;
  pcVar19 = pcVar19 + 4;
  if (uVar17 <= uVar14) goto switchD_14034e72e_caseD_6;
  goto LAB_14034e8e0;
