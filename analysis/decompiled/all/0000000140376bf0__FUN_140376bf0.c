// Function: FUN_140376bf0
// Addr: 140376bf0
// Size: 670 bytes


undefined8 FUN_140376bf0(longlong param_1,undefined8 param_2,longlong param_3)

{
  ...
  if (cVar1 == '\0') {
    ...
    *(undefined8 *)(puVar3 + 0x28) = 0;
    FUN_140371ea0(param_1 + 8,puVar3,uVar2,param_1 + 8);
    ...
    *(undefined8 *)(puVar3 + 0x20) = 0;
    *(undefined8 *)(puVar3 + 0x28) = 0;
    FUN_140370c50(param_1 + 8,puVar3,uVar2,param_1 + 8);
    ...
    *(undefined8 *)(puVar3 + 0x20) = 0;
    *(undefined8 *)(puVar3 + 0x28) = 0;
    FUN_140371340(param_1 + 8,puVar3,uVar2,param_1 + 8);
    puVar4 = (undefined2 *)(puVar3 + 0x30);
    if (puVar4 != (undefined2 *)(puVar3 + 0x230)) {
      do {
        *puVar4 = 0xffff;
    ...
    *(undefined8 *)(puVar3 + 0x20) = 0;
    *(undefined8 *)(puVar3 + 0x28) = 0;
    FUN_14036fca0(param_1 + 8,puVar3,uVar2);
    puVar4 = (undefined2 *)(puVar3 + 0x30);
    if (puVar4 != (undefined2 *)(puVar3 + 0x230)) {
      do {
        *puVar4 = 0xffff;
    ...
    *(undefined8 *)(puVar3 + 0x20) = 0;
    *(undefined8 *)(puVar3 + 0x28) = 0;
    FUN_140371100(param_1 + 8,puVar3,uVar2,param_1 + 8);
    puVar4 = (undefined2 *)(puVar3 + 0x30);
    if (puVar4 != (undefined2 *)(puVar3 + 0x230)) {
      do {
        *puVar4 = 0xffff;
