...
int FUN_140323130(longlong param_1,undefined8 param_2)

{
  ...
  local_48 = DAT_1404dc040 ^ (ulonglong)auStack_768;
  ...
  if (plVar3 == (longlong *)0x0) {
    ...
    local_720 = pbVar9;
    iVar14 = FUN_1402f5c50(pbVar9,local_738 * iVar13 + *(int *)(lVar2 + 0x1a0) +
                                  *(int *)(lVar2 + 0x1c0));
    if ((iVar14 == 0) && (iVar14 = FUN_1402f4fe0(pbVar9,iVar13 * 2), iVar14 == 0)) {
    ...
    if ((((iVar14 != 0) || (uVar12 = uVar12 - uVar15, uVar12 == 0)) ||
        (local_740 = FUN_1402f7fa0(local_728,uVar12,&local_748), uVar8 = local_740, local_748 != 0))
       || (local_748 = FUN_1402f5530(local_328,*(int *)(lVar2 + 0x1c0) + uVar15,local_740,uVar12),
          uVar8 = local_740, local_748 != 0)) goto LAB_1403235be;
    local_748 = 0;
    lVar16 = local_730;
  }
  else {
    ...
    if ((local_748 != 0) ||
       ...
       local_718 < uVar12)) goto LAB_1403235be;
    ...
    local_740 = FUN_1402f7fa0(local_728,uVar12,&local_748);
    if (local_748 == 0) {
      FUN_1404210f0(local_740,local_720 + *(uint *)(lVar2 + 0x1a4),uVar12);
    }
    (**(code **)(*plVar3 + 8))(plVar3[1],&local_720);
    uVar8 = local_740;
    if (local_748 != 0) goto LAB_1403235be;
  }
  ...
  *(uint *)(param_1 + 0x670) = uVar15;
  ...
  if (((local_748 == 0) && (plVar3 != (longlong *)0x0)) && (*(longlong *)(*plVar3 + 0x10) != 0)) {
    iVar14 = FUN_1402f4b60(*(undefined4 *)(param_1 + 0x38));
    local_328 = (ulonglong)(uint)(iVar14 >> 0x10);
    local_320 = FUN_1402f4b60(*(undefined4 *)(param_1 + 0x40));
    local_320 = local_320 >> 0x10;
    local_31c = FUN_1402f4b60(*(undefined4 *)(param_1 + 0x44));
    local_31c = local_31c >> 0x10;
    local_748 = (**(code **)(*plVar3 + 0x10))(plVar3[1],local_738,0,&local_328);
    *(int *)(param_1 + 0x38) = (int)local_328 << 0x10;
    *(int *)(param_1 + 0x40) = local_320 << 0x10;
    *(int *)(param_1 + 0x44) = local_31c << 0x10;
    uVar8 = local_740;
  }
LAB_1403235be:
  FUN_1402f7f90(local_728,uVar8);
  *(undefined1 *)(*(longlong *)(param_1 + 0x10) + 0xf9) = local_744;
  return local_748;
}
