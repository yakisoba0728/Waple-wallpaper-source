// Function: FUN_1402796d0
// Addr: 1402796d0
// Size: 189 bytes


undefined8 FUN_1402796d0(undefined8 param_1,undefined8 param_2)

{
  ...
  uVar3 = FUN_14000d210(local_f8,"-mdl -i \"");
  ...
  if ((((byte)local_80 & 0x22) == 2) || (uVar6 = *local_b0, uVar6 == 0)) {
    if (((local_80 & 4) != 0) || (*plStack_b8 == 0)) goto code_r0x0001402797ca;
    lVar5 = *plStack_d8;
