// Function: FUN_140212a00
// Addr: 140212a00
// Size: 370 bytes


longlong FUN_140212a00(longlong param_1,char *param_2)

{
  ...
  lVar6 = *(longlong *)(DAT_1404e85f8 + 8 + (DAT_1404e8610 & uVar9) * 0x10);
  if (lVar6 == DAT_1404e85e8) {
LAB_140212aae:
    lVar6 = DAT_1404e85e8;
  }
  else {
    lVar2 = *(longlong *)(DAT_1404e85f8 + (DAT_1404e8610 & uVar9) * 0x10);
    cVar4 = FUN_14000d010(lVar6 + 0x10,param_2);
    while (cVar4 == '\0') {
      if (lVar6 == lVar2) goto LAB_140212aae;
      lVar6 = *(longlong *)(lVar6 + 8);
      cVar4 = FUN_14000d010(lVar6 + 0x10,param_2);
    }
    if (lVar6 == 0) goto LAB_140212aae;
  }
  if (lVar6 != DAT_1404e85e8) {
LAB_140212abe:
    return lVar6 + 0x30;
  ...
  if (lVar6 != lVar2) {
    ...
    cVar4 = FUN_14000d010(lVar6 + 0x10,param_2);
    while (cVar4 == '\0') {
      if (lVar6 == lVar3) goto LAB_140212b59;
      lVar6 = *(longlong *)(lVar6 + 8);
      cVar4 = FUN_14000d010(lVar6 + 0x10,param_2);
    }
    if (lVar6 == 0) {
    ...
    if (lVar6 != lVar2) goto LAB_140212abe;
  }
LAB_140212b59:
