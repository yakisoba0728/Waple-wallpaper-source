// Function: FUN_1403f06e0
// Addr: 1403f06e0
// Size: 269 bytes


bool FUN_1403f06e0(longlong param_1,undefined4 param_2,longlong param_3,undefined8 param_4,
...

{
  ...
  if ((param_7 != '\0') && (*(float *)(param_1 + 0x4c) != 0.0)) {
    ...
    (**(code **)(param_3 + 0x10))
              (param_3,param_4,DAT_140492704,0,*(float *)(param_1 + 0x4c),DAT_140492704,0,
