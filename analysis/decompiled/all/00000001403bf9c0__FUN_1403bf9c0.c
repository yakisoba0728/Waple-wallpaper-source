// Function: FUN_1403bf9c0
// Addr: 1403bf9c0
// Size: 5 bytes


undefined1 FUN_1403bf9c0(undefined8 param_1,undefined8 param_2,longlong param_3)

{
  ...
  if (*(int *)(param_3 + 0x60) != 0) {
    cVar2 = FUN_1403ec600(param_3,param_2,"start reordering indic final");
    if (cVar2 != '\0') {
      ...
      if (uVar1 != 0) {
        ...
        if (uVar1 != 0) {
          do {
            uVar5 = uVar4;
            FUN_1403bfac0(param_1,param_3,uVar6,uVar5);
            uVar4 = uVar5;
            do {
              uVar3 = (int)uVar4 + 1;
              uVar4 = (ulonglong)uVar3;
      ...
      FUN_1403ec600(param_3,param_2,"end reordering indic final");
    }
