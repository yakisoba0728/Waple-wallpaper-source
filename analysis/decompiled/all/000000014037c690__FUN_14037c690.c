...
undefined8 FUN_14037c690(longlong param_1,undefined4 param_2)

{
  ...
  *(undefined1 **)(param_1 + 0x148) = local_68;
  ...
  local_74 = uVar3;
  local_70 = uVar4;
  lVar7 = FUN_1403c5c00(puVar12,param_2);
  if (lVar7 != 0) {
      ...
      do {
        if (((ulonglong)puVar9[uVar10 + 5] >>
             (*(uint *)(*(longlong *)(*(longlong *)(param_1 + 0xa0) + 0x70) +
              ...
              ((byte)(&DAT_14045c3c8)[uVar10] & 0x1f) & 0x3f) & 1) == 0) goto LAB_14037c84a;
        uVar15 = (int)uVar10 + 1;
