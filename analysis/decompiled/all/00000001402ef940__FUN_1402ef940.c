// Function: FUN_1402ef940
// Addr: 1402ef940
// Size: 184 bytes


int FUN_1402ef940(undefined4 *param_1,undefined8 param_2,longlong *param_3,undefined8 *param_4)

{
  ...
  puVar8 = (undefined4 *)func_0x0001402f7f60(lVar9,*param_1,local_res8);
  iVar6 = local_res8[0];
  if (local_res8[0] != 0) goto LAB_1402efa9c;
  lVar2 = *param_3;
  ...
  *puVar8 = (int)lVar2;
  ...
  if ((*(code **)(param_1 + 2) == (code *)0x0) ||
    ...
    if (iVar6 < 0) {
code_r0x0001402efa89:
      iVar6 = 6;
    }
    else {
      iVar7 = iVar6 + 1;
      if (iVar7 < 0) goto code_r0x0001402efa89;
      if (iVar7 == 0) {
        if (lVar2 != 0) {
