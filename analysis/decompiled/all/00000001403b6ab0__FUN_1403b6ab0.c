// Function: FUN_1403b6ab0
// Addr: 1403b6ab0
// Size: 611 bytes


uint FUN_1403b6ab0(byte *param_1,longlong *param_2)
        ...
        if (-1 < iVar10) {
          do {
            ...
            if (iVar13 == iVar4) {
              ...
              iVar2 = iVar9 - iVar4;
              if (iVar9 == iVar4) goto LAB_1403b6c94;
            }
            iVar4 = 1;
            if (bVar17 != iVar2 < 0) {
              iVar4 = -1;
            ...
            if (iVar4 < 0) {
              ...
              if (iVar4 < 1) goto LAB_1403b6c94;
              iVar12 = uVar3 + 1;
            }
          } while (iVar12 <= iVar11);
        }
        if (iVar13 != 3) break;
        if (iVar9 != 3) goto LAB_1403b6cd8;
        iVar9 = 1;
        iVar13 = 0x25;
      }
