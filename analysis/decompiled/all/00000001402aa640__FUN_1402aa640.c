...
longlong *
FUN_1402aa640(undefined8 param_1,longlong *param_2,longlong *param_3,undefined4 *param_4,
...

{
  ...
  local_b8 = &local_90;
  uVar1 = FUN_14029ac00(local_68,&local_a8,&local_78,*(undefined4 *)(param_5 + 0x18));
...
LAB_1402aa77b:
  ...
  if ((char)uStack_70 == '\0') {
    if (lVar5 != 0) {
      ...
      if (sVar2 != -1) goto LAB_1402aa7ca;
    }
    lVar5 = 0;
  }
LAB_1402aa7ca:
  if (lVar4 == 0) {
    if (lVar5 != 0) goto LAB_1402aa7de;
  }
  else if (lVar5 == 0) goto LAB_1402aa7de;
  *param_6 = *param_6 | 1;
LAB_1402aa7de:
  *param_7 = uVar3;
  *param_2 = local_a8;
