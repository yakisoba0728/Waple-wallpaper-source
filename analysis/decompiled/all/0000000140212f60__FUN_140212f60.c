// Function: FUN_140212f60
// Addr: 140212f60
// Size: 459 bytes


void FUN_140212f60(undefined8 param_1,longlong *param_2)

{
  ...
  FUN_14015ab00(param_2,DAT_1404e8630);
  FUN_1401efad0(param_1,param_2);
  puVar5 = DAT_1404e8628;
  puVar2 = (undefined8 *)*DAT_1404e8628;
  do {
    if (puVar2 == puVar5) {
      return;
    }
...
LAB_140213121:
                    /* WARNING: Subroutine does not return */
        *(undefined **)(puVar9 + -8) = &UNK_140213126;
        FUN_140017370();
      }
      uVar1 = lVar7 + 1;
      uVar6 = (uVar6 >> 1) + uVar6;
      ...
      puVar9 = auStack_48;
      if (0x1fffffffffffffff < uVar10) goto LAB_140213121;
      uVar6 = uVar10 * 8;
      if (uVar6 == 0) {
        uVar6 = 0;
      }
        ...
        puVar9 = auStack_48;
        if (uVar6 + 0x27 <= uVar6) goto LAB_140213121;
