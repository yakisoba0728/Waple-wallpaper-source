// Function: FUN_140216b90
// Addr: 140216b90
// Size: 636 bytes


undefined4 * FUN_140216b90(undefined4 *param_1,undefined4 *param_2,code *param_3)
      ...
      if (cVar3 == '\0') {
        ...
        while (puVar6 = puVar2, cVar3 != '\0') {
          *puVar8 = *puVar6;
          ...
          puVar8[2] = puVar6[2];
          puVar8[3] = puVar6[3];
          func_0x000140219540(puVar8 + 4,puVar6 + 4);
          func_0x000140219540(puVar8 + 10,puVar6 + 10);
        ...
        *puVar8 = local_88;
        ...
        puVar8[2] = local_80;
        puVar8[3] = local_7c;
        func_0x000140219540(puVar8 + 4,&local_78);
      }
      else {
        puVar8 = puVar5 + 0x10;
        puVar2 = puVar5;
        while (param_1 != puVar2) {
          ...
          if (puVar8 != puVar2) {
            ...
            if (lVar4 != 0) {
              ...
              if (0xfff < uVar7) {
                if (0x1f < (lVar4 - *(longlong *)(lVar4 + -8)) - 8U) goto LAB_140216ec7;
                uVar7 = uVar7 + 0x27;
                lVar4 = *(longlong *)(lVar4 + -8);
              }
              puVar5 = (undefined4 *)func_0x00014028b040(lVar4,uVar7);
              return puVar5;
            }
          ...
          puVar6 = puVar8 + -6;
          puVar8 = puVar8 + -0x10;
          func_0x000140219540(puVar6,puVar2 + -6);
          puVar2 = puVar2 + -0x10;
        }
        *param_1 = local_88;
        param_1[1] = local_84;
...
LAB_140216d8f:
      ...
      func_0x000140219540(puVar8 + 10,&local_60);
...
LAB_140216ec7:
        ...
        func_0x00014028b040(lVar4,uVar7);
      }
    }
  }
  return param_2;
