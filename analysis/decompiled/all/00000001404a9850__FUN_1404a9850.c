...
void FUN_1404a9850(char *param_1,undefined8 param_2)

{
  ...
  *(longlong *)((longlong)in_RAX * 2) = (longlong)in_ST0;
  uVar8 = (ulonglong)in_RAX & 0xffffffff;
  bVar19 = (byte)unaff_ESP;
  *param_1 = *param_1 + bVar19;
  cRam0000000054000cdd = cRam0000000054000cdd + -0x23;
  cRamfffffffffa0019ba = cRamfffffffffa0019ba + '\f';
  lRam00000000a80019ba = (longlong)in_ST1;
  *param_1 = *param_1 + bVar19;
  bVar17 = (byte)((ulonglong)param_2 >> 8) | (byte)(uVar8 >> 8);
  uVar5 = (int)CONCAT71((int7)(uVar8 >> 8),(byte)uVar8 | *(byte *)(uVar8 * 2)) + 0x30000be4;
