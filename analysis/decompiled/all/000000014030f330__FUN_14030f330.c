// Function: FUN_14030f330
// Addr: 14030f330
// Size: 580 bytes


void FUN_14030f330(longlong *param_1,longlong param_2)

{
  ...
  *(uint *)(param_1 + 0x67) = uVar12;
  if (*(short *)((longlong)param_1 + 0x15c) == *(short *)((longlong)param_1 + 0x15e)) {
    pcVar7 = FUN_14030b340;
    pcVar10 = FUN_1403100e0;
    pcVar11 = (code *)&LAB_14030b430;
    pcVar13 = (code *)&LAB_140309390;
  }
  else {
    pcVar7 = FUN_14030b380;
    pcVar10 = FUN_140310120;
    pcVar11 = FUN_14030b440;
    pcVar13 = FUN_1403093a0;
  }
  param_1[0x60] = (longlong)pcVar13;
  param_1[0x61] = (longlong)pcVar11;
  param_1[0x62] = (longlong)pcVar10;
  param_1[99] = (longlong)pcVar7;
  ...
  *(undefined1 *)((longlong)param_1 + 0x2c4) = 0;
                    /* WARNING: Could not recover jumptable at 0x00014030f571. Too many branches */
