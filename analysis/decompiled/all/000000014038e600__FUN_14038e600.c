// Function: FUN_14038e600
// Addr: 14038e600
// Size: 1212 bytes


undefined8 * FUN_14038e600(undefined8 *param_1,longlong param_2)
  ...
  *param_1 = 0;
  ...
  if (*(code **)(param_2 + 0x20) == (code *)0x0) {
    ...
    piVar5 = (int *)(**(code **)(param_2 + 0x20))
                              (param_2,0x47504f53,*(undefined8 *)(param_2 + 0x28));
    piVar11 = (int *)&DAT_14045dd10;
    if (piVar5 != (int *)0x0) {
      piVar11 = piVar5;
    }
  ...
  if (local_80 == (byte *)0x0) {
    ...
    if (uVar12 < 4) {
      ...
      cVar2 = FUN_14038bbe0(pbVar10,local_88);
    }
    else {
      cVar2 = (char)iVar6;
    }
