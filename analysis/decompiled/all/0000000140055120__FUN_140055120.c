...
void FUN_140055120(longlong param_1,longlong *param_2,longlong *param_3)
  ...
  if ((local_100 == local_138) ||
    ...
    if (local_100 != (longlong *)0x0) {
      if (local_100 == local_138) {
        ...
        if (local_100 == (longlong *)0x0) goto LAB_1400552a3;
        (**(code **)(*local_100 + 0x20))
...
LAB_1400552a3:
    ...
    if (plVar6 != (longlong *)0x0) {
      if (plVar6 == plVar1) {
        ...
        plVar6 = (longlong *)*plVar2;
        if (plVar6 == (longlong *)0x0) goto LAB_1400552de;
...
LAB_1400552de:
    if (local_80 != (longlong *)0x0) {
      plVar6 = local_80;
      plVar4 = local_100;
      if (local_80 != local_b8) goto LAB_140055192;
  ...
  if ((local_c0 == local_f8) ||
    ...
    if (local_c0 != (longlong *)0x0) {
      if (local_c0 == local_f8) {
        ...
        if (local_c0 == (longlong *)0x0) goto LAB_14005536b;
        (**(code **)(*local_c0 + 0x20))
...
LAB_14005536b:
    ...
    if (plVar6 != (longlong *)0x0) {
      if (plVar6 == plVar1) {
        ...
        plVar6 = (longlong *)*plVar2;
        if (plVar6 == (longlong *)0x0) goto LAB_1400553a4;
        (**(code **)(*plVar6 + 0x20))(plVar6,plVar6 != plVar1);
        plVar6 = local_c0;
      }
      local_c0 = plVar6;
...
LAB_1400553a4:
    if (local_40 == (longlong *)0x0) goto LAB_1400551fe;
    plVar6 = local_40;
    plVar4 = local_c0;
