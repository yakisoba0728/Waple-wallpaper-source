...
longlong *
FUN_1402aaae0(undefined8 param_1,longlong *param_2,longlong *param_3,longlong *param_4,
...

{
  ...
  local_388 = &local_378;
  uVar3 = FUN_1402970c0(local_368,0x300,param_3,param_4);
  ...
  if (*param_3 == 0) {
    if (*param_4 != 0) goto LAB_1402aac2b;
  }
  else if (*param_4 == 0) goto LAB_1402aac2b;
  *param_6 = *param_6 | 1;
LAB_1402aac2b:
  lVar4 = param_3[1];
  *param_2 = *param_3;
