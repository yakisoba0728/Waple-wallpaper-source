// Function: FUN_1401b6ad0
// Addr: 1401b6ad0
// Size: 238 bytes


undefined8 * FUN_1401b6ad0(longlong *param_1,undefined8 *param_2,undefined8 *param_3)
    ...
    if (local_48 < 0x2000000000000000) {
      ...
      if (uVar7 == 0) {
        ...
        *puVar8 = uVar3;
        ...
        if (param_2 == puVar4) {
          for (; local_40 = puVar8, puVar6 != puVar4; puVar6 = puVar6 + 1) {
            uVar3 = *puVar6;
            *puVar6 = 0;
            *puVar5 = uVar3;
            puVar5 = puVar5 + 1;
