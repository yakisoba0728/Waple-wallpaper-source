// Function: FUN_1403661f0
// Addr: 1403661f0
// Size: 1095 bytes


ulonglong * FUN_1403661f0(ulonglong *param_1,int *param_2,int *param_3,int *param_4)
...
joined_r0x0001403663b5:
  do {
    if (param_4 <= piVar7) {
joined_r0x00014036649d:
...
LAB_140366471:
      if ((int)uVar6 < 0) goto joined_r0x00014036649d;
      if (piVar8 != piVar7) {
        uVar3 = *(undefined8 *)(piVar7 + 2);
