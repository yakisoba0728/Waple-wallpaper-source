// Function: FUN_1403f7fb0
// Addr: 1403f7fb0
// Size: 179 bytes


void FUN_1403f7fb0(longlong param_1,ulonglong param_2,ulonglong param_3)

{
  ...
  *(uint *)(lVar1 + *(longlong *)(*(longlong *)(param_1 + 0x20) + 0x70)) = uVar6;
  if (((*(char *)(param_1 + 0x8d) != '\0') && (pcVar2 = *(char **)(param_1 + 0x90), *pcVar2 != '\0')
    ...
    pcVar2[6] = -1;
    pcVar2[7] = -1;
    puVar4 = (undefined4 *)FUN_1403ed560(pcVar2,param_3 & 0xffffffff,1);
  ...
  if (*(char *)(param_1 + 0x78) != '\0') {
    uVar3 = FUN_1403caa10(*(undefined8 *)(param_1 + 0x70),param_3 & 0xffffffff);
