// Function: FUN_1400ea380
// Addr: 1400ea380
// Size: 479 bytes


ulonglong * FUN_1400ea380(ulonglong *param_1,undefined8 *param_2,undefined8 *param_3)

{
  ...
  *param_1 = 0;
  ...
  uVar4 = param_3[2];
  uVar2 = uVar4 + uVar3;
  if ((param_2[3] - uVar3 < uVar4) || ((ulonglong)param_2[3] < (ulonglong)param_3[3])) {
    if (param_3[3] - uVar4 < uVar3) {
      if (0x7fffffffffffffff - uVar3 < uVar4) {
                    /* WARNING: Subroutine does not return */
        FUN_1400172e0();
      }
      uVar10 = uVar2 | 0xf;
      if (uVar10 < 0x8000000000000000) goto LAB_1400ea4bf;
      uVar13 = 0x8000000000000027;
      puVar14 = auStack_68;
      uVar10 = 0x7fffffffffffffff;
      while( true ) {
        *(undefined8 *)(puVar14 + -8) = 0x1400ea4b3;
...
LAB_1400ea4bf:
        ...
        uVar1 = uVar10 + 1;
        if (uVar1 == 0) goto LAB_1400ea503;
        if (uVar1 < 0x1000) {
          *(undefined8 *)(puVar14 + -8) = 0x1400ea500;
        ...
        if (uVar13 <= uVar1) {
                    /* WARNING: Subroutine does not return */
          *(undefined **)(puVar14 + -8) = &UNK_1400ea560;
          FUN_140017370();
        }
      }
...
LAB_1400ea503:
      ...
      *(undefined8 *)(puVar14 + -8) = 0x1400ea526;
      FUN_1404210f0(uVar12,param_2,uVar3);
      if (0xf < (ulonglong)param_3[3]) {
        param_3 = (undefined8 *)*param_3;
      }
      *(undefined8 *)(puVar14 + -8) = 0x1400ea541;
      FUN_1404210f0(uVar12 + uVar3,param_3,uVar4 + 1);
    }
    else {
    ...
    *(undefined1 *)param_2 = 0;
    ...
    FUN_1404210f0((longlong)puVar9 + uVar3,param_3,uVar4 + 1);
    param_1[2] = uVar2;
  }
  return param_1;
}
