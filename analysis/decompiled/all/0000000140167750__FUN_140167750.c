// Function: FUN_140167750
// Addr: 140167750
// Size: 452 bytes


uint FUN_140167750(longlong param_1)

{
  ...
  do {
    ...
    uVar6 = FUN_140167aa0(param_1);
    while (iVar2 = *(int *)(param_1 + 8), iVar2 - 8U < 4) {
      FUN_140166b60(param_1);
      iVar7 = func_0x000140167ba0(param_1);
      while (iVar3 = *(int *)(param_1 + 8), iVar3 - 0x17U < 2) {
        FUN_140166b60(param_1);
        uVar8 = FUN_140167c50(param_1);
LAB_1401677f4:
        iVar10 = *(int *)(param_1 + 8);
        if (iVar10 - 0xeU < 2) {
          FUN_140166b60(param_1);
          uVar11 = FUN_140167cd0(param_1);
          do {
...
LAB_140167811:
            while( true ) {
              ...
              FUN_140166b60(param_1);
              iVar9 = FUN_140167cd0(param_1);
              if (iVar4 != 0x10) break;
              uVar11 = (ulonglong)(uint)(iVar12 * iVar9);
            }
            if (iVar4 != 0x11) goto LAB_140167848;
            if (iVar9 == 0) goto LAB_14016785a;
