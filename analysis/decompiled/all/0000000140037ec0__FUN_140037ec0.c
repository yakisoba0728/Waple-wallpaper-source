// Function: FUN_140037ec0
// Addr: 140037ec0
// Size: 363 bytes


undefined8 FUN_140037ec0(longlong *param_1,longlong param_2)

{
  ...
  if ((param_1 != (longlong *)0x0) && (*param_1 == 0)) {
    ...
    *puVar2 = std::num_put<char,std::ostreambuf_iterator<char,std::char_traits<char>_>_>::vftable;
