...
void FUN_1404d4590(undefined8 param_1,char *param_2,undefined8 param_3,char *param_4)

{
  ...
  *(byte *)(in_RAX + 0x2588003e) = *(byte *)(in_RAX + 0x2588003e) | bVar11;
  *param_4 = *param_4 + unaff_SPL;
  uVar4 = (int)in_RAX + 0xc4050002;
  pcVar5 = (char *)(ulonglong)uVar4;
  pcVar5[-0x570effc2] = pcVar5[-0x570effc2] | bVar11;
  pcVar6 = (char *)(CONCAT71(unaff_00000021,unaff_SPL) + 0x521004d + (longlong)pcVar5 * 2);
  *pcVar6 = *pcVar6 + bVar11;
  uVar4 = CONCAT31((int3)(uVar4 >> 8),(char)uVar4 + *pcVar5) + 0xf10005d4;
  pcVar5 = (char *)(ulonglong)uVar4;
  bVar7 = (byte)(uVar4 >> 8);
