// Function: FUN_1401edf00
// Addr: 1401edf00
// Size: 370 bytes


void FUN_1401edf00(longlong param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  if ((param_5 & 1) == 0) {
    ...
    uVar7 = (uint)((float)local_res10 * DAT_140492790) ^ DAT_1404930c0;
    uVar8 = (uint)(local_res10._4_4_ * DAT_140492790) ^ DAT_1404930c0;
    fVar9 = (float)local_res10 * DAT_140492790;
    fVar10 = local_res10._4_4_ * DAT_140492790;
  }
  if ((param_5 & 2) == 0) {
    fVar5 = 0.0;
  }
    ...
    fVar4 = DAT_140492730 / (float)local_res18;
    local_res18._4_4_ = (float)((ulonglong)param_3 >> 0x20);
    fVar5 = DAT_140492730 / local_res18._4_4_;
  }
  ...
  lVar3 = (**(code **)(**(longlong **)(param_1 + 0x1518) + 0x40))
                    (*(longlong **)(param_1 + 0x1518),uVar2,&local_e8,4,&uStack_108,6,0,0,0);
  *param_6 = lVar3;
  return;
}
