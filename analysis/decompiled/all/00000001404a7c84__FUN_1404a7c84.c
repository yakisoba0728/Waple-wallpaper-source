...
void FUN_1404a7c84(byte *param_1,char *param_2)

{
  ...
  *in_RAX = *in_RAX + (char)in_RAX;
  pcVar9 = (char *)((ulonglong)in_RAX ^ 0x13);
  *pcVar9 = *pcVar9 + (char)((ulonglong)param_2 >> 8);
  bVar4 = (byte)pcVar9 | *(byte *)(ulonglong)(uint)(int)(short)pcVar9;
  uVar7 = CONCAT22(cVar6 >> 7,CONCAT11(0x98,bVar4));
  bVar5 = *(byte *)(ulonglong)uVar7;
  pbVar10 = (byte *)(CONCAT62(unaff_0000001a,CONCAT11(unaff_BH,unaff_BL)) + 0x4a);
  *pbVar10 = *pbVar10 ^ unaff_BH;
  *param_1 = *param_1 + 0x98;
  uVar7 = CONCAT31((int3)(uVar7 >> 8),bVar4 | bVar5) + 0x34050002;
  ...
  *(char *)(unaff_RBP + -0x58) = *(char *)(unaff_RBP + -0x58) + bVar12;
  bVar5 = *pbVar10;
  *param_1 = *param_1 + (bVar4 | bVar5);
  iVar8 = CONCAT31(uVar2,bVar4 | bVar5) + 0x70050004;
  uVar3 = (uint3)((uint)iVar8 >> 8);
  bVar5 = (char)iVar8 + 0x60;
  iVar14 = (int)param_2 + *(int *)((ulonglong)CONCAT31(uVar3,bVar5) + 2);
  ...
  puVar15 = (uint *)(ulonglong)
                    CONCAT22((short)((uint)iVar14 >> 0x10),
                             CONCAT11((byte)((uint)iVar14 >> 8) |
                                      (&stack0x00000000)[CONCAT31(uVar3,bVar5)],(char)iVar14));
  bVar18 = CARRY1((byte)*puVar15,bVar12);
  *(byte *)puVar15 = (byte)*puVar15 + bVar12;
  cVar6 = bVar5 + (char)*unaff_RSI;
  bVar4 = cVar6 + bVar18;
  pcVar9 = (char *)(ulonglong)CONCAT31(uVar3,bVar4);
  if (SCARRY1(bVar5,(char)*unaff_RSI) != SCARRY1(cVar6,bVar18)) {
  ...
  *pbVar10 = *pbVar10;
  if ((POPCOUNT(*pbVar10) & 1U) == 0) {
    ...
    *pcVar9 = *pcVar9 + cVar6;
    ...
    puVar17 = unaff_RSI + 1;
    uVar7 = *unaff_RSI;
    bVar5 = (byte)uVar7 | *(byte *)(ulonglong)uVar7;
    pcVar9 = (char *)(ulonglong)CONCAT31((int3)(uVar7 >> 8),bVar5);
