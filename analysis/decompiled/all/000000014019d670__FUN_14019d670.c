// Function: FUN_14019d670
// Addr: 14019d670
// Size: 715 bytes


ulonglong FUN_14019d670(float *param_1,float *param_2,float *param_3,float *param_4,float *param_5,
...

{
  ...
  if (fVar9 <= DAT_1404926b0) {
    if (DAT_140492a74 <= fVar9) {
      param_6[0] = 0.0;
      param_6[1] = 0.0;
      *param_7 = -1.0;
    ...
    *param_6 = fVar7;
    ...
    if (0.0 <= fVar4) {
      bVar2 = fVar4 < fVar9;
LAB_14019d90f:
      if (bVar2 || fVar4 == fVar9) goto code_r0x00014019d913;
    }
  }
  bVar1 = 0;
code_r0x00014019d913:
  fVar9 = DAT_1404927d4 / fVar9;
  *param_6 = fVar7 * fVar9;
