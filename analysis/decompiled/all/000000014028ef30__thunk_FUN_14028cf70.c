// Function: thunk_FUN_14028cf70
// Addr: 14028ef30
// Size: 5 bytes


undefined1 (*) [32]
thunk_FUN_14028cf70(undefined1 (*param_1) [32],undefined1 (*param_2) [32],byte param_3)

{
  ...
  if (((uVar6 & 0xffffffffffffffe0) == 0) || ((DAT_1404dc00c & 0x20) == 0)) {
    ...
    if ((uVar6 & 0x1c) != 0) {
      ...
      auVar10 = vpand_avx2(auVar10,*(undefined1 (*) [32])(&DAT_140429a50 + -uVar7));
