// Function: FUN_1402b7c20
// Addr: 1402b7c20
// Size: 1312 bytes


longlong *
FUN_1402b7c20(undefined8 param_1,longlong *param_2,longlong *param_3,longlong *param_4,
...

{
  ...
  *param_6 = 0;
  switch(param_8) {
  case 0x25:
    cVar6 = FUN_140092d40(param_3,param_4);
    if (cVar6 == '\0') {
      if ((char)param_3[1] == '\0') {
        FUN_140097500(param_3);
      }
      cVar6 = (*(code *)PTR__guard_dispatch_icall_140426ae8)
                        (uVar9,*(undefined1 *)((longlong)param_3 + 9),0);
      if (cVar6 == '%') {
...
LAB_1402b7f79:
  ...
  case 0x68:
    ...
    *(undefined4 *)((longlong)param_3 + 0xc) = uStack_70._4_4_;
    break;
  case 0x43:
    uVar7 = FUN_1402b2700(param_3,param_4,0,99,&param_5,&param_8,uVar9);
    *puVar5 = *puVar5 | uVar7;
    if ((*puVar5 & 2) == 0) {
  ...
  case 0x78:
    ...
    goto LAB_1402b7d72;
  case 0x48:
    uVar7 = FUN_1402b2700(param_3,param_4,0,0x17,param_7 + 8,&param_8,uVar9);
    *puVar5 = *puVar5 | uVar7;
    break;
  case 0x49:
    uVar7 = FUN_1402b2700(param_3,param_4,1,0xc,&param_5,&param_8,uVar9);
    *puVar5 = *puVar5 | uVar7;
    if ((*puVar5 & 2) == 0) {
      iVar8 = (int)param_5;
      if ((int)param_5 == 0xc) {
  ...
  case 0x57:
    ...
    goto LAB_1402b7e2a;
  case 0x59:
    uVar7 = FUN_1402b2700(param_3,param_4,0,9999,&param_5,&param_8,uVar9);
    *puVar5 = *puVar5 | uVar7;
    if ((*puVar5 & 2) == 0) {
...
LAB_1402b7e13:
  ...
  case 0x74:
    ...
    goto LAB_1402b7d72;
  case 0x70:
    iVar8 = FUN_140096ed0(param_3,param_4,0,&DAT_14042be40,
                          in_stack_ffffffffffffff68 & 0xffffffffffffff00);
    if (iVar8 < 0) goto LAB_1402b7f79;
    if (1 < iVar8) {
...
LAB_1402b7d72:
    ...
    uStack_4c = *(undefined4 *)((longlong)param_4 + 0xc);
    puVar11 = (undefined4 *)
              FUN_1402b3f40(param_1,&local_78,&local_68,&local_58,lVar4,param_6,param_7,pcVar12);
    uVar1 = puVar11[1];
    uVar2 = puVar11[2];
    uVar3 = puVar11[3];
  ...
  case 0x77:
    ...
    uVar13 = 0;
LAB_1402b7e2a:
    uVar7 = FUN_1402b2700(param_3,param_4,uVar13,uVar14,lVar10,&param_8,uVar9);
    *puVar5 = *puVar5 | uVar7;
    break;
  case 0x79:
    uVar7 = FUN_1402b2700(param_3,param_4,0,99,&param_5,&param_8,uVar9);
  ...
  if (*param_3 == 0) {
    if (*param_4 != 0) goto LAB_1402b8124;
  }
  else if (*param_4 == 0) goto LAB_1402b8124;
  *puVar5 = *puVar5 | 1;
LAB_1402b8124:
  lVar10 = param_3[1];
  *param_2 = *param_3;
