// Function: FUN_1403efc20
// Addr: 1403efc20
// Size: 276 bytes


void FUN_1403efc20(longlong param_1,longlong param_2,undefined4 param_3)

{
  ...
  fVar6 = (float)FUN_1403993a0(*(undefined8 *)(param_2 + 0x48),param_3,0);
  sVar5 = (ushort)*(byte *)(param_1 + 4) * 0x100;
  ...
  (**(code **)(lVar1 + 0x10))
            (lVar1,*(undefined8 *)(param_2 + 0x18),lVar1,sVar5,0,
             ((float)(int)(short)((ushort)*(byte *)(param_1 + 5) + sVar5) + fVar6) * DAT_140471a5c,0
             ,0,uVar2);
  ...
  if (*(longlong *)(lVar1 + 0x98) != 0) {
    uVar2 = *(undefined8 *)(*(longlong *)(lVar1 + 0x98) + 8);
                    ...
                    /* WARNING: Could not recover jumptable at 0x0001403efd30. Too many branches */
