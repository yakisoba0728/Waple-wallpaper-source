...
void FUN_1404b77d0(char *param_1,longlong param_2)

{
  ...
  *param_1 = *param_1 + (char)((uint)(in_EAX + -0x4b76b800) >> 8);
  ...
  *unaff_RDI = *unaff_RDI + (char)param_1;
  param_1[-0x7ea6ffe3] = param_1[-0x7ea6ffe3] & (char)(in_EAX + 0xe88e4802U) + 2U;
  uVar3 = (in_EAX + 0xe88e4802U | 0xb920f00) + 0xe88dcc02;
