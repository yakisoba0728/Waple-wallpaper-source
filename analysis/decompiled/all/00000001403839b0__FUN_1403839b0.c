// Function: FUN_1403839b0
// Addr: 1403839b0
// Size: 105 bytes


void FUN_1403839b0(longlong *param_1,undefined8 param_2,longlong param_3)

{
  ...
  *(undefined4 *)(lVar10 + 0x5c) = 0;
  ...
  do {
    if (cVar15 == '\0') {
code_r0x000140384041:
      if ((*(char *)(lVar10 + 0x58) != '\0') &&
         (cVar15 = func_0x0001403ed130(lVar10,*(int *)(lVar10 + 0x60) - *(int *)(lVar10 + 0x5c)),
         cVar15 != '\0')) {
    ...
    if (*(uint *)(lVar10 + 0x5c) < *(uint *)(lVar10 + 0x60)) {
      ...
      if (((lVar19 == 0) ||
        ...
        if (uVar24 != 0xffff) {
          pbVar18 = (byte *)FUN_1403cf4c0((ulonglong)*(byte *)(lVar11 + 7) +
    ...
    while( true ) {
      ...
      ;
      if (puStack_68 != (uint *)0x0) break;
      if ((((iVar27 != 0) || (local_78 != 0)) || ((bVar7 & 0x20) != 0)) ||
         (((bVar8 >> 5 & 1) != 0 || (uVar24 = uVar23, (bVar8 & 0x40) != 0))))
      goto code_r0x0001403840c6;
      do {
        func_0x00014040dff0(param_2,lVar10,param_1,pbVar3);
        uVar26 = *(uint *)(lVar10 + 0x5c);
        if ((uVar26 == *(uint *)(lVar10 + 0x60)) || (*(char *)(lVar10 + 0x58) == '\0')) break;
        if (*(char *)(lVar10 + 0x59) == '\0') {
code_r0x000140383de4:
          *(uint *)(lVar10 + 0x5c) = uVar26 + 1;
        }
        else {
          if ((*(longlong *)(lVar10 + 0x78) == *(longlong *)(lVar10 + 0x70)) && (*puVar1 == uVar26))
          {
code_r0x000140383de1:
            *puVar1 = *puVar1 + 1;
            goto code_r0x000140383de4;
          }
          cVar15 = func_0x0001403bf270(lVar10,*puVar1 + 1);
          if (cVar15 != '\0') {
        ...
        if (*(uint *)(lVar10 + 0x5c) < *(uint *)(lVar10 + 0x60)) {
          ...
          if (((lVar11 == 0) ||
            ...
            if (uVar26 == 0xffff) {
              ...
              pbVar18 = (byte *)FUN_1403cf4c0((ulonglong)*(byte *)(lVar19 + 7) +
    ...
    if ((*puStack_68 & *(uint *)(param_3 + 0x88)) == 0) {
      if (uVar24 == *(uint *)(lVar10 + 0x60)) goto code_r0x000140384041;
      local_78 = 0;
      if (*(char *)(lVar10 + 0x59) == '\0') {
code_r0x000140383ffc:
        *(int *)(lVar10 + 0x5c) = *(int *)(lVar10 + 0x5c) + 1;
      }
      else {
        if ((*(longlong *)(lVar10 + 0x78) == *(longlong *)(lVar10 + 0x70)) && (*puVar1 == uVar24)) {
code_r0x000140383ff9:
          *puVar1 = *puVar1 + 1;
          goto code_r0x000140383ffc;
        }
        cVar15 = func_0x0001403bf270(lVar10,*puVar1 + 1);
        if (cVar15 != '\0') {
          ...
          *(undefined4 *)(lVar11 + (ulonglong)uVar24 * 0x14 + 0x10) =
          ...
          goto code_r0x000140383ff9;
        }
      }
    }
    else {
code_r0x0001403840c6:
      if ((bVar8 & 0x20) == 0) {
        if ((iVar27 != 0) && (((bVar8 & 0x40) == 0 || (local_78 != 0)))) {
          ...
          if ((((pbVar18[uVar22 * 6 + lVar11 + 2] >> 5 & 1) != 0) ||
             ...
             || ((bVar8 & 0x40) != (pbVar18[uVar22 * 6 + lVar11 + 2] & 0x40)))
          goto code_r0x000140384155;
        }
        lVar19 = FUN_1403c7a80(pbVar18,iVar27,0);
        if ((*(byte *)(lVar19 + 2) & 0x20) != 0) goto code_r0x000140384155;
      }
      else {
code_r0x000140384155:
        ...
        if (*puVar20 != 0) {
          ...
          if (uVar24 < uVar23) {
            ...
            if ((uVar26 == 0xffffffff) || ((uVar24 - iVar27) + 1 < 0x100)) {
              ...
              if (cVar15 == '\0') {
                uVar16 = FUN_1403a1af0(lVar10,*(undefined8 *)(lVar10 + 0x70),iVar27,uVar22,
                                       0xffffffff);
                FUN_1403a1c90(lVar10,*(undefined8 *)(lVar10 + 0x70),iVar27,uVar23,uVar16,3);
              }
              else {
                uVar16 = FUN_1403a1af0(lVar10,*(undefined8 *)(lVar10 + 0x70),uVar24,uVar22,
                                       0xffffffff);
                iVar17 = FUN_1403a1af0(lVar10,*(undefined8 *)(lVar10 + 0x78),iVar27,*puVar1,uVar16);
                FUN_1403a1c90(lVar10,*(undefined8 *)(lVar10 + 0x78),iVar27,*puVar1,iVar17,3);
                uVar24 = *(uint *)(lVar10 + 0x5c);
...
joined_r0x00014038429e:
                    ...
                    if (iVar17 == iVar27) {
                      ...
                      if (iVar17 != iVar27) goto joined_r0x00014038429e;
      ...
      func_0x00014040dff0(param_2,lVar10,param_1,pbVar3);
      if (*(uint *)(lVar10 + 0x5c) == *(uint *)(lVar10 + 0x60)) goto code_r0x000140384041;
      if (((bVar8 & 0x40) == 0) ||
        ...
        if (*(char *)(lVar10 + 0x59) != '\0') {
          if ((*(longlong *)(lVar10 + 0x78) != *(longlong *)(lVar10 + 0x70)) ||
            ...
            cVar15 = func_0x0001403bf270(lVar10,*puVar1 + 1);
            if (cVar15 == '\0') goto code_r0x000140384007;
            uVar23 = *(uint *)(lVar10 + 0x5c);
            lVar19 = *(longlong *)(lVar10 + 0x70);
