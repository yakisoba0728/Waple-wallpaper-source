// Function: FUN_140134320
// Addr: 140134320
// Size: 327 bytes


void FUN_140134320(undefined4 *param_1,undefined4 *param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  *(undefined8 *)(param_1 + 0x1c) = 0xf;
  ...
  FUN_140132c10(local_58,param_2,param_3,param_4,uVar1,uVar3,uVar5);
  *param_2 = uVar1;
  param_2[1] = uVar2;
  param_2[2] = uVar3;
  param_2[3] = uVar4;
  param_2[4] = uVar5;
  param_2[5] = uVar6;
  FUN_14000df10(param_2 + 6,&local_c0);
  FUN_14000df10(param_2 + 0xe,&local_a0);
  FUN_14000df10(param_2 + 0x16,&local_80);
  ...
  *(undefined8 *)(param_2 + 0x1e) = local_60;
  if (0xf < local_68) {
    ...
    if (0xfff < uVar9) {
      ...
      if (0x1f < (local_80 - lVar8) - 8U) goto code_r0x000140134532;
      uVar9 = local_68 + 0x28;
    }
    func_0x00014028b040(lVar8,uVar9);
  }
  if (0xf < local_88) {
    uVar9 = local_88 + 1;
    lVar8 = local_a0;
    if (0xfff < uVar9) {
      ...
      if (0x1f < (local_a0 - lVar8) - 8U) goto code_r0x000140134532;
      uVar9 = local_88 + 0x28;
    }
    func_0x00014028b040(lVar8,uVar9);
  }
