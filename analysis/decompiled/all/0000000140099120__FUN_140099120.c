// Function: FUN_140099120
// Addr: 140099120
// Size: 526 bytes


void FUN_140099120(longlong param_1,undefined8 param_2)

{
  ...
  *(undefined8 *)(param_1 + 0x120) = *(undefined8 *)(param_1 + 0x118);
  ...
  if (plVar2 != (longlong *)0x0) {
    iVar3 = (**(code **)(*plVar2 + 0x48))(plVar2,0,&DAT_140477fc0,&uStackX_8);
    if (-1 < iVar3) {
      plVar2 = (longlong *)*puVar1;
      (**(code **)(*plVar2 + 0x48))(plVar2,uStackX_8,0,&uStackX_10);
    }
    plVar2 = *(longlong **)(*(longlong *)(param_1 + 0x70) + 0x10);
    (**(code **)(*plVar2 + 0x90))(plVar2,&local_88);
    uVar4 = func_0x00014028aff0(0xa0);
    uVar4 = FUN_1400d2d30(uVar4,local_88,local_84,1,0,param_2,0x1b,0x18,0,0,
                          *(undefined8 *)(param_1 + 0x70),uStackX_10,uStackX_8);
