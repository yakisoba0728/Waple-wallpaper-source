// Function: FUN_1400b0570
// Addr: 1400b0570
// Size: 615 bytes


char * FUN_1400b0570(longlong param_1,longlong *param_2)
...
switchD_1400b05dc_caseD_2:
    while (puVar11 != puVar13) {
      ...
      *(ulonglong *)(param_1 + 0xfdd8) = uVar8;
      if (bVar3 == 8) goto LAB_1400b05f6;
      *(ulonglong *)(param_1 + 0xfdd8) = (ulonglong)(bVar3 + 8) << 0x38 | uVar8;
    }
    goto LAB_1400b071d;
  case 3:
    goto switchD_1400b05dc_caseD_3;
  case 4:
    goto switchD_1400b05dc_caseD_4;
  case 5:
    goto switchD_1400b05dc_caseD_5;
  case 6:
    goto switchD_1400b05dc_caseD_6;
  case 7:
    goto switchD_1400b05dc_caseD_7;
  case 8:
    goto switchD_1400b05dc_caseD_8;
  default:
    goto switchD_1400b05dc_default;
  }
  if ((longlong)puVar13 - (longlong)puVar11 < 2) {
    *(undefined8 *)(param_1 + 0xfdd8) = 0;
    iVar10 = 2;
    goto switchD_1400b05dc_caseD_2;
  }
  uVar8 = (ulonglong)*puVar11;
  puVar11 = puVar11 + 1;
LAB_1400b05f6:
  *(int *)(param_1 + 0x80) = (int)uVar8;
switchD_1400b05dc_caseD_3:
  if ((longlong)puVar13 - (longlong)puVar11 < 2) {
    *(undefined8 *)(param_1 + 0xfdd8) = 0;
    iVar10 = 4;
switchD_1400b05dc_caseD_4:
    if (puVar11 == puVar13) {
LAB_1400b071d:
...
switchD_1400b05dc_caseD_5:
    if ((longlong)puVar13 - (longlong)puVar11 < 2) {
      *(undefined8 *)(param_1 + 0xfdd8) = 0;
      iVar10 = 6;
switchD_1400b05dc_caseD_6:
      if (puVar11 == puVar13) goto LAB_1400b071d;
      do {
        uVar9 = *(ulonglong *)(param_1 + 0xfdd8);
        uVar8 = uVar9 & 0xffffffffffffff;
        *(ulonglong *)(param_1 + 0xfdd8) = uVar8;
        ...
        uVar8 = (ulonglong)(byte)uVar4 << (bVar3 & 0x3f) | uVar8;
        *(ulonglong *)(param_1 + 0xfdd8) = uVar8;
        if (bVar3 == 8) goto code_r0x0001400b0634;
        *(ulonglong *)(param_1 + 0xfdd8) = (ulonglong)(bVar3 + 8) << 0x38 | uVar8;
      } while (puVar11 != puVar13);
      pcVar5 = "$base: short read";
      iVar7 = 1;
...
code_r0x0001400b065d:
        ...
        *(uint *)(param_1 + 0x8c) = uVar12;
        ...
        goto UNWIND_INFO_1400b080c_UnwindCodes_59__UnwindOpCode;
      }
      *(undefined8 *)(param_1 + 0xfdd8) = 0;
      iVar10 = 8;
switchD_1400b05dc_caseD_8:
      if (puVar11 == puVar13) goto LAB_1400b071d;
      do {
        ...
        *(ulonglong *)(param_1 + 0xfdd8) = uVar9;
        if (bVar3 == 8) goto code_r0x0001400b065d;
...
switchD_1400b05dc_default:
  if (iVar7 != 0) {
    iVar6 = iVar10;
  }
UNWIND_INFO_1400b080c_UnwindCodes_59__UnwindOpCode:
