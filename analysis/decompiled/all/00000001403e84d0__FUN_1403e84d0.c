...
void FUN_1403e84d0(longlong *param_1,longlong param_2,longlong param_3,uint param_4,char param_5)
...
LAB_1403e872b:
              ...
              if (((local_1ac & puVar1[1]) != 0) &&
                ...
                if (((cVar7 != '\0') &&
                   ...
                   (iVar16 = FUN_1403cb3f0(*puVar10,uVar5,uVar4,puVar10[1]), uVar15 = local_1c0,
                   iVar16 != 0)) {
                  if (local_200 == 4) {
                    if (param_5 != '\0') {
