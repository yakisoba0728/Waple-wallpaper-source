// Function: FUN_1403f43b0
// Addr: 1403f43b0
// Size: 496 bytes


void FUN_1403f43b0(int param_1,longlong param_2)

{
  ...
  case 0x1c:
    ...
    FUN_1403f5980(param_2 + 0x18,(int)(short)((ushort)*pbVar8 << 8) | (uint)*pbVar7);
