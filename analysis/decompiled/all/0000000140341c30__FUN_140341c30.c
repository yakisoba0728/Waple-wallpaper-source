// Function: FUN_140341c30
// Addr: 140341c30
// Size: 200 bytes


longlong FUN_140341c30(longlong param_1,undefined8 param_2)

{
  ...
  if (*(uint *)(param_1 + 0x2c) < uVar9) {
    *(undefined8 *)(param_1 + 0x38) = param_2;
    uVar7 = FUN_1402f7ff0(param_2,4,*(uint *)(param_1 + 0x2c),uVar9,*(undefined8 *)(param_1 + 0x30),
                          local_res8);
