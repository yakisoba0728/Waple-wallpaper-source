...
undefined1 (*) [16]
thunk_FUN_14028e940(undefined1 (*param_1) [16],undefined1 (*param_2) [16],undefined1 (*param_3) [16]
                   ,longlong param_4)
      ...
      if (uVar9 <= uVar5) {
        if (((DAT_1404dc00c & 0x20) == 0) || (uVar5 < 0x20)) {
          if (((DAT_1404dc00c & 4) == 0) || (uVar5 < 0x10)) {
            ...
            uVar2 = (uint)param_4;
            uVar10 = 8 < uVar2;
            FUN_1404210f0(auStack_58,param_3,uVar9);
            auVar1 = auStack_58;
            do {
              iVar4 = pcmpestri(auStack_58,*param_1,0xd,uVar2,8);
              if ((bool)uVar10) {
            ...
            if (uVar9 != 0) {
              bVar11 = (uVar9 & 1) != 0;
              FUN_1404210f0(auStack_58,param_1);
              iVar4 = pcmpestri(auVar1,auStack_58,0xd,uVar2,(int)(uVar9 >> 1));
              if (bVar11) {
